...
TArray<class UClass*> UwUtil::STATIC_GetMutatorClasses(TArray<struct FString> MutClassNames)
{
...
int UwUtil::STATIC_TeamArrayTacticsRating(TArray<struct FString> Players)
{
...
int UwUtil::STATIC_TeamArrayAgilityRating(TArray<struct FString> Players)
{
...
int UwUtil::STATIC_TeamArrayAggressivenessRating(TArray<struct FString> Players)
{
...
int UwUtil::STATIC_TeamArrayAccuracyRating(TArray<struct FString> Players)
{
...
int UwUtil::STATIC_RatingModifier(const struct FString& CharacterName)
{
...
struct FString UwUtil::STATIC_GetFavoriteWeaponFor(const struct FPlayerRecord& PRE)
{
...
struct FPlayerRecord UwUtil::STATIC_FindPlayerRecord(const struct FString& CharName)
{
...
void UwUtil::STATIC_GetMutatorList(TArray<struct UwUtil_FMutatorRecord> MutatorRecords)
{
...
class UDecoText* UwUtil::STATIC_LoadDecoText(const struct FString& PackageName, const struct FString& DecoTextName, int ColumnCount)
{
...
struct FPlayerRecord UwUtil::STATIC_FindUPLPlayerRecord(const struct FString& CharName)
{
...
void UwUtil::STATIC_GetPlayerList(TArray<struct FPlayerRecord>* PlayerRecords)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wTeamRoster.BelongsOnTeam");

	AwTeamRoster_BelongsOnTeam_Params params;
...
bool AwTeamRoster::AlreadyExistsEntry(const struct FString& CharacterName, bool bNoRecursion)
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wTeamRoster.AlreadyExistsEntry");

	AwTeamRoster_AlreadyExistsEntry_Params params;
	params.CharacterName = CharacterName;
...
bool AwTeamRoster::AvailableRecord(const struct FString& MenuString)
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wTeamRoster.AvailableRecord");

	AwTeamRoster_AvailableRecord_Params params;
	params.MenuString = MenuString;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wTeamRoster.GetRandomPlayer");

	AwTeamRoster_GetRandomPlayer_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wTeamRoster.FillPlayerTeam");

	AwTeamRoster_FillPlayerTeam_Params params;
	params.G = G;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wTeamRoster.Initialize");

	AwTeamRoster_Initialize_Params params;
...
class URosterEntry* AwTeamRoster::GetNamedBot(const struct FString& botname)
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wTeamRoster.GetNamedBot");

	AwTeamRoster_GetNamedBot_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wTeamRoster.PostBeginPlay");

	AwTeamRoster_PostBeginPlay_Params params;
...
struct FString AwKillerMessagePlus::STATIC_GetString(int Switch, class APlayerReplicationInfo* RelatedPRI_1, class APlayerReplicationInfo* RelatedPRI_2, class UObject* OptionalObject)
{
...
struct FString AwDeathMessage::STATIC_GetString(int Switch, class APlayerReplicationInfo* RelatedPRI_1, class APlayerReplicationInfo* RelatedPRI_2, class UObject* OptionalObject)
{
...
bool AwAILevel::ActionExists(int ActionGroupID, const struct FString& Action)
{
...
void AwAIBotBase::HandleMessage(const struct FString& Msg)
{
...
void AwAIBotBase::Cmd(const struct FString& P1, const struct FString& P2, const struct FString& p3, const struct FString& p4, const struct FString& p5)
{
...
void AwAIBotBase::SetPawnClass(const struct FString& inClass, const struct FString& InCharacter)
{
...
int USpeciesType::STATIC_GetOffsetForSequence(const struct FName& Sequence)
{
...
struct FString USpeciesType::STATIC_GetRagSkelName(const struct FString& MeshName)
{
...
struct FString USpeciesType::STATIC_GetVoiceType(bool bIsFemale, class ALevelInfo* Level)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wPawn.SetSpecialState");

	AwPawn_SetSpecialState_Params params;
	params.byState = byState;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wPawn.DoSortEquipedItems");

	AwPawn_DoSortEquipedItems_Params params;
	params.kUserInfo = kUserInfo;
...
void AwPawn::RemoveInventoryByDamageType(TEnumAsByte<EeWeaponType> removeWeaponType)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wPawn.GetInvenSkillIDbyPos");

	AwPawn_GetInvenSkillIDbyPos_Params params;
	params.kUser = kUser;
	params.iPos = iPos;
...
TEnumAsByte<EGibType> AwPawn::GetGibParts(int iCollisionPart)
{
...
void AwPawn::SetParts(TEnumAsByte<EePlayerParts> iPartsIndex, class UMesh* resMesh, class UStaticMesh* resStaticMesh)
{
...
class UMaterial* AwPawn::GetCamouflage(int iItemID, unsigned char byTeam)
{
...
void AwPawn::SetCamouflage(int iItemID, unsigned char byTeam)
{
...
class UClass* AwPawn::GetGibClass(TEnumAsByte<EGibType> gibType)
{
...
struct FString AwPawn::GetSound(TEnumAsByte<ESoundType> soundType)
{
...
bool AwPawn::IsTeamGame()
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wPawn.IsTeamGame");

	AwPawn_IsTeamGame_Params params;
...
bool AwPawn::PerformDodge(TEnumAsByte<EDoubleClickDir> DoubleClickMove, const struct FVector& Dir, const struct FVector& Cross)
{
...
bool AwPawn::Dodge(TEnumAsByte<EDoubleClickDir> DoubleClickMove)
{
...
void AwPawn::DoComboName(const struct FString& ComboClassName)
{
...
void AwPawn::SetAnimAction(const struct FName& NewAction)
{
...
void AwPawn::DoDamageFX(const struct FName& BoneName, int Damage, class UClass* DamageType, const struct FRotator& R, const struct FVector& HitLoc, int CollisionPart)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wPawn.GetBoneNameByCollisionID");

	AwPawn_GetBoneNameByCollisionID_Params params;
	params.CollisionID = CollisionID;
...
void AwPawn::CalcHitLoc(const struct FVector& HitLoc, const struct FVector& hitRay, struct FName* BoneName, float* dist)
{
...
void AwPawn::HideBone(const struct FName& BoneName)
{
...
void AwPawn::AttachEffect(class UClass* EmitterClass, const struct FName& BoneName, const struct FVector& Location, const struct FRotator& Rotation)
{
...
void AwMonster::CreateGib(const struct FName& BoneName, class UClass* DamageType, const struct FRotator& R)
{
...
void AwMonster::SetAnimAction(const struct FName& NewAction)
{
...
void AwDefenceBoss::SetAnimAction(const struct FName& NewAction)
{
...
class AwDefenceBoss* AwDefenceBoss::STATIC_Create(class ALevelInfo* Level, unsigned char TeamNum, int Grade, int RegenLoc)
{
...
void AwPlayer::MakeItemBox(const struct FString& t)
{
...
void AwPlayer::Rot_CBR(const struct FString& fX, const struct FString& fY, const struct FString& fZ)
{
...
void AwPlayer::Rot_CBL(const struct FString& fX, const struct FString& fY, const struct FString& fZ)
{
...
void AwPlayer::Rot_CFR(const struct FString& fX, const struct FString& fY, const struct FString& fZ)
{
...
void AwPlayer::Rot_CFL(const struct FString& fX, const struct FString& fY, const struct FString& fZ)
{
...
void AwPlayer::Rot_BR(const struct FString& fX, const struct FString& fY, const struct FString& fZ)
{
...
void AwPlayer::Rot_BL(const struct FString& fX, const struct FString& fY, const struct FString& fZ)
{
...
void AwPlayer::Rot_FR(const struct FString& fX, const struct FString& fY, const struct FString& fZ)
{
...
void AwPlayer::Rot_FL(const struct FString& fX, const struct FString& fY, const struct FString& fZ)
{
...
bool AwPlayer::ActivateSupplyItem(class AController* callingController, TEnumAsByte<ESUPPLY_ITEM_TYPE> eSupplyItemType)
{
...
bool AwPlayer::CanUseActivateSupplyItem(class AController* callingController, TEnumAsByte<ESUPPLY_ITEM_TYPE> eSupplyItemType, bool bShowMessage)
{
...
void AwPlayer::ClientReceiveBan(const struct FString& BanInfo)
{
...
void AwPlayer::AdminMenu(const struct FString& CommandLine)
{
...
void AwPlayer::ChangeCharacter(const struct FString& newCharacter)
{
...
void AwPlayer::UpdateModeItem_SkinCharacter(class UwMatchMaker* MM, unsigned char byModeItem, int ItemID, int* BodyItemID)
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wPlayer.UpdateModeItem_SkinCharacter");

	AwPlayer_UpdateModeItem_SkinCharacter_Params params;
	params.MM = MM;
	...
	if (BodyItemID != nullptr)
		*BodyItemID = params.BodyItemID;
}
...
void AwPlayer::SetPawnClass(const struct FString& inClass, const struct FString& InCharacter)
{
...
void AwPlayer::ServerPlayWeaponNullSound(class AwWeapon* Wpn, TEnumAsByte<ESoundSlot> Slot, bool UseStereo)
{
...
void AwPlayer::ClientReceiveCombo(const struct FString& NewCombo)
{
...
void AwPlayer::ClientReceiveMapName(const struct FString& NewMap)
{
...
void AwPlayer::ClientReceiveResultMenu(const struct FString& MenuClass)
{
...
void AwPlayer::ClientReceiveRule(const struct FString& NewRule)
{
...
void AwPlayer::DebugMessage(const struct FString& DebugString, const struct FName& Type)
{
...
void AwPlayer::setcmd(const struct FString& targetName)
{
...
void AwPlayer::Cmd(const struct FString& P1, const struct FString& P2, const struct FString& p3, const struct FString& p4, const struct FString& p5)
{
...
void AwPlayer::ProcessMapName(const struct FString& NewMap)
{
...
void AwPlayer::ProcessRule(const struct FString& NewRule)
{
...
void AwBotVehicleController::SoakStop(const struct FString& problem)
{
...
struct FString UwPawnSoundGroup::STATIC_GetEquipHitSound()
{
...
struct FString UwPawnSoundGroup::STATIC_GetBreathSound()
{
...
struct FString UwPawnSoundGroup::STATIC_GetSound(TEnumAsByte<ESoundType> soundType)
{
...
struct FString UwPawnSoundGroup::STATIC_GetLandedSound3d(int SurfType)
{
...
struct FString UwPawnSoundGroup::STATIC_GetLandedSound2D(int SurfType)
{
...
class UwRosterEntry* UwRosterEntry::STATIC_CreateRosterEntryCharacter(const struct FString& CharName)
{
...
struct FString USPECIES_Merc::STATIC_GetRagSkelName(const struct FString& MeshName)
{
...
void AwBot::SetPawnClass(const struct FString& inClass, const struct FString& InCharacter)
{
...
void AwMonsterController::SoakStop(const struct FString& problem)
{
...
struct FString AwMonsterController::GetEnemyName()
{
...
struct FString AwMonsterController::GetOldEnemyName()
{
...
void AwMonsterController::WhatToDoNext(unsigned char CallingByte)
{
...
void UGoal::HandleMessage(const struct FString& Msg)
{
...
TEnumAsByte<EGoalStatus> UGoal::ProcessSubGoals(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal::Process(float dt)
{
...
void AwBotVehicle::CreateGib(const struct FName& BoneName, class UClass* DamageType, const struct FRotator& R)
{
...
void AwBotVehicle::SetAnimAction(const struct FName& NewAction)
{
...
bool AwHelicopter::Dodge(TEnumAsByte<EDoubleClickDir> DoubleClickMove)
{
...
struct FString AComboMessage::STATIC_GetString(int Switch, class APlayerReplicationInfo* RelatedPRI_1, class APlayerReplicationInfo* RelatedPRI_2, class UObject* OptionalObject)
{
...
void AwPlayerReplicationInfo::SetCharacterName(const struct FString& S)
{
...
void AwAIBot::SetPawnClass(const struct FString& inClass, const struct FString& InCharacter)
{
...
void UGoal_PlanAndExec::HandleMessage(const struct FString& Msg)
{
...
TEnumAsByte<EGoalStatus> UGoal_PlanAndExec::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_Fire::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_MovePathToward::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_Roam::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_Shoot::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_Test::ActualWork(float dt)
{
...
void UwActionPlanner::SubPlan(int Layer, class UwPurpose* purpose, float parentActionTime, class UwActionContainer** acon, class UwStateData** S, TArray<class UwActionLayer*>* Actions)
{
...
void UwActionPlanner::GetActionCandidatesByLayer(TArray<class UwAction*>* rawActions, TArray<class UwActionLayer*>* actionsByLayer)
{
...
void UwActionPlanner::GetActionCandidates(TArray<class UwAction*>* Actions)
{
...
void UwActionPlanner::GetActionCandidates_Pick(TArray<class UwAction*>* Actions)
{
...
void UwActionPlanner::GetActionCandidates_SwitchWeapon(TArray<class UwAction*>* Actions)
{
...
struct FString AwHelicopterController::Rotator2String(const struct FRotator& R)
{
...
struct FString AwHelicopterController::Vector2String(const struct FVector& V)
{
...
struct FRotator AwAISentryGunController::GetViewRotation()
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wAISentryGunController.GetViewRotation");

	AwAISentryGunController_GetViewRotation_Params params;
...
bool AwAISentryGunController::IsFinishSpecificBoneRotate()
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wAISentryGunController.IsFinishSpecificBoneRotate");

	AwAISentryGunController_IsFinishSpecificBoneRotate_Params params;
...
void AwAISentryGunController::ExecuteWhatToDoNext()
{
	static auto fn = UObject::FindObject<UFunction>("Function WGame.wAISentryGunController.ExecuteWhatToDoNext");

	AwAISentryGunController_ExecuteWhatToDoNext_Params params;
...
TEnumAsByte<EGoalStatus> UGoal_MoveToward::ActualWork(float dt)
{
...
class UDAE_InSight* UDAE_InSight::STATIC_Create(class AwAIBotBase* inOwner)
{
...
class UDAE_Visibility* UDAE_Visibility::STATIC_Create(class AwAIBotBase* inOwner)
{
...
class UDAE_Proximity* UDAE_Proximity::STATIC_Create(class AwAIBotBase* inOwner, float inMaxDistance)
{
...
class UDAE_IsTurret* UDAE_IsTurret::STATIC_Create()
{
...
class UDAE_RecentTarget* UDAE_RecentTarget::STATIC_Create(class AwAIBotBase* inOwner, float InTime)
{
...
TEnumAsByte<EGoalStatus> UGoal_ExecPlan::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_Stay::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_SwitchWeapon::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_Reload::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_ExecPartialPlan::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_MoveToSeeTarget::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_PickTarget::ActualWork(float dt)
{
...
struct FString UGoal_AimSpecificParts::ToString()
{
...
TEnumAsByte<EGoalStatus> UGoal_AimSpecificParts::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_ThrowGrenadeRealTime::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_SwitchAndUse::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_LookAround::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_MeleeNoTarget::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_MoveToEnemyInfluence::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_Fail::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_UseAirstrikeRealTime::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_ApproachAndMelee::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_SwitchAndFire::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_Throw::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_SwitchAndThrow::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_Melee::ActualWork(float dt)
{
...
TEnumAsByte<EGoalStatus> UGoal_Look::ActualWork(float dt)
{
...
bool AwTeamGame::SpawnAndPossessPawn(class AController* C, const struct FString& PawnClassName)
{
...
class ANavigationPoint* AwTeamGame::FindPlayerStart(class AController* Player, unsigned char inTeam, const struct FString& incomingName)
{
...
void AwTeamGame::GetGameSpecificPurposes(class AController* Owner, TArray<class UObject*>* purposes)
{
...
void AwTeamGame::EndGame(class APlayerReplicationInfo* Winner, const struct FString& Reason)
{
...
void AwTeamGame::InitGame(const struct FString& Options, struct FString* Error)
{
...
void AwTurret::PlayFiring(float Rate, const struct FName& FiringMode)
{
...
class UClass* AwAIDefencePawn::GetBloodHitClass(bool bHeadShot)
{
...
void AwAIDefenceBot::SetPawnClass(const struct FString& inClass, const struct FString& InCharacter)
{
