...
public:
	...
	unsigned long                                      UseVSync : 1;                                             // 0x4100(0x0004) (Edit)
	unsigned char                                      UnknownData01[0x80];                                      // 0x4104(0x0080) MISSED OFFSET
	int                                                LevelOfAnisotropy;                                        // 0x4184(0x0004) (Edit)
	unsigned char                                      UnknownData02[0x37D70];                                   // 0x4188(0x37D70) MISSED OFFSET
