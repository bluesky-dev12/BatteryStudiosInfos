...
struct FBT_ItemShopInfo
{
	...
	struct FString                                     sDispNm;                                                  // 0x0004(0x000C) (NeedCtorLink)
	...
	struct FString                                     sAddPartGreoupID;                                         // 0x0018(0x000C) (NeedCtorLink)
...
struct FBT_WeaponInfo
{
	...
	unsigned char                                      bFuseImpactTime;                                          // 0x0040(0x0001)
	...
	unsigned char                                      bHitEffectFriendly;                                       // 0x0080(0x0001)
	...
	unsigned char                                      bReloadType;                                              // 0x0094(0x0001)
	unsigned char                                      bRechamber;                                               // 0x0095(0x0001)
...
struct FBT_Skill
{
	...
	struct FString                                     mSkillName;                                               // 0x0004(0x000C) (NeedCtorLink)
...
struct FBT_PartsGroup
{
	...
	struct FString                                     sPartGroupID;                                             // 0x0004(0x000C) (NeedCtorLink)
	struct FString                                     sPartName;                                                // 0x0010(0x000C) (NeedCtorLink)
	...
	struct FString                                     sZoom1;                                                   // 0x0050(0x000C) (NeedCtorLink)
	struct FString                                     sZoom2;                                                   // 0x005C(0x000C) (NeedCtorLink)
};
...
struct FBT_Promotion
{
	...
	struct FString                                     sAcquieItem;                                              // 0x0004(0x000C) (NeedCtorLink)
...
{
	struct FString                                     sLevelName;                                               // 0x0000(0x000C) (NeedCtorLink)
	int                                                nLevel;                                                   // 0x000C(0x0004)
	int                                                nUpperExp;                                                // 0x0010(0x0004)
	struct FString                                     sClassfy;                                                 // 0x0014(0x000C) (NeedCtorLink)
};
...
struct FBT_GameMapInfo
{
	...
	struct FString                                     sMapNm;                                                   // 0x0008(0x000C) (NeedCtorLink)
...
struct FBT_PaintGroup
{
	...
	struct FString                                     sPaintingGroupID;                                         // 0x0004(0x000C) (NeedCtorLink)
