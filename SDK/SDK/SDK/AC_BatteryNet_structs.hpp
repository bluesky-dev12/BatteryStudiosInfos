...
struct FSystemMsgParam
{
	...
	struct FString                                     CharName;                                                 // 0x0004(0x000C) (NeedCtorLink)
...
struct FClanInfo
{
	struct FString                                     ClanMasterCharname;                                       // 0x0000(0x000C) (NeedCtorLink)
	...
	struct FString                                     HowOld;                                                   // 0x0038(0x000C) (NeedCtorLink)
	struct FString                                     Keyword;                                                  // 0x0044(0x000C) (NeedCtorLink)
	struct FString                                     Intro;                                                    // 0x0050(0x000C) (NeedCtorLink)
	struct FString                                     CM_ClanName;                                              // 0x005C(0x000C) (NeedCtorLink)
	int                                                CM_Pattern;                                               // 0x0068(0x0004)
	int                                                CM_BG;                                                    // 0x006C(0x0004)
	int                                                CM_BL;                                                    // 0x0070(0x0004)
	struct FString                                     ClanNoti;                                                 // 0x0074(0x000C) (NeedCtorLink)
...
struct FGameRoomInfo
{
	...
	struct FString                                     RoomName;                                                 // 0x0004(0x000C) (NeedCtorLink)
	struct FString                                     MapName;                                                  // 0x0010(0x000C) (NeedCtorLink)
	struct FString                                     GameClass;                                                // 0x001C(0x000C) (NeedCtorLink)
	...
	struct FString                                     RoomOwner;                                                // 0x0038(0x000C) (NeedCtorLink)
	...
	struct FString                                     Password;                                                 // 0x0050(0x000C) (NeedCtorLink)
...
struct FNetAuctionItem
{
	...
	struct FString                                     HighestBidderName;                                        // 0x001C(0x000C) (NeedCtorLink)
	struct FString                                     SellerName;                                               // 0x0028(0x000C) (NeedCtorLink)
