...
bool UObject::STATIC_StrStartsWith(const struct FString& str, const struct FString& startStr)
{
...
struct FString UObject::STATIC_PadRight(const struct FString& str, int totalDigits, const struct FString& paddingChar)
{
...
struct FString UObject::STATIC_PadLeft(const struct FString& str, int totalDigits, const struct FString& paddingChar)
{
...
struct FString UObject::STATIC_PadString(const struct FString& str, int totalDigits, const struct FString& paddingChar)
{
...
void UObject::STATIC_slog(const struct FString& S)
{
...
void UObject::STATIC_EatStr(int Num, struct FString* Dest, struct FString* Source)
{
...
void UObject::STATIC_ReplaceText(const struct FString& Replace, const struct FString& With, struct FString* Text)
{
...
struct FString UObject::STATIC_GetItemName(const struct FString& FullName)
{
...
// struct FString                 char                           (Parm, NeedCtorLink)
// bool                           bFull                          (OptionalParm, Parm)

void UObject::STATIC_GetDatefromString(const struct FString& GWEchar, bool bFull, struct FString* in)
{
...
void UObject::GetReferencers(class UObject* Target, TArray<class UObject*>* Referencers)
{
...
TArray<struct FString> UObject::STATIC_GetPerObjectNames(const struct FString& ININame, const struct FString& ObjectClass, int MaxResults)
{
...
void UObject::STATIC_StaticClearConfig(const struct FString& PropName)
{
...
void UObject::STATIC_ResetConfig(const struct FString& PropName)
{
...
void UObject::ClearConfig(const struct FString& PropName)
{
...
bool UObject::SetPropertyText(const struct FString& PropName, const struct FString& PropValue)
{
...
struct FString UObject::GetPropertyText(const struct FString& PropName)
{
...
void UObject::GotoState(const struct FName& NewState, const struct FName& Label)
{
...
void UObject::STATIC_CombatLog(const struct FString& S, const struct FName& Tag)
{
...
void UObject::STATIC_CrashLog(const struct FString& S, const struct FName& Tag)
{
...
void UObject::STATIC_Log(const struct FString& S, const struct FName& Tag)
{
...
struct FBtrDouble UObject::STATIC_StringToBtrDouble(const struct FString& A)
{
...
struct FString UObject::STATIC_BtrDoubleGetToStr(const struct FBtrDouble& A)
{
...
struct FString UObject::STATIC_Eval(bool Condition, const struct FString& ResultIfTrue, const struct FString& ResultIfFalse)
{
...
int UObject::STATIC_StrCmp(const struct FString& S, const struct FString& t, int Count, bool bCaseSensitive)
{
...
int UObject::STATIC_KeyCode(const struct FString& S, int i)
{
...
int UObject::STATIC_Split(const struct FString& Src, const struct FString& Divider, TArray<struct FString>* Parts)
{
...
bool UObject::STATIC_Divide(const struct FString& Src, const struct FString& Divider, struct FString* LeftPart, struct FString* RightPart)
{
