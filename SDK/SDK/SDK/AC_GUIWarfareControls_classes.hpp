...
public:
	...
	unsigned long                                      bSetTimeOut : 1;                                          // 0x0408(0x0004)
	...
	unsigned long                                      UseOpenSound : 1;                                         // 0x0474(0x0004)
	unsigned long                                      UseCloseSound : 1;                                        // 0x0474(0x0004)
	unsigned long                                      CloseWeb : 1;                                             // 0x0474(0x0004)
	struct FString                                     strTitle;                                                 // 0x0478(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strOK;                                                    // 0x0484(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCancel;                                                // 0x0490(0x000C) (Localized, NeedCtorLink)
	unsigned long                                      bHandleEsc : 1;                                           // 0x049C(0x0004)
	struct FScriptDelegate                             __OnOK__Delegate;                                         // 0x04A0(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnCancel__Delegate;                                     // 0x04A8(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnTimeTick__Delegate;                                   // 0x04B0(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnTimeOut__Delegate;                                    // 0x04B8(0x000C) (NeedCtorLink)
	...
	void SetTitleCaption(const struct FString& S);
...
public:
	...
	struct FString                                     ExtraData_string;                                         // 0x04C8(0x000C) (NeedCtorLink)
	int                                                ExtraData_int;                                            // 0x04D4(0x0004)
	int                                                ExtraData_int2;                                           // 0x04D8(0x0004)
	int                                                ExtraData_int3;                                           // 0x04DC(0x0004)
	unsigned long                                      bStableText : 1;                                          // 0x04E0(0x0004)
	struct FString                                     Caption;                                                  // 0x04E4(0x000C) (NeedCtorLink)
	struct FString                                     Warning;                                                  // 0x04F0(0x000C) (NeedCtorLink)
	...
	bool STATIC_ShowWindow(class UGUIController* con, const struct FString& Title, const struct FString& Msg, const struct FString& Warn, const struct FString& btnOk, const struct FString& btnCancel);
	void RemoveSizeY(int halfsize, int halfy);
	void InsertSizeY(int halfsize, int halfy);
	bool Internal_OnPreDraw(class UCanvas* C);
	void SetButtonCaption(const struct FString& strOK, const struct FString& strCancel);
	void SetData(const struct FString& Title, const struct FString& Caption, const struct FString& Warning);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
{
public:
	struct FString                                     strClientDefaultTitle;                                    // 0x05D4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strClientTitle[0x50];                                     // 0x05E0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strClientDefine[0x50];                                    // 0x09A0(0x000C) (Localized, NeedCtorLink)
	...
	bool STATIC_ShowInfo(class UGUIController* con, int Code, const struct FString& arg0, const struct FString& arg1, const struct FString& arg2, const struct FString& arg3);
	bool STATIC_SetContentText(class UGUIController* con, int Code, const struct FString& arg0, const struct FString& arg1, const struct FString& arg2, const struct FString& arg3);
	bool SetContentText_Instance(int Code, const struct FString& arg0, const struct FString& arg1, const struct FString& arg2, const struct FString& arg3);
};
...
{
public:
	unsigned long                                      bChangeText : 1;                                          // 0x04C0(0x0004)
	...
	bool Internal_OnKeyEvent(float Delta, unsigned char* key, unsigned char* Action);
	bool Internal_OnPreDraw(class UCanvas* C);
	bool STATIC_ShowWindow(class UGUIController* con, const struct FString& Title, const struct FString& Msg, const struct FString& btnOk);
	void SetData(const struct FString& Title, int titlepadding, const struct FString& Msg, const struct FString& btnOk);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
{
public:
	struct FString                                     strClientDefaultTitle;                                    // 0x04D8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strClientDefine[0x12C];                                   // 0x04E4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strClientTitle[0x12C];                                    // 0x12F4(0x000C) (Localized, NeedCtorLink)
	...
	bool STATIC_ShowInfo(class UGUIController* con, int Code, const struct FString& arg0, const struct FString& arg1, const struct FString& arg2);
	struct FString STATIC_GetClientString(int Code);
	struct FString STATIC_GetFormatString(int Code, const struct FString& arg0, const struct FString& arg1, const struct FString& arg2, const struct FString& arg3, const struct FString& arg4, const struct FString& arg5, const struct FString& arg6, const struct FString& arg7, const struct FString& arg8);
	void SetContentText_Instance(int Code, const struct FString& arg0, const struct FString& arg1, const struct FString& arg2, const struct FString& arg3);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
{
public:
	unsigned long                                      bHudMode : 1;                                             // 0x0368(0x0004)
	unsigned long                                      bLimitDrawSize : 1;                                       // 0x0368(0x0004)
	...
	unsigned long                                      bActiveCursor : 1;                                        // 0x03D4(0x0004)
	...
	TArray<float>                                      CacheTextWidth;                                           // 0x0424(0x000C) (NeedCtorLink)
	float                                              CacheTextHeight;                                          // 0x0430(0x0004)
	struct FString                                     textStrVis;                                               // 0x0434(0x000C) (NeedCtorLink)
	struct FString                                     BackupTextStr;                                            // 0x0440(0x000C) (NeedCtorLink)
	int                                                EndVis;                                                   // 0x044C(0x0004)
	unsigned long                                      bClickAllSelect : 1;                                      // 0x0450(0x0004)
	unsigned long                                      bSelectionMode : 1;                                       // 0x0450(0x0004)
	unsigned long                                      bMouseFirstPress : 1;                                     // 0x0450(0x0004)
	unsigned long                                      bMousePressed : 1;                                        // 0x0450(0x0004)
	unsigned long                                      bCursorBlink : 1;                                         // 0x0450(0x0004)
	float                                              BlinkTimer;                                               // 0x0454(0x0004)
	float                                              OldBlinkTimer;                                            // 0x0458(0x0004)
	unsigned long                                      useCaps : 1;                                              // 0x045C(0x0004)
	struct UBTEditBoxHK_FSelectionArea                 SelArea;                                                  // 0x0460(0x0008)
	struct FScriptDelegate                             __OnChat__Delegate;                                       // 0x0468(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnInputTab__Delegate;                                   // 0x0470(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnInputSpace__Delegate;                                 // 0x0478(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnFunctionKey__Delegate;                                // 0x0480(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnMaxTextStrNum__Delegate;                              // 0x0488(0x000C) (NeedCtorLink)
	...
	bool CheckPastedTextCondition(const struct FString& Text);
	bool CheckKeyInputCondition(const struct FString& st);
	...
	bool OnFunctionKey(class UGUIComponent* Sender, unsigned char FunctionKey, const struct FString& Text);
	void OnInputSpace(class UGUIComponent* Sender, const struct FString& Text);
	void OnInputTab(class UGUIComponent* Sender, const struct FString& Text);
	bool OnChat(class UGUIComponent* Sender, const struct FString& Text);
};
...
public:
	...
	struct FImage                                      Inven_QuiSlot1_Btn_n;                                     // 0x4914(0x0020)
	struct FImage                                      Inven_QuiSlot1_Btn_on;                                    // 0x4934(0x0020)
	struct FImage                                      Inven_QuiSlot1_Btn_cli;                                   // 0x4954(0x0020)
	struct FImage                                      Inven_QuiSlot1_Btn_Disable;                               // 0x4974(0x0020)
	struct FImage                                      Inven_QuiSlot1_Btn_Focus;                                 // 0x4994(0x0020)
	struct FImage                                      Inven_QuiSlot2_Btn_n;                                     // 0x49B4(0x0020)
	struct FImage                                      Inven_QuiSlot2_Btn_on;                                    // 0x49D4(0x0020)
	struct FImage                                      Inven_QuiSlot2_Btn_cli;                                   // 0x49F4(0x0020)
	struct FImage                                      Inven_QuiSlot2_Btn_Disable;                               // 0x4A14(0x0020)
	struct FImage                                      Inven_QuiSlot2_Btn_Focus;                                 // 0x4A34(0x0020)
	struct FImage                                      Inven_QuiSlot3_Btn_n;                                     // 0x4A54(0x0020)
	struct FImage                                      Inven_QuiSlot3_Btn_on;                                    // 0x4A74(0x0020)
	struct FImage                                      Inven_QuiSlot3_Btn_cli;                                   // 0x4A94(0x0020)
	struct FImage                                      Inven_QuiSlot3_Btn_Disable;                               // 0x4AB4(0x0020)
	struct FImage                                      Inven_QuiSlot3_Btn_Focus;                                 // 0x4AD4(0x0020)
	struct FImage                                      Inven_QuiSlot4_Btn_n;                                     // 0x4AF4(0x0020)
	struct FImage                                      Inven_QuiSlot4_Btn_on;                                    // 0x4B14(0x0020)
	struct FImage                                      Inven_QuiSlot4_Btn_cli;                                   // 0x4B34(0x0020)
	struct FImage                                      Inven_QuiSlot4_Btn_Disable;                               // 0x4B54(0x0020)
	struct FImage                                      Inven_QuiSlot4_Btn_Focus;                                 // 0x4B74(0x0020)
	...
	struct FImage                                      WaitRoom_List_n;                                          // 0x5C54(0x0020)
	struct FImage                                      WaitRoom_List_On;                                         // 0x5C74(0x0020)
	struct FImage                                      WaitRoom_List_cli;                                        // 0x5C94(0x0020)
	struct FImage                                      WaitRoom_List_Me;                                         // 0x5CB4(0x0020)
	struct FImage                                      WaitRoom_List_Focus;                                      // 0x5CD4(0x0020)
	struct FImage                                      WaitRoom_Team_AF_n;                                       // 0x5CF4(0x0020)
	struct FImage                                      WaitRoom_Team_AF_On;                                      // 0x5D14(0x0020)
	struct FImage                                      WaitRoom_Team_AF_Cli;                                     // 0x5D34(0x0020)
	struct FImage                                      WaitRoom_Team_RSA_n;                                      // 0x5D54(0x0020)
	struct FImage                                      WaitRoom_Team_RSA_On;                                     // 0x5D74(0x0020)
	struct FImage                                      WaitRoom_Team_RSA_Cli;                                    // 0x5D94(0x0020)
	struct FImage                                      WaitRoom_StartGame_n;                                     // 0x5DB4(0x0020)
	struct FImage                                      WaitRoom_StartGame_on;                                    // 0x5DD4(0x0020)
	struct FImage                                      WaitRoom_StartGame_cli;                                   // 0x5DF4(0x0020)
	struct FImage                                      WaitRoom_RoomInfo_n;                                      // 0x5E14(0x0020)
	struct FImage                                      WaitRoom_RoomInfo_on;                                     // 0x5E34(0x0020)
	struct FImage                                      WaitRoom_RoomInfo_cli;                                    // 0x5E54(0x0020)
	struct FImage                                      WaitRoom_RoomInof_SubBG;                                  // 0x5E74(0x0020)
	struct FImage                                      ImageList_On;                                             // 0x5E94(0x0020)
	struct FImage                                      GameResult_Win_AF_BG;                                     // 0x5EB4(0x0020)
	struct FImage                                      GameResult_Lose_AF_BG;                                    // 0x5ED4(0x0020)
	struct FImage                                      GameResult_Win_RSA_BG;                                    // 0x5EF4(0x0020)
	struct FImage                                      GameResult_Lose_RSA_BG;                                   // 0x5F14(0x0020)
	struct FImage                                      GameResult_Win_AF_Mark;                                   // 0x5F34(0x0020)
	struct FImage                                      GameResult_Win_RSA_Mark;                                  // 0x5F54(0x0020)
	struct FImage                                      GameResult_MyInfo_BG;                                     // 0x5F74(0x0020)
	struct FImage                                      GameResult_AlienMode_Mark;                                // 0x5F94(0x0020)
	struct FImage                                      GameResult_AlienMode_List_BG;                             // 0x5FB4(0x0020)
	struct FImage                                      GameResult_Deco_BG;                                       // 0x5FD4(0x0020)
	struct FImage                                      GameResult_Top_BG;                                        // 0x5FF4(0x0020)
	struct FImage                                      GameResult_Private_BG;                                    // 0x6014(0x0020)
	struct FImage                                      GameResult_Private_Mark;                                  // 0x6034(0x0020)
	struct FImage                                      GameResult_Close_Btn_n;                                   // 0x6054(0x0020)
	struct FImage                                      GameResult_Close_Btn_On;                                  // 0x6074(0x0020)
	struct FImage                                      GameResult_Close_Btn_Cli;                                 // 0x6094(0x0020)
	struct FImage                                      GameResult_Close_Btn_Dis;                                 // 0x60B4(0x0020)
	struct FImage                                      Option_Panel_BG;                                          // 0x60D4(0x0020)
	struct FImage                                      Option_Init_Btn_n;                                        // 0x60F4(0x0020)
	struct FImage                                      Option_Init_Btn_on;                                       // 0x6114(0x0020)
	struct FImage                                      Option_Init_Btn_cli;                                      // 0x6134(0x0020)
	struct FImage                                      Option_Init_Btn_block;                                    // 0x6154(0x0020)
	struct FImage                                      MakeRoom_Win_BG;                                          // 0x6174(0x0020)
	struct FImage                                      MakeRoom_Input_Text_BG;                                   // 0x6194(0x0020)
	struct FImage                                      scrol_new_up_n;                                           // 0x61B4(0x0020)
	struct FImage                                      scrol_new_up_on;                                          // 0x61D4(0x0020)
	struct FImage                                      scrol_new_up_cli;                                         // 0x61F4(0x0020)
	struct FImage                                      scrol_new_up_dis;                                         // 0x6214(0x0020)
	struct FImage                                      scrol_new_dn_n;                                           // 0x6234(0x0020)
	struct FImage                                      scrol_new_dn_on;                                          // 0x6254(0x0020)
	struct FImage                                      scrol_new_dn_cli;                                         // 0x6274(0x0020)
	struct FImage                                      scrol_new_dn_dis;                                         // 0x6294(0x0020)
	struct FImage                                      scrol_new_grip_n;                                         // 0x62B4(0x0020)
	struct FImage                                      scrol_new_grip_on;                                        // 0x62D4(0x0020)
	struct FImage                                      scrol_new_grip_cli;                                       // 0x62F4(0x0020)
	struct FImage                                      scrol_new_grip_dis;                                       // 0x6314(0x0020)
	struct FImage                                      Scrol_New_BG;                                             // 0x6334(0x0020)
	struct FImage                                      slider_new_back;                                          // 0x6354(0x0020)
	struct FImage                                      slider_new_grip_n;                                        // 0x6374(0x0020)
	struct FImage                                      slider_new_grip_on;                                       // 0x6394(0x0020)
	struct FImage                                      slider_new_grip_cli;                                      // 0x63B4(0x0020)
	struct FImage                                      slider_new_grip_dis;                                      // 0x63D4(0x0020)
	struct FImage                                      Button_Graphic_Opt_all_1_n;                               // 0x63F4(0x0020)
	struct FImage                                      Button_Graphic_Opt_all_1_on;                              // 0x6414(0x0020)
	struct FImage                                      Button_Graphic_Opt_all_1_cli;                             // 0x6434(0x0020)
	struct FImage                                      Button_Graphic_Opt_all_1_dis;                             // 0x6454(0x0020)
	struct FImage                                      Button_Graphic_Opt_all_2_n;                               // 0x6474(0x0020)
	struct FImage                                      Button_Graphic_Opt_all_2_on;                              // 0x6494(0x0020)
	struct FImage                                      Button_Graphic_Opt_all_2_cli;                             // 0x64B4(0x0020)
	struct FImage                                      Button_Graphic_Opt_all_2_dis;                             // 0x64D4(0x0020)
	struct FImage                                      Button_Graphic_Opt_all_3_n;                               // 0x64F4(0x0020)
	struct FImage                                      Button_Graphic_Opt_all_3_on;                              // 0x6514(0x0020)
	struct FImage                                      Button_Graphic_Opt_all_3_cli;                             // 0x6534(0x0020)
	struct FImage                                      Button_Graphic_Opt_all_3_dis;                             // 0x6554(0x0020)
	struct FImage                                      Button_Control_Opt_all_n;                                 // 0x6574(0x0020)
	struct FImage                                      Button_Control_Opt_all_on;                                // 0x6594(0x0020)
	struct FImage                                      Button_Control_Opt_all_cli;                               // 0x65B4(0x0020)
	struct FImage                                      Button_Control_Opt_all_dis;                               // 0x65D4(0x0020)
	struct FImage                                      List_New_Opt_backnlist;                                   // 0x65F4(0x0020)
	struct FImage                                      List_New_Opt_n;                                           // 0x6614(0x0020)
	struct FImage                                      List_New_Opt_on;                                          // 0x6634(0x0020)
	struct FImage                                      List_New_Opt_cli;                                         // 0x6654(0x0020)
	struct FImage                                      List_New_Opt_dis;                                         // 0x6674(0x0020)
	struct FImage                                      Combo_New_Butt_n;                                         // 0x6694(0x0020)
	struct FImage                                      Combo_New_Butt_on;                                        // 0x66B4(0x0020)
	struct FImage                                      Combo_New_Butt_cli;                                       // 0x66D4(0x0020)
	struct FImage                                      Combo_New_Butt_dis;                                       // 0x66F4(0x0020)
	struct FImage                                      Combo_New_Expand;                                         // 0x6714(0x0020)
	struct FImage                                      Combo_New_Expand_on;                                      // 0x6734(0x0020)
	struct FImage                                      Combo_New_Back;                                           // 0x6754(0x0020)
	struct FImage                                      Combo_New_Back_Blur;                                      // 0x6774(0x0020)
	struct FImage                                      ItemPopup_Bgdeco;                                         // 0x6794(0x0020)
	struct FImage                                      ItemPopup_ItemInfo_back;                                  // 0x67B4(0x0020)
	struct FImage                                      ItemRemodel_bgdeco;                                       // 0x67D4(0x0020)
	struct FImage                                      ItemRemodel_Btn_Rollback_n;                               // 0x67F4(0x0020)
	struct FImage                                      ItemRemodel_Btn_Rollback_cli;                             // 0x6814(0x0020)
	struct FImage                                      ItemRemodel_Btn_Rollback_on;                              // 0x6834(0x0020)
	struct FImage                                      ItemRemodel_Btn_Rollback_dis;                             // 0x6854(0x0020)
	struct FImage                                      ItemRemodel_List_BG_n;                                    // 0x6874(0x0020)
	struct FImage                                      ItemRemodel_List_BG_on;                                   // 0x6894(0x0020)
	struct FImage                                      ItemRemodel_List_BG_cli;                                  // 0x68B4(0x0020)
	struct FImage                                      ItemRemodel_List_BG_Focus;                                // 0x68D4(0x0020)
	struct FImage                                      ItemRemodel_Buy_bgdeco;                                   // 0x68F4(0x0020)
	struct FImage                                      QuickEnterRoom_Win_BG;                                    // 0x6914(0x0020)
	struct FImage                                      Icon_ServeMode[0x7];                                      // 0x6934(0x0020)
	struct FImage                                      img_Tilte;                                                // 0x6A14(0x0020)
	struct FImage                                      All_Map_Img;                                              // 0x6A34(0x0020)
	struct FImage                                      newMap_Icon;                                              // 0x6A54(0x0020)
	struct FImage                                      BillingPopup_Deco_Img;                                    // 0x6A74(0x0020)
	struct FImage                                      Expired_Deco_Img;                                         // 0x6A94(0x0020)
	struct FImage                                      Coupon_Bg_Img;                                            // 0x6AB4(0x0020)
	struct FImage                                      Coupon_oversquare_Img;                                    // 0x6AD4(0x0020)
	struct FImage                                      GameResult_Defence_BG;                                    // 0x6AF4(0x0020)
	struct FImage                                      GameResult_Defence_Mark;                                  // 0x6B14(0x0020)
	struct FImage                                      WaitRoom_Defence_Team;                                    // 0x6B34(0x0020)
	struct FImage                                      WaitRoom_Defence_Reward;                                  // 0x6B54(0x0020)
	struct FImage                                      Popup_Defence_Reward;                                     // 0x6B74(0x0020)
	struct FImage                                      SkillTypeRibbon[0x4];                                     // 0x6B94(0x0020)
	struct FImage                                      LuckyShopBG_Img;                                          // 0x6C14(0x0020)
	struct FImage                                      LuckyShop_CapsuleStoreBG_Img;                             // 0x6C34(0x0020)
	struct FImage                                      LuckyShop_CapsuleInventoryBG_Img;                         // 0x6C54(0x0020)
	struct FImage                                      LuckyShop_BlackBoxBG_Img;                                 // 0x6C74(0x0020)
	struct FImage                                      CapsuleList_n;                                            // 0x6C94(0x0020)
	struct FImage                                      CapsuleList_on;                                           // 0x6CB4(0x0020)
	struct FImage                                      CapsuleList_click;                                        // 0x6CD4(0x0020)
	struct FImage                                      CapsuleList_diable;                                       // 0x6CF4(0x0020)
	struct FImage                                      CapsuleList_new;                                          // 0x6D14(0x0020)
	struct FImage                                      LuckyShop_PageLeft_n;                                     // 0x6D34(0x0020)
	struct FImage                                      LuckyShop_PageLeft_on;                                    // 0x6D54(0x0020)
	struct FImage                                      LuckyShop_PageLeft_click;                                 // 0x6D74(0x0020)
	struct FImage                                      LuckyShop_PageLeft_diable;                                // 0x6D94(0x0020)
	struct FImage                                      LuckyShop_PageRight_n;                                    // 0x6DB4(0x0020)
	struct FImage                                      LuckyShop_PageRight_on;                                   // 0x6DD4(0x0020)
	struct FImage                                      LuckyShop_PageRight_click;                                // 0x6DF4(0x0020)
	struct FImage                                      LuckyShop_PageRight_diable;                               // 0x6E14(0x0020)
	struct FImage                                      LuckyShop_PageLeft_Big_n;                                 // 0x6E34(0x0020)
	struct FImage                                      LuckyShop_PageLeft_Big_on;                                // 0x6E54(0x0020)
	struct FImage                                      LuckyShop_PageLeft_Big_click;                             // 0x6E74(0x0020)
	struct FImage                                      LuckyShop_PageLeft_Big_diable;                            // 0x6E94(0x0020)
	struct FImage                                      LuckyShop_PageRight_Big_n;                                // 0x6EB4(0x0020)
	struct FImage                                      LuckyShop_PageRight_Big_on;                               // 0x6ED4(0x0020)
	struct FImage                                      LuckyShop_PageRight_Big_click;                            // 0x6EF4(0x0020)
	struct FImage                                      LuckyShop_PageRight_Big_diable;                           // 0x6F14(0x0020)
	struct FImage                                      LuckyShop_ItemInfoGauge_Back;                             // 0x6F34(0x0020)
	struct FImage                                      LuckyShop_LeftArrow_n;                                    // 0x6F54(0x0020)
	struct FImage                                      LuckyShop_LeftArrow_on;                                   // 0x6F74(0x0020)
	struct FImage                                      LuckyShop_LeftArrow_click;                                // 0x6F94(0x0020)
	struct FImage                                      LuckyShop_LeftArrow_diable;                               // 0x6FB4(0x0020)
	struct FImage                                      LuckyShop_RightArrow_n;                                   // 0x6FD4(0x0020)
	struct FImage                                      LuckyShop_RightArrow_on;                                  // 0x6FF4(0x0020)
	struct FImage                                      LuckyShop_RightArrow_click;                               // 0x7014(0x0020)
	struct FImage                                      LuckyShop_RightArrow_diable;                              // 0x7034(0x0020)
	struct FImage                                      Img_BlackBoxKey;                                          // 0x7054(0x0020)
	struct FImage                                      Img_Item_RW_buycount;                                     // 0x7074(0x0020)
	struct FImage                                      Img_Item_RW_coupon;                                       // 0x7094(0x0020)
	struct FImage                                      Img_RW_AlreadyGet;                                        // 0x70B4(0x0020)
	struct FImage                                      Img_Quest_Slot_Reward_MouseOver;                          // 0x70D4(0x0020)
	struct FImage                                      Img_BGDeco_Popup_MouseOver;                               // 0x70F4(0x0020)
	struct FImage                                      Img_BGDeco_Capsule_Open;                                  // 0x7114(0x0020)
	struct FImage                                      Img_BGDeco_Capsule_Get;                                   // 0x7134(0x0020)
	struct FImage                                      Img_BGDeco_Capsule_Get_RemainBG;                          // 0x7154(0x0020)
	struct FImage                                      Img_BGDeco_Capsule_Reward;                                // 0x7174(0x0020)
	struct FImage                                      Img_BGDeco_Effect_BestItemGet;                            // 0x7194(0x0020)
	struct FImage                                      ModifyBtn_n;                                              // 0x71B4(0x0020)
	struct FImage                                      ModifyBtn_on;                                             // 0x71D4(0x0020)
	struct FImage                                      ModifyBtn_cli;                                            // 0x71F4(0x0020)
	struct FImage                                      ModifyBtn_Disable;                                        // 0x7214(0x0020)
	struct FImage                                      ModifyBtn_Focus;                                          // 0x7234(0x0020)
...
public:
	...
	bool Internal_OnKeyEvent(float Delta, unsigned char* key, unsigned char* Action);
	bool Internal_OnPreDraw(class UCanvas* C);
	void STATIC_ShowWindow(class UGUIController* con, const struct FString& Title, const struct FString& Msg, const struct FString& btnOk, const struct FString& btnCancel);
	void SetData(const struct FString& Title, int titlepadding, const struct FString& Msg, const struct FString& btnOk, const struct FString& btnCancel);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
public:
	struct FString                                     strClientDefaultTitle;                                    // 0x04D8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strClientTitle[0x32];                                     // 0x04E4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strClientDefine[0x32];                                    // 0x073C(0x000C) (Localized, NeedCtorLink)
...
{
public:
	unsigned long                                      bProcess : 1;                                             // 0x002C(0x0004)
	...
	class UBTWindowHK* Pop(TEnumAsByte<EPage> destpage);
	class UBTWindowHK* back(TEnumAsByte<EPage> destpage);
	class UBTWindowHK* Last(TEnumAsByte<EPage> destpage);
	bool RemoveWindowOnStack(TEnumAsByte<EPage> destpage, const struct FName& WindowName, bool bAll);
	class UBTWindowHK* FindWindowOnStack(TEnumAsByte<EPage> destpage, const struct FName& WindowName);
	int ListLen(TEnumAsByte<EPage> destpage);
	void Push(TEnumAsByte<EPage> destpage, class UBTWindowHK* N, bool bUseInsert, int insertPos, bool bUseInsertAtName, const struct FName& nobject);
	class UBTWindowHK* CreateAndPush(TEnumAsByte<EPage> destpage, const struct FString& WindowName, bool bUseInsert, int insertPos, bool bUseInsertAtName, const struct FName& nobject);
	void CloseAndClear();
...
{
public:
	struct FString                                     strErrorTitle[0x2];                                       // 0x04D8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strErrorDefine[0x4B0];                                    // 0x04F0(0x000C) (Localized, NeedCtorLink)
	...
	void STATIC_ShowErrorMsg(class UGUIController* con, const struct FString& ErrorMsg, unsigned char titleID);
	void STATIC_ShowError(class UGUIController* con, int ErrorCode, unsigned char titleID);
	struct FString STATIC_GetFormatString(int Code, const struct FString& arg0, const struct FString& arg1, const struct FString& arg2);
	bool STATIC_ExceptionCondtion(int ErrorCode);
	void SetContentText_Instance(int Title, int Code, const struct FString& arg0, const struct FString& arg1, const struct FString& arg2, const struct FString& arg3);
};
...
{
public:
	struct FString                                     strClose;                                                 // 0x04C0(0x000C) (Localized, NeedCtorLink)
	...
	void OpenWeb(const struct FString& openURL, int Left, int Top, int Right, int Bottom);
	void STATIC_OpenWebWindow(class UGUIController* Controller, const struct FString& openURL, int Left, int Top, int Right, int Bottom, const struct FString& Title);
	bool ButtonOK_OnClick(class UGUIComponent* Sender);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
public:
	...
	unsigned long                                      bSelect : 1;                                              // 0x0334(0x0004)
...
public:
	...
	unsigned long                                      bShowChatState : 1;                                       // 0x0348(0x0004)
	unsigned long                                      bShowAni : 1;                                             // 0x0348(0x0004)
	TArray<struct FFloatBox>                           fbButtonChatStateArray;                                   // 0x034C(0x000C) (NeedCtorLink)
	TArray<struct FFloatBox>                           fbSnapShotButtonChatStateArray;                           // 0x0358(0x000C) (NeedCtorLink)
	TArray<class UBTOwnerDrawCaptionButtonHK*>         ButtonChatStateArray;                                     // 0x0364(0x000C) (NeedCtorLink)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonChatState;                                          // 0x0370(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         BackgroundImage[0x2];                                     // 0x0374(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UTabControlMocker*                           TabControl;                                               // 0x037C(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	TArray<class UBTOwnerDrawCaptionButtonHK*>         ButtonChat;                                               // 0x0380(0x000C) (NeedCtorLink)
	TArray<class UBTAutoScrollListHK*>                 ASLChat;                                                  // 0x038C(0x000C) (NeedCtorLink)
	class UBTChatEditBoxHK*                            InputBox;                                                 // 0x0398(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strChatState[0x7];                                        // 0x039C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strAll;                                                   // 0x03F0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strWhisper;                                               // 0x03FC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strClan;                                                  // 0x0408(0x000C) (Localized, NeedCtorLink)
	TArray<struct FColoredChatText>                    ccText;                                                   // 0x0414(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __ChangeTab_OnClick__Delegate;                            // 0x0420(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnChageChatMode__Delegate;                              // 0x0428(0x000C) (NeedCtorLink)
	...
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void SetEditText(const struct FString& Chat);
	void AddChatHistory(int Panel, const struct FString& Chat, const struct FColor& tcolor);
	void AddChatHistoryNoColor(int Panel, const struct FString& Chat);
...
public:
	...
	bool Internal_OnKeyEvent(float Delta, unsigned char* key, unsigned char* Action);
	bool Internal_OnPreDraw(class UCanvas* C);
	void STATIC_ShowWindow(class UGUIController* con, const struct FString& Msg);
	void UpdateRoomLobbyWindow();
	void UpdateDefaultWindow();
	void SetData(const struct FString& Msg);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
{
public:
	struct FString                                     strClientDefine[0xF];                                     // 0x04D8(0x000C) (Localized, NeedCtorLink)
	...
	bool STATIC_ShowState(class UGUIController* con, int Code, const struct FString& arg0, const struct FString& arg1, const struct FString& arg2);
	struct FString STATIC_GetFormatString(int Code, const struct FString& arg0, const struct FString& arg1, const struct FString& arg2);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
public:
	...
	struct FString                                     strShop;                                                  // 0x035C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strInven;                                                 // 0x0368(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLucky;                                                 // 0x0374(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonList[0x9];                                          // 0x0380(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strToolTip[0x9];                                          // 0x03A4(0x000C) (Localized, NeedCtorLink)
	class UBTRODecorateStringHK*                       btToolTip;                                                // 0x0410(0x0004)
	struct FScriptDelegate                             __HeaderButton_OnClick__Delegate;                         // 0x0414(0x000C) (NeedCtorLink)
	...
	void InitButton(int ButtonID, const struct FString& buttonName, const struct FImage& buttonImage0, const struct FImage& buttonImage1, const struct FImage& buttonImage2, const struct FImage& buttonImage3, const struct FImage& buttonImage4, class UBTOwnerDrawCaptionButtonHK** targetButton);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
...
public:
	...
	unsigned long                                      bAuctionList : 1;                                         // 0x0338(0x0004)
	struct FString                                     strRRMsg[0x8];                                            // 0x033C(0x000C) (Localized, NeedCtorLink)
...
{
public:
	struct FString                                     strLabel[0x4];                                            // 0x04C0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strModeTitle[0x2];                                        // 0x04F0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strModeContent[0x2];                                      // 0x0508(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     SaveData;                                                 // 0x0574(0x000C) (NeedCtorLink)
	struct FString                                     SaveInviterName;                                          // 0x0580(0x000C) (NeedCtorLink)
	...
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void SetClanJoin(const struct FString& ClanName, const struct FString& Inviter);
	void SetClanInvite(const struct FString& UserName);
};


// Class GUIWarfareControls.BTWindowCreateClanHK
// 0x01E8 (0x06A8 - 0x04C0)
class UBTWindowCreateClanHK : public UBTWindowHK
{
public:
	struct FString                                     strLabel[0xB];                                            // 0x04C0(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbLabel[0xB];                                             // 0x0544(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         Label[0xB];                                               // 0x05F4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbEdit[0x3];                                              // 0x0620(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         Edit[0x3];                                                // 0x0650(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strButtonOverlapCheck;                                    // 0x065C(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbButtonOverlapCheck;                                     // 0x0668(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonOverlapCheck;                                       // 0x0678(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTEditBoxHK*                                ClanName;                                                 // 0x067C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTMultiLineEditBoxHK*                       ClanIntroduction;                                         // 0x0680(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTEditBoxHK*                                ClanKeyword;                                              // 0x0684(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTComboBoxHK*                               ClanLocation;                                             // 0x0688(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbClanLocation;                                           // 0x068C(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTLabelLocationHK*                          sampleLocation;                                           // 0x069C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      bCheckDupName : 1;                                        // 0x06A0(0x0004)
	unsigned long                                      bCheckDupID : 1;                                          // 0x06A0(0x0004)
	class UBTTcpLink_Channel*                          TcpChannel;                                               // 0x06A4(0x0004)
...
{
public:
	TEnumAsByte<EDrawType>                             FontDrawType;                                             // 0x0310(0x0001)
	TEnumAsByte<EDrawType>                             ExtraDataFontDrawType;                                    // 0x0311(0x0001)
	...
	unsigned long                                      bShowExtraData : 1;                                       // 0x034C(0x0004)
	...
	unsigned long                                      bHideBtn : 1;                                             // 0x0398(0x0004)
...
{
public:
	struct FString                                     strLabel;                                                 // 0x04C0(0x000C) (Localized, NeedCtorLink)
...
{
public:
	unsigned long                                      bReceiveLock : 1;                                         // 0x04C0(0x0004)
	int                                                CurrentPage;                                              // 0x04C4(0x0004)
	int                                                MinPage;                                                  // 0x04C8(0x0004)
	int                                                MaxPage;                                                  // 0x04CC(0x0004)
	struct FString                                     searchtext;                                               // 0x04D0(0x000C) (NeedCtorLink)
	...
	struct FString                                     strCreateDate[0x2];                                       // 0x04EC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRound;                                                 // 0x0504(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRank;                                                  // 0x0510(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonCafe;                                            // 0x051C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonInfo;                                            // 0x0528(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strClanSearchType[0x4];                                   // 0x0534(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strLabel[0x3];                                            // 0x058C(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strButtonSearch;                                          // 0x0618(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strButtonTop[0x7];                                        // 0x06C4(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strRadioOption[0x2];                                      // 0x0738(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strClanLocation;                                          // 0x07A4(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	unsigned long                                      bActiveCursor : 1;                                        // 0x0320(0x0004)
	unsigned long                                      bSelect : 1;                                              // 0x0320(0x0004)
	unsigned long                                      bSelectHighlight : 1;                                     // 0x0320(0x0004)
	unsigned long                                      bDisable : 1;                                             // 0x0320(0x0004)
	...
	TEnumAsByte<EDrawType>                             CaptionDrawType;                                          // 0x0384(0x0001) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0385(0x0003) MISSED OFFSET
	struct FString                                     Caption;                                                  // 0x0388(0x000C) (NeedCtorLink)
	...
	struct FString                                     strToolTip;                                               // 0x0498(0x000C) (NeedCtorLink)
	unsigned long                                      isShowToolTip : 1;                                        // 0x04A4(0x0004)
	float                                              CursorUSize;                                              // 0x04A8(0x0004)
	float                                              CursorVSize;                                              // 0x04AC(0x0004)
	unsigned long                                      isFlicker : 1;                                            // 0x04B0(0x0004)
	struct FBtrDouble                                  dbUniqID;                                                 // 0x04B4(0x0008)
	unsigned long                                      CaptionScroll : 1;                                        // 0x04BC(0x0004)
	class UBTScrollString*                             scrollString;                                             // 0x04C0(0x0004)
	struct FScriptDelegate                             __OnTimeOut__Delegate;                                    // 0x04C4(0x000C) (NeedCtorLink)
	...
	void SetFontDrawType(TEnumAsByte<EDrawType> dt);
	void SetFontSizeAll(int Size);
...
public:
	...
	unsigned long                                      bUseFontScaleValue : 1;                                   // 0x030C(0x0004)
	...
	TEnumAsByte<EDrawType>                             CaptionDrawType;                                          // 0x0374(0x0001) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0375(0x0003) MISSED OFFSET
	struct FString                                     Caption;                                                  // 0x0378(0x000C) (NeedCtorLink)
	struct FImage                                      BackgroundImage;                                          // 0x0384(0x0020)
	unsigned long                                      bDrawToolTips : 1;                                        // 0x03A4(0x0004) (Edit)
	...
	unsigned long                                      bCullingText : 1;                                         // 0x03B8(0x0004)
	unsigned long                                      cullRight : 1;                                            // 0x03B8(0x0004)
	...
	void SetFontSizeAll(int Size);
	void SetDefaultFontColor();
	void SetToolTipsText(const struct FString& t);
};
...
public:
	...
	struct FString                                     strLabel[0x2];                                            // 0x04E4(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strExpBar;                                                // 0x066C(0x000C) (Localized, NeedCtorLink)
...
{
public:
	struct FString                                     strOK2;                                                   // 0x04C0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabel;                                                 // 0x04CC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelHelp[0x3];                                        // 0x04D8(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strButtonCreateClan;                                      // 0x056C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonFindClan;                                        // 0x0578(0x000C) (Localized, NeedCtorLink)
...
{
public:
	unsigned long                                      bActiveCursor : 1;                                        // 0x0368(0x0004)
	...
	TArray<int>                                        sumLineTextCount;                                         // 0x0418(0x000C) (NeedCtorLink)
	TArray<int>                                        sumLineW;                                                 // 0x0424(0x000C) (NeedCtorLink)
	TArray<int>                                        sumLineHT;                                                // 0x0430(0x000C) (NeedCtorLink)
	TArray<struct FString>                             textStrVis;                                               // 0x043C(0x000C) (NeedCtorLink)
	TArray<int>                                        bEndofNewLineCharacter;                                   // 0x0448(0x000C) (NeedCtorLink)
	unsigned long                                      bUndo : 1;                                                // 0x0454(0x0004)
	int                                                UndoCaretPos;                                             // 0x0458(0x0004)
	struct FString                                     UndoTextStr;                                              // 0x045C(0x000C) (NeedCtorLink)
	int                                                VisibleLineCount;                                         // 0x0468(0x0004)
	unsigned long                                      bSelectionMode : 1;                                       // 0x046C(0x0004)
	unsigned long                                      bMouseFirstPress : 1;                                     // 0x046C(0x0004)
	unsigned long                                      bMousePressed : 1;                                        // 0x046C(0x0004)
	struct UBTMultiLineEditBoxHK_FSelectionArea        SelArea;                                                  // 0x0470(0x0008)
	struct FScriptDelegate                             __OnChat__Delegate;                                       // 0x0478(0x000C) (NeedCtorLink)
	...
	void SaveUndo();
	void OnChat(const struct FString& Text);
	void SetFontSizeAll(int Size);
	void SetSadowColor(unsigned char _R, unsigned char _G, unsigned char _B, unsigned char _A);
	void SetFontColor(unsigned char _R, unsigned char _G, unsigned char _B, unsigned char _A);
	void SetDefaultFontColor();
};
...
{
public:
	class UBTOwnerDrawImageHK*                         LabelTop[0x6];                                            // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbButtonTop[0x6];                                         // 0x0350(0x0010)
	struct FString                                     strButtonTop[0x6];                                        // 0x03B0(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonTop[0x6];                                           // 0x03F8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTACLTeamMemberListHK*                      ACLList;                                                  // 0x0410(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTCMTeamMemberListHK*                       CMList;                                                   // 0x0414(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FScriptDelegate                             __OnPopup__Delegate;                                      // 0x0418(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnNonSelectPopup__Delegate;                             // 0x0420(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupCheck__Delegate;                                 // 0x0428(0x000C) (NeedCtorLink)
...
{
public:
	unsigned long                                      bCustomSpliter : 1;                                       // 0x002C(0x0004) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	unsigned long                                      bSpliter : 1;                                             // 0x002C(0x0004) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	...
	TArray<struct FACLData>                            DataPerColumn;                                            // 0x0034(0x000C) (Edit, NeedCtorLink)
...
public:
	...
	TArray<class UBTOwnerDrawCaptionButtonHK*>         ButtonMsg;                                                // 0x0348(0x000C) (NeedCtorLink)
	TArray<class UBTAutoColumnListHK*>                 ACLMsg;                                                   // 0x0354(0x000C) (NeedCtorLink)
	TArray<class UBTContextMenuHK*>                    CMMsg;                                                    // 0x0360(0x000C) (NeedCtorLink)
	class UwMatchMaker*                                MM;                                                       // 0x036C(0x0004)
	struct FString                                     strConnected;                                             // 0x0370(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strFriend;                                                // 0x037C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strClan;                                                  // 0x0388(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDeny;                                                  // 0x0394(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPCBang;                                                // 0x03A0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strOffLine;                                               // 0x03AC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLogout;                                                // 0x03B8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strMainPCBang[0x4];                                       // 0x03C4(0x000C) (Localized, NeedCtorLink)
	struct FScriptDelegate                             __OnPopupChannel__Delegate;                               // 0x03F4(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupFriend__Delegate;                                // 0x03FC(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupClan__Delegate;                                  // 0x0404(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupPCBang__Delegate;                                // 0x040C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupChannelCheck__Delegate;                          // 0x0414(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupFriendCheck__Delegate;                           // 0x041C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupClanCheck__Delegate;                             // 0x0424(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupPCBangCheck__Delegate;                           // 0x042C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __ChannelUserList_OnHitBottom__Delegate;                  // 0x0434(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __ChannelUserList_OnHitTop__Delegate;                     // 0x043C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __ChannelUserList_OnAdjustWindow__Delegate;               // 0x0444(0x000C) (NeedCtorLink)
	...
	void SetUserServerInfo(const struct FString& szServername, const struct FString& szServerShortName, const struct FString& szServerIP, int serverPort, unsigned char CurPos, unsigned char CurState, int ChannelNum, const struct FString& szChannelNickName, int GameRoomNum);
	void HideTabButton(TEnumAsByte<EBTTPMessengerHK_E_TAB_MENU_TYPE> eTabMenuType);
	void ShowTabButton(TEnumAsByte<EBTTPMessengerHK_E_TAB_MENU_TYPE> eTabMenuType);
	...
	bool ContextMenu_OnClose(class UGUIContextMenu* Sender);
	bool ContextMenu_OnOpen(class UGUIContextMenu* Sender);
	void LoadPos(TEnumAsByte<EBTTPMessengerHK_E_TAB_MENU_TYPE> eTabMenuType);
	void SavePos(TEnumAsByte<EBTTPMessengerHK_E_TAB_MENU_TYPE> eTabMenuType);
	void RemoveAll(TEnumAsByte<EBTTPMessengerHK_E_TAB_MENU_TYPE> eTabMenuType);
	void RemoveChannelUser(int UID);
	bool IsFriendlyUser(const struct FString& UserName, const struct FString& ClanName, int ListIdx);
	void UpdateFriendlyUser(int ListIdx);
	int FindFriendFromUserName(const struct FString& UserName);
	void AddPCBangUser(const struct FString& UserName, int ClanMark, int ClanBG, int ClanBL, const struct FString& ClanName, int Level, const struct FString& ServerName, const struct FString& ServerIP, int serverPort, int CurPos, int ChannelNum, const struct FString& ChannelNickName, int RoomNum, int ClanGrade, int ClanWin, int ClanLose, unsigned char IsLookForClan, int ClanLevel, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3);
	void AddClanUser(const struct FString& UserName, unsigned char IsLogOn, int Level, int ClanGrade, int ClanWinCnt, int ClanLoseCnt, int LevelMarkID, int TitleMarkID);
	void AddFriendUser(const struct FString& UserName, unsigned char IsLogOn, int ClanMark, int ClanBG, int ClanBL, const struct FString& ClanName, int Level, int ClanGrade, unsigned char IsLookForClan, int ClanLevel, int LevelMarkID);
	void ReplaceChannelUser(int Index, int ClanPattern, int ClanBG, int ClanBL, const struct FString& ClanName, int Level, const struct FString& UserName, int UID, int ClanGrade, int ClanWinCnt, int ClanLoseCnt, unsigned char IsLookForClan, int ClanLevel, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3);
	class UBTAutoColumnListHK* GetMessengerType(unsigned char CommunityType);
	void ReplaceClanName(unsigned char CommunityType, const struct FString& OldClanName, const struct FString& NewClanname);
	void ReplaceClanLevel(unsigned char CommunityType, const struct FString& ClanName, int ClanLevel);
	void ReplaceMyClanName(unsigned char CommunityType, const struct FString& UserName, const struct FString& NewClanname);
	void ReplaceUserNickName(unsigned char CommunityType, const struct FString& OldUserName, const struct FString& NewUserName);
	void AddChannelUser(int ClanPattern, int ClanBG, int ClanBL, const struct FString& ClanName, int Level, const struct FString& UserName, int UID, int ClanGrade, int ClanWinCnt, int ClanLoseCnt, unsigned char IsLookForClan, int ClanLevel, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3);
...
{
public:
	TArray<class UGUIButton*>                          Buttons;                                                  // 0x02BC(0x000C) (NeedCtorLink)
	TArray<class UGUIPanel*>                           Panels;                                                   // 0x02C8(0x000C) (NeedCtorLink)
	...
	struct FScriptDelegate                             __OnVisiblePanelChanged__Delegate;                        // 0x02E0(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnChangedTab__Delegate;                                 // 0x02E8(0x000C) (NeedCtorLink)
...
{
public:
	unsigned long                                      bCondition : 1;                                           // 0x0304(0x0004)
	...
	TEnumAsByte<EDrawType>                             CaptionDrawType;                                          // 0x034C(0x0001) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	unsigned char                                      UnknownData00[0x3];                                       // 0x034D(0x0003) MISSED OFFSET
	TArray<TEnumAsByte<EContextMenuState>>             ContextItemsState;                                        // 0x0350(0x000C) (NeedCtorLink)
	struct FImage                                      buttonImage[0x3];                                         // 0x035C(0x0020)
	struct FImage                                      BackgroundImage;                                          // 0x03BC(0x0020)
	struct FScriptDelegate                             __OnSelected__Delegate;                                   // 0x03DC(0x000C) (NeedCtorLink)
	...
	bool ChangeStateByName(const struct FString& ItemName, TEnumAsByte<EContextMenuState> st);
	bool ChangeStateByIndex(int Index, TEnumAsByte<EContextMenuState> st);
	TEnumAsByte<EContextMenuState> GetItemState(int Index);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
...
public:
	...
	struct FString                                     strOnOff[0x3];                                            // 0x03E8(0x000C) (Localized, NeedCtorLink)
	unsigned char                                      nPopupSize[0x2];                                          // 0x040C(0x0001)
	unsigned char                                      UnknownData00[0x2];                                       // 0x040E(0x0002) MISSED OFFSET
	struct FString                                     strLineText[0x2];                                         // 0x0410(0x000C) (NeedCtorLink)
	...
	void SetLocation(const struct FString& strChannelName, int GameRoomNum);
...
public:
	...
	unsigned long                                      bAlwaysActiveCursor : 1;                                  // 0x0350(0x0004)
	unsigned long                                      bActiveCursor : 1;                                        // 0x0350(0x0004)
	...
	TArray<class UBTAutoColumnListHeaderHK*>           ACLHeaderList;                                            // 0x0360(0x000C) (NeedCtorLink)
	TArray<class UBTAutoColumnListDataHK*>             ACLRowList;                                               // 0x036C(0x000C) (NeedCtorLink)
	float                                              saveTime;                                                 // 0x0378(0x0004)
	unsigned long                                      bSaveMode : 1;                                            // 0x037C(0x0004)
	...
	unsigned long                                      isFullRoom : 1;                                           // 0x043C(0x0004)
	struct FScriptDelegate                             __SpliterDraw__Delegate;                                  // 0x0440(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnAdjustWindow__Delegate;                               // 0x0448(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnHitBottom__Delegate;                                  // 0x0450(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnHitTop__Delegate;                                     // 0x0458(0x000C) (NeedCtorLink)
...
{
public:
	struct FScriptDelegate                             __deleClanName__Delegate;                                 // 0x0460(0x000C) (NeedCtorLink)
	...
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void DrawClanName(class UCanvas* C, float L, float t, float R, float B, const struct FACLData& Data, const struct FString& szClanName, int row);
	void deleClanName(class UCanvas* C, float L, float t, float R, float B, const struct FACLData& Data, const struct FString& szClanName, int row);
	struct FString GetClanName(int row);
	void SetCurState(int row, int Value);
	void SetChannelNumber(int row, int Value);
	void SetGameRoomNumber(int row, int Value);
	void SetServerName(int row, const struct FString& Value);
	void SetServerIP(int row, const struct FString& Value);
	void SetServerPort(int row, int Value);
	void SetChannelName(int row, const struct FString& Value);
	void SetCurLocationName(int row, const struct FString& Value);
...
{
public:
	struct FString                                     strLabel[0xC];                                            // 0x04C0(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strEdit[0x8];                                             // 0x06C4(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawTextArrayHK*                     Edit[0x8];                                                // 0x0724(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strButtonSuspend;                                         // 0x0744(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     CharName;                                                 // 0x076C(0x000C) (NeedCtorLink)
	struct FString                                     InviteMsg;                                                // 0x0778(0x000C) (NeedCtorLink)
	...
	void SetData(int ReqJoinUserIdx, const struct FString& CharName, const struct FString& Message);
};
...
{
public:
	struct FString                                     strLabel[0xE];                                            // 0x04C0(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strEdit[0x9];                                             // 0x0714(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawTextArrayHK*                     Edit[0x9];                                                // 0x0780(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strButtonSuspend;                                         // 0x07A4(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     InviterCharname;                                          // 0x07D0(0x000C) (NeedCtorLink)
	struct FString                                     ClanName;                                                 // 0x07DC(0x000C) (NeedCtorLink)
	struct FString                                     InviteMsg;                                                // 0x07E8(0x000C) (NeedCtorLink)
	struct FString                                     strNoRankState;                                           // 0x07F4(0x000C) (Localized, NeedCtorLink)
	...
	void SetData(int InviterUserIdx, const struct FString& InviterCharname, const struct FString& ClanName, const struct FString& InviteMsg);
};
...
{
public:
	struct FString                                     strRadioLocation[0xE];                                    // 0x04C0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabel[0xF];                                            // 0x0568(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strEdit[0xF];                                             // 0x0748(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strNoRankState;                                           // 0x0944(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	unsigned long                                      bVisibleAFModel : 1;                                      // 0x04E4(0x0004)
	struct FString                                     strAF;                                                    // 0x04E8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRSA;                                                   // 0x04F4(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     CharName;                                                 // 0x0508(0x000C) (NeedCtorLink)
	struct FString                                     ClanName;                                                 // 0x0514(0x000C) (NeedCtorLink)
	struct FString                                     strLabel[0xE];                                            // 0x0520(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbLabel[0xE];                                             // 0x05C8(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         Label[0xE];                                               // 0x06A8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strEdit[0xE];                                             // 0x06E0(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbEdit[0xE];                                              // 0x0788(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawTextArrayHK*                     Edit[0xE];                                                // 0x0868(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLevelImg;                                               // 0x08A0(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FFloatBox                                   fbLabelClanMark;                                          // 0x08B0(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LevelImg;                                                 // 0x08C0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTLabelClanMarkHK*                          LabelClanMark;                                            // 0x08C4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbSelfIntroduction;                                       // 0x08C8(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTAutoScrollListHK*                         SelfIntroduction;                                         // 0x08D8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbEquipWeapon[0x2];                                       // 0x08DC(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTItemBoxButtonHK*                          EquipWeapon[0x2];                                         // 0x08FC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbExpBar;                                                 // 0x0904(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTExpBarHK*                                 expbar;                                                   // 0x0914(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strOnLine;                                                // 0x0918(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strOffLine;                                               // 0x0924(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawImageHK*                         strCharInfo;                                              // 0x0930(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbCharInfo;                                               // 0x0934(0x0010)
	struct FString                                     strDefaultSelfIntro;                                      // 0x0944(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strNoRankState;                                           // 0x0950(0x000C) (Localized, NeedCtorLink)
	...
	void SetData(const struct FString& CharName, const struct FString& ClanName, int MainWeaponID, int MainWeaponPartID, int SubWeaponID, int SubWeaponPartID, int AFBodyID, int RSABodyID, const struct FCharInfo& stCharInfo);
	...
	void SetClanInfo(const struct FString& ClanName, int ClanPattern, int ClanBG, int ClanBL, int ClanLevel);
	void SetMyInfo(const struct FString& CharName, const struct FString& ClanName, int Level, int curExp, int startExp, int maxExp, int LevelMarkID);
	void SetSelfIntro(const struct FString& Intro);
...
{
public:
	struct FString                                     strButtonTab[0x2];                                        // 0x04C0(0x000C) (Localized, NeedCtorLink)
	...
	struct FClanInfo                                   kMyClanInfo;                                              // 0x0540(0x00A8) (NeedCtorLink)
	struct FCharInfo                                   kMyCharInfo;                                              // 0x05E8(0x00C0)
...
{
public:
	struct FString                                     strStatus[0xA];                                           // 0x0460(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strMaster;                                                // 0x04D8(0x000C) (Localized, NeedCtorLink)
	...
	struct FString GetClanName(int Index);
	struct FString GetUserName(int Index);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	...
	bool ChangeLevelMarkID(const struct FString& UserName, int LevelMarkID);
	bool ChangeTeamMemberStatus(int UID, int Status);
	bool IsAllReady();
	int GetReadyUserCount();
	struct FString GetMaxSameClanName();
	...
	bool ChangeTeamMember(int UID, int ClanMark, int ClanBG, int ClanBL, int Level, const struct FString& NickName, const struct FString& ClanName, int Status, int Host, int Ping, const struct FString& UserIP, unsigned char LookingFor, int ClanLevel, bool bMe);
	int FindTeamMemberIndex(int UID);
	void ReplaceClanLevel(const struct FString& ClanName, int ClanLevel);
	void ReplaceClanName(const struct FString& old_ClanName, const struct FString& new_ClanName);
	bool ReplaceUserNickName(const struct FString& Old_NickName, const struct FString& New_NickName);
	void AddTeamMember(int UID, int ClanMark, int ClanBG, int ClanBL, int Level, const struct FString& NickName, const struct FString& ClanName, int Status, int Host, int Ping, const struct FString& UserIP, unsigned char LookingFor, int ClanLevel, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3, bool bMe);
	float GetItemHeight(class UCanvas* C);
};
...
{
public:
	struct FString                                     strContextMenuName[0x9];                                  // 0x03E4(0x000C) (Localized, NeedCtorLink)
...
{
public:
	unsigned long                                      bHandleEsc : 1;                                           // 0x0404(0x0004)
...
public:
	...
	struct FString                                     strTitle;                                                 // 0x0430(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSendMsg;                                               // 0x043C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strInviteMsg;                                             // 0x0448(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strOK;                                                    // 0x0454(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCancel;                                                // 0x0460(0x000C) (Localized, NeedCtorLink)
	struct FString                                     FriendName;                                               // 0x046C(0x000C) (NeedCtorLink)
	int                                                friendUID;                                                // 0x0478(0x0004)
	struct FScriptDelegate                             __OnOK__Delegate;                                         // 0x047C(0x000C) (NeedCtorLink)
	...
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	bool OnOK(class UGUIComponent* Sender);
	void SetData(const struct FString& UserName, int UID);
};
...
public:
	...
	void RemoveBlockUser(const struct FString& UserName);
	void AddBlockUser(const struct FString& UserName);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	float GetItemHeight(class UCanvas* C);
	void LC0_Draw(class UCanvas* C, float L, float t, float R, float B, const struct FACLData& Data, int Column, int row);
	struct FString GetUserName(int row);
	void InitScrollBar();
};
...
{
public:
	struct FString                                     strContextMenuName[0x2];                                  // 0x03E4(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	struct FString GetServerName(int row);
	int GetServerPort(int row);
	int GetCurPosInt(int row);
	int GetCurPos(int row);
	struct FString GetServerIP(int row);
...
{
public:
	struct FString                                     strContextMenuName[0x7];                                  // 0x0428(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	int GetLevelMarkID(int row);
	struct FString GetSelfIntro(int row);
	int GetRoomNumber(int row);
	int GetChannelNum(int row);
	int GetServerPort(int row);
	struct FString GetServerIP(int row);
	struct FString GetUserName(int row);
	int GetCurPosInt(int row);
	struct FString GetCurPos(int row);
...
{
public:
	struct FString                                     strContextMenuName[0x5];                                  // 0x0428(0x000C) (Localized, NeedCtorLink)
...
{
public:
	struct FString                                     strContextMenuName[0x8];                                  // 0x0428(0x000C) (Localized, NeedCtorLink)
...
{
public:
	struct FString                                     strContextMenuName[0x8];                                  // 0x03E4(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	struct FString                                     strInviteMsg;                                             // 0x04D0(0x000C) (Localized, NeedCtorLink)
	TArray<struct FString>                             friendNames;                                              // 0x04DC(0x000C) (NeedCtorLink)
	TArray<int>                                        friendUIDs;                                               // 0x04E8(0x000C) (NeedCtorLink)
	TArray<struct FString>                             friendRequestMsg;                                         // 0x04F4(0x000C) (NeedCtorLink)
	...
	void GetTopFriendInfo(struct FString* friName, int* friID);
	void DelData();
	void UpdateData();
	void AddData(const struct FString& UserName, int UID, const struct FString& Msg);
	void SetData(const struct FString& UserName, int UID, const struct FString& Msg);
};


// Class GUIWarfareControls.BTTPOptionBaseHK
// 0x03C8 (0x0700 - 0x0338)
class UBTTPOptionBaseHK : public UBTTabPanelHK
{
public:
	struct FString                                     strRound;                                                 // 0x0338(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRank;                                                  // 0x0344(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strWin;                                                   // 0x0350(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLose;                                                  // 0x035C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strKill;                                                  // 0x0368(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strAssist;                                                // 0x0374(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDeath;                                                 // 0x0380(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strHeadShot;                                              // 0x038C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strNewRank;                                               // 0x0398(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strNew;                                                   // 0x03A4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strHour;                                                  // 0x03B0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strMin;                                                   // 0x03BC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPoint;                                                 // 0x03C8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCash;                                                  // 0x03D4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDay;                                                   // 0x03E0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDiscon;                                                // 0x03EC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strToolTip[0x22];                                         // 0x03F8(0x000C) (Localized, NeedCtorLink)
	unsigned long                                      bPositionChanged : 1;                                     // 0x0590(0x0004)
	class UBTOwnerDrawImageHK*                         BackPanel;                                                // 0x0594(0x0004) (ExportObject, NeedCtorLink, EditInline)
	int                                                ItemWidth;                                                // 0x0598(0x0004) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	int                                                ItemHeight;                                               // 0x059C(0x0004) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	int                                                LabelWidth;                                               // 0x05A0(0x0004) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FFloatBox                                   fbACLList;                                                // 0x05A4(0x0010)
	class UBTAutoImageListNew*                         ACLList;                                                  // 0x05B4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbVisibleComponent[0x11];                                 // 0x05B8(0x0010)
	TArray<struct FFloatBox>                           InternalPadding;                                          // 0x06C8(0x000C) (NeedCtorLink)
	TArray<class UBTOwnerDrawImageHK*>                 Label;                                                    // 0x06D4(0x000C) (NeedCtorLink)
	TArray<class UGUIComponent*>                       Content;                                                  // 0x06E0(0x000C) (NeedCtorLink)
	unsigned long                                      bToolTipVisible : 1;                                      // 0x06EC(0x0004)
	class UBTRODecorateStringHK*                       btToolTip;                                                // 0x06F0(0x0004)
	int                                                WatchedIndex;                                             // 0x06F4(0x0004)
	struct FScriptDelegate                             __Content_AWinPos_Changed__Delegate;                      // 0x06F8(0x000C) (NeedCtorLink)
	...
	bool OptionBase_OnKeyEvent(float Delta, unsigned char* key, unsigned char* Action);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
...
// 0x0230 (0x0930 - 0x0700)
class UBTTPOptionGraphicAdvanceHK : public UBTTPOptionBaseHK
{
public:
	unsigned long                                      bSupportPS30 : 1;                                         // 0x0700(0x0004)
	unsigned long                                      bSupportR32 : 1;                                          // 0x0700(0x0004)
	unsigned long                                      bSupportMRT : 1;                                          // 0x0700(0x0004)
	unsigned long                                      bSupportHWShadowMap : 1;                                  // 0x0700(0x0004)
	unsigned long                                      bShowAAWarning : 1;                                       // 0x0700(0x0004)
	struct FString                                     strAntiAliasing[0x4];                                     // 0x0704(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLow;                                                   // 0x0734(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strHigh;                                                  // 0x0740(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabel[0x10];                                           // 0x074C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strAnisortropy;                                           // 0x080C(0x000C) (Localized, NeedCtorLink)
	struct FOptionGraphicAdvanceInfo                   InitInfo;                                                 // 0x0818(0x0028)
	struct FOptionGraphicAdvanceInfo                   CurrentInfo;                                              // 0x0840(0x0028)
	struct FOptionGraphicAdvanceInfo                   PredefineAdvanceSettings[0x5];                            // 0x0868(0x0028) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
...
public:
	...
	struct FString                                     myName;                                                   // 0x035C(0x000C) (NeedCtorLink)
	struct FString                                     ClanName;                                                 // 0x0368(0x000C) (NeedCtorLink)
	int                                                Ranking;                                                  // 0x0374(0x0004)
	int                                                curExp;                                                   // 0x0378(0x0004)
	int                                                maxExp;                                                   // 0x037C(0x0004)
	struct FString                                     expPerc;                                                  // 0x0380(0x000C) (NeedCtorLink)
	...
	struct FString                                     strClan;                                                  // 0x03A4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRanking[0x2];                                          // 0x03B0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strExp;                                                   // 0x03C8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPoint;                                                 // 0x03D4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRecord;                                                // 0x03E0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strWin;                                                   // 0x03EC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLose;                                                  // 0x03F8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strWinLose;                                               // 0x0404(0x000C) (NeedCtorLink)
	struct FText                                       tPoint;                                                   // 0x0410(0x001C) (NeedCtorLink)
	TArray<struct FText>                               taRanking;                                                // 0x042C(0x000C) (NeedCtorLink)
	TArray<struct FText>                               taExpbar;                                                 // 0x0438(0x000C) (NeedCtorLink)
	...
	void OnRendered(class UCanvas* C);
	void SetMyInfoA(const struct FString& CharName, int Level, int curExp, int startExp, int maxExp, int LevelMarkID);
	void SetClanInfo(const struct FString& ClanName, int ClanPattern, int ClanBG, int ClanBL, int ClanLevel);
	void SetRankingInfo(int Ranking, int Win, int Lose);
	void SetMoneyInfo(int P, int C);
	void SetMyInfo(const struct FString& CharName, const struct FString& ClanName, const struct FCharInfo& cInfo);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};


// Class GUIWarfareControls.BTTPMessengerHKCN
// 0x0058 (0x04A4 - 0x044C)
class UBTTPMessengerHKCN : public UBTTPMessengerHK
{
public:
	struct FScriptDelegate                             __OnPopupChannel__Delegate;                               // 0x044C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupFriend__Delegate;                                // 0x0454(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupClan__Delegate;                                  // 0x045C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupPCBang__Delegate;                                // 0x0464(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupChannelCheck__Delegate;                          // 0x046C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupFriendCheck__Delegate;                           // 0x0474(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupClanCheck__Delegate;                             // 0x047C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupPCBangCheck__Delegate;                           // 0x0484(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __ChannelUserList_OnHitBottom__Delegate;                  // 0x048C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __ChannelUserList_OnHitTop__Delegate;                     // 0x0494(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __ChannelUserList_OnAdjustWindow__Delegate;               // 0x049C(0x000C) (NeedCtorLink)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class GUIWarfareControls.BTTPMessengerHKCN");
		return ptr;
	}
...
{
public:
	struct FString                                     MapName;                                                  // 0x0338(0x000C) (NeedCtorLink)
	int                                                Diffcult;                                                 // 0x0344(0x0004)
	int                                                ModeNum;                                                  // 0x0348(0x0004)
	int                                                WeaponLimit;                                              // 0x034C(0x0004)
	struct FString                                     ModeName;                                                 // 0x0350(0x000C) (NeedCtorLink)
	unsigned long                                      bHardCore : 1;                                            // 0x035C(0x0004)
	struct FString                                     HardCore;                                                 // 0x0360(0x000C) (NeedCtorLink)
	struct FString                                     GameTime;                                                 // 0x036C(0x000C) (NeedCtorLink)
	struct FString                                     TargetScore;                                              // 0x0378(0x000C) (NeedCtorLink)
	struct FString                                     UserCount;                                                // 0x0384(0x000C) (NeedCtorLink)
	struct FImage                                      MapImage;                                                 // 0x0390(0x0020)
	struct FImage                                      ImageSupply[0x3];                                         // 0x03B0(0x0020)
	struct FString                                     strButtonRoomInfo[0x2];                                   // 0x0410(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strHardCore;                                              // 0x0428(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGameTime;                                              // 0x0434(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strTargetScore;                                           // 0x0440(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strUserCount;                                             // 0x044C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDifficult[0x6];                                        // 0x0458(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strWeaponLimit;                                           // 0x04A0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strAlienModeLimit;                                        // 0x04AC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strBotModeUserTeam[0x2];                                  // 0x04B8(0x000C) (NeedCtorLink)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonRoomInfo;                                           // 0x04D0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	...
	void SetData(const struct FString& sMapName, const struct FString& sMapImageName, const struct FString& sModeName, bool sbHardCore, const struct FString& sGameTime, const struct FString& sTargetScore, const struct FString& sUserCount, int iModeNum, int iDiffcult, int WeaponLimit, int BotUserTeam);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
{
public:
	struct FFloatBox                                   fChatTab[0x3];                                            // 0x0430(0x0010)
...
public:
	...
	TArray<struct FGameModeInfo>                       GameModeInfos;                                            // 0x0564(0x000C) (NeedCtorLink)
	...
	struct FString                                     strLabelCommonTop[0x9];                                   // 0x0614(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strLabelCommonBottom[0x7];                                // 0x0714(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strLabelSwitchSide;                                       // 0x07D4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelBombPossesion;                                    // 0x07E0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strBombForEveryone;                                       // 0x07EC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strBombForOne;                                            // 0x07F8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelChangeAD;                                         // 0x0804(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelChangeRound;                                      // 0x0810(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strUserCount;                                             // 0x081C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelBot_UserTeam[0x4];                                // 0x0828(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelBot_Difficult[0x6];                               // 0x0858(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelBot_AF[0x2];                                      // 0x08A0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelBot_RSA[0x2];                                     // 0x08B8(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     CaptionReSpawn;                                           // 0x0B10(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionRandom;                                            // 0x0B1C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionFixed;                                             // 0x0B28(0x000C) (Localized, NeedCtorLink)
	...
	unsigned long                                      bEnableFillModeList : 1;                                  // 0x0B48(0x0004)
...
{
public:
	class UButtonGroups*                               Group;                                                    // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTCheckBoxHK*                               ButtonOff;                                                // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTCheckBoxHK*                               ButtonOn;                                                 // 0x0340(0x0004) (ExportObject, NeedCtorLink, EditInline)
	int                                                OnOffSpaceRange;                                          // 0x0344(0x0004)
	struct FScriptDelegate                             __OnSelect__Delegate;                                     // 0x0348(0x000C) (NeedCtorLink)
...
public:
	...
	TArray<class UBTWindowHK*>                         WindowList;                                               // 0x0030(0x000C) (NeedCtorLink)
...
// 0x00CC (0x0404 - 0x0338)
class UBTTPQuestInfoHK : public UBTTabPanelHK
{
public:
	class UTabControlMocker*                           TabControl;                                               // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         BackgroundImage;                                          // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	TArray<class UBTOwnerDrawCaptionButtonHK*>         ButtonCategory;                                           // 0x0340(0x000C) (NeedCtorLink)
	class UBTACLQuestHK*                               ACLQuest;                                                 // 0x034C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTLabelQuestDescHK*                         LabelQuestDesc;                                           // 0x0350(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonTab[0x6];                                           // 0x0354(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonClose;                                              // 0x036C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strButtonTab[0x6];                                        // 0x0370(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonClose;                                           // 0x03B8(0x000C) (Localized, NeedCtorLink)
	unsigned long                                      bSelfTopMenuOwner : 1;                                    // 0x03C4(0x0004)
	unsigned long                                      bSlidingTabPanel : 1;                                     // 0x03C4(0x0004)
	unsigned long                                      bShowing : 1;                                             // 0x03C4(0x0004)
	...
	class UBTAttendQuest*                              AttendCheck;                                              // 0x03F0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTDailyQuest*                               DailyQuest;                                               // 0x03F4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTSpecialQuest*                             SpecialQuest;                                             // 0x03F8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UwMatchMaker*                                MM;                                                       // 0x03FC(0x0004)
	class UwGameManager*                               GameMgr;                                                  // 0x0400(0x0004)
...
public:
	...
	class UBTOwnerDrawImageHK*                         Quest_SpecialThema;                                       // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         SpecialQuestBG;                                           // 0x0340(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         Quest_SpecialMiniemblelm;                                 // 0x0344(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         SpecialQuestWelcom;                                       // 0x0348(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         SpecialQuestDesc;                                         // 0x034C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         SpecialQuestComp;                                         // 0x0350(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         SpecialQuestMission;                                      // 0x0354(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonClose;                                              // 0x0358(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strSpecialQuest[0x5];                                     // 0x035C(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawCaptionButtonHK*                 DummyBtn;                                                 // 0x0398(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 BtnReceiveReward;                                         // 0x039C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageScroll*                     RewardItemName;                                           // 0x03A0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         RewardItemImg;                                            // 0x03A4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageScroll*                     RewardItemUserList;                                       // 0x03A8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTLabelQuestDescHK*                         LabelQuestDesc;                                           // 0x03AC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTROExpBarHKCN*                             expbar;                                                   // 0x03B0(0x0004)
	class UBTItemInfoToolTipWindow*                    RewardItemInfoToolTip;                                    // 0x03B4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	int                                                nQuestID;                                                 // 0x03B8(0x0004)
	unsigned long                                      RewardItemNameChange : 1;                                 // 0x03BC(0x0004)
...
public:
	struct FString                                     strClientDefaultTitle;                                    // 0x04D8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strClientDefine[0xB4];                                    // 0x04E4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strClientTitle[0xB4];                                     // 0x0D54(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	unsigned long                                      bFreeItem : 1;                                            // 0x04C8(0x0004)
	unsigned long                                      bCheckDupSuccess : 1;                                     // 0x04C8(0x0004)
	...
	struct FString                                     strLabel[0xC];                                            // 0x05C8(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strButtonIsExist;                                         // 0x06A8(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strFT_Button[0x6];                                        // 0x072C(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strST_Button[0x6];                                        // 0x0804(0x000C) (Localized, NeedCtorLink)
...
class UBTTPLuckyBlackBox : public UGUITabPanel
{
public:
	...
	struct FFloatBox                                   fbImgBlackBoxKey;                                         // 0x0368(0x0010)
	class UBTOwnerDrawImageHK*                         ImgBlackBoxKey;                                           // 0x0378(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelHaveKey;                                           // 0x037C(0x0010)
	struct FFloatBox                                   fbLabelHaveKeyNum;                                        // 0x038C(0x0010)
	struct FFloatBox                                   fbLabelKeyName;                                           // 0x039C(0x0010)
	struct FFloatBox                                   fbLabelKeyDesc[0x2];                                      // 0x03AC(0x0010)
	class UBTOwnerDrawImageHK*                         LabelHaveKey;                                             // 0x03CC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelHaveKeyNum;                                          // 0x03D0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelKeyName;                                             // 0x03D4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelKeyDesc[0x2];                                        // 0x03D8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbBuyKeyButton;                                           // 0x03E0(0x0010)
	class UBTOwnerDrawCaptionButtonHK*                 BuyKeyButton;                                             // 0x03F0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTTPLuckyShopCommon*                        LuckyShopCommon;                                          // 0x03F4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbComboBoxBlackBox;                                       // 0x03F8(0x0010)
	struct FFloatBox                                   fbBackgroundComboBoxBlackBox;                             // 0x0408(0x0010)
	class UBTOwnerDrawImageHK*                         BackgroundComboBoxBlackBox;                               // 0x0418(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTComboBoxHK*                               ComboBoxBlackBox;                                         // 0x041C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	TArray<int>                                        BlackBoxIDList;                                           // 0x0420(0x000C) (NeedCtorLink)
	int                                                LastOpenBlackBoxID;                                       // 0x042C(0x0004)
	struct FString                                     strBuyBlackBoxKey;                                        // 0x0430(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strOpenBlackBox;                                          // 0x043C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelHaveKey;                                          // 0x0448(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelHaveKeyNum;                                       // 0x0454(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelKeyName;                                          // 0x0460(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelKeyDesc[0x2];                                     // 0x046C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strBlackBoxListItem;                                      // 0x0484(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelIncludeHeader[0x2];                               // 0x0490(0x000C) (Localized, NeedCtorLink)
	struct FScriptDelegate                             __deleShowCashChargeWindow__Delegate;                     // 0x04A8(0x000C) (NeedCtorLink)
	...
	void ShowItemBuyWindow(class UBTROItemBoxHK* Ro, int buyType, unsigned char cashType);
	...
	void fill();
	void InsertBlackboxData(class UwItemBaseParam* blackboxData, TArray<class UwItemBaseParam*>* OutArray);
	void AddLabel(const struct FFloatBox& fbComponent, const struct FString& strCaption, int FontSize, const struct FColor& TextColor, TEnumAsByte<EDrawType> dt, class UBTOwnerDrawImageHK** AddComponent);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
...
{
public:
	TArray<int>                                        ItemIDChoose;                                             // 0x04C0(0x000C) (NeedCtorLink)
	TArray<int>                                        PartIDChoose;                                             // 0x04CC(0x000C) (NeedCtorLink)
	TArray<struct FBtrDouble>                          ItemIdx;                                                  // 0x04D8(0x000C) (NeedCtorLink)
	TArray<struct FBtrDouble>                          UntilTime;                                                // 0x04E4(0x000C) (NeedCtorLink)
	TArray<int>                                        StackCount;                                               // 0x04F0(0x000C) (NeedCtorLink)
	class UwItemBoxHK*                                 SaveItemInfo[0x3];                                        // 0x04FC(0x0004)
	class UwItemBoxInstanceHK*                         SaveInstanceInfo[0x3];                                    // 0x0508(0x0004)
	TArray<class UwItemBoxHK*>                         RandItemInfo_0;                                           // 0x0514(0x000C) (NeedCtorLink)
	TArray<class UwItemBoxHK*>                         RandItemInfo_1;                                           // 0x0520(0x000C) (NeedCtorLink)
	TArray<class UwItemBoxHK*>                         RandItemInfo_2;                                           // 0x052C(0x000C) (NeedCtorLink)
	TArray<class UwItemBoxInstanceHK*>                 RandInstanceInfo_0;                                       // 0x0538(0x000C) (NeedCtorLink)
	TArray<class UwItemBoxInstanceHK*>                 RandInstanceInfo_1;                                       // 0x0544(0x000C) (NeedCtorLink)
	TArray<class UwItemBoxInstanceHK*>                 RandInstanceInfo_2;                                       // 0x0550(0x000C) (NeedCtorLink)
	TArray<int>                                        RandItemBestInfo_0;                                       // 0x055C(0x000C) (NeedCtorLink)
	TArray<int>                                        RandItemBestInfo_1;                                       // 0x0568(0x000C) (NeedCtorLink)
	TArray<int>                                        RandItemBestInfo_2;                                       // 0x0574(0x000C) (NeedCtorLink)
	int                                                AniEndCount;                                              // 0x0580(0x0004)
	int                                                ItemCount;                                                // 0x0584(0x0004)
	struct FString                                     strPoint;                                                 // 0x0588(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelTopLine;                                          // 0x0594(0x000C) (Localized, NeedCtorLink)
	...
	unsigned long                                      UseOpenSound : 1;                                         // 0x066C(0x0004)
	unsigned long                                      useEndSound : 1;                                          // 0x066C(0x0004)
	struct FScriptDelegate                             __RandEnd__Delegate;                                      // 0x0670(0x000C) (NeedCtorLink)
	...
	void ButtonItemBox_OnChangeItemInfo(TArray<class UwItemBoxHK*> randItemInfo, TArray<class UwItemBoxInstanceHK*> randInstanceInfo, int itemBoxIndex, int Index);
	void SetCandidateItems(int RandNum, TArray<int> ItemID, TArray<int> PartID, TArray<int> BestItemID);
	void CandidateItems(int RandNum, TArray<int> ItemID, TArray<int> PartID, TArray<int> BestItemID, TArray<class UwItemBoxHK*>* randItemInfo, TArray<class UwItemBoxInstanceHK*>* randInstanceInfo, TArray<int>* randBestItemID);
...
public:
	...
	struct FString                                     strSoundShake;                                            // 0x072C(0x000C) (NeedCtorLink)
	struct FString                                     strSoundLose;                                             // 0x0738(0x000C) (NeedCtorLink)
	struct FString                                     strSoundEffect;                                           // 0x0744(0x000C) (NeedCtorLink)
	struct FString                                     strSoundWin;                                              // 0x0750(0x000C) (NeedCtorLink)
	struct FString                                     strOpening;                                               // 0x075C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCongratulation;                                        // 0x0768(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRemainName;                                            // 0x0774(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strReOpen;                                                // 0x0780(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strUseCapsule;                                            // 0x078C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strInventory;                                             // 0x0798(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strBestItemGet[0x2];                                      // 0x07A4(0x000C) (Localized, NeedCtorLink)
	struct FScriptDelegate                             __ClickInventory__Delegate;                               // 0x07BC(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __ClickShowCashChargeWindow__Delegate;                    // 0x07C4(0x000C) (NeedCtorLink)
...
{
public:
	struct FString                                     strUIChangeOption;                                        // 0x04C0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strReset;                                                 // 0x04CC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strVoiceLangChangeMsg;                                    // 0x04D8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strAnd;                                                   // 0x04E4(0x000C) (Localized, NeedCtorLink)
...
{
public:
	struct FString                                     strButtonTab[0x5];                                        // 0x0338(0x000C) (Localized, NeedCtorLink)
	class UTabControlMocker*                           TabControl;                                               // 0x0374(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbButtonTab[0x5];                                         // 0x0378(0x0010)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonTab[0x5];                                           // 0x03C8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbTPPanel;                                                // 0x03DC(0x0010)
	class UBTTPOptionBaseHK*                           TPPanel[0x5];                                             // 0x03EC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTTPOptionGraphicHK*                        TPGraphic;                                                // 0x0400(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTTPOptionSoundHK*                          TPSound;                                                  // 0x0404(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTTPOptionInputHK*                          TPInput;                                                  // 0x0408(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTTPOptionCommunityHK*                      TPCommunity;                                              // 0x040C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTTPOptionETCHK*                            TPETC;                                                    // 0x0410(0x0004) (ExportObject, NeedCtorLink, EditInline)
...
public:
	...
	struct FString                                     RoomUniqueID;                                             // 0x04C8(0x000C) (NeedCtorLink)
	int                                                RoomNumber;                                               // 0x04D4(0x0004)
	struct FString                                     InviterName;                                              // 0x04D8(0x000C) (NeedCtorLink)
	struct FString                                     Password;                                                 // 0x04E4(0x000C) (NeedCtorLink)
	float                                              ElipsedTime;                                              // 0x04F0(0x0004)
	class UBTTcpLink_Channel*                          TcpChannel;                                               // 0x04F4(0x0004)
	struct FString                                     strGameState[0x2];                                        // 0x04F8(0x000C) (Localized, NeedCtorLink)
	...
	TArray<struct FText>                               arrLabel;                                                 // 0x0554(0x000C) (NeedCtorLink)
	struct FString                                     strLabel[0x3];                                            // 0x0560(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strTemp;                                                  // 0x0584(0x000C) (Localized, NeedCtorLink)
	...
	bool Internal_OnPreDraw(class UCanvas* C);
	void SetData(const struct FString& where, const struct FString& Who);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
public:
	...
	struct FString                                     strRemainName;                                            // 0x0544(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDesc;                                                  // 0x0550(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	struct FString                                     strQuickJoin;                                             // 0x034C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strQuickSetup;                                            // 0x0358(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRefresh;                                               // 0x0364(0x000C) (Localized, NeedCtorLink)
	struct FScriptDelegate                             __HeaderButton_OnClick__Delegate;                         // 0x0370(0x000C) (NeedCtorLink)
...
{
public:
	struct FString                                     strToolTip[0x13];                                         // 0x0460(0x000C) (Localized, NeedCtorLink)
	TArray<struct FChannelInfo>                        channelInfos;                                             // 0x0544(0x000C) (NeedCtorLink)
	int                                                ConnectedUser;                                            // 0x0550(0x0004)
	int                                                MaxUser;                                                  // 0x0554(0x0004)
	unsigned long                                      bShowCount : 1;                                           // 0x0558(0x0004)
	struct FString                                     CurrentServerGroup;                                       // 0x055C(0x000C) (NeedCtorLink)
	class UBTRODecorateStringHK*                       ChannelToolTip;                                           // 0x0568(0x0004)
	unsigned long                                      bShowToolTip : 1;                                         // 0x056C(0x0004)
	struct FString                                     strChannelToolTip;                                        // 0x0570(0x000C) (Localized, NeedCtorLink)
	class UBTACLServerSelectionHK*                     SelChannel;                                               // 0x057C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     textChobo;                                                // 0x0580(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     textServerSlash;                                          // 0x058C(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     textChannel;                                              // 0x0598(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     textLC2[0x4];                                             // 0x05A4(0x000C) (Edit, Localized, NeedCtorLink)
	struct FScriptDelegate                             __OnEnterChannel__Delegate;                               // 0x05D4(0x000C) (NeedCtorLink)
...
public:
	...
	unsigned long                                      bShowCount : 1;                                           // 0x0468(0x0004)
	struct FString                                     CurrentServerGroup;                                       // 0x046C(0x000C) (NeedCtorLink)
	struct FString                                     textChobo;                                                // 0x0478(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     textServerSlash;                                          // 0x0484(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     textChannel;                                              // 0x0490(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     textLC2[0x4];                                             // 0x049C(0x000C) (Edit, Localized, NeedCtorLink)
	struct FScriptDelegate                             __OnEnterChannel__Delegate;                               // 0x04CC(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnSelectSvr__Delegate;                                  // 0x04D4(0x000C) (NeedCtorLink)
...
// 0x031C (0x07DC - 0x04C0)
class UBTWindowModifyHK : public UBTWindowHK
{
public:
	unsigned long                                      bSniperRifle : 1;                                         // 0x04C0(0x0004)
	struct FFloatBox                                   fbLabelBackgroundWeapon[0x2];                             // 0x04C4(0x0010)
	struct FString                                     strLabelWeapon[0x2];                                      // 0x04E4(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawImageHK*                         LabelWeapon[0x2];                                         // 0x04FC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	TArray<struct FPaintInfo>                          PaintingInfos;                                            // 0x0504(0x000C) (NeedCtorLink)
	...
	struct FString                                     strLabelAll[0x3];                                         // 0x054C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelSniper[0x3];                                      // 0x0570(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawImageHK*                         Label[0x3];                                               // 0x0594(0x0004) (ExportObject, NeedCtorLink, EditInline)
	...
	int                                                OriginalPaintingItemID;                                   // 0x068C(0x0004)
	int                                                OriginalPaintingID;                                       // 0x0690(0x0004)
	int                                                OriginalUnionedPartID;                                    // 0x0694(0x0004)
	struct FVector                                     vDisplay_3d;                                              // 0x0698(0x000C)
	float                                              fDisplay_rot_y;                                           // 0x06A4(0x0004)
	class UBTItemCommonInfoHK*                         MyData;                                                   // 0x06A8(0x0004)
	class UBTModelWeaponHK*                            btWeapon[0x2];                                            // 0x06AC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class ABTROModelWeapon*                            roWeapon[0x2];                                            // 0x06B4(0x0004)
	class UButtonGroups*                               CustomItemButtonGroup;                                    // 0x06BC(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTItemBoxButtonHK*                          btnSelectedCustomItems[0x5];                              // 0x06C0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 btnRemoveOrRollback[0x5];                                 // 0x06D4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strRemove;                                                // 0x06E8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRollback;                                              // 0x06F4(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawCaptionButtonHK*                 btnInit;                                                  // 0x0700(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbButtonInit;                                             // 0x0704(0x0010)
	struct FString                                     strInit;                                                  // 0x0714(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strFilter[0x6];                                           // 0x0720(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawCaptionButtonHK*                 FilterButton[0x6];                                        // 0x0768(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UTabControlMocker*                           TabControl;                                               // 0x0780(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	unsigned char                                      FilterTabBtnIdx;                                          // 0x0784(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0785(0x0003) MISSED OFFSET
	struct FFloatBox                                   fbACLList_All;                                            // 0x0788(0x0010)
	class UBTAutoImageListHK*                          ACLList_All;                                              // 0x0798(0x0004) (ExportObject, NeedCtorLink, EditInline)
	TArray<class UBTROItemBoxHK*>                      DataPool;                                                 // 0x079C(0x000C) (NeedCtorLink)
	class UBTItemStateBoxButtonHK*                     ItemStateView;                                            // 0x07A8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UwItemBoxHK*                                 CurrentItemInfo;                                          // 0x07AC(0x0004)
	class UwItemBoxInstanceHK*                         CurrentInstanceInfo;                                      // 0x07B0(0x0004)
	class UwItemBoxHK*                                 WantedItemInfo;                                           // 0x07B4(0x0004)
	class UwItemBoxInstanceHK*                         WantedInstanceInfo;                                       // 0x07B8(0x0004)
	int                                                IsEnableRemove[0x5];                                      // 0x07BC(0x0004)
	class UBTOwnerDrawImageHK*                         LockImage[0x3];                                           // 0x07D0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	...
	bool GunstockRemoveButton_OnClick(class UGUIComponent* Sender);
	bool BarrelRemoveButton_OnClick(class UGUIComponent* Sender);
	bool SilencerRemoveButton_OnClick(class UGUIComponent* Sender);
	bool SightRemoveButton_OnClick(class UGUIComponent* Sender);
	bool PaintRemoveButton_OnClick(class UGUIComponent* Sender);
	bool CustomGunstockPartsButton_OnClick(class UGUIComponent* Sender);
	bool CustomBarrelPartsButton_OnClick(class UGUIComponent* Sender);
	bool CustomSilencerPartsButton_OnClick(class UGUIComponent* Sender);
	bool CustomSightPartsButton_OnClick(class UGUIComponent* Sender);
...
{
public:
	unsigned long                                      bPlayScaleAniSound : 1;                                   // 0x04C0(0x0004)
	struct FString                                     strRequiredUser[0x2];                                     // 0x04C4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     MyNickName;                                               // 0x04DC(0x000C) (NeedCtorLink)
	struct FString                                     TrophyReceiver[0x2];                                      // 0x04E8(0x000C) (NeedCtorLink)
	...
	struct FString                                     strLabelTopLine;                                          // 0x0640(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strLabelContent;                                          // 0x0660(0x000C) (Localized, NeedCtorLink)
	...
	void Internal_OnOpen();
	void SetData(const struct FString& MyNickName, const struct FString& TrophyReceiver1, const struct FString& TrophyReceiver2, class UwItemBoxHK* ItemInfo1, class UwItemBoxInstanceHK* InstanceInfo1, class UwItemBoxHK* ItemInfo2, class UwItemBoxInstanceHK* InstanceInfo2, class ABTROModelWeapon* ro1, class ABTROModelWeapon* ro2);
...
{
public:
	class UBTACLQuestHK*                               ACLQuest;                                                 // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTLabelQuestDescHK*                         LabelQuestDesc;                                           // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         puzzelBg;                                                 // 0x0340(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         puzzelPice[0x8];                                          // 0x0344(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonClose;                                              // 0x0364(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelDailyDesc;                                           // 0x0368(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strDaily[0x5];                                            // 0x036C(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawCaptionButtonHK*                 BtnReceiveReward;                                         // 0x03A8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelReward;                                              // 0x03AC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         PuzzleItemImg;                                            // 0x03B0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UwGameManager*                               GameMgr;                                                  // 0x03B4(0x0004)
	class UBTOwnerDrawImageScroll*                     RewardItemName;                                           // 0x03B8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         RewardItemCnt;                                            // 0x03BC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         PopUpBg;                                                  // 0x03C0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTItemInfoToolTipWindow*                    RewardItemInfoToolTip;                                    // 0x03C4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 DummyBtn;                                                 // 0x03C8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      RewardItemNameChange : 1;                                 // 0x03CC(0x0004)
...
{
public:
	class UBTACLMessengerBanHK*                        aclban;                                                   // 0x0700(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strLabel[0x6];                                            // 0x0704(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strAllowMode[0x3];                                        // 0x074C(0x000C) (Localized, NeedCtorLink)
	...
	bool ContextMenu_OnClose(class UGUIContextMenu* Sender);
	bool ContextMenu_OnOpen(class UGUIContextMenu* Sender);
	void UpdateBlockUserList(TArray<struct FString> blockuserlist);
	unsigned char ConvertToCommuniyOption(const struct FString& strOptName);
	void ContextMenu_OnSelected(int ContextMenuIndex);
	void SaveData();
	void ResetData();
	void InitializeContent();
...
public:
	...
	struct FString                                     MapName;                                                  // 0x03C0(0x000C) (NeedCtorLink)
	class UMaterial*                                   MapImg;                                                   // 0x03CC(0x0004)
	TArray<class UMaterial*>                           supplyImg;                                                // 0x03D0(0x000C) (NeedCtorLink)
	...
	void Internal_OnRendered(class UCanvas* C);
	void SetRoomInfo(const struct FString& RoomName, int GameState, const struct FString& roommaster, const struct FString& GameMode, const struct FString& Weapon, const struct FString& HardCore, const struct FString& gamerunning);
	void SetMapName(const struct FString& MN);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
public:
	...
	struct FString                                     strCapsuleTitle;                                          // 0x0528(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRewardTitle;                                           // 0x0534(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCouponTitle;                                           // 0x0540(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCapsuleDesc;                                           // 0x054C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRewardDesc;                                            // 0x0558(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCouponDesc;                                            // 0x0564(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCapsuleRemainName;                                     // 0x0570(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCapsuleRemainCount;                                    // 0x057C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strUseCapsuleButton;                                      // 0x0588(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCapsuleBuyRewardButton;                                // 0x0594(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCouponRewardButton;                                    // 0x05A0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCapsuleBuyRewardInfo;                                  // 0x05AC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCouponRewardInfo;                                      // 0x05B8(0x000C) (Localized, NeedCtorLink)
	...
	void Internal_OnRendered(class UCanvas* C);
	void InserItemCheckNeedNum(class UBTRORewardDecorate* inserItem, TArray<class UObject*>* insertList);
	...
	void FillCapsule();
	void AddButton(const struct FFloatBox& fbButton, const struct FString& strCaption, int FontSize, class UBTOwnerDrawCaptionButtonHK** AddButton);
	void AddLabel(const struct FFloatBox& fbComponent, const struct FString& strCaption, int FontSize, const struct FColor& TextColor, TEnumAsByte<EDrawType> dt, class UBTOwnerDrawImageHK** AddComponent);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
public:
	...
	struct FString                                     strLabel[0x3];                                            // 0x04D4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strAllMaps;                                               // 0x04F8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strAllModes;                                              // 0x0504(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strAllSubMode;                                            // 0x0510(0x000C) (Localized, NeedCtorLink)
	...
	TArray<class UBTCheckBoxHK*>                       ButtonGameMode;                                           // 0x052C(0x000C) (NeedCtorLink)
	class UButtonGroups*                               GroupMap;                                                 // 0x0538(0x0004) (ExportObject, NeedCtorLink, EditInline)
	TArray<class UBTCheckBoxHK*>                       ButtonMap;                                                // 0x053C(0x000C) (NeedCtorLink)
	class UButtonGroups*                               GroupSubMode;                                             // 0x0548(0x0004) (ExportObject, NeedCtorLink, EditInline)
	TArray<class UBTCheckBoxHK*>                       ButtonSubMode;                                            // 0x054C(0x000C) (NeedCtorLink)
	unsigned long                                      bCancelled : 1;                                           // 0x0558(0x0004)
	...
	TArray<class UBTOwnerDrawCaptionButtonHK*>         GameModeBtnList;                                          // 0x0574(0x000C) (NeedCtorLink)
...
public:
	...
	struct FString                                     strGameState[0x2];                                        // 0x0464(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCW_GameMode[0x3];                                      // 0x047C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     onoff[0x2];                                               // 0x04A0(0x000C) (Edit, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	TArray<struct FString>                             strWeaponRestrict;                                        // 0x04B8(0x000C) (NeedCtorLink)
	TArray<struct FString>                             strBotDifficult;                                          // 0x04C4(0x000C) (Localized, NeedCtorLink)
	...
	struct FString IntToGameState(int Index);
	bool ChangeRoomOwenrName(const struct FString& old_name, const struct FString& new_name);
	void ChangeRoomOwnerInfo(int idx, const struct FString& OwnerName, const struct FString& OwnerIP);
	void ChangeRoomUserCount(int i, int CurUser);
	void ChangeRoomState(int i, int game_state);
	void ChangeRoomInfo(int i, const struct FString& room_name, const struct FString& map_name, int map_num, int game_mode, unsigned char IsTeamBalance, int CurUser, int MaxUser, int game_state, unsigned char IsPW, unsigned char BotDifficult, unsigned char WeaponLimit, unsigned char BotModeUserTeamNum);
	void ChangeRoomName(int i, const struct FString& room_name);
	void RemoveAll();
	void RemoveRow(int Index);
	bool RemoveByGameNumber(int GameNumber);
	struct FString SetPingStatus(int Index, int Status);
	struct FString GetMasterIP(int Index);
	void AddRowNoAlign(class UBTAutoColumnListDataHK* Item, int Index);
	void AddRow(class UBTAutoColumnListDataHK* Item, bool bSet, int Index);
	void RemoveRowArray(int StartIndex, int endLength);
	int PingToIndex(int msec);
	void SetRoomPingStatus(const struct FString& IP, int msec);
	struct FString GetRoomOwnerIP(int Index);
	void ReplaceRoomCW(int Index, int WaitRoomIdx, const struct FString& LeaderName, const struct FString& RoomName, const struct FString& MapName, int MapNum, int CurUserCount, int MaxUserCount, int Status);
	void AddRoomCW(int WaitRoomIdx, const struct FString& LeaderName, const struct FString& RoomName, const struct FString& MapName, int MapNum, int CurUserCount, int MaxUserCount, int Status);
	bool RemoveByGameNumberCW(int cw_no);
	void AddRoomInteligenceCW(int WaitRoomIdx, const struct FString& LeaderName, const struct FString& RoomName, const struct FString& MapName, int MapNum, int CurUserCount, int MaxUserCount, int Status);
	void ReplaceRoom(int Index, int SP, int no, int PASS, const struct FString& room_name, const struct FString& map_name, int map_num, int game_mode, int restrict, int CurUser, int MaxUser, int game_state, int Ping, const struct FString& masterIP, int game_minute, int teambalance, const struct FString& room_owner, int BotDifficult, int BotUserTeam, int cw_no);
	int FindRoomNo(int no, int cw_no);
	void AddRoom(int SP, int no, int PASS, const struct FString& room_name, const struct FString& map_name, int map_num, int game_mode, int restrict, int CurUser, int MaxUser, int game_state, int Ping, const struct FString& masterIP, int game_minute, int teambalance, const struct FString& room_owner, int BotDifficult, int BotUserTeam, int cw_no);
	void AddRoomInteligence(int SP, int no, int PASS, const struct FString& room_name, const struct FString& map_name, int map_num, int game_mode, int restrict, int CurUser, int MaxUser, int game_state, int Ping, const struct FString& masterIP, int game_minute, int teambalance, const struct FString& room_owner, int BotDifficult, int BotUserTeam, int cw_no);
...
public:
	...
	unsigned long                                      bVisible : 1;                                             // 0x003C(0x0004)
	unsigned long                                      bMouseOn : 1;                                             // 0x003C(0x0004)
	unsigned long                                      bFocused : 1;                                             // 0x003C(0x0004)
	unsigned long                                      bvisibleBtn : 1;                                          // 0x003C(0x0004)
	unsigned long                                      bMouseClick : 1;                                          // 0x003C(0x0004)
	unsigned long                                      bMouseRelease : 1;                                        // 0x003C(0x0004)
	unsigned long                                      bQuickSlot : 1;                                           // 0x003C(0x0004)
	unsigned long                                      bNeedUpdate : 1;                                          // 0x003C(0x0004)
...
{
public:
	unsigned long                                      bBotMode : 1;                                             // 0x0040(0x0004)
	unsigned long                                      bOverlapControl : 1;                                      // 0x0040(0x0004)
	struct FString                                     strGameState[0x2];                                        // 0x0044(0x000C) (Localized, NeedCtorLink)
	...
	TArray<struct FImage>                              SupplyImage;                                              // 0x00B4(0x000C) (NeedCtorLink)
	...
	struct FString                                     strHeader[0x6];                                           // 0x01A0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strTitle;                                                 // 0x01E8(0x000C) (NeedCtorLink)
	struct FString                                     strCurGameState;                                          // 0x01F4(0x000C) (NeedCtorLink)
	struct FString                                     strMapName;                                               // 0x0200(0x000C) (NeedCtorLink)
	struct FString                                     strData[0x5];                                             // 0x020C(0x000C) (NeedCtorLink)
	...
	bool Render(class UCanvas* C, float Delta);
	void SetData(const struct FString& RoomName, int GameState, const struct FString& MapName, class UMaterial* MapImg, TArray<class UMaterial*> supplyImg, const struct FString& roommaster, const struct FString& GameMode, const struct FString& Weapon, const struct FString& HardCore, const struct FString& gamerunning, bool bBotMode);
...
{
public:
	struct FString                                     DefaultRandomRoomName;                                    // 0x04C0(0x000C) (NeedCtorLink)
	...
	TArray<struct FGameModeInfo>                       GameModeInfos;                                            // 0x053C(0x000C) (NeedCtorLink)
	int                                                DefaultRoomNamesCount;                                    // 0x0548(0x0004) (Localized)
	struct FString                                     DefaultRoomNames[0x64];                                   // 0x054C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionMakeRoom;                                          // 0x09FC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionRoomName;                                          // 0x0A08(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionPassword;                                          // 0x0A14(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionMap;                                               // 0x0A20(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionGameMode;                                          // 0x0A2C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionCapacity;                                          // 0x0A38(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionWeaponRestriction;                                 // 0x0A44(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionScore;                                             // 0x0A50(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionTime;                                              // 0x0A5C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionBlance;                                            // 0x0A68(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionReSpawn;                                           // 0x0A74(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionRandom;                                            // 0x0A80(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionFixed;                                             // 0x0A8C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     CaptionDefenceModeLevel;                                  // 0x0A98(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabeDF_Difficult[0x4];                                 // 0x0AA4(0x000C) (Localized, NeedCtorLink)
	...
	TArray<class UBTOwnerDrawCaptionButtonHK*>         GameModeBtnList;                                          // 0x0B00(0x000C) (NeedCtorLink)
	unsigned char                                      nSelGameMode;                                             // 0x0B0C(0x0001)
	...
	int GetMapIndex();
	struct FString GetMapName();
	struct FString GetMapFriendlyName();
	int GetGameModeIndex();
	void SetGameModeIndex(int idx);
	void SetGameModeByExtraDataIndex(int idx);
	struct FString GetGameModeClass();
...
public:
	...
	bool Render(class UCanvas* C, float Delta);
	void Update(class UCanvas* C, float Delta);
	void SetData(const struct FString& str);
	void Init();
};
...
public:
	...
	unsigned long                                      isChangeTTInfo : 1;                                       // 0x05B8(0x0004)
	unsigned long                                      bShowSubModeToolTip : 1;                                  // 0x05B8(0x0004)
...
public:
	...
	struct FString                                     ColumnName;                                               // 0x0030(0x000C) (Edit, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	...
	TEnumAsByte<EAutoColumnType>                       ColumnType;                                               // 0x0040(0x0001) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0041(0x0003) MISSED OFFSET
	TArray<struct FImage>                              ColumnImageList;                                          // 0x0044(0x000C) (NeedCtorLink)
	struct FImage                                      ColumnBackgroundImage;                                    // 0x0050(0x0020)
	struct FScriptDelegate                             __IntToImageIndex__Delegate;                              // 0x0070(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __FloatToImageIndex__Delegate;                            // 0x0078(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __IntToString__Delegate;                                  // 0x0080(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __FloatToString__Delegate;                                // 0x0088(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __CustomDraw__Delegate;                                   // 0x0090(0x000C) (NeedCtorLink)
	...
	struct FString FloatToString(float Input);
	struct FString IntToString(int Input);
	int FloatToImageIndex(float Input);
	int IntToImageIndex(int Input);
	class UBTAutoColumnListHeaderHK* STATIC_MakeHeader(const struct FString& CName, float cPerc, TEnumAsByte<EAutoColumnType> ct);
};
...
public:
	...
	struct FString                                     strHeader[0x6];                                           // 0x01C0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strTitle;                                                 // 0x0208(0x000C) (NeedCtorLink)
	struct FString                                     strCurGameState;                                          // 0x0214(0x000C) (NeedCtorLink)
	struct FString                                     strMapName;                                               // 0x0220(0x000C) (NeedCtorLink)
	struct FString                                     strData[0x6];                                             // 0x022C(0x000C) (NeedCtorLink)
	...
	struct FString                                     strAlienModeLimit;                                        // 0x028C(0x000C) (Localized, NeedCtorLink)
	...
	bool RenderFixed(class UCanvas* C, float Delta);
	bool Render(class UCanvas* C, float Delta);
	void SetData(const struct FString& RoomName, int GameState, const struct FString& MapName, class UMaterial* MapImg, TArray<class UMaterial*> supplyImg, const struct FString& roommaster, const struct FString& GameMode, const struct FString& Weapon, const struct FString& HardCore, const struct FString& gamerunning, bool bBotMode, const struct FString& CurMaxUser, int GameModeNum);
	void ChangeSelectedIndex(int i);
	void Init();
};
...
public:
	...
	unsigned long                                      CaptionScroll : 1;                                        // 0x03C0(0x0004)
	struct FString                                     OriginalCaption;                                          // 0x03C4(0x000C) (NeedCtorLink)
...
{
public:
	TArray<struct FString>                             arrLeftStr;                                               // 0x0330(0x000C) (NeedCtorLink)
	unsigned long                                      bAutoShowScrollBar : 1;                                   // 0x033C(0x0004)
	unsigned long                                      bActiveCursor : 1;                                        // 0x033C(0x0004)
	...
	unsigned long                                      bMaxRowItem : 1;                                          // 0x034C(0x0004)
	int                                                topIdx;                                                   // 0x0350(0x0004)
	int                                                curIdx;                                                   // 0x0354(0x0004)
	TArray<struct FText>                               ASLRowList;                                               // 0x0358(0x000C) (NeedCtorLink)
	int                                                maxFontSize;                                              // 0x0364(0x0004)
	struct FImage                                      SelectImage;                                              // 0x0368(0x0020)
	struct FImage                                      LastSelectedImage;                                        // 0x0388(0x0020)
	struct FScriptDelegate                             __CustomDraw__Delegate;                                   // 0x03A8(0x000C) (NeedCtorLink)
	...
	bool PopRow();
	void Clear();
	void AddRowFinal(class UCanvas* saveC, const struct FString& Text, const struct FColor& fntColor, const struct FColor& fntShadowColor);
	void AddRowColor(class UCanvas* C, const struct FString& Text, const struct FColor& Front);
	void AddRow(class UCanvas* C, const struct FString& Text);
	void AddLineRow(class UCanvas* C, const struct FString& Text);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void InitScrollBar();
};
...
{
public:
	unsigned long                                      bClanMarkSize128 : 1;                                     // 0x0040(0x0004)
...
{
public:
	unsigned long                                      bDrawArrow : 1;                                           // 0x0040(0x0004)
	unsigned long                                      bRenderText : 1;                                          // 0x0040(0x0004)
	struct FImage                                      back;                                                     // 0x0044(0x0020)
	struct FImage                                      Gauge;                                                    // 0x0064(0x0020)
	struct FImage                                      Arrow;                                                    // 0x0084(0x0020)
	TArray<int>                                        DataArray;                                                // 0x00A4(0x000C) (NeedCtorLink)
...
public:
	...
	TArray<class UBTAutoColumnListHK*>                 ACLMsg;                                                   // 0x0354(0x000C) (NeedCtorLink)
	TArray<class UBTContextMenuHK*>                    CMMsg;                                                    // 0x0360(0x000C) (NeedCtorLink)
	struct FString                                     strCombatState[0x3];                                      // 0x036C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strConnected;                                             // 0x0390(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strFriend;                                                // 0x039C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strClan;                                                  // 0x03A8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDeny;                                                  // 0x03B4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPCBang;                                                // 0x03C0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strOffLine;                                               // 0x03CC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLogout;                                                // 0x03D8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strMainPCBang[0x4];                                       // 0x03E4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strWinLose;                                               // 0x0414(0x000C) (Localized, NeedCtorLink)
	struct FScriptDelegate                             __OnPopupChannel__Delegate;                               // 0x0420(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupFriend__Delegate;                                // 0x0428(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupClan__Delegate;                                  // 0x0430(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupPCBang__Delegate;                                // 0x0438(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupChannelCheck__Delegate;                          // 0x0440(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupFriendCheck__Delegate;                           // 0x0448(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupClanCheck__Delegate;                             // 0x0450(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPopupPCBangCheck__Delegate;                           // 0x0458(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __ChannelUserList_OnHitBottom__Delegate;                  // 0x0460(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __ChannelUserList_OnHitTop__Delegate;                     // 0x0468(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __ChannelUserList_OnAdjustWindow__Delegate;               // 0x0470(0x000C) (NeedCtorLink)
	...
	void RemoveChannelUser(int UID);
	int FindFriendFromUserName(const struct FString& UserName);
	void AddPCBangUser(const struct FString& UserName, int ClanMark, int ClanBG, int ClanBL, const struct FString& ClanName, int Level, const struct FString& ServerName, const struct FString& ServerIP, int serverPort, int CurPos, int ChannelNum, const struct FString& ChannelNickName, int RoomNum, int ClanGrade, int ClanWin, int ClanLose, unsigned char IsLookForClan, int IsCombat, int ClanLevel, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3);
	void AddClanUser(const struct FString& UserName, int Level, const struct FString& ServerName, const struct FString& ServerIP, int serverPort, int CurPos, int ChannelNum, const struct FString& ChannelNickName, int RoomNum, int ClanGrade, int IsCombat, int ClanWinCnt, int ClanLoseCnt, const struct FString& ClanSelfIntro, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3);
	void AddFriendUser(const struct FString& UserName, int ClanMark, int ClanBG, int ClanBL, const struct FString& ClanName, int Level, const struct FString& ServerName, const struct FString& ServerIP, int serverPort, int CurPos, int ChannelNum, const struct FString& ChannelNickName, int RoomNum, int ClanGrade, int IsCombat, int ClanWinCnt, int ClanLoseCnt, unsigned char IsLookForClan, int ClanLevel, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3);
	void ReplaceChannelUser(int Index, int ClanPattern, int ClanBG, int ClanBL, const struct FString& ClanName, int Level, const struct FString& UserName, int UID, int ClanGrade, int ClanWinCnt, int ClanLoseCnt, unsigned char IsLookForClan, int ClanLevel, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3);
	void AddChannelUser(int ClanPattern, int ClanBG, int ClanBL, const struct FString& ClanName, int Level, const struct FString& UserName, int UID, int ClanGrade, int ClanWinCnt, int ClanLoseCnt, unsigned char IsLookForClan, int ClanLevel, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3);
};
...
public:
	...
	struct FString GetCurPos(int row);
	int GetLevel(int row);
	struct FString GetWinLose(int row);
	struct FString GetCombatState(int row);
	void Internal_OnRendered(class UCanvas* Canvas);
	void LC0_Draw(class UCanvas* C, float L, float t, float R, float B, const struct FACLData& Data, int Column, int row);
	void SortByConnectionStatus();
};
...
public:
	...
	int GetChannelNum(int row);
	struct FString GetServerName(int row);
	struct FString GetDataPerColumn0_strValue(int row);
	int GetServerPort(int row);
	int GetCurPos(int row);
	struct FString GetServerIP(int row);
	int GetRoomNumber(int row);
...
public:
	...
	unsigned long                                      bSlideShow : 1;                                           // 0x03CC(0x0004)
	int                                                SlideShowIndex;                                           // 0x03D0(0x0004)
	int                                                NextShowIndex;                                            // 0x03D4(0x0004)
	TArray<struct FImage>                              SlideImage;                                               // 0x03D8(0x000C) (NeedCtorLink)
...
public:
	struct FImage                                      CommonSizeImg;                                            // 0x0460(0x0020)
	struct FString                                     strWinLose;                                               // 0x0480(0x000C) (Localized, NeedCtorLink)
	...
	int GetUserID(int row);
	struct FString GetClanName(int row);
	bool RemoveTeamMember(const struct FString& UserName);
	void AddTeamMember(int UID, const struct FString& UserName, int Level, int ClanGrade, int ClanWinCnt, int ClanLoseCnt, int ClanPattern, int ClanBG, int ClanBL, int Leader, const struct FString& ClanName, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3);
};
...
{
public:
	struct FString                                     strWeapon;                                                // 0x0330(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSkill;                                                 // 0x033C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strQuickSlot;                                             // 0x0348(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRSA;                                                   // 0x0354(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strAF;                                                    // 0x0360(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	struct FString                                     strButtonWeapon[0xB];                                     // 0x03FC(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strMainMenu[0x5];                                         // 0x04DC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuAll[0x3];                                       // 0x0518(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuWeapon[0x4];                                    // 0x053C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuEquip[0x6];                                     // 0x056C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuSpecial[0x4];                                   // 0x05B4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuCash[0x3];                                      // 0x05E4(0x000C) (Localized, NeedCtorLink)
	TArray<struct FString>                             astrSubMenuAll;                                           // 0x0608(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuWeapon;                                        // 0x0614(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuEquip;                                         // 0x0620(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuSpecial;                                       // 0x062C(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuCash;                                          // 0x0638(0x000C) (NeedCtorLink)
	class UTabControlMocker*                           TabControl[0x2];                                          // 0x0644(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawCaptionButtonHK*                 MainButton[0x5];                                          // 0x064C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 SubButton[0x6];                                           // 0x0660(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelItemList;                                          // 0x0678(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelItemList;                                            // 0x0688(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbTPItemList;                                             // 0x068C(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTTPItemListHK*                             TPItemList;                                               // 0x069C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strMenuButton[0x7];                                       // 0x06A0(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbMenuButton;                                             // 0x06F4(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawCaptionButtonHK*                 MenuButton;                                               // 0x0704(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTItemInfoHorzBoxHK*                        InfoBox;                                                  // 0x0708(0x0004) (ExportObject, NeedCtorLink, EditInline)
	int                                                CurrentRepairMode;                                        // 0x070C(0x0004)
	int                                                EquipItemCount;                                           // 0x0710(0x0004)
	TArray<struct FBtrDouble>                          EquipItemList;                                            // 0x0714(0x000C) (NeedCtorLink)
	TArray<struct FBtrDouble>                          InvenItemList;                                            // 0x0720(0x000C) (NeedCtorLink)
	TArray<struct FString>                             Equip_DamegeItemNames;                                    // 0x072C(0x000C) (NeedCtorLink)
	TArray<struct FString>                             Inven_DamegeItemNames;                                    // 0x0738(0x000C) (NeedCtorLink)
	struct FString                                     strCash;                                                  // 0x0744(0x000C) (Localized, NeedCtorLink)
	TArray<class UBTOwnerDrawImageHK*>                 SlotNum;                                                  // 0x0750(0x000C) (NeedCtorLink)
	class UBTOwnerDrawImageHK*                         SlotTemp;                                                 // 0x075C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	TArray<class UBTOwnerDrawImageHK*>                 EquipItemSlot;                                            // 0x0760(0x000C) (NeedCtorLink)
	class UBTOwnerDrawImageHK*                         EquipItemSlotTemp;                                        // 0x076C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned char                                      MainTabBtnIdx;                                            // 0x0770(0x0001)
	unsigned char                                      SubTabBtnIdx;                                             // 0x0771(0x0001)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0772(0x0002) MISSED OFFSET
	TArray<class UBTOwnerDrawCaptionButtonHK*>         ItemSubMenuBtn;                                           // 0x0774(0x000C) (NeedCtorLink)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonLocal;                                              // 0x0780(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTWeaponLIst*                               WList;                                                    // 0x0784(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      SendProtocall : 1;                                        // 0x0788(0x0004)
	struct FString                                     strSlot;                                                  // 0x078C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strEquipItem[0x7];                                        // 0x0798(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strEquipMsg;                                              // 0x07EC(0x000C) (Localized, NeedCtorLink)
	int                                                nOldMouseX;                                               // 0x07F8(0x0004)
	int                                                nOffsetMouseDis;                                          // 0x07FC(0x0004)
	class UBTOwnerDrawImageHK*                         LockImage;                                                // 0x0800(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FScriptDelegate                             __deleShowCashChargeWindow__Delegate;                     // 0x0804(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __dele_StopWebzenWebzenInvenList__Delegate;               // 0x080C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __dele_sfReqWebzenInvenList__Delegate;                    // 0x0814(0x000C) (NeedCtorLink)
	...
	bool ShowItemRenewWindow(class UBTROItemBoxHK* Ro, unsigned char cashType);
	void SelectCoin(int buyType, int cashType, class UBTROItemBoxHK* Ro);
	...
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void ItemList_EndDrag(class UGUIComponent* Sender, bool bAccepted);
	bool ItemList_BeginDrag(class UGUIComponent* Sender);
	...
	bool ChangeSubButton(TArray<struct FString> strTemp);
	void SetInfoBox(int ItemIndex);
	bool dele_sfReqWebzenInvenList(const struct FString& Type);
	...
	void GetCashItemInfo(class UwItemBoxHK* ib, class UwItemBoxCashHK* cii, TArray<int>* temp);
...
// 0x039C (0x06CC - 0x0330)
class UBTTPInventoryQuickSlotHK : public UGUITabPanel
{
public:
	float                                              DeActiveMouseX;                                           // 0x0330(0x0004)
	float                                              DeActiveMouseY;                                           // 0x0334(0x0004)
	class UButtonGroups*                               InvenGroup;                                               // 0x0338(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UButtonGroups*                               QSButtonGroup;                                            // 0x033C(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UButtonGroups*                               QSNameGroup;                                              // 0x0340(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	...
	struct FString                                     strButtonChangeName;                                      // 0x0348(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strQuickSlot;                                             // 0x0354(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strUnRegister;                                            // 0x0360(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strOK;                                                    // 0x036C(0x000C) (Localized, NeedCtorLink)
	TArray<struct FSaveQuickSlot>                      SaveQS;                                                   // 0x0378(0x000C) (NeedCtorLink)
	struct FFloatBox                                   fbLabelTagTop[0x5];                                       // 0x0384(0x0010)
	struct FFloatBox                                   fbLabelTagBottom[0x5];                                    // 0x03D4(0x0010)
	class UBTOwnerDrawImageHK*                         LabelTagTop[0x5];                                         // 0x0424(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelTagBottom[0x5];                                      // 0x0438(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbButtonTag[0x5];                                         // 0x044C(0x0010)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonTag[0x5];                                           // 0x049C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbButtonChangeName[0x5];                                  // 0x04B0(0x0010)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonChangeName[0x5];                                    // 0x0500(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbEditChangeName[0x5];                                    // 0x0514(0x0010)
	class UBTEditBoxHK*                                EditChangeName[0x5];                                      // 0x0564(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbButtonQuickSlot[0x9];                                   // 0x0578(0x0010)
	struct FString                                     strButtonQuickSlot[0x9];                                  // 0x0608(0x000C) (Localized, NeedCtorLink)
	class UBTItemBoxButtonHK*                          ButtonQuickSlot[0x9];                                     // 0x0674(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTTPChatHK*                                 TPTemp;                                                   // 0x0698(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strLabelWarning;                                          // 0x069C(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbLabelWarning;                                           // 0x06A8(0x0010)
	class UBTOwnerDrawImageHK*                         LabelWarning;                                             // 0x06B8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 btnModify[0x2];                                           // 0x06BC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FScriptDelegate                             __delegateUpdateQuickSlot__Delegate;                      // 0x06C4(0x000C) (NeedCtorLink)
	...
	bool FindAndRemoveItem(const struct FBtrDouble& UniqueID);
	bool OnPreDraw(class UCanvas* C);
	void EditChangeName_OnDeActive();
	bool ButtonChangeName_OnClick(class UGUIComponent* Sender);
	bool ButtonTag_OnClick(class UGUIComponent* Sender);
	void SetDefaultButtonImage();
	bool IsEmptyQuickSlot(int Index);
	bool EditChangeName_OnEnter(class UGUIComponent* Sender, const struct FString& qname);
	void ShowSkillTransparent(class UBTROItemBoxHK* Skill_1, class UBTROItemBoxHK* Skill_2, class UBTROItemBoxHK* Skill_3, class UBTROItemBoxHK* Skill_4);
	void ShowWeaponTransparent(class UBTROItemBoxHK* MainWeapon, class UBTROItemBoxHK* SubWeapon, class UBTROItemBoxHK* ThrowWeapon1, class UBTROItemBoxHK* ThrowWeapon2, class UBTROItemBoxHK* Knife);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void delegateUpdateQuickSlot(int i);
};
...
{
public:
	unsigned long                                      bIgnoreMouseOnState : 1;                                  // 0x0330(0x0004)
	unsigned long                                      bIgnoreFocusedState : 1;                                  // 0x0330(0x0004)
	...
	TArray<class URenderObject*>                       DataList;                                                 // 0x0360(0x000C) (NeedCtorLink)
	unsigned long                                      isHaveSubMenuBtn : 1;                                     // 0x036C(0x0004)
	TArray<class UBTItemListMenuBtn*>                  SubMenuBtn;                                               // 0x0370(0x000C) (NeedCtorLink)
	class UBTRODecorateStringHK*                       ItemToolTip;                                              // 0x037C(0x0004)
	unsigned long                                      bShowSkillToolTip : 1;                                    // 0x0380(0x0004)
...
{
public:
	unsigned long                                      bShopItem : 1;                                            // 0x0384(0x0004)
	unsigned long                                      bShowOnlyInventory : 1;                                   // 0x0384(0x0004)
	TArray<class UBTROItemBoxHK*>                      DataPool;                                                 // 0x0388(0x000C) (NeedCtorLink)
	unsigned long                                      bSortAdd : 1;                                             // 0x0394(0x0004)
	...
	void ShowItemOverOne(TEnumAsByte<EItemType> one, TEnumAsByte<EItemType> two);
	void ShowOnlyOne(TEnumAsByte<EItemType> one);
	void ShowEquipItemAll();
	void ShowAll(TEnumAsByte<EItemType> Max, TEnumAsByte<EItemType> Min);
	void ResetItem();
	void ClearItem();
	...
	void GetItemFromItemID(int ItemID, TArray<class UBTROItemBoxHK*>* Arr);
...
public:
	...
	unsigned long                                      bUseCache : 1;                                            // 0x0048(0x0004)
	int                                                RibbonState;                                              // 0x004C(0x0004)
	unsigned long                                      bSelect : 1;                                              // 0x0050(0x0004)
	unsigned long                                      bStartAni : 1;                                            // 0x0050(0x0004)
	float                                              RollAniStep;                                              // 0x0054(0x0004)
	int                                                RollCount;                                                // 0x0058(0x0004)
	int                                                RollMaxCount;                                             // 0x005C(0x0004)
	float                                              RollStartX;                                               // 0x0060(0x0004)
	unsigned long                                      bScaleAni : 1;                                            // 0x0064(0x0004)
	float                                              ScaleAniStep;                                             // 0x0068(0x0004)
	float                                              ScaleStartX;                                              // 0x006C(0x0004)
	unsigned long                                      bDragMode : 1;                                            // 0x0070(0x0004)
	unsigned long                                      bRedAuction : 1;                                          // 0x0070(0x0004)
	unsigned long                                      bRedState : 1;                                            // 0x0070(0x0004)
	unsigned long                                      bNoReasonRedState : 1;                                    // 0x0070(0x0004)
	unsigned long                                      bDisplayPart : 1;                                         // 0x0070(0x0004)
	struct FText                                       PartName;                                                 // 0x0074(0x001C) (NeedCtorLink)
	struct FString                                     PartSkillName;                                            // 0x0090(0x000C) (NeedCtorLink)
	...
	struct FString                                     strItemName;                                              // 0x00E4(0x000C) (NeedCtorLink)
	...
	struct FImage                                      ItemImage;                                                // 0x0144(0x0020)
	struct FImage                                      EquipLevelImage;                                          // 0x0164(0x0020)
	class UBTROExpBarHK*                               ItemDurability;                                           // 0x0184(0x0004)
	struct FImage                                      RepairIconImage;                                          // 0x0188(0x0020)
	struct FImage                                      CashIconImage;                                            // 0x01A8(0x0020)
	struct FImage                                      PointIconImage;                                           // 0x01C8(0x0020)
	struct FImage                                      Img_Selected;                                             // 0x01E8(0x0020)
	struct FImage                                      Img_MouseOn;                                              // 0x0208(0x0020)
	struct FImage                                      Img_Focus;                                                // 0x0228(0x0020)
	struct FImage                                      Img_Normal;                                               // 0x0248(0x0020)
	unsigned long                                      MouseOnWithNormal : 1;                                    // 0x0268(0x0004)
	unsigned long                                      bDotSight : 1;                                            // 0x0268(0x0004)
	unsigned long                                      bScope : 1;                                               // 0x0268(0x0004)
	unsigned long                                      bSilencer : 1;                                            // 0x0268(0x0004)
	unsigned long                                      bSkill : 1;                                               // 0x0268(0x0004)
	unsigned long                                      bBarrel : 1;                                              // 0x0268(0x0004)
	unsigned long                                      bGunstock : 1;                                            // 0x0268(0x0004)
	struct FImage                                      dotImg;                                                   // 0x026C(0x0020)
	struct FImage                                      scoImg;                                                   // 0x028C(0x0020)
	struct FImage                                      silImg;                                                   // 0x02AC(0x0020)
	struct FImage                                      skiImg;                                                   // 0x02CC(0x0020)
	struct FImage                                      BarrelImg;                                                // 0x02EC(0x0020)
	struct FImage                                      GunstockImg;                                              // 0x030C(0x0020)
	unsigned long                                      bBackgroundInfo : 1;                                      // 0x032C(0x0004)
	unsigned long                                      bShowDurability : 1;                                      // 0x032C(0x0004)
	unsigned long                                      bShowPrice : 1;                                           // 0x032C(0x0004)
	unsigned long                                      bShowDamage : 1;                                          // 0x032C(0x0004)
	unsigned long                                      bShowEquipLevel : 1;                                      // 0x032C(0x0004)
	unsigned long                                      bShowRestrictionLevel : 1;                                // 0x032C(0x0004)
	unsigned long                                      bShowRestrictionPrice : 1;                                // 0x032C(0x0004)
	unsigned long                                      bShowRestrictionDurability : 1;                           // 0x032C(0x0004)
	unsigned long                                      bShowNotShopItem : 1;                                     // 0x032C(0x0004)
	unsigned long                                      bShowPCBangLevel : 1;                                     // 0x032C(0x0004)
	unsigned long                                      bShowLeftCount : 1;                                       // 0x032C(0x0004)
	unsigned long                                      bShowLeftSellDate : 1;                                    // 0x032C(0x0004)
	unsigned long                                      bShowCanRepair : 1;                                       // 0x032C(0x0004)
	unsigned long                                      bShowCanBuy : 1;                                          // 0x032C(0x0004)
	class UBTItemCommonInfoHK*                         MyData;                                                   // 0x0330(0x0004)
	struct FColor                                      colCurrentUntilTime;                                      // 0x0334(0x0004)
	struct FString                                     strCurrentUntilTime;                                      // 0x0338(0x000C) (NeedCtorLink)
	struct FString                                     strLeftCount;                                             // 0x0344(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCannotRepair;                                          // 0x0350(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeBase;                                             // 0x035C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeShop;                                             // 0x0368(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeCommon;                                           // 0x0374(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeNormal;                                           // 0x0380(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeHigh;                                             // 0x038C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeRare;                                             // 0x0398(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeLegend;                                           // 0x03A4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradePCBang;                                           // 0x03B0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeBaseS;                                            // 0x03BC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeShopS;                                            // 0x03C8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeCommonS;                                          // 0x03D4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeNormalS;                                          // 0x03E0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeHighS;                                            // 0x03EC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeRareS;                                            // 0x03F8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeLegendS;                                          // 0x0404(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradePCBangS;                                          // 0x0410(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDurability;                                            // 0x041C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDamage;                                                // 0x0428(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLeftTime[0x6];                                         // 0x0434(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPoint;                                                 // 0x047C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCash;                                                  // 0x0488(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strOneDay;                                                // 0x0494(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCannotBuy;                                             // 0x04A0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDurabilityX;                                           // 0x04AC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCannotExpired;                                         // 0x04B8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strOnlyPCoin;                                             // 0x04C4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strItemCount;                                             // 0x04D0(0x000C) (Localized, NeedCtorLink)
	int                                                RRIndex;                                                  // 0x04DC(0x0004)
	unsigned long                                      bRegisterQuickSlot : 1;                                   // 0x04E0(0x0004)
	struct FString                                     strRestrictionReason[0x8];                                // 0x04E4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strActiveSkillToolTip[0x5];                               // 0x0544(0x000C) (Localized, NeedCtorLink)
	unsigned long                                      bShowModifyIcon : 1;                                      // 0x0580(0x0004)
	struct FFloatBox                                   offset;                                                   // 0x0584(0x0010)
	struct FFloatBox                                   fbItemName;                                               // 0x0594(0x0010)
	unsigned long                                      CheckScrollItemName : 1;                                  // 0x05A4(0x0004)
	class UBTScrollString*                             scrollString;                                             // 0x05A8(0x0004)
	TEnumAsByte<EBTROItemBoxHK_EInvenState>            InvenState;                                               // 0x05AC(0x0001)
	...
	void GetExtraItemString(struct FString* outputString, struct FColor* outputColor);
	...
	struct FString GetCoinAppendString(bool onlyPCoin);
	...
	struct FString GradeToShortText(int Grade);
	struct FString GradeToText(int Grade);
	struct FColor GradeToColor(int Grade, bool bDurabilityX);
	void Init();
	void ChangeState(TEnumAsByte<EBTROItemBoxHK_EInvenState> estate);
};


// Class GUIWarfareControls.BTTPInventoryEquipItem
// 0x015C (0x0494 - 0x0338)
class UBTTPInventoryEquipItem : public UBTTabPanelHK
{
public:
	class UButtonGroups*                               InvenGroup;                                               // 0x0338(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTItemBoxButtonHK*                          EquipItemSlot[0x8];                                       // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbEquipItemSlot[0x8];                                     // 0x035C(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FString                                     strEquipItemSlot[0x8];                                    // 0x03DC(0x000C) (Localized, NeedCtorLink)
	class UBTTcpLink_Channel*                          TcpChannel;                                               // 0x043C(0x0004)
	unsigned long                                      bVisibleAFModel : 1;                                      // 0x0440(0x0004)
	struct FString                                     strAF;                                                    // 0x0444(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRSA;                                                   // 0x0450(0x000C) (Localized, NeedCtorLink)
	class UBTModelHK*                                  UIModel;                                                  // 0x045C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class ABTROModelNew*                               CharacterModel;                                           // 0x0460(0x0004)
	class UBTOwnerDrawImageHK*                         EdgeLine;                                                 // 0x0464(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         AFTeamBG;                                                 // 0x0468(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         RSATeamBG;                                                // 0x046C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	...
	unsigned long                                      bLRMousePressed : 1;                                      // 0x0478(0x0004)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonLR;                                                 // 0x047C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      bRRMousePressed : 1;                                      // 0x0480(0x0004)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonRR;                                                 // 0x0484(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTAutoScrollListHK*                         ChatBox;                                                  // 0x0488(0x0004) (ExportObject, NeedCtorLink, EditInline)
	int                                                nOldMouseX;                                               // 0x048C(0x0004)
	int                                                nOffsetMouseDis;                                          // 0x0490(0x0004)
...
public:
	...
	unsigned long                                      bModifyLight : 1;                                         // 0x03E8(0x0004)
	class AwSkinShell*                                 wLightModel;                                              // 0x03EC(0x0004)
	TArray<struct FName>                               AnimNames;                                                // 0x03F0(0x000C) (NeedCtorLink)
	...
	unsigned char                                      LightOnOff[0x5];                                          // 0x0550(0x0001)
	...
	struct FName                                       NoHaveWeaponIdle;                                         // 0x05D0(0x0004)
...
// 0x0058 (0x0524 - 0x04CC)
class UBTItemBoxButtonHK : public UBTOwnerDrawCaptionButtonHK
{
public:
	class UBTROItemBoxHK*                              itemBox;                                                  // 0x04CC(0x0004)
	int                                                DefaultSlotItemID;                                        // 0x04D0(0x0004)
	struct FBtrDouble                                  DefaultSlotUniqueID;                                      // 0x04D4(0x0008)
	struct FString                                     DefaultSlotName[0x2];                                     // 0x04DC(0x000C) (NeedCtorLink)
	struct FPlane                                      DefaultSlotModulate;                                      // 0x04F4(0x0010)
	struct FImage                                      DefaultSlotImage;                                         // 0x0504(0x0020)
...
public:
	...
	struct FString                                     strLabel[0x4];                                            // 0x05B0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPoint;                                                 // 0x05E0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCount;                                                 // 0x05EC(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	struct FString                                     strLabel[0x5];                                            // 0x05A4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPoint;                                                 // 0x05E0(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	struct FString                                     strButtonRepair[0x2];                                     // 0x05D4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strEquipItemDescription;                                  // 0x05EC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strEquipItemWarning[0x2];                                 // 0x05F8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strInvenItemDescription;                                  // 0x0610(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strInvenItemWarning[0x2];                                 // 0x061C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabel[0x3];                                            // 0x0634(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPoint;                                                 // 0x0658(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	struct FString                                     strChargeCash;                                            // 0x03A4(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strRedeemCodesBtn;                                        // 0x03C4(0x000C) (Localized, NeedCtorLink)
	struct FScriptDelegate                             __deleClickChargeCash__Delegate;                          // 0x03D0(0x000C) (NeedCtorLink)
	...
	void SendCodes(const struct FString& codes);
	...
	void AddButton(const struct FFloatBox& fbButton, const struct FString& strCaption, int FontSize, TEnumAsByte<EDrawType> dt, class UBTOwnerDrawCaptionButtonHK** AddButton);
...
{
public:
	unsigned long                                      bTabControlMode : 1;                                      // 0x02BC(0x0004)
	unsigned long                                      bMultiSelect : 1;                                         // 0x02BC(0x0004)
	int                                                selectIndex;                                              // 0x02C0(0x0004)
	TArray<class UBTOwnerDrawCaptionButtonHK*>         ButtonList;                                               // 0x02C4(0x000C) (NeedCtorLink)
...
{
public:
	struct FString                                     strLabel[0x2];                                            // 0x04C0(0x000C) (Localized, NeedCtorLink)
	...
	void Internal_OnOpen();
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void SetData(const struct FString& SelfIntro);
};
...
{
public:
	struct FString                                     strUpArrow;                                               // 0x03BC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDownArrow;                                             // 0x03C8(0x000C) (Localized, NeedCtorLink)
	TArray<struct FText>                               tarray;                                                   // 0x03D4(0x000C) (NeedCtorLink)
	TEnumAsByte<ETextArrayDrawType>                    tArrayDrawType;                                           // 0x03E0(0x0001)
	...
	void Internal_OnRendered(class UCanvas* C);
	void SetRankData(const struct FString& t0, int t1);
	void SetData(const struct FString& t0, const struct FString& t1);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
{
public:
	struct FString                                     strRadioLocation[0x64];                                   // 0x03E4(0x000C) (Localized, NeedCtorLink)
	unsigned char                                      LocationCount;                                            // 0x0894(0x0001)
	...
	unsigned char GetLocationCount();
...
{
public:
	struct FString                                     strRecruitState[0x2];                                     // 0x03E4(0x000C) (Localized, NeedCtorLink)
	...
	void SetRecruitState(unsigned char B);
};
...
public:
	...
	struct FString                                     strClanGrade[0x5];                                        // 0x0488(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strOffLine;                                               // 0x04C4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strOnLine;                                                // 0x04D0(0x000C) (Localized, NeedCtorLink)
	...
	int GetCurPos(int row);
	int GetLevelMarkID(int row);
	struct FString IntToClanGrade(int cg);
	struct FString GetSelfIntro(int row);
	int GetUserGrade(int row);
	struct FString GetUserName(int row);
	void ChangeLevelMarkID(const struct FString& UserName, int LevelMarkID);
	void AddClanMember(unsigned char IsLogOn, int Level, const struct FString& CharName, unsigned char ClanGrade, int LevelMarkID, int TitleMarkID);
	float GetItemHeight(class UCanvas* C);
};
...
{
public:
	struct FString                                     strContextMenuName[0x9];                                  // 0x0428(0x000C) (Localized, NeedCtorLink)
...
{
public:
	struct FString                                     strIssueType[0xC];                                        // 0x0460(0x000C) (Localized, NeedCtorLink)
	...
	void AddNews(const struct FString& IssueDate, unsigned char IssueType, const struct FString& IssuedClanMember);
	struct FString IssueTypeToString(unsigned char IssueType);
	float GetItemHeight(class UCanvas* C);
};
...
{
public:
	struct FString                                     strWinLose[0x2];                                          // 0x0460(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strVS;                                                    // 0x0478(0x000C) (Localized, NeedCtorLink)
	...
	void addResult(const struct FBtrDouble& Date, unsigned char IsWin, const struct FString& EnemyClanname);
	float GetItemHeight(class UCanvas* C);
};
...
{
public:
	struct FString                                     strLabel[0x5];                                            // 0x04C0(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbLabel[0x5];                                             // 0x04FC(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         Label[0x5];                                               // 0x054C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbEdit[0x5];                                              // 0x0560(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         Edit[0x5];                                                // 0x05B0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTComboBoxHK*                               ClanRecruit;                                              // 0x05C4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTComboBoxHK*                               ClanLocation;                                             // 0x05C8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTEditBoxHK*                                ClanKeyword;                                              // 0x05CC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTMultiLineEditBoxHK*                       ClanIntroduction;                                         // 0x05D0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTMultiLineEditBoxHK*                       ClanNotice;                                               // 0x05D4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTLabelLocationHK*                          sampleLocation;                                           // 0x05D8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTLabelRecruitHK*                           sampleRecruit;                                            // 0x05DC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	...
	void Internal_OnOpen();
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void SetData(int loc, int Rec, const struct FString& Keyword, const struct FString& Introduction, const struct FString& Notice, int MyClanGrade);
};
...
{
public:
	struct FString                                     strNoRankState;                                           // 0x0460(0x000C) (Localized, NeedCtorLink)
	...
	void LC0_Draw(class UCanvas* C, float L, float t, float R, float B, const struct FACLData& Data, int Column, int row);
	void AddClan(int ClanMarkPattern, int ClanMarkBG, int ClanMarkBL, const struct FString& ClanName, const struct FString& ClanMaster, const struct FString& ClanMemberCount, const struct FString& ClanCreateDate, const struct FString& ClanHistory, const struct FString& ClanRanking, unsigned char ClanRecruit, int ClanRank, int ClanLevel);
	float GetItemHeight(class UCanvas* C);
};
...
public:
	...
	unsigned long                                      disableBtn : 1;                                           // 0x0048(0x0004)
	int                                                ButtonColor[0xA];                                         // 0x004C(0x0004)
	struct FString                                     MenuName[0xA];                                            // 0x0074(0x000C) (Localized, NeedCtorLink)
	class UGUIController*                              PController;                                              // 0x00EC(0x0004)
	TArray<struct FText>                               MenuText;                                                 // 0x00F0(0x000C) (NeedCtorLink)
...
// 0x0048 (0x0514 - 0x04CC)
class UBTNumericEditBoxHK : public UBTOwnerDrawCaptionButtonHK
{
public:
	int                                                MinValue;                                                 // 0x04CC(0x0004)
	int                                                MaxValue;                                                 // 0x04D0(0x0004)
	unsigned long                                      bReadOnly : 1;                                            // 0x04D4(0x0004)
	struct FString                                     FormatStr;                                                // 0x04D8(0x000C) (NeedCtorLink)
	struct FString                                     OriginalStr;                                              // 0x04E4(0x000C) (NeedCtorLink)
	struct FColor                                      CursorColor;                                              // 0x04F0(0x0004) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FImage                                      cursorImg;                                                // 0x04F4(0x0020)
	...
	bool Internal_OnKeyEvent(float Delta, unsigned char* key, unsigned char* State);
	void SetDataExtra(int Number, const struct FString& Extra);
...
public:
	...
	struct FString                                     StarString;                                               // 0x0498(0x000C) (NeedCtorLink)
...
// 0x0064 (0x039C - 0x0338)
class UBTSliderHK : public UBTTabPanelHK
{
public:
	class UBTOwnerDrawCaptionButtonHK*                 ButtonLeft;                                               // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonRight;                                              // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelSliderBack;                                          // 0x0340(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTSliderGripButtonHK*                       ButtonSliderGrip;                                         // 0x0344(0x0004) (ExportObject, NeedCtorLink, EditInline)
	...
	unsigned long                                      bSmoothSlider : 1;                                        // 0x0364(0x0004)
	unsigned long                                      bActiveCursor : 1;                                        // 0x0364(0x0004)
	unsigned long                                      bGrip : 1;                                                // 0x0364(0x0004)
	unsigned long                                      bCanGrip : 1;                                             // 0x0364(0x0004)
	...
	int                                                SaveXPos;                                                 // 0x037C(0x0004)
	float                                              CurrentValue;                                             // 0x0380(0x0004)
	struct FScriptDelegate                             __SliderValueToString__Delegate;                          // 0x0384(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnChangeValue__Delegate;                                // 0x038C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __CanChangeValue__Delegate;                               // 0x0394(0x000C) (NeedCtorLink)
	...
	void DecrementValue();
	void IncrementValue();
	struct FString SliderValueToString(int Value);
};
...
{
public:
	struct FString                                     strBuying;                                                // 0x0330(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strMyAuction;                                             // 0x033C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSelling;                                               // 0x0348(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	struct FString                                     strAuctionCancel;                                         // 0x0338(0x000C) (Localized, NeedCtorLink)
	class UBTStretchedImageHK*                         BackgroundImage;                                          // 0x0344(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	...
	struct FString                                     strListTopButton[0x8];                                    // 0x035C(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strButtonAuctionCancel;                                   // 0x04A0(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strMainMenu[0x4];                                         // 0x04D8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuAll[0x3];                                       // 0x0508(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuWeapon[0x4];                                    // 0x052C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuEquip[0x5];                                     // 0x055C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuSpecial[0x4];                                   // 0x0598(0x000C) (Localized, NeedCtorLink)
	TArray<struct FString>                             astrSubMenuAll;                                           // 0x05C8(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuWeapon;                                        // 0x05D4(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuEquip;                                         // 0x05E0(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuSpecial;                                       // 0x05EC(0x000C) (NeedCtorLink)
	...
	struct FString                                     strMenuButton[0x3];                                       // 0x064C(0x000C) (Localized, NeedCtorLink)
	...
	TArray<struct FBtrDouble>                          EquipItemList;                                            // 0x06B8(0x000C) (NeedCtorLink)
	TArray<struct FBtrDouble>                          InvenItemList;                                            // 0x06C4(0x000C) (NeedCtorLink)
	TArray<struct FString>                             Equip_DamegeItemNames;                                    // 0x06D0(0x000C) (NeedCtorLink)
	TArray<struct FString>                             Inven_DamegeItemNames;                                    // 0x06DC(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __sfReqAuctioItemListInSelling__Delegate;                 // 0x06E8(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __SortAuctionItemList__Delegate;                          // 0x06F0(0x000C) (NeedCtorLink)
	...
	bool sfReqAuctioItemListInSelling(int Section, const struct FString& Keyword, int ItemRank, unsigned char ItemClassify, unsigned char IsAvailable, int PageNum, int Count, int SortType);
	void Internal_OnRendered(class UCanvas* C);
};


// Class GUIWarfareControls.BTTPAuctionBuyingHK
// 0x048C (0x07C4 - 0x0338)
class UBTTPAuctionBuyingHK : public UBTTabPanelHK
{
public:
	class UBTTcpLink_Channel*                          TcpChannel;                                               // 0x0338(0x0004)
	class UDragObject*                                 DragBox;                                                  // 0x033C(0x0004)
	struct UBTTPAuctionBuyingHK_FReqAuctionList        LockAuctionList;                                          // 0x0340(0x000C)
	class UButtonGroups*                               InvenGroup;                                               // 0x034C(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTStretchedImageHK*                         BackgroundImage;                                          // 0x0350(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FFloatBox                                   fbButtonWeapon[0xA];                                      // 0x0354(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FString                                     strButtonWeapon[0xA];                                     // 0x03F4(0x000C) (Localized, NeedCtorLink)
	class UBTItemBoxButtonHK*                          ButtonWeapon[0xA];                                        // 0x046C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonAF;                                                 // 0x0494(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonRSA;                                                // 0x0498(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      bLRMousePressed : 1;                                      // 0x049C(0x0004)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonLR;                                                 // 0x04A0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      bRRMousePressed : 1;                                      // 0x04A4(0x0004)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonRR;                                                 // 0x04A8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         EdgeLine;                                                 // 0x04AC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         AFTeamBG;                                                 // 0x04B0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         RSATeamBG;                                                // 0x04B4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      bVisibleAFModel : 1;                                      // 0x04B8(0x0004)
	struct FString                                     strAF;                                                    // 0x04BC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRSA;                                                   // 0x04C8(0x000C) (Localized, NeedCtorLink)
	class UBTModelHK*                                  UIModel;                                                  // 0x04D4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class ABTROModelNew*                               CharacterModel;                                           // 0x04D8(0x0004)
	class UBTAutoScrollListHK*                         ChatBox;                                                  // 0x04DC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTItemCommonInfoHK*                         MyData;                                                   // 0x04E0(0x0004)
	struct FString                                     LastBiddingItemName;                                      // 0x04E4(0x000C) (NeedCtorLink)
	struct FString                                     strMainMenu[0x5];                                         // 0x04F0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenu[0x5];                                          // 0x052C(0x000C) (Localized, NeedCtorLink)
	class UTabControlMocker*                           TabControl[0x2];                                          // 0x0568(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawCaptionButtonHK*                 MainButton[0x5];                                          // 0x0570(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 SubButton[0x5];                                           // 0x0584(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strListTopButton[0x8];                                    // 0x0598(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbListTopButton[0x8];                                     // 0x05F8(0x0010)
	class UBTOwnerDrawCaptionButtonHK*                 ListTopButton[0x8];                                       // 0x0678(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         ListTopImage[0x8];                                        // 0x0698(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelItemList;                                          // 0x06B8(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelItemList;                                            // 0x06C8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbACLList;                                                // 0x06CC(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FFloatBox                                   fbACLListScrollBar;                                       // 0x06DC(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTACLAuctionHK*                             ACLList;                                                  // 0x06EC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strMenuButton[0x4];                                       // 0x06F0(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbMenuButton[0x4];                                        // 0x0720(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawCaptionButtonHK*                 MenuButton[0x4];                                          // 0x0760(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbPageButton;                                             // 0x0770(0x0010)
	class UBTPageListButtonHK*                         PageButton;                                               // 0x0780(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTItemInfoHorzBoxHK*                        InfoBox;                                                  // 0x0784(0x0004) (ExportObject, NeedCtorLink, EditInline)
	int                                                RankIdx[0x6];                                             // 0x0788(0x0004)
	int                                                SortIdx[0x5];                                             // 0x07A0(0x0004)
	struct FScriptDelegate                             __SortAuctionItemList__Delegate;                          // 0x07B4(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __sfReqAuctioItemListInBuying__Delegate;                  // 0x07BC(0x000C) (NeedCtorLink)
	...
	void EquipItem();
	void ChangeItemList(int mainTab, int subTab);
	bool sfReqAuctioItemListInBuying(int Section, const struct FString& Keyword, int ItemRank, unsigned char ItemClassify, unsigned char IsAvailable, int PageNum, int Count, int SortType);
	int GetSortIdx();
	int GetRankIdx();
	void MainTabSelect(int tabi, int subtabi, bool bStopLoop);
...
public:
	...
	struct FString                                     strButtonTrade[0x3];                                      // 0x0514(0x000C) (Localized, NeedCtorLink)
	...
	void SetData(int ItemID, int PartID, TArray<struct FString> SellerCharNm, TArray<int> DamageDegree, TArray<int> Price);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
public:
	...
	struct FString                                     strHour;                                                  // 0x04C8(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strLabel[0x5];                                            // 0x0658(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelWarning[0x5];                                     // 0x0694(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelWarning0_0;                                       // 0x06D0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelWarning0_1;                                       // 0x06DC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCount;                                                 // 0x06E8(0x000C) (Localized, NeedCtorLink)
...
// 0x04F8 (0x0830 - 0x0338)
class UBTTPAuctionMyAuctionHK : public UBTTabPanelHK
{
public:
	class UBTTcpLink_Channel*                          TcpChannel;                                               // 0x0338(0x0004)
	class UDragObject*                                 DragBox;                                                  // 0x033C(0x0004)
	struct UBTTPAuctionMyAuctionHK_FReqAuctionList     LockAuctionList;                                          // 0x0340(0x000C)
	class UButtonGroups*                               InvenGroup;                                               // 0x034C(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTStretchedImageHK*                         BackgroundImage;                                          // 0x0350(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FFloatBox                                   fbButtonWeapon[0xA];                                      // 0x0354(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FString                                     strButtonWeapon[0xA];                                     // 0x03F4(0x000C) (Localized, NeedCtorLink)
	...
	class UBTItemCommonInfoHK*                         MyData;                                                   // 0x04E0(0x0004)
	struct FString                                     LastBiddingItemName;                                      // 0x04E4(0x000C) (NeedCtorLink)
	struct FString                                     strMainMenu[0x4];                                         // 0x04F0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuAll[0x3];                                       // 0x0520(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuWeapon[0x4];                                    // 0x0544(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuEquip[0x5];                                     // 0x0574(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuSpecial[0x3];                                   // 0x05B0(0x000C) (Localized, NeedCtorLink)
	TArray<struct FString>                             astrSubMenuAll;                                           // 0x05D4(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuWeapon;                                        // 0x05E0(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuEquip;                                         // 0x05EC(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuSpecial;                                       // 0x05F8(0x000C) (NeedCtorLink)
	class UTabControlMocker*                           TabControl[0x2];                                          // 0x0604(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawCaptionButtonHK*                 MainButton[0x4];                                          // 0x060C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 SubButton[0x5];                                           // 0x061C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strListTopButton[0x8];                                    // 0x0630(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbListTopButton[0x8];                                     // 0x0690(0x0010)
	class UBTOwnerDrawCaptionButtonHK*                 ListTopButton[0x8];                                       // 0x0710(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         ListTopImage[0x8];                                        // 0x0730(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelItemList;                                          // 0x0750(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelItemList;                                            // 0x0760(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbACLList;                                                // 0x0764(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FFloatBox                                   fbACLListScrollBar;                                       // 0x0774(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTACLAuctionHK*                             ACLList;                                                  // 0x0784(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strMenuButton[0x4];                                       // 0x0788(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbMenuButton[0x4];                                        // 0x07B8(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawCaptionButtonHK*                 MenuButton[0x4];                                          // 0x07F8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbPageButton;                                             // 0x0808(0x0010)
	class UBTPageListButtonHK*                         PageButton;                                               // 0x0818(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTItemInfoHorzBoxHK*                        InfoBox;                                                  // 0x081C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FScriptDelegate                             __SortAuctionItemList__Delegate;                          // 0x0820(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __sfReqAuctioItemListInMyAuction__Delegate;               // 0x0828(0x000C) (NeedCtorLink)
	...
	bool ChangeSubButton(TArray<struct FString> strTemp);
	void ChangeItemList(int mainTab, int subTab);
	bool sfReqAuctioItemListInMyAuction(int Section, const struct FString& Keyword, int ItemRank, unsigned char ItemClassify, unsigned char IsAvailable, int PageNum, int Count, int SortType);
	void MainTabSelect(int tabi, int subtabi, bool bStopLoop);
	bool FindAndRemoveItem(const struct FBtrDouble& UniqueID);
	void ChangeVisibleModel(bool bAF);
	bool MenuButton_OnClick(class UGUIComponent* Sender);
...
public:
	...
	struct FString                                     strHTU[0x2];                                              // 0x0468(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDHMS[0x4];                                             // 0x0480(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strUntilTime[0x5];                                        // 0x04B4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strUntilTimeLine[0x5];                                    // 0x04F0(0x000C) (Localized, NeedCtorLink)
	...
	TArray<class UBTAutoColumnListDataHK*>             ACLPoolList;                                              // 0x0558(0x000C) (NeedCtorLink)
	...
	void Clear();
	void AddAuctionItem(int UniqueID, int ItemID, int PartsID, const struct FBtrTime& UntilTime, int CurrentBiddingPrice, int InstantlyBuyingPrice, int ItemDamage, const struct FString& CurrentBiddingUser, const struct FString& SellerName, int ItemCount, bool bShowTime);
	float GetItemHeight(class UCanvas* C);
	struct FString UntilTimeLineToText(int UntilTime);
	struct FString UntilTimeToText(int UntilTime);
...
public:
	...
	struct FString                                     strButtonFirst;                                           // 0x0398(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonPrev;                                            // 0x03A4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonNext;                                            // 0x03B0(0x000C) (Localized, NeedCtorLink)
	struct FPageBox                                    PageInfo;                                                 // 0x03BC(0x0014)
	struct FScriptDelegate                             __ButtonIndex_OnClick__Delegate;                          // 0x03D0(0x000C) (NeedCtorLink)
...
public:
	...
	class UBTStretchedImageHK*                         BackgroundImage;                                          // 0x0344(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FFloatBox                                   fbButtonWeapon[0x8];                                      // 0x0348(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTItemBoxButtonHK*                          ButtonWeapon[0x8];                                        // 0x03C8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strButtonWeapon[0xB];                                     // 0x03E8(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonAF;                                                 // 0x046C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonRSA;                                                // 0x0470(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      bLRMousePressed : 1;                                      // 0x0474(0x0004)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonLR;                                                 // 0x0478(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      bRRMousePressed : 1;                                      // 0x047C(0x0004)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonRR;                                                 // 0x0480(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         EdgeLine;                                                 // 0x0484(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         AFTeamBG;                                                 // 0x0488(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         RSATeamBG;                                                // 0x048C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      bVisibleAFModel : 1;                                      // 0x0490(0x0004)
	struct FString                                     strAF;                                                    // 0x0494(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRSA;                                                   // 0x04A0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strForGift[0x2];                                          // 0x04AC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strForMe[0x2];                                            // 0x04C4(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strMainMenu[0x5];                                         // 0x04E8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuNewAndHot[0x4];                                 // 0x0524(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuWeapon[0x4];                                    // 0x0554(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuEquip[0x6];                                     // 0x0584(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuSpecial[0x4];                                   // 0x05CC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubMenuCashItem[0x3];                                  // 0x05FC(0x000C) (Localized, NeedCtorLink)
	TArray<struct FString>                             astrSubMenuNewAndHot;                                     // 0x0620(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuWeapon;                                        // 0x062C(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuEquip;                                         // 0x0638(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuSpecial;                                       // 0x0644(0x000C) (NeedCtorLink)
	TArray<struct FString>                             astrSubMenuCashItem;                                      // 0x0650(0x000C) (NeedCtorLink)
	class UTabControlMocker*                           TabControl[0x2];                                          // 0x065C(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawCaptionButtonHK*                 MainButton[0x5];                                          // 0x0664(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 SubButton[0x6];                                           // 0x0678(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelItemList;                                          // 0x0690(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelItemList;                                            // 0x06A0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbTPItemList;                                             // 0x06A4(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTTPItemListHK*                             TPItemList;                                               // 0x06B4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strMenuButton[0x3];                                       // 0x06B8(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbMenuButton[0x3];                                        // 0x06DC(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawCaptionButtonHK*                 MenuButton[0x3];                                          // 0x070C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTItemInfoHorzBoxHK*                        InfoBox;                                                  // 0x0718(0x0004) (ExportObject, NeedCtorLink, EditInline)
	int                                                CurrentRepairMode;                                        // 0x071C(0x0004)
	int                                                EquipItemCount;                                           // 0x0720(0x0004)
	TArray<int>                                        EquipItemList;                                            // 0x0724(0x000C) (NeedCtorLink)
	TArray<int>                                        InvenItemList;                                            // 0x0730(0x000C) (NeedCtorLink)
	struct FString                                     SaveWebzenBuyItemName;                                    // 0x073C(0x000C) (NeedCtorLink)
	int                                                nOldMouseX;                                               // 0x0748(0x0004)
	int                                                nOffsetMouseDis;                                          // 0x074C(0x0004)
	class UBTOwnerDrawImageHK*                         LockImage;                                                // 0x0750(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FScriptDelegate                             __deleShowCashChargeWindow__Delegate;                     // 0x0754(0x000C) (NeedCtorLink)
	...
	bool ShowSaveWindow(class UBTROItemBoxHK* Ro, int buyType, unsigned char cashType);
	void SelectCoin(int buyType, int cashType, class UBTROItemBoxHK* Ro);
	void CharRotByDrag();
	...
	void AddSubMenuBtns();
	void fill(TArray<int> ShopItemList);
	void UnequipItem(int ButtonID);
	void EquipItem();
	bool ChangeSubButton(TArray<struct FString> strTemp);
	void ChangeItemList(int mainTab, int subTab);
...
public:
	...
	struct FString                                     strLabel[0x2];                                            // 0x0584(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonAddress;                                         // 0x059C(0x000C) (Localized, NeedCtorLink)
	class UBTROItemBoxHK*                              Ro;                                                       // 0x05A8(0x0004)
	unsigned char                                      cashType;                                                 // 0x05AC(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x05AD(0x0003) MISSED OFFSET
	...
	void SetCashType(unsigned char buyCashType);
...
public:
	...
	unsigned char                                      cashType;                                                 // 0x05F4(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x05F5(0x0003) MISSED OFFSET
	struct FString                                     strLabel[0x3];                                            // 0x05F8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPoint;                                                 // 0x061C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCash;                                                  // 0x0628(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDay;                                                   // 0x0634(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCount;                                                 // 0x0640(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCCoinCash;                                             // 0x064C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonRechargeCash;                                    // 0x0658(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strTerm;                                                  // 0x0664(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strForGift[0x2];                                          // 0x0670(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strForMe[0x2];                                            // 0x0688(0x000C) (Localized, NeedCtorLink)
	class UBTROItemBoxHK*                              Ro;                                                       // 0x06A0(0x0004)
	struct FScriptDelegate                             __deleShowCashChargeWindow__Delegate;                     // 0x06A4(0x000C) (NeedCtorLink)
	...
	bool STATIC_ShowItemBuyWindow(class UGUIController* Controller, class UBTTcpLink_Channel* setTCP, class UBTROItemBoxHK* Ro, int setPoint, int setCash, int setCCoinCash, int buyType, unsigned char cashType);
	int GetCalcCash();
	struct FString GetCoinString();
	void SetData(int iItemID, int myp, int MyC, int myCC, class UwItemBoxHK* itemInfoBase, unsigned char useCashType);
...
public:
	...
	int                                                ItemID;                                                   // 0x04C4(0x0004)
	struct FBtrDouble                                  UniqueID;                                                 // 0x04C8(0x0008)
	unsigned char                                      OptionDay;                                                // 0x04D0(0x0001)
	...
	struct FString                                     strBriefingInfo[0x4];                                     // 0x0544(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strItemRemaingTime;                                       // 0x0588(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRemaingTerm[0x2];                                      // 0x0594(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strItemRenewal;                                           // 0x05AC(0x000C) (Localized, NeedCtorLink)
	...
	void SetOptionDay(unsigned char iDay);
...
public:
	...
	class UBTOwnerDrawImageHK*                         LabelCapsuleName;                                         // 0x0360(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelCapsulePrice;                                        // 0x0364(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbCapsuleList;                                            // 0x0368(0x0010)
	struct FFloatBox                                   fbCapsuleLeftButton;                                      // 0x0378(0x0010)
	struct FFloatBox                                   fbCapsuleRightButton;                                     // 0x0388(0x0010)
	struct FFloatBox                                   fbPageInfo;                                               // 0x0398(0x0010)
	class UBTListWithButton*                           CapsuleList;                                              // 0x03A8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTTPLuckyShopCommon*                        LuckyShopCommon;                                          // 0x03AC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strCapsuleName;                                           // 0x03B0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCapsulePrice;                                          // 0x03BC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strBuyCapsule;                                            // 0x03C8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelIncludeHeader[0x2];                               // 0x03D4(0x000C) (Localized, NeedCtorLink)
	struct FScriptDelegate                             __deleShowCashChargeWindow__Delegate;                     // 0x03EC(0x000C) (NeedCtorLink)
	...
	void fill();
	void InsertCapsuleData(class UBTROCapsuleTitle* capsuleData, TArray<class UBTROCapsuleTitle*>* OutArray);
	void AddButton(const struct FFloatBox& fbButton, const struct FString& strCaption, int FontSize, TEnumAsByte<EDrawType> dt, class UBTOwnerDrawCaptionButtonHK** AddButton);
	void AddLabel(const struct FFloatBox& fbComponent, const struct FString& strCaption, int FontSize, const struct FColor& TextColor, TEnumAsByte<EDrawType> dt, class UBTOwnerDrawImageHK** AddComponent);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void deleShowCashChargeWindow();
...
public:
	class UBTTcpLink_Channel*                          TcpChannel;                                               // 0x0338(0x0004)
	class UwGameManager*                               GameMgr;                                                  // 0x033C(0x0004)
	class UwMatchMaker*                                MM;                                                       // 0x0340(0x0004)
	unsigned long                                      UseItemStateView : 1;                                     // 0x0344(0x0004)
	...
	class UBTOwnerDrawImageHK*                         ImageBestItem;                                            // 0x0378(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelBestItemName;                                        // 0x037C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelBestItemPrice;                                       // 0x0380(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbCapsuleDescription;                                     // 0x0384(0x0010)
	class UBTMultiLineEditBoxHK*                       CapsuleDescription;                                       // 0x0394(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbItemStateBack;                                          // 0x0398(0x0010)
	struct FFloatBox                                   fbItemStateView;                                          // 0x03A8(0x0010)
	class UBTOwnerDrawImageHK*                         ItemStateBack;                                            // 0x03B8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTItemStateBoxButtonHK*                     ItemStateView;                                            // 0x03BC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbBestLeftButton;                                         // 0x03C0(0x0010)
	struct FFloatBox                                   fbBestRightButton;                                        // 0x03D0(0x0010)
	struct FFloatBox                                   fbBuyButton;                                              // 0x03E0(0x0010)
	class UBTOwnerDrawCaptionButtonHK*                 BestLeftButton;                                           // 0x03F0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 BestRightButton;                                          // 0x03F4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 BuyButton;                                                // 0x03F8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelIncludeHeader[0x2];                                // 0x03FC(0x0010)
	class UBTOwnerDrawImageHK*                         LabelIncludeHeader[0x2];                                  // 0x041C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbIncludeItemList;                                        // 0x0424(0x0010)
	class UBTAutoImageListHK*                          IncludeItemList;                                          // 0x0434(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelWinners;                                           // 0x0438(0x0010)
	class UBTOwnerDrawImageScroll*                     LabelWinners;                                             // 0x0448(0x0004) (ExportObject, NeedCtorLink, EditInline)
	int                                                CurrentSelectedCapsuleIndex;                              // 0x044C(0x0004)
	TArray<class UBTLuckyWinner*>                      LuckyWinner;                                              // 0x0450(0x000C) (NeedCtorLink)
	unsigned long                                      HasBestWeaponItem : 1;                                    // 0x045C(0x0004)
	...
	bool Fill_LotteryWinnerList(int CapsuleItemID, unsigned char IsNotification, TArray<struct FString> NickName, TArray<struct FBtrDouble> Time);
...
{
public:
	TArray<class UBTOwnerDrawCaptionButtonHK*>         Buttons;                                                  // 0x0330(0x000C) (NeedCtorLink)
	TArray<class UBTAutoColumnListHK*>                 ACLMail;                                                  // 0x033C(0x000C) (NeedCtorLink)
	...
	struct FString                                     strPoint;                                                 // 0x0414(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCash;                                                  // 0x0420(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strTopButton[0x6];                                        // 0x042C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSendMail;                                              // 0x0474(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRecvMail;                                              // 0x0480(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCashItemMail;                                          // 0x048C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strUndefine;                                              // 0x0498(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDay;                                                   // 0x04A4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strHour;                                                  // 0x04B0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strEmpty;                                                 // 0x04BC(0x000C) (Localized, NeedCtorLink)
	...
	void AddMail(int Panel, int MemoType, int idx, const struct FString& senddate, const struct FString& Sender, const struct FString& Content, int leftdate, int Status, const struct FBtrDouble& ItemUID, int ItemID, int StackCount, int WZStoreSeq, int WZStoreItemSeq, int WZStoreItemType, int Value);
...
public:
	...
	struct FString                                     strLabelTitle;                                            // 0x040C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelReceiver;                                         // 0x0418(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonFriendList;                                      // 0x0424(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelWarning[0x2];                                     // 0x0430(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonSendMail;                                        // 0x0448(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonCancel;                                          // 0x0454(0x000C) (Localized, NeedCtorLink)
	...
	void SetData(const struct FString& receiveUser, const struct FString& ContentText);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
public:
	...
	struct FString                                     strLabelTitle[0x2];                                       // 0x0478(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelSender[0x2];                                      // 0x0490(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelRecvDate[0x2];                                    // 0x04A8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCash;                                                  // 0x04C0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonReply;                                           // 0x04CC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonDelete;                                          // 0x04D8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonReceivePoint;                                    // 0x04E4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButtonReceiveItem;                                     // 0x04F0(0x000C) (Localized, NeedCtorLink)
	...
	void SetData(class UCanvas* C, int TabIndex, int ItemType, const struct FString& Sender, const struct FString& recv_date, const struct FString& Text, int ItemID, const struct FBtrDouble& iItemUID, const struct FString& ExtraText, int StackCount);
	void Clear();
...
public:
	...
	struct FString                                     strPoint;                                                 // 0x031C(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	unsigned long                                      VisibleGaugeBG : 1;                                       // 0x031C(0x0004)
...
// 0x0460 (0x0798 - 0x0338)
class UBTTPMatchResultCommonHK : public UBTTabPanelHK
{
public:
	struct FString                                     strButtonTopLine[0xB];                                    // 0x0338(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelTeamScore;                                        // 0x03BC(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbLabelRoomName;                                          // 0x03C8(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelRoomName;                                            // 0x03D8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbACLResult[0x2];                                         // 0x03DC(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTACLMatchResultHK*                         ACLResult[0x2];                                           // 0x03FC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelACL[0x2];                                          // 0x0404(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelACL[0x2];                                            // 0x0424(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelSelectACL[0x2];                                      // 0x042C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelTeamLogo[0x2];                                     // 0x0434(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelTeamLogo[0x2];                                       // 0x0454(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelTeamResult[0x2];                                   // 0x045C(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelTeamResult[0x2];                                     // 0x047C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelTeamResultMark[0x2];                               // 0x0484(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelTeamResultMark[0x2];                                 // 0x04A4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelTopLine;                                           // 0x04AC(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelTopLine;                                             // 0x04BC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbButtonTopLine[0xB];                                     // 0x04C0(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonTopLine[0xB];                                       // 0x0570(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelSeparator[0xA];                                      // 0x059C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelTeamScore[0x2];                                    // 0x05C4(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelTeamScore[0x2];                                      // 0x05E4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelTeamScoreResult[0x2];                              // 0x05EC(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelTeamScoreResult[0x2];                                // 0x060C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      bDefenceGame : 1;                                         // 0x0614(0x0004)
	class UBTOwnerDrawImageHK*                         ResultMyInfo;                                             // 0x0618(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbResultMyInfo[0x2];                                      // 0x061C(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FFloatBox                                   fbLabelMyInfo[0xD];                                       // 0x063C(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelMyInfo[0xD];                                         // 0x070C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strMyInfo[0x7];                                           // 0x0740(0x000C) (Localized, NeedCtorLink)
	class UClass*                                      ACLMem_ClassName;                                         // 0x0794(0x0004)
...
// 0x035C (0x0694 - 0x0338)
class UBTTPMatchResultPrivateHK : public UBTTabPanelHK
{
public:
	struct FString                                     strButtonTopLine[0xB];                                    // 0x0338(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbLabelRoomName;                                          // 0x03BC(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelRoomName;                                            // 0x03CC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbACLResult;                                              // 0x03D0(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTACLMatchResultHK*                         ACLResult;                                                // 0x03E0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelACL;                                               // 0x03E4(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelACL;                                                 // 0x03F4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelSelectACL;                                           // 0x03F8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelLogo;                                              // 0x03FC(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelLogo;                                                // 0x040C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbLabelTopLine;                                           // 0x0410(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelTopLine;                                             // 0x0420(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbButtonTopLine[0xB];                                     // 0x0424(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonTopLine[0xB];                                       // 0x04D4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         LabelSeparator[0xA];                                      // 0x0500(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         ResultMyInfo;                                             // 0x0528(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbResultMyInfo;                                           // 0x052C(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FFloatBox                                   fbLabelMyInfo[0xD];                                       // 0x053C(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelMyInfo[0xD];                                         // 0x060C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strMyInfo[0x7];                                           // 0x0640(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	unsigned long                                      b1st : 1;                                                 // 0x0450(0x0004)
	int                                                CurrentAni;                                               // 0x0454(0x0004)
	TArray<struct FName>                               AnimNames;                                                // 0x0458(0x000C) (NeedCtorLink)
	...
	unsigned long                                      bLanding : 1;                                             // 0x0580(0x0004)
	...
	unsigned long                                      bBreathOffsetXLeft : 1;                                   // 0x05A8(0x0004) (Transient)
	unsigned long                                      bBreathOffsetYUp : 1;                                     // 0x05A8(0x0004) (Transient)
...
{
public:
	struct FFloatBox                                   fbAlienModeMark;                                          // 0x0798(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelAlienModeMark;                                       // 0x07A8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbAlienModeListBack;                                      // 0x07AC(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTOwnerDrawImageHK*                         LabelAlienModeListBack;                                   // 0x07BC(0x0004) (ExportObject, NeedCtorLink, EditInline)
...
{
public:
	struct FString                                     strLabelInfo;                                             // 0x04D8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelInfo2;                                            // 0x04E4(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	struct FString                                     strLabel[0xC];                                            // 0x0508(0x000C) (Localized, NeedCtorLink)
	...
	TArray<int>                                        ReceivePuzzlePice;                                        // 0x0854(0x000C) (NeedCtorLink)
...
{
public:
	struct FString                                     strLevelUpItemEmpty;                                      // 0x04C0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPoint;                                                 // 0x04CC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelTopLine;                                          // 0x04D8(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strLabelContent;                                          // 0x04F8(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	void Internal_OnOpen();
	void SetPromotionItem(int Exp, TArray<int> ItemID, TArray<int> PartID);
	void SetData(int Level);
	void LabelPromotion_OnEndPhase(int Phase);
	void LabelPromotion_OnStartPhase(int Phase);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
...
{
public:
	struct FString                                     strStatus[0x4];                                           // 0x0460(0x000C) (Localized, NeedCtorLink)
	struct FImage                                      LevelImg;                                                 // 0x0490(0x0020)
	TArray<struct FText>                               tarray;                                                   // 0x04B0(0x000C) (NeedCtorLink)
	...
	class UBTAutoColumnListDataHK* FindTeamMember(int UID);
	bool RemoveTeamMemberByUID(int UID);
	void AddTeamMemeber(bool bMe, int UID, int ClanMark, int ClanBG, int ClanBL, int Level, const struct FString& NickName, const struct FString& ClanName, int Score, int Kill, int Assist, int Death, int Exp, int expup, int Point, int pointup, TArray<int> BonusIDs, int LookingFor, bool bFriendly, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3);
	float GetItemHeight(class UCanvas* C);
};
...
public:
	...
	unsigned long                                      bLMouseDn : 1;                                            // 0x0334(0x0004)
...
// 0x0274 (0x05AC - 0x0338)
class UBTTPMyInfoAllHK : public UBTTabPanelHK
{
public:
	class ABTROModelNew*                               CharacterModel;                                           // 0x0338(0x0004)
	struct FFloatBox                                   fbBackgroundPanel[0x2];                                   // 0x033C(0x0010)
	class UBTOwnerDrawImageHK*                         BackgroundPanel[0x2];                                     // 0x035C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UButtonGroups*                               InvenGroup;                                               // 0x0364(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTStretchedImageHK*                         BackgroundImage;                                          // 0x0368(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FFloatBox                                   fbButtonWeapon[0xA];                                      // 0x036C(0x0010) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FString                                     strButtonWeapon[0xA];                                     // 0x040C(0x000C) (Localized, NeedCtorLink)
	class UBTItemBoxButtonHK*                          ButtonWeapon[0xA];                                        // 0x0484(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonAF;                                                 // 0x04AC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonRSA;                                                // 0x04B0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      bLRMousePressed : 1;                                      // 0x04B4(0x0004)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonLR;                                                 // 0x04B8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	...
	class UBTOwnerDrawImageHK*                         AFTeamBG;                                                 // 0x04C8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         RSATeamBG;                                                // 0x04CC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	unsigned long                                      bVisibleAFModel : 1;                                      // 0x04D0(0x0004)
	struct FString                                     strAF;                                                    // 0x04D4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRSA;                                                   // 0x04E0(0x000C) (Localized, NeedCtorLink)
	class UBTModelHK*                                  UIModel;                                                  // 0x04EC(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTAutoScrollListHK*                         ChatBox;                                                  // 0x04F0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strButtonTab[0x4];                                        // 0x04F4(0x000C) (Localized, NeedCtorLink)
	class UTabControlMocker*                           TabControl;                                               // 0x0524(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbButtonTab[0x4];                                         // 0x0528(0x0010)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonTab[0x4];                                           // 0x0568(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbTPPanel;                                                // 0x0578(0x0010)
	class UBTTPOptionBaseHK*                           TPPanel[0x4];                                             // 0x0588(0x0004) (ExportObject, NeedCtorLink, EditInline)
	int                                                VisiblePanelIdx;                                          // 0x0598(0x0004)
	class UBTTPMyInfoBasicHK*                          TPBasic;                                                  // 0x059C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTTPMyInfoStatHK*                           TPStat;                                                   // 0x05A0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTTPMyInfoRankHK*                           TPRank;                                                   // 0x05A4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTTPMyInfoFriendlyUserHK*                   TPFriendly;                                               // 0x05A8(0x0004) (ExportObject, NeedCtorLink, EditInline)
...
// 0x0118 (0x0818 - 0x0700)
class UBTTPMyInfoFriendlyUserHK : public UBTTPOptionBaseHK
{
public:
	struct FFloatBox                                   fbComboBox;                                               // 0x0700(0x0010)
	class UBTOwnerDrawImageHK*                         LabelMyName;                                              // 0x0710(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	class UBTComboBoxHK*                               ComboFriendlyUser;                                        // 0x0714(0x0004) (Edit, ExportObject, NeedCtorLink, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
	struct FString                                     strLabel[0x14];                                           // 0x0718(0x000C) (Localized, NeedCtorLink)
	struct FScriptDelegate                             __OnChangeFriendlyUser__Delegate;                         // 0x0808(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnHideFriendlyUserList__Delegate;                       // 0x0810(0x000C) (NeedCtorLink)
	...
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void InitializeContent();
	struct FString GetSelectedFriendlyUserName();
	void SetData(bool bMyInfo, int UserID, const struct FString& CharName, const struct FString& ClanName, int CM_Pattern, int CM_BG, int CM_BL, const struct FCharInfo& stCharInfo, const struct FClanInfo& stClanInfo, int ClanLevel);
...
// 0x00E4 (0x07E4 - 0x0700)
class UBTTPMyInfoRankHK : public UBTTPOptionBaseHK
{
public:
	struct FString                                     strMainRank[0xC];                                         // 0x0700(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSubRank[0x4];                                          // 0x0790(0x000C) (Localized, NeedCtorLink)
	class UBTComboBoxHK*                               RankComboBox[0x2];                                        // 0x07C0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	int                                                nContentSettingLength;                                    // 0x07C8(0x0004)
	struct FScriptDelegate                             __OnChangeMainComboBox__Delegate;                         // 0x07CC(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnChangeSubComboBox__Delegate;                          // 0x07D4(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnHideComboBoxList__Delegate;                           // 0x07DC(0x000C) (NeedCtorLink)
	...
	void SetRankingInfo(unsigned char RankingType, unsigned char CommunityType, TArray<struct FString> CharName, TArray<int> CharLevel, TArray<struct FString> ClanName, TArray<int> ClanMarkPattern, TArray<int> ClanMarkBG, TArray<int> ClanMarkBL, TArray<int> Ranking_Accum, TArray<int> Ranking_Accum_Prev, TArray<int> Ranking_Accum_Exp, TArray<int> LevelMarkID, TArray<int> TitleMarkID, TArray<int> Reserved1, TArray<int> Reserved2, TArray<int> Reserved3);
	...
	void InitializeContent(unsigned char RankType, int nRankingCount);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
...
// 0x0168 (0x0868 - 0x0700)
class UBTTPMyInfoStatHK : public UBTTPOptionBaseHK
{
public:
	struct FString                                     strLabel[0x1E];                                           // 0x0700(0x000C) (Localized, NeedCtorLink)
...
// 0x0108 (0x0808 - 0x0700)
class UBTTPMyInfoBasicHK : public UBTTPOptionBaseHK
{
public:
	struct FString                                     strLabel[0x15];                                           // 0x0700(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPlayNetCash;                                           // 0x07FC(0x000C) (Localized, NeedCtorLink)
	...
	void InitializeContent();
	void SetData(int UserID, const struct FString& CharName, const struct FString& ClanName, int CM_Pattern, int CM_BG, int CM_BL, const struct FCharInfo& stCharInfo, const struct FClanInfo& stClanInfo, int ClanLevel);
	void InitializeLabel();
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
public:
	...
	struct FScriptDelegate                             __OnEndCredit__Delegate;                                  // 0x03C8(0x000C) (NeedCtorLink)
...
public:
	...
	unsigned long                                      cullRight : 1;                                            // 0x0030(0x0004)
	struct FString                                     OriginalCaption;                                          // 0x0034(0x000C) (NeedCtorLink)
	...
	void CaptionLeftRight(class UCanvas* C, const struct FString& Caption, const struct FFloatBox& originPos, float FontSize);
	void Internal_OnNextAnimationStart();
	void ProcessScroll(class UCanvas* C, const struct FString& OriginString, const struct FFloatBox& originPos, bool bOn, float FontSize, float fDelta, struct FString* outputString);
	void ProcessScrollPoint(class UCanvas* C, const struct FString& OriginString, float X1, float Y1, float X2, float Y2, bool bOn, float FontSize, float fDelta, struct FString* outputString);
	void InitValue();
};
...
{
public:
	TEnumAsByte<ECheckBoxStyle>                        cbStyle;                                                  // 0x04CC(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x04CD(0x0003) MISSED OFFSET
	int                                                PaddingSize;                                              // 0x04D0(0x0004) (Edit, EditInline, DataBinding, SerializeText, RepNotify, Interp, NonTransactional, EditorOnly, NotForConsole, RepRetry, PrivateWrite, ProtectedWrite, ArchetypeProperty, EditHide, EditTextBox, CrossLevelPassive, CrossLevelActive)
...
{
public:
	class UButtonGroups*                               TextureQualityGroup;                                      // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 TextureQualityButton[0x4];                                // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strTexQuality[0x4];                                       // 0x034C(0x000C) (Localized, NeedCtorLink)
...
{
public:
	class UButtonGroups*                               BGQualityGroup;                                           // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 BGQualityButton[0x3];                                     // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strBGQuality[0x3];                                        // 0x0348(0x000C) (Localized, NeedCtorLink)
...
{
public:
	class UButtonGroups*                               LODGroup;                                                 // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 LODButton[0x4];                                           // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strLOD[0x4];                                              // 0x034C(0x000C) (Localized, NeedCtorLink)
...
{
public:
	class UButtonGroups*                               BTGroup;                                                  // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 CaptionButton[0x2];                                       // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strOnOff[0x2];                                            // 0x0344(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	class UBTRadioOnOffButtonHK*                       ButtonRadio;                                              // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
...
public:
	...
	TArray<struct FText>                               taExpbar;                                                 // 0x0300(0x000C) (NeedCtorLink)
	...
	void OnRendered(class UCanvas* C);
	void SetData(int A, int B, const struct FString& aText, const struct FString& bText);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
public:
	...
	TArray<class UBTAutoColumnListDataHK*>             ACLRowListPool;                                           // 0x046C(0x000C) (NeedCtorLink)
	struct FString                                     strCannotRepair;                                          // 0x0478(0x000C) (Localized, NeedCtorLink)
	struct FString                                     Rewardname[0x2];                                          // 0x0484(0x000C) (Localized, NeedCtorLink)
	...
	struct FString GetDailyReward(int row);
	int GetHelpResourceIndex(int row);
	struct FString GetLastReward(int row);
	struct FString GetReward(int row);
	struct FString GetQuestExtDesc(int row);
	int GetQuestId(int row);
	struct FString GetQuestDesc(int row);
	struct FString GetQuestName(int row);
	struct FString GetPrevQuestDesc(int row);
	struct FString GetPrevQuestName(int row);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	struct FString GetFormatRewardItemString(class UwQuestParam* tempq);
	struct FString GetFormatRewardAttendPuzzleString(class UwQuestParam* tempq);
	struct FString GetFormatRewardString(class UwQuestParam* tempq);
...
{
public:
	struct FString                                     HightLight;                                               // 0x04CC(0x000C) (NeedCtorLink)
	...
	void SetHighLight(const struct FString& Value);
};
...
public:
	...
	unsigned long                                      bUpdateProcess : 1;                                       // 0x004C(0x0004)
	TArray<TEnumAsByte<E_SCROLL_MOVE_TYPE>>            ScrollTypeArray;                                          // 0x0050(0x000C) (NeedCtorLink)
	TArray<float>                                      ScrollDataArray;                                          // 0x005C(0x000C) (NeedCtorLink)
	TArray<TEnumAsByte<E_SCROLL_CHECKEND_TYPE>>        CheckEndArray;                                            // 0x0068(0x000C) (NeedCtorLink)
	TArray<float>                                      CheckDataArray;                                           // 0x0074(0x000C) (NeedCtorLink)
	TArray<TEnumAsByte<E_NEXTANIMATION_ACTION>>        NextActionArray;                                          // 0x0080(0x000C) (NeedCtorLink)
	int                                                CurrentAnimationNum;                                      // 0x008C(0x0004)
	float                                              CheckHoldTime;                                            // 0x0090(0x0004)
	struct FScriptDelegate                             __OnNextAnimationStart__Delegate;                         // 0x0094(0x000C) (NeedCtorLink)
	...
	bool STATIC_CullString(class UCanvas* C, const struct FString& Text, const struct FFloatBox& fbCheck, const struct FFloatBox& fbTarget, float fntSize, struct FString* strOutput);
	void NextAnimation();
	void DoNextAnimation(TEnumAsByte<E_NEXTANIMATION_ACTION> _nextAction);
	...
	void InitValue();
	void AddAnimation(TEnumAsByte<E_SCROLL_MOVE_TYPE> _scrollType, float _scrollData, TEnumAsByte<E_SCROLL_CHECKEND_TYPE> _check, float _checkData, TEnumAsByte<E_NEXTANIMATION_ACTION> _nextAction);
	void ClearAnimation();
...
public:
	...
	TArray<struct FText>                               textAmmosize;                                             // 0x0074(0x000C) (NeedCtorLink)
	TArray<struct FText>                               textSkill;                                                // 0x0080(0x000C) (NeedCtorLink)
	struct FColor                                      plus_c;                                                   // 0x008C(0x0004)
	struct FColor                                      minus_c;                                                  // 0x0090(0x0004)
	struct FString                                     strDamage;                                                // 0x0094(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSpread;                                                // 0x00A0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strViewKick;                                              // 0x00AC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRateofFire;                                            // 0x00B8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strMove;                                                  // 0x00C4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRange;                                                 // 0x00D0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strAmmoSize;                                              // 0x00DC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strSkill;                                                 // 0x00E8(0x000C) (Localized, NeedCtorLink)
	...
	void SetTextDrawType(TEnumAsByte<EDrawType> dt);
	void SetSkill(const struct FString& Skill, const struct FString& mskill);
...
public:
	...
	struct FString                                     strLabel[0x3];                                            // 0x04F0(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawImageHK*                         Label[0x3];                                               // 0x0514(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strPoint;                                                 // 0x0520(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCash;                                                  // 0x052C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPartLabel[0x5];                                        // 0x0538(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strCalcPrice[0x3];                                        // 0x05D8(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strNotify;                                                // 0x0638(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	unsigned long                                      bSelect : 1;                                              // 0x0044(0x0004)
...
{
public:
	struct FString                                     LogStr;                                                   // 0x0330(0x000C) (NeedCtorLink)
...
public:
	...
	struct FString                                     strMapName;                                               // 0x00EC(0x000C) (NeedCtorLink)
	...
	bool Render(class UCanvas* C, float Delta);
	void SetData(const struct FString& MapName, class UMaterial* MapImg, class UMaterial* imgSupply0, class UMaterial* imgSupply1, class UMaterial* imgSupply2);
	void Init();
};
...
public:
	...
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void AddItem(int clanmarkid, int clanmarktype1, int clanmarktype2, int selltype, int DisplayOrder, const struct FString& clanmarkresource32, const struct FString& clanmarkresource128);
	void SetOutlineBorder(int horz, int vert);
};
...
public:
	...
	unsigned long                                      bUseSellMark : 1;                                         // 0x0078(0x0004)
	int                                                selltype[0x3];                                            // 0x007C(0x0004)
	int                                                DisplayOrder[0x3];                                        // 0x0088(0x0004)
	struct FString                                     clanmarkresource32[0x3];                                  // 0x0094(0x000C) (NeedCtorLink)
	struct FString                                     clanmarkresource128[0x3];                                 // 0x00B8(0x000C) (NeedCtorLink)
	...
	bool Render(class UCanvas* C, float Delta);
	void Update(class UCanvas* C, float Delta);
	void SetData(int LayerIndex, int clanmarkid, int clanmarktype1, int clanmarktype2, int selltype, int DisplayOrder, const struct FString& clanmarkresource32, const struct FString& clanmarkresource128);
...
{
public:
	TArray<class UBTROCreateClanMarkHK*>               DataPool;                                                 // 0x0384(0x000C) (NeedCtorLink)
...
{
public:
	unsigned long                                      bSummaryMode : 1;                                         // 0x03BC(0x0004)
	class UwGameManager*                               GameMgr;                                                  // 0x03C0(0x0004)
	class UwQuestParam*                                q;                                                        // 0x03C4(0x0004)
	class UwQuestParam*                                pq;                                                       // 0x03C8(0x0004)
	TArray<struct FText>                               arrPrevQuest;                                             // 0x03CC(0x000C) (NeedCtorLink)
	TArray<struct FText>                               arrCurQuest;                                              // 0x03D8(0x000C) (NeedCtorLink)
	...
	void Internal_OnRendered(class UCanvas* C);
	void SetData(const struct FString& PrevQuestName, const struct FString& PrevQuestDesc, const struct FString& QuestName, const struct FString& QuestDesc, const struct FString& QuestExtDesc, const struct FString& Reward, const struct FString& LastReward);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
{
public:
	class UBTOwnerDrawImageHK*                         BackgroundImg;                                            // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         Title;                                                    // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         RewardItemImage;                                          // 0x0340(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         ItemName;                                                 // 0x0344(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         strBEST[0xA];                                             // 0x0348(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         contents[0xA];                                            // 0x0370(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strPopUp[0xA];                                            // 0x0398(0x000C) (Localized, NeedCtorLink)
	class UBTROItemBoxHK*                              tempROItem;                                               // 0x0410(0x0004)
	...
	bool IsBestItem(int checkItemID, TArray<int> BestItemIDs);
...
public:
	...
	unsigned long                                      ChangedWinners : 1;                                       // 0x0304(0x0004)
	TArray<struct FString>                             Winners;                                                  // 0x0308(0x000C) (NeedCtorLink)
	TArray<struct FBtrDouble>                          WinnersTime;                                              // 0x0314(0x000C) (NeedCtorLink)
	struct FString                                     strWinnersHeader;                                         // 0x0320(0x000C) (Localized, NeedCtorLink)
	...
	bool MakeString(struct FString* strOutput);
	void ClearWinners();
	void AddWinner(const struct FString& winnerName, const struct FBtrDouble& winTime);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};


// Class GUIWarfareControls.BTTPOptionGraphicHK
// 0x017C (0x087C - 0x0700)
class UBTTPOptionGraphicHK : public UBTTPOptionBaseHK
{
public:
	unsigned long                                      bInGameResolutionChanged : 1;                             // 0x0700(0x0004)
	unsigned long                                      bChangeResolution : 1;                                    // 0x0700(0x0004)
	unsigned long                                      bChangeGraphicOption : 1;                                 // 0x0700(0x0004)
	struct FString                                     strDark;                                                  // 0x0704(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strBright;                                                // 0x0710(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLow;                                                   // 0x071C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strHigh;                                                  // 0x0728(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabel[0xA];                                            // 0x0734(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strBrightness;                                            // 0x07AC(0x000C) (Localized, NeedCtorLink)
	class UButtonGroups*                               OptionGroup;                                              // 0x07B8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	int                                                LastSimpleButtonPos;                                      // 0x07BC(0x0004)
	struct FString                                     strResRatio[0x5];                                         // 0x07C0(0x000C) (Localized, NeedCtorLink)
	struct FDisplayModeInfo                            CurrentInfo;                                              // 0x07FC(0x0018)
	struct FDisplayModeInfo                            InitInfo;                                                 // 0x0814(0x0018)
	struct FString                                     strGraphicQuality[0x6];                                   // 0x082C(0x000C) (Localized, NeedCtorLink)
	struct FScriptDelegate                             __OnChangeScreen__Delegate;                               // 0x0874(0x000C) (NeedCtorLink)
	...
	struct FString Content6_ValueToString(int Value);
	void Content2_OnChangeValue(int changeValue);
	struct FString Content2_ValueToString(int Value);
...
// 0x00B4 (0x07B4 - 0x0700)
class UBTTPOptionSoundHK : public UBTTPOptionBaseHK
{
public:
	struct FString                                     strLow;                                                   // 0x0700(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strHigh;                                                  // 0x070C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabel[0xA];                                            // 0x0718(0x000C) (Localized, NeedCtorLink)
	unsigned long                                      bUseSound : 1;                                            // 0x0790(0x0004)
...
// 0x2F7C (0x367C - 0x0700)
class UBTTPOptionInputHK : public UBTTPOptionBaseHK
{
public:
	struct FString                                     strLow;                                                   // 0x0700(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strHigh;                                                  // 0x070C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabel[0x28];                                           // 0x0718(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strFunc[0x28];                                            // 0x08F8(0x000C) (NeedCtorLink)
	struct FString                                     strOn;                                                    // 0x0AD8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strOff;                                                   // 0x0AE4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strToggle;                                                // 0x0AF0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strButton;                                                // 0x0AFC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strWeak;                                                  // 0x0B08(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strStrong;                                                // 0x0B14(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDefaultSensAim;                                        // 0x0B20(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strUseLeftHand;                                           // 0x0B2C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strUseRightHand;                                          // 0x0B38(0x000C) (Localized, NeedCtorLink)
	struct FOptionInputInfo                            InitInfo;                                                 // 0x0B44(0x01B0) (NeedCtorLink)
	struct FOptionInputInfo                            CurrentInfo;                                              // 0x0CF4(0x01B0) (NeedCtorLink)
	struct FInputKeyInfo                               AllKeys[0xFF];                                            // 0x0EA4(0x0028) (Edit, EditConst, NeedCtorLink, NoExport)
	...
	void InitializeLabel();
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void BTOptionKeyButtonHK_OnChangeKey(class UGUIComponent* Sender, const struct FString& NewKey);
	void Content4_OnSelect(bool bOn);
	void Content3_OnSelect(bool bOn);
	void Content1_OnSelect(bool bOn);
	struct FString Content0_ValueToStringAim(int Value);
...
// 0x0174 (0x0874 - 0x0700)
class UBTTPOptionETCHK : public UBTTPOptionBaseHK
{
public:
	struct FETCModeInfo                                CurrentInfo;                                              // 0x0700(0x0020) (NeedCtorLink)
	struct FETCModeInfo                                InitInfo;                                                 // 0x0720(0x0020) (NeedCtorLink)
	struct FString                                     strUsageRecord;                                           // 0x0740(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabel[0x4];                                            // 0x074C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLanguage[0x2];                                         // 0x077C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strMinimapType[0x3];                                      // 0x0794(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRecordResolution[0xC];                                 // 0x07B8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRecordQuality[0x3];                                    // 0x0848(0x000C) (Localized, NeedCtorLink)
	unsigned char                                      iRecordStartOffset;                                       // 0x086C(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x086D(0x0003) MISSED OFFSET
	unsigned long                                      bVoiceLangChanged : 1;                                    // 0x0870(0x0004)
...
{
public:
	struct FString                                     strButtonRadio;                                           // 0x0338(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbButtonRadio;                                            // 0x0344(0x0010)
	class UBTCheckBoxHK*                               ButtonRadio;                                              // 0x0354(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strButtonAdvance;                                         // 0x0358(0x000C) (Localized, NeedCtorLink)
	struct FFloatBox                                   fbButtonAdvance;                                          // 0x0364(0x0010)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonAdvance;                                            // 0x0374(0x0004) (ExportObject, NeedCtorLink, EditInline)
...
public:
	class UBTOwnerDrawImageHK*                         BackgroundImage;                                          // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
	TArray<class UBTOwnerDrawCaptionButtonHK*>         ReceiveBtnList;                                           // 0x033C(0x000C) (NeedCtorLink)
	TArray<class UBTOwnerDrawImageHK*>                 RewardItemImgList;                                        // 0x0348(0x000C) (NeedCtorLink)
	class UwGameManager*                               GameMgr;                                                  // 0x0354(0x0004)
	struct FImage                                      ItemImage;                                                // 0x0358(0x0020)
	class UBTOwnerDrawImageHK*                         AttendBg;                                                 // 0x0378(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawCaptionButtonHK*                 ButtonClose;                                              // 0x037C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	TArray<class UBTOwnerDrawImageScroll*>             RewardItemName;                                           // 0x0380(0x000C) (NeedCtorLink)
	TArray<class UBTOwnerDrawImageHK*>                 RewardItemPoint;                                          // 0x038C(0x000C) (NeedCtorLink)
	TArray<class UBTOwnerDrawImageHK*>                 RewardItemAttend;                                         // 0x0398(0x000C) (NeedCtorLink)
	TArray<class UBTOwnerDrawImageHK*>                 RewardItemAttendCnt;                                      // 0x03A4(0x000C) (NeedCtorLink)
	class UBTOwnerDrawImageHK*                         AttendaceDesc;                                            // 0x03B0(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         AttendaceInit;                                            // 0x03B4(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTOwnerDrawImageHK*                         AttendaceCount;                                           // 0x03B8(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strAttend[0xA];                                           // 0x03BC(0x000C) (Localized, NeedCtorLink)
	class UBTItemInfoToolTipWindow*                    RewardItemInfoToolTip;                                    // 0x0434(0x0004) (ExportObject, NeedCtorLink, EditInline)
	TArray<class UBTOwnerDrawCaptionButtonHK*>         DummyBtn;                                                 // 0x0438(0x000C) (NeedCtorLink)
	TArray<int>                                        RewardItemNameChange;                                     // 0x0444(0x000C) (NeedCtorLink)
...
// 0x0028 (0x04F4 - 0x04CC)
class UBTIconButtonHK : public UBTOwnerDrawCaptionButtonHK
{
public:
	int                                                SpaceINT;                                                 // 0x04CC(0x0004)
	TEnumAsByte<EIconHorzOrder>                        IconSide;                                                 // 0x04D0(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x04D1(0x0003) MISSED OFFSET
	struct FImage                                      IconImage;                                                // 0x04D4(0x0020)
	...
	void OnRendered(class UCanvas* C);
	void SetData(const struct FImage& img, TEnumAsByte<EIconHorzOrder> side, const struct FString& Text, int Space);
};
...
public:
	...
	struct FString                                     strCaption;                                               // 0x04EC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCCoin;                                                 // 0x04F8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPCoin;                                                 // 0x0504(0x000C) (Localized, NeedCtorLink)
	class UBTROItemBoxHK*                              roItemBox;                                                // 0x0510(0x0004)
	int                                                selectBuyType;                                            // 0x0514(0x0004)
	unsigned char                                      selectCashType;                                           // 0x0518(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0519(0x0003) MISSED OFFSET
	struct FScriptDelegate                             __SelectCoin__Delegate;                                   // 0x051C(0x000C) (NeedCtorLink)
	...
	void SelectCoin(int buyType, int cashType, class UBTROItemBoxHK* Ro);
	void UpdateDefaultWindow();
	void STATIC_ShowWindowSelectCashType(class UGUIController* con, class UBTROItemBoxHK* Ro, int _selectBuyType, bool EnablePCoin, bool EnableCCoin);
	void SetDataCash(class UBTROItemBoxHK* Ro, int _selectBuyType, bool EnablePCoin, bool EnableCCoin);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
public:
	...
	unsigned char                                      OptionDay;                                                // 0x04CC(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x04CD(0x0003) MISSED OFFSET
	...
	struct FString                                     strItemRemaingTime;                                       // 0x050C(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strRenewTerm;                                             // 0x0540(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strButtnCash;                                             // 0x0574(0x000C) (Localized, NeedCtorLink)
	...
	struct FString                                     strMyMoney[0x2];                                          // 0x05E4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCount;                                                 // 0x05FC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDay;                                                   // 0x0608(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCash;                                                  // 0x0614(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPoint;                                                 // 0x0620(0x000C) (Localized, NeedCtorLink)
	unsigned char                                      cashType;                                                 // 0x062C(0x0001)
	unsigned char                                      UnknownData01[0x3];                                       // 0x062D(0x0003) MISSED OFFSET
	struct FString                                     strCCoinCash;                                             // 0x0630(0x000C) (Localized, NeedCtorLink)
	...
	struct FString GetFormatMoney(int iCurMoney, int iPayMoney, const struct FString& strMoney);
...
public:
	...
	TArray<int>                                        CapsuleIDList;                                            // 0x0314(0x000C) (NeedCtorLink)
	unsigned long                                      CapsuleFillEnd : 1;                                       // 0x0320(0x0004)
	struct FString                                     strCapsuleCount;                                          // 0x0324(0x000C) (Localized, NeedCtorLink)
	struct FScriptDelegate                             __ChangeComboBox__Delegate;                               // 0x0330(0x000C) (NeedCtorLink)
...
{
public:
	struct FString                                     ItemName;                                                 // 0x04C0(0x000C) (NeedCtorLink)
	...
	struct FString                                     strLabel[0x2];                                            // 0x059C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelWarning[0x4];                                     // 0x05B4(0x000C) (Localized, NeedCtorLink)
	...
	void Internal_OnOpen();
	void Internal_OnRendered(class UCanvas* C);
	void SetData(int MyPoint, int InstantlyPrice, int iUniqueID, int iItemID, int iPartID, int iDamage, float CurrentTender, const struct FString& HightestBidUser, int iOverlapCount);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
public:
	...
	struct FString                                     strLabel[0x2];                                            // 0x056C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLabelWarning[0x4];                                     // 0x0584(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	void Internal_OnRendered(class UCanvas* C);
	void SetData(int Lv, const struct FString& myName, const struct FString& MyClan, int Pattern, int BG, int BL, int ClanLevel, int LevelMarkID);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
// 0x004C (0x0518 - 0x04CC)
class UBTAniItemBoxButtonHK : public UBTOwnerDrawCaptionButtonHK
{
public:
	class UBTROAniItemBoxHK*                           itemBox;                                                  // 0x04CC(0x0004)
	struct FString                                     DefaultSlotName[0x2];                                     // 0x04D0(0x000C) (NeedCtorLink)
	struct FPlane                                      DefaultSlotModulate;                                      // 0x04E8(0x0010)
	struct FImage                                      DefaultSlotImage;                                         // 0x04F8(0x0020)
...
public:
	...
	unsigned long                                      bStartAni : 1;                                            // 0x0044(0x0004)
	unsigned long                                      bStartCheckCount : 1;                                     // 0x0044(0x0004)
	...
	unsigned long                                      bLastReverseRoll : 1;                                     // 0x0060(0x0004)
	unsigned long                                      bSlowMove : 1;                                            // 0x0060(0x0004)
	unsigned long                                      bCheckFinish : 1;                                         // 0x0060(0x0004)
	float                                              RollStartX;                                               // 0x0064(0x0004)
	float                                              RollEndValue;                                             // 0x0068(0x0004)
	unsigned long                                      bScaleAni : 1;                                            // 0x006C(0x0004)
	...
	unsigned long                                      bScaleAni2 : 1;                                           // 0x0080(0x0004)
	...
	TEnumAsByte<E_ANI_END_TYPE>                        EndAnimationType;                                         // 0x0094(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0095(0x0003) MISSED OFFSET
	int                                                CandidateSize;                                            // 0x0098(0x0004)
	unsigned long                                      bDragMode : 1;                                            // 0x009C(0x0004)
	unsigned long                                      bRedAuction : 1;                                          // 0x009C(0x0004)
	unsigned long                                      bRedState : 1;                                            // 0x009C(0x0004)
	unsigned long                                      bDisplayPart : 1;                                         // 0x009C(0x0004)
	struct FText                                       PartName;                                                 // 0x00A0(0x001C) (NeedCtorLink)
	struct FString                                     PartSkillName;                                            // 0x00BC(0x000C) (NeedCtorLink)
	struct FImage                                      PartImage;                                                // 0x00C8(0x0020)
	class UwItemBoxHK*                                 ItemInfo;                                                 // 0x00E8(0x0004)
	TArray<class UwItemBoxHK*>                         ItemInfoPool;                                             // 0x00EC(0x000C) (NeedCtorLink)
	class UwItemBoxInstanceHK*                         instanceInfo;                                             // 0x00F8(0x0004)
	unsigned long                                      bestItem : 1;                                             // 0x00FC(0x0004)
	unsigned long                                      bRenderInfo : 1;                                          // 0x00FC(0x0004)
	...
	unsigned long                                      bDotSight : 1;                                            // 0x01F8(0x0004)
	unsigned long                                      bScope : 1;                                               // 0x01F8(0x0004)
	unsigned long                                      bSilencer : 1;                                            // 0x01F8(0x0004)
	unsigned long                                      bSkill : 1;                                               // 0x01F8(0x0004)
	unsigned long                                      bBarrel : 1;                                              // 0x01F8(0x0004)
	unsigned long                                      bGunstock : 1;                                            // 0x01F8(0x0004)
	...
	unsigned long                                      bBackgroundInfo : 1;                                      // 0x02BC(0x0004)
	unsigned long                                      bShowDurability : 1;                                      // 0x02BC(0x0004)
	unsigned long                                      bShowPrice : 1;                                           // 0x02BC(0x0004)
	unsigned long                                      bShowDamage : 1;                                          // 0x02BC(0x0004)
	unsigned long                                      bShowEquipLevel : 1;                                      // 0x02BC(0x0004)
	unsigned long                                      bShowRestrictionLevel : 1;                                // 0x02BC(0x0004)
	unsigned long                                      bShowRestrictionPrice : 1;                                // 0x02BC(0x0004)
	unsigned long                                      bShowRestrictionDurability : 1;                           // 0x02BC(0x0004)
	unsigned long                                      bShowGrade : 1;                                           // 0x02BC(0x0004)
	class UBTItemCommonInfoHK*                         MyData;                                                   // 0x02C0(0x0004)
	struct FColor                                      colCurrentUntilTime;                                      // 0x02C4(0x0004)
	struct FString                                     strCurrentUntilTime;                                      // 0x02C8(0x000C) (NeedCtorLink)
	struct FString                                     strGradeBase;                                             // 0x02D4(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeShop;                                             // 0x02E0(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeCommon;                                           // 0x02EC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeNormal;                                           // 0x02F8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeHigh;                                             // 0x0304(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeRare;                                             // 0x0310(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strGradeLegend;                                           // 0x031C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDurability;                                            // 0x0328(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDamage;                                                // 0x0334(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strLeftTime[0x5];                                         // 0x0340(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPoint;                                                 // 0x037C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strCash;                                                  // 0x0388(0x000C) (Localized, NeedCtorLink)
	int                                                RRIndex;                                                  // 0x0394(0x0004)
	unsigned long                                      bRegisterQuickSlot : 1;                                   // 0x0398(0x0004)
	struct FString                                     strRestrictionReason[0x6];                                // 0x039C(0x000C) (Localized, NeedCtorLink)
	TEnumAsByte<EBTROAniItemBoxHK_EInvenState>         InvenState;                                               // 0x03E4(0x0001)
	unsigned char                                      UnknownData01[0x3];                                       // 0x03E5(0x0003) MISSED OFFSET
	struct FScriptDelegate                             __OnStartScaleAni__Delegate;                              // 0x03E8(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnScaleAniChanged__Delegate;                            // 0x03F0(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnDramaEnded__Delegate;                                 // 0x03F8(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnNextRoll__Delegate;                                   // 0x0400(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnChangeItemInfo__Delegate;                             // 0x0408(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnChangeItemInfoEnd__Delegate;                          // 0x0410(0x000C) (NeedCtorLink)
	...
	void RandEndAniType();
	void Init();
	void ChangeState(TEnumAsByte<EBTROAniItemBoxHK_EInvenState> estate);
	void OnNextRoll();
	void OnDramaEnded();
...
{
public:
	unsigned long                                      bStartSlide : 1;                                          // 0x03BC(0x0004)
...
{
public:
	TArray<struct FText>                               textAmmosize;                                             // 0x0040(0x000C) (NeedCtorLink)
	TArray<struct FText>                               textSkill;                                                // 0x004C(0x000C) (NeedCtorLink)
	struct FString                                     strStatus[0x8];                                           // 0x0058(0x000C) (Localized, NeedCtorLink)
...
{
public:
	class UBTOwnerDrawImageHK*                         Label;                                                    // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UBTComboBoxHK*                               ComboBox;                                                 // 0x033C(0x0004) (ExportObject, NeedCtorLink, EditInline)
...
{
public:
	class UBTExpBarHK*                                 expbar[0x2];                                              // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
...
{
public:
	class UBTOwnerDrawTextArrayHK*                     Label[0x2];                                               // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
...
{
public:
	struct FString                                     strRank;                                                  // 0x03BC(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strUpArrow;                                               // 0x03C8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strDownArrow;                                             // 0x03D4(0x000C) (Localized, NeedCtorLink)
	int                                                ClanBG;                                                   // 0x03E0(0x0004)
	unsigned long                                      bClan : 1;                                                // 0x03E4(0x0004)
	...
	TArray<struct FText>                               Ranking;                                                  // 0x0428(0x000C) (NeedCtorLink)
	...
	void SetRankData(const struct FString& t0, int t1);
	void Internal_OnRendered(class UCanvas* C);
	void SetData(int CharLevel, int Pattern, int BG, int BL, int ClanLevel, const struct FString& strUserName, const struct FString& strClanName, int iRanking, int iPrevRanking, int iRankingExp, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
};
...
{
public:
	class UBTComboBoxHK*                               ComboBox[0x2];                                            // 0x0338(0x0004) (ExportObject, NeedCtorLink, EditInline)
...
public:
	...
	unsigned long                                      bStartShow : 1;                                           // 0x03C0(0x0004)
	...
	struct FScriptDelegate                             __OnStartPhase__Delegate;                                 // 0x03F4(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnEndPhase__Delegate;                                   // 0x03FC(0x000C) (NeedCtorLink)
...
public:
	...
	TArray<class URenderObject*>                       DataList;                                                 // 0x030C(0x000C) (NeedCtorLink)
	unsigned long                                      bIgnoreMouseOnState : 1;                                  // 0x0318(0x0004)
	unsigned long                                      bIgnoreFocusedState : 1;                                  // 0x0318(0x0004)
	unsigned long                                      usePageInfo : 1;                                          // 0x0318(0x0004)
	...
	struct FScriptDelegate                             __ChangeItemList__Delegate;                               // 0x038C(0x000C) (NeedCtorLink)
	...
	void ClearItem();
	void Initialize(class UGUIController* MyController, class UGUIComponent* myOwner, bool useVert, int ItemCountPerPage, const struct FFloatBox& fbItemList, const struct FFloatBox& fbButton0, const struct FFloatBox& fbButton1, const struct FString& _titleName, bool _usePageInfo, bool _useBigButton, const struct FFloatBox& _fbTitle, const struct FFloatBox& _fbPageInfo);
	void ChangeItemList();
};
...
public:
	...
	unsigned long                                      EnableItem : 1;                                           // 0x004C(0x0004)
	unsigned long                                      DrawAlreadyInfo : 1;                                      // 0x004C(0x0004)
	...
	struct FString                                     strAlreadyGet;                                            // 0x00D4(0x000C) (Localized, NeedCtorLink)
	...
	void SetCenterText(int FontSize, const struct FFloatBox& fbFixed, const struct FString& str);
	void SetItemData(int _itemID, int _uniqueIndex, int _needNum, const struct FString& str, bool bEnable);
};


// Class GUIWarfareControls.BTROIncludeItemPopup
// 0x032C (0x036C - 0x0040)
...
public:
	...
	class UwItemBoxHK*                                 ItemInfo;                                                 // 0x0348(0x0004)
	int                                                CurrentItemID;                                            // 0x034C(0x0004)
	int                                                IncludeItemCount;                                         // 0x0350(0x0004)
	struct FString                                     strTitle;                                                 // 0x0354(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strBestItem;                                              // 0x0360(0x000C) (Localized, NeedCtorLink)
	...
	bool Render(class UCanvas* C, float Delta);
	bool IsBestItem(int checkItemID, TArray<int> BestItemIDs);
	void SetPivotPos(class UGUIController* Controller, const struct FFloatBox& pivotBox);
	void SetData(int ItemIndex, class UwGameManager* GameMgr);
	void Init();
};
...
public:
	...
	void LC1_Draw(class UCanvas* C, float L, float t, float R, float B, const struct FACLData& Data, int Column, int row);
	struct FColor DamageToColor(int Damage);
	void AddItem(const struct FString& s1, int Damage, const struct FString& s2);
	float GetItemHeight(class UCanvas* C);
};
...
public:
	...
	struct FImage                                      NewItemImage;                                             // 0x0088(0x0020)
	struct FImage                                      NormalImgage;                                             // 0x00A8(0x0020)
	struct FImage                                      MouseOnImgage;                                            // 0x00C8(0x0020)
	struct FImage                                      SelectImgage;                                             // 0x00E8(0x0020)
	struct FImage                                      DisableImgage;                                            // 0x0108(0x0020)
...
{
public:
	struct FFloatBox                                   fbLabelInfo[0x2];                                         // 0x04D8(0x0010)
	...
	class UBTOwnerDrawImageHK*                         LabelInfo[0x2];                                           // 0x051C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	float                                              FadeInTime;                                               // 0x0524(0x0004)
	float                                              FadeInStartTime;                                          // 0x0528(0x0004)
	float                                              CloseWaitTime;                                            // 0x052C(0x0004)
	unsigned long                                      FadeInStart : 1;                                          // 0x0530(0x0004)
	struct FString                                     strFadeInSound;                                           // 0x0534(0x000C) (NeedCtorLink)
...
public:
	...
	struct FString                                     strRedeemCodeTitle;                                       // 0x059C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strRedeemCodeInfo[0x2];                                   // 0x05A8(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strPaste;                                                 // 0x05C0(0x000C) (Localized, NeedCtorLink)
	struct FScriptDelegate                             __deleSendCodes__Delegate;                                // 0x05CC(0x000C) (NeedCtorLink)
	...
	bool deleOnChat(class UGUIComponent* Sender, const struct FString& Text);
	bool STATIC_ShowWindowRedeemCodes(class UGUIController* con);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void deleSendCodes(const struct FString& codes);
};
...
public:
	...
	TArray<int>                                        DataArray;                                                // 0x00C0(0x000C) (NeedCtorLink)
	TArray<struct FText>                               textArray;                                                // 0x00CC(0x000C) (NeedCtorLink)
	TEnumAsByte<EDrawType>                             DrawType;                                                 // 0x00D8(0x0001)
	TEnumAsByte<ETextArrayDrawType>                    TADrawType;                                               // 0x00D9(0x0001)
...
{
public:
	unsigned long                                      bHideAllExceptName : 1;                                   // 0x0040(0x0004)
	unsigned long                                      bHideGaugeBack : 1;                                       // 0x0040(0x0004)
	unsigned long                                      bHideValue : 1;                                           // 0x0040(0x0004)
	int                                                TextX;                                                    // 0x0044(0x0004)
	int                                                GaugeStartX;                                              // 0x0048(0x0004)
	int                                                GaugeEndX;                                                // 0x004C(0x0004)
	int                                                ValueX;                                                   // 0x0050(0x0004)
	struct FString                                     GaugeName;                                                // 0x0054(0x000C) (NeedCtorLink)
	TArray<int>                                        DataArray;                                                // 0x0060(0x000C) (NeedCtorLink)
	TArray<struct FText>                               textArray;                                                // 0x006C(0x000C) (NeedCtorLink)
	...
	void SetData(const struct FString& GaugeName, int A, int B);
	void Init();
};


// Class GUIWarfareControls.BTTPOptionGQSimpleHK
// 0x00A4 (0x03DC - 0x0338)
...
public:
	...
	struct FFloatBox                                   fbButtonRadio;                                            // 0x0344(0x0010)
	class UBTCheckBoxHK*                               ButtonRadio;                                              // 0x0354(0x0004) (ExportObject, NeedCtorLink, EditInline)
	class UButtonGroups*                               GraphicSimpleGroup;                                       // 0x0358(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FString                                     strLow;                                                   // 0x035C(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strNormal;                                                // 0x0368(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strHigh;                                                  // 0x0374(0x000C) (Localized, NeedCtorLink)
	struct FString                                     strExHigh;                                                // 0x0380(0x000C) (Localized, NeedCtorLink)
	class UBTOwnerDrawCaptionButtonHK*                 SimpleButton[0x4];                                        // 0x038C(0x0004) (ExportObject, NeedCtorLink, EditInline)
	struct FFloatBox                                   fbButtonTab[0x4];                                         // 0x039C(0x0010)
...
// 0x0044 (0x0510 - 0x04CC)
class UBTOptionKeyButtonHK : public UBTOwnerDrawCaptionButtonHK
{
public:
	struct FString                                     SaveKey;                                                  // 0x04CC(0x000C) (NeedCtorLink)
	struct FString                                     SaveCaption;                                              // 0x04D8(0x000C) (NeedCtorLink)
	struct FString                                     BindName;                                                 // 0x04E4(0x000C) (NeedCtorLink)
	struct FString                                     strBindFuncName;                                          // 0x04F0(0x000C) (NeedCtorLink)
	struct FString                                     strNewKey;                                                // 0x04FC(0x000C) (Localized, NeedCtorLink)
	struct FScriptDelegate                             __OnChangeKey__Delegate;                                  // 0x0508(0x000C) (NeedCtorLink)
	...
	bool RawKey(unsigned char NewKey);
	void SetKey(const struct FString& KeyName);
	void OnChangeKey(class UGUIComponent* Sender, const struct FString& NewKey);
	bool IsAllowedKey(unsigned char NewKey);
	bool Internal_OnClick(class UGUIComponent* Sender);
	void InitComponent(class UGUIController* MyController, class UGUIComponent* myOwner);
	void SetBindFuncName(const struct FString& str);
};
