...
{
public:
	unsigned char                                      UnknownData00[0x18];                                      // 0x00EC(0x0018) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x44];                                      // 0x0104(0x0044) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x1220];                                    // 0x0104(0x1220) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xC];                                       // 0x1324(0x000C) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x434];                                     // 0x0104(0x0434) MISSED OFFSET
