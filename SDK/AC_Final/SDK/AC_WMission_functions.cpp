...
// Function WMission.wAlienPlayerReplicationInfo.GetTeamIndex
// (Defined, Simulated, Public)
// Parameters:
// int                            ReturnValue                    (Parm, OutParm, ReturnParm)

int AwAlienPlayerReplicationInfo::GetTeamIndex()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienPlayerReplicationInfo.GetTeamIndex");

	AwAlienPlayerReplicationInfo_GetTeamIndex_Params params;
...
byte AwAlienPlayerReplicationInfo::GetInfectionLevel()
{
...
void AwAlienPlayerReplicationInfo::SetInfectionLevel(byte Level)
{
...
// Function WMission.wAlienPlayerReplicationInfo.GetSkinType
// (Defined, Simulated, Public)
// Parameters:
// EAlienMode_Object_Type         ReturnValue                    (Parm, OutParm, ReturnParm)

EAlienMode_Object_Type AwAlienPlayerReplicationInfo::GetSkinType()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienPlayerReplicationInfo.GetSkinType");

	AwAlienPlayerReplicationInfo_GetSkinType_Params params;
...
// Function WMission.wAlienPlayerReplicationInfo.SetSkinType
// (Defined, Simulated, Public)
// Parameters:
// EAlienMode_Object_Type         eSkinType                      (Parm)

void AwAlienPlayerReplicationInfo::SetSkinType(EAlienMode_Object_Type eSkinType)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienPlayerReplicationInfo.SetSkinType");

	AwAlienPlayerReplicationInfo_SetSkinType_Params params;
	params.eSkinType = eSkinType;
...
// (Defined, Simulated, Public)
// Parameters:
// EAlienModeType                 ReturnValue                    (Parm, OutParm, ReturnParm)

EAlienModeType AwAlienPlayerReplicationInfo::GetObjType()
{
...
// (Defined, Simulated, Public)
// Parameters:
// EAlienModeType                 eObjType                       (Parm)

void AwAlienPlayerReplicationInfo::SetObjType(EAlienModeType eObjType)
{
...
string AwHUD_Mission::GetInfoString()
{
...
void AwHUD_Mission::DrawTextWithBackground(class UCanvas* C, const string& Text, const struct FColor& TextColor, float XO, float YO)
{
...
void AwHUD_Mission::STATIC_Draw_2DCollisionBox(class UCanvas* C, class AActor* A, const struct FVector& ScrPos, const string& Description, float ColExpand, bool bSizeOverride)
{
...
// byte                           bProgressPulsing               (OptionalParm, Parm, OutParm)
// struct FColor                  ReturnValue                    (Parm, OutParm, ReturnParm)

struct FColor AwHUD_Mission::GetObjectiveColor(class AGameObjective* Go, byte* bProgressPulsing)
{
...
struct FColor AwHUD_Mission::STATIC_GetTeamColor(byte Team)
{
...
// Parameters:
// string                         AnnouncerSound                 (Parm, NeedCtorLink)
// byte                           Switch                         (Parm)

void AwHUD_Mission::AnnouncementPlayed(const string& AnnouncerSound, byte Switch)
{
...
int AwHUD_Mission::STATIC_GetGameObjectIndexByTag(const FName& Tag)
{
...
// Function WMission.wHUD_Alien.DrawAddScore
// (Defined, Public)
// Parameters:
// class UCanvas*                 C                              (Parm)
// int                            i                              (Parm)
...
void AwHUD_Alien::DrawAddScore(class UCanvas* C, int i, float ScorePosX, float ScorePosY, int MessageScoreEffect, float CurrentScale)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wHUD_Alien.DrawAddScore");

	AwHUD_Alien_DrawAddScore_Params params;
	params.C = C;
	params.i = i;
...
// Function WMission.wHUD_Alien.DisplayDebug
// (Defined, Public)
// Parameters:
...
void AwHUD_Alien::DisplayDebug(class UCanvas* Canvas, float* YL, float* YPos)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wHUD_Alien.DisplayDebug");

	AwHUD_Alien_DisplayDebug_Params params;
...
void AwHUD_Alien::LocalizedMessage2(class UClass* Message, int Switch, bool bOption_Push, const string& CriticalString)
{
...
// Function WMission.wHUD_Alien.ChangeSuperHeroMark
// (Defined, Public)

void AwHUD_Alien::ChangeSuperHeroMark()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wHUD_Alien.ChangeSuperHeroMark");

	AwHUD_Alien_ChangeSuperHeroMark_Params params;
...
// Function WMission.wHUD_Alien.InsertUsingSkillList
// (Defined, Simulated, Public)
// Parameters:
// int                            SkillID                        (Parm)
// int                            weaponID                       (Parm)
...
void AwHUD_Alien::InsertUsingSkillList(int SkillID, int weaponID, int SubSkillID)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wHUD_Alien.InsertUsingSkillList");

	AwHUD_Alien_InsertUsingSkillList_Params params;
...
void AwHUD_Alien::ChangeHudType(byte Type)
{
...
// Function WMission.wHUD_Alien.ChangeSuperAlienBackScreen
// (Defined, Public)

void AwHUD_Alien::ChangeSuperAlienBackScreen()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wHUD_Alien.ChangeSuperAlienBackScreen");

	AwHUD_Alien_ChangeSuperAlienBackScreen_Params params;
...
// Function WMission.wHUD_Alien.SwapSuperHeroEffectValue
// (Defined, Public)

void AwHUD_Alien::SwapSuperHeroEffectValue()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wHUD_Alien.SwapSuperHeroEffectValue");

	AwHUD_Alien_SwapSuperHeroEffectValue_Params params;
...
// Function WMission.wHUD_Alien.DrawSuperAlienDisplayBackScreen
// (Defined, Public)
// Parameters:
// class UCanvas*                 C                              (Parm)

void AwHUD_Alien::DrawSuperAlienDisplayBackScreen(class UCanvas* C)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wHUD_Alien.DrawSuperAlienDisplayBackScreen");

	AwHUD_Alien_DrawSuperAlienDisplayBackScreen_Params params;
	params.C = C;
...
// Function WMission.wMSGameReplicationInfo.GetMaxRound
// (Defined, Simulated, Public)
// Parameters:
// int                            ReturnValue                    (Parm, OutParm, ReturnParm)

int AwMSGameReplicationInfo::GetMaxRound()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wMSGameReplicationInfo.GetMaxRound");

	AwMSGameReplicationInfo_GetMaxRound_Params params;
...
// Function WMission.wMSGameReplicationInfo.GetCurRound
// (Defined, Simulated, Public)
// Parameters:
// int                            ReturnValue                    (Parm, OutParm, ReturnParm)

int AwMSGameReplicationInfo::GetCurRound()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wMSGameReplicationInfo.GetCurRound");

	AwMSGameReplicationInfo_GetCurRound_Params params;
...
string AwMSGameReplicationInfo::GetRoundWinnerString()
{
...
bool AwMSGameReplicationInfo::IsDefender(byte Team)
{
...
string AwScoreBoard_Mission::GetDefaultScoreInfoString()
{
...
string AwScoreBoard_Mission::GetRestartString()
{
...
string AwScoreBoard_Mission::GetTitleString()
{
...
byte AwTrigger_MSMessageTrigger::GetTeamNum()
{
...
void AwObjectivePointingArrow::SetTeamSkin(byte Team, bool bPulse)
{
...
void AwMSGameInfo::AddGameSpecificActions(class UwAction*[]* Actions)
{
...
// byte                           bOtherTeamNoneLeft             (Parm, OutParm)

void AwMSGameInfo::FindLiving(class APlayerReplicationInfo** Living, byte* bOtherTeamNoneLeft)
{
...
// (Defined, Static, Public)
// Parameters:
// string                         MutatorClassName               (Parm, NeedCtorLink)
// bool                           ReturnValue                    (Parm, OutParm, ReturnParm)

bool AwMSGameInfo::STATIC_AllowMutator(const string& MutatorClassName)
{
...
string AwMSGameInfo::STATIC_GetDescriptionText(const string& PropName)
{
...
bool AwMSGameInfo::STATIC_AcceptPlayInfoProperty(const string& PropertyName)
{
...
// (Defined, Public)
// Parameters:
// string                         ASound                         (Parm, NeedCtorLink)
// byte                           AnnouncementLevel              (Parm)
// byte                           Team                           (Parm)
// EAPriority                     Priority                       (OptionalParm, Parm)
// byte                           Switch                         (OptionalParm, Parm)

void AwMSGameInfo::QueueAnnouncerSound(const string& ASound, byte AnnouncementLevel, byte Team, EAPriority Priority, byte Switch)
{
...
// Parameters:
// class APawn*                   TP                             (Parm)
// FName                          ObjectTag                      (Parm)
// struct FVector                 FlagLocation                   (Parm)

void AwMSGameInfo::SetObjectiveSetted(class APawn* TP, const FName& ObjectTag, const struct FVector& FlagLocation)
{
...
class ANavigationPoint* AwMSGameInfo::FindPlayerStart(class AController* Player, byte inTeam, const string& incomingName)
{
...
void AwMSGameInfo::TeamScoreEvent(int Team, float Points, const string& Desc)
{
...
void AwMSGameInfo::ScoreEvent(class APlayerReplicationInfo* Who, float Points, const string& Desc)
{
...
void AwMSGameInfo::KillEvent(const string& KillType, class APlayerReplicationInfo* Killer, class APlayerReplicationInfo* Victim, class UClass* Damage)
{
...
void AwMSGameInfo::SpecialEvent(class APlayerReplicationInfo* Who, const string& Desc)
{
...
int AwMSGameInfo::VehicleScoreKill(class AController* Killer, class AController* Killed, class AVehicle* DestroyedVehicle, string* KillInfo)
{
...
// (Defined, Public)
// Parameters:
// ERER_Reason                    RoundEndReason                 (Parm)
// class APawn*                   Instigator                     (Parm)
// string                         Reason                         (Parm, NeedCtorLink)

void AwMSGameInfo::EndRound(ERER_Reason RoundEndReason, class APawn* Instigator, const string& Reason)
{
...
bool AwMSGameInfo::CheckEndGame(class APlayerReplicationInfo* Winner, const string& Reason)
{
...
void AwMSGameInfo::fEndRound(byte Team)
{
...
void AwMSGameInfo::InitGameOption(const string& Options, string* Error)
{
...
void AwMSGameInfo::InitGame(const string& Options, string* Error)
{
...
class APlayerController* AwMSGameInfo::Login(const string& Portal, const string& Options, string* Error)
{
...
void AwGameObject_Bomb::Drop(const struct FVector& NewVel, const string& sReason)
{
...
void AwSetObjective::SetDefuseLocation(const struct FVector& loc, const FName& Tag)
{
...
string AwObjectiveProgressDisplay::GetObjectiveDescription(class AGameObjective* Go, bool bDefender)
{
...
// Parameters:
// class UCanvas*                 C                              (Parm)
// string                         Entry                          (Parm, NeedCtorLink)
// string                         ReturnValue                    (Parm, OutParm, ReturnParm, NeedCtorLink)

string AwObjectiveProgressDisplay::CheckEntry(class UCanvas* C, const string& Entry)
{
...
// Function WMission.wAlienController.ShowDebugAlienPlayer
// (Defined, Exec, Public)

void AwAlienController::ShowDebugAlienPlayer()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienController.ShowDebugAlienPlayer");

	AwAlienController_ShowDebugAlienPlayer_Params params;
...
// Function WMission.wAlienController.DisplayDebug
// (Defined, Simulated, Public)
// Parameters:
// class UCanvas*                 Canvas                         (Parm)
// float                          YL                             (Parm, OutParm)
...
void AwAlienController::DisplayDebug(class UCanvas* Canvas, float* YL, float* YPos)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienController.DisplayDebug");

	AwAlienController_DisplayDebug_Params params;
	params.Canvas = Canvas;
...
// Function WMission.wAlienController.Output_PawnList
// (Defined, Exec, Public)

void AwAlienController::Output_PawnList()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienController.Output_PawnList");

	AwAlienController_Output_PawnList_Params params;
...
// Function WMission.wAlienController.ReceiveLocalizedMessage2
...
// string                         Reserved3                      (OptionalParm, Parm, NeedCtorLink)

void AwAlienController::ReceiveLocalizedMessage2(class UClass* Message, int Switch, bool bOption_Push, int Reserved1, int Reserved2, const string& Reserved3)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienController.ReceiveLocalizedMessage2");

	AwAlienController_ReceiveLocalizedMessage2_Params params;
	params.Message = Message;
	params.Switch = Switch;
	params.bOption_Push = bOption_Push;
...
// Function WMission.wAlienController.ClientDamageShake
// (Defined, Private)
// Parameters:
// int                            Damage                         (Parm)

void AwAlienController::ClientDamageShake(int Damage)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienController.ClientDamageShake");

	AwAlienController_ClientDamageShake_Params params;
	params.Damage = Damage;
...
// Function WMission.wAlienController.DamageShake
// (Defined, Public)
// Parameters:
// int                            Damage                         (Parm)

void AwAlienController::DamageShake(int Damage)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienController.DamageShake");

	AwAlienController_DamageShake_Params params;
	params.Damage = Damage;
...
// Function WMission.wAlienController.wViewAttacked
// (Defined, Public)
// Parameters:
// float                          DeltaTime                      (Parm)

void AwAlienController::wViewAttacked(float DeltaTime)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienController.wViewAttacked");

	AwAlienController_wViewAttacked_Params params;
	params.DeltaTime = DeltaTime;
...
// Function WMission.wAlienController.wAttackedView
// (Defined, Public)
// Parameters:
// int                            iPitch                         (Parm)
// int                            iYaw                           (Parm)
...
void AwAlienController::wAttackedView(int iPitch, int iYaw, int iRoll)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienController.wAttackedView");

	AwAlienController_wAttackedView_Params params;
...
// Function WMission.wAlienController.RotateByAttacked
// (Defined, Public)
// Parameters:
// struct FVector                 CameraLocation                 (Parm, OutParm)
// struct FRotator                CameraRotation                 (Parm, OutParm)

void AwAlienController::RotateByAttacked(struct FVector* CameraLocation, struct FRotator* CameraRotation)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienController.RotateByAttacked");

	AwAlienController_RotateByAttacked_Params params;
...
// (Defined, Net, NetReliable, Simulated, Public)
// Parameters:
// byte                           InvertSideID                   (Parm)

void AwAlienController::ClientChangeTeam(byte InvertSideID)
{
...
// Function WMission.wAlienController.ClientChangeSuperAlien
// (Defined, Net, NetReliable, Simulated, Public)

void AwAlienController::ClientChangeSuperAlien()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienController.ClientChangeSuperAlien");

	AwAlienController_ClientChangeSuperAlien_Params params;
...
// (Defined, Net, NetReliable, Simulated, Public)
// Parameters:
// byte                           byAttackLevelIndex             (Parm)

void AwAlienController::ClientUpdateLevelup(byte byAttackLevelIndex)
{
...
void AwAlienController::ClientUpdate3rdModel(int PlayerID, EAlienModeType eObjType, EAlienMode_Object_Type eSkinType)
{
...
void AwAlienController::ServerChangePawn(EAlienMode_Object_Type eSkinType)
{
...
EAlienModeType AwAlienController::GetObjType()
{
...
void AwAlienController::UpdateHPValue(EAlienMode_Object_Type eSkinType, EAlienModeType eObjType)
{
...
byte AwAlienController::GetInfectionLevel()
{
...
byte AwAlienGameReplicationInfo::GetCurTeamMemberCount(int TeamIndex)
{
...
// Function WMission.wAMPawn.AddNoWeaponChangeMessage
// (Defined, Simulated, Public)
// Parameters:
// byte                           bySlot                         (Parm)

void AwAMPawn::AddNoWeaponChangeMessage(byte bySlot)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAMPawn.AddNoWeaponChangeMessage");

	AwAMPawn_AddNoWeaponChangeMessage_Params params;
...
// Function WMission.wAMPawn.TestVersion_SetParameters
// (Defined, Simulated, Public)

void AwAMPawn::TestVersion_SetParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAMPawn.TestVersion_SetParameters");

	AwAMPawn_TestVersion_SetParameters_Params params;
...
void AwAMPawn::ClientChangeModelType(EAlienModeType eObjType, EAlienMode_Object_Type eSkinType)
{
...
void AwAMPawn::ChangeModelType(EAlienModeType eObjType, EAlienMode_Object_Type eSkinType)
{
...
// Function WMission.wAMPawn.MakeQuickRepairByAlienEffect
// (Defined, Simulated, Public)

void AwAMPawn::MakeQuickRepairByAlienEffect()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAMPawn.MakeQuickRepairByAlienEffect");

	AwAMPawn_MakeQuickRepairByAlienEffect_Params params;
...
void AwAMPawn::MakeAttackLevelEffect(byte byAttackLevelIndex)
{
...
// Function WMission.wAMPawn.DestroyEffect_Character
// (Defined, Simulated, Public)

void AwAMPawn::DestroyEffect_Character()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAMPawn.DestroyEffect_Character");

	AwAMPawn_DestroyEffect_Character_Params params;
...
class UClass* AwAMPawn::GetBloodHitClass(ECollisionPartsType collisionParts)
{
...
class UClass* AwAMPawn::Alien_GetBloodHitClass(ECollisionPartsType collisionParts)
{
...
// Function WMission.wAlienGameInfo.AnnounceMatchInfo
// (Defined, Public)

void AwAlienGameInfo::AnnounceMatchInfo()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienGameInfo.AnnounceMatchInfo");

	AwAlienGameInfo_AnnounceMatchInfo_Params params;
...
// Function WMission.wAlienGameInfo.SetAssistPoint
// (Defined, Public)
// Parameters:
// class AController*             Killer                         (Parm)
// class AController*             Other                          (Parm)

void AwAlienGameInfo::SetAssistPoint(class AController* Killer, class AController* Other)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienGameInfo.SetAssistPoint");

	AwAlienGameInfo_SetAssistPoint_Params params;
	params.Killer = Killer;
	params.Other = Other;
...
// Function WMission.wAlienGameInfo.AlienGame_SinTime
// (Defined, Exec, Public)

void AwAlienGameInfo::AlienGame_SinTime()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienGameInfo.AlienGame_SinTime");

	AwAlienGameInfo_AlienGame_SinTime_Params params;
...
// Function WMission.wAlienGameInfo.AlienGame_MagicTime
// (Defined, Exec, Public)
// Parameters:
// int                            RemainTime                     (Parm)

void AwAlienGameInfo::AlienGame_MagicTime(int RemainTime)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienGameInfo.AlienGame_MagicTime");

	AwAlienGameInfo_AlienGame_MagicTime_Params params;
...
// Function WMission.wAlienGameInfo.AlienGame_Hero
// (Defined, Exec, Public)

void AwAlienGameInfo::AlienGame_Hero()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienGameInfo.AlienGame_Hero");

	AwAlienGameInfo_AlienGame_Hero_Params params;
...
// Function WMission.wAlienGameInfo.AlienGame_SuperHero
// (Defined, Exec, Public)

void AwAlienGameInfo::AlienGame_SuperHero()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienGameInfo.AlienGame_SuperHero");

	AwAlienGameInfo_AlienGame_SuperHero_Params params;
...
// Function WMission.wAlienGameInfo.AlienGame_AlienLevelup
// (Defined, Exec, Public)

void AwAlienGameInfo::AlienGame_AlienLevelup()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienGameInfo.AlienGame_AlienLevelup");

	AwAlienGameInfo_AlienGame_AlienLevelup_Params params;
...
// Function WMission.wAlienGameInfo.AlienGame_AttackLevelup
// (Defined, Exec, Public)

void AwAlienGameInfo::AlienGame_AttackLevelup()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienGameInfo.AlienGame_AttackLevelup");

	AwAlienGameInfo_AlienGame_AttackLevelup_Params params;
...
int AwAlienGameInfo::GetWinTeam(ERER_Reason RoundEndReason)
{
...
int AwAlienGameInfo::GetRoundEndType(ERER_Reason RoundEndReason)
{
...
void AwAlienGameInfo::ServerLogEndRound(ERER_Reason RoundEndReason, class APawn* Instigator, const string& Reason)
{
...
class ANavigationPoint* AwAlienGameInfo::FindPlayerStart(class AController* Player, byte inTeam, const string& incomingName)
{
...
void AwAlienGameInfo::EndRound(ERER_Reason RoundEndReason, class APawn* Instigator, const string& Reason)
{
...
// Function WMission.wAlienGameInfo.AlarmAppearAlien
// (Defined, Public)
// Parameters:
// EAlienModeType                 eObjType                       (Parm)
// int                            iTimeCount                     (Parm)

void AwAlienGameInfo::AlarmAppearAlien(EAlienModeType eObjType, int iTimeCount)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienGameInfo.AlarmAppearAlien");

	AwAlienGameInfo_AlarmAppearAlien_Params params;
	params.eObjType = eObjType;
	params.iTimeCount = iTimeCount;
...
// Function WMission.wAlienGameInfo.Log_ControllerInfo
// (Defined, Public)

void AwAlienGameInfo::Log_ControllerInfo()
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienGameInfo.Log_ControllerInfo");

	AwAlienGameInfo_Log_ControllerInfo_Params params;
...
void AwAlienGameInfo::ChangeAttackLevel(byte byAttackLevelIndex)
{
...
// Function WMission.wAlienGameInfo.CalcPlayingUserCount
// (Defined, Public)
// Parameters:
// int                            iHumanTeamCount                (Parm, OutParm)
// int                            iAlienTeamCount                (Parm, OutParm)

void AwAlienGameInfo::CalcPlayingUserCount(int* iHumanTeamCount, int* iAlienTeamCount)
{
	static auto fn = UObject::FindObject<UFunction>("Function WMission.wAlienGameInfo.CalcPlayingUserCount");

	AwAlienGameInfo_CalcPlayingUserCount_Params params;
	...
	if (iHumanTeamCount != nullptr)
		*iHumanTeamCount = params.iHumanTeamCount;
	if (iAlienTeamCount != nullptr)
		*iAlienTeamCount = params.iAlienTeamCount;
}
...
bool AwAlienGameInfo::IsAppropriateRespawnPoint(class ANavigationPoint* N, byte Team)
{
...
void AwAlienGameInfo::InitGame(const string& Options, string* Error)
{
...
bool AwBombObjective::BetterObjectiveThan(class AGameObjective* Best, byte DesiredTeamNum, byte RequesterTeamNum)
{
...
string AwMessage_MSKillMessages::STATIC_GetString(int Switch, class APlayerReplicationInfo* RelatedPRI_1, class APlayerReplicationInfo* RelatedPRI_2, class UObject* OptionalObject)
{
...
void AwSDGameInfo::EndRound(ERER_Reason RoundEndReason, class APawn* Instigator, const string& Reason)
{
...
void AwSDGameInfo::ServerLogEndRound(ERER_Reason RoundEndReason, class APawn* Instigator, const string& Reason)
{
...
int AwSDGameInfo::GetWinTeam(ERER_Reason RoundEndReason)
{
...
int AwSDGameInfo::GetRoundEndType(ERER_Reason RoundEndReason)
{
...
void AwSDGameInfo::OnBombDiffused(class APawn* TP, const FName& Tag, const struct FVector& FlagLocation)
{
...
void AwSDGameInfo::SetObjectiveSetted(class APawn* TP, const FName& ObjectTag, const struct FVector& FlagLocation)
{
...
void AwSDGameInfo::GotoDefusePhase(const FName& ObjectTag)
{
...
void AwSDGameInfo::InitGame(const string& Options, string* Error)
{
