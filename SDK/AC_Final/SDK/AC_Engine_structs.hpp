...
#define CONST_SPECIFIC_BONE_ROTATOR_COUNT                         3
...
#define CONST_GAME_ADD_SENTRYGUN_POINT                            5
#define CONST_kST_CCoinFlatRate                                   0x06
#define CONST_MAX_ALIEN_MASTER_LV                                 5
#define CONST_GAME_ADD_SENTRYGUN_EXP                              15
#define CONST_GAME_ADD_HELI_POINT                                 5
#define CONST_kIISF_Best                                          0x10
#define CONST_maxCountFontSize                                    25
#define CONST_GAME_ADD_HELI_EXP                                   15
...
// Enum Engine.Controller.ECONTROLLER_TYPE
enum class ECONTROLLER_TYPE : uint8_t
{
	ECONTROLLER_NONE               = 0,
	ECONTROLLER_SENTRYGUN          = 1,
	ECONTROLLER_DEFENCE_BOT        = 2
};
...
enum class EItemType : uint8_t
{
	...
	ITYPE_GOLD                     = 41,
	ITYPE_Extend_QuickSlot3        = 42,
	ITYPE_Extend_QuickSlot4        = 43,
	ITYPE_Extend_SkillSlot3        = 44,
	ITYPE_Extend_SkillSlot4        = 45,
	ITYPE_None                     = 46
};
...
// Enum Engine.wGameManager.ECostType
...
struct FPointRegion
{
	...
	byte                                               ZoneNumber;                                               // 0x0008(0x0001)
	byte                                               Padding00[0x3];                                           // 0x0009(0x0003) MISSED OFFSET
};
...
struct FAnimRep
{
	FName                                              AnimSequence;                                             // 0x0000(0x0004)
	bool                                               bAnimLoop;                                                // 0x0004(0x0004)
	byte                                               AnimRate;                                                 // 0x0008(0x0001)
	byte                                               AnimFrame;                                                // 0x0009(0x0001)
	byte                                               TweenRate;                                                // 0x000A(0x0001)
	byte                                               Padding00[0x1];                                           // 0x000B(0x0001) MISSED OFFSET
};
...
{
	string                                             UserName;                                                 // 0x0000(0x000C) (NeedCtorLink)
	byte                                               LoadingState;                                             // 0x000C(0x0001)
	byte                                               Padding00[0x3];                                           // 0x000D(0x0003) MISSED OFFSET
...
struct FTencentLoginInfo
{
	...
	byte                                               GameSignature[0x80];                                      // 0x0008(0x0001)
};
...
struct FPingTime
{
	string                                             IP;                                                       // 0x0000(0x000C) (NeedCtorLink)
...
{
	string                                             UserName;                                                 // 0x0000(0x000C) (NeedCtorLink)
	byte                                               IsLogOn;                                                  // 0x000C(0x0001)
	byte                                               Padding00[0x3];                                           // 0x000D(0x0003) MISSED OFFSET
	string                                             ClanName;                                                 // 0x0010(0x000C) (NeedCtorLink)
	int                                                ClanPattern;                                              // 0x001C(0x0004)
	int                                                ClanBG;                                                   // 0x0020(0x0004)
	int                                                ClanBL;                                                   // 0x0024(0x0004)
	string                                             ServerName;                                               // 0x0028(0x000C) (NeedCtorLink)
	string                                             ServerShortName;                                          // 0x0034(0x000C) (NeedCtorLink)
	string                                             ServerIP;                                                 // 0x0040(0x000C) (NeedCtorLink)
	int                                                serverPort;                                               // 0x004C(0x0004)
	byte                                               CurPos;                                                   // 0x0050(0x0001)
	byte                                               Padding01[0x3];                                           // 0x0051(0x0003) MISSED OFFSET
	int                                                ChannelNum;                                               // 0x0054(0x0004)
	string                                             ChannelNickName;                                          // 0x0058(0x000C) (NeedCtorLink)
	int                                                GameRoomNum;                                              // 0x0064(0x0004)
	int                                                Level;                                                    // 0x0068(0x0004)
	int                                                ClanGrade;                                                // 0x006C(0x0004)
	byte                                               IsCombat;                                                 // 0x0070(0x0001)
	byte                                               Padding02[0x3];                                           // 0x0071(0x0003) MISSED OFFSET
...
struct FClanStruct
{
	...
	string                                             UserName;                                                 // 0x0004(0x000C) (NeedCtorLink)
	byte                                               IsLogOn;                                                  // 0x0010(0x0001)
	byte                                               ClanGrade;                                                // 0x0011(0x0001)
	byte                                               Padding00[0x2];                                           // 0x0012(0x0002) MISSED OFFSET
	string                                             ServerName;                                               // 0x0014(0x000C) (NeedCtorLink)
	string                                             ServerShortName;                                          // 0x0020(0x000C) (NeedCtorLink)
	string                                             ServerIP;                                                 // 0x002C(0x000C) (NeedCtorLink)
	int                                                serverPort;                                               // 0x0038(0x0004)
	byte                                               CurPos;                                                   // 0x003C(0x0001)
	byte                                               Padding01[0x3];                                           // 0x003D(0x0003) MISSED OFFSET
	int                                                ChannelNum;                                               // 0x0040(0x0004)
	string                                             ChannelNickName;                                          // 0x0044(0x000C) (NeedCtorLink)
	int                                                GameRoomNum;                                              // 0x0050(0x0004)
	byte                                               IsCombat;                                                 // 0x0054(0x0001)
	byte                                               Padding02[0x3];                                           // 0x0055(0x0003) MISSED OFFSET
	int                                                ClanWin;                                                  // 0x0058(0x0004)
	int                                                ClanLose;                                                 // 0x005C(0x0004)
	string                                             ClanSelfIntro;                                            // 0x0060(0x000C) (NeedCtorLink)
...
struct FMissionItem
{
	...
	string                                             MissionDesc;                                              // 0x0018(0x000C) (NeedCtorLink)
...
struct FResultInfo
{
	...
	string                                             Nick;                                                     // 0x000C(0x000C) (NeedCtorLink)
	...
	bool                                               IsMVP;                                                    // 0x0034(0x0004)
	bool                                               IsLevelUp;                                                // 0x0034(0x0004)
...
struct FRewardInfo
{
	...
	byte                                               byClearRewardTYPE;                                        // 0x000C(0x0001)
	byte                                               byClearRewardItemCount;                                   // 0x000D(0x0001)
	byte                                               byScoreRewardTYPE;                                        // 0x000E(0x0001)
	byte                                               byScoreRewardItemCount;                                   // 0x000F(0x0001)
...
struct FBootyInfo
{
	...
	string                                             PrizeWinUserName;                                         // 0x0004(0x000C) (NeedCtorLink)
...
{
	byte[]                                             StateList;                                                // 0x0000(0x000C) (NeedCtorLink)
	byte                                               IsComplete;                                               // 0x000C(0x0001)
	byte                                               Padding00[0x3];                                           // 0x000D(0x0003) MISSED OFFSET
	byte[]                                             UpdatedNum;                                               // 0x0010(0x000C) (NeedCtorLink)
...
{
	byte[]                                             Type;                                                     // 0x0000(0x000C) (NeedCtorLink)
	byte[]                                             Number;                                                   // 0x000C(0x000C) (NeedCtorLink)
	int[]                                              ItemID;                                                   // 0x0018(0x000C) (NeedCtorLink)
	int[]                                              ItemCount;                                                // 0x0024(0x000C) (NeedCtorLink)
};
...
struct FFireProperties
{
	...
	bool                                               bTossed;                                                  // 0x0010(0x0004)
	bool                                               bTrySplash;                                               // 0x0010(0x0004)
	bool                                               bLeadTarget;                                              // 0x0010(0x0004)
	bool                                               bInstantHit;                                              // 0x0010(0x0004)
	bool                                               bInitialized;                                             // 0x0010(0x0004)
};
...
struct FResultData
{
	...
	ECollisionPartsType                                CollisionPart;                                            // 0x001C(0x0001)
...
struct FSEAXEffect
{
	string                                             strClassName;                                             // 0x0000(0x000C) (NeedCtorLink)
...
struct FText
{
	string                                             Text;                                                     // 0x0000(0x000C) (Edit, NeedCtorLink)
	int                                                FontSize;                                                 // 0x000C(0x0004) (Edit)
	EDrawType                                          FontDrawType;                                             // 0x0010(0x0001) (Edit)
...
struct FImage
{
	...
	EDrawType                                          DrawType;                                                 // 0x0014(0x0001) (Edit)
	byte                                               Padding00[0x3];                                           // 0x0015(0x0003) MISSED OFFSET
...
struct FWebzenShopProduct
{
	...
	string                                             ProductName;                                              // 0x000C(0x000C) (NeedCtorLink)
...
struct FWebzenShopPackage
{
	...
	string                                             PackageName;                                              // 0x000C(0x000C) (NeedCtorLink)
	int                                                CashPrice;                                                // 0x0018(0x0004)
	string                                             CashName;                                                 // 0x001C(0x000C) (NeedCtorLink)
	...
	string                                             ItemDesc;                                                 // 0x0048(0x000C) (NeedCtorLink)
	string                                             ItemWarn;                                                 // 0x0054(0x000C) (NeedCtorLink)
	...
	struct FWebzenShopProduct[]                        ProductList;                                              // 0x0098(0x000C) (NeedCtorLink)
	struct FWebzenShopProduct[]                        PriceList;                                                // 0x00A4(0x000C) (NeedCtorLink)
};
...
struct FWebzenInven
{
	...
	string                                             CashName;                                                 // 0x0018(0x000C) (NeedCtorLink)
	struct FBtrDouble                                  CashPoint;                                                // 0x0024(0x0008)
	string                                             SendAccountID;                                            // 0x002C(0x000C) (NeedCtorLink)
	string                                             SendMessage;                                              // 0x0038(0x000C) (NeedCtorLink)
	byte                                               ItemType;                                                 // 0x0044(0x0001)
	byte                                               RelationType;                                             // 0x0045(0x0001)
...
struct FWebzenShopCategory
{
	...
	string                                             CatagoryName;                                             // 0x0008(0x000C) (NeedCtorLink)
	int                                                EventFlag;                                                // 0x0014(0x0004)
	int                                                OpenFlag;                                                 // 0x0018(0x0004)
	int[]                                              SubCategorySeqList;                                       // 0x001C(0x000C) (NeedCtorLink)
	int[]                                              PackageSeqList;                                           // 0x0028(0x000C) (NeedCtorLink)
};
...
struct FPlayerPartsInfo
{
	...
	string                                             strName;                                                  // 0x000C(0x000C) (NeedCtorLink)
	string                                             strMeshName;                                              // 0x0018(0x000C) (NeedCtorLink)
	string                                             strTexName;                                               // 0x0024(0x000C) (NeedCtorLink)
...
struct FPlayerSet
{
	string                                             strBodyName;                                              // 0x0000(0x000C) (NeedCtorLink)
	string                                             strHeadName;                                              // 0x000C(0x000C) (NeedCtorLink)
	string                                             strHelmetName;                                            // 0x0018(0x000C) (NeedCtorLink)
	string                                             strBackpackName;                                          // 0x0024(0x000C) (NeedCtorLink)
};
...
{
	string                                             Name;                                                     // 0x0000(0x000C) (NeedCtorLink)
...
struct FWeaponPart
{
	byte                                               byType;                                                   // 0x0000(0x0001)
	byte                                               Padding00[0x3];                                           // 0x0001(0x0003) MISSED OFFSET
	int                                                iID;                                                      // 0x0004(0x0004)
	string                                             Name;                                                     // 0x0008(0x000C) (NeedCtorLink)
...
struct FsSkill
{
	...
	byte                                               bySlotPosition;                                           // 0x0010(0x0001)
	byte                                               Padding00[0x3];                                           // 0x0011(0x0003) MISSED OFFSET
};
...
struct FsQuickSlot
{
	string                                             strName;                                                  // 0x0000(0x000C) (NeedCtorLink)
	int                                                iUniqueSlotID;                                            // 0x000C(0x0004)
	int                                                iItemID[0x5];                                             // 0x0010(0x0004)
	struct FBtrDouble                                  iUniqueItemUID[0x5];                                      // 0x0024(0x0008)
	int                                                iPartsID[0x4];                                            // 0x004C(0x0004)
	int                                                iSkillID[0x4];                                            // 0x005C(0x0004)
	int                                                iUniqueSkillID[0x4];                                      // 0x006C(0x0004)
};
...
struct FFilePath
{
	string                                             FullPath;                                                 // 0x0000(0x000C) (NeedCtorLink)
	string                                             Directory;                                                // 0x000C(0x000C) (NeedCtorLink)
	string                                             fileName;                                                 // 0x0018(0x000C) (NeedCtorLink)
	string                                             Extension;                                                // 0x0024(0x000C) (NeedCtorLink)
	string[]                                           DirectoryParts;                                           // 0x0030(0x000C) (NeedCtorLink)
};
...
struct FID3Field
{
	...
	string                                             FieldName;                                                // 0x0004(0x000C) (NeedCtorLink)
	string                                             FieldValue;                                               // 0x0010(0x000C) (NeedCtorLink)
	byte                                               FieldID;                                                  // 0x001C(0x0001)
	byte                                               Code[0x4];                                                // 0x001D(0x0001)
	byte                                               Padding00[0x3];                                           // 0x0021(0x0003) MISSED OFFSET
};
...
struct FOtherLoadingStateItem
{
	...
	string                                             strLoadingMsg;                                            // 0x001C(0x000C) (NeedCtorLink)
};
...
{
	string                                             Codec;                                                    // 0x0000(0x000C) (NeedCtorLink)
	string                                             CodecName;                                                // 0x000C(0x000C) (Localized, NeedCtorLink)
	string                                             CodecDescription;                                         // 0x0018(0x000C) (Localized, NeedCtorLink)
};
...
struct FTerrainLayer
{
	...
	ETexMapAxis                                        TextureMapAxis;                                           // 0x0018(0x0001) (Edit)
	byte                                               Padding00[0x3];                                           // 0x0019(0x0003) MISSED OFFSET
...
struct FDecorationLayer
{
	...
	ESortOrder                                         DrawOrder;                                                // 0x0048(0x0001) (Edit)
	...
	EDetailMode                                        DetailMode;                                               // 0x005C(0x0001) (Edit)
	byte                                               Padding01[0x3];                                           // 0x005D(0x0003) MISSED OFFSET
};
...
{
	struct FDecoInfo[]                                 DecoInfo;                                                 // 0x0000(0x000C) (NeedCtorLink)
...
{
	struct FDecoSectorInfo[]                           Sectors;                                                  // 0x0000(0x000C) (NeedCtorLink)
};
...
struct FHitFXData
{
	FName                                              Bone;                                                     // 0x0000(0x0004) (Edit)
	class UClass*                                      damtype;                                                  // 0x0004(0x0004) (Edit)
	bool                                               bSever;                                                   // 0x0008(0x0004) (Edit)
...
struct FSVehicleIcon
{
	...
	bool                                               bIsGreyScale;                                             // 0x0014(0x0004)
};
...
struct FStaticMeshMaterial
{
	...
	byte                                               Padding00[0x4];                                           // 0x0004(0x0004) MISSED OFFSET
	bool                                               EnableCollision;                                          // 0x0008(0x0004) (Edit)
	byte                                               Padding01[0x4];                                           // 0x000C(0x0004) MISSED OFFSET
};
...
{
	ECamOrientation                                    CamOrientation;                                           // 0x0000(0x0001) (Edit)
	byte                                               Padding00[0x3];                                           // 0x0001(0x0003) MISSED OFFSET
...
struct FColorPreset
{
	...
	string                                             preName;                                                  // 0x0034(0x000C) (NeedCtorLink)
};
...
struct FPlayInfoData
{
	...
	string                                             SettingName;                                              // 0x0008(0x000C) (Const, NeedCtorLink)
	string                                             DisplayName;                                              // 0x0014(0x000C) (Const, NeedCtorLink)
	string                                             Description;                                              // 0x0020(0x000C) (Const, NeedCtorLink)
	string                                             Grouping;                                                 // 0x002C(0x000C) (Const, NeedCtorLink)
	string                                             Data;                                                     // 0x0038(0x000C) (Const, NeedCtorLink)
	string                                             ExtraPriv;                                                // 0x0044(0x000C) (Const, NeedCtorLink)
	string                                             Value;                                                    // 0x0050(0x000C) (Const, NeedCtorLink)
	EPlayInfoType                                      RenderType;                                               // 0x005C(0x0001) (Const)
	byte                                               SecLevel;                                                 // 0x005D(0x0001) (Const)
	byte                                               Weight;                                                   // 0x005E(0x0001) (Const)
	byte                                               Padding00[0x1];                                           // 0x005F(0x0001) MISSED OFFSET
	bool                                               bMPOnly;                                                  // 0x0060(0x0004) (Const)
	bool                                               bAdvanced;                                                // 0x0060(0x0004) (Const)
	bool                                               bGlobal;                                                  // 0x0060(0x0004) (Const)
	bool                                               bStruct;                                                  // 0x0060(0x0004) (Const)
...
{
	ESConstant                                         Type;                                                     // 0x0000(0x0001) (Edit)
	byte                                               Padding00[0x3];                                           // 0x0001(0x0003) MISSED OFFSET
...
struct FMaterialSequenceItem
{
	...
	EMaterialSequenceAction                            Action;                                                   // 0x0008(0x0001) (Edit)
	byte                                               Padding00[0x3];                                           // 0x0009(0x0003) MISSED OFFSET
};
...
struct FAlias
{
	FName                                              Alias;                                                    // 0x0000(0x0004) (Config)
	string                                             Command;                                                  // 0x0004(0x000C) (Config, NeedCtorLink)
};
...
{
	string                                             FriendlyName;                                             // 0x0000(0x000C) (Edit, Localized, NeedCtorLink)
...
struct FURL
{
	string                                             Protocol;                                                 // 0x0000(0x000C) (NeedCtorLink)
	string                                             Host;                                                     // 0x000C(0x000C) (NeedCtorLink)
	int                                                Port;                                                     // 0x0018(0x0004)
	string                                             Map;                                                      // 0x001C(0x000C) (NeedCtorLink)
	string[]                                           Op;                                                       // 0x0028(0x000C) (NeedCtorLink)
	string                                             Portal;                                                   // 0x0034(0x000C) (NeedCtorLink)
...
{
	string                                             ClassName;                                                // 0x0000(0x000C) (Edit, Const, NeedCtorLink)
	string                                             FriendlyName;                                             // 0x000C(0x000C) (Edit, Const, NeedCtorLink)
	string                                             PackageName;                                              // 0x0018(0x000C) (Edit, Const, NeedCtorLink)
	string                                             FallbackPackage;                                          // 0x0024(0x000C) (Edit, Const, NeedCtorLink)
	bool                                               bEnglishOnly;                                             // 0x0030(0x0004) (Edit, Const)
...
struct FVehicleRecord
{
	string                                             ClassName;                                                // 0x0000(0x000C) (Edit, Const, NeedCtorLink)
	string                                             FriendlyName;                                             // 0x000C(0x000C) (Edit, Const, NeedCtorLink)
	string                                             Description;                                              // 0x0018(0x000C) (Edit, Const, NeedCtorLink)
...
{
	string                                             ClassName;                                                // 0x0000(0x000C) (Edit, Const, NeedCtorLink)
	string                                             PickupClassName;                                          // 0x000C(0x000C) (Edit, Const, NeedCtorLink)
	string                                             AttachmentClassName;                                      // 0x0018(0x000C) (Edit, Const, NeedCtorLink)
	string                                             Description;                                              // 0x0024(0x000C) (Edit, Const, NeedCtorLink)
	string                                             TextName;                                                 // 0x0030(0x000C) (Edit, Const, NeedCtorLink)
	string                                             FriendlyName;                                             // 0x003C(0x000C) (Edit, Const, NeedCtorLink)
...
struct UCacheManager_FMutatorRecord
{
	...
	string                                             FriendlyName;                                             // 0x000C(0x000C) (Edit, Const, NeedCtorLink)
	string                                             Description;                                              // 0x0018(0x000C) (Edit, Const, NeedCtorLink)
	string                                             IconMaterialName;                                         // 0x0024(0x000C) (Edit, Const, NeedCtorLink)
	string                                             ConfigMenuClassName;                                      // 0x0030(0x000C) (Edit, Const, NeedCtorLink)
	string                                             GroupName;                                                // 0x003C(0x000C) (Edit, Const, NeedCtorLink)
	int                                                RecordIndex;                                              // 0x0048(0x0004) (Const)
	byte                                               bActivated;                                               // 0x004C(0x0001) (Const)
...
struct FMapRecord
{
	string                                             Acronym;                                                  // 0x0000(0x000C) (Edit, Const, NeedCtorLink)
	string                                             MapName;                                                  // 0x000C(0x000C) (Edit, Const, NeedCtorLink)
	string                                             TextName;                                                 // 0x0018(0x000C) (Edit, Const, NeedCtorLink)
	string                                             FriendlyName;                                             // 0x0024(0x000C) (Edit, Const, NeedCtorLink)
	string                                             Author;                                                   // 0x0030(0x000C) (Edit, Const, NeedCtorLink)
	string                                             Description;                                              // 0x003C(0x000C) (Edit, Const, NeedCtorLink)
	int                                                PlayerCountMin;                                           // 0x0048(0x0004) (Edit, Const)
	int                                                PlayerCountMax;                                           // 0x004C(0x0004) (Edit, Const)
	string                                             ScreenshotRef;                                            // 0x0050(0x000C) (Edit, Const, NeedCtorLink)
	string                                             ExtraInfo;                                                // 0x005C(0x000C) (Edit, Const, NeedCtorLink)
...
{
	string                                             FriendlyName;                                             // 0x0000(0x000C) (Edit, Const, NeedCtorLink)
...
struct FStandard
{
	string[]                                           Classes;                                                  // 0x0000(0x000C) (Edit, Const, NeedCtorLink)
	string[]                                           Maps;                                                     // 0x000C(0x000C) (Edit, Const, NeedCtorLink)
};
...
{
	string                                             ClassName;                                                // 0x0000(0x000C) (Edit, Const, NeedCtorLink)
	string                                             GameName;                                                 // 0x000C(0x000C) (Edit, Const, NeedCtorLink)
	string                                             Description;                                              // 0x0018(0x000C) (Edit, Const, NeedCtorLink)
	string                                             TextName;                                                 // 0x0024(0x000C) (Edit, Const, NeedCtorLink)
	string                                             GameAcronym;                                              // 0x0030(0x000C) (Edit, Const, NeedCtorLink)
	string                                             MapListClassName;                                         // 0x003C(0x000C) (Edit, Const, NeedCtorLink)
	string                                             MapPrefix;                                                // 0x0048(0x000C) (Edit, Const, NeedCtorLink)
	string                                             ScreenshotRef;                                            // 0x0054(0x000C) (Edit, Const, NeedCtorLink)
	string                                             HUDMenu;                                                  // 0x0060(0x000C) (Edit, Const, NeedCtorLink)
	string                                             RulesMenu;                                                // 0x006C(0x000C) (Edit, Const, NeedCtorLink)
	bool                                               bTeamGame;                                                // 0x0078(0x0004) (Edit, Const)
	byte                                               GameTypeGroup;                                            // 0x007C(0x0001) (Edit, Const)
...
{
	FName                                              ActorTag;                                                 // 0x0000(0x0004) (Edit)
...
struct FCachedSound
{
	string                                             CacheName;                                                // 0x0000(0x000C) (NeedCtorLink)
...
{
	string                                             key;                                                      // 0x0000(0x000C) (Edit, NeedCtorLink)
	string                                             Value;                                                    // 0x000C(0x000C) (Edit, NeedCtorLink)
};
...
struct FPlayerResponseLine
{
	...
	string                                             PlayerName;                                               // 0x0004(0x000C) (Edit, NeedCtorLink)
...
struct FServerResponseLine
{
	...
	string                                             IP;                                                       // 0x0004(0x000C) (Edit, NeedCtorLink)
	int                                                Port;                                                     // 0x0010(0x0004) (Edit)
	int                                                QueryPort;                                                // 0x0014(0x0004) (Edit)
	string                                             ServerName;                                               // 0x0018(0x000C) (Edit, NeedCtorLink)
	string                                             MapName;                                                  // 0x0024(0x000C) (Edit, NeedCtorLink)
	string                                             GameType;                                                 // 0x0030(0x000C) (Edit, NeedCtorLink)
	...
	string                                             SkillLevel;                                               // 0x004C(0x000C) (Edit, NeedCtorLink)
	struct FKeyValuePair[]                             ServerInfo;                                               // 0x0058(0x000C) (Edit, NeedCtorLink)
	struct FPlayerResponseLine[]                       PlayerInfo;                                               // 0x0064(0x000C) (Edit, NeedCtorLink)
};
...
struct FstMultiBulletPerFire
{
	...
	ECollisionPartsType                                mCollisionPart[0x6];                                      // 0x0060(0x0001)
	byte                                               Padding00[0x2];                                           // 0x0066(0x0002) MISSED OFFSET
...
{
	string                                             mInfo;                                                    // 0x0000(0x000C) (NeedCtorLink)
...
{
	string                                             ChatRoomName;                                             // 0x0000(0x000C) (NeedCtorLink)
	string                                             ChatRoomPassword;                                         // 0x000C(0x000C) (NeedCtorLink)
};
...
{
	string[]                                           MatchWords;                                               // 0x0000(0x000C) (NeedCtorLink)
	string                                             ReplaceWord;                                              // 0x000C(0x000C) (NeedCtorLink)
};
...
struct FWeatherPcl
{
	...
	byte                                               frame;                                                    // 0x002C(0x0001)
	byte                                               Dummy1;                                                   // 0x002D(0x0001)
	byte                                               Visible;                                                  // 0x002E(0x0001)
	byte                                               Dummy2;                                                   // 0x002F(0x0001)
};
...
{
	ERenderStyle                                       RenderStyle;                                              // 0x0000(0x0001)
	byte                                               Padding00[0x3];                                           // 0x0001(0x0003) MISSED OFFSET
	int                                                MinDigitCount;                                            // 0x0004(0x0004)
	float                                              TextureScale;                                             // 0x0008(0x0004)
	EDrawPivot                                         DrawPivot;                                                // 0x000C(0x0001)
	byte                                               Padding01[0x3];                                           // 0x000D(0x0003) MISSED OFFSET
...
struct FSpriteWidget
{
	...
	ERenderStyle                                       RenderStyle;                                              // 0x0004(0x0001)
	byte                                               Padding00[0x3];                                           // 0x0005(0x0003) MISSED OFFSET
	struct FIntBox                                     TextureCoords;                                            // 0x0008(0x0010)
	float                                              TextureScale;                                             // 0x0018(0x0004)
	EDrawPivot                                         DrawPivot;                                                // 0x001C(0x0001)
	byte                                               Padding01[0x3];                                           // 0x001D(0x0003) MISSED OFFSET
	float                                              PosX;                                                     // 0x0020(0x0004)
	float                                              PosY;                                                     // 0x0024(0x0004)
	int                                                OffsetX;                                                  // 0x0028(0x0004)
	int                                                OffsetY;                                                  // 0x002C(0x0004)
	EScaleMode                                         ScaleMode;                                                // 0x0030(0x0001)
	byte                                               Padding02[0x3];                                           // 0x0031(0x0003) MISSED OFFSET
...
struct FLookPreset
{
	string                                             PresetName;                                               // 0x0000(0x000C) (Edit, Localized, NeedCtorLink)
...
struct FQueueItem
{
	string                                             Voice;                                                    // 0x0000(0x000C) (NeedCtorLink)
	float                                              Delay;                                                    // 0x000C(0x0004)
	byte                                               Switch;                                                   // 0x0010(0x0001)
	byte                                               Padding00[0x3];                                           // 0x0011(0x0003) MISSED OFFSET
};
...
struct FPartInfo
{
	...
	string                                             Name;                                                     // 0x0004(0x000C) (NeedCtorLink)
	string                                             Description;                                              // 0x0010(0x000C) (NeedCtorLink)
	...
	string                                             SkillName;                                                // 0x0048(0x000C) (NeedCtorLink)
	...
	string                                             UI_Zoom1;                                                 // 0x0064(0x000C) (NeedCtorLink)
	string                                             UI_Zoom2;                                                 // 0x0070(0x000C) (NeedCtorLink)
...
struct FCustomPartInfo
{
	...
	string                                             Name;                                                     // 0x0008(0x000C) (NeedCtorLink)
	string                                             Description;                                              // 0x0014(0x000C) (NeedCtorLink)
	...
	string                                             SkillName;                                                // 0x0034(0x000C) (NeedCtorLink)
	class UTexture*                                    SkillImage;                                               // 0x0040(0x0004)
	int                                                UI_DamageRange;                                           // 0x0044(0x0004)
	int                                                ui_firesound;                                             // 0x0048(0x0004)
	string                                             UI_Zoom1;                                                 // 0x004C(0x000C) (NeedCtorLink)
	string                                             UI_Zoom2;                                                 // 0x0058(0x000C) (NeedCtorLink)
...
struct FPaintInfo
{
	...
	string                                             PaintingGroupID;                                          // 0x0004(0x000C) (NeedCtorLink)
	...
	string                                             strUI_Icon;                                               // 0x0020(0x000C) (NeedCtorLink)
...
struct FEquippedItemInfo
{
	...
	byte                                               ItemOnUse;                                                // 0x001C(0x0001)
	byte                                               Padding00[0x3];                                           // 0x001D(0x0003) MISSED OFFSET
	int                                                Painting_Item_ID;                                         // 0x0020(0x0004)
	byte                                               byModeItem;                                               // 0x0024(0x0001)
	byte                                               Padding01[0x3];                                           // 0x0025(0x0003) MISSED OFFSET
};
...
{
	int                                                ItemID[0x5];                                              // 0x0000(0x0004)
	int                                                PartsID[0x5];                                             // 0x0014(0x0004)
	struct FBtrDouble                                  ItemUniqueID[0x5];                                        // 0x0028(0x0008)
	int                                                ItemUsedSeconds[0x5];                                     // 0x0050(0x0004)
	int                                                ItemUsedCount[0x5];                                       // 0x0064(0x0004)
	byte                                               ItemOnUse[0x5];                                           // 0x0078(0x0001)
	byte                                               Padding00[0x3];                                           // 0x007D(0x0003) MISSED OFFSET
	int                                                SkillID[0x4];                                             // 0x0080(0x0004)
	int                                                Painting_Item_ID[0x4];                                    // 0x0090(0x0004)
};
...
struct FMyMatchState
{
	...
	string                                             szName;                                                   // 0x0004(0x000C) (NeedCtorLink)
};
...
{
	class UwDefenceGameParam*[]                        EasyLevel;                                                // 0x0000(0x000C) (NeedCtorLink)
	class UwDefenceGameParam*[]                        NormalLevel;                                              // 0x000C(0x000C) (NeedCtorLink)
	class UwDefenceGameParam*[]                        HardLevel;                                                // 0x0018(0x000C) (NeedCtorLink)
	class UwDefenceGameParam*[]                        VeryHardLevel;                                            // 0x0024(0x000C) (NeedCtorLink)
};
...
struct FMapItem
{
	string                                             MapName;                                                  // 0x0000(0x000C) (Edit, NeedCtorLink)
	string                                             OptionString;                                             // 0x000C(0x000C) (Edit, NeedCtorLink)
	string                                             FullURL;                                                  // 0x0018(0x000C) (Edit, NeedCtorLink)
	struct FKeyValuePair[]                             Options;                                                  // 0x0024(0x000C) (Edit, NeedCtorLink)
};
...
{
	string                                             GameType;                                                 // 0x0000(0x000C) (Edit, NeedCtorLink)
	string                                             ActiveMaplist;                                            // 0x000C(0x000C) (Edit, NeedCtorLink)
};
...
{
	string                                             GameType;                                                 // 0x0000(0x000C) (NeedCtorLink)
	int                                                Active;                                                   // 0x000C(0x0004)
	int                                                LastActive;                                               // 0x0010(0x0004)
	struct FMapItem[]                                  AllMaps;                                                  // 0x0014(0x000C) (NeedCtorLink)
	class UMaplistRecord*[]                            Records;                                                  // 0x0020(0x000C) (NeedCtorLink)
};
...
{
	int                                                iWeaponID;                                                // 0x0000(0x0004)
	bool                                               bHaveSupplyItem;                                          // 0x0004(0x0004)
};
...
{
	string                                             ClanName;                                                 // 0x0000(0x000C) (NeedCtorLink)
	int                                                Pattern;                                                  // 0x000C(0x0004)
	int                                                BG;                                                       // 0x0010(0x0004)
	int                                                BL;                                                       // 0x0014(0x0004)
	bool                                               bClanLF;                                                  // 0x0018(0x0004)
...
{
	string                                             M;                                                        // 0x0000(0x000C) (NeedCtorLink)
	int                                                P;                                                        // 0x000C(0x0004)
	int                                                S;                                                        // 0x0010(0x0004)
	string                                             G;                                                        // 0x0014(0x000C) (NeedCtorLink)
	string                                             U;                                                        // 0x0020(0x000C) (NeedCtorLink)
};
...
{
	string                                             MapName;                                                  // 0x0000(0x000C) (NeedCtorLink)
	int                                                PlayCount;                                                // 0x000C(0x0004)
	int                                                Sequence;                                                 // 0x0010(0x0004)
	bool                                               bEnabled;                                                 // 0x0014(0x0004)
};
...
{
	string                                             GameClass;                                                // 0x0000(0x000C) (NeedCtorLink)
	string                                             Prefix;                                                   // 0x000C(0x000C) (NeedCtorLink)
	string                                             GameName;                                                 // 0x0018(0x000C) (NeedCtorLink)
};
...
struct FMapVoteGameConfig
{
	string                                             GameClass;                                                // 0x0000(0x000C) (NeedCtorLink)
	string                                             Prefix;                                                   // 0x000C(0x000C) (NeedCtorLink)
	string                                             Acronym;                                                  // 0x0018(0x000C) (NeedCtorLink)
	string                                             GameName;                                                 // 0x0024(0x000C) (NeedCtorLink)
	string                                             Mutators;                                                 // 0x0030(0x000C) (NeedCtorLink)
	string                                             Options;                                                  // 0x003C(0x000C) (NeedCtorLink)
};
...
{
	EStreamPlaylistType                                Type;                                                     // 0x0000(0x0001) (Edit)
	byte                                               Padding00[0x3];                                           // 0x0001(0x0003) MISSED OFFSET
	string                                             ParserClass;                                              // 0x0004(0x000C) (Edit, NeedCtorLink)
};
...
struct FHtmlChar
{
	string                                             Plain;                                                    // 0x0000(0x000C) (NeedCtorLink)
	string                                             Coded;                                                    // 0x000C(0x000C) (NeedCtorLink)
};
