...
struct FTimerData
{
	bool                                               bLoop;                                                    // 0x0000(0x0004)
	FName                                              FuncName;                                                 // 0x0004(0x0004)
...
struct FHudLocalizedMessage
{
	...
	string                                             StringMessage;                                            // 0x0004(0x000C) (NeedCtorLink)
	...
	EDrawPivot                                         DrawPivot;                                                // 0x0034(0x0001)
	EStackMode                                         StackMode;                                                // 0x0035(0x0001)
	...
	bool                                               Drawn;                                                    // 0x0048(0x0004)
	bool                                               PlaySound;                                                // 0x0048(0x0004)
...
struct FKillMessageItem
{
	...
	string                                             KillerName;                                               // 0x0008(0x000C) (NeedCtorLink)
	string                                             VictimName;                                               // 0x0014(0x000C) (NeedCtorLink)
	class UClass*                                      DamageType;                                               // 0x0020(0x0004)
	float                                              TimeToRemove;                                             // 0x0024(0x0004)
	bool                                               NoKillerName;                                             // 0x0028(0x0004)
	bool                                               NoVictimName;                                             // 0x0028(0x0004)
	...
	bool                                               IsHeadShot;                                               // 0x0048(0x0004)
	bool                                               IsAimShot;                                                // 0x0048(0x0004)
	int                                                NumKillSuccession;                                        // 0x004C(0x0004)
	bool                                               KillerIsBot;                                              // 0x0050(0x0004)
	bool                                               VictimIsBot;                                              // 0x0050(0x0004)
...
struct FGUIListElem
{
	string                                             Item;                                                     // 0x0000(0x000C) (NeedCtorLink)
	class UObject*                                     ExtraData;                                                // 0x000C(0x0004)
	string                                             ExtraStrData;                                             // 0x0010(0x000C) (NeedCtorLink)
	bool                                               bSection;                                                 // 0x001C(0x0004)
};
...
{
	string                                             SortString;                                               // 0x0000(0x000C) (Edit, Const, EditConst, NeedCtorLink)
...
struct FGUITabItem
{
	string                                             ClassName;                                                // 0x0000(0x000C) (Edit, NeedCtorLink)
	string                                             Caption;                                                  // 0x000C(0x000C) (Edit, Localized, NeedCtorLink)
	string                                             Hint;                                                     // 0x0018(0x000C) (Edit, Localized, NeedCtorLink)
};
...
struct FeOwnageMap
{
	...
	string                                             MapName;                                                  // 0x0004(0x000C) (NeedCtorLink)
	string                                             MapDesc;                                                  // 0x0010(0x000C) (NeedCtorLink)
	string                                             MapURL;                                                   // 0x001C(0x000C) (NeedCtorLink)
};
...
{
	string                                             ProfileName;                                              // 0x0000(0x000C) (NeedCtorLink)
...
{
	string                                             MenuClassName;                                            // 0x0000(0x000C) (NeedCtorLink)
	bool                                               bPreInitialize;                                           // 0x000C(0x0004)
};
...
{
	string                                             MenuClassName;                                            // 0x0000(0x000C) (Edit, NeedCtorLink)
	string                                             Param1;                                                   // 0x000C(0x000C) (Edit, NeedCtorLink)
	string                                             Param2;                                                   // 0x0018(0x000C) (Edit, NeedCtorLink)
};
...
{
	string                                             key;                                                      // 0x0000(0x000C) (Edit, Localized, NeedCtorLink)
	string                                             Description;                                              // 0x000C(0x000C) (Edit, Localized, NeedCtorLink)
};
...
{
	string                                             IP;                                                       // 0x0000(0x000C) (Edit, NeedCtorLink)
	string                                             Port;                                                     // 0x000C(0x000C) (Edit, NeedCtorLink)
	string                                             UserName;                                                 // 0x0018(0x000C) (Edit, NeedCtorLink)
	string                                             Password;                                                 // 0x0024(0x000C) (Edit, NeedCtorLink)
	bool                                               bAutologin;                                               // 0x0030(0x0004) (Edit)
};
...
struct FGUITreeNode
{
	string                                             Caption;                                                  // 0x0000(0x000C) (Edit, NeedCtorLink)
	string                                             Value;                                                    // 0x000C(0x000C) (Edit, NeedCtorLink)
	string                                             ParentCaption;                                            // 0x0018(0x000C) (Edit, NeedCtorLink)
	string                                             ExtraInfo;                                                // 0x0024(0x000C) (Edit, NeedCtorLink)
	int                                                Level;                                                    // 0x0030(0x0004) (Edit)
	bool                                               bEnabled;                                                 // 0x0034(0x0004) (Edit)
};
...
struct FMultiSelectListElem
{
	...
	class UObject*                                     ExtraData;                                                // 0x000C(0x0004)
	string                                             ExtraStrData;                                             // 0x0010(0x000C) (NeedCtorLink)
	bool                                               bSelected;                                                // 0x001C(0x0004)
	int                                                SelectionIndex;                                           // 0x0020(0x0004)
	bool                                               bSection;                                                 // 0x0024(0x0004)
};
...
struct FAPackInfo
{
	string                                             PackageName;                                              // 0x0000(0x000C) (NeedCtorLink)
	string                                             Description;                                              // 0x000C(0x000C) (Localized, NeedCtorLink)
};
...
{
	string                                             Server;                                                   // 0x0000(0x000C) (NeedCtorLink)
	string                                             Password;                                                 // 0x000C(0x000C) (NeedCtorLink)
};
...
struct FChatStruct
{
	string                                             Message;                                                  // 0x0000(0x000C) (NeedCtorLink)
...
{
	bool                                               bRepeat;                                                  // 0x0000(0x0004) (Config)
	bool                                               bShuffle;                                                 // 0x0000(0x0004) (Config)
	string                                             current;                                                  // 0x0004(0x000C) (Config, NeedCtorLink)
	string[]                                           Songs;                                                    // 0x0010(0x000C) (Config, NeedCtorLink)
};
...
struct FGameNotice
{
	string                                             sNotice;                                                  // 0x0000(0x000C) (NeedCtorLink)
	float                                              fStartTime;                                               // 0x000C(0x0004)
	float                                              fEndTime;                                                 // 0x0010(0x0004)
	float                                              fLifeTime;                                                // 0x0014(0x0004)
	bool                                               bSendConsole;                                             // 0x0018(0x0004)
	float                                              NoticeStartPosX;                                          // 0x001C(0x0004)
};
...
{
	string                                             KillerName;                                               // 0x0000(0x000C) (NeedCtorLink)
	string                                             VictimName;                                               // 0x000C(0x000C) (NeedCtorLink)
	class UClass*                                      Type;                                                     // 0x0018(0x0004)
	float                                              Time;                                                     // 0x001C(0x0004)
	string                                             Message;                                                  // 0x0020(0x000C) (NeedCtorLink)
...
struct FSkillProperty
{
	...
	bool                                               bDrawedIcon;                                              // 0x0014(0x0004)
	bool                                               bDrawed;                                                  // 0x0014(0x0004)
...
struct FSQuest
{
	...
	bool                                               bDraw;                                                    // 0x0014(0x0004)
	string                                             MissionDesc;                                              // 0x0018(0x000C) (NeedCtorLink)
	bool                                               bPlaySound;                                               // 0x0024(0x0004)
};
...
struct FstItemInfo
{
	...
	byte                                               nBuyItemIndex;                                            // 0x0008(0x0001)
	byte                                               nBuyEnableLevel;                                          // 0x0009(0x0001)
	byte                                               Padding00[0x2];                                           // 0x000A(0x0002) MISSED OFFSET
};
