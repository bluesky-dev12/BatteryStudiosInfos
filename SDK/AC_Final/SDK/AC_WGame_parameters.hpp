...
struct AwAIBotBase_SeeMonster_Params
{
...
struct AwPawn_SpawnDSentry_Params
{
};

// Function WGame.wPawn.SpawnSentry
struct AwPawn_SpawnSentry_Params
{
...
struct AwPawn_ClientResetPhysicsBasedAnim_Params
{
};
...
struct AwPlayer_GetUniqueID_Params
{
	int                                                iItemID;                                                  // (Parm)
...
struct AwPlayer_SetItemCount_Params
{
	int                                                iItemID;                                                  // (Parm)
...
struct AwPlayer_GetItemCount_Params
{
	int                                                iItemID;                                                  // (Parm)
	int                                                ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct AwPlayer_ServerReqNowRespawn_Params
{
	struct FBtrDouble                                  iUniqueID;                                                // (Parm)
};

// Function WGame.wPlayer.ServerReqUsingItem
struct AwPlayer_ServerReqUsingItem_Params
{
	int                                                iItemID;                                                  // (Parm)
	struct FBtrDouble                                  iUniqueID;                                                // (Parm)
};
...
struct AwPlayer_UsingItem_Slot8_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};

// Function WGame.wPlayer.UsingItem_Slot7
struct AwPlayer_UsingItem_Slot7_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};

// Function WGame.wPlayer.ReqUsingItem
struct AwPlayer_ReqUsingItem_Params
{
	byte                                               byKey;                                                    // (Parm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct AwAmmoSupplyObjective_CheckFillAmmoToWeapon_Params
{
...
struct AwSentryGunPawn_PlayDyingSound_Params
{
};

// Function WGame.wSentryGunPawn.TakeDamageSound
struct AwSentryGunPawn_TakeDamageSound_Params
{
	int                                                LeftHealth;                                               // (Parm)
	int                                                ActualDamage;                                             // (Parm)
	struct FVector                                     HitLocation;                                              // (Parm)
...
struct AwSentryGunPawn_SpawnDebris_Params
{
};

// Function WGame.wSentryGunPawn.PlayDirectionalDeath
struct AwSentryGunPawn_PlayDirectionalDeath_Params
{
	struct FVector                                     HitLoc;                                                   // (Parm)
};

// Function WGame.wSentryGunPawn.StopFiring
struct AwSentryGunPawn_StopFiring_Params
{
};

// Function WGame.wSentryGunPawn.GetBloodHitClass
struct AwSentryGunPawn_GetBloodHitClass_Params
{
	ECollisionPartsType                                collisionParts;                                           // (Parm)
	class UClass*                                      ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct AwSentryGunPawn_UpdateIdleMuzzle_Params
{
	float                                              dt;                                                       // (Parm)
	bool                                               bYaw;                                                     // (Parm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ReturnParm)
...
struct AwSentryGunPawn_UpdateMuzzleBoneRotation_Params
{
	float                                              dt;                                                       // (Parm)
...
struct AwSentryGunPawn_Tick_Activate_Params
{
	float                                              dt;                                                       // (Parm)
};

// Function WGame.wSentryGunPawn.InitSentryZuzzleRotationParam
struct AwSentryGunPawn_InitSentryZuzzleRotationParam_Params
{
};

// Function WGame.wSentryGunPawn.Tick
struct AwSentryGunPawn_Tick_Params
{
	float                                              Delta;                                                    // (Parm)
};

// Function WGame.wSentryGunPawn.RemoveLevelSentryGun
struct AwSentryGunPawn_RemoveLevelSentryGun_Params
{
};
...
struct AwSentryGunPawn_UnPossessed_Params
{
};

// Function WGame.wSentryGunPawn.AddAllyEffect
struct AwSentryGunPawn_AddAllyEffect_Params
{
	int                                                iSideIndex;                                               // (OptionalParm, Parm)
};

// Function WGame.wSentryGunPawn.AddDefaultInventory
struct AwSentryGunPawn_AddDefaultInventory_Params
{
	bool                                               bQuickslotChange;                                         // (OptionalParm, Parm)
};
...
struct AwAISentryGunController_Tick_Params
{
	float                                              dt;                                                       // (Parm)
};
