...
struct FAddBotInfo
{
	...
	bool                                               bUseDynamicRegenLocation;                                 // 0x0018(0x0004)
	struct FVector                                     v3DynamicRegenLocation;                                   // 0x001C(0x000C)
	float                                              fDynamicRegenPitch;                                       // 0x0028(0x0004)
};
...
{
	string                                             CharacterName;                                            // 0x0000(0x000C) (Config, NeedCtorLink)
	string                                             PlayerName;                                               // 0x000C(0x000C) (Config, NeedCtorLink)
	string                                             CustomVoice;                                              // 0x0018(0x000C) (Config, NeedCtorLink)
	EPlayerPos                                         CustomOrders;                                             // 0x0024(0x0001) (Config)
	byte                                               Padding00[0x3];                                           // 0x0025(0x0003) MISSED OFFSET
	string                                             FavoriteWeapon;                                           // 0x0028(0x000C) (Edit, Config, NeedCtorLink)
	...
	bool                                               bJumpy;                                                   // 0x0050(0x0004) (Config)
};
...
{
	string                                             PlayerHash;                                               // 0x0000(0x000C) (NeedCtorLink)
	byte                                               Restriction;                                              // 0x000C(0x0001)
...
struct AUnrealPlayerChatManager_FChatBan
{
	...
	string                                             PlayerHash;                                               // 0x0004(0x000C) (NeedCtorLink)
	string                                             PlayerAddress;                                            // 0x0010(0x000C) (NeedCtorLink)
	byte                                               PlayerVoiceMask;                                          // 0x001C(0x0001)
	byte                                               Restriction;                                              // 0x001D(0x0001)
	byte                                               Padding00[0x2];                                           // 0x001E(0x0002) MISSED OFFSET
};
