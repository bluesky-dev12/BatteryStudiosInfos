...
{
public:
	byte                                               Padding00[0x4];                                           // 0x003C(0x0004) MISSED OFFSET
...
{
public:
	byte                                               Padding00[0xF0];                                          // 0x0120(0x00F0) MISSED OFFSET
	string[]                                           EditPackages;                                             // 0x0210(0x000C) (Edit, NeedCtorLink)
	string[]                                           CutdownPackages;                                          // 0x021C(0x000C) (Edit, NeedCtorLink)
	byte                                               Padding01[0x4];                                           // 0x0228(0x0004) MISSED OFFSET
...
{
public:
	FName                                              TextureName;                                              // 0x006C(0x0004) (Edit)
...
{
public:
	FName                                              ClassName;                                                // 0x006C(0x0004) (Edit)
...
{
public:
	string                                             LevelTitle;                                               // 0x006C(0x000C) (Edit, NeedCtorLink)
	string                                             Author;                                                   // 0x0078(0x000C) (Edit, NeedCtorLink)
	bool                                               CloseExistingWindows;                                     // 0x0084(0x0004) (Edit)
...
{
public:
	byte                                               Padding00[0x8];                                           // 0x01E0(0x0008) MISSED OFFSET
...
{
public:
	byte                                               Padding00[0x88];                                          // 0x01E0(0x0088) MISSED OFFSET
...
{
public:
	byte                                               Padding00[0x4];                                           // 0x01E0(0x0004) MISSED OFFSET
...
{
public:
	string                                             FontName;                                                 // 0x006C(0x000C) (Edit, NeedCtorLink)
	...
	string                                             Chars;                                                    // 0x0094(0x000C) (Edit, NeedCtorLink)
	bool                                               AntiAlias;                                                // 0x00A0(0x0004) (Edit)
	string                                             UnicodeRange;                                             // 0x00A4(0x000C) (Edit, NeedCtorLink)
	string                                             Wildcard;                                                 // 0x00B0(0x000C) (Edit, NeedCtorLink)
	string                                             Path;                                                     // 0x00BC(0x000C) (Edit, NeedCtorLink)
	int                                                Style;                                                    // 0x00C8(0x0004) (Edit)
	bool                                               Italic;                                                   // 0x00CC(0x0004) (Edit)
	bool                                               Padding00 : 31;                                           // 0x00CC(0x0001)
	bool                                               Underline;                                                // 0x00D0(0x0004) (Edit)
