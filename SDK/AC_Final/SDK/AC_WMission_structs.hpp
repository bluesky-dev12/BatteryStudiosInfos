...
#define CONST_MAX_WAIT_END_ROUND_TIME                             3.0f
...
// Enum WMission.wRandomBonusPack.E_RAND_SUPPLY_TYPE
enum class E_RAND_SUPPLY_TYPE : uint8_t
{
	ITS_AMMO                       = 0,
	ITS_WEAPON                     = 1,
	ITS_SKILL                      = 2
