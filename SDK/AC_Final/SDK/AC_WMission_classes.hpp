...
{
public:
	byte                                               DisabledObjectivesCount;                                  // 0x0738(0x0001) (Net)
	byte                                               DisabledFinalObjective;                                   // 0x0739(0x0001) (Net)
	byte                                               DestroyedVehicles;                                        // 0x073A(0x0001) (Net)
	byte                                               Padding00[0x1];                                           // 0x073B(0x0001) MISSED OFFSET
	float                                              TrophiesXOffset;                                          // 0x073C(0x0004)
	bool                                               bAutoRespawn;                                             // 0x0740(0x0004) (Net)
	bool                                               bTeleportToSpawnArea;                                     // 0x0740(0x0004) (Net)
...
{
public:
	EAlienModeType                                     eObjType;                                                 // 0x0748(0x0001) (Net)
	byte                                               InfectionLevel;                                           // 0x0749(0x0001) (Net)
	EAlienMode_Object_Type                             eSkinType;                                                // 0x074A(0x0001) (Net)
	byte                                               InfectionPoint;                                           // 0x074B(0x0001)
	float                                              fAttackDereaseRate;                                       // 0x074C(0x0004)
	byte                                               NoTransferAlienPoint;                                     // 0x0750(0x0001)
	byte                                               Padding00[0x3];                                           // 0x0751(0x0003) MISSED OFFSET
	...
	int GetTeamIndex();
	void Reset();
	byte GetInfectionLevel();
	void SetInfectionLevel(byte Level);
	EAlienMode_Object_Type GetSkinType();
	void SetSkinType(EAlienMode_Object_Type eSkinType);
	EAlienModeType GetObjType();
	void SetObjType(EAlienModeType eObjType);
};


// Class WMission.wHUD_Mission
// 0x06C4 (0x4D14 - 0x4650)
class AwHUD_Mission : public AHudCTeamDeathMatch
{
public:
	float                                              ObjectiveScale;                                           // 0x4650(0x0004) (Config)
	bool                                               bOnHUDObjectiveNotification;                              // 0x4654(0x0004) (Config)
	bool                                               bShowInfoPods;                                            // 0x4654(0x0004) (Config)
	bool                                               bDrawAllObjectives;                                       // 0x4654(0x0004) (Config)
	bool                                               bShow3DArrow;                                             // 0x4654(0x0004) (Config)
	bool                                               bObjectiveReminder;                                       // 0x4654(0x0004) (Config)
	bool                                               bDrawRadar;                                               // 0x4654(0x0004) (Config)
	bool                                               bDrawRadarCardinalPoints;                                 // 0x4654(0x0004) (Config)
	bool                                               bShowWillowWhisp;                                         // 0x4654(0x0004) (Config)
	int                                                wPawnCountsOld;                                           // 0x4658(0x0004)
	bool                                               bForceSpawnNotification;                                  // 0x465C(0x0004)
	bool                                               bShowObjectiveBoard;                                      // 0x465C(0x0004)
	bool                                               bForceObjectiveBoard;                                     // 0x465C(0x0004)
	bool                                               bShowMissionIcon;                                         // 0x465C(0x0004)
	class AGameObjective*[]                            obj;                                                      // 0x4660(0x000C) (NeedCtorLink)
	class AwInfoPod*[]                                 InfoPods;                                                 // 0x466C(0x000C) (NeedCtorLink)
	class AwTrigger_MSMessageTrigger*[]                MTrigger;                                                 // 0x4678(0x000C) (NeedCtorLink)
	class UTexRotator*[]                               BehindObjectiveArrows;                                    // 0x4684(0x000C) (NeedCtorLink)
	class AwObjectivePointingArrow*                    OBJPointingArrow;                                         // 0x4690(0x0004)
	byte                                               BehindObjectiveCount;                                     // 0x4694(0x0001)
	byte                                               Padding00[0x3];                                           // 0x4695(0x0003) MISSED OFFSET
	float                                              OBJ_ReAppearTime;                                         // 0x4698(0x0004)
	float                                              OBJ_FadedOutTime;                                         // 0x469C(0x0004)
	float                                              Global_Delta;                                             // 0x46A0(0x0004)
	float                                              fBlink;                                                   // 0x46A4(0x0004)
	float                                              fPulse;                                                   // 0x46A8(0x0004)
	float                                              ASRadarScale;                                             // 0x46AC(0x0004)
	float                                              ASRadarPosX;                                              // 0x46B0(0x0004) (Config)
	float                                              ASRadarPosY;                                              // 0x46B4(0x0004) (Config)
	float                                              LastRadarUpdate;                                          // 0x46B8(0x0004)
	class AVehicle*[]                                  RadarVehicleCache;                                        // 0x46BC(0x000C) (NeedCtorLink)
	class UMaterial*                                   HealthBarBackMat;                                         // 0x46C8(0x0004)
	class UMaterial*                                   HealthBarMat;                                             // 0x46CC(0x0004)
	float                                              HealthBarWidth;                                           // 0x46D0(0x0004)
	float                                              HealthBarHeight;                                          // 0x46D4(0x0004)
	int                                                OldRemainingRoundTime;                                    // 0x46D8(0x0004)
	string                                             IP_Bracket_Open;                                          // 0x46DC(0x000C) (Localized, NeedCtorLink)
	string                                             IP_Bracket_Close;                                         // 0x46E8(0x000C) (Localized, NeedCtorLink)
	string                                             Cardinal_North;                                           // 0x46F4(0x000C) (Localized, NeedCtorLink)
	string                                             Cardinal_East;                                            // 0x4700(0x000C) (Localized, NeedCtorLink)
	string                                             Cardinal_South;                                           // 0x470C(0x000C) (Localized, NeedCtorLink)
	string                                             Cardinal_West;                                            // 0x4718(0x000C) (Localized, NeedCtorLink)
	string                                             NoGameReplicationInfoString;                              // 0x4724(0x000C) (Localized, NeedCtorLink)
	string                                             MetersString;                                             // 0x4730(0x000C) (Localized, NeedCtorLink)
	string                                             TargetString;                                             // 0x473C(0x000C) (Localized, NeedCtorLink)
	string                                             NoTargetString;                                           // 0x4748(0x000C) (Localized, NeedCtorLink)
	string                                             PracticeRoundString;                                      // 0x4754(0x000C) (Localized, NeedCtorLink)
	float                                              AttackerProgressUpdateTime;                               // 0x4760(0x0004)
	float                                              ObjectiveProgressPulseTime;                               // 0x4764(0x0004) (Config)
	byte                                               ObjectiveProgress;                                        // 0x4768(0x0001)
	byte                                               OldObjectiveProgress;                                     // 0x4769(0x0001)
	byte                                               Padding01[0x2];                                           // 0x476A(0x0002) MISSED OFFSET
	class AwMSGameReplicationInfo*                     MSGRI;                                                    // 0x476C(0x0004)
	class AwMSPlayerReplicationInfo*                   MSPRI;                                                    // 0x4770(0x0004)
	class AGameObjective*                              CurrentObjective;                                         // 0x4774(0x0004)
	class AVehicle*                                    TrackedVehicle;                                           // 0x4778(0x0004)
	float                                              NextTrackedVehicleSearch;                                 // 0x477C(0x0004)
	struct FSpriteWidget                               RoundTimeBackGround;                                      // 0x4780(0x0040) (Edit)
	struct FSpriteWidget                               ReinforceBackground;                                      // 0x47C0(0x0040) (Edit)
	struct FSpriteWidget                               TeleportBackground;                                       // 0x4800(0x0040) (Edit)
	struct FSpriteWidget                               VSBackground;                                             // 0x4840(0x0040) (Edit)
	struct FSpriteWidget                               RoundTimeIcon;                                            // 0x4880(0x0040) (Edit)
	struct FSpriteWidget                               ReinforceIcon;                                            // 0x48C0(0x0040) (Edit)
	struct FSpriteWidget                               TeleportIcon;                                             // 0x4900(0x0040) (Edit)
	struct FSpriteWidget                               VSIcon;                                                   // 0x4940(0x0040) (Edit)
	struct FSpriteWidget                               ReinforcePulse;                                           // 0x4980(0x0040) (Edit)
	struct FSpriteWidget                               TeleportPulse;                                            // 0x49C0(0x0040) (Edit)
	struct FSpriteWidget                               VSPulse;                                                  // 0x4A00(0x0040) (Edit)
	struct FSpriteWidget                               RoundTimeBackGroundDisc;                                  // 0x4A40(0x0040) (Edit)
	struct FSpriteWidget                               ReinforceBackGroundDisc;                                  // 0x4A80(0x0040) (Edit)
	struct FSpriteWidget                               TeleportBackgroundDisc;                                   // 0x4AC0(0x0040) (Edit)
	struct FSpriteWidget                               VSBackgroundDisc;                                         // 0x4B00(0x0040) (Edit)
	struct FSpriteWidget                               RoundTimeSeparator;                                       // 0x4B40(0x0040) (Edit)
	struct FNumericWidget                              RoundTimeMinutes;                                         // 0x4B80(0x0030) (Edit)
	struct FNumericWidget                              RoundTimeSeconds;                                         // 0x4BB0(0x0030) (Edit)
	struct FNumericWidget                              ReinforceSprNum;                                          // 0x4BE0(0x0030) (Edit)
	struct FNumericWidget                              TeleportSprNum;                                           // 0x4C10(0x0030) (Edit)
	float                                              NextSpawnNotification;                                    // 0x4C40(0x0004)
	byte                                               PrevTeam;                                                 // 0x4C44(0x0001)
	byte                                               Padding02[0x3];                                           // 0x4C45(0x0003) MISSED OFFSET
	class AwObjectiveProgressDisplay*                  ObjectiveBoard;                                           // 0x4C48(0x0004) (Edit)
	float                                              IntroTitleFade;                                           // 0x4C4C(0x0004)
	float                                              fViewDelayTime;                                           // 0x4C50(0x0004)
	float                                              fBeginDrawTime;                                           // 0x4C54(0x0004)
	bool                                               bViewRoundResult;                                         // 0x4C58(0x0004)
	struct FSpriteWidget                               PlantLabel;                                               // 0x4C5C(0x0040) (Edit)
	struct FSpriteWidget                               DiffuseLabel;                                             // 0x4C9C(0x0040) (Edit)
	bool                                               bProgressDone;                                            // 0x4CDC(0x0004)
	float                                              fProgressDoneTime;                                        // 0x4CE0(0x0004)
	struct FSpriteWidget[]                             MinimapEnemyFlags;                                        // 0x4CE4(0x000C) (Edit, NeedCtorLink)
	struct FSpriteWidget[]                             MinimapNoncapturedFlag;                                   // 0x4CF0(0x000C) (Edit, NeedCtorLink)
	struct FSpriteWidget[]                             MinimapAllyFlag;                                          // 0x4CFC(0x000C) (Edit, NeedCtorLink)
	float                                              LastSpectatingTime;                                       // 0x4D08(0x0004)
	float                                              BeginSpectatingTime;                                      // 0x4D0C(0x0004)
	bool                                               bDrawRoundResult;                                         // 0x4D10(0x0004)
	...
	void DrawTextWithBackground(class UCanvas* C, const string& Text, const struct FColor& TextColor, float XO, float YO);
	...
	void STATIC_Draw_2DCollisionBox(class UCanvas* C, class AActor* A, const struct FVector& ScrPos, const string& Description, float ColExpand, bool bSizeOverride);
	struct FColor STATIC_GetGYRColorRamp(float Pct);
	struct FColor GetObjectiveColor(class AGameObjective* Go, byte* bProgressPulsing);
	struct FColor STATIC_GetTeamColor(byte Team);
	...
	int STATIC_GetGameObjectIndexByTag(const FName& Tag);
...
// 0x092C (0x5640 - 0x4D14)
class AwHUD_Alien : public AwHUD_Mission
{
public:
	int                                                iModeItemSlots[0x2];                                      // 0x4D14(0x0004)
	byte[]                                             AlienObjectTypes;                                         // 0x4D1C(0x000C) (NeedCtorLink)
	byte                                               SelectedAlienObjectType;                                  // 0x4D28(0x0001)
	byte                                               byAlienGame_MenuType;                                     // 0x4D29(0x0001)
	byte                                               Padding00[0x2];                                           // 0x4D2A(0x0002) MISSED OFFSET
	struct FSpriteWidget                               WAlienSelectMenuBack;                                     // 0x4D2C(0x0040)
	struct FSpriteWidget                               WAlienSelectBut_Cli;                                      // 0x4D6C(0x0040)
	struct FSpriteWidget                               WAlienSelectBut_Nor;                                      // 0x4DAC(0x0040)
	struct FSpriteWidget                               WHumanMarkDisplay;                                        // 0x4DEC(0x0040)
	struct FSpriteWidget                               WAlienMarkDisplay;                                        // 0x4E2C(0x0040)
	struct FSpriteWidget                               WAlienModeSkillSlot;                                      // 0x4E6C(0x0040)
	struct FSpriteWidget                               WAlienModeSkillType[0x2];                                 // 0x4EAC(0x0040)
	struct FSpriteWidget                               WAlienModeAlienType[0x3];                                 // 0x4F2C(0x0040)
	class UMaterial*[]                                 matModeItemIcons;                                         // 0x4FEC(0x000C) (NeedCtorLink)
	class UMaterial*[]                                 matAlienTypeIcons;                                        // 0x4FF8(0x000C) (NeedCtorLink)
	struct FSpriteWidget                               WHumanAttackBuffDisplay;                                  // 0x5004(0x0040)
	struct FSpriteWidget                               WHumanAttackLevelDisplay[0xA];                            // 0x5044(0x0040)
	string                                             strOriAttackBuffMsg;                                      // 0x52C4(0x000C) (Localized, NeedCtorLink)
	string                                             strAttackBuffMsg;                                         // 0x52D0(0x000C) (NeedCtorLink)
	struct FSpriteWidget                               WAlienLevelBackDisplay;                                   // 0x52DC(0x0040)
	struct FSpriteWidget                               WAlienLevelDisplay[0x5];                                  // 0x531C(0x0040)
	struct FSpriteWidget                               WAlienEyeBackDisplay;                                     // 0x545C(0x0040)
	string                                             strRoundGoalMsg;                                          // 0x549C(0x000C) (NeedCtorLink)
	string                                             strHumanGoalMsg;                                          // 0x54A8(0x000C) (Localized, NeedCtorLink)
	string                                             strAlienGoalMsg;                                          // 0x54B4(0x000C) (Localized, NeedCtorLink)
	string                                             strAlienLevelMsg[0x3];                                    // 0x54C0(0x000C) (Localized, NeedCtorLink)
	class AwPawn*[]                                    ShowHeroPawnArrays;                                       // 0x54E4(0x000C) (NeedCtorLink)
	struct FSpriteWidget                               WHeroIconDisplays[0x2];                                   // 0x54F0(0x0040)
	string                                             strAlienSelect;                                           // 0x5570(0x000C) (Localized, NeedCtorLink)
	struct FSpriteWidget                               WAlienMeleeKill;                                          // 0x557C(0x0040) (Edit)
	string                                             strSecond;                                                // 0x55BC(0x000C) (Localized, NeedCtorLink)
	string                                             strAlienSelectKey[0x3];                                   // 0x55C8(0x000C) (Localized, NeedCtorLink)
	string                                             strAlienSelectWaitMesage;                                 // 0x55EC(0x000C) (Localized, NeedCtorLink)
	float                                              fCurAlienRespawnTime;                                     // 0x55F8(0x0004)
	bool                                               bSelectAlienType;                                         // 0x55FC(0x0004)
	float                                              fSuperHeroEffectFirstRange;                               // 0x5600(0x0004)
	float                                              fSuperHeroEffectEndRange;                                 // 0x5604(0x0004)
	float                                              fSuperHeroEffectCurValue;                                 // 0x5608(0x0004)
	string                                             strHumanHeroName[0x2];                                    // 0x560C(0x000C) (Localized, NeedCtorLink)
	byte                                               byHeroDisplayIndex;                                       // 0x5624(0x0001)
	byte                                               Padding01[0x3];                                           // 0x5625(0x0003) MISSED OFFSET
	struct FScriptDelegate                             __DrawDisplayHUD__Delegate;                               // 0x5628(0x0090) (NeedCtorLink)
	struct FScriptDelegate                             __DrawBackScreen__Delegate;                               // 0x5630(0x0090) (NeedCtorLink)
	struct FScriptDelegate                             __DrawDisplaySelectMenu__Delegate;                        // 0x5638(0x0090) (NeedCtorLink)
	...
	void ChangeSuperAlienBackScreen();
	void SwapSuperHeroEffectValue();
	void DrawSuperAlienDisplayBackScreen(class UCanvas* C);
...
public:
	...
	bool                                               bChangeAttackingTeam;                                     // 0x05D4(0x0004) (Net)
	int                                                ScoringTeam;                                              // 0x05D8(0x0004) (Net)
	float                                              fEndRoundTime;                                            // 0x05DC(0x0004) (Net)
	byte                                               ObjectiveProgress;                                        // 0x05E0(0x0001) (Net)
	byte                                               MaxObjectivePriority;                                     // 0x05E1(0x0001)
	byte                                               Padding00[0x2];                                           // 0x05E2(0x0002) MISSED OFFSET
	...
	ERoundWinner                                       RoundWinner;                                              // 0x05F4(0x0001) (Net)
	byte                                               Padding01[0x3];                                           // 0x05F5(0x0003) MISSED OFFSET
	string                                             ERW_PracticeRoundEndedStr;                                // 0x05F8(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_RedAttackedStr;                                       // 0x0604(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_BlueAttackedStr;                                      // 0x0610(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_RedDefendedStr;                                       // 0x061C(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_BlueDefendedStr;                                      // 0x0628(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_DefendersStr;                                         // 0x0634(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_AttackersStr;                                         // 0x0640(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_RedMoreObjectivesStr;                                 // 0x064C(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_BlueMoreObjectivesStr;                                // 0x0658(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_RedMoreProgressStr;                                   // 0x0664(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_BlueMoreProgressStr;                                  // 0x0670(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_RedGotSameOBJFasterStr;                               // 0x067C(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_BlueGotSameOBJFasterStr;                              // 0x0688(0x000C) (Localized, NeedCtorLink)
	string                                             ERW_DrawStr;                                              // 0x0694(0x000C) (Localized, NeedCtorLink)
...
{
public:
	string                                             RemainingRoundTime;                                       // 0x066C(0x000C) (Localized, NeedCtorLink)
	string                                             CurrentRound;                                             // 0x0678(0x000C) (Localized, NeedCtorLink)
	string                                             RoundSeparator;                                           // 0x0684(0x000C) (Localized, NeedCtorLink)
	string                                             Defender;                                                 // 0x0690(0x000C) (Localized, NeedCtorLink)
	string                                             Attacker;                                                 // 0x069C(0x000C) (Localized, NeedCtorLink)
	string                                             WaitForReinforcements;                                    // 0x06A8(0x000C) (Localized, NeedCtorLink)
	string                                             WaitingToSpawnReinforcements;                             // 0x06B4(0x000C) (Localized, NeedCtorLink)
	string                                             AutoRespawn;                                              // 0x06C0(0x000C) (Localized, NeedCtorLink)
	string                                             YouWonRound;                                              // 0x06CC(0x000C) (Localized, NeedCtorLink)
	string                                             YouLostRound;                                             // 0x06D8(0x000C) (Localized, NeedCtorLink)
	string                                             PracticeRoundOver;                                        // 0x06E4(0x000C) (Localized, NeedCtorLink)
...
{
public:
	EIP_AssaultTeam                                    Team;                                                     // 0x03D8(0x0001) (Edit)
	EIP_InfoType                                       InfoType;                                                 // 0x03D9(0x0001) (Edit)
	EIP_InfoEffect                                     InfoEffect;                                               // 0x03DA(0x0001) (Edit)
	byte                                               Padding00[0x1];                                           // 0x03DB(0x0001) MISSED OFFSET
	bool                                               bIsTriggered;                                             // 0x03DC(0x0004) (Edit)
	bool                                               bDisabled;                                                // 0x03DC(0x0004) (Edit, Net)
	bool                                               BACKUP_bDisabled;                                         // 0x03DC(0x0004)
	bool                                               bOverrideZoneCheck;                                       // 0x03DC(0x0004) (Edit)
	bool                                               bOverrideVisibilityCheck;                                 // 0x03DC(0x0004) (Edit)
	float                                              DrawDistThresHold;                                        // 0x03E0(0x0004) (Edit)
	ERenderStyle                                       InfoPodDrawStyle;                                         // 0x03E4(0x0001) (Edit)
	byte                                               DrawOpacity;                                              // 0x03E5(0x0001) (Edit)
	byte                                               Padding01[0x2];                                           // 0x03E6(0x0002) MISSED OFFSET
	class UMaterial*                                   POD_Texture;                                              // 0x03E8(0x0004) (Edit)
	float                                              TextureScale;                                             // 0x03EC(0x0004) (Edit)
	string                                             POD_Message;                                              // 0x03F0(0x000C) (Edit, Localized, NeedCtorLink)
	byte                                               FontSize;                                                 // 0x03FC(0x0001) (Edit)
	byte                                               Padding02[0x3];                                           // 0x03FD(0x0003) MISSED OFFSET
...
{
public:
	EPSM_AssaultTeam                                   AssaultTeam;                                              // 0x03D8(0x0001) (Edit)
	byte                                               Padding00[0x3];                                           // 0x03D9(0x0003) MISSED OFFSET
	class USound*                                      AnnouncerSound;                                           // 0x03DC(0x0004) (Edit)
	string                                             Message;                                                  // 0x03E0(0x000C) (Edit, Localized, NeedCtorLink)
	byte                                               AnnouncementLevel;                                        // 0x03EC(0x0001) (Edit)
	byte                                               Padding01[0x3];                                           // 0x03ED(0x0003) MISSED OFFSET
	bool                                               bSoundsPrecached;                                         // 0x03F0(0x0004)
	EAPriority                                         Priority;                                                 // 0x03F4(0x0001) (Edit)
	byte                                               Padding02[0x3];                                           // 0x03F5(0x0003) MISSED OFFSET
...
public:
	...
	void SetTeamSkin(byte Team, bool bPulse);
};


// Class WMission.wMSGameInfo
// 0x00DC (0x16BC - 0x15E0)
class AwMSGameInfo : public AwTeamGame
{
public:
	int                                                RoundLimit;                                               // 0x15E0(0x0004) (Edit, Config)
	int                                                MaxRounds;                                                // 0x15E4(0x0004)
	int                                                RoundTimeLimit;                                           // 0x15E8(0x0004) (Edit, Config)
	int                                                PracticeTimeLimit;                                        // 0x15EC(0x0004) (Edit, Config)
	int                                                DefuseTimeLimit;                                          // 0x15F0(0x0004)
	int                                                ReinforcementsFreq;                                       // 0x15F4(0x0004) (Config)
	int                                                ReinforcementsValidTime;                                  // 0x15F8(0x0004)
	int                                                ReinforcementsCount;                                      // 0x15FC(0x0004)
	int                                                ScoreLimit;                                               // 0x1600(0x0004) (Edit)
	int                                                ChangeAttackTeamRound;                                    // 0x1604(0x0004) (Edit)
	int                                                RespawnRestrictionTimeRound1;                             // 0x1608(0x0004)
	float                                              EnqueueRespawningControllersLastTIme;                     // 0x160C(0x0004)
	int                                                RemainingTimeWhenObjectIsSet;                             // 0x1610(0x0004)
	bool                                               bRoundOverProcessed;                                      // 0x1614(0x0004)
	float                                              RespawnElapsedTime;                                       // 0x1618(0x0004)
	float                                              LastRespawnTime;                                          // 0x161C(0x0004)
	bool                                               bCheckPrecacheInProcessRespawn;                           // 0x1620(0x0004)
	class AController*[]                               RespawningControllers;                                    // 0x1624(0x000C) (NeedCtorLink)
	byte                                               CurrentAttackingTeam;                                     // 0x1630(0x0001)
	byte                                               FirstAttackingTeam;                                       // 0x1631(0x0001)
	byte                                               CurrentRound;                                             // 0x1632(0x0001)
	byte                                               Padding00[0x1];                                           // 0x1633(0x0001) MISSED OFFSET
	int                                                RoundStartTime;                                           // 0x1634(0x0004)
	bool                                               bDisableReinforcements;                                   // 0x1638(0x0004)
	string                                             NewRoundSound;                                            // 0x163C(0x000C) (NeedCtorLink)
	string                                             sndBeginRound;                                            // 0x1648(0x000C) (NeedCtorLink)
	FName                                              AttackerWinRound[0x2];                                    // 0x1654(0x0004)
	FName                                              DefenderWinRound[0x2];                                    // 0x165C(0x0004)
	FName                                              DrawGameSound;                                            // 0x1664(0x0004)
	class AVehicle*                                    KeyVehicle;                                               // 0x1668(0x0004)
	class ASceneManager*                               CurrentMatineeScene;                                      // 0x166C(0x0004)
	class AwMSCinematic_SceneManager*                  EndCinematic;                                             // 0x1670(0x0004)
	bool                                               bObjectivePlanted;                                        // 0x1674(0x0004)
	FName                                              nPlantedObjectiveName;                                    // 0x1678(0x0004)
	string                                             sndChangeAttackTeam;                                      // 0x167C(0x000C) (NeedCtorLink)
	string                                             sndLastMan;                                               // 0x1688(0x000C) (NeedCtorLink)
	string                                             sndRoundWin;                                              // 0x1694(0x000C) (NeedCtorLink)
	string                                             sndRoundLose;                                             // 0x16A0(0x000C) (NeedCtorLink)
	string                                             BombPlantedMessage;                                       // 0x16AC(0x000C) (Localized, NeedCtorLink)
	bool                                               bMultiBomb;                                               // 0x16B8(0x0004)
	bool                                               bSentEndRound;                                            // 0x16B8(0x0004)
	...
	void AddGameSpecificActions(class UwAction*[]* Actions);
	...
	void lll();
	void FindLiving(class APlayerReplicationInfo** Living, byte* bOtherTeamNoneLeft);
	...
	void QueueAnnouncerSound(const string& ASound, byte AnnouncementLevel, byte Team, EAPriority Priority, byte Switch);
	...
	void SetObjectiveSetted(class APawn* TP, const FName& ObjectTag, const struct FVector& FlagLocation);
	int GetRemainingTime();
	...
	void EndRound(ERER_Reason RoundEndReason, class APawn* Instigator, const string& Reason);
	void NotifyEndRound();
	...
	void InitGameOption(const string& Options, string* Error);
...
{
public:
	string                                             PlayerDroppedMessage;                                     // 0x046C(0x000C) (Localized, NeedCtorLink)
	string                                             DroppedMessage;                                           // 0x0478(0x000C) (Localized, NeedCtorLink)
	string                                             EnergyCorePickedUp;                                       // 0x0484(0x000C) (Localized, NeedCtorLink)
	string                                             PlayerPickedUpEnergyCore;                                 // 0x0490(0x000C) (Localized, NeedCtorLink)
	string                                             PlayerCoreReset;                                          // 0x049C(0x000C) (Localized, NeedCtorLink)
	string                                             EnemyPickedUpBomb;                                        // 0x04A8(0x000C) (Localized, NeedCtorLink)
	string                                             EnemyDroppedBomb;                                         // 0x04B4(0x000C) (Localized, NeedCtorLink)
	bool                                               bSoundsPrecached;                                         // 0x04C0(0x0004)
	class AwBombObjective*                             MySpawnObjective;                                         // 0x04C4(0x0004)
	string                                             strPlayerName;                                            // 0x04C8(0x000C) (Net, NeedCtorLink)
...
public:
	...
	bool                                               bReplicateSettingOn;                                      // 0x06F8(0x0004)
	byte                                               bySettingOn;                                              // 0x06FC(0x0001) (Net)
	byte                                               byOldSettingOn;                                           // 0x06FD(0x0001)
	byte                                               Padding00[0x2];                                           // 0x06FE(0x0002) MISSED OFFSET
	...
	void Tick(float DeltaTime);
	void SetDefuseLocation(const struct FVector& loc, const FName& Tag);
...
public:
	...
	bool                                               bReplicateSettingOn;                                      // 0x06FC(0x0004)
	byte                                               bySettingOn;                                              // 0x0700(0x0001) (Net)
	byte                                               Padding00[0x3];                                           // 0x0701(0x0003) MISSED OFFSET
	bool                                               lastBombVisibility;                                       // 0x0704(0x0004)
	class APawn*[]                                     TouchingPawns;                                            // 0x0708(0x000C) (NeedCtorLink)
	class AwGameObject_Bomb*[]                         bombs;                                                    // 0x0714(0x000C) (NeedCtorLink)
	string                                             BombDefusedMessage;                                       // 0x0720(0x000C) (Localized, NeedCtorLink)
...
public:
	...
	string                                             HeaderText;                                               // 0x0430(0x000C) (Localized, NeedCtorLink)
	string                                             OptionalObjectivePrefix;                                  // 0x043C(0x000C) (Localized, NeedCtorLink)
	string                                             ObjTimesString;                                           // 0x0448(0x000C) (Localized, NeedCtorLink)
	string                                             TextCutSuffix;                                            // 0x0454(0x000C) (Localized, NeedCtorLink)
	string                                             SpaceSeparator;                                           // 0x0460(0x000C) (Localized, NeedCtorLink)
	string                                             PrimaryObjectivePrefix;                                   // 0x046C(0x000C) (Localized, NeedCtorLink)
	...
	string GetObjectiveDescription(class AGameObjective* Go, bool bDefender);
	...
	string CheckEntry(class UCanvas* C, const string& Entry);
...
// 0x003C (0x1170 - 0x1134)
class AwAlienController : public AwPlayer
{
public:
	struct FCoolTimeSkillObject[]                      CoolTimeSkills;                                           // 0x1134(0x000C) (NeedCtorLink)
	struct FVector                                     vDeadLocation;                                            // 0x1140(0x000C)
	struct FRotator                                    rDeadRotation;                                            // 0x114C(0x000C)
	struct FVector                                     vKnockBackDir;                                            // 0x1158(0x000C)
	float                                              fKnockBackTime;                                           // 0x1164(0x0004)
	float                                              fKnockBackMomentum;                                       // 0x1168(0x0004)
	bool                                               bShowDebug_AlienPlayerInfo;                               // 0x116C(0x0004)
	...
	void ShowDebugAlienPlayer();
	void DisplayDebug(class UCanvas* Canvas, float* YL, float* YPos);
	void ConsoleTakeHit();
	void Output_PawnList();
	...
	void ClientChangeTeam(byte InvertSideID);
	void ClientChangeSuperAlien();
	void ClientQuickRepairByAlien(int PlayerID);
	void ClientUpdateDefSuccessFromInfection(int PlayerID);
	void ClientUpdateLevelup(byte byAttackLevelIndex);
	void ClientUpdate3rdModel(int PlayerID, EAlienModeType eObjType, EAlienMode_Object_Type eSkinType);
	void PlayerTick(float DeltaTime);
	void ServerChangePawn(EAlienMode_Object_Type eSkinType);
	void ServerSetBase();
	void OnEndRound();
	...
	void UpdateHPValue(EAlienMode_Object_Type eSkinType, EAlienModeType eObjType);
	void PawnItemList();
	void ClientReset();
...
public:
	...
	bool                                               bAlienAppeared;                                           // 0x06A4(0x0004) (Net)
	int                                                iPlayingNum;                                              // 0x06A8(0x0004) (Net)
	byte                                               CurAlienAttackBuffLevel;                                  // 0x06AC(0x0001) (Net)
	byte                                               MaxAlienAttackBuffLevel;                                  // 0x06AD(0x0001)
	byte                                               Padding00[0x2];                                           // 0x06AE(0x0002) MISSED OFFSET
	int                                                iPrevAlienAttackIndex;                                    // 0x06B0(0x0004)
	byte                                               AlienTeamCount;                                           // 0x06B4(0x0001) (Net)
	byte                                               HumanTeamCount;                                           // 0x06B5(0x0001) (Net)
	byte                                               Padding01[0x2];                                           // 0x06B6(0x0002) MISSED OFFSET
	float                                              fMaxRespawnTime;                                          // 0x06B8(0x0004)
	bool                                               bSuperAlienAppeared;                                      // 0x06BC(0x0004)
	float                                              fAlienKnockBackDelta;                                     // 0x06C0(0x0004) (Net)
	float                                              fAlienSpeedDelta;                                         // 0x06C4(0x0004) (Net)
...
// 0x0004 (0x1334 - 0x1330)
class AwHudPart_MinimapAlienGame : public AwHudPart_Minimap
{
public:
	class UMaterial*                                   MinimapMatHero;                                           // 0x1330(0x0004)
...
// 0x0058 (0x1924 - 0x18CC)
class AwAMPawn : public AwPawn
{
public:
	bool                                               bIsOldDefencing;                                          // 0x18CC(0x0004)
	float                                              fKnockRatio;                                              // 0x18D0(0x0004)
	FName                                              Frag_DefenceProne;                                        // 0x18D4(0x0004)
	FName                                              Frag_DefenceCrouch;                                       // 0x18D8(0x0004)
	FName                                              Frag_Defence;                                             // 0x18DC(0x0004)
	FName                                              Meele_Alien_Pr_LR;                                        // 0x18E0(0x0004)
	FName                                              Meele_Alien_Cr_LR;                                        // 0x18E4(0x0004)
	FName                                              Meele_Alien_LR;                                           // 0x18E8(0x0004)
	FName                                              Meele_Alien_Pr_L;                                         // 0x18EC(0x0004)
	FName                                              Meele_Alien_Cr_L;                                         // 0x18F0(0x0004)
	FName                                              Meele_Alien_L;                                            // 0x18F4(0x0004)
	FName                                              Meele_Alien_Pr_R;                                         // 0x18F8(0x0004)
	FName                                              Meele_Alien_Cr_R;                                         // 0x18FC(0x0004)
	FName                                              Meele_Alien_R;                                            // 0x1900(0x0004)
	class AEmitter*                                    TransEffect;                                              // 0x1904(0x0004)
	class AEmitter*                                    SpecialEffect;                                            // 0x1908(0x0004)
	class AEmitter*                                    AuraEffect;                                               // 0x190C(0x0004)
	class AEmitter*                                    TransEffect_1st;                                          // 0x1910(0x0004)
	class AActor*                                      TransEffect_1st_AttachedActor;                            // 0x1914(0x0004)
	class AwObjectiveTankerAlienShield*                ShieldObjective;                                          // 0x1918(0x0004)
	class AwObjectiveTankerAlienShield*                ShieldObjective_1st;                                      // 0x191C(0x0004)
	EAlienModeType                                     eAMPawnType;                                              // 0x1920(0x0001) (Net)
	byte                                               Padding00[0x3];                                           // 0x1921(0x0003) MISSED OFFSET
	...
	void ChangeModel();
	void ClientChangeModelType(EAlienModeType eObjType, EAlienMode_Object_Type eSkinType);
	void ChangeModelType(EAlienModeType eObjType, EAlienMode_Object_Type eSkinType);
	...
	void ClientReStart();
	void MakeQuickRepairByAlienEffect();
	void MakeDefecneSuccessEffect();
	void MakeAttackLevelEffect(byte byAttackLevelIndex);
	void MakeShieldEffect();
	void CallEffect_PHJ();
	void MakeTransformEffect();
	void DestroyEffect_Character();
	void Destroyed();
	void ProcessHitFX();
	...
	class UClass* Alien_GetBloodHitClass(ECollisionPartsType collisionParts);
...
// 0x0060 (0x171C - 0x16BC)
class AwAlienGameInfo : public AwMSGameInfo
{
public:
	float                                              fSuperAlien_RemainingTime;                                // 0x16BC(0x0004)
	class AwSupplyRespawnPoint*[]                      SupplyRespawnPoints;                                      // 0x16C0(0x000C) (NeedCtorLink)
	class AwSupplyRespawnPoint*[]                      SupplyedRespawnPoints;                                    // 0x16CC(0x000C) (NeedCtorLink)
	int[]                                              SupplyRandomBonusPack_SkillIDs;                           // 0x16D8(0x000C) (NeedCtorLink)
	float                                              fCurSupplyItemDropTime;                                   // 0x16E4(0x0004)
	float                                              fMaxSupplyItemDropTime;                                   // 0x16E8(0x0004)
	int                                                iCurSupplyItemDropTryCount;                               // 0x16EC(0x0004)
	int                                                iMaxSupplyItemDropOnetimeCount;                           // 0x16F0(0x0004)
	int                                                iMaxSupplyItemDropMaxCount;                               // 0x16F4(0x0004)
	int                                                iMaxSupplyItemDropTryCount;                               // 0x16F8(0x0004)
	bool                                               bSentEndRound;                                            // 0x16FC(0x0004)
	float                                              fCheckEndRoundTime;                                       // 0x1700(0x0004)
	bool                                               bIsSuperHeroTime;                                         // 0x1704(0x0004)
	string                                             sndDropRandomItemBox;                                     // 0x1708(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __ProcessGameLogic__Delegate;                             // 0x1714(0x0090) (NeedCtorLink)
	...
	bool IsRightTimeForRespawn(class AController* C);
	void AlienGame_SinTime();
	void AlienGame_MagicTime(int RemainTime);
	void AlienGame_Hero();
	void AlienGame_SuperHero();
	void AlienGame_AlienLevelup();
	void AlienGame_AttackLevelup();
	...
	int GetWinTeam(ERER_Reason RoundEndReason);
	int GetRoundEndType(ERER_Reason RoundEndReason);
	void ServerLogEndRound(ERER_Reason RoundEndReason, class APawn* Instigator, const string& Reason);
	float GetAttackBuff();
	bool NeedPlayers();
	bool ProcessSwitchTeam(bool bNoReset);
	...
	void AlarmAppearAlien(EAlienModeType eObjType, int iTimeCount);
	void InGameRoundEnd();
	void InGameAlienMode();
	void InGameAppearAlien();
	void ProcessGameLogic();
	void Log_ControllerInfo();
	...
	void ChangeAttackLevel(byte byAttackLevelIndex);
	void ChangePawn(class APlayerController* PC);
	void CalcPlayingUserCount(int* iHumanTeamCount, int* iAlienTeamCount);
	void Killed(class AController* Killer, class AController* Killed, class APawn* KilledPawn, class UClass* DamageType, int CollisionPart, int WeaponType, bool bWallShot);
	void StartAlienMode();
	void BeginRound(bool bNoReset);
...
public:
	...
	string                                             PlayerDroppedMessage;                                     // 0x06E0(0x000C) (Edit, Localized, NeedCtorLink)
	string                                             DroppedMessage;                                           // 0x06EC(0x000C) (Edit, Localized, NeedCtorLink)
	string                                             EnergyCorePickedUp;                                       // 0x06F8(0x000C) (Edit, Localized, NeedCtorLink)
	string                                             PlayerPickedUpEnergyCore;                                 // 0x0704(0x000C) (Edit, Localized, NeedCtorLink)
	string                                             PlayerCoreReset;                                          // 0x0710(0x000C) (Edit, Localized, NeedCtorLink)
...
{
public:
	string                                             KillString[0x8];                                          // 0x0450(0x000C) (Localized, NeedCtorLink)
	FName                                              KillSound[0x8];                                           // 0x04B0(0x0004)
...
{
public:
	FName                                              CameraTag;                                                // 0x042C(0x0004) (Edit)
	FName                                              EventSceneStarted;                                        // 0x0430(0x0004) (Edit)
	FName                                              EventSceneEnded;                                          // 0x0434(0x0004) (Edit)
...
// 0x0050 (0x170C - 0x16BC)
class AwSDGameInfo : public AwMSGameInfo
{
public:
	string                                             VoiceOurTeamPlantedBomb;                                  // 0x16BC(0x000C) (NeedCtorLink)
	string                                             VoiceEnemyPlantedBomb;                                    // 0x16C8(0x000C) (NeedCtorLink)
	string                                             sndModeExplain_Attack;                                    // 0x16D4(0x000C) (NeedCtorLink)
	string                                             sndModeExplain_Defend;                                    // 0x16E0(0x000C) (NeedCtorLink)
	float                                              AddScore_Plant;                                           // 0x16EC(0x0004)
	float                                              AddScore_Defuse;                                          // 0x16F0(0x0004)
	float                                              AddExp_Plant;                                             // 0x16F4(0x0004)
	float                                              AddExp_Defuse;                                            // 0x16F8(0x0004)
	float                                              AddPoint_Plant;                                           // 0x16FC(0x0004)
	float                                              AddPoint_Defuse;                                          // 0x1700(0x0004)
	int                                                StartPlayerCount;                                         // 0x1704(0x0004)
	bool                                               bSentEndRound;                                            // 0x1708(0x0004)
	...
	void BeginRound(bool bNoReset);
	void OnBombDiffused(class APawn* TP, const FName& Tag, const struct FVector& FlagLocation);
	void SetObjectiveSetted(class APawn* TP, const FName& ObjectTag, const struct FVector& FlagLocation);
	void PlayObjectiveSetVociceBGM(class APawn* TP);
	void GotoDefusePhase(const FName& ObjectTag);
	void InitGame(const string& Options, string* Error);
};
...
public:
	...
	string                                             DropSound;                                                // 0x0440(0x000C) (NeedCtorLink)
...
{
public:
	float                                              fAttackDecreaseRate;                                      // 0x007C(0x0004)
	int                                                iSubHealthPoint;                                          // 0x0080(0x0004)
...
public:
	...
	FName                                              EventViewingCamera;                                       // 0x03DC(0x0004) (Edit)
	FName                                              NextCameraTag;                                            // 0x03E0(0x0004) (Edit)
	class AwMSCinematic_Camera*                        NextCamera;                                               // 0x03E4(0x0004)
	bool                                               bInitiallyActive;                                         // 0x03E8(0x0004) (Edit)
	bool                                               bActive;                                                  // 0x03E8(0x0004)
