...
// (Native, Public)
// Parameters:
// string                         category                       (Parm, NeedCtorLink)
// string                         key                            (Parm, NeedCtorLink)
// int                            iIndex                         (Parm)
// FName                          ReturnValue                    (Parm, OutParm, ReturnParm)

FName UBTNetPlayerData::getNameData(const string& category, const string& key, int iIndex)
{
...
string UBTNetPlayerData::getData(const string& category, const string& key, int iIndex)
{
...
string UBTNetMapData::getData(const string& category, const string& key, int iIndex)
{
...
string UBTNetGameData::getData(const string& category, const string& key, int iIndex)
{
...
string UBTNetExcelData::getData(const string& category, const string& key, int iIndex)
{
...
// (Native, Public)
// Parameters:
// string                         fileName                       (Parm, NeedCtorLink)
// string                         sheetName                      (Parm, NeedCtorLink)
...
bool UBTNetExcelData::LoadExcelData(const string& fileName, const string& sheetName, int numHeadRows, int numHeadColumns, int nKeyColumnOrRow, int arrangeType)
{
