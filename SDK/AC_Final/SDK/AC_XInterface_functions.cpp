...
class UMaterial* UGUI::GetModLogo(const string& ModDir)
{
...
string UGUI::GetModValue(const string& ModDir, const string& ModKey)
{
...
void UGUI::GetModList(string[]* ModDirs, string[]* ModTitles)
{
...
void UGUI::Profile(const string& ProfileName)
{
...
string UGUI::STATIC_JoinArray(string[] StringArray, const string& Delim, bool bIgnoreBlanks)
{
...
bool UGUI::STATIC_IsDigit(const string& test, bool bAllowDecimal)
{
...
void UGUIComponent::EndAnimation(class UGUIComponent* Animating, EAnimationType Type)
{
...
void UGUIComponent::SetToolTipText(const string& NewToolTipText)
{
...
void UGUIComponent::SetHint(const string& NewHint)
{
...
void UGUIComponent::DropStateChange(EeDropState NewState)
{
...
void UGUIComponent::MenuStateChange(EeMenuState NewState)
{
...
string UGUIComponent::STATIC_MakeColorCode(const struct FColor& NewColor)
{
...
string UGUIComponent::STATIC_StripColorCodes(const string& InString)
{
...
void UGUIComponent::SaveINI(const string& Value)
{
...
string UGUIComponent::AdditionalDebugString()
{
...
string UGUIComponent::GetMenuPath()
{
...
bool UGUIComponent::IsInIncompleteLetter(const string& strUserName)
{
...
int UGUIComponent::IsCorrectUserName_THAILAND(const string& strUserName)
{
...
int UGUIComponent::IsCorrectUserName_China(const string& strUserName)
{
...
int UGUIComponent::IsCorrectUserName(const string& strUserName)
{
...
void UGUIComponent::AutoPositionOn(class UGUIComponent*[] Components, class UGUIComponent* frame, float LeftPadPerc, float UpperPadPerc, float RightPadPerc, float LowerPadPerc, int NumberOfColumns, float ColumnPadding)
{
...
void UGUIComponent::AutoPosition(class UGUIComponent*[] Components, float LeftBound, float UpperBound, float RightBound, float LowerBound, float LeftPad, float UpperPad, float RightPad, float LowerPad, int NumberOfColumns, float ColumnPadding)
{
...
void UGUIComponent::KillTimer(const FName& TimerFunc)
{
...
void UGUIComponent::SetTimer(float Interval, bool bRepeat, const FName& TimerFunc)
{
...
string UGUIComponent::OnSaveINI(class UGUIComponent* Sender)
{
...
void UGUIComponent::OnLoadINI(class UGUIComponent* Sender, const string& S)
{
...
bool UGUIComponent::OnKeyEvent(float Delta, byte* key, byte* State)
{
...
bool UGUIComponent::OnKeyType(const string& Unicode, byte* key)
{
...
void UGUIComponent::OnMessage(const string& Msg, float MsgLife)
{
...
void UGUIComponent::OnEndAnimation(class UGUIComponent* Sender, EAnimationType Type)
{
...
void UGUIComponent::OnArrival(class UGUIComponent* Sender, EAnimationType Type)
{
...
struct FFloatBox UGUIMultiComponent::GetTooltipPosFinal(int tooltipWidth, int tooltipHeight, float CursorUSize, float CursorVSize, int nOffsetX, int nOffsetY)
{
	static auto fn = UObject::FindObject<UFunction>("Function XInterface.GUIMultiComponent.GetTooltipPosFinal");

	UGUIMultiComponent_GetTooltipPosFinal_Params params;
	params.tooltipWidth = tooltipWidth;
	params.tooltipHeight = tooltipHeight;
	params.CursorUSize = CursorUSize;
	params.CursorVSize = CursorVSize;
...
void UGUIMultiComponent::EndAnimation(class UGUIComponent* Animating, EAnimationType Type)
{
...
class UGUIComponent* UGUIMultiComponent::AddComponent(const string& ComponentClass, bool SkipRemap)
{
...
bool UGUIPage::AllowOpen(const string& MenuClass)
{
...
void UGUIPage::SetDataString(const string& str)
{
...
bool UGUIPage::GetRestoreParams(string* Param1, string* Param2)
{
...
void UGUIPage::HandleParameters(const string& Param1, const string& Param2)
{
...
void UGUIPage::ChangeHint(const string& NewHint)
{
...
string UGUIQuestionPage::Replace(const string& Src, const string& Tag, const string& Value)
{
...
void UGUIQuestionPage::LayoutButtons(byte ActiveButton)
{
...
class UGUIButton* UGUIQuestionPage::AddButton(byte idesc)
{
...
void UGUIQuestionPage::SetupQuestion(const string& Question, byte bButtons, byte ActiveButton, bool bClearFirst)
{
...
bool UGUIQuestionPage::NewOnButtonClick(byte bButton)
{
...
void UGUIQuestionPage::OnButtonClick(byte bButton)
{
...
void AHudBase::userzone(const string& szPath, const string& szCommand)
{
...
void AHudBase::usermove(const string& szPath, const string& szCommand, int nCombatNum)
{
...
void AHudBase::killlog(const string& szPath, const string& szCommand)
{
...
void AHudBase::STATIC_PlayHUDSound(class APlayerController* PC, EeHUDSOUND soundType)
{
...
void AHudBase::RefreshKillerName(const string& mKillerName)
{
...
void AHudBase::DrawCustomNameTag(class UCanvas* C, const struct FVector& vNameTagPos, class AwPawn* curPawn, const string& strName, float fAdditionalX, float fAdditionalY)
{
	static auto fn = UObject::FindObject<UFunction>("Function XInterface.HudBase.DrawCustomNameTag");

	AHudBase_DrawCustomNameTag_Params params;
	params.C = C;
	params.vNameTagPos = vNameTagPos;
	params.curPawn = curPawn;
	params.strName = strName;
	params.fAdditionalX = fAdditionalX;
	params.fAdditionalY = fAdditionalY;
...
string AHudBase::GetBaseTeamName(int TeamIndex)
{
...
void AHudBase::SetInstructionKeyText(const string& Text)
{
...
void AHudBase::SetInstructionText(const string& Text)
{
...
struct FColor AHudBase::STATIC_GetTeamColor(byte TeamNum)
{
...
void AHudBase::RemoveLocalizedMessage(class UClass* Message, int Switch, class APlayerReplicationInfo* RelatedPRI_1, class APlayerReplicationInfo* RelatedPRI_2, class UObject* OptionalObject, const string& CriticalString)
{
	static auto fn = UObject::FindObject<UFunction>("Function XInterface.HudBase.RemoveLocalizedMessage");

	AHudBase_RemoveLocalizedMessage_Params params;
...
void AHudBase::LocalizedMessage2(class UClass* Message, int Switch, bool bOption_Push, const string& CriticalString)
{
...
void AHudBase::LocalizedMessageEx(class UClass* Message, int Switch, class APlayerReplicationInfo* RelatedPRI_1, class APlayerReplicationInfo* RelatedPRI_2, class UObject* OptionalObject, const string& CriticalString, int iReserve)
{
...
void AHudBase::LocalizedMessage(class UClass* Message, int Switch, class APlayerReplicationInfo* RelatedPRI_1, class APlayerReplicationInfo* RelatedPRI_2, class UObject* OptionalObject, const string& CriticalString)
{
...
void AHudBase::Message(class APlayerReplicationInfo* PRI, const string& Msg, const FName& MsgType)
{
...
void AHudBase::DrawDigitSet(class UCanvas* C, float X, float Y, float OffsetX, float XL, float YL, int Value, const struct FDigitSet& dSet, int totalDigits, const string& paddingChar)
{
...
struct FKillMessageItem AwHudPart_KillMessage::MakeKillMessageItem(class APlayerReplicationInfo* KillerPRI, class APlayerReplicationInfo* victimPRI, const string& KillerName, const string& VictimName, class UClass* DamageType, int Switch, bool NoKillerName, bool NoVictimName, class UMaterial* overrideImage)
{
...
void UGUIListBoxBase::SetHint(const string& NewHint)
{
...
void UGUIScrollTextBox::AddText(const string& NewText)
{
...
string UGUIScrollTextBox::StripColors(const string& MyString)
{
...
bool UGUIScrollTextBox::IsNumber(const string& Num)
{
...
void UGUIScrollTextBox::SetContent(const string& NewContent, const string& sep)
{
...
void UGUIMultiColumnListBox::SetHeaderStyle(bool changeStyle, const string& stylez, bool changeBarStyle, const string& barStylez)
{
...
void UGUIMultiColumnListBox::InternalOnLoadINI(class UGUIComponent* Sender, const string& S)
{
...
bool UGUIListBase::InternalOnKeyEvent(float Delta, byte* key, byte* KeyState)
{
...
string[] UGUIListBase::GetPendingItems(bool bGuarantee)
{
...
string UGUIListBase::GetItemAtIndex(int idx)
{
...
string UGUIListBase::AdditionalDebugString()
{
...
void UGUIListBase::InitLinkObjects(class UGUIComponent*[] NewObj, bool bNoCheck)
{
...
bool UGUIVertList::InternalOnKeyType(const string& Unicode, byte* key)
{
...
struct FGUIListElem[] UGUIList::GetPendingElements(bool bGuarantee)
{
...
int UGUIList::FindIndex(const string& test, bool bExact, bool bExtra, class UObject* TestObject)
{
...
int UGUIList::FindExtra(const string& Text, bool bExact)
{
...
string UGUIList::Find(const string& Text, bool bExact, bool bExtra)
{
...
void UGUIList::RemoveExtra(const string& str)
{
...
void UGUIList::RemoveItem(const string& Item)
{
...
void UGUIList::SetExtraAtIndex(int i, const string& NewExtra)
{
...
void UGUIList::SetItemAtIndex(int i, const string& NewItem)
{
...
void UGUIList::GetAtIndex(int i, string* ItemStr, class UObject** ExtraObj, string* ExtraStr)
{
...
string UGUIList::GetExtraAtIndex(int i)
{
...
string UGUIList::GetItemAtIndex(int i)
{
...
string UGUIList::Get(bool bGuarantee)
{
...
void UGUIList::Insert(int i, const string& NewItem, class UObject* obj, const string& str, bool bNoSort, bool bSection)
{
...
void UGUIList::Replace(int i, const string& NewItem, class UObject* obj, const string& str, bool bNoSort)
{
...
void UGUIList::Add(const string& NewItem, class UObject* obj, const string& str, bool bSection)
{
...
bool UGUIScrollText::InternalOnKeyEvent(float Delta, byte* key, byte* State)
{
...
bool UGUIScrollText::InternalOnKeyType(const string& Unicode, byte* key)
{
...
void UGUIScrollText::SetContent(const string& NewContent, const string& sep)
{
...
string UGUIScrollText::GetWordUnderCursor()
{
...
struct FImageListElem[] UGUIVertImageList::GetPendingElements(bool bGuarantee)
{
...
string UGUIVertImageList::GetItemAtIndex(int i)
{
...
string UGUIMultiColumnList::GetSortString(int YourArrayIndex)
{
...
void UGUIBorder::SetCaption(const string& NewCaption)
{
...
class UGUITabPanel* UGUITabControl::BorrowPanel(const string& Caption)
{
...
int UGUITabControl::TabIndex(const string& tabname)
{
...
bool UGUITabControl::ActivateTabByName(const string& tabname, bool bFocusPanel)
{
...
void UGUITabControl::RemoveTab(const string& Caption, class UGUITabButton* Who)
{
...
class UGUITabPanel* UGUITabControl::ReplaceTab(class UGUITabButton* Which, const string& Caption, const string& PanelClass, class UGUITabPanel* ExistingPanel, const string& InHint, bool bForceActive)
{
...
class UGUITabPanel* UGUITabControl::InsertTab(int pos, const string& Caption, const string& PanelClass, class UGUITabPanel* ExistingPanel, const string& InHint, bool bForceActive)
{
...
class UGUITabPanel* UGUITabControl::AddTab(const string& InCaption, const string& PanelClass, class UGUITabPanel* ExistingPanel, const string& InHint, bool bForceActive)
{
...
bool UGUITabControl::InternalOnKeyEvent(float Delta, byte* key, byte* State)
{
...
bool UGUIButton::InternalOnKeyEvent(float Delta, byte* key, byte* State)
{
...
string UGUIEditBox::ConvertIllegal(const string& inputstr)
{
...
bool UGUIEditBox::InternalOnKeyEvent(float Delta, byte* key, byte* State)
{
...
bool UGUIEditBox::InternalOnKeyType(const string& Unicode, byte* key)
{
...
void UGUIEditBox::SetText(const string& NewText)
{
...
bool UGUIEditBox::OnIME_Notify(int Type, int LangID, const string& strText, int nStartPos, int nSize)
{
...
int UGUIComboBox::FindIndex(const string& test, bool bExact, bool bExtra, class UObject* obj)
{
...
int UGUIComboBox::FindExtra(const string& Text, bool bExact)
{
...
string UGUIComboBox::Find(const string& Text, bool bExact, bool bExtra)
{
...
string UGUIComboBox::GetItem(int Index)
{
...
void UGUIComboBox::AddItem(const string& Item, class UObject* Extra, const string& str)
{
...
void UGUIComboBox::SetExtra(const string& NewExtra, bool bListItemsOnly)
{
...
void UGUIComboBox::SetText(const string& NewText, bool bListItemsOnly)
{
...
void UGUIComboBox::InternalOnLoadINI(class UGUIComponent* Sender, const string& S)
{
...
string UGUIComboBox::InternalOnSaveINI(class UGUIComponent* Sender)
{
...
bool UGUIComboBox::InternalOnKeyEvent(float Delta, byte* key, byte* State)
{
...
void UGUIComboBox::SetHint(const string& NewHint)
{
...
void UGUIMenuOption::SetCaption(const string& NewCaption)
{
...
void UGUIMenuOption::SetHint(const string& NewHint)
{
...
string UGUIMenuOption::GetComponentValue()
{
...
void UGUIMenuOption::SetComponentValue(const string& NewValue, bool bNoChange)
{
...
string UGUIImage::AdditionalDebugString()
{
...
bool UGUIContextMenu::ReplaceItem(int Index, const string& NewItem)
{
...
bool UGUIContextMenu::RemoveItemByName(const string& ItemName)
{
...
int UGUIContextMenu::InsertItem(const string& NewItem, int Index)
{
...
int UGUIContextMenu::AddItem(const string& NewItem)
{
...
void UGUIToolTip::SetTip(const string& NewTip)
{
...
class UGUIQuestionPage* UGUIController::ShowQuestionDialog(const string& Question, byte Buttons, byte defButton)
{
...
bool UGUIController::SearchBinds(const string& BindAliasMask, string[]* BindAliases)
{
...
bool UGUIController::GetAssignedKeys(const string& BindAlias, string[]* BindKeyNames, string[]* LocalizedBindKeyNames)
{
...
bool UGUIController::GetCurrentBind(const string& BindKeyName, string* BindKeyValue)
{
...
bool UGUIController::KeyNameFromIndex(byte iKey, string* KeyName, string* LocalizedKeyName)
{
...
bool UGUIController::SetKeyBind(const string& BindKeyName, const string& BindKeyValue)
{
...
string UGUIController::STATIC_GetQuitPage()
{
...
string UGUIController::STATIC_GetSettingsPage()
{
...
string UGUIController::STATIC_GetModPage()
{
...
string UGUIController::STATIC_GetInstantActionPage()
{
...
string UGUIController::STATIC_GetMultiplayerPage()
{
...
string UGUIController::STATIC_GetServerBrowserPage()
{
...
string UGUIController::STATIC_GetSinglePlayerPage()
{
...
string UGUIController::STATIC_GetMainMenuClass()
{
...
void UGUIController::SetRequiredGameResolution(const string& GameRes)
{
...
void UGUIController::PushMenu(int Index, class UGUIPage* NewMenu, const string& Param1, const string& Param2)
{
...
void UGUIController::ReplaceMenu2(const string& NewMenuName, bool bCancelled)
{
...
bool UGUIController::ReplaceMenu(const string& NewMenuName, const string& Param1, const string& Param2, bool bCancelled)
{
...
bool UGUIController::OpenMenuByObject(class UGUIPage* NewMenu, const string& Param1, const string& Param2)
{
...
bool UGUIController::OpenMenu(const string& NewMenuName, const string& Param1, const string& Param2)
{
...
class UGUIPage* UGUIController::CreateMenu(const string& NewMenuName)
{
...
int UGUIController::FindMenuIndexByName(const string& MenuClass)
{
...
class UGUIPage* UGUIController::FindPersistentMenuByName(const string& MenuClass)
{
...
class UClass* UGUIController::AddComponentClass(const string& ClassName)
{
...
void UGUIController::GetTeamSymbolList(bool bNoSinglePlayer, string[]* SymbolNames)
{
...
string UGUIController::LoadDecoText(const string& PackageName, const string& DecoTextName)
{
...
void UGUIController::LaunchURL(const string& URL)
{
...
void UGUIController::GetMapList(const string& Prefix, class UGUIList* List, bool bDecoText)
{
...
void UGUIController::GetWeaponList(class UClass*[]* WeaponClass, string[]* WeaponDesc)
{
...
void UGUIController::SaveOwnageList(struct FeOwnageMap[] Maps)
{
...
void UGUIController::GetOwnageList(int[]* RLevel, string[]* MNames, string[]* MDesc, string[]* mURL)
{
...
bool UGUIController::GetDEMHeader(const string& DemoName, string* MapName, string* GameType, int* ScoreLimit, int* TimeLimit, int* ClientSide, string* RecordedBy, string* TimeStamp, string* ReqPackages)
{
...
void UGUIController::GetDEMList(string[]* DEMFiles)
{
...
void UGUIController::Profile(const string& ProfileName)
{
...
void UGUIController::GetOGGList(string[]* OGGFiles)
{
...
void UGUIController::GetProfileList(const string& Prefix, string[]* ProfileList)
{
...
bool UGUIController::SetRenderDevice(const string& NewRenderDevice)
{
...
string UGUIController::GetCurrentRes()
{
...
class UGUIStyles* UGUIController::GetStyle(const string& StyleName, EeFontScale* FontScale)
{
...
class UGUIFont* UGUIController::GetMenuFont(const string& FontName)
{
...
void UGUIController::AddBuddy(const string& NewBuddyName)
{
...
bool UGUIController::OnNeedRawKeyPress(byte NewKey)
{
...
void UGUIStyles::btrDrawTextStyles(class UCanvas* Canvas, EeMenuState MenuState, float Left, float Top, float width, float Height, EeTextAlign Align, const string& Text, EeFontScale FontScale, int FontSize, float R, float G, float B, float A)
{
...
void UGUIStyles::btrTextSizeStyles(class UCanvas* Canvas, EeMenuState MenuState, const string& Text, EeFontScale FontScale, int FontSize, float* XL, float* YL)
{
...
void UGUIStyles::STATIC_TextSize(class UCanvas* Canvas, EeMenuState MenuState, const string& Text, EeFontScale FontScale, float* XL, float* YL)
{
...
void UGUIStyles::STATIC_DrawText(class UCanvas* Canvas, EeMenuState MenuState, float Left, float Top, float width, float Height, EeTextAlign Align, const string& Text, EeFontScale FontScale)
{
...
void UGUIStyles::STATIC_Draw(class UCanvas* Canvas, EeMenuState MenuState, float Left, float Top, float width, float Height)
{
...
bool UGUIStyles::OnDrawText(class UCanvas* Canvas, EeMenuState MenuState, float Left, float Top, float width, float Height, EeTextAlign Align, const string& Text, EeFontScale FontScale)
{
...
bool UGUIStyles::OnDraw(class UCanvas* Canvas, EeMenuState MenuState, float Left, float Top, float width, float Height)
{
...
void UExtendedConsole::DumpLoadingHints(const string& Param)
{
...
void UExtendedConsole::DLO(const string& ClassName, const string& ClassType)
{
...
void UExtendedConsole::DumpCacheRecords(const string& CacheType)
{
...
void UExtendedConsole::AddMessage(const string& Mesg)
{
...
void UExtendedConsole::DumpRecords(const string& Type)
{
...
void UExtendedConsole::DumpPlayInfo(const string& Group)
{
...
void UExtendedConsole::STATIC_GetFavorites(struct FServerFavorite[]* List)
{
...
bool UExtendedConsole::STATIC_RemoveFavorite(const string& IP, int Port, int QueryPort)
{
...
void UExtendedConsole::Message(const string& Msg, float MsgLife)
{
...
void UExtendedConsole::OnChatMessage(const string& Msg)
{
...
void UExtendedConsole::Chat(const string& Msg, float MsgLife, class APlayerReplicationInfo* PRI)
{
...
void UExtendedConsole::ConnectFailure(const string& FailCode, const string& URL)
{
...
void UExtendedConsole::OnChat(const string& Msg, int TeamIndex)
{
...
string UUT2MusicManager::SetInitialMusic(const string& NewSong)
{
...
void UUT2MusicManager::SetMusic(const string& NewSong)
{
...
string AHudCDeathmatch::GetNoticeFirst()
{
...
void AHudCDeathmatch::PushAASNotice(const string& sNotice, float beginTime, byte byLevel)
{
...
void AHudCDeathmatch::PushGameNotice(const string& sNotice)
{
...
void AHudCDeathmatch::RecGameNotice(const string& sNotice)
{
...
void AHudCDeathmatch::RecAAS(const string& sNotice, float DrawTime)
{
...
void AHudCDeathmatch::LocalizedMessage(class UClass* Message, int Switch, class APlayerReplicationInfo* RelatedPRI_1, class APlayerReplicationInfo* RelatedPRI_2, class UObject* OptionalObject, const string& CriticalString)
{
...
void AHudCDeathmatch::TutorialEvent(const string& S, const FName& Type, const FName& reserv)
{
...
void AHudCDeathmatch::DrawObjectSprite2(class UCanvas* C, class UObject* Tag, const struct FSpriteWidget& objectSprite, const struct FVector& objectLoc, const string& ObjectName, int Alpha)
{
...
void AHudCDeathmatch::DrawCustomObjectSprite(class UCanvas* C, class AwPawn* curPawn, const struct FSpriteWidget& objectSprite, const string& strName, float fAdditionalX, float fAdditionalY)
{
	static auto fn = UObject::FindObject<UFunction>("Function XInterface.HudCDeathmatch.DrawCustomObjectSprite");

	AHudCDeathmatch_DrawCustomObjectSprite_Params params;
	params.C = C;
	params.curPawn = curPawn;
	params.objectSprite = objectSprite;
	params.strName = strName;
...
struct FVector AHudCDeathmatch::CalcScreenPos(class UCanvas* C, const struct FVector& objectLoc, float W, float H, bool ClipEclipse, float rX, float rY, byte* clipped)
{
...
struct FSelfKillMessage AHudCDeathmatch::MakeSelfKillMessage(const string& KillerName, const string& VictimName, class UClass* Type)
{
...
void AHudCDeathmatch::RefreshKillerMark(const string& mKillerName)
{
...
void AHudCDeathmatch::OnClientReceiveSentryGunDeathMessage(class APlayerController* P, class APlayerReplicationInfo* attackerPRI, class APlayerReplicationInfo* victimPRI, class UObject* OptionalObject)
{
	static auto fn = UObject::FindObject<UFunction>("Function XInterface.HudCDeathmatch.OnClientReceiveSentryGunDeathMessage");

	AHudCDeathmatch_OnClientReceiveSentryGunDeathMessage_Params params;
	params.P = P;
	params.attackerPRI = attackerPRI;
	params.victimPRI = victimPRI;
	params.OptionalObject = OptionalObject;
...
void AHudCDeathmatch::DrawWeaponImage(class UCanvas* C, bool bShowSpectating, string* sWeaponName)
{
...
string AHudCDeathmatch::GetInfoString()
{
...
struct FColor AHudCDeathmatch::STATIC_GetTeamColor(byte TeamNum)
{
...
string AHudCDeathmatch::GetScoreTagLine()
{
...
string AHudCDeathmatch::GetScoreValue(class APlayerReplicationInfo* PRI)
{
...
string AHudCDeathmatch::GetScoreText()
{
...
struct FColor AHudCDeathmatch::CalcArrayColor(float V, struct FColor[] carray)
{
...
void AHudCDeathmatch::rendai(const string& v1, const string& v2)
{
...
string AwHudPart_DisplayBase::GetEllipsString(class UCanvas* C, const string& strText, float fLimitWidth, float FontSize)
{
...
bool AwHudPart_DisplayBase::GetKeyTexture(const string& sKey, float OffsetX, struct FSpriteWidget* W, float* fWidth)
{
...
void AwHudPart_MinimapBase::DrawMinimap_SentryGun(class UCanvas* C)
{
	static auto fn = UObject::FindObject<UFunction>("Function XInterface.wHudPart_MinimapBase.DrawMinimap_SentryGun");

	AwHudPart_MinimapBase_DrawMinimap_SentryGun_Params params;
	params.C = C;
...
string AxScoreBoard::GetEllipsString(class UCanvas* C, const string& strText, float fLimitWidth, float FontSize)
{
...
void AxScoreBoardTeamGame::MissonComment(class UCanvas* C, float X1, float Y1, float X2, float Y2, const string& MN)
{
...
string AxScoreBoardTeamGame::GetStringGoalScore()
{
...
string AxScoreBoardTeamGame::GetStringPlayMode()
{
...
void AxScoreBoardTeamGame::RankingSorting(int iCurrent, int iNext, class APlayerReplicationInfo*[]* pris)
{
...
void AxScoreBoardTeamGame::DrawPersonListSection_C(class UCanvas* C, int lpTeam, class APlayerReplicationInfo* currPRI, int memberCount, const string& HostName, float beginY, float markBeginY, float markPingY)
{
...
void AxScoreBoardTeamGame::DrawTeamListSection_C(class UCanvas* C, int lpTeam, class APlayerReplicationInfo* currPRI, int memberCount, const string& HostName, float beginY, float markBeginY, float markPingY)
{
...
string AScoreBoardDeathMatch::GetDefaultScoreInfoString()
{
...
string AScoreBoardDeathMatch::GetRestartString()
{
...
string AScoreBoardDeathMatch::GetTitleString()
{
...
void AwHudPart_Tutorial2::EnableShootTarget(const FName& eventTag)
{
...
class AMover* AwHudPart_Tutorial2::EnableTriggerEvent(const FName& EventName, class AActor* Other, class APawn* EventInstigator)
{
...
class AMover* AwHudPart_Tutorial2::DisableTriggerEvent(const FName& EventName, class AActor* Other, class APawn* EventInstigator)
{
...
void AwHudPart_Tutorial2::TutorialEvent(const string& S, const FName& Type, const FName& reserv)
{
...
void AxScoreBoardTutorial::DrawTeamListSection_C(class UCanvas* C, int lpCount, class APlayerReplicationInfo* currPRI, int lpQuestNumber, const string& HostName, float beginY, float markBeginY, float markPingY)
{
...
void AwHudPart_DisplayEvent::DrawEventString(class UCanvas* C, float StartTime, const string& strHead, const struct FColor& headColor, const string& strDesc, const string& strKey)
{
...
void AwHudPart_DisplayEvent::DrawAAS(class UCanvas* C, const string& sAASNotice)
{
...
void AwHudPart_DisplayEvent::DrawMoveGameNotice(class UCanvas* C, const string& sGameNotice, float fLifeTime)
{
...
void AwHudPart_DisplayEvent::DrawGameNotice(class UCanvas* C, const string& sGameNotice)
{
...
string AwHudPart_DisplayEvent::GetMessageGameMode_FFA()
{
...
string AwHudPart_DisplayEvent::GetMessageGameMode_SBT()
{
...
string AwHudPart_DisplayEvent::GetMessageGameMode_SD()
{
...
string AwHudPart_DisplayEvent::GetMessageGameMode_DOA()
{
...
string AwHudPart_DisplayEvent::GetMessageGameMode_DOM()
{
...
string AwHudPart_DisplayEvent::GetMessageGameMode_TD()
{
...
string AwHudPart_DisplayEvent::GetMessageGameMode(class UMaterial** mat)
{
...
void AwHudPart_DisplayEvent::DisplayEvent_GameMode(const string& Message)
{
...
void AwHudPart_DisplayEvent::DrawRoundResult(class UCanvas* C, int ScoringTeam, int iMyTeam)
{
...
void AwHudPart_DisplayEvent::DisplayRoundResult(class UCanvas* C, int ScoringTeam, int iMyTeam)
{
...
void AwHudPart_DisplayEvent::DrawMessageHeadShotAndMultiKill(class UCanvas* C, const string& sMessage, bool bAddPosY, float fFontSize, const struct FColor& _colorShadow)
{
...
void AwHudPart_DisplayEvent::DisplayEvent_Skill_SentryGun(class UCanvas* C)
{
	static auto fn = UObject::FindObject<UFunction>("Function XInterface.wHudPart_DisplayEvent.DisplayEvent_Skill_SentryGun");

	AwHudPart_DisplayEvent_DisplayEvent_Skill_SentryGun_Params params;
	params.C = C;
...
void AwHudPart_DisplayEvent::DisPlayEvent_Waiting(const string& Message)
{
...
void AwHudPart_DisplayMain::UpdateHelpKey_Slot(byte iIndex, bool bEnable)
{
...
void AwHudPart_RadioMessage::DrawRadioMessage(class UCanvas* C, int iMessage, int iHeight, const string& sMessage)
{
...
ERMType AwHudPart_RadioMessage::GetRadioType()
{
...
void AwHudPart_RadioMessage::SetRadioType(ERMType _ERMType)
{
...
void AwHudPart_DisplayQuest::PushMessage(const string& MissionDesc, int cur, int Max)
{
...
void AwHudPart_DisplayQuest::ReceivedAccomplishMission100Percent(const string& MissionDesc, int cur, int Max)
{
...
void AwHudPart_DisplayQuest::ReceivedAccomplishMission75Percent(const string& MissionDesc, int cur, int Max)
{
...
void AwHudPart_DisplayQuest::ReceivedAccomplishMission50Percent(const string& MissionDesc, int cur, int Max)
{
...
void AwHudPart_DisplayQuest::ReceivedAccomplishMission25Percent(const string& MissionDesc, int cur, int Max)
{
...
void UmoEditBox::SetText(const string& NewText)
{
...
string UmoEditBox::GetComponentValue()
{
...
void UmoEditBox::SetComponentValue(const string& NewValue, bool bNoChange)
{
