...
#define CONST_QUICKSLOT_EXTEND                                    1
#define CONST_TEAM_ID_AF                                          0
#define CONST_NPCID_DEFENCE_SENTRYGUN                             201
#define CONST_MaxInt                                              0x7fffffff
#define CONST_Pi                                                  3.1415926535897932
#define CONST_QUICK_SLOT_ORDER_ONLY_MODEITEM                      255
...
#define CONST_ITEMID_DEFAULT_KNIFE                                9000
#define CONST_ITEMID_DEFAULT_BODY                                 15000
#define CONST_WEAPONID_DEFENCE_SENTRYGUN                          5021
#define CONST_WEAPONID_SENTRYGUN                                  5017
#define CONST_WEAPONID_UAV                                        5010
#define CONST_WEAPONID_BOMBING                                    5006
#define CONST_COMMON_MODE_ITEM                                    0
#define CONST_INVAILD_ITEM_ID                                     0
#define CONST_INVALID_SUPPLY_ITEM_ID                              255
#define CONST_INVAILD_SLOT_INDEX                                  -1
...
struct FInterpCurve
{
	struct FInterpCurvePoint[]                         Points;                                                   // 0x0000(0x000C) (Edit, NeedCtorLink)
};
...
struct FIntArray
{
	int[]                                              Values;                                                   // 0x0000(0x000C) (NeedCtorLink)
};
...
{
	string                                             ClassName;                                                // 0x0000(0x000C) (NeedCtorLink)
	string                                             UserFriendlyName;                                         // 0x000C(0x000C) (NeedCtorLink)
	string                                             ModeDescription;                                          // 0x0018(0x000C) (NeedCtorLink)
	string[]                                           TimeLimits;                                               // 0x0024(0x000C) (NeedCtorLink)
	string[]                                           Scores;                                                   // 0x0030(0x000C) (NeedCtorLink)
	string[]                                           Scores_DefaultTimeLimits;                                 // 0x003C(0x000C) (NeedCtorLink)
	string                                             ScoreDefault;                                             // 0x0048(0x000C) (NeedCtorLink)
	int[]                                              UserCount;                                                // 0x0054(0x000C) (NeedCtorLink)
	int                                                UserCount_Default;                                        // 0x0060(0x0004)
	bool                                               bPlayWithBots;                                            // 0x0064(0x0004)
...
struct FColor
{
	byte                                               B;                                                        // 0x0000(0x0001) (Edit, Config)
	byte                                               G;                                                        // 0x0001(0x0001) (Edit, Config)
	byte                                               R;                                                        // 0x0002(0x0001) (Edit, Config)
	byte                                               A;                                                        // 0x0003(0x0001) (Edit, Config)
...
struct FMessageItem
{
	...
	EMessageType                                       Type;                                                     // 0x000C(0x0001)
...
{
	struct FVector                                     vPos;                                                     // 0x0000(0x000C)
	string                                             szName;                                                   // 0x000C(0x000C) (NeedCtorLink)
};
...
struct FScale
{
	...
	ESheerAxis                                         SheerAxis;                                                // 0x0010(0x0001) (Edit, Config)
