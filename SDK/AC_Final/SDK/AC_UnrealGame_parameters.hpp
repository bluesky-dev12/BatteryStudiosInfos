...
struct ADeathMatch_AnnounceSentryGun_Destory_Params
{
	int                                                iTeamIndex;                                               // (Parm)
};

// Function UnrealGame.DeathMatch.AnnounceSentryGun_Spawn
struct ADeathMatch_AnnounceSentryGun_Spawn_Params
{
...
struct ADeathMatch_Proccess_AddDefaultInventory_Params
{
...
struct UACTION_GotoMenu_GetActionString_Params
{
	string                                             ReturnValue;                                              // (Parm, OutParm, ReturnParm, NeedCtorLink)
};

// Function UnrealGame.ACTION_GotoMenu.GetMenuName
struct UACTION_GotoMenu_GetMenuName_Params
{
	string                                             ReturnValue;                                              // (Parm, OutParm, ReturnParm, NeedCtorLink)
};

// Function UnrealGame.ACTION_GotoMenu.InitActionFor
struct UACTION_GotoMenu_InitActionFor_Params
{
