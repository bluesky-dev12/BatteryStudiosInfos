...
{
public:
	bool                                               bFadeTimeChangeAlpha;                                     // 0x0374(0x0004)
	bool                                               bFadeTimeChangeColor;                                     // 0x0374(0x0004)
	bool                                               bFadeTimeTranslate;                                       // 0x0374(0x0004)
	bool                                               bUseChangeAlpha;                                          // 0x0374(0x0004)
	bool                                               bUseTranslate;                                            // 0x0374(0x0004)
	...
	bool                                               bCallFadeIn;                                              // 0x037C(0x0004)
	bool                                               bFading;                                                  // 0x037C(0x0004)
	bool                                               bClosing;                                                 // 0x037C(0x0004)
	float                                              FadeTime;                                                 // 0x0380(0x0004) (Edit)
	float                                              CurFadeTime;                                              // 0x0384(0x0004) (Edit)
	byte                                               CurFade;                                                  // 0x0388(0x0001) (Edit)
	byte                                               DesiredFade;                                              // 0x0389(0x0001) (Edit)
	byte                                               StartFade;                                                // 0x038A(0x0001) (Edit)
	byte                                               Padding00[0x1];                                           // 0x038B(0x0001) MISSED OFFSET
	...
	struct FScriptDelegate                             __OnFadeEnd__Delegate;                                    // 0x03BC(0x0090) (NeedCtorLink)
...
public:
	...
	string                                             WindowName;                                               // 0x03CC(0x000C) (Edit, Localized, NeedCtorLink)
	...
	bool                                               BtSizing;                                                 // 0x03E8(0x0004) (Edit, EditConst)
	bool                                               TLSizing;                                                 // 0x03E8(0x0004) (Edit, EditConst)
	bool                                               TRSizing;                                                 // 0x03E8(0x0004) (Edit, EditConst)
	bool                                               BRSizing;                                                 // 0x03E8(0x0004) (Edit, EditConst)
	bool                                               BLSizing;                                                 // 0x03E8(0x0004) (Edit, EditConst)
	bool                                               bResizeWidthAllowed;                                      // 0x03E8(0x0004) (Edit, EditConst)
	bool                                               bResizeHeightAllowed;                                     // 0x03E8(0x0004) (Edit, EditConst)
	bool                                               bResizing;                                                // 0x03E8(0x0004) (Edit, EditConst)
	bool                                               bMoveAllowed;                                             // 0x03E8(0x0004) (Edit, EditConst)
	bool                                               bMoving;                                                  // 0x03E8(0x0004) (Edit, EditConst)
	bool                                               TSizing;                                                  // 0x03E8(0x0004) (Edit, EditConst)
	bool                                               RSizing;                                                  // 0x03E8(0x0004) (Edit, EditConst)
	bool                                               LSizing;                                                  // 0x03E8(0x0004) (Edit, EditConst)
	...
	bool                                               bSetControlsBoundToParent;                                // 0x0400(0x0004)
	bool                                               bSetControlsScaleToParent;                                // 0x0400(0x0004)
...
public:
	...
	byte[]                                             CloseKey;                                                 // 0x0414(0x000C) (Edit, NeedCtorLink, EditInline)
	...
	void HandleChat(const string& Msg, int TeamIndex);
