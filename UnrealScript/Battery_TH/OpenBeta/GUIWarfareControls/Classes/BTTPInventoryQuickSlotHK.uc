...
{
    var wItemBoxHK ItemInfo[8];
    var wItemBoxInstanceHK instanceInfo[8];
};
...
var FloatBox fbButtonQuickSlot[8];
var localized string strButtonQuickSlot[8];
var export editinline BTItemBoxButtonHK ButtonQuickSlot[8];
...
function ShowWeaponTransparent(BTROItemBoxHK MainWeapon, BTROItemBoxHK SubWeapon, BTROItemBoxHK ThrowWeapon1, BTROItemBoxHK ThrowWeapon2)
{
    MainWeapon.Update();
    SubWeapon.Update();
    ThrowWeapon1.Update();
...
function ShowSkillTransparent(BTROItemBoxHK Skill_1, BTROItemBoxHK Skill_2)
{
    Skill_1.Update();
    Skill_2.Update();
    // End:0x6F
...
defaultproperties
{
    ...
    begin object name="mBackgroundImage" class=GUIWarfareControls_Decompressed.BTStretchedImageHK
        Image=Texture'Warfare_TH_UI_UI.Common.panel_1'
        WinTop=0.0000000
        WinLeft=0.0000000
        WinWidth=1.0000000
        WinHeight=1.0000000
    ...
    fbButtonTag[0]=(X1=29.0000000,Y1=129.0000000,X2=319.0000000,Y2=187.0000000)
    fbButtonTag[1]=(X1=29.0000000,Y1=195.0000000,X2=319.0000000,Y2=253.0000000)
    fbButtonTag[2]=(X1=29.0000000,Y1=261.0000000,X2=319.0000000,Y2=319.0000000)
    fbButtonTag[3]=(X1=29.0000000,Y1=327.0000000,X2=319.0000000,Y2=385.0000000)
    fbButtonTag[4]=(X1=29.0000000,Y1=393.0000000,X2=319.0000000,Y2=451.0000000)
    ...
    fbButtonQuickSlot[0]=(X1=337.0000000,Y1=117.0000000,X2=493.0000000,Y2=202.0000000)
    fbButtonQuickSlot[1]=(X1=337.0000000,Y1=204.0000000,X2=493.0000000,Y2=289.0000000)
    fbButtonQuickSlot[2]=(X1=337.0000000,Y1=291.0000000,X2=413.0000000,Y2=376.0000000)
    fbButtonQuickSlot[3]=(X1=415.0000000,Y1=291.0000000,X2=493.0000000,Y2=376.0000000)
    fbButtonQuickSlot[4]=(X1=337.0000000,Y1=465.0000000,X2=493.0000000,Y2=550.0000000)
    fbButtonQuickSlot[5]=(X1=337.0000000,Y1=552.0000000,X2=493.0000000,Y2=637.0000000)
