...
function AddTeamMemeber(bool bMe, int UID, int ClanMark, int ClanBG, int ClanBL, int Level, string NickName, string ClanName, int Score, int Kill, int Assist, int Death, int Exp, int expup, int Point, int pointup, array<int> BonusIDs, int LookingFor, bool bFriendly, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3)
{
    ...
    Data.DataPerColumn[9].Text[0].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.SmallPerc();
    Data.DataPerColumn[10].Text[0].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.SmallPerc();
    // End:0x2CB
    if((bMe && none != Controller.ViewportOwner.Actor) && int(Controller.ViewportOwner.Actor.AASLevel) >= 3)
    {
        switch(Controller.ViewportOwner.Actor.AASLevel)
        {
            // End:0x211
            case 3:
            // End:0x216
            ...
            // End:0x238
            case 6:
                aasColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.AASLevel3();
                // End:0x260
                break;
            // End:0x23D
            case 7:
            // End:0x25A
            case 8:
                aasColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.AASLevel7();
                // End:0x260
                break;
            // End:0xFFFF
            default:
        ...
        if(i < 3)
        {
            Data.DataPerColumn[9].Text[i].DrawColor = aasColor;
            Data.DataPerColumn[10].Text[i].DrawColor = aasColor;
            i++;
            // [Loop Continue]
            goto J0x267;
        }
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("clan", 266.0000000 - float(233), 7);
    headerInfo.__CustomDraw__Delegate = LC0_Draw;
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("level", 300.0000000 - float(266), 7);
    headerInfo.__CustomDraw__Delegate = LC1_Draw;
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("nickname", 461.0000000 - float(300), 7);
    headerInfo.__CustomDraw__Delegate = LC2_Draw;
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("clanname", 572.0000000 - float(461), 7);
    headerInfo.__CustomDraw__Delegate = LC3_Draw;
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("score", 610.0000000 - float(572), 1);
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("kill", 645.0000000 - float(610), 1);
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("assist", 697.0000000 - float(645), 1);
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("death", 733.0000000 - float(697), 1);
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("bonus", 835.0000000 - float(733), 7);
    headerInfo.__CustomDraw__Delegate = LC8_Draw;
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("exp", 929.0000000 - float(835), 7);
    headerInfo.__CustomDraw__Delegate = LC9_10_Draw;
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("point", 1024.0000000 - float(929), 7);
    headerInfo.__CustomDraw__Delegate = LC9_10_Draw;
    self.AddColumn(headerInfo);
    NormalizeColumnPerc();
    tarray.Length = 2;
