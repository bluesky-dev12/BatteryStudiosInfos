...
var localized string strLabel[23];
...
function SetData(int UserID, string CharName, string ClanName, int CM_Pattern, int CM_BG, int CM_BL, CharInfo stCharInfo, ClanInfo stClanInfo, int ClanLevel)
{
    ...
    {
        nPerc = int((float(stCharInfo.Kill) / float(stCharInfo.Death)) * 100.0000000);
    }
    ...
    BTOwnerDrawTextArrayHK(Content[10]).SetRankData(string(stCharInfo.WomanRanking) @ strRank, stCharInfo.WomanRanking - stCharInfo.PrevWomanRanking);
    BTOwnerDrawTextArrayHK(Content[11]).SetRankData(string(stCharInfo.MonthlyWomanRanking) @ strRank, stCharInfo.MonthlyWomanRanking - stCharInfo.MonthlyPrevWomanRanking);
    BTOwnerDrawTextArrayHK(Content[12]).SetRankData(string(stCharInfo.HeadShotRanking) @ strRank, stCharInfo.HeadShotRanking - stCharInfo.PrevHeadShotRanking);
    BTOwnerDrawTextArrayHK(Content[13]).SetRankData(string(stCharInfo.MonthlyHeadShotRanking) @ strRank, stCharInfo.MonthlyHeadShotRanking - stCharInfo.MonthlyPrevHeadShotRanking);
    BTOwnerDrawTextArrayHK(Content[14]).SetData(string(stCharInfo.ClanContribue));
    // End:0x620
    ...
    BTOwnerDrawTextArrayHK(Content[15]).SetData((((((((((string(stCharInfo.ClanWin + stCharInfo.ClanLose) $ strRound) $ " ") $ string(stCharInfo.ClanWin)) $ strWin) $ " / ") $ string(stCharInfo.ClanLose)) $ strLose) $ " (") $ string(nPerc)) $ "%)");
    // End:0x702
    ...
    BTOwnerDrawTextArrayHK(Content[16]).SetData((((((((((string(stCharInfo.ClanKill) $ strKill) $ " / ") $ string(stCharInfo.ClanAssist)) $ strAssist) $ " / ") $ string(stCharInfo.ClanDeath)) $ strDeath) $ " (K/D ") $ string(nPerc)) $ "%)");
    // End:0x7C0
    ...
    BTOwnerDrawTextArrayHK(Content[17]).SetData((((string(stCharInfo.ClanHeadshot) $ strHeadShot) $ " (") $ string(nPerc)) $ "%)");
    BTOwnerDrawTextArrayHK(Content[18]).SetData((string(0) $ " ") $ strDiscon);
    BTOwnerDrawTextArrayHK(Content[19]).SetRankData(string(stCharInfo.ClanRanking) @ strRank, stCharInfo.ClanRanking - stCharInfo.ClanRankingPrev);
    BTOwnerDrawTextArrayHK(Content[20]).SetRankData(string(stCharInfo.ClanRankingMonthly) @ strRank, stCharInfo.ClanRankingMonthly - stCharInfo.ClanRankingMonthlyPrev);
    BTOwnerDrawTextArrayHK(Content[21]).SetData(string(stCharInfo.DisCon));
    Day = stCharInfo.TotPlayTime / 86400;
    Hour = int(float(stCharInfo.TotPlayTime) % float(86400)) / 3600;
    // End:0x96F
    if(Day > 0)
    {
        BTOwnerDrawTextArrayHK(Content[22]).SetData(((string(Day) @ strDay) @ string(Hour)) @ strHour);        
    }
    else
    {
        BTOwnerDrawTextArrayHK(Content[22]).SetData(string(Hour) @ strHour);
    }
    //return;    
}
...
function InitializeContent()
{
    ...
    BTOwnerDrawTextArrayHK(Content[3]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[7]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[8]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[9]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[10]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[11]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[12]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[13]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[14]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[15]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[16]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[17]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[18]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[19]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    ...
    BTOwnerDrawTextArrayHK(Content[20]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    Content[21] = NewComponent(new Class'GUIWarfareControls_Decompressed.BTOwnerDrawTextArrayHK', Class'Engine.BTCustomDrawHK'.static.MakeEmptyBox(), 0.7600000);
    BTOwnerDrawTextArrayHK(Content[21]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    Content[22] = NewComponent(new Class'GUIWarfareControls_Decompressed.BTOwnerDrawTextArrayHK', Class'Engine.BTCustomDrawHK'.static.MakeEmptyBox(), 0.7600000);
    BTOwnerDrawTextArrayHK(Content[22]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeYellow();
    //return;    
}
...
defaultproperties
{
    ...
    strLabel[10]="Ranking ???????"
    strLabel[11]="Rank/Month"
    strLabel[12]="Ranking ???????"
    strLabel[13]="H/S Rank/Month"
    strLabel[14]="?????????????"
    strLabel[15]="Ranking ???????"
    strLabel[16]="ClanWar"
    strLabel[17]="???????????????"
