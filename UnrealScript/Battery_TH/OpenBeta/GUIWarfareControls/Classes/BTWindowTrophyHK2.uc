...
function ItemBox_OnDramaEnded()
{
    ...
    // End:0x103
    if(ButtonItemBox[0].itemBox.ItemInfo.ItemID != 0)
    {
        LabelPreviewSlide[0].SetStartTime();
    }
    //return;    
}
...
function ItemBox_OnDramaEnded2()
{
    ...
    ButtonCancel.EnableMe();
    // End:0x104
    if(ButtonItemBox[1].itemBox.ItemInfo.ItemID != 0)
    {
        LabelPreviewSlide[1].SetStartTime();
    }
    //return;    
}
...
function ButtonItemBox_OnChangeItemInfoEnd1()
{
    ...
    if(SaveItemInfo[0] != none)
    {
        ...
        PInfo = SaveItemInfo[0].PartGroupList[SaveItemInfo[0].FindPartGroupIndex(SaveInstanceInfo[0].PartID)];
        roWeapon[0].SetPositionUI(PInfo.Bootyitem_3d_x, PInfo.Bootyitem_3d_y, PInfo.Bootyitem_3d_z);
        roWeapon[0].SetRotationUI(PInfo.Bootyitem_3d_rot_y);
    }
    //return;    
}
...
function ButtonItemBox_OnChangeItemInfoEnd2()
{
    ...
    if(SaveItemInfo[1] != none)
    {
        ...
        PInfo = SaveItemInfo[1].PartGroupList[SaveItemInfo[1].FindPartGroupIndex(SaveInstanceInfo[1].PartID)];
        roWeapon[1].SetPositionUI(PInfo.Bootyitem_3d_x, PInfo.Bootyitem_3d_y, PInfo.Bootyitem_3d_z);
        roWeapon[1].SetRotationUI(PInfo.Bootyitem_3d_rot_y);
    }
    //return;    
}
