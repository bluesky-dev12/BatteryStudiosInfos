...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    Grade.buttonImage[0].Image = Texture'Warfare_TH_UI_UI.Common.butt_rate_n';
    Grade.buttonImage[1].Image = Texture'Warfare_TH_UI_UI.Common.butt_rate_on';
    Grade.buttonImage[2].Image = Texture'Warfare_TH_UI_UI.Common.butt_rate_n';
    Grade.buttonImage[3].Image = Texture'Warfare_TH_UI_UI.Common.butt_rate_cli';
    Grade.buttonImage[4].Image = Texture'Warfare_TH_UI_UI.Common.butt_rate_dis';
    ...
    Exit.buttonImage[0].Image = Texture'Warfare_TH_UI_UI.Common.butt_logout_n';
    Exit.buttonImage[1].Image = Texture'Warfare_TH_UI_UI.Common.butt_logout_on';
    Exit.buttonImage[2].Image = Texture'Warfare_TH_UI_UI.Common.butt_logout_n';
    Exit.buttonImage[3].Image = Texture'Warfare_TH_UI_UI.Common.butt_logout_cli';
    Exit.buttonImage[4].Image = Texture'Warfare_TH_UI_UI.Common.butt_logout_dis';
...
defaultproperties
{
    ...
    BGImage=mBGImage
    strQuickJoin="QuickJoin_gc368"
    strQuickSetup="QuickSetup_gc369"
    strRefresh="Refresh"
}