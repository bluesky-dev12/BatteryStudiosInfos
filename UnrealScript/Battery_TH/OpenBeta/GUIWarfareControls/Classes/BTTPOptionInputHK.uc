...
function InitializeContent()
{
    ...
    BTTPOptionRadioButtonHK(Content[4]).ButtonRadio.ButtonOn.DisableMe();
    BTTPOptionRadioButtonHK(Content[4]).ButtonRadio.ButtonOff.DisableMe();
    ...
    BTTPOptionRadioButtonHK(Content[5]).ButtonRadio.ButtonOn.DisableMe();
    BTTPOptionRadioButtonHK(Content[5]).ButtonRadio.ButtonOff.DisableMe();
    i = 7;
    J0x49F:
