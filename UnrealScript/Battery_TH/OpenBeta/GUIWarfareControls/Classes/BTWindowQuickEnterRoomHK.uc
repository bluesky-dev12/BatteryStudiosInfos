...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    {
        // End:0x3FB
        if(((((((GameModes[i].ModeIndex == Class'Engine.wGameSettings'.static.GetModeIndex_Medal()) || GameModes[i].ModeIndex == Class'Engine.wGameSettings'.static.GetModeIndex_COL()) || GameModes[i].ModeIndex == Class'Engine.wGameSettings'.static.GetModeIndex_BotTutorial()) || GameModes[i].ModeIndex == Class'Engine.wGameSettings'.static.GetModeIndex_BotTeamDeathBeginner()) || GameModes[i].ModeIndex == Class'Engine.wGameSettings'.static.GetModeIndex_Domination()) || GameModes[i].ModeIndex == Class'Engine.wGameSettings'.static.GetModeIndex_BotDomination()) || GameModes[i].ModeIndex == Class'Engine.wGameSettings'.static.GetModeIndex_Sabotage())
        {
            // [Explicit Continue]
            goto J0x545;
            // [Explicit Continue]
