...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    LabelEditReceiver.BackgroundImage = Class'Engine.BTCustomDrawHK'.static.MakeImage(16, 16, 15, Texture'Warfare_TH_UI_UI.Common.panel_4');
    ...
    LabelContent.BackgroundImage = Class'Engine.BTCustomDrawHK'.static.MakeImage(16, 16, 15, Texture'Warfare_TH_UI_UI.Common.panel_4');
