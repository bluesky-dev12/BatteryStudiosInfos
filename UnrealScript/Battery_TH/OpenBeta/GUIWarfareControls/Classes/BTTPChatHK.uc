...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    if(i < 2)
    {
        ...
        ButtonChatStateArray[i].CaptionPadding[1] = 4;
    ...
    ButtonChatStateArray[1].ButtonID = 3;
    ButtonChatStateArray[0].Caption = strChatState[1];
    ButtonChatStateArray[1].Caption = strChatState[3];
    ButtonChatState.CaptionPadding[1] = 4;
