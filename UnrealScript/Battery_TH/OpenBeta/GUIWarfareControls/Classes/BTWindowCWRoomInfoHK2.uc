class BTWindowCWRoomInfoHK2 extends BTWindowHK
    editinlinenew
    instanced;
...
defaultproperties
{
    ...
    strLabelCommonTop[3]="???????"
    strLabelCommonTop[4]="??????????_gc2871"
    strLabelCommonTop[5]="sub mode_gc2872"
    strLabelCommonTop[7]="Target Point_gc2874"
    ...
    strLabelCommonBottom[0]="?????????????_gc2877"
    strLabelCommonBottom[1]="?????????_gc2878"
    strLabelCommonBottom[2]="??????????_gc2879"
    strLabelCommonBottom[4]="???????????????_gc2881"
    strLabelCommonBottom[5]="Voice Chatting_gc2882"
    strLabelCommonBottom[6]="???????_gc2883"
    ...
    strLabelWarning[2]="3.????????????????????????????????????????????????????????????????????????????????"
    strLabelWarning[3]="??????????????????????????????"
    strLabelSwitchSide="??????????????_gc2885"
    strLabelBombPossesion="????????"
    strBombForEveryone="???????"
    strBombForOne="???????"
    strLabelChangeAD="????????????????_gc2887"
    strLabelChangeRound="??????????_gc2888"
