...
function Internal_OnRendered(Canvas C)
{
    ...
    Class'Engine.BTCustomDrawHK'.static.DrawImage(C, Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.img_point_b, AWinPos.X1 + SaveX, AWinPos.Y1, AWinPos.X2, AWinPos.Y2);
    Class'Engine.BTCustomDrawHK'.static.DrawText(C, SavePoint, (AWinPos.X1 + SaveX) + float(imgW), AWinPos.Y1, AWinPos.X2, AWinPos.Y2);
    //return;    
}
