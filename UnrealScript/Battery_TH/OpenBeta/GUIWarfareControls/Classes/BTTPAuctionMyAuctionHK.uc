...
defaultproperties
{
    // Reference: ButtonGroups'GUIWarfareControls_Decompressed.BTTPAuctionMyAuctionHK.mgroups'
    begin object name="mgroups" class=GUIWarfareControls_Decompressed.ButtonGroups
    end object
    InvenGroup=mgroups
    // Reference: BTStretchedImageHK'GUIWarfareControls_Decompressed.BTTPAuctionMyAuctionHK.mBackgroundImage'
    ...
    strSubMenuSpecial[1]="?????????"
    strSubMenuSpecial[2]="????"
    // Referen[0]ce: TabControlMocker'GUIWarfareControls_Decompressed.BTTPAuctionMyAuctionHK.mTabControl'
    begin object name="mTabControl" class=GUIWarfareControls_Decompressed.TabControlMocker
    end object
    TabControl=mTabControl
    // Reference: TabControlMocker'GUIWarfareControls_Decompressed.BTTPAuctionMyAuctionHK.mTabControl2'
    ...
    fbMenuButton[3]=(X1=617.0000000,Y1=520.0000000,X2=711.0000000,Y2=552.0000000)
    fbPageButton=(X1=512.0000000,Y1=481.0000000,X2=997.0000000,Y2=506.0000000)
    OnPreDraw=BTTPAuctionMyAuctionHK.Internal_OnPreDraw
    OnRendered=BTTPAuctionMyAuctionHK.Internal_OnRendered
}