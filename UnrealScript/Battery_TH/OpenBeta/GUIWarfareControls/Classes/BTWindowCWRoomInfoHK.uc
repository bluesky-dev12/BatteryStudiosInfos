...
defaultproperties
{
    ...
    strLabelCommonTop[0]="???????_gc2824"
    strLabelCommonTop[1]="??????????_gc2825"
    strLabelCommonTop[2]="sub mode_gc2826"
    strLabelCommonTop[3]="Target Point_gc2827"
    ...
    strLabelCommonBottom[0]="?????????????_gc2828"
    strLabelCommonBottom[1]="?????????_gc2829"
    strLabelCommonBottom[2]="??????????_gc2830"
    strLabelCommonBottom[3]="???????????????_gc2831"
    strLabelCommonBottom[4]="Voice Chatting_gc2832"
    strLabelCommonBottom[5]="???????_gc2833"
    ...
    strLabelWarning[0]="1.???????????????? 50%???????????????????????????????????????????????????????????????????????"
    strLabelWarning[1]="2. Record ?????????????????????"
    strLabelWarning[2]="3.????????????????????????????????????????????????????????????????????????????????"
    strLabelWarning[3]="??????????????????????????????"
    strLabelSwitchSide="??????????????_gc2843"
    strLabelBombPossesion="??????????????_gc2844"
    strBombForEveryone="???????"
    strBombForOne="???????"
    strLabelChangeAD="????????????????????_gc2845"
    strLabelChangeRound="??????????"
    strClanRule[0]="Explosion Mission_gc2835"
    strClanRule[1]="3"
    strClanRule[2]="????????????"
    strClanRule[3]="6"
    strClanRule[4]="???????"
