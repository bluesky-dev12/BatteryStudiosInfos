...
defaultproperties
{
    ...
    strIssueType[2]="???"
    strIssueType[3]="??????"
    strIssueType[4]="?????????????_gc2701"
    strIssueType[5]="?????????_gc2702"
    strIssueType[6]="????????"
    strIssueType[7]="?????????????????_gc2704"
    strIssueType[8]="???????????????_gc2705"
    strIssueType[9]="?????????????_gc2706"
    strIssueType[10]="???????????_gc2707"
    strIssueType[11]="????????????_gc2708"
}