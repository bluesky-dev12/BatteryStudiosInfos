...
var export editinline ButtonGroups RadioGroup[2];
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    RadioGroup[0] = ButtonGroups(NewComponent(new Class'GUIWarfareControls_Decompressed.ButtonGroups', fbRadioOption[0]));
    i = 0;
    J0x23A:
    ...
    if(i < 2)
    {
        ...
        RadioGroup[0].AddButton(RadioOption[i]);
        i++;
        // [Loop Continue]
        goto J0x23A;
    }
    RadioGroup[0].SelectButton(0);
    RadioGroup[1] = ButtonGroups(NewComponent(new Class'GUIWarfareControls_Decompressed.ButtonGroups', fbRadioLocation[0]));
    i = 0;
    J0x353:
    ...
    if(i < 14)
    {
        ...
        RadioGroup[1].AddButton(RadioLocation[i]);
        i++;
        // [Loop Continue]
        goto J0x353;
    }
    RadioGroup[1].SelectButton(0);
    i = 0;
    J0x449:
...
function bool ButtonSearch_OnClick(GUIComponent Sender)
{
    ...
    Status = RadioGroup[0].GetSelectIndex();
    Region = RadioGroup[1].GetSelectIndex();
    MaxPage = -1;
    CurrentPage = 1;
    TcpChannel.sfReqSerachClan(byte(SearchType), searchtext, byte(Status), byte(Region), CurrentPage);
    return true;
...
defaultproperties
{
    ...
    strRadioLocation[12]="????"
    strRadioLocation[13]="????"
    fbRadioLocation[0]=(X1=228.0000000,Y1=185.0000000,X2=292.0000000,Y2=206.0000000)
    fbRadioLocation[1]=(X1=292.0000000,Y1=185.0000000,X2=356.0000000,Y2=206.0000000)
    fbRadioLocation[2]=(X1=356.0000000,Y1=185.0000000,X2=420.0000000,Y2=206.0000000)
    fbRadioLocation[3]=(X1=420.0000000,Y1=185.0000000,X2=484.0000000,Y2=206.0000000)
    fbRadioLocation[4]=(X1=484.0000000,Y1=185.0000000,X2=548.0000000,Y2=206.0000000)
    fbRadioLocation[5]=(X1=548.0000000,Y1=185.0000000,X2=612.0000000,Y2=206.0000000)
    fbRadioLocation[6]=(X1=612.0000000,Y1=185.0000000,X2=676.0000000,Y2=206.0000000)
    fbRadioLocation[7]=(X1=676.0000000,Y1=185.0000000,X2=740.0000000,Y2=206.0000000)
    fbRadioLocation[8]=(X1=740.0000000,Y1=185.0000000,X2=804.0000000,Y2=206.0000000)
    fbRadioLocation[9]=(X1=228.0000000,Y1=219.0000000,X2=292.0000000,Y2=239.0000000)
    fbRadioLocation[10]=(X1=292.0000000,Y1=219.0000000,X2=356.0000000,Y2=239.0000000)
    fbRadioLocation[11]=(X1=356.0000000,Y1=219.0000000,X2=420.0000000,Y2=239.0000000)
    fbRadioLocation[12]=(X1=420.0000000,Y1=219.0000000,X2=484.0000000,Y2=239.0000000)
    fbRadioLocation[13]=(X1=484.0000000,Y1=219.0000000,X2=548.0000000,Y2=239.0000000)
