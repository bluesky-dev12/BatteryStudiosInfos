...
defaultproperties
{
    ...
    strSubMenuAll[0]="???????"
    strSubMenuAll[1]="??????"
    strSubMenuAll[2]="?????????????????????_gc519"
    strSubMenuWeapon[0]="???????"
    strSubMenuWeapon[1]="?????????"
    strSubMenuWeapon[2]="????????"
    strSubMenuWeapon[3]="??????????"
    strSubMenuEquip[0]="???????_gc526"
    strSubMenuEquip[1]="???????????_gc527"
    strSubMenuEquip[2]="??????_gc528"
    strSubMenuEquip[3]="?????????????_gc529"
    strSubMenuEquip[4]="????????????_gc530"
    strSubMenuSpecial[0]="????????_gc532"
    strSubMenuSpecial[1]="????????_gc533"
    ...
    strMenuButton[0]="???"
    strMenuButton[1]="???????????_gc536"
    strMenuButton[2]="???????????_gc537"
    strMenuButton[3]="????"
    strMenuButton[4]="??????"
