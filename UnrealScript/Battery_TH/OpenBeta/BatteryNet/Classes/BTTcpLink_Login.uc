...
event bool rfAckCreateChar(byte Success, string ErrMsg)
{
    return false;
    //return;    
}
...
event bool rfAckCharInfo(int Result, string CharName, int Level, int Exp, string ClanName, byte ClanGrade, int CMarkPattern, int CMarkBG, int CMarkBL)
{
    return false;
    //return;    
}
...
native function bool sfAckCreateChar(byte Success, string ErrMsg)
{
    //native.Success;
    //native.ErrMsg;        
}
...
native function bool sfAckFriendsList(byte ListType, array<string> UserName, array<string> CServername, array<string> ServerShortName, array<string> ServerIP, array<int> ServerPort, array<byte> CurPos, array<int> chNumber, array<string> ChannelNickName, array<int> rmNumber, array<int> CMarkPattern, array<int> CMarkBG, array<int> CMarkBL, array<string> ClanName, array<int> Level)
{
    //native.ListType;
    //native.UserName;
    //native.CServername;
...
native function bool sfAckCharInfo(int Result, string CharName, int Level, int Exp, string ClanName, byte ClanGrade, int CMarkPattern, int CMarkBG, int CMarkBL)
{
    //native.Result;
    //native.CharName;
    //native.Level;
