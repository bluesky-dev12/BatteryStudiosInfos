...
function MatchReultPostStep()
{
    ...
    if(page_Main.LevelUpInfo.bLevelUp)
    {
        ...
        if(page_Main.LevelUpInfo.ItemID.Length == 0)
        {
            ...
            else
            {
                ...
                {
                    BTWindowPromotionHK2(Controller.TopPage()).__OnOK__Delegate = BTWindowTrophyHK_OnCancel;
                }
            }            
        }
        else
        {
            ...
            else
            {
                ...
                {
                    BTWindowPromotionHK(Controller.TopPage()).__OnOK__Delegate = BTWindowTrophyHK_OnCancel;
                }
            }
        }        
    }
    else
    {
        ...
        else
        {
            ...
            {
                BTWindowTrophyHK_OnCancel(none);
            }
        }
    }
    //return;    
...
function bool BTWindowNoUpdateQuestHK_OpenMenu(GUIComponent Sender)
{
    ...
    BTWindowDefineARHK(Controller.TopPage()).__OnOK__Delegate = BTWindowTrophyHK_OnCancel;
    NeedUpdate();
    //return;    
}
...
function bool BTWindowQuestInfoHK_OpenMenu(GUIComponent Sender)
{
    ...
    BTWindowQuestInfoHK(Controller.TopPage()).__OnOK__Delegate = BTWindowTrophyHK_OnCancel;
    NeedUpdate();
    //return;    
}
...
function bool BTWindowTrophyHK_OpenMenu(GUIComponent Sender)
{
    ...
    local array<int> candidatePool;

    Log("[BTPageMatchResult::BTWindowTrophyHK_OpenMenu] ");
    GameMgr = Controller.ViewportOwner.Actor.Level.GameMgr;
    candidatePool.Length = 26;
    candidatePool[0] = 1030;
    candidatePool[1] = 1031;
    candidatePool[2] = 1032;
    candidatePool[3] = 2010;
    candidatePool[4] = 2011;
    candidatePool[5] = 2012;
    candidatePool[6] = 2013;
    candidatePool[7] = 2014;
    candidatePool[8] = 2015;
    candidatePool[9] = 2040;
    candidatePool[10] = 2041;
    candidatePool[11] = 2042;
    candidatePool[12] = 2043;
    candidatePool[13] = 2044;
    candidatePool[14] = 3030;
    candidatePool[15] = 3031;
    candidatePool[16] = 3032;
    candidatePool[17] = 3033;
    candidatePool[18] = 3034;
    candidatePool[19] = 3035;
    candidatePool[20] = 4040;
    candidatePool[21] = 4041;
    candidatePool[22] = 4042;
    candidatePool[23] = 4043;
    candidatePool[24] = 4044;
    candidatePool[25] = 4045;
    // End:0x4CC
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    LabelBackground.BackgroundImage = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.img_back1;
    ...
    LabelBottomLine = NewLabelComponent(fbLabelBottomLine, Class'GUIWarfareControls.BTUIResourcePoolHK'.default.img_HUD_back_3);
...
defaultproperties
{
    ...
    fbButtonClose=(X1=398.0000000,Y1=692.0000000,X2=628.0000000,Y2=725.0000000)
