...
defaultproperties
{
    ...
    LoadingStateMessage[0]="?????????????????????????????"
    LoadingStateMessage[1]="?????????????????????????"
    LoadingStateMessage[2]="????????????????????"
    LoadingStateMessage[3]="???????????????????????"
    LoadingStateMessage[4]="????????????????????????????"
    LoadingStateMessage[5]="????????????????????????????"
    LoadingStateMessage[6]="??????????????????????????????????"
    OtherLoadingStateMessage[0]="?????????????????????????????"
    OtherLoadingStateMessage[1]="??????????????????????"
    OtherLoadingStateMessage[2]="????????????????????"
    OtherLoadingStateMessage[3]="???????????????????"
    OtherLoadingStateMessage[4]="???????????????????????"
    OtherLoadingStateMessage[5]="???????????????????????"
    OtherLoadingStateMessage[6]="?????????????????????"
