...
function bool sfReqWebzenInvenList(string StorageType)
{
    ...
    Log("[BTNetMainMenu::sfReqWebzenInvenList] ThailandVersion false");
    return false;
    //return;    
}
...
function AddServerChannelList(int ServerID, int ChannelID, string ServerIP, int ServerPort, int ServerDataPort, string ServerName, string ServerShortName, string ChannelName, int ServerGroupID, string ServerGroupName, int IsClanChannel, string ChannelNickName, bool IsPracticeChannel, bool IsDedicatedServer)
{
    local int AddIdx;
...
function TPChat_OnInputTab(GUIComponent Sender, string Text)
{
    ...
    // End:0x62
    if(PrevChatMode.ChatType == 2)
    {
        PrevChatMode.ChatType++;
    }
