...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    LabelClanMark = BTLabelClanMarkHK(NewComponent(new Class'GUIWarfareControls.BTLabelClanMarkHK', fbLabelClanMark));
...
function OnPopupCheck()
{
    ...
    // End:0x12D
    if(ACLMember.IsOffLine(ACLMember.selectIndex))
    {
        return;
    }
...
function bool rfAckClanUserList(int Result, string ErrMsg, array<int> Level, array<string> CharName, array<byte> ClanGrade, array<string> ServerName, array<string> ServerShortName, array<string> ServerIP, array<int> ServerPort, array<byte> CurPos, array<int> ChannelNum, array<string> ChannelNickName, array<int> GameRoomNum, array<byte> IsCombat, array<int> ClanWinCnt, array<int> ClanLoseCnt, array<string> ClanSelfIntro, array<int> LevelMarkID, array<int> TitleMarkID, array<int> Reserved1, array<int> Reserved2, array<int> Reserved3)
{
    ...
    if(i < Level.Length)
    {
        ACLMember.AddClanMember(Level[i], CharName[i], ClanGrade[i], ServerShortName[i], ServerIP[i], ServerPort[i], CurPos[i], ChannelNum[i], ChannelNickName[i], GameRoomNum[i], ClanSelfIntro[i], LevelMarkID[i], TitleMarkID[i], Reserved1[i], Reserved2[i], Reserved3[i]);
        i++;
        // [Loop Continue]
        goto J0x50;
    }
...
function bool rfAckDBCharInfo(int Result, string ErrMsg, string CharName, string ClanName, int CM_Pattern, int CM_BG, int CM_BL, int MainWeaponItemID, int MainWeaponPartID, int SubWeaponItemID, int SubWeaponPartID, int AFSpecialCostumeItemID, int RSASpecialCostumeItemID, CharInfo stCharInfo, int ClanLevel)
{
...
defaultproperties
{
    ...
    strLabel[13]="?????"
    strLabel[14]="??????"
    fbLabel[0]=(X1=21.0000000,Y1=102.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[1]=(X1=222.0000000,Y1=102.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[2]=(X1=21.0000000,Y1=134.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[3]=(X1=222.0000000,Y1=134.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[4]=(X1=21.0000000,Y1=165.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[5]=(X1=222.0000000,Y1=165.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[6]=(X1=21.0000000,Y1=197.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[7]=(X1=222.0000000,Y1=197.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[8]=(X1=21.0000000,Y1=229.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[9]=(X1=222.0000000,Y1=229.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[10]=(X1=21.0000000,Y1=261.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[11]=(X1=222.0000000,Y1=261.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[12]=(X1=21.0000000,Y1=293.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[13]=(X1=21.0000000,Y1=323.0000000,X2=401.0000000,Y2=440.0000000)
    fbLabel[14]=(X1=21.0000000,Y1=388.0000000,X2=401.0000000,Y2=440.0000000)
    ...
    strButtonTop[2]="?????"
    strButtonTop[3]="???????????????"
    fbACLMember=(X1=420.0000000,Y1=116.0000000,X2=746.0000000,Y2=455.0000000)
    ...
    strListBottomButton[0]="??????????"
    strListBottomButton[1]="????????"
