class wInfoPod extends Keypoint;
...
var() wInfoPod.EIP_AssaultTeam Team;
var() wInfoPod.EIP_InfoType InfoType;
var() wInfoPod.EIP_InfoEffect InfoEffect;
...
simulated function DrawInfoPod_PlainText(Canvas C, Vector IPScreenPos, PlayerController PC)
{
    ...
    FinalString = (Class'WMission_Decompressed.wHUD_Mission'.default.IP_Bracket_Open @ POD_Message) @ Class'WMission_Decompressed.wHUD_Mission'.default.IP_Bracket_Close;
...
simulated function DrawInfoPod_TextBrackets(Canvas C, Vector IPScrO, PlayerController PC)
{
    ...
    C.Font = PC.myHUD.GetFontSizeIndex(C, int(FontSize) - 8);
    Description = (Class'WMission_Decompressed.wHUD_Mission'.default.IP_Bracket_Open @ POD_Message) @ Class'WMission_Decompressed.wHUD_Mission'.default.IP_Bracket_Close;
    Class'WMission_Decompressed.wHUD_Mission'.static.Draw_2DCollisionBox(C, self, IPScrO, Description, DrawScale, false);
    //return;    
}
