...
function DrawGiftItem(Canvas C)
{
    ...
    local Material mat;
    local float fTotalDrawTime, fDrawEffectTime, fDeltaTime, fDeltaTime2, _PosX, _PosY,
	    fScale, fAddRatio;
    ...
    WGiftItemBG.WidgetTexture = Material(DynamicLoadObject("Warfare_UI_UI.list_item_store_n", Class'Engine.Material'));
