...
defaultproperties
{
    ...
    SpSelectLine=(WidgetTexture=Texture'Warfare_TH_UI_UI.Common.img_back_quick_3',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=16,Y2=16),TextureScale=0.6500000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=192),Tints[1]=(R=255,G=255,B=255,A=192))
    ...
    MissionNameTD="Team Exterminate Mode"
    MissionNameSD="Explosion Mission"
    MissionNameDOMI="Capture Mode"
    MissionNameSBT="Explosion Exterminate"
    MissionNameDM="Single Mode"
    MissionNameFM="???????????????"
    MissionNameTM="??????????"
    MissionCommentTD1="??????????????? ????????? Target point ??????????????"
    MissionCommentSDA1="??????????????????????????? (A???? B)????????? ???????????????????"
    MissionCommentSDA2="????????????????? ??????? Target point ???????????????"
    MissionCommentSDD1="??????????????????????????????????? (A???? B) ???????????????????"
    MissionCommentSDD2="????????????????? ??????? Target point ?????????????"
    MissionCommentDOMI1="??????????????? ???????????? Target point ?????????????"
    MissionCommentSBT1="??????????????????????????????????? ?????????????????????"
    MissionCommentSBT2="????????????????? ??????? Target point ???????????????"
    MissionCommentDM1="??????????????? ????????????? Target point ??????????????"
    MissionCommentFM1="??????????????? ???????????? Target point ??????????"
    MissionCommentTM1="???????????????????????????????????"
    StrLoading="?????????"
    WeaponLimitKnifeOnly="???????"
    WeaponLimitRPGOnly="??? RPG"
    WeaponLimitSROnly="????????"
    WeaponLimitSRBan="???????"
    WSBIBG1=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_back_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=2),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=54,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WSBIBG2=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_back_2',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=512,Y2=8),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=121,OffsetY=150,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WSBBG2=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.hud_back_2',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=32,Y2=8),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=121,OffsetY=150,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WSBBGPanel=(WidgetTexture=Texture'Warfare_TH_UI_UI.Common.panel_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=16,Y2=16),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=129,OffsetY=255,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamAF=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_scbod_AF_ma',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=671,Y2=50),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=810,OffsetY=118,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamRSA=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_scbod_RSA_ma',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=671,Y2=50),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=810,OffsetY=643,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WDivid=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_list_divid_b',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=3,Y2=19),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=864,OffsetY=176,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WContentBG=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.butt_list_scbd_n',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=16,Y2=16),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=810,OffsetY=167,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WListDivedBar=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.list_scor_bord',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=669,Y2=2),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WIconMaster=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.icon_mstr_b',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=46,Y2=46),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WIconDeath=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.icon_death',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=46,Y2=46),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WPing[0]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.sgau_ping_b_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=30,Y2=30),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WPing[1]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.sgau_ping_b_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=30,Y2=30),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WPing[2]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.sgau_ping_b_2',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=30,Y2=30),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WPing[3]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.sgau_ping_b_3',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=30,Y2=30),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WPing[4]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.sgau_ping_b_4',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=30,Y2=30),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WTeamScoreBG=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_score',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=486,Y2=40),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=213,OffsetY=166,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WFFABG=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_scbod_indimat_ma',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=671,Y2=102),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=810,OffsetY=118,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WFFAScoreBG=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_score_0',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=486,Y2=71),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=213,OffsetY=150,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
