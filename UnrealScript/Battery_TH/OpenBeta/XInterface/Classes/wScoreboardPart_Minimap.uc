...
function DrawMinimap_Airstrike(Canvas C)
{
    ...
    if((true == Level.IsAirStriking) || Level.fAirStrikeFadeTime > 0.0000000)
    {
        ...
        C.DrawTile(MinimapAirStrikeRect.WidgetTexture, (cx2 - cx1) * _rX, (cy2 - cy1) * _rY, 0.0000000, 0.0000000, float(MinimapAirStrikeRect.WidgetTexture.MaterialUSize()), float(MinimapAirStrikeRect.WidgetTexture.MaterialVSize()));
...
defaultproperties
{
    ...
    MinimapSize=404
    DrawFrame=false
    UAVBG_Base=VariableTexPanner'Warfare_TH_UI_HUD_ETC.minimapicon.UAV_BIG_VPan'
    UAVBG=TexRotator'Warfare_TH_UI_HUD_ETC.minimapicon.UAV_BIG_Rot'
