...
function DisplayEvent_Skill_Helicopter(Canvas C)
{
    ...
    fRatio = FClamp(fRatio, 0.0000000, 1.0000000);
    SkillHelicopterOn.OffsetX = int(float(default.SkillHelicopterOn.OffsetX) + (float(-454) * fRatio));
...
function CallSkill(optional int iKey, optional bool bRequire, optional bool iSucess)
{
    ...
    if(6 == iKey)
    {
        ...
        else
        {
            ...
            if(5 == iKey)
            {
                wWP = Level.GetLocalPlayerController().Pawn.GetWeaponByInvenGroup(5);
                // End:0x500
                if(wWP != none)
                {
                    // End:0x3AC
                    ...
                    {
                        // End:0x45A
                        if((int(wWP.BaseParams.eType) == int(14)) || int(wWP.BaseParams.eType) == int(11))
                        {
                            // End:0x406
                            if(bRequire)
                            {
...
function DisplayEvent_Skill_AirStirke(Canvas C)
{
    ...
    fRatio = FClamp(fRatio, 0.0000000, 1.0000000);
    SkillAirstrikeOn.OffsetX = int(float(default.SkillAirstrikeOn.OffsetX) + (float(-454) * fRatio));
...
function DisplayEvent_Skill_UAV(Canvas C)
{
    ...
    fRatio = FClamp(fRatio, 0.0000000, 1.0000000);
    SkillUAVOn.OffsetX = int(float(default.SkillUAVOn.OffsetX) + (float(-454) * fRatio));
...
function DisplayEvent_Skill_UsingSkill(Canvas C)
{
    ...
    // End:0x333
    if(((HudCDeathmatch(HudOwner).ActiveUsingSkill.iSkillID == 40018) || HudCDeathmatch(HudOwner).ActiveUsingSkill.iSkillID == 40017) || HudCDeathmatch(HudOwner).ActiveUsingSkill.iSkillID == 40022)
    {
        AddKeyPosX = -52;
    }
    ...
    SkillIconEvent.OffsetX = int(float(default.SkillIconEvent.OffsetX) + (float(-384) * fRatio));
...
function Draw_Item_Supply(Canvas C, PlayerReplicationInfo curPRI)
{
    ...
    if((HudOwner != none) && HudOwner.PlayerOwner != none)
    {
        ...
        // End:0x17D
        if(int(curPRI.bySupply_AirStrike) == 1)
        {
...
function DrawResultScore(Canvas C, bool Won)
{
    ...
    C.SetDrawColor(byte(255), byte(255), byte(255), byte(255));
    matDrawBack = Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_0_1';
    ...
    else
    {
        ...
        if(Level.GRI.GameClass == "WMission.wDefenceGameInfo")
        {
            ...
            if(((bMessageDraw == true) && wDefenceGradeList.Length == 0) && CurrentRound != 0)
            {
                ...
                Level.GameMgr.GetDefenceGameBotGradeList(mapInfo.MapID, CurrentRound, wDefenceGradeList);
            }
        }
    }
    //return;    
...
function DrawVehicleInfo(Canvas C)
{
    ...
    mat = Texture'Warfare_TH_UI_HUD.Text.img_HUD_text';
    // End:0x537
    if(DrivenVehicle != none)
    {
...
function DrawSudenDeath(Canvas C)
{
    ...
    CalculateCoordinateEx(C, wTxtSubSudenDeath, 112.0000000, 32.0000000, calW);
    C.SetPos(calW.X1, calW.Y1);
    C.DrawTile(wTxtSubSudenDeath.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    //return;    
}
...
function string GetMessageGameMode_SD()
{
    ...
    if(Level.GRI.CurrentAttackingTeam == iTeamIndex)
    {
        ...
        if(Level.GRI.bObjectivePlanted)
        {
            ...
            if((Message != "") && bChangeMessgeGameMode)
            {
                switch(iGameObjectIndex)
                {
                    // End:0x146
                    case 0:
                        mGameMode[0] = Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.our_capture_a", Class'Engine.Material'));
                        // End:0x1EA
                        break;
                    // End:0x196
                    case 1:
                        mGameMode[0] = Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.our_capture_b", Class'Engine.Material'));
                        // End:0x1EA
                        break;
                    // End:0x1E7
                    case 2:
                        mGameMode[0] = Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.our_capture_c", Class'Engine.Material'));
                        // End:0x1EA
                        break;
                    // End:0xFFFF
                    default:
        ...
        else
        {
            ...
            {
                mGameMode[0] = Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.enemy_capture_b", Class'Engine.Material'));
                mGameMode[1] = Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.enemy_capture_a", Class'Engine.Material'));
                bChangeMessgeGameMode = false;
            }
        }        
    }
    else
    {
        ...
        if(Level.GRI.bObjectivePlanted)
        {
            ...
            if((Message != "") && bChangeMessgeGameMode)
            {
                switch(iGameObjectIndex)
                {
                    // End:0x3A3
                    case 0:
                        mGameMode[0] = Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.enemy_capture_a", Class'Engine.Material'));
                        // End:0x44B
                        break;
                    // End:0x3F5
                    case 1:
                    ...
                    // End:0x448
                    case 2:
                        mGameMode[0] = Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.enemy_capture_c", Class'Engine.Material'));
                        // End:0x44B
                        break;
                    // End:0xFFFF
                    default:
        ...
        else
        {
            ...
            {
                mGameMode[0] = Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.our_capture_b", Class'Engine.Material'));
                mGameMode[1] = Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.our_capture_a", Class'Engine.Material'));
                bChangeMessgeGameMode = false;
            }
        }
    }
    ...
    if(Message != sMessageGameMode)
    {
        switch(iCode)
        {
            ...
            case Class'Engine.wMessage_Game_Mode'.default.Code_GameMode_SBTGetBomb:
                mGameMode[0] = Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.map_bomb", Class'Engine.Material'));
                // End:0x38F
                break;
            // End:0x251
            case Class'Engine.wMessage_Game_Mode'.default.Code_GameMode_SBT:
                mGameMode[0] = Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.map_bomb_1", Class'Engine.Material'));
                // End:0x38F
                break;
            // End:0x262
...
{
    local CalCoordsW calW;
    local int i, FontSize, iIndex, PresetIndex;
    local Color ShadowColor;
    local string strText, sTemp, sTemp2, sTemp3;
...
defaultproperties
{
    ...
    WHelpBG=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_back_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=2),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=328,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wHelicopter=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=82,X2=1024,Y2=164),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=745,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirke=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=164,X2=512,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=745,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WUAV=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=410,X2=1024,Y2=492),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=745,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WC4=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=912,X2=1024,Y2=994),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=745,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WRPG7=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=512,Y2=82),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=745,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WReadyIncen=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=0,Y1=82,X2=512,Y2=164),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WReadyHellFire=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=0,Y1=164,X2=512,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WReadySpiltGrenade=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=0,Y1=246,X2=512,Y2=328),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WNotReadyIncen=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=82,X2=1024,Y2=164),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WNotReadyHellFire=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=164,X2=1024,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WNotReadySpiltGrenade=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=246,X2=1024,Y2=328),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirkeIcon=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_pac_bom',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.6500000,DrawPivot=0,PosX=0.3475000,PosY=0.6016667,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHelicopterIcon=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_pac_hel',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.6500000,DrawPivot=0,PosX=0.3475000,PosY=0.6016667,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WUAVIcon=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_pac_uav',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.6500000,DrawPivot=0,PosX=0.3475000,PosY=0.6016667,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WC4NotReady=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=164,X2=1024,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirkeNotReady=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=82,X2=512,Y2=164),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHelicopterNotReady=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=0,X2=1024,Y2=82),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WUAVNotReady=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=246,X2=512,Y2=328),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WRPG7NotReady=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=0,X2=1024,Y2=82),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WHelicopterRequireFaild=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=248,X2=1024,Y2=328),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WUAVRequireFaild=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=328,X2=1024,Y2=410),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirkeFocus=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=328,X2=512,Y2=410),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirkeSellect=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=410,X2=512,Y2=492),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ECallSkillState=14
    WRespawnText=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=536,X2=644,Y2=580),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=733,OffsetY=343,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WConnectionInstability=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_dishost',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=128,Y2=128),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=700,OffsetY=465,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WBGStart=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_gmstart',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=128),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=536,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WBGStartDF=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_roundDisplay_bg',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=279),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=289,OffsetY=431,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeTD=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=688,X2=256,Y2=752),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeSD=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=256,Y1=688,X2=512,Y2=752),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeDOMI=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=256,Y1=624,X2=512,Y2=688),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeSB=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=752,X2=256,Y2=816),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeDM=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=624,X2=256,Y2=688),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeFM=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=256,Y1=816,X2=512,Y2=880),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeTM=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=587,Y1=816,X2=819,Y2=891),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameChangeAttack=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=816,X2=256,Y2=880),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameChangePosition=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=256,Y1=752,X2=512,Y2=816),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGo=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_gmstart_go_1',RenderStyle=5,TextureCoords=(X1=1,Y1=20,X2=1024,Y2=237),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=288,OffsetY=491,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    BeginMessageTD="???????????"
    ...
    WRoundResultBG=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_back_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=2),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=454,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WRoundWin=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=624,X2=1024,Y2=720),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=551,OffsetY=337,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WRoundLose=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=720,X2=1024,Y2=816),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=551,OffsetY=337,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamMarkAF=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_01',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=314,Y2=314),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=643,OffsetY=313,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamMarkRSA=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_01',RenderStyle=5,TextureCoords=(X1=314,Y1=0,X2=628,Y2=314),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=643,OffsetY=313,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WCompareSign=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_number',RenderStyle=5,TextureCoords=(X1=65,Y1=72,X2=79,Y2=127),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=786,OffsetY=558,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WCompareSignMid=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_number2',RenderStyle=5,TextureCoords=(X1=330,Y1=0,X2=344,Y2=42),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=786,OffsetY=558,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WTeamImageAF[0]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_af',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageAF[1]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_af',RenderStyle=5,TextureCoords=(X1=0,Y1=256,X2=1024,Y2=502),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=576,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageAF[2]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_af',RenderStyle=5,TextureCoords=(X1=0,Y1=512,X2=1024,Y2=758),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageAF[3]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_af',RenderStyle=5,TextureCoords=(X1=0,Y1=768,X2=1024,Y2=1014),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=576,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageRSA[0]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_rsa',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageRSA[1]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_rsa',RenderStyle=5,TextureCoords=(X1=0,Y1=256,X2=1024,Y2=502),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=576,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageRSA[2]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_rsa',RenderStyle=5,TextureCoords=(X1=0,Y1=512,X2=1024,Y2=758),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageRSA[3]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_rsa',RenderStyle=5,TextureCoords=(X1=0,Y1=768,X2=1024,Y2=1014),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=576,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wBackSeparationTop=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_up',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=40),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=459,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wBackSeparationBottom=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_down',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=40),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=723,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[0]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=80,Y2=80),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[1]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=80,Y1=0,X2=160,Y2=80),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[2]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=160,Y1=0,X2=240,Y2=80),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[3]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=240,Y1=0,X2=320,Y2=80),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[4]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=320,Y1=0,X2=400,Y2=80),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[5]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=400,Y1=0,X2=480,Y2=80),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[6]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=0,Y1=80,X2=80,Y2=160),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[7]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=80,Y1=80,X2=160,Y2=160),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[8]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=160,Y1=80,X2=240,Y2=160),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[9]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=240,Y1=80,X2=320,Y2=160),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[10]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=320,Y1=80,X2=400,Y2=160),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[11]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=400,Y1=80,X2=480,Y2=160),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WHudBG2=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_back_2',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=512,Y2=8),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=121,OffsetY=150,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WTeamScoreBG=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_score',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=486,Y2=40),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=557,OffsetY=5,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WResultTxtAF[0]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_01',RenderStyle=5,TextureCoords=(X1=460,Y1=314,X2=758,Y2=442),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=570,OffsetY=478,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WResultTxtAF[1]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_01',RenderStyle=5,TextureCoords=(X1=460,Y1=442,X2=758,Y2=570),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=570,OffsetY=478,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WResultTxtRSA[0]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_01',RenderStyle=5,TextureCoords=(X1=0,Y1=314,X2=460,Y2=442),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=651,OffsetY=478,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WResultTxtRSA[1]=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_etc_01',RenderStyle=5,TextureCoords=(X1=0,Y1=442,X2=460,Y2=570),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=651,OffsetY=478,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WFFAScoreBG=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_score_0',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=486,Y2=71),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=557,OffsetY=5,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WFFAScoreOverLayer=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_score_0_sel',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=375,Y2=32),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=107,OffsetY=4,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTimerBombBG=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.time_notice',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=240,Y2=106),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=659,OffsetY=74,ScaleMode=4,Scale=0.4000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    matBack1=Texture'Warfare_TH_UI_HUD.Common.img_HUD_back_1'
    matLine=Texture'Warfare_TH_UI_UI.HUD_ETC.list_scor_bord'
    matOn=Texture'Warfare_TH_UI_UI.HUD_ETC.list_result_on'
    Medals[0]=Texture'Warfare_TH_UI_UI.HUD_ETC.img_indimat_1'
    Medals[1]=Texture'Warfare_TH_UI_UI.HUD_ETC.img_indimat_2'
    Medals[2]=Texture'Warfare_TH_UI_UI.HUD_ETC.img_indimat_3'
    RankPostfix="?????"
    W3Kill=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=0,Y1=144,X2=274,Y2=216),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    W5Kill=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=274,Y1=144,X2=548,Y2=216),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    W7Kill=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=548,Y1=144,X2=822,Y2=216),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    W15Kill=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=274,Y1=216,X2=548,Y2=288),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHeadshot=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=548,Y1=72,X2=822,Y2=144),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillTextBg=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text_bg2',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=182,Y2=53),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=720,OffsetY=262,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHudBack3=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.hud_back_3',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=32,Y2=32),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=119,OffsetY=116,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTxtHostChange=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=256,Y1=816,X2=512,Y2=880),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=700,OffsetY=459,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTxtSudenDeath=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=912,X2=256,Y2=976),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wTxtSubSudenDeath=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=339,Y1=880,X2=451,Y2=912),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=744,OffsetY=245,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    lsSudenDeathMessage[0]="Single Mode: ???????????????????????????????????????????"
    lsSudenDeathMessage[1]="Team Exterminate Mode: ????????????????????????????????"
    lsSudenDeathMessage[2]="Explosion Mission: ??????????????????????????????????????????????????????????"
