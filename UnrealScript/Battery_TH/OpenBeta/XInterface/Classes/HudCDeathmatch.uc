...
function DrawHpStamina(Canvas C, optional bool bShowSpectating)
{
    ...
    if(!bShowSpectating)
    {
        X1 = (default.SPIcon.PosX + (float(default.SPIcon.OffsetX) / 1600.0000000)) * C.ClipX;
        Y1 = (default.SPIcon.PosY + (float(default.SPIcon.OffsetY) / 1200.0000000)) * C.ClipY;
        fWidth = 21.0000000 / 1600.0000000;
        fHeight = 17.0000000 / 1200.0000000;
        X2 = X1 + (fWidth * C.ClipX);
        Y2 = Y1 + (fHeight * C.ClipY);
        XL = X2 - X1;
        YL = Y2 - Y1;
        U = float(SPIcon.TextureCoords.X1);
        V = float(SPIcon.TextureCoords.Y1);
        UL = float(SPIcon.TextureCoords.X2 - SPIcon.TextureCoords.X1);
        VL = float(SPIcon.TextureCoords.Y2 - SPIcon.TextureCoords.Y1);
        C.SetPos(X1, Y1);
        C.DrawTile(SPIcon.WidgetTexture, XL, YL, U, V, UL, VL);
        ...
        fWidth = 213.0000000 / 1600.0000000;
        fHeight = 13.0000000 / 1200.0000000;
        X2 = X1 + (fWidth * C.ClipX);
        Y2 = Y1 + (fHeight * C.ClipY);
        XL = X2 - X1;
        YL = Y2 - Y1;
        ...
        fWidth = 209.0000000 / 1600.0000000;
        ...
        StaminaBar.TextureCoords.X2 = int(float(default.StaminaBar.TextureCoords.X2) * fStaminaRatio);
        ...
        {
            nFloorTimeSeconds = int(Level.TimeSeconds);
            fDeltaTimeSeconds = Level.TimeSeconds - float(nFloorTimeSeconds);
            nFloorTimeSeconds = int(fDeltaTimeSeconds / 0.2500000);
            // End:0x103B
            if((nFloorTimeSeconds == 0) || nFloorTimeSeconds == 2)
            {
                C.DrawTile(StaminaBarWarn.WidgetTexture, XL, YL, U, V, UL, VL);                
            }
            else
            {
        ...
        // End:0x10EF
        if((fStaminaRatio < 0.2500000) && fStaminaRatio > 0.0000000)
        {
            PlaySoundRecovery();
        }
        // End:0x111A
...
function DrawSkill_Slot5(Canvas C)
{
    ...
    // End:0x129
    if(bBlinkState && SkillSlot5.WidgetTexture != matEmptySkillSlot)
    {
        C.SetPos(calW.X1, calW.Y1);
...
function DrawSkill_Slot6(Canvas C)
{
    ...
    // End:0x12C
    if((bBlinkState == true) && SkillSlot6.WidgetTexture != matEmptySkillSlot)
    {
        C.SetPos(calW.X1, calW.Y1);
        C.DrawTile(matSkillBlink, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    }
...
function InsertUsingSkillList(int SkillID)
{
    ...
    switch(SkillID)
    {
        ...
        case 40005:
            ...
            skillunit.matIcon = Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_time_c4';
        ...
        case 40012:
            ...
            skillunit.matIcon = Texture'Warfare_UI_Item.SupplySkillicon.icon_wea_RPG7';
        ...
        case 40017:
            ...
            skillunit.matIcon = Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_incen';
        ...
        case 40018:
            ...
            skillunit.matIcon = Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_hellfire';
        ...
        case 40022:
            ...
            skillunit.matIcon = Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_Cluster';
...
function DrawAmmoFlameThrower2(Canvas C, int curr, int Max)
{
    ...
    C.DrawTile(Texture'Warfare_TH_UI_HUD.Common.frame_1', 223.0000000 * _reX, 40.0000000 * _reY, 0.0000000, 0.0000000, 224.0000000, 41.0000000);
    // End:0x75
    if(curr == 0)
    {        
    }
    else
    {
        ...
        C.DrawTile(Texture'Warfare_TH_UI_HUD.Common.frame_fuel', (200.0000000 * ratio) * _reX, 26.0000000 * _reY, 0.0000000, 0.0000000, 201.0000000 * ratio, 27.0000000);
    }
    //return;    
}
...
function DrawHudSpectating(Canvas C)
{
    ...
    SpecPlayerLevel = Max(0, Min(SpecPlayerLevel, Level.GameMgr.75 - 1));
...
function DrawSelfKillMessage(Canvas C)
{
    ...
    if((LastSelfKillMessage.Time != float(0)) && (Level.TimeSeconds - LastSelfKillMessage.Time) < float(3))
    {
        ...
        C.SetDrawColor(byte(255), byte(255), byte(255));
        C.DrawTileStretched(Texture'Warfare_TH_UI_HUD.Common.img_HUD_back_2', 511.0000000 * _reX, 51.0000000 * _reY);
...
function DrawUAV(Canvas C)
{
    ...
    if(myTeamUAV)
    {
        ...
        C.DrawTile(Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.icon_wh_uav", Class'Engine.Material')), UAVIconWidth * _reX, UAVIconHeight * _reY, 0.0000000, 0.0000000, 64.0000000, 64.0000000);
    ...
    if(enemyTeamUAV)
    {
        ...
        C.DrawTile(Material(DynamicLoadObject("Warfare_TH_UI_HUD_ETC.minimapicon.icon_r_uav", Class'Engine.Material')), UAVIconWidth * _reX, UAVIconHeight * _reY, 0.0000000, 0.0000000, 64.0000000, 64.0000000);
...
simulated function DrawMessageScore(Canvas C, int i, float PosX, float PosY, out float dx, out float dy)
{
    ...
    KillWidth = 274;
    KillHeight = 72;
    KillMarkMedalWidth = 300;
    KillMarkMedalHeight = 260;
    ...
    switch(LocalMessages[i].StringMessage)
    {
        ...
        case "FragGrenadeKill":
            DrawScoreEffect(C, WFragGrenadeKill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW);
            bNeedReturn = true;
            // End:0x5E0
            break;
        // End:0x472
        case "MeleeKill":
            DrawScoreEffect(C, WMeleeKill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW);
            bNeedReturn = true;
            // End:0x5E0
            break;
        // End:0x4AF
        case "StepOnKill":
            DrawScoreEffect(C, WStepOnKill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW);
            bNeedReturn = true;
            // End:0x5E0
            break;
        // End:0x4F0
        case "SpecialETCKill":
            DrawScoreEffect(C, WSpecialETCKill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW);
            bNeedReturn = true;
            // End:0x5E0
            break;
        // End:0x52B
        case "Helikill":
            DrawScoreEffect(C, WHelikill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW);
            bNeedReturn = true;
            // End:0x5E0
            break;
        // End:0x56B
        case "Artillerykill":
            DrawScoreEffect(C, WArtillerykill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW);
            bNeedReturn = true;
            // End:0x5E0
            break;
        // End:0x5A6
        case "headshot":
            DrawScoreEffect(C, WHeadshot, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW);
            bNeedReturn = true;
            // End:0x5E0
            break;
        // End:0x5DA
        case "NormalKill":
            DrawScoreEffect(C, WKill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW);
            return;
        // End:0xFFFF
        default:
            // End:0x5E0
    ...
    switch(LocalMessages[i].StringMessage)
    {
        // End:0x6B7
        case "2kill":
            DrawScoreEffect(C, WKillSuccession[0], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x6E9
        case "3kill":
            DrawScoreEffect(C, WKillSuccession[1], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x71C
        case "4kill":
            DrawScoreEffect(C, WKillSuccession[2], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x74F
        case "5kill":
            DrawScoreEffect(C, WKillSuccession[3], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x782
        case "6kill":
            DrawScoreEffect(C, WKillSuccession[4], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x7B5
        case "7kill":
            DrawScoreEffect(C, WKillSuccession[5], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x7E8
        case "8kill":
            DrawScoreEffect(C, WKillSuccession[6], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x81B
        case "9kill":
            DrawScoreEffect(C, WKillSuccession[7], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x84F
        case "10kill":
            DrawScoreEffect(C, WKillSuccession[8], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x883
        case "11kill":
            DrawScoreEffect(C, WKillSuccession[9], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x8B7
        case "12kill":
            DrawScoreEffect(C, WKillSuccession[10], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x8EB
        case "13kill":
            DrawScoreEffect(C, WKillSuccession[11], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x91F
        case "14kill":
            DrawScoreEffect(C, WKillSuccession[12], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x953
        case "15kill":
            DrawScoreEffect(C, WKillSuccession[13], float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x965
        case "Storm Kill":
        ...
        // End:0x996
        case "Assist":
            DrawScoreEffect(C, WAssist, float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x9C8
        case "Capture":
            DrawScoreEffect(C, WCapture, float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0x9FD
        case "BombSetted":
            DrawScoreEffect(C, WBombSetted, float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0xA34
        case "BombDiffused":
            DrawScoreEffect(C, WBombDiffused, float(KillWidth), float(KillHeight), calW);
            // End:0xA46
            break;
        // End:0xA40
        case "Kill":
    ...
    HudPart_DisplayEvent.DrawGainPoint(C, Class'Engine.wMessage_Score'.static.GetGainPoint(LocalMessages[i].Switch), int(dx), 421, int(C.DrawColor.A), MessageScoreEffect, CurrentScale);
...
function ChangeWeaponSlot6Hud(wWeapon newWeapon, optional bool bAddSkill)
{
    local int nWeaponID;
    ...
    if((newWeapon == none) || int(newWeapon.InventoryGroup) != 6)
    {
        ...
        newWeapon = PlayerOwner.GetWeaponByInventoryGroup(6);
        // End:0x60
        if(newWeapon == none)
        {
    ...
    else
    {
        ...
        {
            // End:0x85
            if(SkillSlot6.WidgetTexture != matEmptySkillSlot)
            {
                return;
            }
        }
    ...
    {
        newWeapon = PlayerOwner.GetWeaponByInventoryGroup(6, newWeapon);
        // End:0xC9
        if(newWeapon == none)
        {
            DisalbeWeaponSlot6Hud();
    ...
    EnableWeaponSlot6Hud(nWeaponID);
    //return;    
}

function ChangeWeaponSlot5Hud(wWeapon newWeapon)
{
    // End:0xA1
    if((newWeapon != none) && int(newWeapon.InventoryGroup) == 5)
    {
        ...
        {
            SkillSlot5.WidgetTexture = matSkillAirStrike;            
        }
        else
        {
            // End:0x7C
            ...
            {
                SkillSlot5.WidgetTexture = matSkillHelicopter;                
            }
            else
            {
                SkillSlot5.WidgetTexture = matSkillUAV;
            }
        }
...
function EnableWeaponSlot6Hud(int nWeaponID)
{
    // End:0x22
    if(nWeaponID == 5001)
    {
        SkillSlot6.WidgetTexture = matSkillRPG;        
    }
    else
    {
        // End:0x44
        if(nWeaponID == 5003)
        {
            SkillSlot6.WidgetTexture = matSkillM2B;            
        }
        else
        {
            // End:0x69
            if(ActiveUsingSkill.matIcon != none)
            {
                SkillSlot6.WidgetTexture = ActiveUsingSkill.matIcon;
            }
        }
    }
...
defaultproperties
{
    ...
    outArrow=TexRotator'Warfare_TH_UI_HUD_ETC.DisplayIcon.outArrow_rot_2'
    ...
    HpBarBackground=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.gau_hp_back',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=16,Y2=16),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    HpBar=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.gau_hp',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=167,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    DamageBar=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.gau_hp_mn',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=167,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    RecoveryBar=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.gau_hp_pl',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=167,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    StaminaBarBackground=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.gau_sp_back',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=212,Y2=13),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=41,OffsetY=1174,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    StaminaBar=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.gau_sp',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=209,Y2=9),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=42,OffsetY=1175,ScaleMode=4,Scale=1.0000000,Tints=(R=112,G=157,B=211,A=255),Tints[1]=(R=112,G=157,B=255,A=211))
    StaminaBarWarn=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.gau_sp_use',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=209,Y2=9),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=42,OffsetY=1175,ScaleMode=4,Scale=1.0000000,Tints=(R=112,G=157,B=211,A=255),Tints[1]=(R=112,G=157,B=255,A=211))
    HPIcon=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.hp_icon',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=29,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=55,OffsetY=1150,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    HpGauBlink=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.gau_hpblink',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=167,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    fHPDelayTime=0.5000000
    fHPDisplayRatio=1.0000000
    WDigitsHP=(DigitTexture=Texture'Warfare_TH_UI_HUD.Common.img_number2',TextureCoords=(X1=297,Y1=0,X2=328,Y2=42),TextureCoords[1]=(X1=0,Y1=0,X2=31,Y2=42),TextureCoords[2]=(X1=33,Y1=0,X2=64,Y2=42),TextureCoords[3]=(X1=66,Y1=0,X2=97,Y2=42),TextureCoords[4]=(X1=99,Y1=0,X2=130,Y2=42),TextureCoords[5]=(X1=132,Y1=0,X2=163,Y2=42),TextureCoords[6]=(X1=165,Y1=0,X2=196,Y2=42),TextureCoords[7]=(X1=198,Y1=0,X2=229,Y2=42),TextureCoords[8]=(X1=231,Y1=0,X2=262,Y2=42),TextureCoords[9]=(X1=264,Y1=0,X2=295,Y2=42),TextureCoords[10]=(X1=330,Y1=0,X2=361,Y2=42))
    HPCount=(RenderStyle=5,MinDigitCount=0,TextureScale=0.5000000,DrawPivot=2,PosX=1.0000000,PosY=0.0000000,OffsetX=-1280,OffsetY=1048,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bPadWithZeroes=0)
    SPIcon=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.st_icon',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=21,Y2=17),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=17,OffsetY=1171,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    PostureStand=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_status',RenderStyle=5,TextureCoords=(X1=84,Y1=0,X2=126,Y2=42),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=13,OffsetY=1126,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    PostureCrouch=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_status',RenderStyle=5,TextureCoords=(X1=42,Y1=0,X2=84,Y2=42),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=13,OffsetY=1126,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    PostureDown=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_status',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=42,Y2=42),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=13,OffsetY=1126,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    PostureRun=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_status1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=42,Y2=42),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=13,OffsetY=1126,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    AmmoSet50=(DigitTexture=Texture'Warfare_TH_UI_HUD.Common.ammo_50_set',TextureCoords=(X1=0,Y1=0,X2=0,Y2=0),TextureCoords[1]=(X1=7,Y1=0,X2=12,Y2=25),TextureCoords[2]=(X1=0,Y1=0,X2=5,Y2=25),TextureCoords[3]=(X1=14,Y1=0,X2=19,Y2=25),X2=1594,Y2=1152,XL=5,YL=25,ExtraOffsetX=0)
    AmmoSetSniper=(DigitTexture=Texture'Warfare_TH_UI_HUD.Common.ammo_sr_set',TextureCoords=(X1=0,Y1=0,X2=0,Y2=0),TextureCoords[1]=(X1=11,Y1=0,X2=20,Y2=31),TextureCoords[2]=(X1=0,Y1=0,X2=9,Y2=31),TextureCoords[3]=(X1=22,Y1=0,X2=31,Y2=31),X2=1585,Y2=1155,XL=9,YL=31,ExtraOffsetX=4)
    AmmoSetShotgun=(DigitTexture=Texture'Warfare_TH_UI_HUD.Common.ammo_shotgun_set',TextureCoords=(X1=0,Y1=0,X2=0,Y2=0),TextureCoords[1]=(X1=14,Y1=0,X2=26,Y2=26),TextureCoords[2]=(X1=0,Y1=0,X2=12,Y2=26),TextureCoords[3]=(X1=28,Y1=0,X2=40,Y2=26),X2=1585,Y2=1153,XL=12,YL=26,ExtraOffsetX=2)
    AmmoSetRPG=(DigitTexture=Texture'Warfare_TH_UI_HUD.Common.ammo_rpg7_set',TextureCoords=(X1=0,Y1=0,X2=0,Y2=0),TextureCoords[1]=(X1=169,Y1=0,X2=336,Y2=20),TextureCoords[2]=(X1=0,Y1=0,X2=167,Y2=20),TextureCoords[3]=(X1=338,Y1=0,X2=505,Y2=20),X2=1585,Y2=1149,XL=167,YL=20,ExtraOffsetX=4)
    AmmoSetATR=(DigitTexture=Texture'Warfare_TH_UI_HUD.Common.ammo_atr_set',TextureCoords=(X1=0,Y1=0,X2=0,Y2=0),TextureCoords[1]=(X1=91,Y1=0,X2=180,Y2=18),TextureCoords[2]=(X1=0,Y1=0,X2=89,Y2=18),TextureCoords[3]=(X1=182,Y1=0,X2=271,Y2=18),X2=1584,Y2=1148,XL=89,YL=18,ExtraOffsetX=2)
    ...
    AmmoFlameThrowerCan=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.frame_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=224,Y2=41),TextureScale=0.3950000,DrawPivot=4,PosX=0.9906250,PosY=0.9630000,OffsetX=0,OffsetY=0,ScaleMode=0,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    AmmoFlameThrowerBar=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.frame_fuel',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=201,Y2=27),TextureScale=0.3950000,DrawPivot=4,PosX=0.9887500,PosY=0.9608300,OffsetX=0,OffsetY=0,ScaleMode=0,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    GaugeOverHeat=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.gau_mg',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=32,Y2=5),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=1400,OffsetY=1127,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    TeamDeathSprite=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.our_sol_death',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.6500000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    Crosshair_Left=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.Crosshairs.bagic_left',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=15,Y2=3),TextureScale=0.6500000,DrawPivot=3,PosX=0.5040000,PosY=0.5000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    Crosshair_Right=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.Crosshairs.bagic_right',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=15,Y2=3),TextureScale=0.6500000,DrawPivot=7,PosX=0.4960000,PosY=0.5000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    Crosshair_Up=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.Crosshairs.bagic_up',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=3,Y2=15),TextureScale=0.6500000,DrawPivot=5,PosX=0.5000000,PosY=0.5050000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    Crosshair_Down=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.Crosshairs.bagic_down',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=3,Y2=15),TextureScale=0.6500000,DrawPivot=1,PosX=0.5000000,PosY=0.4950000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    Crosshair_MG=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.Crosshairs.ch_mg',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.6500000,DrawPivot=8,PosX=0.5000000,PosY=0.5000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    Crosshair_DamageDealt=(WidgetTexture=TexOscillator'Warfare_TH_UI_HUD_ETC.Crosshairs.cross_hair_osc',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.6500000,DrawPivot=8,PosX=0.5000000,PosY=0.5000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    PlaceMark=(WidgetTexture=TexOscillator'Warfare_TH_UI_HUD.Common.img_spwp_posi_osc',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=54,Y2=32),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=10,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    lsPlaceM2B="?????"
    lsPlaceMG3="?????"
    lsPlaceRPG7="????"
    lsPlaceATR="????"
    lsPlaceHealthPack="HealthPack"
    lsPlaceHeliPack="HealthPack"
    lsPlaceArtilleryPack="ArtilleryPack"
    lsPlaceUAVPack="UAVPack"
    lsMessageNotice="??????"
    ...
    WKill=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_markmedal',RenderStyle=5,TextureCoords=(X1=300,Y1=520,X2=600,Y2=780),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=650,OffsetY=74,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAssist=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=274,Y2=72),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHelikill=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_markmedal',RenderStyle=5,TextureCoords=(X1=600,Y1=260,X2=900,Y2=520),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=650,OffsetY=74,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WArtillerykill=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_markmedal',RenderStyle=5,TextureCoords=(X1=300,Y1=260,X2=600,Y2=520),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=650,OffsetY=74,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WCapture=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=274,Y1=0,X2=548,Y2=72),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WBombSetted=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=0,Y1=288,X2=274,Y2=360),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WBombDiffused=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=548,Y1=0,X2=822,Y2=72),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WFragGrenadeKill=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_markmedal',RenderStyle=5,TextureCoords=(X1=600,Y1=0,X2=900,Y2=260),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=650,OffsetY=74,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WMeleeKill=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_markmedal',RenderStyle=5,TextureCoords=(X1=300,Y1=0,X2=600,Y2=260),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=650,OffsetY=74,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WStepOnKill=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_markmedal',RenderStyle=5,TextureCoords=(X1=0,Y1=260,X2=300,Y2=520),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=650,OffsetY=74,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WSpecialETCKill=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_markmedal',RenderStyle=5,TextureCoords=(X1=0,Y1=520,X2=300,Y2=780),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=650,OffsetY=74,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[0]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=274,Y1=288,X2=548,Y2=360),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[1]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=548,Y1=288,X2=822,Y2=360),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[2]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=0,Y1=360,X2=274,Y2=432),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[3]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=274,Y1=360,X2=548,Y2=432),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[4]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=548,Y1=360,X2=822,Y2=432),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[5]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=0,Y1=432,X2=274,Y2=504),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[6]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=274,Y1=432,X2=548,Y2=504),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[7]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=548,Y1=432,X2=822,Y2=504),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[8]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=0,Y1=504,X2=274,Y2=576),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[9]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=274,Y1=504,X2=548,Y2=576),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[10]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=548,Y1=504,X2=822,Y2=576),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[11]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=0,Y1=576,X2=274,Y2=648),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[12]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=274,Y1=576,X2=548,Y2=648),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillSuccession[13]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=548,Y1=576,X2=822,Y2=648),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=473,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHeadshot=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_markmedal',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=300,Y2=260),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=650,OffsetY=74,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillBlood=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_blood01',RenderStyle=5,TextureCoords=(X1=67,Y1=111,X2=453,Y2=421),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=606,OffsetY=186,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillBlood_Teen=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_kill_blood01_T',RenderStyle=5,TextureCoords=(X1=67,Y1=111,X2=453,Y2=421),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=606,OffsetY=186,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WWarningMark=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_bombing_warningmark',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=450,Y2=169),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=575,OffsetY=280,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStrikeMark=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.bombing_location',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=126),TextureScale=0.5000000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=-53,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
