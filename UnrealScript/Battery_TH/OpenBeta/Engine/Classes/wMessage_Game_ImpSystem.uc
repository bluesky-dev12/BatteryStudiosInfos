...
defaultproperties
{
    ...
    strGameMode_TD="Team Exterminate Mode"
    strGameMode_FFA="Single Mode"
    strGameMode_DOM="Capture Mode"
    strGameMode_SD="Explosion Mission"
    strGameMode_SBT="Explosion Exterminate"
    strNoWeapon="???????????????"
