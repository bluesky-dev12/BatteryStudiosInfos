...
simulated event PreBeginPlay()
{
    ...
    super.PreBeginPlay();
    ObjectPool = new (XLevel) Class'Engine_Decompressed.ObjectPool';
...
defaultproperties
{
    ...
    DefaultTexture=Texture'Engine_Decompressed.DefaultTexture'
    WireframeTexture=Texture'Engine_Decompressed.WhiteSquareTexture'
    WhiteSquareTexture=Texture'Engine_Decompressed.WhiteSquareTexture'
    LargeVertex=Texture'Engine_Decompressed.LargeVertex'
