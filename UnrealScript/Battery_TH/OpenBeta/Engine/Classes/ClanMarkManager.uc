...
function Init(wGameManager gm)
{
    ...
    ex_clanmark_01 = Class'Engine_Decompressed.BTCustomDrawHK'.static.MakeImage(32, 32, 28, Material(DynamicLoadObject("Warfare_UI_Clan.Clan_Mark.ex_clanmark_01", Class'Engine_Decompressed.Material')));
    ex_clanmark_02 = Class'Engine_Decompressed.BTCustomDrawHK'.static.MakeImage(32, 32, 28, Material(DynamicLoadObject("Warfare_UI_Clan.Clan_Mark.ex_clanmark_02", Class'Engine_Decompressed.Material')));
    //return;    
}
