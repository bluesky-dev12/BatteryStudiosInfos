...
simulated function bool SwitchWeapon(byte f, optional bool bQuickGr)
{
    ...
    if(int(newWeapon.WeaponType) == int(15))
    {
        ...
        {
            PlayerController(Controller).myHUD.CallSkill(5, true, false);
            return true;
        }        
    }
    else
...
function ServerChangedWeapon(wWeapon OldWeapon, wWeapon newWeapon)
{
    ...
    if(Weapon != none)
    {
        ...
        PlayerController(Controller).ClientChangeSlot6(Weapon);
    }
    // End:0x2C9
    if(Inventory != none)
    {
...
function Died(Controller Killer, Class<DamageType> DamageType, Vector HitLocation, optional int CollisionPart, optional int WeaponType)
{
    ...
    if((Weapon != none) && (DrivenVehicle == none) || DrivenVehicle.bAllowWeaponToss)
    {
        ...
        bSkillWeapon = false;
        // End:0x30A
        if(int(Weapon.InventoryGroup) == 6)
        {
...
function AddWeaponFromSkill(BtrDouble iUniqueID, int iWeaponID)
{
    ...
    {
        PlayerController(Controller).ClientChangeSlot5(W);        
    }
    else
    {
        // End:0x105
        ...
        {
            PlayerController(Controller).ClientChangeSlot6(W, true);
        }
    }
    //return;    
}
