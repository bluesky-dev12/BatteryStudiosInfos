...
var array<wDefenceGameParam> DefenceGameParams;
...
function AddEventTimerHMS(int EventType, int Hour, int Min, int sec, optional DelegateEventTimer EventDelegate, optional int msec)
{
    ...
    local BtrTime CurTime, PlusTime, PlusTime2;
    local int Day;
...
{
    local int idx, imgX, imgY, tempLevelImageCount;
    ...
    idx = Level / 64;
    imgX = int(float(Level) % float(64)) - 1;
    imgY = imgX / 16;
    imgX = int(float(imgX) % float(16));
...
function LoadUILists()
{
    ...
    if(lp1 < ItemParams.Length)
    {
        ...
        if((cItemParam.iItemID != -1) && cItemResParam.iItemResourceID != -1)
        {
            ...
            // End:0x34E
            if(cItemParam.strAddPartGroupID == "")
            {
            ...
            else
            {
                ...
                // End:0xAC8 [Loop If]
                if(i < AddPartsGroupParams.Length)
                {
                    // End:0xABE
                    if(AddPartsGroupParams[i].strPartsGroupID == itemBox.PartGroupID)
                    {
                        pgp = AddPartsGroupParams[i];
                        itemBox.PartGroupList.Length = pgcount + 1;
                        itemBox.PartGroupList[pgcount].PartID = pgp.iAddPartID;
                        itemBox.PartGroupList[pgcount].Name = pgp.strName;
                        itemBox.PartGroupList[pgcount].Description = pgp.strDescription;
                        itemBox.PartGroupList[pgcount].PointPrice = pgp.iPointPrice;
                        itemBox.PartGroupList[pgcount].CashPrice = pgp.iCashPrice;
                        // End:0x500
                        if(pgp.strResource_UI_Icon != "-")
                        {
                            itemBox.PartGroupList[pgcount].UI_Image = Texture(DynamicLoadObject(pgp.strResource_UI_Icon, Class'Engine_Decompressed.Texture'));
                        }
                        itemBox.PartGroupList[pgcount].UI_DamageRange = pgp.ui_damage_range;
                        itemBox.PartGroupList[pgcount].ui_firesound = pgp.ui_firesound;
                        itemBox.PartGroupList[pgcount].UI_Zoom1 = pgp.ui_zoom_1;
                        itemBox.PartGroupList[pgcount].UI_Zoom2 = pgp.ui_zoom_2;
                        itemBox.PartGroupList[pgcount].UI_Durability = pgp.UI_Durability;
                        itemBox.PartGroupList[pgcount].display_3d_x = pgp.display_3d_x;
                        itemBox.PartGroupList[pgcount].display_3d_y = pgp.display_3d_y;
                        itemBox.PartGroupList[pgcount].display_3d_z = pgp.display_3d_z;
                        itemBox.PartGroupList[pgcount].display_3d_rot_y = pgp.display_3d_rot_y;
                        itemBox.PartGroupList[pgcount].Bootyitem_3d_x = pgp.Bootyitem_3d_x;
                        itemBox.PartGroupList[pgcount].Bootyitem_3d_y = pgp.Bootyitem_3d_y;
                        itemBox.PartGroupList[pgcount].Bootyitem_3d_z = pgp.Bootyitem_3d_z;
                        itemBox.PartGroupList[pgcount].Bootyitem_3d_rot_y = pgp.Bootyitem_3d_rot_y;
                        itemBox.PartGroupList[pgcount].SightID = pgp.iSightID;
                        // End:0x7B7
                        if(itemBox.PartGroupList[pgcount].SightID != 0)
                        {
                            cPartResParam = GetItemResourceParam(pgp.iSightID);
                            // End:0x7B7
                            if(cPartResParam.strRes_Icon != "-")
                            {
                                itemBox.PartGroupList[pgcount].SightImage = Texture(DynamicLoadObject(cPartResParam.strRes_Icon, Class'Engine_Decompressed.Texture'));
                            }
                        }
                        itemBox.PartGroupList[pgcount].SilencerID = pgp.iSilencerID;
                        // End:0x866
                        if(itemBox.PartGroupList[pgcount].SilencerID != 0)
                        {
                            cPartResParam = GetItemResourceParam(pgp.iSilencerID);
                            // End:0x866
                            if(cPartResParam.strRes_Icon != "-")
                            {
                                itemBox.PartGroupList[pgcount].SilencerImage = Texture(DynamicLoadObject(cPartResParam.strRes_Icon, Class'Engine_Decompressed.Texture'));
                            }
                        }
                        itemBox.PartGroupList[pgcount].CamoID = pgp.iCamoID;
                        // End:0x915
                        if(itemBox.PartGroupList[pgcount].CamoID != 0)
                        {
                            cPartResParam = GetItemResourceParam(pgp.iCamoID);
                            // End:0x915
                            if(cPartResParam.strRes_Icon != "-")
                            {
                                itemBox.PartGroupList[pgcount].CamoImage = Texture(DynamicLoadObject(cPartResParam.strRes_Icon, Class'Engine_Decompressed.Texture'));
                            }
                        }
                        itemBox.PartGroupList[pgcount].PaintingID = pgp.iPaintingID;
                        // End:0x9C4
                        if(itemBox.PartGroupList[pgcount].PaintingID != 0)
                        {
                            cPartResParam = GetItemResourceParam(pgp.iPaintingID);
                            // End:0x9C4
                            if(cPartResParam.strRes_Icon != "-")
                            {
                                itemBox.PartGroupList[pgcount].PaintingImage = Texture(DynamicLoadObject(cPartResParam.strRes_Icon, Class'Engine_Decompressed.Texture'));
                            }
                        }
                        itemBox.PartGroupList[pgcount].SkillID = pgp.iSkillID;
                        // End:0xAB7
                        if(itemBox.PartGroupList[pgcount].SkillID != 0)
                        {
                            cPartResParam = GetItemResourceParam(pgp.iSkillID);
                            itemBox.PartGroupList[pgcount].SkillImage = Texture(DynamicLoadObject("Warfare_TH_UI_UI.Store.icon_rem_skil", Class'Engine_Decompressed.Texture'));
                            cSkillParam = GetSkillParam(pgp.iSkillID);
                            itemBox.PartGroupList[pgcount].SkillName = cSkillParam.strName;
                        }
                        pgcount++;
                    }
                    i++;
            ...
            // End:0xB46
            if((((itemBox.Grade > 1) && itemBox.Grade != 7) && itemBox.Grade != 8) || cItemParam.strPaintingGroupID == "")
            {
            ...
            // End:0x126E
            if(int(cItemParam.eType) == int(22))
            {
                itemBox.bSkill = true;
                i = 0;
                J0x1202:
...
function LoadNPCSpawn()
{
    ...
    if(NPCSpawnParams.Length == 0)
    {
        ...
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params_TH.xlsx", "NPC_Spon", 2, 1, 1);
        // End:0x77
        if(!bResult)
        {
            return;
...
function LoadNPC()
{
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params_TH.xlsx", "NPC", 2, 1, 1);
        // End:0x72
        if(!bResult)
        {
            return;
...
function LoadNPCNameGroup()
{
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params_TH.xlsx", "Name_Group", 2, 1, 1);
        // End:0x79
        if(!bResult)
        {
            return;
...
function LoadNPCItemGroup()
{
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params_TH.xlsx", "Item_Group", 2, 1, 1);
        // End:0x79
        if(!bResult)
        {
            return;
...
function LoadNPCActionGroup()
{
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params_TH.xlsx", "Action_Group", 2, 1, 1);
        // End:0x7B
        if(!bResult)
        {
            return;
...
function LoadDefenceGameInfo()
{
    local BTNetExcelData excel;
    local bool bResult;
    local int iIndex, MapID;
    local wDefenceGameParam Param;

    // End:0x233
    if(DefenceGameParams.Length == 0)
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params.xlsx", "Mode_Defence", 2, 1, 1);
        // End:0x78
        if(!bResult)
        {
            return;
        ...
        if(true)
        {
            ...
            Param.MapID = MapID;
            Param.Round = int(excel.getData("Mode_Defence", "round", iIndex));
            Param.DelayTime = int(excel.getData("Mode_Defence", "delay_time", iIndex));
            Param.RegenLoc = int(excel.getData("Mode_Defence", "regen_loc", iIndex));
            Param.Grade = int(excel.getData("Mode_Defence", "npc_spon", iIndex));
            Param.Unit = int(excel.getData("Mode_Defence", "unit", iIndex));
            DefenceGameParams[DefenceGameParams.Length] = Param;
            ++iIndex;
            // [Loop Continue]
            goto J0x7F;
        }
...
function GetDefenceGamePrams(int MapID, int Round, out array<int> DelayTime, out array<int> RegenLoc, out array<int> Grade, out array<int> Unit)
{
    local int i;
    ...
    // End:0xE3 [Loop If]
    if(i < DefenceGameParams.Length)
    {
        // End:0xD9
        if((DefenceGameParams[i].MapID == MapID) && DefenceGameParams[i].Round == Round)
        {
            DelayTime[DelayTime.Length] = DefenceGameParams[i].DelayTime;
            RegenLoc[RegenLoc.Length] = DefenceGameParams[i].RegenLoc;
            Grade[Grade.Length] = DefenceGameParams[i].Grade;
            Unit[Unit.Length] = DefenceGameParams[i].Unit;
        }
        ++i;
        // [Loop Continue]
        goto J0x07;
...
function GetDefenceGameBotGradeList(int MapID, int Round, out array<int> GradeList)
{
    local int i, j;
    local bool bFind;
    ...
    if(i < DefenceGameParams.Length)
    {
        ...
        if((DefenceGameParams[i].MapID == MapID) && DefenceGameParams[i].Round == Round)
        {
            ...
            {
                // End:0xA3
                if(DefenceGameParams[i].Grade == GradeList[j])
                {
                    bFind = true;
                    // [Explicit Break]
                    goto J0xAD;
            ...
            if(bFind == false)
            {
                GradeList[GradeList.Length] = DefenceGameParams[i].Grade;
            }
        }
        ++i;
        // [Loop Continue]
...
function int GetDefenceGameRoundCount(int MapID)
{
    ...
    {
        // End:0x56
        if(DefenceGameParams[i].MapID == MapID)
        {
            RoundNum = Max(DefenceGameParams[i].Round, RoundNum);
        }
        ++i;
        // [Loop Continue]
        goto J0x07;
...
function LoadBadwords()
{
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params_TH.xlsx", "BadWords", 2, 1, 1);
        // End:0x77
        if(!bResult)
        {
            return;
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params_TH.xlsx", "BadNicks", 2, 1, 1);
        // End:0x156
        if(!bResult)
        {
            return;
...
function Material GetPartsGroupPainting(int iItemID, int iPartsID, optional bool bThird, optional int iPainting_Item_ID)
{
    ...
    PartsParam = GetAddPartsGroupParam(iPartsID);
    // End:0x64
    if(((PartsParam == none) || PartsParam.iAddPartID <= 0) || (PartsParam.iPaintingID <= 0) && iPainting_Item_ID <= 0)
    {
        return none;
    }
    // End:0x1DB
    if(bThird == false)
    {
        ...
        if(iPainting_Item_ID > 0)
        {
            ...
            PartsParam.matWeapon_1st = Material(DynamicLoadObject(strName, Class'Engine_Decompressed.Material'));            
        }
        else
        {
            // End:0x1C9
            ...
            {
                resParam = GetItemResourceParam(PartsParam.iPaintingID);
                // End:0x18A
                if((resParam == none) || resParam.iItemResourceID <= 0)
                {
                    return none;
        ...
        return PartsParam.matWeapon_1st;        
    }
    else
    {
        resParam = GetItemResourceParam(iItemID);
        ...
        if(iPainting_Item_ID > 0)
        {
            ...
            strName = strName $ resParam.strRes_3rd_AF_Backpack;
            PartsParam.matWeapon_3rd = Material(DynamicLoadObject(strName, Class'Engine_Decompressed.Material'));            
        }
        else
        {
            strName = resParam.strRes_3rd_AF_Gore;
        ...
        return PartsParam.matWeapon_3rd;
    }
    return none;
    //return;    
}
...
function wMapInfo GetMapInfo(int MapID)
{
    local int i;
    ...
    // End:0x4B [Loop If]
    if(i < MapInfos.Length)
    {
        // End:0x41
        if(MapInfos[i].MapID == MapID)
        {
            return MapInfos[i];
        }
        i++;
...
function wMapInfo GetMapInfoFromFileName(string dfile)
{
    local int idx, lp1;
    local wMapInfo Info;
    ...
    // End:0x58 [Loop If]
    if(lp1 < MapInfos.Length)
    {
        // End:0x4E
        if(MapInfos[lp1].File ~= dfile)
        {
            idx = lp1;
            // [Explicit Break]
            goto J0x58;
    ...
    if(idx == -1)
    {
        MapInfos[0].CopyTo(Info);
        Info.File = dfile;
        Info.FriendlyName = dfile;        
    }
    else
    {
        MapInfos[idx].CopyTo(Info);
    }
    return Info;
    //return;    
}
...
defaultproperties
{
    ...
    LevelExps[1]=3450
    LevelExps[2]=5900
    LevelImages[0]="Warfare_TH_UI_UI.Lv_Mark.Lv_Mark_1"
    LevelImages[1]="Warfare_TH_UI_UI.Lv_Mark.Lv_Mark_2"
    ClanLevelImages[0]="none"
    ClanLevelImages[1]="Warfare_TH_UI_UI.Common.icon_cl_f5"
    ClanLevelImages[2]="Warfare_TH_UI_UI.Common.icon_cl_f4"
    ClanLevelImages[3]="Warfare_TH_UI_UI.Common.icon_cl_f3"
    ClanLevelImages[4]="Warfare_TH_UI_UI.Common.icon_cl_f2"
    ClanLevelImages[5]="Warfare_TH_UI_UI.Common.icon_cl_f1"
    ClanLevelImages[6]="Warfare_TH_UI_UI.Common.icon_cl_e5"
    ClanLevelImages[7]="Warfare_TH_UI_UI.Common.icon_cl_e4"
    ClanLevelImages[8]="Warfare_TH_UI_UI.Common.icon_cl_e3"
    ClanLevelImages[9]="Warfare_TH_UI_UI.Common.icon_cl_e2"
    ClanLevelImages[10]="Warfare_TH_UI_UI.Common.icon_cl_e1"
    ClanLevelImages[11]="Warfare_TH_UI_UI.Common.icon_cl_d5"
    ClanLevelImages[12]="Warfare_TH_UI_UI.Common.icon_cl_d4"
    ClanLevelImages[13]="Warfare_TH_UI_UI.Common.icon_cl_d3"
    ClanLevelImages[14]="Warfare_TH_UI_UI.Common.icon_cl_d2"
    ClanLevelImages[15]="Warfare_TH_UI_UI.Common.icon_cl_d1"
    ClanLevelImages[16]="Warfare_TH_UI_UI.Common.icon_cl_c5"
    ClanLevelImages[17]="Warfare_TH_UI_UI.Common.icon_cl_c4"
    ClanLevelImages[18]="Warfare_TH_UI_UI.Common.icon_cl_c3"
    ClanLevelImages[19]="Warfare_TH_UI_UI.Common.icon_cl_c2"
    ClanLevelImages[20]="Warfare_TH_UI_UI.Common.icon_cl_c1"
    ClanLevelImages[21]="Warfare_TH_UI_UI.Common.icon_cl_b5"
    ClanLevelImages[22]="Warfare_TH_UI_UI.Common.icon_cl_b4"
    ClanLevelImages[23]="Warfare_TH_UI_UI.Common.icon_cl_b3"
    ClanLevelImages[24]="Warfare_TH_UI_UI.Common.icon_cl_b2"
    ClanLevelImages[25]="Warfare_TH_UI_UI.Common.icon_cl_b1"
    ClanLevelImages[26]="Warfare_TH_UI_UI.Common.icon_cl_a5"
    ClanLevelImages[27]="Warfare_TH_UI_UI.Common.icon_cl_a4"
    ClanLevelImages[28]="Warfare_TH_UI_UI.Common.icon_cl_a3"
    ClanLevelImages[29]="Warfare_TH_UI_UI.Common.icon_cl_a2"
    ClanLevelImages[30]="Warfare_TH_UI_UI.Common.icon_cl_a1"
