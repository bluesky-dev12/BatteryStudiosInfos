...
static function array<GameModeInfo> GetAllGameModesAtServiceBuild()
{
    ...
    modeTeamGame.ModeIndex = Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_TeamDeath();
    ...
    ModeDomination.ModeIndex = Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_Domination();
    ...
    modeDeathMatch.ModeIndex = Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_DeathMatch();
...
defaultproperties
{
    TeamGame_UserFriendlyName="TeamDeath"
    ...
    Domination_UserFriendlyName="Capture Mode"
    ...
    SBT_ScoreDefault="2"
    COL_UserFriendlyName="Collection"
    COL_ModeDescription="????????"
    COL_TimeLimits[0]="5"
    COL_TimeLimits[1]="7"
    COL_TimeLimits[2]="10"
    ...
    Deathmatch_UserFriendlyName="Single Mode"
    ...
    TeamGameAI_UserFriendlyName="AI Team"
    DominationAI_UserFriendlyName="AI Capture"
    DeathMatchAI_UserFriendlyName="AI Single"
    ...
    Defence_TimeLimits[0]="0"
    Defence_Scores[0]="50"
    Defence_Scores_DefaultTimeLimits[0]="10"
