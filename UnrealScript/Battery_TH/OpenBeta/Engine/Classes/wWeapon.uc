...
simulated function ClientWeaponSet(bool bPossiblySwitch)
{
    ...
    // End:0x316
    if((bPickupChange == true) && ((BaseParams.iInventoryGroup == 1) || BaseParams.iInventoryGroup == 2) || BaseParams.iInventoryGroup == 6)
    {
...
simulated function SetBaseParams(wWeaponBaseParams wBase)
{
    ...
    else
    {
        ...
        if(BaseParams.wt_BoundingMax > float(0))
        {
            ...
            i = int(BaseParams.wt_BoundingMax);
            J0x259:
        ...
        if(BaseParams.wtAim_BoundingMax > float(0))
        {
            ...
            i = int(BaseParams.wtAim_BoundingMax);
            J0x3B6:
            ...
            if(i < 60)
            {
                wtAim_x[i] = 0.0000000;
                wtAim_y[i] = 0.0000000;
                wtAim_RandomWeight[i] = 0.0000000;
                i++;
                // [Loop Continue]
                goto J0x3B6;
            }
