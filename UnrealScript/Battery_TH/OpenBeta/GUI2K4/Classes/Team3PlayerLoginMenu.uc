...
defaultproperties
{
    Panels[0]=(ClassName="GUI2K4.Team3Tab_PlayerLoginControls",Caption="Game",Hint="Game Controls")
    SPRulesPanel=(ClassName="GUI2K4.UT2K4Tab_ServerInfo",Caption="Rules",Hint="Game settings")
    // Reference: GUITabControl'GUI2K4_Decompressed.Team3PlayerLoginMenu.LoginMenuTC'
    begin object name="LoginMenuTC" class=XInterface.GUITabControl
        bFillSpace=true
        bDockPanels=true
        TabHeight=30.0000000
        BackgroundStyleName="TabBackground"
        WinTop=45.0000000
        WinLeft=8.0000000
        WinWidth=800.0000000
    ...
    bMoveAllowed=false
    DefaultLeft=104.0000000
    DefaultTop=38.0000000
    DefaultWidth=816.0000000
    DefaultHeight=652.0000000
    bRequire640x480=true
    bPersistent=true
    bAllowedAsLast=true
    OnClose=Team3PlayerLoginMenu.InternalOnClose
    WinTop=38.0000000
    WinLeft=104.0000000
    WinWidth=816.0000000
    WinHeight=652.0000000
}