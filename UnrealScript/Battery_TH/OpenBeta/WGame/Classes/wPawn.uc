...
event PlayLandedSound(int SurfType)
{
    ...
    {
        PlayOwnedSound(SoundGroupClass.static.GetLanedSound(SurfType, IsLocalPlayerViewtarget()), 0, FMin(1.0000000, (-0.6000000 * Velocity.Z) / JumpZ),, 95.0000000);
    }
    //return;    
}
...
simulated function FootStepping(int side)
{
    ...
    {
        PlaySound(SoundFootsteps_3rd[SurfaceNum], 0, FootstepVolume,, 105.0000000,, true,,, false);
    }
    //return;    
}
