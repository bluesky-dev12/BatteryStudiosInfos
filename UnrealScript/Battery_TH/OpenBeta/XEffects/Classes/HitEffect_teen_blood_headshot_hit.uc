...
defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_teen_blood_headshot_hit.SpriteEmitter121'
    begin object name="SpriteEmitter121" class=Engine.SpriteEmitter
        ...
        DrawStyle=1
        Texture=Texture'FX_TEX.Hit_blood.hit_effect_china_01'
        TextureUSubdivisions=4
        TextureVSubdivisions=4
        LifetimeRange=(Min=0.6901410,Max=0.6901410)
    end object
    Emitters[0]=SpriteEmitter121
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_teen_blood_headshot_hit.SpriteEmitter122'
    begin object name="SpriteEmitter122" class=Engine.SpriteEmitter
        ...
        DrawStyle=1
        Texture=Texture'FX_TEX.Hit_blood.hit_effect_china_04'
        TextureUSubdivisions=4
        TextureVSubdivisions=4
    ...
    Emitters[1]=SpriteEmitter122
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_teen_blood_headshot_hit.SpriteEmitter123'
    ...
    Emitters[2]=SpriteEmitter123
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_teen_blood_headshot_hit.SpriteEmitter0'
    begin object name="SpriteEmitter0" class=Engine.SpriteEmitter
        ...
        DrawStyle=1
        Texture=Texture'FX_TEX.Hit_blood.hit_effect_china_03'
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_teen_blood_headshot_hit.SpriteEmitter4'
    begin object name="SpriteEmitter4" class=Engine.SpriteEmitter
        ...
        MaxParticles=2
        StartLocationShape=1
        SpinsPerSecondRange=(X=(Min=-0.7356960,Max=0.7356960),Y=(Min=0.0000000,Max=0.0000000),Z=(Min=0.0000000,Max=0.0000000))
        StartSpinRange=(X=(Min=-0.1000000,Max=0.1000000),Y=(Min=0.0000000,Max=0.0000000),Z=(Min=0.0000000,Max=0.0000000))
        SizeScale=/* Array type was not detected. */
        ...
        LifetimeRange=(Min=0.1890590,Max=0.1890590)
        InitialDelayRange=(Min=0.2000000,Max=0.2000000)
    end object
    Emitters[4]=SpriteEmitter4
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_teen_blood_headshot_hit.SpriteEmitter5'
