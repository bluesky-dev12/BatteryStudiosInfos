class SR_MuzFlash_smoke_3RD extends EmitterThirdPerson;

defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.SR_MuzFlash_smoke_3RD.SpriteEmitter6'
    begin object name="SpriteEmitter6" class=Engine.SpriteEmitter
        ...
        Acceleration=(X=377.0000000,Y=0.0000000,Z=0.0000000)
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.SR_MuzFlash_smoke_3RD.SpriteEmitter7'
    begin object name="SpriteEmitter7" class=Engine.SpriteEmitter
        ...
        AutomaticInitialSpawning=false
        UseRandomSubdivision=true
        Acceleration=(X=351.0000000,Y=0.0000000,Z=0.0000000)
        ColorScale=/* Array type was not detected. */
        Opacity=0.3000000
        FadeOutStartTime=0.2015000
        FadeInEndTime=0.0130000
        ...
        TextureVSubdivisions=2
        LifetimeRange=(Min=0.6500000,Max=0.6500000)
        InitialDelayRange=(Min=0.1200000,Max=0.1200000)
        StartVelocityRange=(X=(Min=325.0000000,Max=325.0000000),Y=(Min=0.0000000,Max=0.0000000),Z=(Min=0.0000000,Max=0.0000000))
    end object
    Emitters[1]=SpriteEmitter7
    // Reference: SpriteEmitter'XEffects_Decompressed.SR_MuzFlash_smoke_3RD.SpriteEmitter8'
