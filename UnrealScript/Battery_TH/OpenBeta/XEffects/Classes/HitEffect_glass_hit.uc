...
defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_glass_hit.SpriteEmitter162'
    begin object name="SpriteEmitter162" class=Engine.SpriteEmitter
        FadeOut=true
    ...
    Emitters[0]=SpriteEmitter162
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_glass_hit.SpriteEmitter163'
    begin object name="SpriteEmitter163" class=Engine.SpriteEmitter
        ...
        UniformSize=true
        AutomaticInitialSpawning=false
        Acceleration=(X=322.1457520,Y=112.5867615,Z=127.5996170)
        ColorScale=/* Array type was not detected. */
        Opacity=0.1000000
        ...
        StartVelocityRange=(X=(Min=-71.2140045,Max=71.2140045),Y=(Min=-138.9960022,Max=138.9960022),Z=(Min=-46.3320007,Max=46.3320007))
        StartVelocityRadialRange=(Min=3.0000000,Max=3.0000000)
        GetVelocityDirectionFrom=3
    end object
    Emitters[1]=SpriteEmitter163
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_glass_hit.SpriteEmitter164'
    begin object name="SpriteEmitter164" class=Engine.SpriteEmitter
        ...
        StartSizeRange=(X=(Min=3.0000000,Max=13.0000000),Y=(Min=3.0000000,Max=13.0000000),Z=(Min=3.0000000,Max=13.0000000))
    ...
    Emitters[2]=SpriteEmitter164
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_glass_hit.SpriteEmitter166'
