class Pistol_MuzFlash_01_3rd extends wEmitter;
...
defaultproperties
{
    ...
    mRandTextures=true
    mNumTileRows=4
    mMeshNodes=StaticMesh'Warfare_Staticmeshes.Weapon_Effects.AR_Muzzleflash_01_3rd'
    DrawScale=0.6000000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes.PB_Muzzleflash_01_3rd'
    Style=6
}