class Pistol_MuzFlash_01_1rd extends wEmitter;
...
defaultproperties
{
    ...
    mRandTextures=true
    mNumTileRows=2
    mMeshNodes=StaticMesh'Warfare_Staticmeshes.Weapon_Effects.AR_Muzzleflash_01_1rd'
    DrawScale=1.1000000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes.PB_Muzzleflash_01_1rd'
    Style=6
}