...
var string FmodSound_Putdown_Plant;
var string FmodSound_Putdown_Defuse;
...
simulated function bool PutDown()
{
    ...
    if(bPlayedPutdownSound == false)
    {
        ...
        if(bPlant)
        {
            ServerFmodPlayOwnedSound(FmodSound_Putdown_Plant, 3, FireMode[0].FireAnimRate,, false, false, -1, !Instigator == Owner.Level.GetLocalPlayerController().ViewTarget);            
        }
        else
        {
            ServerFmodPlayOwnedSound(FmodSound_Putdown_Defuse, 3, FireMode[0].FireAnimRate,, false, false, -1, !Instigator == Owner.Level.GetLocalPlayerController().ViewTarget);
        }
...
defaultproperties
{
    ...
    FmodSound_Putdown_Plant="Warfare_Sound_Weapon/ETC/DemolitionPack/demolition_plant_d"
    FmodSound_Putdown_Defuse="Warfare_Sound_Weapon/ETC/DemolitionPack/demolition_defuse_d"
