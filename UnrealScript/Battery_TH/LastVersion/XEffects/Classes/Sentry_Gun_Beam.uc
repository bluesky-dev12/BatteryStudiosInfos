...
defaultproperties
{
    ...
    begin object name="SpriteEmitter0" class=Engine.SpriteEmitter
        ...
        CoordinateSystem=1
        MaxParticles=2
        StartLocationOffset=(X=2.0000000,Y=0.0000000,Z=0.0000000)
    ...
    begin object name="BeamEmitter0" class=Engine.BeamEmitter
        ...
        CoordinateSystem=1
        MaxParticles=1
        StartSizeRange=(X=(Min=3.0000000,Max=3.0000000),Y=(Min=3.0000000,Max=3.0000000),Z=(Min=3.0000000,Max=3.0000000))
        Texture=Texture'FX_TEX.Flares.Sentry_Gun_Beam_01'
        LifetimeRange=(Min=0.0010000,Max=0.0010000)
        StartVelocityRange=(X=(Min=7.5000000,Max=7.5000000),Y=(Min=0.0000000,Max=0.0000000),Z=(Min=0.0000000,Max=0.0000000))
    end object
