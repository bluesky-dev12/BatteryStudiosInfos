class Alien_Nemesis_ball_fire extends Emitter;

defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.Alien_Nemesis_ball_fire.SpriteEmitter4'
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.Alien_Nemesis_ball_fire.SpriteEmitter187'
    begin object name="SpriteEmitter187" class=Engine.SpriteEmitter
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
        SpinParticles=true
    ...
    Emitters[1]=SpriteEmitter187
    // Reference: SpriteEmitter'XEffects_Decompressed.Alien_Nemesis_ball_fire.SpriteEmitter190'
