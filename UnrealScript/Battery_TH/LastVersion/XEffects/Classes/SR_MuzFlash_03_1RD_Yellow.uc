class SR_MuzFlash_03_1RD_Yellow extends wEmitter;
...
defaultproperties
{
    ...
    mStartParticles=0
    mMaxParticles=1
    mLifeRange[0]=0.0500000
    mLifeRange[1]=0.0800000
    ...
    mNumTileColumns=4
    mNumTileRows=4
    mMeshNodes=StaticMesh'FX_StaticMesh.MuzzleFlash.Muzzleflash_03_1rd'
    DrawScale=1.5000000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes_color.FB_Muzzleflash_03_1rd_Yellow'
    Style=6
}