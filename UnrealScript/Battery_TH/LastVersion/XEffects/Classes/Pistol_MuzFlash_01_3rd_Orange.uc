class Pistol_MuzFlash_01_3rd_Orange extends wEmitter;
...
defaultproperties
{
    ...
    mRandTextures=true
    mNumTileRows=4
    mMeshNodes=StaticMesh'FX_StaticMesh.MuzzleFlash.Muzzleflash_01_3rd'
    DrawScale=0.2000000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes_color.FB_Muzzleflash_01_3rd_Orange'
    Style=6
}