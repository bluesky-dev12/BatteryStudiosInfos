class SG_MuzFlash_01_3RD_Yellow extends wEmitter;
...
defaultproperties
{
    ...
    mRandTextures=true
    mNumTileRows=4
    mMeshNodes=StaticMesh'FX_StaticMesh.MuzzleFlash.Muzzleflash_07_3rd'
    DrawScale=0.3000000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes_color.FB_Muzzleflash_07_3rd_Yellow'
    Style=6
}