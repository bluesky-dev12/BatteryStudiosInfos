class AR_MuzFlash_04_3RD_Orange extends wEmitter;
...
defaultproperties
{
    ...
    mRandTextures=true
    mNumTileRows=4
    mMeshNodes=StaticMesh'FX_StaticMesh.MuzzleFlash.Muzzleflash_04_3rd'
    DrawScale=0.2500000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes_color.FB_Muzzleflash_04_3rd_Orange'
    Style=6
}