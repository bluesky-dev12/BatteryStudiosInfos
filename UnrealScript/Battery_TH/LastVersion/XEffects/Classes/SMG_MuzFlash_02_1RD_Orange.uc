class SMG_MuzFlash_02_1RD_Orange extends wEmitter;
...
defaultproperties
{
    ...
    mNumTileColumns=4
    mNumTileRows=4
    mMeshNodes=StaticMesh'FX_StaticMesh.MuzzleFlash.Muzzleflash_02_1rd'
    DrawScale=0.8000000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes_color.FB_Muzzleflash_02_1rd_Orange'
    Style=6
}