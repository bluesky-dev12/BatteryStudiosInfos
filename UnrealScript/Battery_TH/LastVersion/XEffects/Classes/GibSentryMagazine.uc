class GibSentryMagazine extends Gib
    notplaceable;
...
simulated function SetTeam(string strSTMeshName)
{
    ...
    NewMesh = StaticMesh(DynamicLoadObject("Char_SentryGun_Gore_Static.SentryG01.SentryG01_GoreRFProp_St", Class'Engine.StaticMesh'));
