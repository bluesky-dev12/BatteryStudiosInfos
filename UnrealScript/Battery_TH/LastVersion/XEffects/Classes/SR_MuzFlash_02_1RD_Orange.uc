class SR_MuzFlash_02_1RD_Orange extends wEmitter;
...
defaultproperties
{
    ...
    mNumTileColumns=2
    mNumTileRows=2
    mMeshNodes=StaticMesh'FX_StaticMesh.MuzzleFlash.Muzzleflash_05_1rd'
    DrawScale=1.5500000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes_color.FB_Muzzleflash_05_1rd_Orange'
    Style=6
}