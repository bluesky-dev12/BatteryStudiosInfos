class AR_MuzFlash_03_1RD_M4A1_Yellow extends wEmitter;
...
defaultproperties
{
    ...
    mNumTileColumns=4
    mNumTileRows=4
    mMeshNodes=StaticMesh'FX_StaticMesh.MuzzleFlash.Muzzleflash_03_1rd_M4A1'
    DrawScale=1.3000000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes_color.FB_Muzzleflash_03_1rd_M4A1_Yellow'
    Style=6
}