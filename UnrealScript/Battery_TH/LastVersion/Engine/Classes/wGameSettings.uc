...
static function bool IsNotRestriction(int Index)
{
    // End:0x1C
...
static function array<int> GetGameModeDispOrder()
{
    ...
    GameModeDispOrder[GameModeDispOrder.Length] = 14;
...
defaultproperties
{
    ...
    TeamGameBeginnerAI_UserFriendlyName="Beginner Mission"
    TeamGameBeginner_ModeDescription="Destroy the enemy!"
    ...
    Defence_ModeDescription="Defence"
    ...
    Alien_UserFriendlyName="ALIEN Mode"
    Alien_ModeDescription="Survive from ALIEN and Zombie"
    ...
    Alien_TeamName[0]="HUMAN TEAM"
    Alien_TeamName[1]="ALIENS TEAM"
    Capacities[0]="2"
    Capacities[1]="4"
    Capacities[2]="6"
    Capacities[3]="8"
    ...
    WeaponRestriction_All="All Weapon"
    WeaponRestriction_KnifeOnly="Knife Mode"
    WeaponRestriction_PistolOnly="Pistol Mode"
    WeaponRestriction_GrenadeOnly="Grenade Mode"
    WeaponRestriction_RPGOnly="RPG Mode"
    WeaponRestriction_SROnly="Sniper Mode"
    WeaponRestriction_SRBan="No Sniper Mode"
    WeaponRestriction_FlameThrower="Flame Thrower Mode"
    WeaponRestriction_ShotgunOnly="Shotgun Mode"
