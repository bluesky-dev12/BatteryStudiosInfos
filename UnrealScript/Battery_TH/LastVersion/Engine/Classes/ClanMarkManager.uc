...
function Init(wGameManager GM)
{
    ...
    ex_clanmark_01 = Class'Engine.BTCustomDrawHK'.static.MakeImage(32, 32, 28, Material(DynamicLoadObject("Warfare_UI_Clan.Clan_Mark.ex_clanmark_01_TH", Class'Engine.Material')));
    ex_clanmark_02 = Class'Engine.BTCustomDrawHK'.static.MakeImage(32, 32, 28, Material(DynamicLoadObject("Warfare_UI_Clan.Clan_Mark.ex_clanmark_02_TH", Class'Engine.Material')));
    //return;    
}
