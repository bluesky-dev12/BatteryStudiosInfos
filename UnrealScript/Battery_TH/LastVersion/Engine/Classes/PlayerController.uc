...
var bool bToggleItemBuyWindow;
var int iSellectedItemIndex;
var float fBuyedTime;
var float fReqUsingItemTime;
...
replication
{
    ...
    reliable if(bNetDirty && int(Role) == int(ROLE_Authority))
        GSSS, bFreeView, 
        fAirStrikeCenterX, fAirStrikeCenterY, 
        fAirStrikeRadius;
    ...
    reliable if(int(Role) == int(ROLE_Authority))
        ...
        ClearProgressMessages, ClientAddMagazine, 
        ClientAddStamina, ClientAdjustGlow, 
        ClientBombDetection, ClientCapBandwidth, 
        ClientChangeTcpTimeLimit, ClientCheckSkill, 
        ClientCloseMenu, ClientDeleteSuppliesPositions, 
        ClientFadeToBlackWhite, ClientFadeToBlackWhite2, 
        ClientFadeToColor, ClientGotoState, 
        ClientHoldFlag, ClientIncExplosion, 
        ClientIncHealthPack, ClientLogPawns, 
        ClientNetworkMessage, ClientOpenMenu, 
        ClientPopMessage, ClientQuickDemolition, 
        ClientQuickRespawn, ClientReStart, 
    ...
    // Pos:0x0A8
    reliable if(int(Role) == int(ROLE_Authority))
        ClientChangeSlot5, ClientChangeSlot6, 
        ClientMessage, QueueAnnouncement, 
        ReceiveLocalizedMessage, ReceiveLocalizedMessage2, 
        RemoveLocalizedMessage, TeamMessage;
    ...
    // Pos:0x0CF
    reliable if((int(Role) == int(ROLE_Authority)) && !bDemoRecording)
        ClientFmodPlaySoundLocal, ClientQueueAnnouncement, 
        ClientSetClassicView, ClientStopForceFeedback, 
        ClientTravel, FmodClientPlaySound;
    ...
    reliable if(int(Role) < int(ROLE_Authority))
        ...
        ServerAcknowledgePossession, ServerBuyItem, 
        ServerCallHelicopter, ServerCallSentryGunInstall, 
    ...
    reliable if(int(Role) < int(ROLE_Authority))
        ...
        ServerSendCheatMsg, ServerSetPrecached;
...
// Export UPlayerController::execFmodClientHearSound(FFrame&, void* const)
native event FmodClientHearSound(Actor Actor, int id, string SoundName, Vector soundLocation, float Pitch, bool Attenuate, bool Loop)
{
    //native.Actor;
    //native.id;
    //native.SoundName;
...
event CreateGameStateStorageSender()
{
    ...
    if(int(Role) == int(ROLE_Authority))
    {
        ...
        GSSS = Spawn(Class'Engine.wGameStateStorageSender');
...
exec function KillAll(Class<Actor> aClass)
{
    ...
    // End:0xE6
    if(ClassIsChildOf(aClass, Class'Engine.AIController'))
    {
...
{
    Log("[PlayerController::ServerGivePawn]");
    GivePawn(Pawn);
    //return;    
}
...
{
    // End:0x23
    if((NewPawn == none) || NewPawn.PlayerReplicationInfo == none)
    {
        return;
    }
...
{
    Log("[PlayerController::AcknowledgePossession]");
    // End:0x78
...
function PawnDied(Pawn P)
{
    ...
    RemoveLocalizedMessage(Class'Engine.wMessage_Game_ImpSystem', Class'Engine.wMessage_Game_ImpSystem'.default.Code_EnableInstallSentryGun);
    RemoveLocalizedMessage(Class'Engine.wMessage_Game_ImpSystem', Class'Engine.wMessage_Game_ImpSystem'.default.Code_DisableInstallSentryGun);
    super.PawnDied(P);
    //return;    
}
...
simulated function ReceiveLocalizedMessage2(Class<LocalMessage> Message, optional int Switch, optional bool bOption_Push, optional int Reserved1, optional int Reserved2, optional string Reserved3)
{
    ...
    if(Message == Class'Engine.wMessage_Game_Alien')
    {
        ...
        {
            // End:0x27
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMAppearHostAlien:
            // End:0x38
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMTransformdHostAlien:
            // End:0x49
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMTransformdMasterAlien:
            // End:0x5A
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMHeadShotAlien:
            // End:0x6B
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMDropRandomItemBox:
            // End:0x7C
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMTouchItemBoxInWeapon:
            // End:0x8D
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMTouchItemBoxInSkill:
            // End:0x9E
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMTouchItemBoxInFillAmmo:
            // End:0xAF
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMDefenceToAlien:
            // End:0xC0
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMInfectToFail:
            // End:0xD1
            ...
            // End:0x110
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMAppearSuperAlien:
                strMessage = Class'Engine.wMessage_Game_Alien'.static.GetString(Switch);
                // End:0x1DD
                break;
            // End:0x121
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMAcquiredAttackBuff:
            // End:0x132
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMReadyTimeCount:
            // End:0x176
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMReadyTimeCountSuperAlien:
                strMessage = Class'Engine.wMessage_Game_Alien'.static.GetString(Switch);
                ReplaceText(strMessage, "%0", string(Reserved1));
                // End:0x1DD
                break;
            // End:0x187
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMSelectedHero:
            // End:0x198
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMInfectdHero:
            // End:0x1DA
            case Class'Engine.wMessage_Game_Alien'.default.Code_AMTouchItemBoxToEveryOne:
                strMessage = Class'Engine.wMessage_Game_Alien'.static.GetString(Switch);
                ReplaceText(strMessage, "%0", Reserved3);
                // End:0x1DD
                break;
            // End:0xFFFF
            default:
    ...
    else
    {
        ...
        if(Message == Class'Engine.wMessage_Game_ImpSystem')
        {
            ...
            {
                // End:0x23A
                case Class'Engine.wMessage_Game_ImpSystem'.default.Code_DFSupplyAmmo:
                    strMessage = Class'Engine.wMessage_Game_ImpSystem'.static.GetString(Switch);
                    ReplaceText(strMessage, "%0", string(Reserved1));
                    // End:0x23D
                    break;
                // End:0xFFFF
        ...
        myHUD.LocalizedMessage2(Message, Switch, bOption_Push, strMessage);
        //return;        
    }
}
...
simulated event RemoveLocalizedMessage(Class<LocalMessage> Message, optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2, optional Object OptionalObject, optional int iReserve)
{
    Message.static.RemoveLocalizedMessage(self, Switch, RelatedPRI_1, RelatedPRI_2, OptionalObject);
    //return;    
}
...
event TeamMessage(PlayerReplicationInfo PRI, coerce string S, name Type)
{
    ...
    if((Player != none) && Player.Console != none)
    {
        switch(Type)
        {
            ...
            // End:0x18C
            case 'GotItem':
                Player.Console.AddMessageItem(Player.Console.ConstructMessageItem(S, 10));
                // End:0x1C9
                break;
            // End:0xFFFF
            default:
...
simulated function PlayStatusAnnouncement(string AName, byte AnnouncementLevel, optional bool bForce)
{
    ...
    if(AName != "")
    {
        FmodClientPlaySound(StatusAnnouncer.GetSound(AName), true,, 5);
    }
...
simulated function PlayRewardAnnouncement(name AName, byte AnnouncementLevel, optional bool bForce, optional Actor.ESoundSlot Slot, optional bool isWomanVoice)
{
    local float Atten;
    ...
    if(string(AName) != "")
    {
        ...
        if(int(Slot) == int(0))
        {
            FmodClientPlaySound(RewardAnnouncer.GetSound(string(AName), isWomanVoice), true, Atten, 5);            
        }
        else
        {
            FmodClientPlaySound(RewardAnnouncer.GetSound(string(AName), isWomanVoice), true, Atten, Slot);
        }
    }
    //return;    
}
...
simulated function QueueAnnouncement(string ASoundName, byte AnnouncementLevel, optional Object.EAPriority Priority, optional byte Switch)
{
    ...
    {
        AnnouncerQueueManager = Spawn(Class'Engine.AnnouncerQueueManager');
...
simulated function FmodClientPlaySound(string SoundName, optional bool bVolumeControl, optional float inAtten, optional Actor.ESoundSlot Slot)
{
    local float Atten;
    ...
    if(ViewTarget != none)
    {
        ViewTarget.FmodDemoPlaySound(SoundName, Slot);
    }
    //return;    
}
...
simulated function ClientFmodPlaySoundLocal(string SoundName, optional Actor.ESoundSlot Slot, optional float Pitch, optional bool bNoOverride, optional bool Attenuate, optional bool Loop, optional int SellectTeam, optional bool bExceptOwner, optional Vector soundLocation)
{
    // End:0x4B
    if(ViewTarget != none)
    {
        ViewTarget.FmodPlaySoundLocal(SoundName, Slot, Pitch, bNoOverride, Attenuate, Loop, SellectTeam, bExceptOwner, soundLocation);
    }
    //return;    
}
...
simulated event Destroyed()
{
    ...
    if(Pawn != none)
    {
        ...
        if(DrivenVehicle != none)
        {
            ...
            {
                Driver.Health = 0;
                Driver.Died(self, Class'Engine.Suicided', Driver.Location);
            }            
        }
        else
        {
...
{
    // End:0x63
    if(((f >= 5.0000000) || int(Level.NetMode) == int(NM_Standalone)) || PlayerReplicationInfo.bOnlySpectator)
    {
    ...
    if(PlayerReplicationInfo.bAdmin && Left(Msg, 1) == "#")
    {
        ...
        if(C != none)
        {
            ...
            if(C.IsA('PlayerController'))
            {
                ...
                PlayerController(C).SetProgressMessage(0, Msg, Class'Engine.Canvas'.static.MakeColor(byte(255), byte(255), byte(255)));
            }
            C = C.nextController;
            // [Loop Continue]
            goto J0x72;
...
{
    Class'Engine.PlayerController'.default.bAutoTaunt = Value;
...
function LongClientAdjustPosition(float TimeStamp, name NewState, Actor.EPhysics newPhysics, float NewLocX, float NewLocY, float NewLocZ, float NewVelX, float NewVelY, float NewVelZ, Actor NewBase, float NewFloorX, float NewFloorY, float NewFloorZ)
{
    ...
    if((PlayerReplicationInfo != none) && !bDemoOwner)
    {
        ...
        else
        {
            ...
            ExactPing = FMin(0.9900000, (0.9900000 * ExactPing) + (0.0100000 * NewPing));
        }
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                // End:0xBD
                if((int(10) == int(Pawn.TypeOfWeapon)) || int(19) == int(Pawn.TypeOfWeapon))
                {
                    return;
                }
                bPressedJump = true;
...
function DoProne()
{
    ...
    {
        ReceiveLocalizedMessage(Class'Engine.wMessage_Game_ImpSystem', Class'Engine.wMessage_Game_ImpSystem'.default.Code_CantProne);
        return;
    }
    // End:0xBD
    if(int(bDuck) == 0)
...
{
    // End:0x1B
    if(int(19) == int(Pawn.TypeOfWeapon))
    {
        return;
    }
    // End:0x42
...
exec function SwitchWeapon(byte f, optional bool bQuickGr)
{
    ...
    // End:0x4A
    if((Pawn.PendingWeapon != none) && int(Pawn.PendingWeapon.InventoryGroup) == int(f))
    {
        return;
    }
    // End:0xB2
...
simulated function wWeapon GetWeaponByID(int iWeaponID, optional Inventory SkipWeapon)
{
    ...
    myPawn = GetMyPawn();
    // End:0x2F
    if((myPawn == none) || myPawn.Inventory == none)
    {
        return none;
    }
...
simulated function wWeapon GetWeaponByWeaponType(byte nWeaponType, optional Inventory SkipWeapon)
{
    ...
    if(Inv != none)
    {
        ...
        {
            // End:0xA6
            if((int(nWeaponType) == 0) && true == (IsFragGrenade(wWeapon(Inv))))
            {
                return wWeapon(Inv);                
            }
            else
            {
                // End:0xD6
                if((int(nWeaponType) == 1) && true == (IsSpecialGrenade(wWeapon(Inv))))
                {
                    return wWeapon(Inv);
                }
            }
...
{
    // End:0x36
    if(int(kWeapon.BaseParams.damtype) == int(kWeapon.BaseParams.5))
    {
        return true;
    }
    return false;
...
{
    // End:0x8E
    if(int(kWeapon.BaseParams.eType) == int(5))
    {
        // End:0x8E
        if((int(kWeapon.BaseParams.damtype) == int(kWeapon.BaseParams.7)) || int(kWeapon.BaseParams.damtype) == int(kWeapon.BaseParams.6))
        {
            return true;
        }
    }
...
function bool ServerUse()
{
    ...
    // End:0x133
    foreach Pawn.VisibleCollidingActors(Class'Engine.Vehicle', V, VehicleCheckRadius)
    {
...
exec function ClearProgressMessages()
{
    ...
    {
        ProgressMessage[i] = "";
        ProgressColor[i] = Class'Engine.Canvas'.static.MakeColor(byte(255), byte(255), byte(255));
        i++;
        // [Loop Continue]
        goto J0x07;
    }
...
function ClientReStart(Pawn NewPawn)
{
    ...
    {
        Log("[PlayerController::ClientRestart]");
    }
    Pawn = NewPawn;
    // End:0xAA
    if((Pawn != none) && Pawn.bTearOff)
...
event PlayerTick(float DeltaTime)
{
    ...
    if(!Level.GetMatchMaker().bChangingHost)
    {
        ...
        if((Level.GetIsServiceBuild() == false) && Pawn != none)
        {
            ...
            // End:0x2AB
            if(Level.fMoveLogTimer >= 1.0000000)
            {
                // End:0x297
                if(Level.Game != none)
                {
...
simulated function CheckPerformence(float DeltaTime)
{
    ...
    else
    {
        ...
        {
            // End:0x38C
            if(Level.TimeSeconds > (fPostBeginTime + 30.0000000))
            {
                // End:0x38C
...
{
    local bool bLimitInput;
    local name naOutSeqName;
    local float fOutAnimFrame, fOutAnimRate;

    // End:0xB6
    if(Pawn != none)
    {
        // End:0x48
        if(int(10) == int(Pawn.TypeOfWeapon))
        {
            aForward = 0.0000000;
            aStrafe = 0.0000000;
            aUp = 0.0000000;            
        ...
        else
        {
            ...
            {
                // End:0xB6
                if(int(Pawn.Weapon.5) == int(Pawn.Weapon.ClientState))
                {
                    aForward = 0.0000000;
                    aStrafe = 0.0000000;
                    aUp = 0.0000000;
...
function DoPosture()
{
    ...
    if(Pawn != none)
    {
        ...
        if(int(19) == int(Pawn.TypeOfWeapon))
        {
            bInputCrouch = bOldInputCrouch;
            bInputProne = bOldInputProne;
            return;
        }
    }
    // End:0x65
...
simulated function ClientToggleAimMode(bool bToggle)
{
    ...
    if(Pawn.bIsIdle == true)
    {
        ...
        if(Pawn.bIsAiming == false)
        {
            ...
            {
                Pawn.IdleAnim = Pawn.Pistol_IdleRifleAnim;                
            }
            else
            {
                Pawn.IdleAnim = Pawn.IdleRifleAnim;
            }            
        }
        else
        {
            ...
            {
                Pawn.IdleAnim = Pawn.IdleAimAnim;
            }
        }
        Pawn.AnimBlendParams(1, 0.0000000);
        Pawn.PlayAnim(Pawn.IdleAnim,, 0.1000000);
    }
    //return;    
}
...
event AdjustView(float DeltaTime)
{
    ...
    if(FovAngle != DesiredFOV)
    {
        ...
        if(FovAngle > DesiredFOV)
        {
            fFOVSpeed = (100.0000000 * fAnimRate_AdsOn) * (fDeltaFOVAngle / 20.0000000);
            // End:0x8B
        ...
        {
            fFOVSpeed = (100.0000000 * fAnimRate_AdsOff) * (fDeltaFOVAngle / 20.0000000);
            // End:0xF1
            if(Pawn.Weapon.bQuickAimZoom == true)
            {
                fFOVSpeed *= 1.5000000;
...
exec function PPEffectOn(name PP_EffectClass)
{
    ...
    switch(PP_EffectClass)
    {
        ...
        case 'DOFEffect':
            ...
            {
                CreatePostProcessEffect(Class'Engine.DOFEffect');
            }
            // End:0x1B8
            break;
        // End:0x15B
        case 'MotionBlurEffect':
            CreatePostProcessEffect(Class'Engine.MotionBlurEffect');
            // End:0x1B8
            break;
        // End:0x171
        case 'DripEffect':
            CreatePostProcessEffect(Class'Engine.DripEffect');
            // End:0x1B8
            break;
        // End:0x187
        case 'FinalEffect':
            CreatePostProcessEffect(Class'Engine.FinalEffect');
            // End:0x1B8
            break;
        // End:0x1B5
        case 'SSAOEffect':
            ...
            {
                CreatePostProcessEffect(Class'Engine.SSAOEffect');
            }
            // End:0x1B8
            break;
        // End:0xFFFF
...
function Vector ReCalDecayVelocity()
{
    ...
    {
        TempShakeVelocity.X = -1.0000000 * float(iDist2);
    }
    ...
    {
        TempShakeVelocity.Y = -1.0000000 * float(iDist2);
    }
    TempShakeVelocity.Z = 0.0000000;
        ...
        switch(wShakeState)
        {
            ...
            case 3:
                ...
                if(fDecayStayTime >= wShakeDecayFastTime)
                {
                    ...
                    fDecayRatio = FClamp(fDecayRatio, 0.0100000, 1.0000000);
                    fDecayRatio = 1.0000000 - fDecayRatio;
                    fDecayRatio = 1.0000000 - (fDecayRatio * fDecayRatio);
                    ...
                    if((Pawn != none) && Pawn.Weapon != none)
                    {
                        ...
                        if(Pawn.Weapon.wt_index > 0)
                        {
                            ...
                            if(fDecayStayTime >= wShakeDecayFastTime)
                            {
                                ...
                                // End:0x8D2 [Loop If]
                                if((Level.TimeSeconds - wDecayRemainTime) > (Pawn.Weapon.BaseParams.fRateOfFire * 0.5000000))
                                {
                                    Pawn.Weapon.wt_index -= 1;
                                    wShakeKickedRot = wShakeRot;
                                    wDecayRemainTime += (Pawn.Weapon.BaseParams.fRateOfFire * 0.5000000);
                                    // End:0x8CF
                                    if((Level.TimeSeconds - wDecayRemainTime) < 0.0000000)
                                    {
                                        // [Explicit Break]
                                        goto J0x8D2;
                                    }
...
function FixedVelocity(float DeltaTime)
{
    ...
    if(bHit == true)
    {
        ...
        if(hit_gun_delta_Time < hit_gun_move_time)
        {
            ...
            {
                fTest = 1.0000000 - ((hit_gun_delta_Time / hit_gun_move_time) * hit_gun_move_speed);
            }
            clog("vel % = " $ string(fTest));
            fOldZPos = Pawn.Velocity.Z;
            Pawn.Velocity = (VSize(OldVel) * fTest) * Normal(Pawn.Velocity);
            Pawn.Velocity.Z = fOldZPos;
            // End:0x11D
            if(int(Role) < int(ROLE_Authority))
            {
        ...
        else
        {
            ...
            if(hit_gun_delta_Time >= hit_gun_move_delay)
            {
                ...
                // End:0x1AC
                if((int(bHitRun) == 1) && pInput.bWasForward == true)
                {
                    bOldRun = 1;
                    bRun = 1;
                    bHitRun = 0;
    ...
    if(C != none)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    // End:0x248
                    if(C.IsA('wAISentryGunController'))
                    {                        
                    }
                    else
                    {
...
function ServerSpectate(optional bool cannotPickSelf)
{
    ...
    if((Pawn != none) && !Pawn.bDeleteMe)
    {
        Pawn.Died(self, Class'Engine.DamageType', Pawn.Location);
    }
    // End:0xC8
    if((int(Level.GetMatchMaker().GMLevelFlag) & 2) == 2)
    {
...
function BecomeActivePlayer()
{
    ...
    {
        Level.Game.ChangeTeam(self, Level.Game.GetTeamID_by_Balancing(0, none), false);
    }
    // End:0x288
...
simulated function float AdjustRespawnTime()
{
...
exec function InvertLook()
{
    ...
    if(IsOnConsole())
    {
        Class'Engine.XBoxPlayerInput'.default.bInvertVLook = Result;
        Class'Engine.XBoxPlayerInput'.static.StaticSaveConfig();
    }
    //return;    
}
...
{
    Log((((((("ChatBan Role:" $ string(GetEnum(Enum'Engine.Actor.ENetRole', int(Role)))) @ "ChatManager:") $ string(ChatManager)) @ "PlayerID:") $ string(PlayerID)) @ "Type:") $ string(Type), 'ChatManager');
    // End:0xA3
...
function DisplayDebug(Canvas Canvas, out float YL, out float YPos)
{
    ...
    if(Pawn != none)
    {
        ...
        YPos += YL;
        Canvas.SetPos(4.0000000, YPos);
        Canvas.DrawText((((("bWantsToProne : " $ string(Pawn.bWantsToProne)) $ " / bIsProned : ") $ string(Pawn.bIsProned)) $ " / bIsProning : ") $ string(Pawn.bIsProning));
        YPos += YL;
        Canvas.SetPos(4.0000000, YPos);
    }
    Canvas.DrawText((((((("DesiredFOV : " $ string(DesiredFOV)) $ " / FOVAngle : ") $ string(FovAngle)) $ " / bZooming : ") $ string(bZooming)) $ " / bMeleeFire : ") $ string(bMeleeFire));
    YPos += YL;
    Canvas.SetPos(4.0000000, YPos);
...
function ServerCallSentryGunInstall(Controller callingController)
{
    //return;    
}
...
exec function ggga()
{
    ...
    if(lp1 < 100)
    {
        DynamicLoadObject("aaaashgasa", Class'Engine.Material');
        lp1++;
        // [Loop Continue]
        goto J0x07;
    }
...
exec function gggb()
{
    ...
    if(lp1 < 100)
    {
        DynamicLoadObject("aaaashgasa", Class'Engine.Material', true);
        lp1++;
        // [Loop Continue]
        goto J0x07;
    }
...
function ClientSetViewTargetDied(Actor Killer, optional Object OptionalObject)
{
    ...
    {
        // End:0x5E
        case Class'Engine.wDamageAirStrike':
        // End:0x8A
        case Class'Engine.wDamageHelicopter':
...
function PlaySoundRadioMessage(int iKey, int iType)
{
    ...
    if(iType == 1)
    {
        switch(iKey)
        {
            // End:0x2F
            case 1:
                iCodeID = Class'Engine.wMessage_Game'.default.Code_RMC[0];
                // End:0x12B
                break;
            // End:0x4D
            case 2:
                iCodeID = Class'Engine.wMessage_Game'.default.Code_RMC[1];
                // End:0x12B
                break;
            // End:0x6C
            case 3:
                iCodeID = Class'Engine.wMessage_Game'.default.Code_RMC[2];
                // End:0x12B
                break;
            // End:0x8B
            case 4:
                iCodeID = Class'Engine.wMessage_Game'.default.Code_RMC[3];
                // End:0x12B
                break;
            // End:0xAA
            case 5:
                iCodeID = Class'Engine.wMessage_Game'.default.Code_RMC[4];
                // End:0x12B
                break;
            // End:0xC9
            case 6:
                iCodeID = Class'Engine.wMessage_Game'.default.Code_RMC[5];
                // End:0x12B
                break;
            // End:0xE8
            case 7:
                iCodeID = Class'Engine.wMessage_Game'.default.Code_RMC[6];
                // End:0x12B
                break;
            // End:0x107
            case 8:
                iCodeID = Class'Engine.wMessage_Game'.default.Code_RMC[7];
                // End:0x12B
                break;
            // End:0x126
            case 9:
                iCodeID = Class'Engine.wMessage_Game'.default.Code_RMC[8];
                // End:0x12B
                break;
            // End:0xFFFF
            default:
    ...
    else
    {
        ...
        if(iType == 2)
        {
            switch(iKey)
            {
                // End:0x15E
                case 1:
                    iCodeID = Class'Engine.wMessage_Game'.default.Code_RMS[0];
                    // End:0x21C
                    break;
                // End:0x17C
                case 2:
                    iCodeID = Class'Engine.wMessage_Game'.default.Code_RMS[1];
                    // End:0x21C
                    break;
                // End:0x19B
                case 3:
                    iCodeID = Class'Engine.wMessage_Game'.default.Code_RMS[2];
                    // End:0x21C
                    break;
                // End:0x1BA
                case 4:
                    iCodeID = Class'Engine.wMessage_Game'.default.Code_RMS[3];
                    // End:0x21C
                    break;
                // End:0x1D9
                case 5:
                    iCodeID = Class'Engine.wMessage_Game'.default.Code_RMS[4];
                    // End:0x21C
                    break;
                // End:0x1F8
                case 6:
                    iCodeID = Class'Engine.wMessage_Game'.default.Code_RMS[5];
                    // End:0x21C
                    break;
                // End:0x217
                case 7:
                    iCodeID = Class'Engine.wMessage_Game'.default.Code_RMS[6];
                    // End:0x21C
                    break;
                // End:0xFFFF
                default:
        ...
        else
        {
            ...
            if(iType == 3)
            {
                switch(iKey)
                {
                    // End:0x24F
                    case 1:
                        iCodeID = Class'Engine.wMessage_Game'.default.Code_RMR[0];
                        // End:0x441
                        break;
                    // End:0x26D
                    case 2:
                        iCodeID = Class'Engine.wMessage_Game'.default.Code_RMR[1];
                        // End:0x441
                        break;
                    // End:0x28C
                    case 3:
                        iCodeID = Class'Engine.wMessage_Game'.default.Code_RMR[2];
                        // End:0x441
                        break;
                    // End:0x2AB
                    case 4:
                        iCodeID = Class'Engine.wMessage_Game'.default.Code_RMR[3];
                        // End:0x441
                        break;
                    // End:0x2CA
                    case 5:
                        iCodeID = Class'Engine.wMessage_Game'.default.Code_RMR[4];
                        // End:0x441
                        break;
                    // End:0x2E9
                    case 6:
                        iCodeID = Class'Engine.wMessage_Game'.default.Code_RMR[5];
                        // End:0x441
                        break;
                    // End:0x308
                    case 7:
                        iCodeID = Class'Engine.wMessage_Game'.default.Code_RMR[6];
                        // End:0x441
                        break;
                    // End:0x43C
                    case 8:
                        iCodeID = Class'Engine.wMessage_Game'.default.Code_RMR[7];
                        // End:0x37C
                        ...
                        if(C != none)
                        {
                            ...
                            {
                                PlayerController(C).ReceiveLocalizedMessage(Class'Engine.wMessage_Game', iCodeID, PlayerReplicationInfo);
                            }
                            C = C.nextController;
                            // [Loop Continue]
                            goto J0x3B8;
    ...
    Level.Game.TeamReceiveLocalizedMessage(byte(GetTeamNum()), Class'Engine.wMessage_Game', iCodeID, PlayerReplicationInfo);
    //return;    
}
...
function ServerNotifyOnSkill(Class<wSkill> onSkill)
{
    //return;    
}
...
function ServerAddMagazine(bool bAdd)
{
    ClientAddMagazine(bAdd);
    //return;    
}

simulated function ClientAddMagazine(bool bAdd)
{
    // End:0x21
    if(SkillBase != none)
    {
        SkillBase.bAddManazine = bAdd;
    }
    //return;    
}
...
function SetVoiceLanguage(int iTeamIndex)
{
    ...
    switch(VoiceLanguage)
    {
        ...
        case "foreign":
            ...
            if(iTeamIndex == 0)
            {
                Class'Engine.wGameManager'.default.TeamIndex = 0;
                // End:0x89
                if(Class'Engine.wGameManager'.default.VoicePackageName != Class'Engine.wMessage_Game'.default.PackageEng_AF)
                {
                    bPackageChanged = true;
                }
                Class'Engine.wGameManager'.default.VoicePackageName = Class'Engine.wMessage_Game'.default.PackageEng_AF;
                VoiceType = Class'Engine.wMessage_Game'.default.PackageEng_AF;                
            }
            else
            {
                // End:0x132
                if(iTeamIndex == 1)
                {
                    Class'Engine.wGameManager'.default.TeamIndex = 1;
                    // End:0x101
                    if(Class'Engine.wGameManager'.default.VoicePackageName != Class'Engine.wMessage_Game'.default.PackageRus_RSA)
                    {
                        bPackageChanged = true;
                    }
                    Class'Engine.wGameManager'.default.VoicePackageName = Class'Engine.wMessage_Game'.default.PackageRus_RSA;
                    VoiceType = Class'Engine.wMessage_Game'.default.PackageRus_RSA;
                }
            }
            Class'Engine.wGameManager'.default.LanguageType = 1;
            // End:0x254
            break;
        // End:0x251
        case "chinese":
            ...
            if(iTeamIndex == 0)
            {
                Class'Engine.wGameManager'.default.TeamIndex = 0;
                // End:0x195
                if(Class'Engine.wGameManager'.default.VoicePackageName != Class'Engine.wMessage_Game'.default.PackageCH_AF)
                {
                    bPackageChanged = true;
                }
                Class'Engine.wGameManager'.default.VoicePackageName = Class'Engine.wMessage_Game'.default.PackageCH_AF;
                VoiceType = Class'Engine.wMessage_Game'.default.PackageCH_AF;                
            }
            else
            {
                // End:0x23E
                if(iTeamIndex == 1)
                {
                    Class'Engine.wGameManager'.default.TeamIndex = 1;
                    // End:0x20D
                    if(Class'Engine.wGameManager'.default.VoicePackageName != Class'Engine.wMessage_Game'.default.PackageCH_RSA)
                    {
                        bPackageChanged = true;
                    }
                    Class'Engine.wGameManager'.default.VoicePackageName = Class'Engine.wMessage_Game'.default.PackageCH_RSA;
                    VoiceType = Class'Engine.wMessage_Game'.default.PackageCH_RSA;
                }
            }
            Class'Engine.wGameManager'.default.LanguageType = 0;
            // End:0x254
            break;
        // End:0xFFFF
        default:
...
{
    Class'Engine.AnnouncerVoice'.default.AlternateFallbackSoundPackage = Class'Engine.wGameManager'.default.VoicePackageName;
    //return;    
}

function ChangeVoiceObjectLanguage(out string voiceObjectName)
{
    local string frontDivide, rearDivide;

    Divide(voiceObjectName, "/", frontDivide, rearDivide);
    voiceObjectName = (Class'Engine.wGameManager'.default.VoicePackageName $ "/") $ rearDivide;
    //return;    
}
...
simulated function DestroyEmitter()
{
    ...
    // End:0x28
    foreach DynamicActors(Class'Engine.Emitter', FindEmitter)
    {
        // End:0x27
        if(FindEmitter != none)
        {
...
exec function GetPawnCount()
{
    local Pawn P;
    local PlayerReplicationInfo PRI;
    local int PawnCount, PawnExistPRICount, TotalPRICount;
    ...
    clog("Pawn Count=" $ string(PawnCount));
    clog("Pawn ExistPRI Count=" $ string(PawnExistPRICount));
    clog("Total PRI Count=" $ string(TotalPRICount));
    //return;    
}
...
function ServerUseSupplyItem(Object.ESUPPLY_ITEM_TYPE eSupplyItemType)
{
    // End:0x1F
    if(SkillBase != none)
    {
        SkillBase.UseSupplyItem(eSupplyItemType);
    }
    //return;    
}

function ClientUseSupplyItem(Object.ESUPPLY_ITEM_TYPE eSupplyItemType)
{
    // End:0x1F
    if(SkillBase != none)
    {
...
exec function SetASSize(float f)
{
    // End:0x23
    if((Pawn == none) || Pawn.Weapon == none)
    {
    ...
    wGun(Pawn.Weapon).fPartsBreathRadius = f;
    //return;    
}

exec function SetASSpeed(float f)
{
    // End:0x23
    if((Pawn == none) || Pawn.Weapon == none)
    {
    ...
    wGun(Pawn.Weapon).fPartsBreathSpeed = f;
    //return;    
}

exec function SetRMin(float f)
{
    // End:0x23
    if((Pawn == none) || Pawn.Weapon == none)
    {
    ...
    wInstantFire(Pawn.Weapon.FireMode[0]).fPartsDamRange_Eff = f;
    //return;    
}

exec function SetRMax(float f)
{
    // End:0x23
    if((Pawn == none) || Pawn.Weapon == none)
    {
    ...
    wInstantFire(Pawn.Weapon.FireMode[0]).fPartsDamRange_Max = f;
    //return;    
}
...
{
    Pawn.Weapon.wt_index = 0;
    Pawn.Weapon.wt_RandomMul = 0.0000000;
    Pawn.Weapon.wt_BoundingMax = 0;
    Pawn.Weapon.wtAim_RandomMul = 0.0000000;
...
exec function ReWeaponParam()
{
    Level.WeaponMgr.LoadWeaponParams(Level.GetMatchMaker().GetParamsExcelPathFileName(), true, Pawn.Weapon);
    //return;    
}
...
exec function input_weaponex(string S)
{
    ...
    Pawn.Weapon.BaseParams.fMeleeDelay = float(arrs[int(Pawn.Weapon.BaseParams.0)]);
    Pawn.Weapon.BaseParams.iDamMelee = int(arrs[int(Pawn.Weapon.BaseParams.1)]);
    Pawn.Weapon.BaseParams.iMeleeRange = int(arrs[int(Pawn.Weapon.BaseParams.2)]);
    Pawn.Weapon.BaseParams.iMeleeExtent = int(arrs[int(Pawn.Weapon.BaseParams.3)]);
    Pawn.Weapon.BaseParams.iMeleeExtent_Head = int(arrs[int(Pawn.Weapon.BaseParams.4)]);
    Pawn.Weapon.BaseParams.iMeleeDam_Back = int(float(arrs[int(Pawn.Weapon.BaseParams.5)]));
    Pawn.Weapon.BaseParams.fMeleeDam_Head = float(arrs[int(Pawn.Weapon.BaseParams.6)]);
    Pawn.Weapon.BaseParams.fMeleeDam_UpperTorso = float(arrs[int(Pawn.Weapon.BaseParams.7)]);
    Pawn.Weapon.BaseParams.fMeleeDam_LowerTorso = float(arrs[int(Pawn.Weapon.BaseParams.8)]);
    Pawn.Weapon.BaseParams.fMeleeDam_UpperArm = float(arrs[int(Pawn.Weapon.BaseParams.9)]);
    Pawn.Weapon.BaseParams.fMeleeDam_LowerArm = float(arrs[int(Pawn.Weapon.BaseParams.10)]);
    Pawn.Weapon.BaseParams.fMeleeDam_UpperLeg = float(arrs[int(Pawn.Weapon.BaseParams.11)]);
    Pawn.Weapon.BaseParams.fMeleeDam_LowerLeg = float(arrs[int(Pawn.Weapon.BaseParams.12)]);
    Pawn.Weapon.BaseParams.fFiringSway_HipX_Max = float(arrs[int(Pawn.Weapon.BaseParams.13)]);
    Pawn.Weapon.BaseParams.fFiringSway_HipX_Incr = float(arrs[int(Pawn.Weapon.BaseParams.14)]);
    Pawn.Weapon.BaseParams.fFiringSway_HipX_Speed = float(arrs[int(Pawn.Weapon.BaseParams.15)]);
    Pawn.Weapon.BaseParams.fFiringSway_HipY_Max = float(arrs[int(Pawn.Weapon.BaseParams.16)]);
    Pawn.Weapon.BaseParams.fFiringSway_HipY_Incr = float(arrs[int(Pawn.Weapon.BaseParams.17)]);
    Pawn.Weapon.BaseParams.fFiringSway_HipY_Speed = float(arrs[int(Pawn.Weapon.BaseParams.18)]);
    Pawn.Weapon.BaseParams.fFiringSway_AdsX_Max = float(arrs[int(Pawn.Weapon.BaseParams.19)]);
    Pawn.Weapon.BaseParams.fFiringSway_AdsX_Incr = float(arrs[int(Pawn.Weapon.BaseParams.20)]);
    Pawn.Weapon.BaseParams.fFiringSway_AdsX_Speed = float(arrs[int(Pawn.Weapon.BaseParams.21)]);
    Pawn.Weapon.BaseParams.fFiringSway_AdsY_Max = float(arrs[int(Pawn.Weapon.BaseParams.22)]);
    Pawn.Weapon.BaseParams.fFiringSway_AdsY_Incr = float(arrs[int(Pawn.Weapon.BaseParams.23)]);
    Pawn.Weapon.BaseParams.fFiringSway_AdsY_Speed = float(arrs[int(Pawn.Weapon.BaseParams.24)]);
    i = 0;
    J0x722:

    // End:0x7C8 [Loop If]
    if(int(i) < Pawn.Weapon.3)
    {
        // End:0x7BE
        if(Pawn.Weapon.FireMode[int(i)] != none)
        {
            Pawn.Weapon.FireMode[int(i)].NextFireTime = 0.0000000;
            Pawn.Weapon.FireMode[int(i)].wLoadOut();
        }
        i++;
        // [Loop Continue]
        goto J0x722;
...
exec function input_weapon(string S)
{
    ...
    SplitForInputWeapon(S, arrs);
    Pawn.Weapon.BaseParams.iSpread_2nd_StartNum = int(arrs[int(Pawn.Weapon.BaseParams.76)]);
    Pawn.Weapon.BaseParams.fSpread_2nd_Add = float(arrs[int(Pawn.Weapon.BaseParams.77)]);
    Pawn.Weapon.BaseParams.fSpread_2nd_Max = float(arrs[int(Pawn.Weapon.BaseParams.78)]);
    Pawn.Weapon.BaseParams.fRateOfFire = float(arrs[int(Pawn.Weapon.BaseParams.7)]);
    Pawn.Weapon.BaseParams.fSpread_Aim_move_add = float(arrs[int(Pawn.Weapon.BaseParams.79)]);
    Pawn.Weapon.BaseParams.fSpread_Stand_Min = float(arrs[int(Pawn.Weapon.BaseParams.83)]);
    Pawn.Weapon.BaseParams.fSpread_Stand_Max = float(arrs[int(Pawn.Weapon.BaseParams.84)]);
    Pawn.Weapon.BaseParams.fSpread_Move_Add = float(arrs[int(Pawn.Weapon.BaseParams.89)]);
    Pawn.Weapon.BaseParams.fSpread_Fire_Add = float(arrs[int(Pawn.Weapon.BaseParams.90)]);
    Pawn.Weapon.BaseParams.fSpread_Image_Increase = float(arrs[int(Pawn.Weapon.BaseParams.91)]);
    Pawn.Weapon.BaseParams.fSpread_Stand_Reduce = float(arrs[int(Pawn.Weapon.BaseParams.92)]);
    Pawn.Weapon.BaseParams.iRoundBurstCount = int(arrs[int(Pawn.Weapon.BaseParams.8)]);
    Pawn.Weapon.BaseParams.fRoundBurstTime = float(arrs[int(Pawn.Weapon.BaseParams.9)]);
    Pawn.Weapon.BaseParams.iDam_OOR = int(arrs[int(Pawn.Weapon.BaseParams.37)]);
    Pawn.Weapon.BaseParams.iDamage = int(arrs[int(Pawn.Weapon.BaseParams.38)]);
    Pawn.Weapon.BaseParams.fDamPerc_Head = float(arrs[int(Pawn.Weapon.BaseParams.42)]);
    Pawn.Weapon.BaseParams.fDamPerc_UpperTorso = float(arrs[int(Pawn.Weapon.BaseParams.43)]);
    Pawn.Weapon.BaseParams.fDamPerc_LowerTorso = float(arrs[int(Pawn.Weapon.BaseParams.44)]);
    Pawn.Weapon.BaseParams.fDamPerc_UpperArm = float(arrs[int(Pawn.Weapon.BaseParams.45)]);
    Pawn.Weapon.BaseParams.fDamPerc_LowerArm = float(arrs[int(Pawn.Weapon.BaseParams.46)]);
    Pawn.Weapon.BaseParams.fDamPerc_UpperLeg = float(arrs[int(Pawn.Weapon.BaseParams.47)]);
    Pawn.Weapon.BaseParams.fDamPerc_LowerLeg = float(arrs[int(Pawn.Weapon.BaseParams.48)]);
    Pawn.Weapon.BaseParams.fViewKickHip_XMin = float(arrs[int(Pawn.Weapon.BaseParams.95)]);
    Pawn.Weapon.BaseParams.fViewKickHip_XMax = float(arrs[int(Pawn.Weapon.BaseParams.96)]);
    Pawn.Weapon.BaseParams.fViewKickHip_YMin = float(arrs[int(Pawn.Weapon.BaseParams.97)]);
    Pawn.Weapon.BaseParams.fViewKickHip_YMax = float(arrs[int(Pawn.Weapon.BaseParams.98)]);
    Pawn.Weapon.BaseParams.fViewKickHip_Accel = float(arrs[int(Pawn.Weapon.BaseParams.99)]);
    Pawn.Weapon.BaseParams.fViewKickHip_Decel = float(arrs[int(Pawn.Weapon.BaseParams.100)]);
    Pawn.Weapon.BaseParams.fViewKickHip_StayTime = float(arrs[int(Pawn.Weapon.BaseParams.101)]);
    Pawn.Weapon.BaseParams.fViewKickHip_DecaySpeed = float(arrs[int(Pawn.Weapon.BaseParams.102)]);
    Pawn.Weapon.BaseParams.fViewKickHip_DecayTimeFast = float(arrs[int(Pawn.Weapon.BaseParams.103)]);
    Pawn.Weapon.BaseParams.fViewKickAds_XMin = float(arrs[int(Pawn.Weapon.BaseParams.104)]);
    Pawn.Weapon.BaseParams.fViewKickAds_XMax = float(arrs[int(Pawn.Weapon.BaseParams.105)]);
    Pawn.Weapon.BaseParams.fViewKickAds_YMin = float(arrs[int(Pawn.Weapon.BaseParams.106)]);
    Pawn.Weapon.BaseParams.fViewKickAds_YMax = float(arrs[int(Pawn.Weapon.BaseParams.107)]);
    Pawn.Weapon.BaseParams.fViewKickAds_Accel = float(arrs[int(Pawn.Weapon.BaseParams.108)]);
    Pawn.Weapon.BaseParams.fViewKickAds_Decel = float(arrs[int(Pawn.Weapon.BaseParams.109)]);
    Pawn.Weapon.BaseParams.fViewKickAds_StayTime = float(arrs[int(Pawn.Weapon.BaseParams.110)]);
    Pawn.Weapon.BaseParams.fViewKickAds_DecaySpeed = float(arrs[int(Pawn.Weapon.BaseParams.111)]);
    Pawn.Weapon.BaseParams.fViewKickAds_DecayTimeFast = float(arrs[int(Pawn.Weapon.BaseParams.112)]);
    Pawn.Weapon.BaseParams.fHitMoveSpeed = float(arrs[int(Pawn.Weapon.BaseParams.141)]);
    Pawn.Weapon.BaseParams.fHitMoveTime = float(arrs[int(Pawn.Weapon.BaseParams.142)]);
    Pawn.Weapon.BaseParams.fHitMoveDelay = float(arrs[int(Pawn.Weapon.BaseParams.143)]);
    Pawn.Weapon.BaseParams.fSprintSpeed = float(arrs[int(Pawn.Weapon.BaseParams.144)]);
    Pawn.Weapon.BaseParams.fRunSpeed = float(arrs[int(Pawn.Weapon.BaseParams.145)]);
    Pawn.Weapon.BaseParams.fAimRunSpeed = float(arrs[int(Pawn.Weapon.BaseParams.148)]);
    Pawn.Weapon.BaseParams.fFireDelay = float(arrs[int(Pawn.Weapon.BaseParams.10)]);
    Pawn.Weapon.BaseParams.fDamRange_Eff = float(arrs[int(Pawn.Weapon.BaseParams.40)]);
    Pawn.Weapon.BaseParams.fDamRange_Max = float(arrs[int(Pawn.Weapon.BaseParams.41)]);
    Pawn.Weapon.BaseParams.fDamWallShot = float(arrs[int(Pawn.Weapon.BaseParams.39)]);
    Pawn.Weapon.BaseParams.fHitGunKick = float(arrs[int(Pawn.Weapon.BaseParams.52)]);
    Pawn.Weapon.BaseParams.fExplRad_Inner = float(arrs[int(Pawn.Weapon.BaseParams.66)]);
    Pawn.Weapon.BaseParams.fExplRad_Outer = float(arrs[int(Pawn.Weapon.BaseParams.67)]);
    Pawn.Weapon.BaseParams.fExplRad_Effect = float(arrs[int(Pawn.Weapon.BaseParams.68)]);
    Pawn.Weapon.BaseParams.fExplForce_Effect = float(arrs[int(Pawn.Weapon.BaseParams.69)]);
    Pawn.Weapon.BaseParams.fExplDam_Inner = float(arrs[int(Pawn.Weapon.BaseParams.70)]);
    Pawn.Weapon.BaseParams.fExplDam_Outer = float(arrs[int(Pawn.Weapon.BaseParams.71)]);
    Pawn.Weapon.BaseParams.iSpread_Visual_Add = int(arrs[int(Pawn.Weapon.BaseParams.80)]);
    Pawn.Weapon.BaseParams.fSpread_Shotgun = float(arrs[int(Pawn.Weapon.BaseParams.81)]);
    Pawn.Weapon.BaseParams.fSpread_Jump = float(arrs[int(Pawn.Weapon.BaseParams.82)]);
    Pawn.Weapon.BaseParams.fSpread_Ducked_Min = float(arrs[int(Pawn.Weapon.BaseParams.85)]);
    Pawn.Weapon.BaseParams.fSpread_Ducked_Max = float(arrs[int(Pawn.Weapon.BaseParams.86)]);
    Pawn.Weapon.BaseParams.fSpread_Prone_Min = float(arrs[int(Pawn.Weapon.BaseParams.87)]);
    Pawn.Weapon.BaseParams.fSpread_Prone_Max = float(arrs[int(Pawn.Weapon.BaseParams.88)]);
    Pawn.Weapon.BaseParams.fSpread_Ducked_Reduce = float(arrs[int(Pawn.Weapon.BaseParams.93)]);
    Pawn.Weapon.BaseParams.fSpread_Prone_Reduce = float(arrs[int(Pawn.Weapon.BaseParams.94)]);
    Pawn.Weapon.BaseParams.fCrouchSpeed = float(arrs[int(Pawn.Weapon.BaseParams.146)]);
    Pawn.Weapon.BaseParams.fPronedSpeed = float(arrs[int(Pawn.Weapon.BaseParams.147)]);
    Pawn.Weapon.BaseParams.fAimCrouchSpeed = float(arrs[int(Pawn.Weapon.BaseParams.149)]);
    Pawn.Weapon.BaseParams.fZoomFOV = float(arrs[int(Pawn.Weapon.BaseParams.12)]);
    Pawn.Weapon.BaseParams.BulletType = Pawn.Weapon.BaseParams.GetBulletType(arrs[int(Pawn.Weapon.BaseParams.17)]);
    Pawn.Weapon.BaseParams.ProjMoveType = Pawn.Weapon.BaseParams.GetProjMoveType(arrs[int(Pawn.Weapon.BaseParams.18)]);
    Pawn.Weapon.BaseParams.iBulletCount = int(arrs[int(Pawn.Weapon.BaseParams.19)]);
    Pawn.Weapon.BaseParams.fProjSpeed = float(arrs[int(Pawn.Weapon.BaseParams.20)]);
    Pawn.Weapon.BaseParams.fFuseTime = float(arrs[int(Pawn.Weapon.BaseParams.29)]);
    Pawn.Weapon.BaseParams.bFuseImpactTime = bool(arrs[int(Pawn.Weapon.BaseParams.30)]);
    Pawn.Weapon.BaseParams.ReloadType = Pawn.Weapon.BaseParams.GetReloadType(arrs[int(Pawn.Weapon.BaseParams.59)]);
    Pawn.Weapon.BaseParams.bRechamber = bool(arrs[int(Pawn.Weapon.BaseParams.60)]);
    Pawn.Weapon.BaseParams.fRechamberRate = float(arrs[int(Pawn.Weapon.BaseParams.61)]);
    Pawn.Weapon.BaseParams.fReloadRate = float(arrs[int(Pawn.Weapon.BaseParams.62)]);
    Pawn.Weapon.BaseParams.fReloadEmptyRate = float(arrs[int(Pawn.Weapon.BaseParams.63)]);
    Pawn.Weapon.BaseParams.fReloadBeginRate = float(arrs[int(Pawn.Weapon.BaseParams.64)]);
    Pawn.Weapon.BaseParams.fReloadEndRate = float(arrs[int(Pawn.Weapon.BaseParams.65)]);
    Pawn.Weapon.BaseParams.iAmmo_Initial = int(arrs[int(Pawn.Weapon.BaseParams.72)]);
    Pawn.Weapon.BaseParams.iAmmo_Magazine = int(arrs[int(Pawn.Weapon.BaseParams.73)]);
    Pawn.Weapon.BaseParams.iAmmo_Reload = int(arrs[int(Pawn.Weapon.BaseParams.74)]);
    Pawn.Weapon.BaseParams.iAmmo_Max = int(arrs[int(Pawn.Weapon.BaseParams.75)]);
    Pawn.Weapon.BaseParams.fBreathRadius_Idle = float(arrs[int(Pawn.Weapon.BaseParams.113)]);
    Pawn.Weapon.BaseParams.fBreathSpeed_Idle = float(arrs[int(Pawn.Weapon.BaseParams.114)]);
    Pawn.Weapon.BaseParams.fBreathRadius_Aim = float(arrs[int(Pawn.Weapon.BaseParams.115)]);
    Pawn.Weapon.BaseParams.fBreathSpeed_Aim = float(arrs[int(Pawn.Weapon.BaseParams.116)]);
    Pawn.Weapon.BaseParams.fBreathRadius_DuckedAim = float(arrs[int(Pawn.Weapon.BaseParams.117)]);
    Pawn.Weapon.BaseParams.fBreathSpeed_DuckedAim = float(arrs[int(Pawn.Weapon.BaseParams.118)]);
    Pawn.Weapon.BaseParams.fBreathRadius_ProneAim = float(arrs[int(Pawn.Weapon.BaseParams.119)]);
    Pawn.Weapon.BaseParams.fBreathSpeed_ProneAim = float(arrs[int(Pawn.Weapon.BaseParams.120)]);
    Pawn.Weapon.BaseParams.fBobWeapon_Sprint_Move = float(arrs[int(Pawn.Weapon.BaseParams.121)]);
    Pawn.Weapon.BaseParams.fBobWeapon_sprint_y = float(arrs[int(Pawn.Weapon.BaseParams.122)]);
    Pawn.Weapon.BaseParams.fBobScreen_Sprint_Move = float(arrs[int(Pawn.Weapon.BaseParams.123)]);
    Pawn.Weapon.BaseParams.fBobScreen_sprint_y = float(arrs[int(Pawn.Weapon.BaseParams.124)]);
    Pawn.Weapon.BaseParams.fBobWeapon_Ads_Move = float(arrs[int(Pawn.Weapon.BaseParams.125)]);
    Pawn.Weapon.BaseParams.fBobWeapon_ads_move_y = float(arrs[int(Pawn.Weapon.BaseParams.126)]);
    Pawn.Weapon.BaseParams.fBobScreen_Ads_Move = float(arrs[int(Pawn.Weapon.BaseParams.127)]);
    Pawn.Weapon.BaseParams.fBobScreen_ads_move_y = float(arrs[int(Pawn.Weapon.BaseParams.128)]);
    Pawn.Weapon.BaseParams.fBobWeapon_Move = float(arrs[int(Pawn.Weapon.BaseParams.129)]);
    Pawn.Weapon.BaseParams.fBobWeapon_move_y = float(arrs[int(Pawn.Weapon.BaseParams.130)]);
    Pawn.Weapon.BaseParams.fBobScreen_Move = float(arrs[int(Pawn.Weapon.BaseParams.131)]);
    Pawn.Weapon.BaseParams.fBobScreen_move_y = float(arrs[int(Pawn.Weapon.BaseParams.132)]);
    Pawn.Weapon.BaseParams.fBobWeapon_Ducked_Move = float(arrs[int(Pawn.Weapon.BaseParams.133)]);
    Pawn.Weapon.BaseParams.fBobWeapon_ducked_move_y = float(arrs[int(Pawn.Weapon.BaseParams.134)]);
    Pawn.Weapon.BaseParams.fBobScreen_Ducked_Move = float(arrs[int(Pawn.Weapon.BaseParams.135)]);
    Pawn.Weapon.BaseParams.fBobScreen_ducked_move_y = float(arrs[int(Pawn.Weapon.BaseParams.136)]);
    Pawn.Weapon.BaseParams.fBobScreen_Prone_Move = float(arrs[int(Pawn.Weapon.BaseParams.137)]);
    Pawn.Weapon.BaseParams.fBobScreen_prone_move_y = float(arrs[int(Pawn.Weapon.BaseParams.138)]);
    Pawn.Weapon.BaseParams.fSprintStaminaRate = float(arrs[int(Pawn.Weapon.BaseParams.139)]);
    Pawn.Weapon.BaseParams.fStaminaRecovery = float(arrs[int(Pawn.Weapon.BaseParams.140)]);
    Pawn.Weapon.BaseParams.fHitMoveSpeed = float(arrs[int(Pawn.Weapon.BaseParams.141)]);
    Pawn.Weapon.BaseParams.fHitMoveTime = float(arrs[int(Pawn.Weapon.BaseParams.142)]);
    Pawn.Weapon.BaseParams.fHitMoveDelay = float(arrs[int(Pawn.Weapon.BaseParams.143)]);
    Pawn.Weapon.BaseParams.fAnimRate_PutDown = float(arrs[int(Pawn.Weapon.BaseParams.150)]);
    Pawn.Weapon.BaseParams.fAnimRate_PutDown_Quick = float(arrs[int(Pawn.Weapon.BaseParams.151)]);
    Pawn.Weapon.BaseParams.bApplyQuickDrop = bool(arrs[int(Pawn.Weapon.BaseParams.152)]);
    Pawn.Weapon.BaseParams.fAnimRate_BringUp = float(arrs[int(Pawn.Weapon.BaseParams.153)]);
    Pawn.Weapon.BaseParams.fAnimRate_SprintBringUp = float(arrs[int(Pawn.Weapon.BaseParams.154)]);
    Pawn.Weapon.BaseParams.fAnimRate_AdsOn = float(arrs[int(Pawn.Weapon.BaseParams.155)]);
    Pawn.Weapon.BaseParams.fAnimRate_AdsOff = float(arrs[int(Pawn.Weapon.BaseParams.156)]);
    Pawn.Weapon.BaseParams.fMaxPitch = float(arrs[int(Pawn.Weapon.BaseParams.169)]);
    Pawn.Weapon.BaseParams.CrosshairType = Pawn.Weapon.BaseParams.GetCrosshairType(arrs[int(Pawn.Weapon.BaseParams.170)]);
    Pawn.Weapon.BaseParams.CrosshairImage = arrs[int(Pawn.Weapon.BaseParams.171)];
    Pawn.Weapon.BaseParams.fMovePivot = float(arrs[int(Pawn.Weapon.BaseParams.172)]);
    Pawn.Weapon.BaseParams.bOverHeat = bool(arrs[int(Pawn.Weapon.BaseParams.14)]);
    Pawn.Weapon.BaseParams.fOverHeat_Up = float(arrs[int(Pawn.Weapon.BaseParams.15)]);
    Pawn.Weapon.BaseParams.fOverHeat_Down = float(arrs[int(Pawn.Weapon.BaseParams.16)]);
    Pawn.Weapon.BaseParams.bExplodeCollide = bool(arrs[int(Pawn.Weapon.BaseParams.21)]);
    Pawn.Weapon.BaseParams.bBulletLandExplode = bool(arrs[int(Pawn.Weapon.BaseParams.22)]);
    Pawn.Weapon.BaseParams.bProjTakeDamage = bool(arrs[int(Pawn.Weapon.BaseParams.23)]);
    Pawn.Weapon.BaseParams.fProjDecelEachBound = float(arrs[int(Pawn.Weapon.BaseParams.24)]);
    Pawn.Weapon.BaseParams.fProjSpin = float(arrs[int(Pawn.Weapon.BaseParams.25)]);
    Pawn.Weapon.BaseParams.fProjThrowPitch = float(arrs[int(Pawn.Weapon.BaseParams.26)]);
    Pawn.Weapon.BaseParams.fBulletGravity = float(arrs[int(Pawn.Weapon.BaseParams.27)]);
    // End:0x27F9
    if(Pawn.Weapon.BaseParams.fBulletGravity == 0.0000000)
    {
        Pawn.Weapon.BaseParams.fBulletGravity = 1.0000000;
    }
    Pawn.Weapon.BaseParams.iBombWeaponID = int(float(arrs[int(Pawn.Weapon.BaseParams.28)]));
    Pawn.Weapon.BaseParams.fActiveTime = float(arrs[int(Pawn.Weapon.BaseParams.31)]);
    Pawn.Weapon.BaseParams.i2ndBulletCount = int(arrs[int(Pawn.Weapon.BaseParams.32)]);
    Pawn.Weapon.BaseParams.fMomentum = float(arrs[int(Pawn.Weapon.BaseParams.33)]);
    Pawn.Weapon.BaseParams.fMomentum_Pawn = float(arrs[int(Pawn.Weapon.BaseParams.34)]);
    Pawn.Weapon.BaseParams.fDamPerc_Heli = float(arrs[int(Pawn.Weapon.BaseParams.49)]);
    Pawn.Weapon.BaseParams.fDamPerc_SentryGun = float(arrs[int(Pawn.Weapon.BaseParams.50)]);
    Pawn.Weapon.BaseParams.bHitEffFriendly = bool(arrs[int(Pawn.Weapon.BaseParams.51)]);
    Pawn.Weapon.BaseParams.fHitStunTime = float(arrs[int(Pawn.Weapon.BaseParams.53)]);
    Pawn.Weapon.BaseParams.fHitFlashTime = float(arrs[int(Pawn.Weapon.BaseParams.55)]);
    Pawn.Weapon.BaseParams.fHitEAXEffectTime = float(arrs[int(Pawn.Weapon.BaseParams.56)]);
    Pawn.Weapon.BaseParams.strHitEAXEffectClass = arrs[int(Pawn.Weapon.BaseParams.57)];
    Pawn.Weapon.BaseParams.fHitFireTime = float(arrs[int(Pawn.Weapon.BaseParams.58)]);
    Pawn.Weapon.BaseParams.fSway_HipX_Max = float(arrs[int(Pawn.Weapon.BaseParams.157)]);
    Pawn.Weapon.BaseParams.fSway_HipX_Incr = float(arrs[int(Pawn.Weapon.BaseParams.158)]);
    Pawn.Weapon.BaseParams.fSway_HipX_Speed = float(arrs[int(Pawn.Weapon.BaseParams.159)]);
    Pawn.Weapon.BaseParams.fSway_HipY_Max = float(arrs[int(Pawn.Weapon.BaseParams.160)]);
    Pawn.Weapon.BaseParams.fSway_HipY_Incr = float(arrs[int(Pawn.Weapon.BaseParams.161)]);
    Pawn.Weapon.BaseParams.fSway_HipY_Speed = float(arrs[int(Pawn.Weapon.BaseParams.162)]);
    Pawn.Weapon.BaseParams.fSway_AdsX_Max = float(arrs[int(Pawn.Weapon.BaseParams.163)]);
    Pawn.Weapon.BaseParams.fSway_AdsX_Incr = float(arrs[int(Pawn.Weapon.BaseParams.164)]);
    Pawn.Weapon.BaseParams.fSway_AdsX_Speed = float(arrs[int(Pawn.Weapon.BaseParams.165)]);
    Pawn.Weapon.BaseParams.fSway_AdsY_Max = float(arrs[int(Pawn.Weapon.BaseParams.166)]);
    Pawn.Weapon.BaseParams.fSway_AdsY_Incr = float(arrs[int(Pawn.Weapon.BaseParams.167)]);
    Pawn.Weapon.BaseParams.fSway_AdsY_Speed = float(arrs[int(Pawn.Weapon.BaseParams.168)]);
    Pawn.Weapon.BaseParams.fNPCSpreadRate = float(arrs[int(Pawn.Weapon.BaseParams.180)]);
    Pawn.Weapon.BaseParams.fNPCRateOfFire = float(arrs[int(Pawn.Weapon.BaseParams.181)]);
    Pawn.Weapon.BaseParams.iNPCFire = int(arrs[int(Pawn.Weapon.BaseParams.182)]);
    i = 0;
    J0x2FE2:
...
function DisplayDebugChan1(Canvas Canvas)
{
    ...
    Canvas.SetPos(10.0000000, Canvas.ClipY / float(3));
    Canvas.DrawText("======== Shot Gun ========");
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(20));
    Canvas.DrawText("ISFiring = " $ string(Gun.IsFiring()));
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(40));
    Canvas.DrawText("Mode[0] iFireCount = " $ string(Gun.FireMode[0].iFireCount));
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(60));
    Canvas.DrawText("Mode[1] iFireCount = " $ string(Gun.FireMode[1].iFireCount));
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(80));
    Canvas.DrawText("NextFireTime = " $ string(Gun.FireMode[0].NextFireTime));
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(100));
    Canvas.DrawText("Level Time = " $ string(Level.TimeSeconds));
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(120));
    Canvas.DrawText("IsReadyFirebulletType = " $ string(Gun.IsReadyFirebulletType));
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(140));
...
function DisplayDebugPHJ(Canvas Canvas)
{
    ...
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(1000));
    Canvas.DrawText("ads Off = " $ string(self.Pawn.Weapon.BaseParams.fAnimRate_AdsOff));
    Canvas.SetDrawColor(byte(255), byte(255), byte(255));
    //return;    
}

exec function SetKillNum(int i)
{
    self.PlayerReplicationInfo.KillSuccession = i;
    //return;    
}

exec function AddKill()
{
    self.PlayerReplicationInfo.KillSuccession++;
    self.PlayerReplicationInfo.Kills++;
    //return;    
}

exec function EnableSkillSlot(int enableNum)
{
    local wGameManager GameMgr;

    GameMgr = Level.GameMgr;
    GameMgr.EnableSkillSlot[2] = enableNum;
    GameMgr.EnableSkillSlot[3] = enableNum;
    //return;    
}
...
{
    local Pawn myPawn;
    local Vehicle vehiclePawn;

    vehiclePawn = Vehicle(Pawn);
    // End:0x32
    if(vehiclePawn != none)
    {
        myPawn = vehiclePawn.Driver;        
    }
    else
    {
        myPawn = Pawn;
...
state PlayerWalking
{
    ...
    function PlayerMove(float DeltaTime)
    {
        ...
        if(int(19) == int(Pawn.TypeOfWeapon))
        {
            ...
            if(int(Pawn.Weapon.5) == int(Pawn.Weapon.ClientState))
            {
                ViewRotation.Pitch = ViewRotation.Pitch & 65535;
                // End:0x447
                if(32768 > ViewRotation.Pitch)
                {
                    ViewRotation.Pitch -= int(float(20000) * DeltaTime);
                    // End:0x444
                    if(0 > ViewRotation.Pitch)
                    {
    ...
    function BeginState()
    {
        ...
        if(Pawn != none)
        {
            ...
            // End:0x27E
            if((((self == Level.GetLocalPlayerController()) && Pawn.PlayerReplicationInfo.IsInvulnerable) && Level.GetMatchMaker().kGame_GameMode != Class'Engine.wGameSettings'.static.GetModeIndex_SD()) && !GameReplicationInfo.WaitingForStart)
            {
                // End:0x269
...
{
    ignores SyncLocation, ProcessMove, PlayerMove, EndState, BeginState, Timer, 
	    AltFire, Fire, SwitchWeapon, Jump, ChangeCamView;
    ...
    function PlayerMove(float DeltaTime)
    {
        ...
        if(iGMCamMode != 3)
        {
            Acceleration = 0.0200000 * ((((aForward * X) + (aStrafe * Y)) + (GmAccUp * vect(0.0000000, 0.0000000, 1.0000000))) + (GmAccDown * vect(0.0000000, 0.0000000, 1.0000000)));
            // End:0x1C0
            if(int(Role) < int(ROLE_Authority))
            {
                ReplicateMove(DeltaTime, Acceleration, 0, rot(0, 0, 0));                
...
state WaitingForStart extends PlayerWaiting
{
    ...
    function PlayerMove(float DeltaTime)
    {
        ...
        if(((Pawn.PlayerReplicationInfo != none) && Pawn.PlayerReplicationInfo.IsIntervented) && Pawn.PlayerReplicationInfo.NumLives <= 1)
        {
            ...
            {
                // End:0x7C
                case Class'Engine.wGameSettings'.static.GetModeIndex_SD():
                // End:0xFA
                case Class'Engine.wGameSettings'.static.GetModeIndex_Sabotage():
                    // End:0xFA
...
state Dead
{
    ignores EndState, BeginState, CheckNextRespawn, Timer, AutoRespawn, SetCameraDeltaRotation, 
	    UpdateRotation, FindGoodView, PlayerMove, ServerMove, Use, 
	    AltFire, Fire, SelectQuickSlot, ServerReStartPlayer, IsDead, 
	    ThrowWeapon;
    ...
    function AutoRespawn()
    {
        ...
        fRespawnTimeLength = AdjustRespawnTime();
        // End:0x6E
    ...
    function bool CheckNextRespawn()
    {
        ...
        return !(iMaxLives > 0) && PlayerReplicationInfo.NumLives >= iMaxLives;
        //return;        
    }
...
defaultproperties
{
    ...
    bCanOpenDoors=true
    bCanDoSpecial=true
    fCrouchingTimeLimit=0.3500000
    fProningTimeLimit=0.5000000
