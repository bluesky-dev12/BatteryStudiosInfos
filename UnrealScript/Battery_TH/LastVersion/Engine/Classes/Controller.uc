...
var Pawn Pawn;
var Controller.ECONTROLLER_TYPE eControllerType;
...
function SendMessageSprintTime()
{
    ...
    {
        self.ReceiveMessage_QuestType2(Class'Engine.wMessage_Quest', Class'Engine.wMessage_Quest'.default.Code_Quest_SprintTime,,,, iSendSprintTime);
    ...
    if(P != none)
    {
        ...
        if(P != none)
        {
            ...
            if(P.GetTeamNum() == (GetTeamNum()))
            {
                ...
                {
                    PlayerController(P).ReceiveLocalizedMessage(Class'Engine.wMessage_Game', Class'Engine.wMessage_Game'.default.Code_OurUAVOnline);
                }
                P.ClientUAV(Class'Engine.GameInfo'.default.UAVDuration);                
            }
            else
            {
                // End:0x141
                if(P.IsA('PlayerController'))
                {
                    PlayerController(P).ReceiveLocalizedMessage(Class'Engine.wMessage_Game', Class'Engine.wMessage_Game'.default.Code_EnemyUAVOnline);
                }
            }
        }
        P = P.nextController;
...
function Vector CalcAirStrikeLocation(float fMaxDist)
{
    ...
    // End:0x77
    if(kMM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_Defence())
    {
    ...
    {
        // End:0x16C
        if(((((kMM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_TeamDeath()) || kMM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_Domination()) || kMM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_BotTeamDeath()) || kMM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_BotDomination()) || kMM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_Alien())
        {
