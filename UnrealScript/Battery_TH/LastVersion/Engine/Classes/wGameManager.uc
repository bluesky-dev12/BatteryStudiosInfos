            ...
            if((wcip.iItemID > 0) && ItemID == wcip.iItemID)
            {
                ...
                if(i < WeaponCustomPartsParams.Length)
                {
                    ...
                    if((IsUsablePartItem(wcip.iItemID, i)) > 0)
                    {
                        ...
                        if(wcpp.iSkillID != 0)
                        {
                            itemBox.PartAllList[pgcount].SkillImage = Texture(DynamicLoadObject("Warfare_TH_UI_UI.Store.icon_rem_skil", Class'Engine.Texture'));
...
function LoadDefenceShopParam()
{
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params_TH.xlsx", "Defence_Shop", 2, 1, 1);
        // End:0x7B
        if(!bResult)
        {
            return;
...
function LoadDefenceRewardParam()
{
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params_TH.xlsx", "Defence_Reward", 2, 1, 1);
        // End:0x7D
        if(!bResult)
        {
            return;
...
defaultproperties
{
    ...
    LevelImages[2]="Warfare_TH_UI_UI.Lv_Mark.Lv_Mark_3"
