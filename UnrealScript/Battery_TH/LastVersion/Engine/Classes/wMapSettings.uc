...
private function bool _isValidMap(string fileName, optional bool bServiceBuild)
{
    ...
    return IsValidMap_THAILAND(LocStr, bServiceBuild);
    //return;    
}
...
{
    // End:0xB2
    if(((((((LocStr == "dm-vintage") || LocStr == "dm-bootcamp") || LocStr == "dm-cqbhouse") || LocStr == "dm-arcticwind") || LocStr == "dm-silo") || LocStr == "dm-downtown") || LocStr ~= "TUT-BasicTraining")
    {
        return true;
    }
    return false;
...
{
    // End:0x1A5
    if(((((((((((((((((LocStr == "dm-bootcamp") || LocStr == "dm-cqbhouse") || LocStr == "dm-arcticwind") || LocStr == "dm-downtown") || LocStr == "dm-quarterblow") || LocStr == "dm-mirage") || LocStr == "dm-newyork") || LocStr == "dm-bigbang") || LocStr == "dm-inferno") || LocStr == "dm-repair") || LocStr == "dm-syria") || LocStr == "dm-watchtower") || LocStr ~= "dm-burningcity") || LocStr == "dm-highway") || LocStr ~= "dm-whiteout") || LocStr ~= "dm-pattaya") || LocStr == "dm-moscow")
    {
        return true;
    }
    return false;
...
function array<wMapInfo> GetAllMapInfos(optional bool bServiceBuild)
{
    ...
    Class'Engine.CacheManager'.static.GetMapList(List);
...
function int IsGameModeEnable(int MapID, int GameModeIdx)
{
    ...
    // End:0xA3
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_TeamDeath())
    {
        return int(GM.MapInfos[idx].ModeTDM);
    }
    // End:0xDC
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_SD())
    {
        return int(GM.MapInfos[idx].ModeSD);
    }
    // End:0x115
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_DeathMatch())
    {
        return int(GM.MapInfos[idx].ModeFFA);
    }
    // End:0x14E
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_Domination())
    {
        return int(GM.MapInfos[idx].ModeDomination);
    }
    // End:0x187
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_Sabotage())
    {
        return int(GM.MapInfos[idx].ModeSabotage);
    }
    // End:0x1C0
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_BotTeamDeath())
    {
        return int(GM.MapInfos[idx].ModeBotTDM);
    }
    // End:0x1F9
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_BotDomination())
    {
        return int(GM.MapInfos[idx].ModeBotDomination);
    }
    // End:0x232
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_BotDeathMatch())
    {
        return int(GM.MapInfos[idx].ModeBotFFA);
    }
    // End:0x259
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_BotTutorial())
    {
        // End:0x259
        if(MapID != 29)
        {
    ...
    // End:0x292
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_BotTeamDeathBeginner())
    {
        return int(GM.MapInfos[idx].ModeBotBeginner);
    }
    // End:0x2CB
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_Defence())
    {
        return int(GM.MapInfos[idx].ModeDefence);
    }
    // End:0x304
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_DOA())
    {
        return int(GM.MapInfos[idx].ModeDOA);
    }
    // End:0x33D
    if(GameModeIdx == Class'Engine.wGameSettings'.static.GetModeIndex_Alien())
    {
