...
function LoadCacheMoveParam()
{
    ...
    MyPlayer.F_DiagmoveRatio = 0.9000000;
    MyPlayer.SideMoveRatio = 0.9000000;
    MyPlayer.B_DiagmoveRatio = 0.9000000;
    MyPlayer.BackMoveRatio = 0.9000000;
    MyPlayer.AccelRate = 1200.0000000;
    ...
    MyPlayer.Land_Dropspeed_Rate = 1.0000000;
...
event InitMyPlayer()
{
    ...
    if(MyPlayer == none)
    {
        MyPlayer = new Class'Engine.wMyPlayerStatus';
    }
    //return;    
}
...
event AddBasePlayers()
{
    ...
    BasePlayers[i].Inven = new Class'Engine.wInventory';
    BasePlayers[i].Skills = new Class'Engine.wSkills';
    //return;    
}
