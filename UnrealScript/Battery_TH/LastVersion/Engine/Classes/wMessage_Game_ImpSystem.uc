...
var int Code_NotHasAmmoSemtexGrenade;
...
var localized string StrNotHasAmmoSemtexGrenade;
...
static function string GetString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2, optional Object OptionalObject)
{
    switch(Switch)
    {
        ...
        // End:0x183
        case default.Code_NotHasAmmoSemtexGrenade:
            return default.StrNotHasAmmoSemtexGrenade;
        // End:0x191
...
defaultproperties
{
    ...
    Code_NotHasAmmoSemtexGrenade=20025
    ...
    strNoWeapon="???????????????"
    strNoThrowingGreanade="???????????????????"
    strNoThrowingSmoke="????????????????????"
    strNoThrowingC4="????????????????????"
    strNotHasAmmoRPG7="??? RPG-7 ???????"
    strChangeQS[0]="???????????????? Basic Slot"
    strChangeQS[1]="???????????????? Slot 1"
    strChangeQS[2]="???????????????? Slot 2"
    strChangeQS[3]="???????????????? Slot 3"
    strChangeQS[4]="???????????????? Slot 4"
    strChangeQS[5]="???????????????? Slot 5"
    strChangeQSInPlayerWalking="????????????????????????????????? Respawn"
    strCloseQSTime="?????????????? ???????? Slot ????????"
    strCloseQSDistance="?????????????? ???????? Slot ????????"
    strQuickSlotChangeFailed="?????????? Slot ???????"
    strCloseQSWindow="????? Slot ?????????????????"
    strNotHasAmmoIncen="?????????????????????"
    strNotHasAmmoHellFire="????????????????????"
    StrNotHasAmmoSpiltGrenade="???????????????????????"
    StrNotHasAmmoSemtexGrenade="???????????????????"
    strNotReadyCoolTimeSkill="???????????????????????????"
    strHoldWeapon="Hold Weapon!!!"
    Code_HoldWeapon=20021
    strHoldFireByOverHeat="OverHeat ????????????"
    Code_HoldFireOverHeat=20022
    SoundNotReady="Warfare_Sound_ATS/cb/ats_cb_use_fail"
    Code_DFSupplyAmmo=20024
    strDFSupplyAmmo="+ %0 Supply Ammo!!!"
