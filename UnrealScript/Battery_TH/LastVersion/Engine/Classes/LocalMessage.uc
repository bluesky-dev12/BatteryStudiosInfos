...
static function Color GetColor(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
    ...
    {
        // End:0x30
        case Class'Engine.wMessage_Game_ImpSystem'.default.Code_EnableInstallSentryGun:
            return Class'Engine.Canvas'.static.MakeColor(0, byte(255), 0);
        // End:0x59
        case Class'Engine.wMessage_Game_ImpSystem'.default.Code_DisableInstallSentryGun:
            return Class'Engine.Canvas'.static.MakeColor(byte(255), 0, 0);
        // End:0xFFFF
        default:
            return default.DrawColor;
            break;
