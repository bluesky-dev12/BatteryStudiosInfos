...
event bool CreateBackGroundImage(wMatchMaker MatchMaker)
{
    ...
    else
    {
        ...
        ModeFB2.Length = 3;
        ModeFB2[0] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(0.0000000, 64.0000000, 256.0000000, 128.0000000);
        ModeFB2[1] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(0.0000000, 128.0000000, 256.0000000, 192.0000000);
        ModeFB2[2] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(0.0000000, 0.0000000, 304.0000000, 64.0000000);
        ModeHelp[0] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(0.0000000, 0.0000000, 120.0000000, 74.0000000);
        ModeHelp[1] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(0.0000000, 74.0000000, 120.0000000, 148.0000000);
        ModeHelp[2] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(0.0000000, 148.0000000, 120.0000000, 222.0000000);
        ModeHelp[3] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(0.0000000, 222.0000000, 120.0000000, 296.0000000);
        ModeHelp[4] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(0.0000000, 296.0000000, 120.0000000, 370.0000000);
        ModeHelp[5] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(0.0000000, 370.0000000, 120.0000000, 444.0000000);
        ModeHelp[6] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(120.0000000, 0.0000000, 240.0000000, 74.0000000);
        ModeHelp[7] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(120.0000000, 74.0000000, 240.0000000, 148.0000000);
        ModeHelp[8] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(120.0000000, 148.0000000, 240.0000000, 222.0000000);
        ModeHelp[9] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(120.0000000, 222.0000000, 240.0000000, 296.0000000);
        ModeHelp[10] = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(120.0000000, 296.0000000, 240.0000000, 370.0000000);
        SelectHelp = Rand(11);
        Initialize();
        Mat_img_help_line = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_help_line", Class'Engine.Material'));
        Mat_img_hud_text = Material(DynamicLoadObject("Warfare_TH_UI_HUD.Text.img_hud_text", Class'Engine.Material'));
        Mat_img_hud_text2 = Material(DynamicLoadObject("Warfare_TH_UI_HUD.Text.img_hud_text2", Class'Engine.Material'));
        Mat_img_help_all = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_loading_help_all", Class'Engine.Material'));
        Mat_gauge_loading = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.gauge_loading", Class'Engine.Material'));
        Mat_gauge_loading_back = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.gauge_loading_back", Class'Engine.Material'));
        Mat_img_point_help = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_point_help", Class'Engine.Material'));
        Mat_img_load_pllist = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_load_pllist", Class'Engine.Material'));
        Mat_img_SupplyIcon[int(1)] = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_loading_supplyicon_UAV", Class'Engine.Material'));
        Mat_img_SupplyIcon[int(2)] = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_loading_supplyicon_helicopter", Class'Engine.Material'));
        Mat_img_SupplyIcon[int(3)] = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_loading_supplyicon_bombing", Class'Engine.Material'));
        Mat_img_SupplyIcon[int(4)] = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_loading_supplyicon_sent", Class'Engine.Material'));
        Mat_img_RespawnLevelStar[0] = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_loading_respawnlevel_star01", Class'Engine.Material'));
        Mat_img_RespawnLevelStar[1] = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_loading_respawnlevel_star02", Class'Engine.Material'));
        Mat_img_RespawnLevelStar[2] = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_loading_respawnlevel_star03", Class'Engine.Material'));
        Mat_img_RespawnLevelStar[3] = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_loading_respawnlevel_star04", Class'Engine.Material'));
        Mat_img_RespawnLevelStar[4] = Material(DynamicLoadObject("Warfare_TH_UI_Map.LoadingImage.img_loading_respawnlevel_star05", Class'Engine.Material'));
        // End:0xCF5
...
event DrawLoadingScreen(Canvas C)
{
    ...
    if(OtherLoadingState.Length > 0)
    {
        ...
        C.DrawColor = Class'Engine.Canvas'.static.MakeColorNoEmpty(byte(255), byte(255), byte(255), byte(255));
        fb = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(28.0000000 * ratioX, 447.0000000 * ratioY, 228.0000000 * ratioX, (462.0000000 * ratioY) + ((float(15) * ratioY) * float(TeamCountAF)));
        ...
        fb = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox((28.0000000 * ratioX) + listStepX, 447.0000000 * ratioY, (228.0000000 * ratioX) + listStepX, (462.0000000 * ratioY) + ((float(15) * ratioY) * float(TeamCountRSA)));
        img = Class'Engine.BTCustomDrawHK'.static.MakeImage(32, 32, 15, Mat_img_load_pllist);
        Class'Engine.BTCustomDrawHK'.static.DrawImage(C, img, fb.X1, fb.Y1, fb.X2, fb.Y2);
        ...
        if(i < OtherLoadingState.Length)
        {
            ...
            if(OtherLoadingState[i].LoadingMsgItem.TeamNum == 0)
            {
                ...
                Class'Engine.BTCustomDrawHK'.static.DrawString(C, OtherLoadingState[i].LoadingMsgItem.UserName, 3, 9.0000000, fb.X1, fb.Y1, fb.X2, fb.Y2,,, true);
                C.DrawColor = OtherLoadingState[i].LoadingMsgItem.StateColor;
                Class'Engine.BTCustomDrawHK'.static.DrawString(C, OtherLoadingState[i].strLoadingMsg, 5, 9.0000000, fb.X1, fb.Y1, fb.X2, fb.Y2,,, true);
                // [Explicit Continue]
                goto J0x8AF;
            }
            fbRSA.Y1 = fbRSA.Y2;
            ...
            C.DrawColor = OtherLoadingState[i].LoadingMsgItem.NameColor;
            Class'Engine.BTCustomDrawHK'.static.DrawString(C, OtherLoadingState[i].LoadingMsgItem.UserName, 3, 9.0000000, fbRSA.X1 + listStepX, fbRSA.Y1, fbRSA.X2 + listStepX, fbRSA.Y2,,, true);
            C.DrawColor = OtherLoadingState[i].LoadingMsgItem.StateColor;
            Class'Engine.BTCustomDrawHK'.static.DrawString(C, OtherLoadingState[i].strLoadingMsg, 5, 9.0000000, fbRSA.X1 + listStepX, fbRSA.Y1, fbRSA.X2 + listStepX, fbRSA.Y2,,, true);
            J0x8AF:
    ...
    if(ModeIndex < ModeFB.Length)
    {
        ...
        {
            Class'Engine.BTCustomDrawHK'.static.DrawString(C, GameSubMode, 5, 14.0000000, (fb.X1 + ((img.width * float(2)) / float(3))) * ratioX, ((fb.Y1 + img.Height) + float(5)) * ratioY, ((fb.X1 - float(25)) + img.width) * ratioX, ((fb.Y1 + img.Height) + float(25)) * ratioY, kShadowColor, 0, false);
        }
        Class'Engine.BTCustomDrawHK'.static.DrawString(C, ModeDescriptions[ModeIndex], 5, 13.0000000, 661.0000000 * ratioX, 53.0000000 * ratioY, 999.0000000 * ratioX, 72.0000000 * ratioY, kShadowColor, 0, false);        
    }
    else
    {
        // End:0xE56
        ...
        {
            img = Class'Engine.BTCustomDrawHK'.static.MakeImage(256, 64, 0, Mat_img_hud_text2);
            C.DrawColor = Class'Engine.Canvas'.static.MakeColor(byte(255), byte(255), byte(255), byte(255));
            Class'Engine.BTCustomDrawHK'.static.DrawImageWithClipArea(C, img, fb.X1, fb.Y1, fb.X1 + (img.width * ratioX), fb.Y1 + (img.Height * ratioY), ModeFB2[modeNameIndex].X1, ModeFB2[modeNameIndex].Y1, ModeFB2[modeNameIndex].X2, ModeFB2[modeNameIndex].Y2);
            // End:0xDF9
            if(MM.kGame_WeaponLimit != 0)
            {
                Class'Engine.BTCustomDrawHK'.static.DrawString(C, GameSubMode, 5, 14.0000000, (fb.X1 + ((img.width * float(2)) / float(3))) * ratioX, ((fb.Y1 + img.Height) + float(5)) * ratioY, ((fb.X1 - float(25)) + img.width) * ratioX, ((fb.Y1 + img.Height) + float(25)) * ratioY, kShadowColor, 0, false);
    ...
    {
        C.DrawColor = Class'Engine.Canvas'.static.MakeColor(byte(255), byte(255), byte(255), byte(255));
        fb = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(715.0000000 * ratioX, 497.0000000 * ratioY, 872.0000000 * ratioX, 517.0000000 * ratioY);
        Class'Engine.BTCustomDrawHK'.static.DrawString(C, szMapInfo[0], 5, 17.0000000, fb.X1, fb.Y1, fb.X2, fb.Y2, kShadowColor, 0, false);
        // End:0xFFD
        if(MM.IsSDRespawn())
        {
        ...
        fb = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(893.0000000 * ratioX, 497.0000000 * ratioY, 1024.0000000 * ratioX, 517.0000000 * ratioY);
        Class'Engine.BTCustomDrawHK'.static.DrawString(C, GameRespawnType, 3, 17.0000000, fb.X1, fb.Y1, fb.X2, fb.Y2, kShadowColor, 0, false);
    }
    C.DrawColor = Class'Engine.Canvas'.static.MakeColor(byte(255), byte(255), byte(255), byte(255));
    fb = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(715.0000000 * ratioX, 530.0000000 * ratioY, 872.0000000 * ratioX, 550.0000000 * ratioY);
    Class'Engine.BTCustomDrawHK'.static.DrawString(C, szMapInfo[1], 5, 17.0000000, fb.X1, fb.Y1, fb.X2, fb.Y2, kShadowColor, 0, false);
    fb = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(890.0000000 * ratioX, 527.0000000 * ratioY, 1008.0000000 * ratioX, 553.0000000 * ratioY);
    img = Class'Engine.BTCustomDrawHK'.static.MakeImage(118, 26, 28, Mat_img_RespawnLevelStar[MapDifficulty - 1]);
    Class'Engine.BTCustomDrawHK'.static.DrawImageWithClipArea(C, img, fb.X1, fb.Y1, fb.X1 + (img.width * ratioX), fb.Y1 + (img.Height * ratioY), img.X, img.Y, img.X + img.width, img.Y + img.Height);
    Class'Engine.BTCustomDrawHK'.static.DrawString(C, szMapInfo[2], 3, 9.0000000, 19.0000000 * ratioX, 275.0000000 * ratioY, 232.0000000 * ratioX, 290.0000000 * ratioY, kShadowColor, 0, false);
    img = Class'Engine.BTCustomDrawHK'.static.MakeImage(120, 74, 28, Mat_img_help_all);
    fb = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(59.0000000 * ratioX, 301.0000000 * ratioY, 179.0000000 * ratioX, 375.0000000 * ratioY);
    Class'Engine.BTCustomDrawHK'.static.DrawImageWithClipArea(C, img, fb.X1, fb.Y1, fb.X1 + (img.width * ratioX), fb.Y1 + (img.Height * ratioY), ModeHelp[SelectHelp].X1, ModeHelp[SelectHelp].Y1, ModeHelp[SelectHelp].X2, ModeHelp[SelectHelp].Y2);
    fb = Class'Engine.BTCustomDrawHK'.static.GetDrawStringFloatBox(C, strModeHelp1[SelectHelp], 0, 9.0000000, 19.0000000 * ratioX, 380.0000000 * ratioY, 232.0000000 * ratioX, 395.0000000 * ratioY, kShadowColor);
    // End:0x15C1
    if((float(213) * ratioX) < (fb.X2 - fb.X1))
    {
        ...
        Class'Engine.BTCustomDrawHK'.static.DrawString(C, tmpStrTip, 0, 9.0000000, 19.0000000 * ratioX, 380.0000000 * ratioY, 232.0000000 * ratioX, 395.0000000 * ratioY, kShadowColor, 0, false);
        tmpStrTip = Mid(strModeHelp1[SelectHelp], StrLenPerOneLine, Len(strModeHelp1[SelectHelp]));
        Class'Engine.BTCustomDrawHK'.static.DrawString(C, tmpStrTip, 0, 9.0000000, 19.0000000 * ratioX, 396.0000000 * ratioY, 232.0000000 * ratioX, 411.0000000 * ratioY, kShadowColor, 0, false);        
    }
    else
    {
        Class'Engine.BTCustomDrawHK'.static.DrawString(C, strModeHelp1[SelectHelp], 0, 9.0000000, 19.0000000 * ratioX, 380.0000000 * ratioY, 232.0000000 * ratioX, 395.0000000 * ratioY, kShadowColor, 0, false);
    }
    SupplyAddCount = 0;
    i = 0;
    J0x162C:
    ...
    if(SupplyAddCount == 0)
    {
        Class'Engine.BTCustomDrawHK'.static.DrawString(C, CantUseSupplyLineText1, 4, 10.0000000, 13.0000000 * ratioX, 195.0000000 * ratioY, 226.0000000 * ratioX, 210.0000000 * ratioY, kShadowColor, 0, false);
        Class'Engine.BTCustomDrawHK'.static.DrawString(C, CantUseSupplyLineText2, 4, 10.0000000, 13.0000000 * ratioX, 211.0000000 * ratioY, 226.0000000 * ratioX, 226.0000000 * ratioY, kShadowColor, 0, false);        
    }
    else
    {
        i = 0;
        ...
        if(i < SupplyAddCount)
        {
            img = Class'Engine.BTCustomDrawHK'.static.MakeImage(68, 90, 28, Mat_img_SupplyIcon[SupplyImgNum[i]]);
            fb = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox((fbSupplyIcon[SupplyAddCount - 1].X1 + float(i * 71)) * ratioX, fbSupplyIcon[SupplyAddCount - 1].Y1 * ratioY, (fbSupplyIcon[SupplyAddCount - 1].X2 + float(i * 71)) * ratioX, fbSupplyIcon[SupplyAddCount - 1].Y2 * ratioY);
            Class'Engine.BTCustomDrawHK'.static.DrawImageWithClipArea(C, img, fb.X1, fb.Y1, fb.X1 + (img.width * ratioX), fb.Y1 + (img.Height * ratioY), img.X, img.Y, img.X + img.width, img.Y + img.Height);
            Class'Engine.BTCustomDrawHK'.static.DrawString(C, strSupplyIcon[SupplyImgNum[i]], 4, 10.0000000, (fbSupplyStr[SupplyAddCount - 1].X1 + float(i * 71)) * ratioX, fbSupplyStr[SupplyAddCount - 1].Y1 * ratioY, (fbSupplyStr[SupplyAddCount - 1].X2 + float(i * 71)) * ratioX, fbSupplyStr[SupplyAddCount - 1].Y2 * ratioY, kShadowColor, 0, false);
            i++;
            // [Loop Continue]
            goto J0x1721;
        }
    }
    C.DrawColor = Class'Engine.Canvas'.static.MakeColor(byte(255), 204, 0, byte(255));
    Class'Engine.BTCustomDrawHK'.static.DrawString(C, szMapInfo[3], 3, 9.0000000, 28.0000000 * ratioX, 137.0000000 * ratioY, 222.0000000 * ratioX, 152.0000000 * ratioY, kShadowColor, 0, false);
    // End:0x1A0A
    if(ModeIndex == Class'Engine.wGameSettings'.static.GetModeIndex_Defence())
    {
    ...
    Class'Engine.BTCustomDrawHK'.static.DrawString(C, strHelpTip, 0, 12.0000000, 37.0000000 * ratioX, 708.0000000 * ratioY, 760.0000000 * ratioX, 768.0000000 * ratioY, kShadowColor, 0, false);
    //return;    
}
...
defaultproperties
{
    ...
    strSupplyIcon[3]="Bombing"
    strSupplyIcon[4]="Sentrygun"
    strModeHelp1[0]="???????????????????????????????"
    strModeHelp1[1]="?????? Shift  ?????????"
    strModeHelp1[2]="??????? Helicopter pack ????????????? Helicopter ?????????"
    strModeHelp1[3]="??????? Bombing pack ??????????????? M777 ???????????"
    strModeHelp1[4]="??????? UAV pack ??????????????????????????????????????"
    strModeHelp1[5]="Health Pack ???????????????????????????????"
    strModeHelp1[6]="????????????? ATR ??????????????????"
    strModeHelp1[7]="????????????? Flame thrower ??????????????????"
    strModeHelp1[8]="????????? Machine gun ??????????????????"
    strModeHelp1[9]="Sniper Rifle ?????????????????????????????????????"
    strModeHelp1[10]="????????? E ?????????????????????????????"
    szTipText[0]="?????? Shift  ?????????"
    szTipText[1]="?????? Ctrl ?????????, ????, ??????? "
    ...
    szMapInfo[1]="Level: "
    szMapInfo[2]="Game Tip"
    szMapInfo[3]="Reward"
    szTipText_Defence[0]="Tip: ???????????????????????????????????"
    szTipText_Defence[1]="Tip: ????????????????????????????????????????"
    szTipText_Defence[2]="Tip: ??????? Point ??????????????????????????????"
    CantUseSupplyLineText1="?????????????????????????????????"
