...
var localized string WeaponLimitShotgunOnly;
var localized string WeaponLimitFlameOnly;
var string MapName;
...
function SetMissionInfo()
{
    ...
    switch(kMM.eWeaponLimit)
    {
        ...
        // End:0x121
        case kMM.8:
            limitWeapon = WeaponLimitShotgunOnly;
            bLimitWeapon = true;
            // End:0x153
            break;
        // End:0x145
        case kMM.10:
            limitWeapon = WeaponLimitFlameOnly;
            bLimitWeapon = true;
            // End:0x153
            break;
        // End:0xFFFF
...
defaultproperties
{
    ...
    wGM_Playlist_BG=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_gmmode_playerlist_back',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=256,Y2=48),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wGM_Players_HP=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_gmmode_players_hp',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=207,Y2=46),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wGM_TeamMark_AF=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_gmmode_teammark_all',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=256,Y2=51),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wGM_TeamMark_RSA=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_gmmode_teammark_all',RenderStyle=5,TextureCoords=(X1=256,Y1=0,X2=512,Y2=51),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wGM_ViewTarget=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_gmmode_mark_observeredplayer',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=310,Y2=48),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    IndicateDeads=true
    ...
    MissionNameTD="TeamDeathMatch"
    MissionNameSD="Search and Destroy"
    MissionNameDOMI="Domination"
    MissionNameSBT="Demolition"
    MissionNameDM="Free For All"
    MissionNameFM="Beginner  Mission"
    MissionNameTM="Tutorial"
    MissionNameDOA="Annihilation"
    ...
    WeaponLimitPistolOnly="Pistol Mode"
    WeaponLimitGrenadeOnly="Grenade Mode"
    WeaponLimitRPGOnly="??? RPG"
    WeaponLimitSROnly="????????"
    WeaponLimitSRBan="???????"
    WeaponLimitShotgunOnly="Shotgun Mode"
    WeaponLimitFlameOnly="Flame Thrower Mode"
    ...
    WContentBG=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_scoreboard_black_listmenu_back',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=32,Y2=32),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=467,OffsetY=225,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WListDivedBar=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.list_scoreboard_boardline',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=667,Y2=2),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WPingBack=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_scoreboard_ping_back',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=25,Y2=25),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WPing=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_scoreboard_ping_status',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=17,Y2=17),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    ScoreBoardTitleBG=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_scoreboard_blackstroke_back',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=465,OffsetY=93,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WDEFTITLE=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_scoreboard_teammark_all',RenderStyle=5,TextureCoords=(X1=0,Y1=188,X2=667,Y2=235),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=467,OffsetY=280,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
