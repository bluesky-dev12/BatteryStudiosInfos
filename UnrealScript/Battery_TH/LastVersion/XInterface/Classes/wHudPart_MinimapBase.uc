...
function DrawMinimap_NorthPole(Canvas C)
{
    ...
    mat = TexRotator(DynamicLoadObject("warfare_TH_ui_hud_etc.img_north_rot", Class'Engine.Material', true));
...
function DrawMinimap_SentryGun(Canvas C)
{
    local wSentryGunPawn sentryGunPawn;
    local float fMinimapX, fMinimapY;
    local int lp1;
    local float fWidth, fHeight;
    local SpriteWidget Sprite;
    local Rotator rotDefault;
    ...
    {
        sentryGunPawn = wSentryGunPawn(Level.SentryGuns[lp1]);
        // End:0x4D
        if(none == sentryGunPawn)
        {
            // [Explicit Continue]
            goto J0x1E8;
        }
        // End:0x62
        if(sentryGunPawn.bHidden)
        {
            // [Explicit Continue]
            goto J0x1E8;
        }
        // End:0x90
        if(HudOwner.PlayerOwner.GetTeamNum() != sentryGunPawn.TeamIndex)
        {
            // [Explicit Continue]
            goto J0x1E8;
        }
        CalculateMinimapPositionPawnCentering(HudOwner.PawnOwner, sentryGunPawn.Location, fMinimapX, fMinimapY);
        ClampMinimapPosition(fMinimapX, fMinimapY);
        Sprite = sentryGunPawn.MinimapIconAlly;
        SetupMinimapSpriteWidgetForDrawing(Sprite, rotDefault, fMinimapX, fMinimapY);
        fWidth = float(Sprite.WidgetTexture.MaterialUSize()) * IconSizeF;
        fHeight = float(Sprite.WidgetTexture.MaterialVSize()) * IconSizeF;
        C.SetPos((fMinimapX - (fWidth / float(2))) * _rX, (fMinimapY - (fHeight / float(2))) * _rY);
        C.DrawTile(Sprite.WidgetTexture, fWidth * _rX, fHeight * _rY, 0.0000000, 0.0000000, float(Sprite.WidgetTexture.MaterialUSize()), float(Sprite.WidgetTexture.MaterialVSize()));
        J0x1E8:
...
defaultproperties
{
    MinimapBG=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.hud_back_3',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=32,Y2=32),TextureScale=0.6500000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=9,OffsetY=9,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    MinimapMatMyself=TexRotator'Warfare_TH_UI_HUD_ETC.minimapicon.minimap_myself2_rot'
    MinimapMatAlly=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.minimap_our_team'
    MinimapMatAttackingAlly=FinalBlend'Warfare_TH_UI_HUD_ETC.minimapicon.minimap_our_team_comb_rot_fb'
    MinimapFCMatAlly=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.minimap_our_clan'
    MinimapFCMatAttackingAlly=FinalBlend'Warfare_TH_UI_HUD_ETC.minimapicon.minimap_our_clan_comb_rot_fb'
    MinimapMatRadioMessage=FinalBlend'Warfare_TH_UI_HUD_ETC.minimapicon.minimap_radio_final'
    MinimapDeadAlly=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.death_our',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapAttackingEnemies[0]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.enemy_target',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapAttackingEnemies[1]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.enemy_target',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapAttackingEnemies[2]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.enemy_target',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapDeadEnemies[0]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.death_enemy',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapDeadEnemies[1]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.death_enemy',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapDeadEnemies[2]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.death_enemy',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapAlien=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.enemy_target_monster_walk',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapStrikeAlly=(WidgetTexture=FinalBlend'Warfare_TH_UI_HUD_ETC.minimapicon.icon_wh_bom',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapStrikeEnem=(WidgetTexture=FinalBlend'Warfare_TH_UI_HUD_ETC.minimapicon.icon_r_bom',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapAirStrikeAllyRect=(WidgetTexture=FinalBlend'Warfare_TH_UI_HUD_ETC.minimapicon.img_area_bombing2_Ally',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=128,Y2=128),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapAirStrikeEnemRect=(WidgetTexture=FinalBlend'Warfare_TH_UI_HUD_ETC.minimapicon.img_area_bombing2',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=128,Y2=128),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    MinimapIconEnemyBoss[0]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.enemy_target_monster_midboss_alien',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapIconEnemyBoss[1]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.enemy_target_monster_midboss_omega',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapIconEnemyBoss[2]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.enemy_target_monster_finalboss_nemesis',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapIconEnemyBossBlend[0]=(WidgetTexture=FinalBlend'Warfare_TH_UI_HUD_ETC.minimapicon.icon_omega_finalblend',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapIconEnemyBossBlend[1]=(WidgetTexture=FinalBlend'Warfare_TH_UI_HUD_ETC.minimapicon.icon_alien_finalblend',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapIconEnemyBossBlend[2]=(WidgetTexture=FinalBlend'Warfare_TH_UI_HUD_ETC.minimapicon.icon_nemesis_finalblend',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    SpecialPositions_Image[0]=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.icon_mnmap_m2b'
    SpecialPositions_Image[1]=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.icon_mnmap_at4'
    SpecialPositions_Image[2]=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.icon_mnmap_m249'
    SpecialPositions_Image[3]=Texture'Warfare_TH_UI_HUD_ETC.minimapicon.icon_mnmap_m249'
    BaseColor=(R=255,G=255,B=255,A=255)
    IconSizeF=1.0000000
    DrawFrame=true
    UAVBG_Base=VariableTexPanner'Warfare_TH_UI_HUD_ETC.minimapicon.UAV4_VPan'
    UAVBG=TexRotator'Warfare_TH_UI_HUD_ETC.minimapicon.UAV4_Rot'
