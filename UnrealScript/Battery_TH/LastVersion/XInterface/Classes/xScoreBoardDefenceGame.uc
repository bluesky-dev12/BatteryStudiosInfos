...
function PostBeginPlay()
{
    ...
    ItemRewardBG = Class'Engine.BTCustomDrawHK'.static.MakeImage(169, 86, 0, Texture'Warfare_TH_UI_UI.Store.list_remodeling_remodelingitem');
    //return;    
}
...
defaultproperties
{
    lsScore="point"
    lsScoreOver="Points ???????"
    lsRewardScore="Game Reward"
    lsRewardClear="Clear Reward"
    lsRewardTitle="?????????????????????? "
