...
function CallSkill(optional int iKey, optional bool bRequire, optional bool iSucess)
{
    ...
    if(5 == iKey)
    {
        ...
        }/* !MISMATCHING REMOVE, tried If got Type:Else Position:0x0F3! */
        else
        {
            // End:0x46F
            if(6 == iKey)
...
function DrawMainScore(Canvas C)
{
    ...
    if(iTeamIndex == 0)
    {
        ...
        {
            CalculateCoordinateEx(C, WNowAFTeamisWin, 80.0000000, 42.0000000, calW);
            C.SetPos(calW.X1, calW.Y1);
        ...
        else
        {
            ...
            if(iScoreAF < iScoreRSA)
            {
                CalculateCoordinateEx(C, WNowAFTeamisLose, 80.0000000, 42.0000000, calW);
                C.SetPos(calW.X1, calW.Y1);
    ...
    else
    {
        ...
        if(iScoreAF > iScoreRSA)
        {
            CalculateCoordinateEx(C, WNowRSATeamisLose, 80.0000000, 42.0000000, calW);
            C.SetPos(calW.X1, calW.Y1);
        ...
        else
        {
            ...
            if(iScoreAF < iScoreRSA)
            {
                CalculateCoordinateEx(C, WNowRSATeamisWin, 80.0000000, 42.0000000, calW);
                C.SetPos(calW.X1, calW.Y1);
...
defaultproperties
{
    ...
    WGameTypeDOA=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text2',RenderStyle=5,TextureCoords=(X1=0,Y1=128,X2=256,Y2=192),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    strQuestNoUpdate="??????????????????????????? 3 ?? Quest Mission ???????????????????????"
    BeginMessageTD="???????????"
    ...
    LsReload="Reload"
    LsWarningAmmo="???????????"
    LsRechargingAmmo="In the Ammo-Box can be charged."
    LsConnectionInstability="???????????????????????????????????????????????????????????????"
    lsIsInvincible="????????????????? 3 ?????? ????????????????"
    lsIsInvincibleBeginner="????????????????? 5 ?????? ????????????????"
    safeZoneRandomRespawn="?????????????????????? \"Random Respawn\" ???????????????????"
    RespawnText="Respawn"
    ...
    WResultTeamMarkAF=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_teamemblem',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=207,Y2=256),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=518,OffsetY=369,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WResultTeamMarkRSA=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_teamemblem',RenderStyle=5,TextureCoords=(X1=207,Y1=0,X2=414,Y2=256),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=875,OffsetY=369,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamMarkHumanTeam=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_modestart_alienmode_teamemblem',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=313,Y2=242),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=313,OffsetY=242,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamMarkAlienTeam=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_modestart_alienmode_teamemblem',RenderStyle=5,TextureCoords=(X1=313,Y1=0,X2=626,Y2=242),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=313,OffsetY=242,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamBigMarkHumanTeam=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_HUD_etc_alienmode_emblem',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=492,Y2=370),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=150,OffsetY=405,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamBigMarkAlienTeam=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_HUD_etc_alienmode_emblem',RenderStyle=5,TextureCoords=(X1=492,Y1=0,X2=984,Y2=370),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=958,OffsetY=405,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WResultMarkHumanTeam=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_alienmode_teamemblem',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=293,Y2=256),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=495,OffsetY=369,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WResultMarkAlienTeam=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_alienmode_teamemblem',RenderStyle=5,TextureCoords=(X1=0,Y1=256,X2=293,Y2=512),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=812,OffsetY=369,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WWinTextAF=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_text_winlose',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=512,Y2=165),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=116,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WLoseTextAF=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_text_winlose',RenderStyle=5,TextureCoords=(X1=0,Y1=165,X2=512,Y2=330),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=116,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WWinTextRSA=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_text_winlose',RenderStyle=5,TextureCoords=(X1=0,Y1=330,X2=512,Y2=495),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=116,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WLoseTextRSA=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_text_winlose',RenderStyle=5,TextureCoords=(X1=0,Y1=495,X2=512,Y2=660),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=116,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WRoundResultNewBG=(WidgetTexture=Texture'Warfare_TH_UI_UI.Common.img_commom_black_40_back',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WRoundResultGradationBG=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_gradation_back',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=128,Y2=1024),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=495,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WWinTextHumanTeam=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_alienmode_text_winlose',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=512,Y2=165),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=116,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WLoseTextHumanTeam=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_alienmode_text_winlose',RenderStyle=5,TextureCoords=(X1=0,Y1=165,X2=512,Y2=330),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=116,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WWinTextAlienTeam=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_alienmode_text_winlose',RenderStyle=5,TextureCoords=(X1=0,Y1=330,X2=512,Y2=495),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=116,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WLoseTextAlienTeam=(WidgetTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_alienmode_text_winlose',RenderStyle=5,TextureCoords=(X1=0,Y1=495,X2=512,Y2=660),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=116,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WDigitsNumResultWin=(DigitTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_scorenum_win',TextureCoords=(X1=324,Y1=0,X2=360,Y2=51),TextureCoords[1]=(X1=0,Y1=0,X2=36,Y2=51),TextureCoords[2]=(X1=36,Y1=0,X2=72,Y2=51),TextureCoords[3]=(X1=72,Y1=0,X2=108,Y2=51),TextureCoords[4]=(X1=108,Y1=0,X2=144,Y2=51),TextureCoords[5]=(X1=144,Y1=0,X2=180,Y2=51),TextureCoords[6]=(X1=180,Y1=0,X2=216,Y2=51),TextureCoords[7]=(X1=216,Y1=0,X2=252,Y2=51),TextureCoords[8]=(X1=252,Y1=0,X2=288,Y2=51),TextureCoords[9]=(X1=288,Y1=0,X2=324,Y2=51),TextureCoords[10]=(X1=0,Y1=0,X2=0,Y2=0))
    WDigitsNumResultLose=(DigitTexture=Texture'Warfare_TH_UI_UI.HUD_ETC.img_hud_exitgame_scorenum_lose',TextureCoords=(X1=270,Y1=0,X2=300,Y2=41),TextureCoords[1]=(X1=0,Y1=0,X2=30,Y2=41),TextureCoords[2]=(X1=30,Y1=0,X2=60,Y2=41),TextureCoords[3]=(X1=60,Y1=0,X2=90,Y2=41),TextureCoords[4]=(X1=90,Y1=0,X2=120,Y2=41),TextureCoords[5]=(X1=120,Y1=0,X2=150,Y2=41),TextureCoords[6]=(X1=150,Y1=0,X2=180,Y2=41),TextureCoords[7]=(X1=180,Y1=0,X2=210,Y2=41),TextureCoords[8]=(X1=210,Y1=0,X2=240,Y2=41),TextureCoords[9]=(X1=240,Y1=0,X2=270,Y2=41),TextureCoords[10]=(X1=0,Y1=0,X2=0,Y2=0))
    ...
    wDefenceBotIcon[12]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=0,Y1=160,X2=80,Y2=240),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[13]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=160,Y1=160,X2=240,Y2=240),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wDefenceBotIcon[14]=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_pve_iconMonster',RenderStyle=5,TextureCoords=(X1=240,Y1=160,X2=320,Y2=240),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=666,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    lsSudenDeathMessage[1]="TeamDeathMatch : ????????????????????????????????"
    lsSudenDeathMessage[2]="Demolition : ??????????????????????????????????????????????????????????"
    ...
    WScoreTeamMarkAF=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_score_indicatecamp_myteammark_af',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=32,Y2=32),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=705,OffsetY=7,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WScoreTeamMarkRSA=(WidgetTexture=Texture'Warfare_TH_UI_HUD.Common.img_HUD_score_indicatecamp_myteammark_rsa',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=32,Y2=32),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=863,OffsetY=7,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    strNotReadySkill[0]="%0 ?????????????????? %1 ????????"
    strNotReadySkill[1]="%0 ??????????? %1 ????????"
    strNotReadySkill[2]="%0 ?????? Assist %1 ????????"
    strNotReadySkill[3]="%0 ??????? Death %1 ????????"
    strNotReadySkillDesc="????????????"
    strReadySkill="%0 ???????????"
    strReadySkillDesc="%0 ????????"
    strReadySupplyItem="%0 ???????????"
    strReadySupplyItemDesc="%0 ????????"
    strHelicopter="Helicopter"
    strSentryGun="Sentrygun"
    strAirStrike="Bombing"
    strUAV="UAV"
    strHelicopterFailed="?????????????? ?. ???"
    strSentryGunFailed="??????????? SentryGun"
    strAirStrikeFailed="????????????????"
    strHelicopterFailedDesc="??????????? ?. ????????"
    strSentryGunFailedDesc="??????????? SentryGun"
    strAirStrikeFailedDesc="????????????????????????"
