...
function string DAE_Healthy_Test()
{
    ...
    DAE = Class'WGame.DAE_Healthy'.static.Create(false);
...
function string DAE_Inverse()
{
    ...
    DAE = Class'WGame.DAE_Healthy'.static.Create(false);
    Inv = Class'WGame.DAE_Inverse'.static.Create(false, DAE);
    mi = Class'WGame.MemoryItem'.static.Create(none, P);
...
function string DAE_Multiple()
{
    ...
    dae1 = Class'WGame.DAE_Dummy'.static.Create(false, 0.5000000);
    dae2 = Class'WGame.DAE_Dummy'.static.Create(false, 1.0000000);
...
function string DAE_Proximity()
{
    ...
    DAE = Class'WGame.DAE_Proximity'.static.Create(false, aiBot, 100.0000000);
