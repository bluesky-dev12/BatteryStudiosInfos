    ...
    if(int(iAction) == int(1))
    {
        ...
        if(Controller.ViewportOwner.Actor.Level.GetIsServiceBuild())
        {
            ...
            if(page_Main.bConnectedLoginServer)
            {
                ...
                page_Main.AuthLogin_Blood = Controller.ViewportOwner.Actor.Level.AuthLogin_Blood;
                page_Main.AuthLogin_NoGore = byte(Controller.ViewportOwner.Actor.Level.bNoGoreVersion);
