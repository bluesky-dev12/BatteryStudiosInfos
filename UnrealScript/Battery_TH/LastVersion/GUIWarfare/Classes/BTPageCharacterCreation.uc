...
function bool ButtonConfirm_OnClick(GUIComponent Sender)
{
    ...
    temp = IsCorrectUserName_THAILAND(EditNickName.TextStr);
    // End:0x120
...
defaultproperties
{
    ...
    CharacterCreationBgDeco=(X=0.0000000,Y=0.0000000,width=1024.0000000,Height=768.0000000,Image=Texture'Warfare_TH_UI_UI.Common.img_charactercreate_bgdeco',DrawType=28,DrawColor=(R=255,G=255,B=255,A=255),DrawShadowColor=(R=0,G=0,B=0,A=255))
    ...
    strAF="AF"
    strRSA="RSA"
    NickNameDeco=(X=0.0000000,Y=0.0000000,width=475.0000000,Height=51.0000000,Image=Texture'Warfare_TH_UI_UI.Common.img_charactercreate_nametipbg',DrawType=28,DrawColor=(R=255,G=255,B=255,A=255),DrawShadowColor=(R=0,G=0,B=0,A=255))
    fbToolTip=(X1=274.0000000,Y1=593.0000000,X2=749.0000000,Y2=644.0000000)
    strNickNameToolTip="?????????????????????(?????? 16 ???) ???????? ???????????????? ???????????????"
    strErrorList[0]="???????????????????"
    strErrorList[1]="???????????????????????????"
