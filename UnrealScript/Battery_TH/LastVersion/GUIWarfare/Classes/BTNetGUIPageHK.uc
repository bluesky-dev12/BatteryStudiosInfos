...
defaultproperties
{
    ...
    strWeaponList[0]="???????"
    strWeaponList[1]="Assault Rifles"
    strWeaponList[2]="Submachine Gun"
    strWeaponList[3]="Sniper Rifles"
    strWeaponList[4]="Shot gun"
    strWeaponList[5]="Machine Gun"
    fbSkillListBg=(X1=601.0000000,Y1=191.0000000,X2=687.0000000,Y2=305.0000000)
    strSkillList[0]="???????"
    strSkillList[1]="Kill Combo"
    strSkillList[2]="Accumulated kill"
    strSkillList[3]="Assist"
    strSkillList[4]="Death"
    bPersistent=true
    bAllowedAsLast=true
