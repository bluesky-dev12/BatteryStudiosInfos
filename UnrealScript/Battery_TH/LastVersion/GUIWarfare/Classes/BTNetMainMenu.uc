...
var int AuthLogin_PCBang;
var byte AuthLogin_Gender;
var byte AuthLogin_Blood;
var byte AuthLogin_NoGore;
var string AuthLogin_UnixTimeStamp;
var string BirthDay;
var byte Sex;
...
function bool sfReqWebzenInvenList(string StorageType)
{
    ...
    Log("[BTNetMainMenu::sfReqWebzenInvenList] Thailand Version false");
    return false;
    //return;    
}
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    if(Controller.ViewportOwner.Actor.Level.GetIsServiceBuild())
    {
        ...
        if(bFind == false)
        {
            ...
            {
                LoginServers[0].szIP = "61.91.229.17";                
            }
            else
            {
                LoginServers[0].szIP = "61.91.229.17";
...
{
    Class'GUIWarfareControls.BTWindowDefineARHK'.static.ShowInfo(Controller, 47);
    BTWindowDefineARHK(Controller.TopPage()).__OnOK__Delegate = ShowCashChargeWindow_OnOK;
    //return;    
}

function bool ShowCashChargeWindow_OnOK(GUIComponent Sender)
{
    Controller.LaunchURL("https://bill.gg.in.th");
    Controller.CloseMenu(false);
...
{
    Controller.LaunchURL("http://BTR.in.th");
    Controller.CloseMenu(false);
    Class'GUIWarfareControls.BTWindowDefineInfoHK'.static.ShowInfo(Controller, 176);
    return true;
    //return;    
...
function SendLogin()
{
    Log(((((((((((("sfReqLoginWithThailand(" $ AuthLogin_AccountID) $ ", ") $ string(AuthLogin_Gender)) $ ", ") $ string(AuthLogin_Blood)) $ ", ") $ string(AuthLogin_PCBang)) $ ", ") $ AuthLogin_UnixTimeStamp) $ ", ") $ AuthLogin_GUID) $ ")");
    TcpLogin.sfReqLoginWithThailand(AuthLogin_AccountID, int(AuthLogin_Blood), AuthLogin_PCBang, AuthLogin_UnixTimeStamp, AuthLogin_GUID, AuthLogin_Gender);
    //return;    
}
