class wHUD_Domination extends wHUD_Mission
    transient
    config(User);
...
function DrawMiniMap(wHudPart_MinimapBase Minimap, Canvas C)
{
    ...
    if(lp1 < obj.Length)
    {
        Go = obj[lp1];
        // End:0x317
        if(Go.IsA('wFlagObjective') && Go.IsActive())
        {
            flag = wFlagObjective(Go);
...
simulated function DrawDominationFlagObjective(Canvas C, wFlagObjective Go, Vector ScreenPos, Rotator camRot)
{
    local wFlagObjective TGO, InGO;
    local bool bDraw;
    ...
    {
        // End:0xBC
        foreach PawnOwner.TouchingActors(Class'WMission_Decompressed.wFlagObjective', TGO)
        {
            // End:0xBB
            if(TGO == Go)
            {
...
simulated function DrawObjectives(Canvas C)
{
    ...
    if(i < obj.Length)
    {
        ...
        if(Go.IsActive())
        {
            ...
            if(PawnOwner != none)
            {
                ...
                if(Go.IsA('wFlagObjective'))
                {
                    ...
                    C.Style = 5;
                    C.GetCameraLocation(camLoc, camRot);
                    DrawDominationFlagObjective(C, wFlagObjective(Go), ScreenPos, camRot);
                }
                ...
                if(Go.IsA('wFlagObjective'))
                {
                    ...
                    // End:0x1BC
                    if(wFlagObjective(Go).iActiveTeam == iTeamIndex)
                    {
                    ...
                    {
                        switch(wFlagObjective(Go).iActiveTeam)
                        {
                            // End:0x200
                            case -1:
                ...
                }/* !MISMATCHING REMOVE, tried If got Type:Else Position:0x25B! */
            }
            i++;
            // [Loop Continue]
            goto J0x6D;
        }/* !MISMATCHING REMOVE, tried Loop got Type:If Position:0x08E! */
        // End:0x2E0
        ...
        //return;        
    }/* !MISMATCHING REMOVE, tried Else got Type:Loop Position:0x06D! */
}
...
function DrawDebug(Canvas C, int X, out int Y, int dy)
{
    ...
    foreach DynamicActors(Class'WMission_Decompressed.wFlagObjective', f)
    {
        ...
        Y += dy;
        C.BtrDrawTextJustified((("    TeamA=" $ string(f.LinkedTeam_A.Length)) @ " TeamB=") $ string(f.LinkedTeam_B.Length), 0, float(X), float(Y), 640.0000000, float(Y + dy), 9);
        Y += dy;
        C.BtrDrawTextJustified((("    iActiveTeam=" $ string(f.iActiveTeam)) @ " fActiveStartTime=") $ string(f.fActiveStartTime), 0, float(X), float(Y), 640.0000000, float(Y + dy), 9);
        Y += dy;        
    }    
    //return;    
}
...
defaultproperties
{
    DomObjectCaptureAF[0]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.capture_rsa_a',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectCaptureAF[1]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.capture_rsa_b',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectCaptureAF[2]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.capture_rsa_c',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectCaptureLAG[0]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.capture_rsa_a',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectCaptureLAG[1]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.capture_rsa_b',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectCaptureLAG[2]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.capture_rsa_c',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectCaptureRSA[0]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.capture_rsa_a',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectCaptureRSA[1]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.capture_rsa_b',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectCaptureRSA[2]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.capture_rsa_c',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectCaptureNon[0]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.capture_non_a',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectCaptureNon[1]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.capture_non_b',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectCaptureNon[2]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.capture_non_c',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectDefend[0]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.depend_a',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectDefend[1]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.depend_b',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectDefend[2]=(WidgetTexture=Texture'Warfare_TH_UI_HUD_ETC.DisplayIcon.depend_c',RenderStyle=5,TextureCoords=(X1=18,Y1=0,X2=110,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    DomObjectHeightOffset=280.0000000
    TCapture[0]=1
    TCapture[1]=1
    TCapture[2]=1
    MessageRegion=(DigitTexture=Texture'Warfare_TH_UI_HUD.Text.img_HUD_text',TextureCoords=(X1=512,Y1=492,X2=556,Y2=536),TextureCoords[1]=(X1=556,Y1=492,X2=600,Y2=536),TextureCoords[2]=(X1=600,Y1=492,X2=644,Y2=536),TextureCoords[3]=(X1=0,Y1=0,X2=0,Y2=31),TextureCoords[4]=(X1=69,Y1=0,X2=89,Y2=31),TextureCoords[5]=(X1=92,Y1=0,X2=112,Y2=31),TextureCoords[6]=(X1=115,Y1=0,X2=135,Y2=31),TextureCoords[7]=(X1=138,Y1=0,X2=158,Y2=31),TextureCoords[8]=(X1=161,Y1=0,X2=181,Y2=31),TextureCoords[9]=(X1=184,Y1=0,X2=204,Y2=31),TextureCoords[10]=(X1=230,Y1=0,X2=250,Y2=31))
