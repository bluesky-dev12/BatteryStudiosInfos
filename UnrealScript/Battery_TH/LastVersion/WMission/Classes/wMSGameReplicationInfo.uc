...
simulated function bool IsGhostChatting(Actor Sender)
{
    ...
    // End:0x16F
    if(PRI.IsDead && (((MM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_SD()) || MM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_Sabotage()) || MM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_DOA()) || MM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_Alien())
    {
        bGhostChatting = true;
        // End:0x15D
        if(MM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_Sabotage())
        {
            // End:0x15D
            if(MaxLives <= 0)
            {
