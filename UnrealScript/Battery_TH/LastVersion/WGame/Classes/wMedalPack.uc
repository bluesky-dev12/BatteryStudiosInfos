...
auto state Pickup
{
    function Touch(Actor Other)
    {
        ...
        if(ValidTouch(Other))
        {
            ...
            Level.Game.TeamReceiveLocalizedMessageDistance(byte(PC.GetTeamNum()), Class'Engine.wMessage_Game', Class'Engine.wMessage_Game'.default.Code_GotMedalAlly, PC.PlayerReplicationInfo, none, none, vect(0.0000000, 0.0000000, 0.0000000), 99999.0000000, true);
...
defaultproperties
{
    ...
    PickupSound="Warfare_Sound_Char/GetItem/get_healthpack"
    DrawType=8
