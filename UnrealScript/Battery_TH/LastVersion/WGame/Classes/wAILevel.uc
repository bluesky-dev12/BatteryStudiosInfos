...
function wNPCActions GetNPCAction(int ActionGroupID)
{
    ...
    A.ApproachTarget = ActionExists(ActionGroupID, "ApproachTarget");
    ...
    A.m_bPickSentryGun = ActionExists(ActionGroupID, "PickSentryGunPack");
    A.GotoFlag = ActionExists(ActionGroupID, "GotoFlag");
    A.CaptureFlag = ActionExists(ActionGroupID, "CaptureFlag");
    A.bAimSpecificParts = ActionExists(ActionGroupID, "AimSpecificParts");
    A.RemoveBarricade = ActionExists(ActionGroupID, "RemoveBarricade");
    return A;
    //return;    
}
...
{
    // End:0x16
    if(Bot.IsA('wAISentryGunController'))
    {
        return;
    }
