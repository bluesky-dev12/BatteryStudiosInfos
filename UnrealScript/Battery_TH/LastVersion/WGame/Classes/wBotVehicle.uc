...
var string StaySound;
var string MoveSound;
var string MoveDamagedSound;
var string SpindownSound;
var string ExplosionSoundWhenDying;
var string NullSound;
var bool bTestCheck;
...
simulated function SpawnGiblet(Class<Gib> GibClass, Vector Location, Rotator Rotation, float GibPerterbation, Vector GibVelocity)
{
    ...
    Giblet.SetDrawScale(Giblet.DrawScale);
...
state Dying
{
    ...
    function BeginState()
    {
        ...
        if(!bHidden)
        {
            FmodPlaySound(SpindownSound, 10,,, false, false);
        }
        super.BeginState();
        //return;        
    }
...
defaultproperties
{
    ...
    bCanDodge=true
    ScoringValue=1
    NullSound="Warfare_Sound_Char/etc/nullsound"
