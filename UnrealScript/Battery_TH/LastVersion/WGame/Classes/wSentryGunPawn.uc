...
simulated function AddAllyEffect(optional int iSideIndex)
{
    ...
    {
        allyEffect = Spawn(Class'XEffects.SentryGun_FX_Strobo_light_Green', self);        
    }
    else
    {
        allyEffect = Spawn(Class'XEffects.SentryGun_FX_Strobo_light_Red', self);
    }
    // End:0xB8
