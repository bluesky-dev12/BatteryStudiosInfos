...
function InitGameModeList(optional bool bSet, optional int Index)
{
    ...
    if(i < GameModeDispOrder.Length)
    {
        ...
        // End:0x2B0
        if((((GameModeIndex == Class'Engine.wGameSettings'.static.GetModeIndex_BotTeamDeathBeginner()) || GameModeIndex == Class'Engine.wGameSettings'.static.GetModeIndex_BotDomination()) || GameModeIndex == Class'Engine.wGameSettings'.static.GetModeIndex_Domination()) || GameModeIndex == Class'Engine.wGameSettings'.static.GetModeIndex_Sabotage())
        {
            // [Explicit Continue]
            goto J0x45C;
        }
...
function FillSubMode()
{
    ...
    else
    {
        ...
        {
            // End:0xE3
            if(PlayerOwner().Level.GetMatchMaker().MapSettings.GetWeaponRestriction(selectMapID, lp1) > 0)
            {
