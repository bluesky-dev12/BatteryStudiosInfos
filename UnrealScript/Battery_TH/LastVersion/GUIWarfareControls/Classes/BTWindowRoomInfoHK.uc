...
function FillGameMode()
{
    ...
    // End:0x31F
    if(Class'Engine.wGameSettings'.static.IsBotModeIndex(IntClass(ComboGameMode.ComboBox.List.GetObjectAtIndex(ComboGameMode.ComboBox.Index)).Index) || Class'Engine.wGameSettings'.static.IsNotRestriction(IntClass(ComboGameMode.ComboBox.List.GetObjectAtIndex(ComboGameMode.ComboBox.Index)).Index))
    {
...
defaultproperties
{
    ...
    strLabelCommonTop[6]="?????"
    strLabelCommonTop[7]="Target Point"
    ...
    strLabelBot_AF[0]="AF(Bot)"
    strLabelBot_AF[1]="AF(Bot2)"
    strLabelBot_RSA[0]="RSA(Bot)"
    strLabelBot_RSA[1]="RSA(Bot2)"
