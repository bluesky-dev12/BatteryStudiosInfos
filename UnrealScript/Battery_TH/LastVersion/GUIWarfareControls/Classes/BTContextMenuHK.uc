...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    BackgroundImage = Class'Engine.BTCustomDrawHK'.static.MakeImage(64, 64, 15, Texture'Warfare_TH_UI_UI.Common.pup_back');
    buttonImage[0] = Class'Engine.BTCustomDrawHK'.static.MakeImage(32, 26, 15, Texture'Warfare_TH_UI_UI.Common.pup_menu_n');
    buttonImage[1] = Class'Engine.BTCustomDrawHK'.static.MakeImage(32, 26, 15, Texture'Warfare_TH_UI_UI.Common.pup_menu_on');
    buttonImage[2] = Class'Engine.BTCustomDrawHK'.static.MakeImage(32, 26, 15, Texture'Warfare_TH_UI_UI.Common.pup_menu_dis');
    //return;    
}
