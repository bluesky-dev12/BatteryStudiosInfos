...
function bool Render(Canvas C, optional float Delta)
{
    ...
    {
        Class'Engine.BTCustomDrawHK'.static.DrawImageRatio(C, Background, AWinPos.X1, AWinPos.Y1, AWinPos.X2, AWinPos.Y2);
    }
    // End:0xBE
    if(ClanMark[2].Image != none)
    {
        Class'Engine.BTCustomDrawHK'.static.DrawImageRatio(C, ClanMark[2], AWinPos.X1, AWinPos.Y1, AWinPos.X2, AWinPos.Y2);
        bExistClanMark = true;
    }
    // End:0x11B
    if(ClanMark[1].Image != none)
    {
        Class'Engine.BTCustomDrawHK'.static.DrawImageRatio(C, ClanMark[1], AWinPos.X1, AWinPos.Y1, AWinPos.X2, AWinPos.Y2);
        bExistClanMark = true;
    }
    // End:0x178
    if(ClanMark[0].Image != none)
    {
        Class'Engine.BTCustomDrawHK'.static.DrawImageRatio(C, ClanMark[0], AWinPos.X1, AWinPos.Y1, AWinPos.X2, AWinPos.Y2);
        bExistClanMark = true;
    }
    // End:0x1CE
    if(bExistClanMark == false)
    {
        Class'Engine.BTCustomDrawHK'.static.DrawImageRatio(C, Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.ex_clanmark, AWinPos.X1, AWinPos.Y1, AWinPos.X2, AWinPos.Y2);
    }
    // End:0x21F
    if(ClanLevel_Img.Image != none)
    {
        Class'Engine.BTCustomDrawHK'.static.DrawImageRatio(C, ClanLevel_Img, AWinPos.X1, AWinPos.Y1, AWinPos.X2, AWinPos.Y2);
    }
    return true;
    //return;    
}
