...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    DifficultTabButtons[4 - 1].SetVisibility(false);
    i = 0;
    J0x2AE:
    ...
    {
        defenceParam = GameMgr.DefenceLevelInfoParams[i];
        // End:0x31F
        if(int(defenceParam.byDifficulty) == 4)
        {
            DifficultTabButtons[4 - 1].SetVisibility(defenceParam.bEnable);
            // [Explicit Break]
            goto J0x329;
        }
        i++;
