...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    self.ItemRewardBG = Class'Engine.BTCustomDrawHK'.static.MakeImage(169, 86, 0, Texture'Warfare_TH_UI_UI.Store.list_remodeling_remodelingitem');
...
defaultproperties
{
    strStatus[0]="?????? Point Reward"
    strStatus[1]="?????? Clear Reward"
    strStatus[2]="??????????????"
}