...
function Created()
{
    Groups = new (none) Class'Engine_Decompressed.wAdminGroupList';
    ManagedGroups = new (none) Class'Engine_Decompressed.wAdminGroupList';
    //return;    
}
...
function wAdminUserList GetManagedUsers(wAdminGroupList uAllGroups)
{
    ...
    retList = new (none) Class'Engine_Decompressed.wAdminUserList';
    // End:0x26
    if(bMasterAdmin)
    {
        uGroups = uAllGroups;        
