...
simulated function wLoadOut(int iID, int iAddPartsID, int iPaintID, Pawn Pawn)
{
    ...
    if(iSavedWID != iID)
    {
        ...
        ResetBase();
        // End:0x1BB
        if(((((((((int(BaseParams.eType) == int(0)) || int(BaseParams.eType) == int(5)) || int(BaseParams.eType) == int(10)) || int(BaseParams.eType) == int(11)) || int(BaseParams.eType) == int(12)) || int(BaseParams.eType) == int(16)) || int(BaseParams.eType) == int(13)) || int(BaseParams.eType) == int(14)) || int(BaseParams.eType) == int(15))
        {
            bUseFlashEffect = false;            
        }
        else
