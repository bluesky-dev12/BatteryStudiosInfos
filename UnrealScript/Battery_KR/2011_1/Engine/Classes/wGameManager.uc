                ...
                if(i < AddPartsGroupParams.Length)
                {
                    ...
                    if(AddPartsGroupParams[i].strPartsGroupID == itemBox.PartGroupID)
                    {
                        ...
                        if(itemBox.PartGroupList[pgcount].SkillID != 0)
                        {
                            ...
                            itemBox.PartGroupList[pgcount].SkillImage = Texture(DynamicLoadObject("Warfare_UI_UI.Store.icon_rem_skil", Class'Engine_Decompressed.Texture'));
...
function LoadNPCSpawn()
{
    ...
    if(NPCSpawnParams.Length == 0)
    {
        ...
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params.xlsx", "NPC_Spon", 2, 1, 1);
        // End:0x74
        if(!bResult)
        {
            return;
...
function LoadNPC()
{
    ...
    local string strID, strNameGroupID, strLv, strType, strMainWeapon, strPistol,
	    ...
	    ZeroRangeSpreadMin, ZeroRangeSpreadMax, HeadshotChanceMG, HeadshotSpreadRate;
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params.xlsx", "NPC", 2, 1, 1);
        // End:0x6F
        if(!bResult)
        {
            return;
...
function LoadNPCNameGroup()
{
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params.xlsx", "Name_Group", 2, 1, 1);
        // End:0x76
        if(!bResult)
        {
            return;
...
function LoadNPCItemGroup()
{
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params.xlsx", "Item_Group", 2, 1, 1);
        // End:0x76
        if(!bResult)
        {
            return;
...
function LoadNPCActionGroup()
{
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params.xlsx", "Action_Group", 2, 1, 1);
        // End:0x78
        if(!bResult)
        {
            return;
...
function LoadBadwords()
{
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params.xlsx", "BadWords", 2, 1, 1);
        // End:0x74
        if(!bResult)
        {
            return;
    ...
    {
        excel = new Class'BTData.BTNetExcelData';
        bResult = excel.LoadExcelData("../../ExcelData/Parameters/Params.xlsx", "BadNicks", 2, 1, 1);
        // End:0x150
        if(!bResult)
        {
            return;
...
defaultproperties
{
    ...
    LevelExps[1]=3450
    LevelExps[2]=5900
    LevelImages[0]="Warfare_UI_UI.Lv_Mark.Lv_Mark_1"
    LevelImages[1]="Warfare_UI_UI.Lv_Mark.Lv_Mark_2"
    ClanLevelImages[0]="none"
    ClanLevelImages[1]="Warfare_UI_UI.Common.icon_cl_f5"
    ClanLevelImages[2]="Warfare_UI_UI.Common.icon_cl_f4"
    ClanLevelImages[3]="Warfare_UI_UI.Common.icon_cl_f3"
    ClanLevelImages[4]="Warfare_UI_UI.Common.icon_cl_f2"
    ClanLevelImages[5]="Warfare_UI_UI.Common.icon_cl_f1"
    ClanLevelImages[6]="Warfare_UI_UI.Common.icon_cl_e5"
    ClanLevelImages[7]="Warfare_UI_UI.Common.icon_cl_e4"
    ClanLevelImages[8]="Warfare_UI_UI.Common.icon_cl_e3"
    ClanLevelImages[9]="Warfare_UI_UI.Common.icon_cl_e2"
    ClanLevelImages[10]="Warfare_UI_UI.Common.icon_cl_e1"
    ClanLevelImages[11]="Warfare_UI_UI.Common.icon_cl_d5"
    ClanLevelImages[12]="Warfare_UI_UI.Common.icon_cl_d4"
    ClanLevelImages[13]="Warfare_UI_UI.Common.icon_cl_d3"
    ClanLevelImages[14]="Warfare_UI_UI.Common.icon_cl_d2"
    ClanLevelImages[15]="Warfare_UI_UI.Common.icon_cl_d1"
    ClanLevelImages[16]="Warfare_UI_UI.Common.icon_cl_c5"
    ClanLevelImages[17]="Warfare_UI_UI.Common.icon_cl_c4"
    ClanLevelImages[18]="Warfare_UI_UI.Common.icon_cl_c3"
    ClanLevelImages[19]="Warfare_UI_UI.Common.icon_cl_c2"
    ClanLevelImages[20]="Warfare_UI_UI.Common.icon_cl_c1"
    ClanLevelImages[21]="Warfare_UI_UI.Common.icon_cl_b5"
    ClanLevelImages[22]="Warfare_UI_UI.Common.icon_cl_b4"
    ClanLevelImages[23]="Warfare_UI_UI.Common.icon_cl_b3"
    ClanLevelImages[24]="Warfare_UI_UI.Common.icon_cl_b2"
    ClanLevelImages[25]="Warfare_UI_UI.Common.icon_cl_b1"
    ClanLevelImages[26]="Warfare_UI_UI.Common.icon_cl_a5"
    ClanLevelImages[27]="Warfare_UI_UI.Common.icon_cl_a4"
    ClanLevelImages[28]="Warfare_UI_UI.Common.icon_cl_a3"
    ClanLevelImages[29]="Warfare_UI_UI.Common.icon_cl_a2"
    ClanLevelImages[30]="Warfare_UI_UI.Common.icon_cl_a1"
