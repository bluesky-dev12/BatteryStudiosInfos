class SMG_MuzFlash_01_3RD extends wEmitter;
...
defaultproperties
{
    ...
    mRandTextures=true
    mNumTileRows=4
    mMeshNodes=StaticMesh'Warfare_Staticmeshes.Weapon_Effects.SMG_Muzzleflash_01_3rd'
    DrawScale=0.8000000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes.PB_muzzleflash_02_3rd'
    Style=6
}