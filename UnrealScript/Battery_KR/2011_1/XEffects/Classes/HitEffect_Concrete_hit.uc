class HitEffect_Concrete_hit extends Emitter;

defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_Concrete_hit.SpriteEmitter14'
    begin object name="SpriteEmitter14" class=Engine.SpriteEmitter
        ...
        Acceleration=(X=154.6299591,Y=54.0416451,Z=61.2478180)
        ...
        StartSizeRange=(X=(Min=123.5519943,Max=123.5519943),Y=(Min=123.5519943,Max=123.5519943),Z=(Min=123.5519943,Max=123.5519943))
        ...
        StartVelocityRange=(X=(Min=-51.2740822,Max=51.2740822),Y=(Min=-100.0771255,Max=100.0771255),Z=(Min=-33.3590393,Max=33.3590393))
        StartVelocityRadialRange=(Min=3.0000000,Max=3.0000000)
        GetVelocityDirectionFrom=3
    end object
    Emitters[0]=SpriteEmitter14
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_Concrete_hit.SpriteEmitter15'
    begin object name="SpriteEmitter15" class=Engine.SpriteEmitter
        ...
        StartVelocityRange=(X=(Min=0.0000000,Max=508.2000122),Y=(Min=-508.2000122,Max=508.2000122),Z=(Min=-217.1399994,Max=586.7399902))
        CullDistance=1800.0000000
        DisableIfCulled=true
    end object
    Emitters[1]=SpriteEmitter15
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_Concrete_hit.SpriteEmitter16'
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_Concrete_hit.SpriteEmitter17'
    ...
    Emitters[3]=SpriteEmitter17
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_Concrete_hit.SpriteEmitter18'
    begin object name="SpriteEmitter18" class=Engine.SpriteEmitter
        UseDirectionAs=1
        FadeOut=true
        RespawnDeadParticles=false
        ...
        StartLocationShape=2
        StartSizeRange=(X=(Min=36.0000000,Max=36.0000000),Y=(Min=91.0000000,Max=91.0000000),Z=(Min=36.0000000,Max=36.0000000))
    ...
    Emitters[4]=SpriteEmitter18
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_Concrete_hit.SpriteEmitter19'
    begin object name="SpriteEmitter19" class=Engine.SpriteEmitter
        ...
        UniformSize=true
        AutomaticInitialSpawning=false
        Acceleration=(X=727.3603516,Y=0.0000000,Z=0.0000000)
        ColorScale=/* Array type was not detected. */
        Opacity=0.4500000
        ...
        StartLocationShape=2
        StartLocationPolarRange=(X=(Min=10.0000000,Max=10.0000000),Y=(Min=0.0000000,Max=0.0000000),Z=(Min=0.0000000,Max=0.0000000))
        ...
        StartVelocityRange=(X=(Min=51.9573555,Max=51.9573555),Y=(Min=0.0000000,Max=0.0000000),Z=(Min=0.0000000,Max=0.0000000))
        StartVelocityRadialRange=(Min=3.0000000,Max=3.0000000)
        GetVelocityDirectionFrom=3
    end object
    Emitters[5]=SpriteEmitter19
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_Concrete_hit.SpriteEmitter20'
