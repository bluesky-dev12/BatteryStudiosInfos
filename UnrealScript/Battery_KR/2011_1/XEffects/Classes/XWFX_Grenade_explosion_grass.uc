class XWFX_Grenade_explosion_grass extends Emitter;
...
defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter284'
    begin object name="SpriteEmitter284" class=Engine.SpriteEmitter
        FadeOut=true
    ...
    Emitters[0]=SpriteEmitter284
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter285'
    begin object name="SpriteEmitter285" class=Engine.SpriteEmitter
        UseColorScale=true
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
        ...
        DrawStyle=1
        Texture=Texture'FX_TEX.Hit_Effects.Dirt_Plume'
    ...
    Emitters[1]=SpriteEmitter285
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter286'
    begin object name="SpriteEmitter286" class=Engine.SpriteEmitter
        UseColorScale=true
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
    ...
    Emitters[2]=SpriteEmitter286
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter287'
    begin object name="SpriteEmitter287" class=Engine.SpriteEmitter
        UseColorScale=true
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
    ...
    Emitters[3]=SpriteEmitter287
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter289'
    begin object name="SpriteEmitter289" class=Engine.SpriteEmitter
        FadeOut=true
        RespawnDeadParticles=false
        SpinParticles=true
        UseSizeScale=true
    ...
    Emitters[4]=SpriteEmitter289
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter290'
    begin object name="SpriteEmitter290" class=Engine.SpriteEmitter
        UseDirectionAs=1
        UseColorScale=true
        FadeOut=true
        FadeIn=true
    ...
    Emitters[5]=SpriteEmitter290
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter291'
    begin object name="SpriteEmitter291" class=Engine.SpriteEmitter
        UseDirectionAs=1
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
        ...
        StartSpinRange=(X=(Min=-0.1000000,Max=0.1000000),Y=(Min=0.0000000,Max=0.0000000),Z=(Min=0.0000000,Max=0.0000000))
        StartSizeRange=(X=(Min=12.0000000,Max=28.0000000),Y=(Min=12.0000000,Max=28.0000000),Z=(Min=12.0000000,Max=28.0000000))
    ...
    Emitters[6]=SpriteEmitter291
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter293'
    begin object name="SpriteEmitter293" class=Engine.SpriteEmitter
        UseDirectionAs=1
        UseColorScale=true
        FadeOut=true
        FadeIn=true
    ...
    Emitters[7]=SpriteEmitter293
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter294'
    begin object name="SpriteEmitter294" class=Engine.SpriteEmitter
        UseColorScale=true
        FadeOut=true
        RespawnDeadParticles=false
        SpinParticles=true
    ...
    Emitters[8]=SpriteEmitter294
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter295'
    begin object name="SpriteEmitter295" class=Engine.SpriteEmitter
        UseColorScale=true
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
    ...
    Emitters[9]=SpriteEmitter295
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter297'
    begin object name="SpriteEmitter297" class=Engine.SpriteEmitter
        UseColorScale=true
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
    ...
    Emitters[10]=SpriteEmitter297
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter298'
    begin object name="SpriteEmitter298" class=Engine.SpriteEmitter
        UseColorScale=true
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
    ...
    Emitters[11]=SpriteEmitter298
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_grass.SpriteEmitter299'
    begin object name="SpriteEmitter299" class=Engine.SpriteEmitter
        UseDirectionAs=1
        UseColorScale=true
        FadeOut=true
        FadeIn=true
