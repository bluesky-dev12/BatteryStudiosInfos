class SMG_MuzFlash_02_3RD extends wEmitter;
...
defaultproperties
{
    ...
    mRandTextures=true
    mNumTileRows=4
    mMeshNodes=StaticMesh'Warfare_Staticmeshes.Weapon_Effects.SMG_Muzzleflash_02_3rd'
    DrawScale=0.8000000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes.PB_Muzzleflash_04_3rd'
    Style=6
}