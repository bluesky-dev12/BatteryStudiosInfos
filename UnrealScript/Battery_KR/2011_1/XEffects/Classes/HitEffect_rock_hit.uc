...
defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_rock_hit.SpriteEmitter166'
    begin object name="SpriteEmitter166" class=Engine.SpriteEmitter
        ...
        Acceleration=(X=100.1230011,Y=34.9920006,Z=39.6580009)
        ...
        StartVelocityRange=(X=(Min=-33.2000008,Max=33.2000008),Y=(Min=-64.8000031,Max=64.8000031),Z=(Min=-21.6000004,Max=21.6000004))
        StartVelocityRadialRange=(Min=3.0000000,Max=3.0000000)
        GetVelocityDirectionFrom=3
    end object
    Emitters[0]=SpriteEmitter166
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_rock_hit.SpriteEmitter167'
    ...
    Emitters[1]=SpriteEmitter167
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_rock_hit.SpriteEmitter168'
    begin object name="SpriteEmitter168" class=Engine.SpriteEmitter
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
        UseSizeScale=true
    ...
    Emitters[2]=SpriteEmitter168
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_rock_hit.SpriteEmitter169'
    begin object name="SpriteEmitter169" class=Engine.SpriteEmitter
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
        SpinParticles=true
    ...
    Emitters[3]=SpriteEmitter169
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_rock_hit.SpriteEmitter170'
    begin object name="SpriteEmitter170" class=Engine.SpriteEmitter
        UseDirectionAs=1
        FadeOut=true
        RespawnDeadParticles=false
        ...
        StartLocationShape=2
        StartSizeRange=(X=(Min=26.0000000,Max=26.0000000),Y=(Min=91.0000000,Max=91.0000000),Z=(Min=26.0000000,Max=26.0000000))
    ...
    Emitters[4]=SpriteEmitter170
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_rock_hit.SpriteEmitter171'
    begin object name="SpriteEmitter171" class=Engine.SpriteEmitter
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
        SpinParticles=true
        ...
        StartVelocityRange=(X=(Min=30.7439995,Max=30.7439995),Y=(Min=0.0000000,Max=0.0000000),Z=(Min=0.0000000,Max=0.0000000))
        StartVelocityRadialRange=(Min=3.0000000,Max=3.0000000)
        GetVelocityDirectionFrom=3
    end object
    Emitters[5]=SpriteEmitter171
    AutoDestroy=true
    bNoDelete=false
}