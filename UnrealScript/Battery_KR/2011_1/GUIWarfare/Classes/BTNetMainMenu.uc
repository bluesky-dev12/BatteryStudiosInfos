...
var export editinline BTNetMainMenu_Lobby page_Lobby;
var string pagename_Lobby;
...
var export editinline BTNetMainMenu_Channel page_Channel;
var string pagename_Channel;
var export editinline BTPageRoomLobby page_RoomLobby;
var string pagename_RoomLobby;
var export editinline BTNetMainMenu_GameRoom page_GameRoom;
var string pagename_GameRoom;
var export editinline BTNetMatchResult page_MatchResult;
var string pagename_MatchResult;
var export editinline BTPageMatchResult page_MatchResult2;
var string pagename_MatchResult2;
var export editinline BTPageMatchResult_Booty page_MatchResult_Booty;
var string pagename_MatchResult_Booty;
var export editinline BTPageTestHK page_ControlTest;
var string pagename_ControlTest;
var export editinline BTNetControlTestB page_ControlTest2;
var string pagename_ControlTest2;
var export editinline BTNetControlTestTab page_ControlTestTab;
var string pagename_ControlTestTab;
var export editinline BTNetControlTestVerticalTab page_ControlTestVerticalTab;
var string pagename_ControlTestVerticalTab;
...
function bool sfReqWebzenInvenList(string StorageType)
{
    ...
    WZILP.CurPage = 1;
    WZILP.MaxPage = 0;
    WZILP.CountPerPage = 10;
    WZILP.StorageType = StorageType;
    Log(((((("[BTNetMainMenu::sfReqWebzenInvenList] sfReqWebzenBillingStorageList(" $ string(WZILP.CurPage)) $ ", ") $ string(WZILP.CountPerPage)) $ ", ") $ WZILP.StorageType) $ ")");
    TcpChannel.sfReqWebzenBillingStorageList(WZILP.CurPage, WZILP.CountPerPage, byte(Asc(WZILP.StorageType)));
    return true;
    //return;    
}
...
function ChannelToLogin_OnEventTimer(int Index)
{
    ...
    Class'GUIWarfareControls.BTWindowDefineStateHK'.static.CloseWindowAllByName(Controller, 'BTWindowDefineStateHK');
    // End:0xBE
...
function AddExpiredItem(int ItemID, int SlotPos, int PartID)
{
...
function AddExpiredSkillItem(int ItemID)
{
    ExpiredItems.bExpiredItem = true;
    ExpiredItems.items.Length = ExpiredItems.items.Length + 1;
    ExpiredItems.items[ExpiredItems.items.Length - 1].ItemID = ItemID;
    ExpiredItems.items[ExpiredItems.items.Length - 1].SlotPos = 0;
...
function bool CheckExpiredItemList()
{
    ...
    if(ExpiredItems.bExpiredItem && ExpiredItems.items.Length > 0)
    {
        ...
        {
            BTWindow.AddItem(ExpiredItems.items[i].ItemID, ExpiredItems.items[i].PartID, ExpiredItems.items[i].SlotPos);
            i++;
            // [Loop Continue]
            goto J0x137;
        }
...
function AddServerChannelList(int ServerID, int ChannelID, string serverIP, int serverPort, int ServerDataPort, string ServerName, string ServerShortName, string ChannelName, int ServerGroupID, string ServerGroupName, int IsClanChannel, string ChannelNickName, bool IsPracticeChannel)
{
    local int AddIdx;
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    if(Controller.ViewportOwner.Actor.Level.GetIsServiceBuild())
    {
        ...
        {
            // End:0x22C
            if(Controller.ViewportOwner.Actor.Level.GetIsConnectDMZ())
            {
                szLoginServerIP = "218.234.76.43";                
            }
            else
            {
                szLoginServerIP = "202.31.179.65";
            }
...
function SetPage(Object.EPage PageType, bool closeLastMenu)
{
    ...
    switch(PageType)
    {
        ...
        // End:0x22C
        case 6:
            Controller.OpenMenu(pagename_Lobby);
            // End:0x229
            if(page_Lobby == none)
            {
                page_Lobby = BTNetMainMenu_Lobby(Controller.FindPersistentMenuByName(pagename_Lobby));
            }
            // End:0x7ED
            break;
        // End:0x272
        ...
        // End:0x2FE
        case 8:
            Controller.OpenMenu(pagename_Channel);
            // End:0x2FB
            if(page_Channel == none)
            {
                page_Channel = BTNetMainMenu_Channel(Controller.FindPersistentMenuByName(pagename_Channel));
            }
            // End:0x7ED
            break;
        // End:0x344
        ...
        // End:0x38A
        case 9:
            Controller.OpenMenu(pagename_GameRoom);
            // End:0x387
            if(page_GameRoom == none)
            {
                page_GameRoom = BTNetMainMenu_GameRoom(Controller.FindPersistentMenuByName(pagename_GameRoom));
            }
            // End:0x7ED
            break;
        // End:0x3D0
        case 11:
            Controller.OpenMenu(pagename_MatchResult);
            // End:0x3CD
            if(page_MatchResult == none)
            {
                page_MatchResult = BTNetMatchResult(Controller.FindPersistentMenuByName(pagename_MatchResult));
            }
            // End:0x7ED
            break;
        // End:0x416
        ...
        // End:0x45C
        case 13:
            Controller.OpenMenu(pagename_MatchResult_Booty);
            // End:0x459
            if(page_MatchResult_Booty == none)
            {
                page_MatchResult_Booty = BTPageMatchResult_Booty(Controller.FindPersistentMenuByName(pagename_MatchResult_Booty));
            }
            // End:0x7ED
            break;
        // End:0x4A2
        case 14:
            Controller.OpenMenu(pagename_ControlTest);
            // End:0x49F
            if(page_ControlTest == none)
            {
                page_ControlTest = BTPageTestHK(Controller.FindPersistentMenuByName(pagename_ControlTest));
            }
            // End:0x7ED
            break;
        // End:0x4E8
        case 15:
            Controller.OpenMenu(pagename_ControlTest2);
            // End:0x4E5
            if(page_ControlTest2 == none)
            {
                page_ControlTest2 = BTNetControlTestB(Controller.FindPersistentMenuByName(pagename_ControlTest2));
            }
            // End:0x7ED
            break;
        // End:0x52E
        case 16:
            Controller.OpenMenu(pagename_ControlTestTab);
            // End:0x52B
            if(page_ControlTestTab == none)
            {
                page_ControlTestTab = BTNetControlTestTab(Controller.FindPersistentMenuByName(pagename_ControlTestTab));
            }
            // End:0x7ED
            break;
        // End:0x574
        case 17:
            Controller.OpenMenu(pagename_ControlTestVerticalTab);
            // End:0x571
            if(page_ControlTestVerticalTab == none)
            {
                page_ControlTestVerticalTab = BTNetControlTestVerticalTab(Controller.FindPersistentMenuByName(pagename_ControlTestVerticalTab));
            }
            // End:0x7ED
            break;
        // End:0x5BA
...
function int IsInClanWarChannel(int ServerID, int ChannelID)
{
    local int i;
    ...
    {
        // End:0x5E
        if((SCIList[i].ChannelID == ChannelID) && SCIList[i].ServerID == ServerID)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        SendWhisperMsg = ((("[" $ ci.ChatTo) $ "]") $ strTo) @ ci.chatText;
...
{
    // End:0xB1
    if(int(AuthLogin_ChannelType) == 1)
    {
        // End:0x63
        if(int(AuthLogin_ConnectAlpha) == 0)
        {
            Controller.LaunchURL("https://bill.playnetwork.co.kr/pay/charge.nhn?CHNL=PN");            
        }
        else
        {
            Controller.LaunchURL("http://alpha-bill.playnetwork.co.kr/pay/charge.nhn?CHNL=PN");
        }        
    }
    else
    {
        // End:0x105
        if(int(AuthLogin_ChannelType) == 0)
        {
...
defaultproperties
{
    ...
    pagename_Lobby="GUIWarfare.BTNetMainMenu_Lobby"
    pagename_Lobby2="GUIWarfare.BTPageLobby"
    pagename_CharacterCreation="GUIWarfare.BTPageCharacterCreation"
    pagename_ServerSelection="GUIWarfare.BTPageServerSelection"
    pagename_Channel="GUIWarfare.BTNetMainMenu_Channel"
    pagename_RoomLobby="GUIWarfare.BTPageRoomLobby"
    pagename_GameRoom="GUIWarfare.BTNetMainMenu_GameRoom"
    pagename_MatchResult="GUIWarfare.BTNetMatchResult"
    pagename_MatchResult2="GUIWarfare.BTPageMatchResult"
    pagename_MatchResult_Booty="GUIWarfare.BTPageMatchResult_Booty"
    pagename_ControlTest="GUIWarfare.BTPageTestHK"
    pagename_ControlTest2="GUIWarfare.BTNetControlTestB"
    pagename_ControlTestTab="GUIWarfare.BTNetControlTestTab"
    pagename_ControlTestVerticalTab="GUIWarfare.BTNetControlTestVerticalTab"
