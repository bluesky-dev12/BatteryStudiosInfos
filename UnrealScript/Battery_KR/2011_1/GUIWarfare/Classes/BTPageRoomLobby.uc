...
var export editinline BTTPMessengerHK TPMessenger;
...
{
    local int i, LimitCount, GameUserCount;
    ...
    if(MM.bIsOwner)
    {
        ...
        GameUserCount = TPTeamList[0].ACLList.ACLRowList.Length + TPTeamList[1].ACLList.ACLRowList.Length;
        // End:0x5C4
        ...
        // End:0x650
        if((MM.szGameClass == "wGame.wDeathMatch") && (TPTeamList[0].ACLList.ACLRowList.Length + TPTeamList[1].ACLList.ACLRowList.Length) > 8)
        {
            Controller.PopPage();
    ...
    {
        // End:0x718
        if((MM.kGM == false) && MM.kClanMatch_InChannel)
        {
            Controller.PopPage();
...
function bool ButtonTeam_OnClick(GUIComponent Sender)
{
    ...
    // End:0x71
    if(TPTeamList[btn.ButtonID].ACLList.ACLRowList.Length >= (MM.kGame_UserCount / 2))
    {
        return false;
    }
...
{
    TPTeamList[0].ACLList.ChangeRoomOwnerInfo(UID);
    TPTeamList[1].ACLList.ChangeRoomOwnerInfo(UID);
    //return;    
}
...
function bool ChangeButtonTeam(int Team)
{
    ...
    if(Team == 0)
    {
        ButtonTeam[0].buttonImage[0] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_cli;
        ButtonTeam[0].buttonImage[1] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_cli;
        ButtonTeam[0].buttonImage[2] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_cli;
        ButtonTeam[0].buttonImage[3] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_cli;
        ButtonTeam[0].buttonImage[4] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_cli;
        ...
        ButtonTeam[1].buttonImage[0] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_n;
        ButtonTeam[1].buttonImage[1] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_on;
        ButtonTeam[1].buttonImage[2] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_n;
        ButtonTeam[1].buttonImage[3] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_on;
        ButtonTeam[1].buttonImage[4] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_on;
        ButtonTeam[1].__OnClick__Delegate = ButtonTeam_OnClick;        
    }
    else
    {
        ButtonTeam[0].buttonImage[0] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_n;
        ButtonTeam[0].buttonImage[1] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_on;
        ButtonTeam[0].buttonImage[2] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_n;
        ButtonTeam[0].buttonImage[3] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_on;
        ButtonTeam[0].buttonImage[4] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_on;
        ButtonTeam[0].__OnClick__Delegate = ButtonTeam_OnClick;
        ButtonTeam[1].buttonImage[0] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_cli;
        ButtonTeam[1].buttonImage[1] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_cli;
        ButtonTeam[1].buttonImage[2] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_cli;
        ButtonTeam[1].buttonImage[3] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_cli;
        ButtonTeam[1].buttonImage[4] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_cli;
...
function bool BTWindowCreateClanHK_OnOK(GUIComponent Sender)
{
    ...
    if(BTWindowCreateClanHK(Controller.TopPage()).CheckDup())
    {
        ...
        URL = BTWindowCreateClanHK(Controller.TopPage()).ClanID.TextStr;
...
{
    LabelTeam = NewLabelComponent(fbLabelTeam, Class'GUIWarfareControls.BTUIResourcePoolHK'.default.panel_1);
    LabelTeamTopLine = NewLabelComponent(fbLabelTeamTopLine, Class'GUIWarfareControls.BTUIResourcePoolHK'.default.img_input_x);
    LabelTeamTopLine.SetFontSizeAll(11);
    ButtonTeam[0] = NewButtonComponent(fbButtonTeam[0]);
    ButtonTeam[0].buttonImage[0] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_n;
    ButtonTeam[0].buttonImage[1] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_on;
    ButtonTeam[0].buttonImage[2] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_on;
    ButtonTeam[0].buttonImage[3] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_on;
    ButtonTeam[0].buttonImage[4] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_af_on;
    ...
    ButtonTeam[1].buttonImage[0] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_n;
    ButtonTeam[1].buttonImage[1] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_on;
    ButtonTeam[1].buttonImage[2] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_on;
    ButtonTeam[1].buttonImage[3] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_on;
    ButtonTeam[1].buttonImage[4] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.butt_rsa_on;
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    TPMessenger = BTTPMessengerHK(NewComponent(new Class'GUIWarfareControls.BTTPMessengerHK', fbTPMessenger, 0.9000000));
    ...
    TPMyInfo = BTTPMyInfoHK(NewComponent(new Class'GUIWarfareControls.BTTPMyInfoHK', fbTPMyInfo, 0.8000000));
    ...
    ButtonStart = NewButtonComponent(fbButtonStart);
    ButtonStart.SetDefaultBigButtonImage();
...
function SetFriendlyUser(BTAutoColumnListDataHK ACLData, optional int UserListIdx)
{
    ...
    if(TPMessenger.IsFriendlyUser(ACLData.DataPerColumn[2].strValue, ACLData.DataPerColumn[3].strValue, UserListIdx))
    {
        ...
        ACLData.DataPerColumn[2].Text[3].DrawColor = Class'GUIWarfareControls.BTUIColorPoolHK'.static.FriendlyUserNamePressed();
        ACLData.DataPerColumn[2].Text[4].DrawColor = Class'GUIWarfareControls.BTUIColorPoolHK'.static.FriendlyUserNameDisable();
        ACLData.DataPerColumn[2].Text[5].DrawColor = Class'GUIWarfareControls.BTUIColorPoolHK'.static.FriendlyUserNameSelected();
    }
    //return;    
}
...
{
    return GameModes[GameModeIndex].UserFriendlyName;
    //return;    
}

function UpdateRoomInfoByMatchMaker()
{
    local string UserCountString;
    local array<GameModeInfo> gmi;
    ...
    self.TPRoomInfo.SetData(MM.MapSettings.GetMapInfo(MM.kGame_MapName).FriendlyName, MM.kGame_MapName, FindFriendlyGameModeByIndex(MM.kGame_GameMode), MM.kGame_TeamBalance, string(MM.kGame_GameTime) $ ":00", string(MM.kGame_GameRound), UserCountString, MM.kGame_GameMode, MM.BotDifficulty, MM.kGame_WeaponLimit, MM.BotUserTeam);
    //return;    
}
...
{
    local array<string> ingamebgmList;
...
function bool rfAckEnterRoom(int GameNum, int OwnerID, int UID, string UserID, int TeamNum, int Grade, string UserIP, string Clanname, int Clan_Mark_Pattern, int Clan_Mark_BG, int Clan_Mark_BL, byte IsLookFor, int Result, string ErrMsg, int ClanLevel, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3)
{
    ...
    local int NewIndex, addACLRowIdx;
    ...
    if(Result == 0)
    {
        ...
        if(UID == MM.kUID)
        {
            MM.My_iTeam = TeamNum;
            MM.kTeamID = TeamNum;
            TPTeamList[TeamNum].ACLList.AddTeamMember(UID, Clan_Mark_Pattern, Clan_Mark_BG, Clan_Mark_BL, Grade, UserID, RecvClanName, 0, 1, 0, UserIP, IsLookFor, ClanLevel, LevelMarkID, TitleMarkID, Reserved1, Reserved2, Reserved3, true);
        ...
        {
            TPTeamList[TeamNum].ACLList.AddTeamMember(UID, Clan_Mark_Pattern, Clan_Mark_BG, Clan_Mark_BL, Grade, UserID, RecvClanName, 0, 1, 0, UserIP, IsLookFor, ClanLevel, LevelMarkID, TitleMarkID, Reserved1, Reserved2, Reserved3);
            // End:0x4A5
...
function bool rfAckLeaveRoom(int Num, int UID, string UserID, int Result, string ErrMsg)
{
    ...
    if(Result == 0)
    {
        ...
        else
        {
            ...
            // End:0x193
            if(TPTeamList[0].ACLList.RemoveTeamMemberByUID(UID) == false)
            {
                TPTeamList[1].ACLList.RemoveTeamMemberByUID(UID);
            }
        }        
    }
    else
...
function bool rfAckChangeTeam(int GameNumber, string UserID, int UID, int TeamNum, int Result, string ErrMsg)
{
    ...
    if(Result == 0)
    {
        ...
        TPTeamList[TeamNum].ACLList.AddRow(Data);
        TPTeamList[PrevTeam].ACLList.RemoveTeamMemberByUID(UID);        
    }
    else
    {
        Class'GUIWarfareControls.BTWindowErrorDefineHK'.static.ShowError(Controller, Result);
...
function bool rfAckUpdateScore(array<int> UserIDs, array<string> NickNames, array<byte> TeamIDs, array<int> Scores, array<int> Kills, array<int> Assists, array<int> Deaths, array<int> EXPs, array<int> EXPBonuses, array<int> Points, array<int> PointBonuses, array<int> TeamScores, array<int> BonusOwnerID, array<int> BonusID)
{
    ...
    local bool bSwap;
    local ResultInfo Result, curr, tmp;
...
{
    local string strHostIP, strHostPort;
...
function bool rfAckUpdateWeaponDurability(int Result, string ErrMsg, array<BtrDouble> UniqueItemID, array<int> Durability, array<byte> IsDestroy, array<BtrDouble> FailedWeaponUniqueID)
{
    ...
    if(i < GameMgr.InstanceItemLists.Length)
    {
        ItemInfo = GameMgr.FindUIItem(GameMgr.InstanceItemLists[i].ItemID);
        // End:0x55A
        if(((ItemInfo.CostType == 1) || ItemInfo.CostType == 3) && GameMgr.InstanceItemLists[i].Durability < 10000)
        {
...
{
    local int lp1, i, UserID, Number;
    local byte Position, oldstate, NewState;
    local BTNetGUIPage.eUserState userState;
...
function bool rfAckRoomUserList(array<int> UID, array<string> UserName, array<int> Grade, array<int> TeamNum, array<byte> Statue, array<byte> IsHost, array<string> UserIP, array<string> Clanname, array<int> CM_Pattern, array<int> CM_BG, array<int> CM_BL, array<byte> IsLookingFor, array<int> GMUID, array<int> ClanLevel, array<int> LevelMarkID, array<int> TitleMarkID, array<int> Reserved1, array<int> Reserved2, array<int> Reserved3)
{
    ...
    if(lp1 < UID.Length)
    {
        ...
        if(UID[lp1] == MM.kUID)
        {
            ...
            ChangeButtonStart();
            TPTeamList[TeamNum[lp1]].ACLList.AddTeamMember(UID[lp1], CM_Pattern[lp1], CM_BG[lp1], CM_BL[lp1], Grade[lp1], UserName[lp1], RecvClanName, int(Statue[lp1]), int(IsHost[lp1]), 0, UserIP[lp1], IsLookingFor[lp1], ClanLevel[lp1], LevelMarkID[lp1], TitleMarkID[lp1], Reserved1[lp1], Reserved2[lp1], Reserved3[lp1], true);
            addACLRowIdx = TPTeamList[TeamNum[lp1]].ACLList.ACLRowList.Length - 1;
            SetFriendlyUser(TPTeamList[TeamNum[lp1]].ACLList.ACLRowList[addACLRowIdx]);
            // [Explicit Continue]
            goto J0x703;
        }
        TPTeamList[TeamNum[lp1]].ACLList.AddTeamMember(UID[lp1], CM_Pattern[lp1], CM_BG[lp1], CM_BL[lp1], Grade[lp1], UserName[lp1], RecvClanName, int(Statue[lp1]), int(IsHost[lp1]), 0, UserIP[lp1], IsLookingFor[lp1], ClanLevel[lp1], LevelMarkID[lp1], TitleMarkID[lp1], Reserved1[lp1], Reserved2[lp1], Reserved3[lp1]);
        addACLRowIdx = TPTeamList[TeamNum[lp1]].ACLList.ACLRowList.Length - 1;
        SetFriendlyUser(TPTeamList[TeamNum[lp1]].ACLList.ACLRowList[addACLRowIdx]);
        J0x703:
...
function OnPopupChannel(int ContextMenuIndex, BTACLMessengerChannelHK acl)
{
    ...
    switch(ContextMenuIndex)
    {
        ...
        case 2:
            ...
            {
                Class'GUIWarfareControls.BTWindowDefineInfoHK'.static.ShowInfo(Controller, 139);
            }
            // End:0x3BC
            break;
        // End:0x166
...
function bool rfReqRecvClanInvite(string InviterCharname, string Clanname, string InviteMsg)
{
    ...
    if(IsGameReadyOrPlaying())
    {
        page_Main.TcpChannel.sfAckRecvClanInvite(InviterCharname, InviteMsg, Clanname, 3);
...
function bool BTWindowRequestClanHK_OnOK(GUIComponent Sender)
{
    ...
    Log("[BTPageRoomLobby::BTWindowRequestClanHK_OnOK]");
    BTWindow = BTWindowRequestClanHK(Controller.TopPage());
...
function bool BTWindowRequestClanHK_OnCancel(GUIComponent Sender)
{
    ...
    Log("[BTPageRoomLobby::BTWindowRequestClanHK_OnCancel]");
    BTWindow = BTWindowRequestClanHK(Controller.TopPage());
...
function bool BTWindowRequestClanHK_OnSuspend(GUIComponent Sender)
{
    ...
    Log("[BTPageRoomLobby::BTWindowRequestClanHK_OnSuspend]");
    BTWindow = BTWindowRequestClanHK(Controller.TopPage());
...
function bool rfReqRecvJoinClan(string CharName, string Message)
{
    ...
    if(IsGameReadyOrPlaying())
    {
        page_Main.TcpChannel.sfAckRecvJoinClan(CharName, Message, 3);
...
defaultproperties
{
    ...
    strTeamBalance[0]="? ???? ???? ?? ???? ???? +5% ??? ? ????."
    strTeamBalance[1]="? ??? ??? ???? ??? ??? ?? ???? ??? ?? ? ? ? ???? ?? ???? ?? ?????."
    strTeamBalance[2]="??? ?? ? ??? ??? OFF ????."
    strBotModeWarn[0]="??(3)??? ? ????? 100%? ???? ??? ? ????."
    strBotModeWarn[1]="? ??? ???&??? ??? ?? ??? ?? ????."
    strNoviceMode="????? AI(???)? ??? ??? ??? ?? ????? ?? ??? ???? ?? ?????."
    strBotMode="? ??? AI(???)? ??? ??? ??? ?? ??? ?? ??? ????."
    TimeAutoStart=-1.0000000
    ...
    fbLabelTeamTopLine=(X1=12.0000000,Y1=89.0000000,X2=759.0000000,Y2=112.0000000)
    fbButtonTeam[0]=(X1=19.0000000,Y1=132.0000000,X2=384.0000000,Y2=175.0000000)
    fbButtonTeam[1]=(X1=390.0000000,Y1=132.0000000,X2=755.0000000,Y2=175.0000000)
    fbTPTeamList[0]=(X1=19.0000000,Y1=174.0000000,X2=381.0000000,Y2=474.0000000)
    fbTPTeamList[1]=(X1=390.0000000,Y1=174.0000000,X2=752.0000000,Y2=474.0000000)
    fbTPChat=(X1=10.0000000,Y1=504.0000000,X2=508.0000000,Y2=735.0000000)
    fbTPMessenger=(X1=518.0000000,Y1=504.0000000,X2=761.0000000,Y2=735.0000000)
    fbTPMyInfo=(X1=771.0000000,Y1=508.0000000,X2=1014.0000000,Y2=735.0000000)
    ...
    CannotChangeHostTitle="????"
    CannotChangeHostMessage="???? ??? ?????. ????? ??? ????? ?? ???????"
    WaitingMessage="???? ?? ?? ????. ??? ??? ???."
    MessageNewHost="????? ?????. ??? ??? ?????"
    MessageNewGuestPre="????? ?????. "
    MessageNewGuestPost="?? ??? ?????"
    MessageHostChangeEnable[0]="?? ??? ???? PC ??? ?? ?????? ???? ?? ? ????.?? ???? ??? ???? ?? ???????."
    MessageHostChangeEnable[1]="?? ??? ???? PC ??? ?? ?????? ???? ?? ? ????.??? ??? ?????????"
    strLowHostScoreWarning[0]="??("
    strLowHostScoreWarning[1]="?)? PC??? ??? ?? ??? ?? ???? ???? ?? ? ????."
    MinHostPoint=100
