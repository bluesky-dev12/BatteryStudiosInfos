...
defaultproperties
{
    ...
    C_ERR_LOADING_FAILED_MyNetworkChecking_1_5001="???? ??? ??????. ?? ??? ?? ??? ???. ? ??? ?? ?????? ?? ???? ?? ??? ? ?? ?????. ?? ???? ?? ?? ??????. (5001)"
    ...
    C_ERR_LOADING_FAILED_WrongStep_6_5020="?? ? ??? ??????. ????? ?? ?? ??? ??? ???. ? ??? ?? ?????? ?? ???? ?? ??? ? ?? ?????. ?? ???? ?? ?? ??????. (5020)"
    ...
    C_ERR_LOADING_FAILED_Inervention_Failed_By_ChangeRoomOwner_5081="?? ???? ?? ????? ??????. ????? ??? ??? ?? ??? ???. (5081)"
    C_ERR_LOADING_FAILED_Inervention_MapLoading_Failed_5082="?? ???? ?? ????? ??????. ????? ??? ??? ?? ??? ???. (5082)"
    ...
    C_ERR_LOADING_FAILED_Found_Overlap_User_Name_5110="??? ?? ?????. ?? ?? ?? ??? ?? ??? ???. (5110)"
