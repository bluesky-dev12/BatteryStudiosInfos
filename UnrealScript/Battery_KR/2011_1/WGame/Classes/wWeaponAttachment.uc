...
simulated function GetHitInfo()
{
    ...
    offset = float(20) * Normal(Instigator.Location - mHitLocation);
    mHitActor = Trace(HitLocation, mHitNormal, mHitLocation - offset, mHitLocation + offset, false,, mHitMaterial);
