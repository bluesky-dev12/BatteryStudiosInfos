...
static function string GetString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2, optional Object OptionalObject)
{
    ...
    if(Switch == 1)
    {
        return Class'Engine.GameInfo'.static.ParseKillMessage(KillerName, VictimName, Class<DamageType>(OptionalObject).static.SuicideMessage(RelatedPRI_2));
    }
    // End:0x97
...
{
    // End:0x65
    if(((P != none) && RelatedPRI_1 != none) && RelatedPRI_2 != none)
    {
        // End:0x65
        if(P.myHUD != none)
        {
            P.myHUD.OnClientReceiveDeathMessage(P, RelatedPRI_1, RelatedPRI_2, OptionalObject);
        }
    }
    //return;    
}
