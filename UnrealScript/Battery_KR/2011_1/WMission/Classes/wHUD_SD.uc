...
function DrawMinimapBomb(wHudPart_MinimapBase Minimap, Canvas C)
{
    ...
    // End:0x2CF
    if((!MSGRI.IsDefender(byte(PlayerOwner.GetTeamNum())) && !MSGRI.bMultiBomb) && !MSGRI.bObjectivePlanted)
    {
        // End:0x2CF
        ...
        if(Go.IsActive())
        {
            ...
            if(true)
            {
                ...
                if(MSGRI != none)
                {
                    ...
                    {
                        // End:0x276
                        if(MSGRI.IsDefender(byte(PlayerOwner.GetTeamNum())) && Go.IsA('wBombObjective'))
                        {
                            // [Explicit Continue]
                            goto J0x3C9;
                        }
...
defaultproperties
{
    MinimapBomb=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.minimapicon.map_bomb',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=15,Y2=15),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    IconBomb=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_demo_pack',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=101,Y2=108),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=1011,OffsetY=1087,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ObjectBomb=(WidgetTexture=FinalBlend'Warfare_UI_HUD_ETC.DisplayIcon.c4_bomb_fb',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=126),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ObjectiveDefend[0]=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.DisplayIcon.keep_a',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=126),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ObjectiveDefend[1]=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.DisplayIcon.keep_b',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=126),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ObjectivePlant[0]=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.DisplayIcon.explosion_a',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=126),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ObjectivePlant[1]=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.DisplayIcon.explosion_b',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=126),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ObjectiveDiffuse[0]=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.DisplayIcon.defuse_a',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=126),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ObjectiveDiffuse[1]=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.DisplayIcon.defuse_b',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=126),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ObjectNotification=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.DisplayIcon.point_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
