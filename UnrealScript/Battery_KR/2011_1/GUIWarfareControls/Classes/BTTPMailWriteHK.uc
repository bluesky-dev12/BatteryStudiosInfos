...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    LabelTitle.BackgroundImage = Class'Engine.BTCustomDrawHK'.static.MakeImage(512, 8, 28, Texture'Warfare_UI_UI.Common.img_ptitl_back');
    ...
    LabelEditReceiver.BackgroundImage = Class'Engine.BTCustomDrawHK'.static.MakeImage(16, 16, 15, Texture'Warfare_UI_UI.Common.panel_4');
    ...
    LabelContent.BackgroundImage = Class'Engine.BTCustomDrawHK'.static.MakeImage(16, 16, 15, Texture'Warfare_UI_UI.Common.panel_4');
