...
function PlayAnimByParams(optional int wID)
{
    ...
    else
    {
        ...
        PlayAnim(AnimNames[WeaponType], 1.0000000, 0.2000000);
    }
    //return;    
}
...
function SetWeaponParts(int iPartsID, optional int iPaintingID)
{
    ...
    if(PartsParam.iSightID != 0)
    {
        ...
        {
            wWeaponParts[0] = Spawn(Class'Engine.wSkinShell', wWeapon);
            wWeaponParts[0].SetDrawType(8);
            wWeaponParts[0].SetStaticMesh(Level.GameMgr.GetItemResourceStaticMesh(PartsParam.iSightID, true));
    ...
    if(PartsParam.iSilencerID != 0)
    {
        ...
        if(ItemResParam.iItemResourceID != -1)
        {
            wWeaponParts[1] = Spawn(Class'Engine.wSkinShell', wWeapon);
            wWeaponParts[1].SetDrawType(8);
            wWeaponParts[1].SetStaticMesh(Level.GameMgr.GetItemResourceStaticMesh(PartsParam.iSilencerID, true));
    ...
    if(PartsParam.iSightID_Sub != 0)
    {
        ...
        if(ItemResParam.iItemResourceID != -1)
        {
            wWeaponParts[2] = Spawn(Class'Engine.wSkinShell', wWeapon);
            wWeaponParts[2].SetDrawType(8);
            wWeaponParts[2].SetStaticMesh(Level.GameMgr.GetItemResourceStaticMesh(PartsParam.iSightID_Sub, true));
    ...
    if(iPaintingID > 0)
    {
        wWeapon.Skins[0] = Level.GameMgr.GetPartsGroupPainting(weaponID, PartsParam.iAddPartID, true, iPaintingID);        
    }
    else
    {
