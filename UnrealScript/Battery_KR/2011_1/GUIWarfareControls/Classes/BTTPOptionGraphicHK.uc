...
defaultproperties
{
    ...
    strGraphicQuality[4]="??"
    strGraphicQuality[5]="??? ??"
    strTooltip[3]="[?? ??]<P> <P>???? ??? ? ???? ??? ???? ??? ?????.<P> <P>?19? ??? ?? ??? ?????."
    strTooltip[5]="[?? ??]<P> <P>??? ??? ??? ???? ?????? ?????."
    strTooltip[6]="[?? ??]<P> <P>??? ??? ???? ?????.<P>???? ???? ??? ??? ????.<P> <P>[??] P4 3.2GHZ, 2G RAM, GeForce 9800GT? <P>[?] P4 3.0GHZ, 2G RAM, GeForce 8600GT? <P>[?] P4 3.0GHZ, 2G RAM, GeForce 7600GT? <P>[?] P4 2.8GHZ, 1G RAM, GeForce 6600GT? <P>[??] P4 2.4GHZ, 1G RAM, GeForce FX5700? "
    strTooltip[7]="[?? ??]<P> <P>??? ??? ? ???? ?????."
    OnRendered=BTTPOptionGraphicHK.Internal_OnRendered
}