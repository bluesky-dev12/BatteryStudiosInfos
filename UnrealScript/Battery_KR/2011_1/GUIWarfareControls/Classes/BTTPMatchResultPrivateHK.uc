...
function SetData(wMatchMaker MM)
{
    ...
    if(i < MM.ResultInfos.Length)
    {
        ...
        {
            ACLResult.AddTeamMemeber(true, ri.UserID, ui.ClanMark, ui.ClanBG, ui.ClanBL, ui.Grade, ri.Nick, ui.Clanname, ri.Score, ri.Kill, ri.Assist, ri.Death, ri.Exp, ri.ExpBonus, ri.Point, ri.PointBonus, BonusIDs, ui.IsLookingFor, false, ui.LevelMarkID, ui.TitleMarkID, ui.Reserved1, ui.Reserved2, ui.Reserved3);
