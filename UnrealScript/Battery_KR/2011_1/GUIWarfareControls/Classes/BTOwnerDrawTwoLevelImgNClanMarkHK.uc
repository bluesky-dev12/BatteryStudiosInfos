...
{
    local int X1, halfwidth, QuarterWidth;
    ...
    C.Style = 5;
    X1 = int(((AWinPos.X1 + float(QuarterWidth)) - float(32)) - float(5));
    Class'Engine.BTCustomDrawHK'.static.DrawImage(C, LevelImg[0], float(X1), AWinPos.Y1, float(X1 + 32), AWinPos.Y1 + float(32));
    X1 = int((AWinPos.X1 + float(QuarterWidth)) + float(5));
    ClanMark[0].AWinPos.X1 = float(X1);
    ClanMark[0].AWinPos.Y1 = AWinPos.Y1;
    ClanMark[0].AWinPos.X2 = float(X1 + 32);
    ClanMark[0].AWinPos.Y2 = AWinPos.Y1 + float(32);
    ClanMark[0].Render(C);
    X1 = int((((AWinPos.X1 + float(halfwidth)) + float(QuarterWidth)) - float(32)) - float(5));
    Class'Engine.BTCustomDrawHK'.static.DrawImage(C, LevelImg[1], float(X1), AWinPos.Y1, float(X1 + 32), AWinPos.Y1 + float(32));
    X1 = int(((AWinPos.X1 + float(halfwidth)) + float(QuarterWidth)) + float(5));
    ClanMark[1].AWinPos.X1 = float(X1);
    ClanMark[1].AWinPos.Y1 = AWinPos.Y1;
    ClanMark[1].AWinPos.X2 = float(X1 + 32);
