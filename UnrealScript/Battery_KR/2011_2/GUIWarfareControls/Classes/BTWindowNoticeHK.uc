...
var export editinline BTOwnerDrawImageHK NoticeImg;
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    LabelBack.Caption = "";
    NoticeImg = NewLabelComponent(Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(113.0000000, 167.0000000, 911.0000000, 597.0000000), Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.help_Notice);
    NoticeImg.Caption = "";
    //return;    
}
