...
function Internal_OnRendered(Canvas C)
{
    ...
    C.Style = 5;
    X1 = 534;
    Class'Engine.BTCustomDrawHK'.static.DrawImage(C, LevelImg, float(X1), AWinPos.Y1, float(X1 + 32), AWinPos.Y1 + float(32));
    X1 += 42;
    // End:0x111
    if(bClan)
    {
    ...
    {
        Class'Engine.BTCustomDrawHK'.static.DrawImage(C, BackgroundImage, float(X1), AWinPos.Y1 + float(2), 752.0000000, AWinPos.Y1 + float(30));
    }
    ...
    if(BackgroundImage.Image != none)
    {
        Class'Engine.BTCustomDrawHK'.static.DrawImage(C, BackgroundImage, float(X1), AWinPos.Y1 + float(2), 984.0000000, AWinPos.Y1 + float(30));
    }
