...
function AddTeamMemeber(bool bMe, int UID, int ClanMark, int ClanBG, int ClanBL, int Level, string NickName, string Clanname, int Score, int Kill, int Assist, int Death, int Exp, int expup, int Point, int pointup, array<int> BonusIDs, int LookingFor, bool bFriendly, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3)
{
    ...
    if(bFriendly)
    {
        ...
        Data.DataPerColumn[2].Text[3].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.FriendlyUserNamePressed();
        Data.DataPerColumn[2].Text[4].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.FriendlyUserNameDisable();
        Data.DataPerColumn[2].Text[5].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.FriendlyUserNameSelected();
    }
    AddRow(Data);
    //return;    
}
