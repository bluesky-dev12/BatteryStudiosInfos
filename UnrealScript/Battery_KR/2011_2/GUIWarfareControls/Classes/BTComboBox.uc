...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    PositionControls();
    ComboBox.MyListBox.SetScrollBarStyle(true, new Class'GUIWarfareStyles.STY2WarfareScrollZoneOpaque', true, new Class'GUIWarfareStyles.STY2WarfareScrollIncreaseButton', true, none, true, new Class'GUIWarfareStyles.STY2WarfareScrollDecreaseButton', true, none, true, new Class'GUIWarfareStyles.STY2WarfareScrollGripButton');
    //return;    
}
