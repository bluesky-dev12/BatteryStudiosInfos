...
function InitComboBox()
{
    ...
    btn.buttonImage[0] = Class'Engine.BTCustomDrawHK'.static.MakeImage(26, 26, 28, Texture'Warfare_UI_UI.Common.comb_buutt_n');
    btn.buttonImage[1] = Class'Engine.BTCustomDrawHK'.static.MakeImage(26, 26, 28, Texture'Warfare_UI_UI.Common.comb_buutt_on');
    btn.buttonImage[2] = Class'Engine.BTCustomDrawHK'.static.MakeImage(26, 26, 28, Texture'Warfare_UI_UI.Common.comb_buutt_on');
    btn.buttonImage[3] = Class'Engine.BTCustomDrawHK'.static.MakeImage(26, 26, 28, Texture'Warfare_UI_UI.Common.comb_buutt_cli');
    btn.buttonImage[4] = Class'Engine.BTCustomDrawHK'.static.MakeImage(26, 26, 28, Texture'Warfare_UI_UI.Common.comb_buutt_n');
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    InitScrollBar();
    InitComboBox();
    Border.BackgroundImage = Class'Engine.BTCustomDrawHK'.static.MakeImage(16, 16, 15, Texture'Warfare_UI_UI.Common.panel_4');
    super.InitComponent(MyController, myOwner);
    combBackImg = Class'Engine.BTCustomDrawHK'.static.MakeImage(16, 16, 15, Texture'Warfare_UI_UI.Common.comb_back');
    combSelectImg = Class'Engine.BTCustomDrawHK'.static.MakeImage(8, 8, 15, Texture'Warfare_UI_UI.Common.comb_expand_on');
