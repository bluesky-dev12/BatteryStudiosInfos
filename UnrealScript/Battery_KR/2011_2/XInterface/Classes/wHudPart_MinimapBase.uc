...
var() SpriteWidget MinimapHelicopterAlly;
var() SpriteWidget MinimapHelicopterEnem;
...
var array<Material> CachedSpecialPositionImages;
var Color BaseColor;
var float IconSizeF;
var bool DrawFrame;
...
function CacheSpecialPositions()
{
    ...
    CachedSpecialPositionImages.Length = 0;
    lp1 = 0;
    J0x17:
    ...
    if(lp1 < SpecialPositions_Class.Length)
    {
        ...
        {
            CachedSpecialPositions[CachedSpecialPositions.Length] = loc.Location;
            CachedSpecialPositionImages[CachedSpecialPositionImages.Length] = SpecialPositions_Image[lp1];            
        }        
        lp1++;
        // [Loop Continue]
        goto J0x17;
...
function DrawMinimap_NorthPole(Canvas C)
{
    ...
    mat = TexRotator(DynamicLoadObject("warfare_ui_hud_etc.img_north_rot", Class'Engine.Material', true));
...
function DrawMinimap_Myself(Canvas C)
{
    ...
    W = float(MinimapMatMyself.MaterialUSize()) * IconSizeF;
    H = float(MinimapMatMyself.MaterialVSize()) * IconSizeF;
    old = C.DrawColor;
...
function DrawMinimap_Helicopter(Canvas C)
{
    ...
    if(lp1 < Level.Helicopters.Length)
    {
        ...
        if((P != none) && !P.bHidden)
        {
            ...
            {
                Sprite = MinimapHelicopterAlly;                
            }
            else
            {
                Sprite = MinimapHelicopterEnem;
            }
            SetupMinimapSpriteWidgetForDrawing(Sprite, P.Rotation, minimapX, minimapY);
            W = float(Sprite.WidgetTexture.MaterialUSize()) * IconSizeF;
            H = float(Sprite.WidgetTexture.MaterialVSize()) * IconSizeF;
...
function DrawMinimap_SpecialPositions(Canvas C)
{
    ...
    {
        loc = CachedSpecialPositions[lp1];
        mat = CachedSpecialPositionImages[lp1];
        CalculateMinimapPositionPawnCentering(HudOwner.PawnOwner, loc, minimapX, minimapY);
        bDraw = false;
        // End:0x1A0
...
defaultproperties
{
    MinimapBG=(WidgetTexture=Texture'Warfare_UI_HUD.Common.hud_back_3',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=32,Y2=32),TextureScale=0.6500000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=9,OffsetY=9,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    MinimapMatMyself=TexRotator'Warfare_UI_HUD_ETC.minimapicon.minimap_myself2_rot'
    MinimapMatAlly=Texture'Warfare_UI_HUD_ETC.minimapicon.minimap_our_team'
    MinimapMatAttackingAlly=FinalBlend'Warfare_UI_HUD_ETC.minimapicon.minimap_our_team_comb_rot_fb'
    MinimapFCMatAlly=Texture'Warfare_UI_HUD_ETC.minimapicon.minimap_our_clan'
    MinimapFCMatAttackingAlly=FinalBlend'Warfare_UI_HUD_ETC.minimapicon.minimap_our_clan_comb_rot_fb'
    MinimapMatRadioMessage=FinalBlend'Warfare_UI_HUD_ETC.minimapicon.minimap_radio_final'
    MinimapDeadAlly=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.minimapicon.death_our',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapAttackingEnemies[0]=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.minimapicon.enemy_target',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapAttackingEnemies[1]=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.minimapicon.enemy_target',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapAttackingEnemies[2]=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.minimapicon.enemy_target',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapDeadEnemies[0]=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.minimapicon.death_enemy',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapDeadEnemies[1]=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.minimapicon.death_enemy',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapDeadEnemies[2]=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.minimapicon.death_enemy',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapHelicopterAlly=(WidgetTexture=TexRotator'Warfare_UI_HUD_ETC.minimapicon.icon_wh_heli_rot',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapHelicopterEnem=(WidgetTexture=TexRotator'Warfare_UI_HUD_ETC.minimapicon.icon_r_heli_rot',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapStrikeAlly=(WidgetTexture=FinalBlend'Warfare_UI_HUD_ETC.minimapicon.icon_wh_bom',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MinimapStrikeEnem=(WidgetTexture=FinalBlend'Warfare_UI_HUD_ETC.minimapicon.icon_r_bom',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.6500000,DrawPivot=8,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=104,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    SpecialPositions_Image[0]=Texture'Warfare_UI_HUD_ETC.minimapicon.icon_mnmap_m2b'
    SpecialPositions_Image[1]=Texture'Warfare_UI_HUD_ETC.minimapicon.icon_mnmap_at4'
    SpecialPositions_Image[2]=Texture'Warfare_UI_HUD_ETC.minimapicon.icon_mnmap_m249'
    SpecialPositions_Image[3]=Texture'Warfare_UI_HUD_ETC.minimapicon.icon_mnmap_m249'
    BaseColor=(R=255,G=255,B=255,A=255)
    IconSizeF=1.0000000
    DrawFrame=true
    UAVBG_Base=VariableTexPanner'Warfare_UI_HUD_ETC.minimapicon.UAV4_VPan'
    UAVBG=TexRotator'Warfare_UI_HUD_ETC.minimapicon.UAV4_Rot'
