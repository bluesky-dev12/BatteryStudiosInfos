...
enum SKILL_ARRAY
{
    ...
    SKILL_ARRAY_Incen,              // 10
    SKILL_ARRAY_Incen_Require,      // 11
    SKILL_ARRAY_SpiltGrenade,       // 12
    SKILL_ARRAY_SpiltGrenade_Require,// 13
    SKILL_ARRAY_NONE                // 14
};
...
var() SpriteWidget WTeamMarkBackAF;
var() SpriteWidget WTeamMarkBackRSA;
...
var() SpriteWidget WTeamImageWin[2];
var() SpriteWidget WTeamImageLose[2];
...
function DisPlayEvent_Waiting(string Message)
{
    ...
    {
        sWaitingMessage = "waiting player...";
    }
...
function DisplayEvent_Skill_Helicopter(Canvas C)
{
    ...
    C.DrawColor.A = byte(float(255) * fFadeOutEffect);
    DrawHelpBG(C,, 734);
    CalculateCoordinateEx(C, wHelicopter, 512.0000000, 82.0000000, calW);
    C.SetPos(calW.X1, calW.Y1);
    ...
    fRatio = FClamp(fRatio, 0.0000000, 1.0000000);
    SkillHelicopterOn.OffsetX = int(float(default.SkillHelicopterOn.OffsetX) + (float(32) * fRatio));
    SkillHelicopterOn.OffsetY = int(float(default.SkillHelicopterOn.OffsetY) + (float(287) * fRatio));
...
function CallSkill(optional int iKey, optional bool bRequire, optional bool iSucess)
{
    ...
    if(5 == iKey)
    {
        ...
        if(1 == HudCDeathmatch(HudOwner).ActiveUsingSkill.iState)
        {
            ...
            switch(iSkillID)
            {
                ...
                case 40012:
                    ECallSkillState = 1;
                    // End:0xD4
                    if(int(HudOwner.PlayerOwner.PlayerReplicationInfo.KillSuccession) >= RPG7KillStreak)
                    {
                        iCodeID = Class'Engine.wMessage_Game_ImpSystem'.default.Code_NotHasAmmoRPG7;
                ...
                case 40017:
                    ECallSkillState = 10;
                    // End:0x149
                    if(int(HudOwner.PlayerOwner.PlayerReplicationInfo.KillSuccession) >= IncenKillStreak)
                    {
                        iCodeID = Class'Engine.wMessage_Game_ImpSystem'.default.Code_NotHasAmmoIncen;
                        HudOwner.PlayerOwner.ReceiveLocalizedMessage(Class'Engine.wMessage_Game_ImpSystem', iCodeID);
                    }
                    // End:0x239
                    break;
                ...
                case 40018:
                    ECallSkillState = 8;
                    // End:0x1BE
                    if(int(HudOwner.PlayerOwner.PlayerReplicationInfo.KillSuccession) >= HellfireKillStreak)
                    {
                        iCodeID = Class'Engine.wMessage_Game_ImpSystem'.default.Code_NotHasAmmoHellFire;
                        HudOwner.PlayerOwner.ReceiveLocalizedMessage(Class'Engine.wMessage_Game_ImpSystem', iCodeID);
                    }
                    // End:0x239
                    break;
                ...
                case 40022:
                    ECallSkillState = 12;
                    // End:0x233
                    if(int(HudOwner.PlayerOwner.PlayerReplicationInfo.KillSuccession) >= SpiltGrenadeKillStreak)
                    {
                        iCodeID = Class'Engine.wMessage_Game_ImpSystem'.default.Code_NotHasAmmoSpiltGrenade;
                        HudOwner.PlayerOwner.ReceiveLocalizedMessage(Class'Engine.wMessage_Game_ImpSystem', iCodeID);
                    }
                    // End:0x239
                    break;
        ...
        }/* !MISMATCHING REMOVE, tried If got Type:Else Position:0x268! */
        else
        {
            // End:0x355
            if(6 == iKey)
            {
                ...
                // End:0x352
                if(1 == int(HudOwner.PlayerOwner.PlayerReplicationInfo.bySupply_Helipack))
                {
                    bSkillReady = true;
                    // End:0x352
                    if(bRequire && iSucess)
            ...
            else
            {
                ...
                else
                {
                    ...
                    if(10 == iKey)
                    {
                        ...
                        // End:0x456
                        if(1 == int(HudOwner.PlayerOwner.PlayerReplicationInfo.bySupply_UAV))
                        {
                            bSkillReady = true;
                            // End:0x456
                            if(bRequire && iSucess)
...
function DisplayEvent_Skill_AirStirke(Canvas C)
{
    ...
    C.DrawColor.A = byte(float(255) * fFadeOutEffect);
    DrawHelpBG(C,, 734);
    CalculateCoordinateEx(C, WAirStirke, 512.0000000, 82.0000000, calW);
    C.SetPos(calW.X1, calW.Y1);
    ...
    fRatio = FClamp(fRatio, 0.0000000, 1.0000000);
    SkillAirstrikeOn.OffsetX = int(float(default.SkillAirstrikeOn.OffsetX) + (float(108) * fRatio));
    SkillAirstrikeOn.OffsetY = int(float(default.SkillAirstrikeOn.OffsetY) + (float(287) * fRatio));
...
function DisplayEvent_Skill_UAV(Canvas C)
{
    ...
    // End:0x119
    if((int(HudOwner.PlayerOwner.PlayerReplicationInfo.bySupply_UAV) == 1) && Displaying_State[int(4)] == 0)
    {
    ...
    C.DrawColor.A = byte(float(255) * fFadeOutEffect);
    DrawHelpBG(C,, 734);
    CalculateCoordinateEx(C, WUAV, 512.0000000, 82.0000000, calW);
    C.SetPos(calW.X1, calW.Y1);
    ...
    fRatio = FClamp(fRatio, 0.0000000, 1.0000000);
    SkillUAVOn.OffsetX = int(float(default.SkillUAVOn.OffsetX) + (float(32) * fRatio));
    SkillUAVOn.OffsetY = int(float(default.SkillUAVOn.OffsetY) + (float(287) * fRatio));
...
function DisplayEvent_Skill_UsingSkill(Canvas C)
{
    ...
    CalculateCoordinateEx(C, wTex, 512.0000000, 82.0000000, calW);
    C.SetPos(calW.X1, calW.Y1);
    ...
    fRatio = FClamp(fRatio, 0.0000000, 1.0000000);
    SkillIconEvent.WidgetTexture = HudCDeathmatch(HudOwner).ActiveUsingSkill.matIcon[1];
    SkillIconEvent.OffsetX = int(float(default.SkillIconEvent.OffsetX) + (float(-44) * fRatio));
    SkillIconEvent.OffsetY = int(float(default.SkillIconEvent.OffsetY) + (float(287) * fRatio));
...
function Draw_Item_Supply(Canvas C, PlayerReplicationInfo curPRI)
{
    ...
    {
        // End:0xA1
        if(HudCDeathmatch(HudOwner).mapInfo.SupplyUAV > float(0))
        {
            // End:0x80
            if(int(ECallSkillState) == int(4))
            {
                // End:0x80
                if(0 == int(curPRI.bySupply_UAV))
                {
                    DisplayEvent_Skill_State(C, WUAVNotReady, WUAVIcon);
                }
            }
            // End:0xA1
            if(1 == int(curPRI.bySupply_UAV))
            {
                DisplayEvent_Skill_UAV(C);
            }
        }
        // End:0x160
        if(HudCDeathmatch(HudOwner).mapInfo.SupplyHelicopter > float(0))
        {
            // End:0x117
            if(1 == int(curPRI.bySupply_Helipack))
            {
            ...
            {
                // End:0x160
                if(0 == int(curPRI.bySupply_Helipack))
                {
                    // End:0x160
                    if((int(2) == int(ECallSkillState)) && false == bResultSkillRequire)
                    {
                        DisplayEvent_Skill_State(C, WHelicopterNotReady, WHelicopterIcon);
                    }
                }
            }
        }
        // End:0x1FA
        if(HasSkillAirStirke == 2)
        {
        ...
        {
            // End:0x22D
            if((int(3) == int(ECallSkillState)) && false == bResultSkillRequire)
            {
...
function Draw_Item_Skill(Canvas C, PlayerReplicationInfo curPRI)
{
    ...
    if(1 == HudCDeathmatch(HudOwner).ActiveUsingSkill.iState)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    // End:0x14E
                    if(int(8) == int(ECallSkillState))
                    {
                        // End:0x14B
                        if(int(HudOwner.PlayerOwner.PlayerReplicationInfo.KillSuccession) < HellfireKillStreak)
                        {
                            DisplayEvent_Skill_State(C, WNotReadyHellFire);
                        }                        
                    }
                    else
                    {
                        // End:0x19A
                        if(int(12) == int(ECallSkillState))
                        {
                            // End:0x19A
                            if(int(HudOwner.PlayerOwner.PlayerReplicationInfo.KillSuccession) < SpiltGrenadeKillStreak)
                            {
    ...
    else
    {
        ...
        {
            // End:0x225
            if(HudOwner.PlayerOwner.Pawn.Weapon.IsA('wAirStrike') && int(8) == int(ECallSkillState))
            {
                DisplayEvent_Skill_State(C, WAirStirkeSellect,, true);                
            }
            else
...
{
    local CalCoordsW calW;
    local float fDeltaTime, fProgressPct, fRespawnTimeLength, fX1, fX2, fY1,
	    fY2;
    ...
    CalculateCoordinateEx(C, WRespawnText, 132.0000000, 44.0000000, calW);
    C.SetPos(calW.X1, calW.Y1);
    C.DrawTile(WRespawnText.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    // End:0x24D
    if(Level.GetMatchMaker().kGame_GameMode == 11)
    {
    ...
    C.SetDrawColor(byte(255), 155, byte(255), byte(255));
    //return;    
}
...
{
    local float fLifeTime, fEndOfLife, FadeValue, fFadeOutTime, iFontSize, fPosY,
	    fTotalEffectRunTime, fEffectRunTime1, fEffectRunTime2, fRealDrawTime, CurrentScale,
	    Delta, Delta2, fPassingTime, StartScale, fScaleStepMultiplier,
	    fScaleStep;
...
{
    local CalCoordsW calW;
    local int iIndex, iWaitingTime, iSecond, iFirst;
    ...
    iIndex = int(Level.TimeSeconds % float(3));
    ...
    C.SetPos(calW.X1, calW.Y1);
    C.DrawTile(WHelpBG.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    iWaitingTime = int(sWaitingMessage);
...
function DrawMainScore(Canvas C)
{
    ...
    CalculateCoordinateEx(C, WTeamScoreBG, 486.0000000, 40.0000000, calW);
    C.SetPos(calW.X1, calW.Y1);
    ...
    fY1 = (42.0000000 + float(_iPosY)) * _reY;
...
function FFARankingSorting()
{
    ...
    if(lpPRI < pris.Length)
    {
        currPRI = pris[lpPRI];
        // End:0xE2
        if((currPRI == HudOwner.PlayerOwner.PlayerReplicationInfo) && !currPRI.bAdminSpecator)
        {
            PRI_Self = currPRI;
...
{
    local Material matDrawBack;
    local int iTeamIndex;
    local CalCoordsW calW;
    local SpriteWidget WTeamMark, wResultImage1, wResultImage2;

    C.SetDrawColor(byte(255), byte(255), byte(255), byte(255));
    matDrawBack = Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_0_1';
    C.SetPos(0.0000000 * _reX, 0.0000000 * _reY);
    C.DrawTileStretched(matDrawBack, 1600.0000000 * _reX, 40.0000000 * _reY);
    matDrawBack = Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_0_1';
    C.SetPos(0.0000000 * _reX, 1160.0000000 * _reY);
    C.DrawTileStretched(matDrawBack, 1600.0000000 * _reX, 40.0000000 * _reY);
    CalculateCoordinateEx(C, wBackSeparationTop, 1600.0000000, 18.0000000, calW);
    C.SetPos(calW.X1, calW.Y1);
    C.DrawTile(wBackSeparationTop.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    CalculateCoordinateEx(C, wBackSeparationBottom, 1600.0000000, 18.0000000, calW);
    C.SetPos(calW.X1, calW.Y1);
    C.DrawTile(wBackSeparationBottom.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    iTeamIndex = HudOwner.PlayerOwner.PlayerReplicationInfo.Team.TeamIndex;
    // End:0x3B6
    if(iTeamIndex == 0)
    {
        ...
        if(Won)
        {
            wResultImage1 = WTeamImageAF[1];
            wResultImage2 = WTeamImageAF[0];            
        }
        else
        {
            wResultImage1 = WTeamImageAF[3];
            wResultImage2 = WTeamImageAF[2];
        }
        CalculateCoordinateEx(C, wResultImage1, 1024.0000000, 246.0000000, calW);
        C.SetPos(calW.X1, calW.Y1);
        C.DrawTile(wResultImage1.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
        CalculateCoordinateEx(C, wResultImage2, 1024.0000000, 246.0000000, calW);
        C.SetPos(calW.X1, calW.Y1);
        C.DrawTile(wResultImage2.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);        
    }
    else
    {
        // End:0x3DC
        if(Won)
        {
            wResultImage1 = WTeamImageRSA[1];
            wResultImage2 = WTeamImageRSA[0];            
        }
        else
        {
            wResultImage1 = WTeamImageRSA[3];
            wResultImage2 = WTeamImageRSA[2];
        }
        CalculateCoordinateEx(C, wResultImage1, 1024.0000000, 246.0000000, calW);
        C.SetPos(calW.X1, calW.Y1);
        C.DrawTile(wResultImage1.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
...
function DrawResultScore_FFA_Item(Canvas C, bool drawTop, PlayerReplicationInfo currPRI, wMatchUserInfo User, int lh, int currLH, int nextLH, Material medalMat, int Rank)
{
    ...
    tempMat = Level.GameMgr.GetLevelTexture(User.Grade, User.LevelMarkID);
    LvImgCoordi = Level.GameMgr.GetLevelImageCoordi(User.Grade, User.LevelMarkID);
...
{
    local float fDeltaTime, fFadeOut;
    local int iAlpha, iChangedAttackTeam;
...
function DrawWeaponChange(Canvas C)
{
    ...
    CalculateCoordinateEx(C, WHudBGR, 512.0000000, 101.0000000, calW);
    C.SetPos(calW.X1, calW.Y1);
    C.SetDrawColor(byte(255), byte(255), byte(255), byte(255));
    C.DrawTile(WHudBGR.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    WKeyButtonBG.OffsetX = int(PosX + float(81));
    WKeyButtonBG.OffsetY = int(PosY + float(25));
    CalculateCoordinateEx(C, WKeyButtonBG, 52.0000000, 52.0000000, calW);
    C.SetPos(calW.X1, calW.Y1);
    C.DrawTile(WKeyButtonBG.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    // End:0x295
    if(HudCDeathmatch(HudOwner).bBlinkState)
    {
        WKeyButtonBGBlink.OffsetX = int(PosX + float(79));
        WKeyButtonBGBlink.OffsetY = int(PosY + float(23));
        CalculateCoordinateEx(C, WKeyButtonBGBlink, 56.0000000, 56.0000000, calW);
        C.SetPos(calW.X1, calW.Y1);
        C.DrawTile(WKeyButtonBGBlink.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    }
    X1 = (PosX + 88.0000000) * _reX;
    Y1 = (PosY + 32.0000000) * _reY;
    X2 = (PosX + 126.0000000) * _reX;
    Y2 = (PosY + 60.0000000) * _reY;
    C.SetDrawColor(0, 0, 0, byte(255));
    ...
    DrawTileByMaterial(C, mat, 255, PosX + float(96), PosY + float(2), 1.5000000);
    C.SetDrawColor(byte(255), byte(255), byte(255), byte(255));
    X1 = (PosX + 192.0000000) * _reX;
    Y1 = (PosY + 77.0000000) * _reY;
    X2 = (PosX + 384.0000000) * _reX;
    Y2 = (PosY + 97.0000000) * _reY;
...
function DrawVehicleInfo(Canvas C)
{
    ...
    switch(wVehicle(ActiveVehicle).DefaultWeaponClassName)
    {
        // End:0x129
        case "wWeapons.wWeapon_Turret_FNM240":
    ...
    mat = Texture'Warfare_UI_HUD.Text.img_HUD_text';
    // End:0x537
    if(DrivenVehicle != none)
    {
...
function DrawWarningWeaponInfo(Canvas C)
{
    ...
    if((fCurAmmoRatio <= 0.3300000) && fMaxAmmoRatio > 0.3300000)
    {
        WHudBG2.OffsetX = 672;
        WHudBG2.OffsetY = 687;
        CalculateCoordinateEx(C, WHudBG2, 256.0000000, 28.0000000, calW);
        C.SetPos(calW.X1, calW.Y1);
        C.DrawTile(WHudBG2.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
        ...
        Y1 = int(float(689) * _reY);
        X2 = int(float(871) * _reX);
        Y2 = int(float(713) * _reY);
...
function DrawGainPoint(Canvas C, int iPoint, int iPosX, int iPosY, int iAlpha, optional int iEffectState, optional float fScale)
{
    local CalCoordsW calW;
    local float fWidth, fHeight, fOffSetX, fOffSetY, fBasePosX, fWidthAll,
	    fWidthHalf, fHeightHalf;

    CalculateCoordinateEx(C, WKillTextBg, 185.0000000, 53.0000000, calW);
    C.SetPos(calW.X1, calW.Y1);
    C.DrawTile(WKillTextBg.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    DigitsNumberPlus.Value = 10;
    DigitsNumberSecond.Value = iPoint / 10;
    DigitsNumberFirst.Value = int(float(iPoint) % float(10));
    fWidth = 51.0000000 * fScale;
    fHeight = 42.0000000 * fScale;
    // End:0x11F
    if(0 != DigitsNumberSecond.Value)
    {
        fBasePosX = 724.0000000;
        fWidthAll = 152.0000000;        
    }
    else
    {
        fBasePosX = 750.0000000;
        fWidthAll = 101.0000000;
    }
    fWidthHalf = (fWidthAll * (fScale - float(1))) * 0.5000000;
    fHeightHalf = (42.0000000 * (fScale - float(1))) * 0.5000000;
    DigitsNumberPlus.OffsetX = int(fBasePosX - fWidthHalf);
    DigitsNumberPlus.OffsetY = int(float(iPosY) - fHeightHalf);
    // End:0x1E8
    if(0 == iEffectState)
    {
        fWidth = 51.0000000;
        fHeight = 42.0000000;
        DigitsNumberPlus.OffsetX = int(fBasePosX);
        DigitsNumberPlus.OffsetY = iPosY;
    }
    CalculateCoordinateDigitEx(C, WDigitsNumberBroadBig, DigitsNumberPlus, fWidth, fHeight, DigitsNumberPlus.Value, calW);
    C.SetPos(calW.X1, calW.Y1);
    C.DrawTile(WDigitsNumberBroadBig.DigitTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    // End:0x3BC
    if(0 != DigitsNumberSecond.Value)
    {
        DigitsNumberSecond.OffsetX = int(float(DigitsNumberPlus.OffsetX) + (float(default.DigitsNumberSecond.OffsetX + 10) * fScale));
        DigitsNumberSecond.OffsetY = int(float(iPosY) - fHeightHalf);
        // End:0x316
        if(0 == iEffectState)
        {
            DigitsNumberSecond.OffsetX = 775;
            DigitsNumberSecond.OffsetY = iPosY;
        }
        CalculateCoordinateDigitEx(C, WDigitsNumberBroadBig, DigitsNumberSecond, fWidth, fHeight, DigitsNumberSecond.Value, calW);
        C.SetPos(calW.X1, calW.Y1);
        C.DrawTile(WDigitsNumberBroadBig.DigitTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    }
    // End:0x3DA
    if(0 != DigitsNumberSecond.Value)
    {
        fOffSetX = 826.0000000;        
    }
    else
    {
        fOffSetX = 801.0000000;
    }
    DigitsNumberFirst.OffsetX = int(fOffSetX);
    DigitsNumberFirst.OffsetY = int(float(iPosY) - fHeightHalf);
    // End:0x43F
    if(0 == iEffectState)
    {
        DigitsNumberFirst.OffsetX = int(fOffSetX);
        DigitsNumberFirst.OffsetY = iPosY;
    }
    CalculateCoordinateDigitEx(C, WDigitsNumberBroadBig, DigitsNumberFirst, fWidth, fHeight, DigitsNumberFirst.Value, calW);
    C.SetPos(calW.X1, calW.Y1);
    C.DrawTile(WDigitsNumberBroadBig.DigitTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    //return;    
}
...
function DrawGameMode(Canvas C)
{
    ...
    X1 = 800.0000000 - (float((iLen + 4) * iFontSize) / 2.0000000);
    i = 0;
    J0x89:
    ...
    if(i < 3)
    {
        ...
        DrawTileByMaterial(C, mGameMode[i], 255, X1, 65.0000000);
        X1 -= float(34);
        J0xD6:
    ...
    X1 = 453.0000000 * _reX;
    Y1 = 69.0000000 * _reY;
    X2 = 1147.0000000 * _reX;
    Y2 = 93.0000000 * _reY;
    C.SetDrawColor(byte(255), 153, 0, byte(255));
    C.BtrDrawTextJustifiedWithVolumeLine(sMessageGameMode, 1, X1, Y1, X2, Y2, int(float(iFontSize) * _reY), color_Shadow);
    C.SetDrawColor(byte(255), byte(255), byte(255), byte(255));
    //return;    
}
...
function string GetMessageGameMode_SD()
{
    ...
    if(Level.GRI.CurrentAttackingTeam == iTeamIndex)
    {
        ...
        if(Level.GRI.bObjectivePlanted)
        {
            ...
            if((Message != "") && bChangeMessgeGameMode)
            {
                switch(iGameObjectIndex)
                {
                    // End:0x143
                    case 0:
                        mGameMode[0] = Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.our_capture_a", Class'Engine.Material'));
                        // End:0x1E1
                        break;
                    // End:0x190
                    case 1:
                        mGameMode[0] = Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.our_capture_b", Class'Engine.Material'));
                        // End:0x1E1
                        break;
                    // End:0x1DE
                    case 2:
                        mGameMode[0] = Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.our_capture_c", Class'Engine.Material'));
                        // End:0x1E1
                        break;
                    // End:0xFFFF
                    default:
        ...
        else
        {
            ...
            {
                mGameMode[0] = Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.enemy_capture_b", Class'Engine.Material'));
                mGameMode[1] = Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.enemy_capture_a", Class'Engine.Material'));
                bChangeMessgeGameMode = false;
            }
        }        
    }
    else
    {
        ...
        if(Level.GRI.bObjectivePlanted)
        {
            ...
            if((Message != "") && bChangeMessgeGameMode)
            {
                switch(iGameObjectIndex)
                {
                    // End:0x391
                    case 0:
                        mGameMode[0] = Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.enemy_capture_a", Class'Engine.Material'));
                        // End:0x433
                        break;
                    // End:0x3E0
                    case 1:
                    ...
                    // End:0x430
                    case 2:
                        mGameMode[0] = Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.enemy_capture_c", Class'Engine.Material'));
                        // End:0x433
                        break;
                    // End:0xFFFF
                    default:
        ...
        else
        {
            ...
            {
                mGameMode[0] = Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.our_capture_b", Class'Engine.Material'));
                mGameMode[1] = Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.our_capture_a", Class'Engine.Material'));
                bChangeMessgeGameMode = false;
            }
        }
    }
    ...
    if(Message != sMessageGameMode)
    {
        switch(iCode)
        {
            ...
            case Class'Engine.wMessage_Game_Mode'.default.Code_GameMode_SBTGetBomb:
                mGameMode[0] = Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.map_bomb", Class'Engine.Material'));
                // End:0x380
                break;
            // End:0x24B
            case Class'Engine.wMessage_Game_Mode'.default.Code_GameMode_SBT:
                mGameMode[0] = Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.map_bomb_1", Class'Engine.Material'));
                // End:0x380
                break;
            // End:0x25C
...
defaultproperties
{
    ...
    WHelpBG=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_back_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=2),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=328,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wHelicopter=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=82,X2=1024,Y2=164),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=745,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirke=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=164,X2=512,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=745,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WUAV=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=410,X2=1024,Y2=492),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=745,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WC4=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=912,X2=1024,Y2=994),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=745,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WRPG7=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=512,Y2=82),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=745,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WReadyIncen=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=0,Y1=82,X2=512,Y2=164),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WReadyHellFire=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=0,Y1=164,X2=512,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WReadySpiltGrenade=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=0,Y1=246,X2=512,Y2=328),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WNotReadyIncen=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=82,X2=1024,Y2=164),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WNotReadyHellFire=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=164,X2=1024,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WNotReadySpiltGrenade=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=246,X2=1024,Y2=328),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirkeIcon=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_pac_bom',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.6500000,DrawPivot=0,PosX=0.3475000,PosY=0.6016667,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHelicopterIcon=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_pac_hel',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.6500000,DrawPivot=0,PosX=0.3475000,PosY=0.6016667,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WUAVIcon=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_pac_uav',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.6500000,DrawPivot=0,PosX=0.3475000,PosY=0.6016667,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    SkillRPG7On=(WidgetTexture=Texture'Warfare_UI_Item.SupplySkillicon.icon_wea_RPG7',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=736,OffsetY=844,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WC4NotReady=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=164,X2=1024,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirkeNotReady=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=82,X2=512,Y2=164),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHelicopterNotReady=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=0,X2=1024,Y2=82),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WUAVNotReady=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=246,X2=512,Y2=328),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WRPG7NotReady=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=0,X2=1024,Y2=82),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirkeRequireFaild=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=512,Y2=82),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHelicopterRequireFaild=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=248,X2=1024,Y2=328),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WUAVRequireFaild=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=328,X2=1024,Y2=410),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirkeFocus=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=328,X2=512,Y2=410),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirkeSellect=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=410,X2=512,Y2=492),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ECallSkillState=14
    WRespawnText=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=536,X2=644,Y2=580),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=733,OffsetY=343,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WConnectionInstability=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_dishost',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=128,Y2=128),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=700,OffsetY=465,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WBGStart=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_gmstart',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=128),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=536,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeTD=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=688,X2=256,Y2=752),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeSD=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=256,Y1=688,X2=512,Y2=752),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeDOMI=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=256,Y1=624,X2=512,Y2=688),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeSB=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=752,X2=256,Y2=816),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeDM=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=624,X2=256,Y2=688),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeFM=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=256,Y1=816,X2=512,Y2=880),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameTypeTM=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=587,Y1=816,X2=819,Y2=891),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameChangeAttack=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=816,X2=256,Y2=880),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGameChangePosition=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=256,Y1=752,X2=512,Y2=816),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGo=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_gmstart_go_1',RenderStyle=5,TextureCoords=(X1=1,Y1=20,X2=1024,Y2=237),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=288,OffsetY=491,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    strQuestNoUpdate="?? ??? ??? 3? ??? ?? ??? ?? ?? ??? ???? ????."
    BeginMessageTD="??? ????!"
    BeginMessageSDA1="???(A ? B)? ??? ???? ????!"
    BeginMessageSDD1="???(A ? B)? ?? ??? ????? ????!"
    BeginMessageDOMI="??? ???? ????!"
    BeginMessageSB="??? ?? ???? ??? ???? ????!"
    BeginMessageDM="??? ????!"
    BeginMessageFM="??? ????!"
    ...
    LsReload="???"
    LsWarningAmmo="????"
    LsConnectionInstability="???? ??? ???? ?? ??? ???????."
    lsIsInvincible="??? ? 3?? ?????."
    lsIsInvincibleBeginner="??? ? 5?? ?????."
    MessageChangingHostPre="??? ??"
    MessageChangingHost="?? ?? ?..."
    MessageChangingHostPlzWait="?? ?? ??? ??? ?? ?? ?????. ??? ??? ???."
    fMessageDrawTime=2.5000000
    fBeginMessageTime_Go=9999.0000000
    fMessageDrawTime_Go=0.1000000
    fFadeOutTime_Go=1.5000000
    WRoundResultBG=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_back_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=2),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=454,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WRoundWin=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=624,X2=1024,Y2=720),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=551,OffsetY=337,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WRoundLose=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=720,X2=1024,Y2=816),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=551,OffsetY=337,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamMarkAF=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_01',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=314,Y2=314),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=643,OffsetY=313,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamMarkRSA=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_01',RenderStyle=5,TextureCoords=(X1=314,Y1=0,X2=628,Y2=314),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=643,OffsetY=313,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WCompareSign=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_number',RenderStyle=5,TextureCoords=(X1=65,Y1=72,X2=79,Y2=127),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=786,OffsetY=558,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WCompareSignMid=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_number2',RenderStyle=5,TextureCoords=(X1=330,Y1=0,X2=344,Y2=42),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=786,OffsetY=558,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WTeamImageAF[0]=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_af',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageAF[1]=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_af',RenderStyle=5,TextureCoords=(X1=0,Y1=256,X2=1024,Y2=502),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=576,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageAF[2]=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_af',RenderStyle=5,TextureCoords=(X1=0,Y1=512,X2=1024,Y2=758),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageAF[3]=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_af',RenderStyle=5,TextureCoords=(X1=0,Y1=768,X2=1024,Y2=1014),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=576,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageRSA[0]=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_rsa',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageRSA[1]=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_rsa',RenderStyle=5,TextureCoords=(X1=0,Y1=256,X2=1024,Y2=502),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=576,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageRSA[2]=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_rsa',RenderStyle=5,TextureCoords=(X1=0,Y1=512,X2=1024,Y2=758),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamImageRSA[3]=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_rsa',RenderStyle=5,TextureCoords=(X1=0,Y1=768,X2=1024,Y2=1014),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=576,OffsetY=477,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wBackSeparationTop=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_up',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=40),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=459,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    wBackSeparationBottom=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_down',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=40),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=723,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WHudBG2=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_back_2',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=512,Y2=8),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=121,OffsetY=150,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHudBGR=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_back_red',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=512,Y2=8),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=121,OffsetY=150,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTeamScoreBG=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_score',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=486,Y2=40),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=557,OffsetY=5,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WResultTxtAF[0]=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_01',RenderStyle=5,TextureCoords=(X1=460,Y1=314,X2=758,Y2=442),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=570,OffsetY=478,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WResultTxtAF[1]=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_01',RenderStyle=5,TextureCoords=(X1=460,Y1=442,X2=758,Y2=570),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=570,OffsetY=478,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WResultTxtRSA[0]=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_01',RenderStyle=5,TextureCoords=(X1=0,Y1=314,X2=460,Y2=442),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=651,OffsetY=478,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WResultTxtRSA[1]=(WidgetTexture=Texture'Warfare_UI_UI.HUD_ETC.img_hud_etc_01',RenderStyle=5,TextureCoords=(X1=0,Y1=442,X2=460,Y2=570),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=651,OffsetY=478,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WFFAScoreBG=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_score_0',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=486,Y2=71),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=557,OffsetY=5,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WTimerBombBG=(WidgetTexture=Texture'Warfare_UI_HUD.Common.time_notice',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=240,Y2=106),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=659,OffsetY=74,ScaleMode=4,Scale=0.4000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    matBack1=Texture'Warfare_UI_HUD.Common.img_HUD_back_1'
    matLine=Texture'Warfare_UI_UI.HUD_ETC.list_scor_bord'
    matOn=Texture'Warfare_UI_UI.HUD_ETC.list_result_on'
    medals[0]=Texture'Warfare_UI_UI.HUD_ETC.img_indimat_1'
    medals[1]=Texture'Warfare_UI_UI.HUD_ETC.img_indimat_2'
    medals[2]=Texture'Warfare_UI_UI.HUD_ETC.img_indimat_3'
    RankPostfix="?"
    ...
    WKillTextBg=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text_bg2',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=182,Y2=53),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=720,OffsetY=262,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTxtHostChange=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=256,Y1=816,X2=512,Y2=880),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=700,OffsetY=459,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WTxtSudenDeath=(WidgetTexture=Texture'Warfare_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=912,X2=256,Y2=976),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=672,OffsetY=173,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WRespawnBG=(WidgetTexture=Texture'Warfare_UI_HUD.Common.gauge_HUD_back',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=512,Y2=32),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=544,OffsetY=388,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WRespawnGauge=(WidgetTexture=Texture'Warfare_UI_HUD.Common.gauge_HUD_n',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=512,Y2=32),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=546,OffsetY=390,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
}