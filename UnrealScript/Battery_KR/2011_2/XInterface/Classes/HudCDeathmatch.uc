...
struct AmmoThrowable
{
    ...
    var int Max;
    var int curr;
    var SpriteWidget Icon;
    var SpriteWidget Control;
};
...
var() SpriteWidget AmmoFragGrenadeIcon;
var() SpriteWidget AmmoFragGrenadeControl;
var() SpriteWidget AmmoStunGrenadeIcon;
var() SpriteWidget AmmoStunGrenadeControl;
var() SpriteWidget AmmoSmokeGrenadeIcon;
var() SpriteWidget AmmoSmokeGrenadeControl;
var() SpriteWidget AmmoGrenadeBG;
var bool bSetGrenade;
var bool bCountFragGrenade;
var bool bCountSmokeGrenade;
var bool bCountStunGrenade;
var int iCountSlot3;
var int iCountSlot4;
var Color AmmoGrenadeAvailableColor;
var Color AmmoGrenadeUnavailableColor;
var float AmmoGrenadeIconBeginX;
var float AmmoGrenadeIconBeginY;
var float AmmoGrenadeIconWidth;
var float AmmoGrenadeIconHeight;
var float AmmoGrenadeControlBeginX;
var float AmmoGrenadeControlBeginY;
var float AmmoGrenadeControlWidth;
var float AmmoGrenadeControlHeight;
var float AmmoGrenadeCountBeginX;
var float AmmoGrenadeCountBeginY;
var float AmmoGrenadeCountWidth;
var float AmmoGrenadeCountHeight;
var float AmmoGrenadeCountFontSize;
var float AmmoGrenadeOffsetX;
var array<AmmoThrowable> AmmoThrowableInfos;
...
var() SpriteWidget C4Bomb;
var() SpriteWidget ProgressStatusBG;
var() SpriteWidget ProgressStatusBar;
var() SpriteWidget SkillBG;
var() SpriteWidget SkillC4;
var() SpriteWidget SkillRPG;
var() SpriteWidget SkillM2B;
var() SpriteWidget SkillRPG7;
var() SpriteWidget SkillRPG7On;
var() SpriteWidget SkillIncen;
var() SpriteWidget SkillIncenOn;
var() SpriteWidget SkillHellFire;
var() SpriteWidget SkillHellFireOn;
var() SpriteWidget SkillHelicopter;
var() SpriteWidget SkillAirstrike;
var() SpriteWidget SkillC4On;
var() SpriteWidget SkillHelicopterOn;
var() SpriteWidget SkillAirstrikeOn;
var() SpriteWidget SkillUAV;
var() SpriteWidget SkillUAVOn;
var() SpriteWidget SkillC4Ctrl;
var() SpriteWidget SkillHelicopterCtrl;
var() SpriteWidget SkillAirstrikeCtrl;
var() SpriteWidget SkillBlink;
...
{
    Level.GetMatchMaker().MinimapMode++;
    UpdateMinimapMode();
    PlayHUDSound(PlayerOwner, 2);
    //return;    
}
...
function UpdateMinimapMode()
{
    switch(Level.GetMatchMaker().MinimapMode)
    {
        ...
        case 0:
            ...
            HudPart_Minimap.MinimapCoverSize = 350;
            HudPart_Minimap.IconSizeF = 0.5000000;
        ...
        case 1:
            ...
            HudPart_Minimap.MinimapCenterY = int(92.8000031);
            HudPart_Minimap.MinimapSize = int(166.3999939);
            HudPart_Minimap.MinimapCoverSize = 235;
            HudPart_Minimap.IconSizeF = 0.8000000;
            HudPart_Minimap.BaseColor.A = byte(255);
            HudPart_Minimap.DrawFrame = true;
            UAVIconPosXAlly = 286.0000000;
            UAVIconPosYAlly = 16.0000000;
        ...
        // End:0x633
        case 2:
            HudPart_Minimap.MinimapCenterX = 512;
            HudPart_Minimap.MinimapCenterY = 560;
            HudPart_Minimap.MinimapSize = 180;
            HudPart_Minimap.MinimapCoverSize = 450;
            HudPart_Minimap.IconSizeF = 0.5000000;
            HudPart_Minimap.BaseColor.A = 75;
            HudPart_Minimap.DrawFrame = false;
            UAVIconPosXAlly = 961.0000000;
            UAVIconPosYAlly = 741.0000000;
            UAVIconPosXEnemy = 961.0000000;
            UAVIconPosYEnemy = 815.0000000;
            UAVIconWidth = 64.0000000;
            UAVIconHeight = 64.0000000;
            UAVIconTextPosXAlly = 982.0000000;
            UAVIconTextPosYAlly = 752.0000000;
            UAVIconTextPosXEnemy = 982.0000000;
            UAVIconTextPosYEnemy = 827.0000000;
            UAVIconTextOffsetX = 12.0000000;
            UAVIconTextXL = 10.0000000;
            UAVIconTextYL = 13.0000000;
            UAVIconColor.A = 128;
            AFStringLeftTopX = 273.0000000 + 675.0000000;
            AFStringLeftTopY = 14.0000000 + 725.0000000;
            AFStringRightBottomX = 362.0000000 + 675.0000000;
            AFStringRightBottomY = 38.0000000 + 725.0000000;
            AFSurvivedUserCountLeftTopX = 273.0000000 + 675.0000000;
            AFSurvivedUserCountLeftTopY = 38.0000000 + 725.0000000;
            AFSurvivedUserCountRightBottomX = 362.0000000 + 675.0000000;
            AFSurvivedUserCountRightBottomY = 62.0000000 + 725.0000000;
            RSAStringLeftTopX = 273.0000000 + 675.0000000;
            RSAStringLeftTopY = 78.0000000 + 725.0000000;
            RSAStringRightBottomX = 362.0000000 + 675.0000000;
            RSAStringRightBottomY = 102.0000000 + 725.0000000;
            RSASurvivedUserCountLeftTopX = 273.0000000 + 675.0000000;
            RSASurvivedUserCountLeftTopY = 102.0000000 + 725.0000000;
            RSASurvivedUserCountRightBottomX = 362.0000000 + 675.0000000;
            RSASurvivedUserCountRightBottomY = 126.0000000 + 725.0000000;
            // End:0x659
            break;
        // End:0xFFFF
        default:
...
function PostBeginPlay()
{
    ...
    HudPart_KillMessage = Spawn(Class'XInterface_Decompressed.wHudPart_KillMessage', self);
    HudPart_KillMessage.Initialize(self, Level);
    HudPart_Minimap = Spawn(Class'XInterface_Decompressed.wHudPart_Minimap', self);
    ...
    HudPart_SelQuickSlot = Spawn(Class'XInterface_Decompressed.wHudPart_SelectQSlot', self);
    ...
    HudPart_Tutorial = Spawn(Class'XInterface_Decompressed.wHudPart_Tutorial', self);
...
function ResetHud()
{
    ...
    if(PawnOwner == none)
    {
        ...
        LastHealth = 0;
        bSetGrenade = false;
        bCountFragGrenade = false;
        bCountSmokeGrenade = false;
        bCountStunGrenade = false;
        InitSkillFlag();
    }
    //return;    
}
...
function PlaySoundRecovery()
{
    ...
    {
        fSoundPlayTime = PlayerOwner.GetSoundDuration(SoundGroup'Warfare_Sound_Char.breath.char_breath_recovery');
        // End:0xCC
        if((fStartPlayRecoverySound + fSoundPlayTime) < Level.TimeSeconds)
        {
            fStartPlayRecoverySound = Level.TimeSeconds;
            PlayerOwner.ClientPlaySound(SoundGroup'Warfare_Sound_Char.breath.char_breath_recovery', true, fVolume, 1);
        }        
    }
    else
    {
...
simulated function DrawSpectatingHud(Canvas C)
{
    ...
    HudPart_SelQuickSlot.Display_SelectQSlot(C);
...
simulated function DrawTurretCrossHair(Canvas C)
{
    ...
    cht = Texture'Warfare_HUD.HUD_Crosshair.ch_mg_rpg';
    C.Reset();
...
function float CalculateHPBar(bool bDamage, bool bRecovery)
{
    ...
    if(bDamage)
    {
        ...
        if(bBeginDamage)
        {
            ...
            // End:0x8C
            if((fAddValue <= 0.0000000) || CurHealth >= 100)
            {
                fAddValue = 0.0000000;
                bBeginDamage = false;
            }
...
{
    local float fHealthRatio, fStaminaRatio, X1, Y1, X2, Y2,
	    XL, YL, U, V, UL,
	    VL, fWidth, fHeight, fHPIconPosX, fHPIconPosY,
	    fSpectatingPosX, fSpectatingPosY;
    ...
    else
    {
        ...
        HpStaminaBackground.OffsetX = int(fSpectatingPosX);
        HpStaminaBackground.OffsetY = int(fSpectatingPosY);
        HpBarBackground.OffsetX = int(fSpectatingPosX);
        HpBarBackground.OffsetY = int(fSpectatingPosY);
        DamageBar.OffsetX = int(fSpectatingPosX);
        DamageBar.OffsetY = int(fSpectatingPosY);
        RecoveryBar.OffsetX = int(fSpectatingPosX);
        RecoveryBar.OffsetY = int(fSpectatingPosY);
        fHPIconPosX = 57.0000000;
        fHPIconPosY = fSpectatingPosY;
        // End:0x229
    ...
    fWidth = 22.0000000 / 1600.0000000;
    fHeight = 22.0000000 / 1200.0000000;
    ...
    if(bBeginDamage)
    {
        ...
        {
            XL = ((X2 - X1) * fCurrentDamageBar) / 100.0000000;
            YL = Y2 - Y1;
            ...
            C.DrawTile(DamageBar.WidgetTexture, XL, YL, U, V, (UL * fCurrentDamageBar) / 100.0000000, VL);
        }
    }
    ...
    if(bBeginRecovery)
    {
        ...
        {
            XL = ((X2 - X1) * float(CurHealth)) / 100.0000000;
            YL = Y2 - Y1;
            ...
            C.SetPos(X1, Y1);
            C.DrawTile(RecoveryBar.WidgetTexture, XL, YL, U, V, (UL * float(CurHealth)) / 100.0000000, VL);
        }
    }
    XL = ((X2 - X1) * fCurrentHPBar) / 100.0000000;
    YL = Y2 - Y1;
    ...
    C.SetPos(X1, Y1);
    C.DrawTile(HpBar.WidgetTexture, XL, YL, U, V, (UL * fCurrentHPBar) / 100.0000000, VL);
    // End:0xE19
    if(!bShowSpectating)
    {
        X1 = (StaminaBarBackground.PosX + (float(StaminaBarBackground.OffsetX) / 1600.0000000)) * C.ClipX;
        Y1 = (StaminaBarBackground.PosY + (float(StaminaBarBackground.OffsetY) / 1200.0000000)) * C.ClipY;
        fWidth = 238.0000000 / 1600.0000000;
        fHeight = 9.0000000 / 1200.0000000;
        X2 = X1 + (fWidth * C.ClipX);
        Y2 = Y1 + (fHeight * C.ClipY);
        XL = X2 - X1;
        YL = Y2 - Y1;
        U = float(StaminaBarBackground.TextureCoords.X1);
        V = float(StaminaBarBackground.TextureCoords.Y1);
        UL = float(StaminaBarBackground.TextureCoords.X2 - StaminaBarBackground.TextureCoords.X1);
        VL = float(StaminaBarBackground.TextureCoords.Y2 - StaminaBarBackground.TextureCoords.Y1);
        C.SetPos(X1, Y1);
        C.DrawTile(StaminaBarBackground.WidgetTexture, XL, YL, U, V, UL, VL);
        X1 = (StaminaBar.PosX + (float(StaminaBar.OffsetX) / 1600.0000000)) * C.ClipX;
        Y1 = (StaminaBar.PosY + (float(StaminaBar.OffsetY) / 1200.0000000)) * C.ClipY;
        fWidth = 238.0000000 / 1600.0000000;
        fHeight = 9.0000000 / 1200.0000000;
        fStaminaRatio = PlayerOwner.fSprintTime / PawnOwner.wMyParam.Stm_MaxTime;
        X2 = X1 + (fWidth * C.ClipX);
        Y2 = Y1 + (fHeight * C.ClipY);
        XL = (X2 - X1) * fStaminaRatio;
        YL = Y2 - Y1;
        U = float(StaminaBar.TextureCoords.X1);
        V = float(StaminaBar.TextureCoords.Y1);
        UL = float(StaminaBar.TextureCoords.X2 - StaminaBar.TextureCoords.X1);
        VL = float(StaminaBar.TextureCoords.Y2 - StaminaBar.TextureCoords.Y1);
        C.SetPos(X1, Y1);
        C.DrawTile(StaminaBar.WidgetTexture, XL, YL, U, V, UL, VL);
        fHealthRatio = float(CurHealth) / PawnOwner.HealthMax;
        // End:0xDEE
        if((fStaminaRatio < 0.8000000) && fStaminaRatio > 0.0000000)
        {
            PlaySoundRecovery();
        }
        // End:0xE19
        if(fStaminaRatio >= 0.8000000)
        {
            // End:0xE11
            if(bPlayRecoverySounding)
            {
                PlaySoundStop(C);
            }
            bPlayRecoverySounding = false;
        }
    }
...
function NotifyDeath(Pawn P)
{
    ...
    else
    {
        ...
        if(pPRI != none)
        {
            ...
            // End:0x11A
            if(pPRI.Team.TeamIndex == PawnOwnerPRI.Team.TeamIndex)
            {
...
function DrawSkill_Slot5(Canvas C)
{
    ...
    // End:0x29F
    if((bSkill_ATR || bSkill_M2B) || 2 == ActiveUsingSkill.iState)
    {
        // End:0x3E
        if(bSkill_ATR)
        {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    // End:0x8F
                    if(none != ActiveUsingSkill.matIcon[1])
                    {
        ...
        SkillSlot5.Tints[0] = C.MakeColor(byte(255), byte(255), byte(255), byte(255));
        SkillSlot5.Tints[1] = C.MakeColor(byte(255), byte(255), byte(255), byte(255));
        // End:0x18E
        if(SkillSlot5.WidgetTexture != none)
        {
        ...
        if(bBlinkState)
        {
            C.SetPos(calW.X1, calW.Y1);
            // End:0x233
            if((2 == ActiveUsingSkill.iState) && ActiveUsingSkill.bDrawedIcon)
            {
                C.DrawTile(SkillBlink.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);                
            }
            else
            {
                // End:0x29C
    ...
    {
        // End:0x3A3
        if(1 == ActiveUsingSkill.iState)
        {
            SkillSlot5.Tints[0] = AmmoGrenadeUnavailableColor;
            SkillSlot5.Tints[1] = AmmoGrenadeUnavailableColor;
            // End:0x2FC
            if(none != ActiveUsingSkill.matIcon[0])
            {
...
{
    local bool bSupplyUAV;
    local CalCoordsW calW;

    // End:0x36
    if((mapInfo.SupplyHelicopter <= float(0)) && mapInfo.SupplyUAV > float(0))
    {
        bSupplyUAV = true;
    }
    // End:0x394
    if((1 == int(PlayerOwner.PlayerReplicationInfo.bySupply_Helipack)) || 1 == int(PlayerOwner.PlayerReplicationInfo.bySupply_UAV))
    {
        SkillHelicopter.Tints[0] = C.MakeColor(byte(255), byte(255), byte(255), byte(255));
        SkillHelicopter.Tints[1] = C.MakeColor(byte(255), byte(255), byte(255), byte(255));
        SkillHelicopter.OffsetX = default.SkillHelicopter.OffsetX;
        SkillHelicopter.OffsetY = default.SkillHelicopter.OffsetY;
        CalculateCoordinateEx(C, SkillHelicopter, 64.0000000, 64.0000000, calW);
        C.SetPos(calW.X1, calW.Y1);
        // End:0x27C
        if(bSupplyUAV && 1 == int(PlayerOwner.PlayerReplicationInfo.bySupply_UAV))
        {
            // End:0x184
            if(HudPart_DisplayEvent.bDrawSkillUAV)
            {
                SkillSlot6 = SkillUAVOn;                
            }
            else
            {
                SkillSlot6 = SkillUAV;
            ...
            // End:0x279
            if(bBlinkState && HudPart_DisplayEvent.bDrawSkillUAV)
            {
                C.SetPos(calW.X1, calW.Y1);
                C.DrawTile(SkillBlink.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
            }            
        ...
        {
            // End:0x29C
            if(HudPart_DisplayEvent.bDrawSkillHelicopter)
            {
                SkillSlot6 = SkillHelicopterOn;                
            }
            else
            {
                SkillSlot6 = SkillHelicopter;
            }
            C.DrawTile(SkillSlot6.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
            // End:0x391
            if(bBlinkState && HudPart_DisplayEvent.bDrawSkillHelicopter)
            {
                C.SetPos(calW.X1, calW.Y1);
                C.DrawTile(SkillBlink.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
            }
    ...
    {
        SkillHelicopter.Tints[0] = AmmoGrenadeUnavailableColor;
        SkillHelicopter.Tints[1] = AmmoGrenadeUnavailableColor;
        SkillHelicopter.OffsetX = default.SkillHelicopter.OffsetX;
        SkillHelicopter.OffsetY = default.SkillHelicopter.OffsetY;
        CalculateCoordinateEx(C, SkillHelicopter, 64.0000000, 64.0000000, calW);
        C.SetPos(calW.X1, calW.Y1);
        ...
        if(bSupplyUAV)
        {
            C.DrawTile(SkillUAV.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);            
        }
        else
        {
            C.DrawTile(SkillHelicopter.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
        }
    }
    //return;    
}

function DrawSkill_Slot7(Canvas C)
{
    local CalCoordsW calW;

    // End:0x1D1
    if((2 == HasSkillAirStirke) && HudPart_DisplayEvent.bDrawSkillAirStrike)
    {
        SkillAirstrikeOn.Tints[0] = C.MakeColor(byte(255), byte(255), byte(255), byte(255));
        SkillAirstrikeOn.Tints[1] = C.MakeColor(byte(255), byte(255), byte(255), byte(255));
        SkillAirstrikeOn.OffsetX = default.SkillAirstrikeOn.OffsetX;
        SkillAirstrikeOn.OffsetY = default.SkillAirstrikeOn.OffsetY;
        CalculateCoordinateEx(C, SkillAirstrikeOn, 64.0000000, 64.0000000, calW);
        C.SetPos(calW.X1, calW.Y1);
        C.DrawTile(SkillAirstrikeOn.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
        // End:0x1CE
        if(bBlinkState && HudPart_DisplayEvent.bDrawSkillAirStrike)
        {
            C.SetPos(calW.X1, calW.Y1);
            C.DrawTile(SkillBlink.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
        }        
    ...
    {
        SkillAirstrike.Tints[0] = AmmoGrenadeUnavailableColor;
        SkillAirstrike.Tints[1] = AmmoGrenadeUnavailableColor;
        SkillAirstrike.OffsetX = default.SkillAirstrike.OffsetX;
        SkillAirstrike.OffsetY = default.SkillAirstrike.OffsetY;
        CalculateCoordinateEx(C, SkillAirstrike, 64.0000000, 64.0000000, calW);
        C.SetPos(calW.X1, calW.Y1);
        C.DrawTile(SkillAirstrike.WidgetTexture, calW.XL, calW.YL, calW.U, calW.V, calW.UL, calW.VL);
    }
    //return;    
}
...
function CheckPawnOwnerSkill(out int SkillC4, out int skillAirStirke, out int SkillRPG)
{
    ...
    arSkills = PlayerOwner.SkillBase.Skills;
    iTemp = 0;
    J0x5F:
    ...
    if(iTemp < arSkills.Length)
    {
        switch(arSkills[iTemp].SkillID)
        {
            ...
            // End:0x104
            case 40022:
                InsertUsingSkillList(arSkills[iTemp].SkillID);
                iState = 1;
                // End:0x107
                break;
            // End:0xFFFF
...
function InsertUsingSkillList(int SkillID)
{
    ...
    switch(SkillID)
    {
        // End:0xC6
        case 40005:
            skillunit.iSlotPos = 5;
            skillunit.iSkillID = SkillID;
            skillunit.iWeaponID = 7001;
            skillunit.matIcon[0] = Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_time_c4_0';
            skillunit.matIcon[1] = Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_time_c4';
        ...
        case 40012:
            ...
            skillunit.matIcon[0] = Texture'Warfare_UI_Item.SupplySkillicon.icon_wea_RPG7_0';
            skillunit.matIcon[1] = Texture'Warfare_UI_Item.SupplySkillicon.icon_wea_RPG7';
        ...
        case 40017:
            ...
            skillunit.matIcon[0] = Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_incen_0';
            skillunit.matIcon[1] = Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_incen';
        ...
        case 40018:
            skillunit.iSlotPos = 5;
            skillunit.iSkillID = SkillID;
            skillunit.iWeaponID = 5013;
            skillunit.matIcon[0] = Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_hellfire_0';
            skillunit.matIcon[1] = Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_hellfire';
            skillunit.wTex[0] = HudPart_DisplayEvent.default.WNotReadyHellFire;
            skillunit.wTex[1] = HudPart_DisplayEvent.default.WReadyHellFire;
            ActiveUsingSkill = skillunit;
            // End:0x33F
            break;
        // End:0x33A
        case 40022:
            ...
            skillunit.matIcon[0] = Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_Cluster_0';
            skillunit.matIcon[1] = Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_Cluster';
...
function DrawAmmo(Canvas C)
{
    ...
    // End:0x4AC
    if(((int(PlayerOwner.Pawn.Weapon.WeaponType) != int(5)) && int(PlayerOwner.Pawn.Weapon.WeaponType) != int(8)) && int(PlayerOwner.Pawn.Weapon.WeaponType) != int(12))
    {
        // End:0x30C
        if(int(PlayerOwner.Pawn.Weapon.WeaponType) != int(9))
        {
            // End:0x1FB
    ...
    DrawAmmoForThrowables(C);
    //return;    
}

function CheckEnableThrowWeapon()
{
    local Inventory Inv;
    local wWeapon Wpn;
    local byte wInvGroup;
    ...
    local int wID, lp1;
    local float Max, curr;
    local AmmoThrowable newAmmo;
    local int iCountFragGrenade, iCountSmokeGrenade, iCountStunGrenade;
    ...
    AmmoThrowableInfos[0] = newAmmo;
    AmmoThrowableInfos[1] = newAmmo;
    AmmoThrowableInfos[0].WeaponCode = 6002;
    AmmoThrowableInfos[0].Icon = AmmoStunGrenadeIcon;
    AmmoThrowableInfos[0].Control = AmmoStunGrenadeControl;
    AmmoThrowableInfos[1].WeaponCode = 6000;
    AmmoThrowableInfos[1].Icon = AmmoFragGrenadeIcon;
    AmmoThrowableInfos[1].Control = AmmoFragGrenadeControl;
    AmmoThrowableInfos[2] = newAmmo;
    AmmoThrowableInfos[2].WeaponCode = 6001;
    AmmoThrowableInfos[2].Icon = AmmoSmokeGrenadeIcon;
    AmmoThrowableInfos[2].Control = AmmoSmokeGrenadeControl;
    Inv = PawnOwner.Inventory;
    J0x100:
    ...
    if(Inv != none)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                // End:0x2F1
                if((int(wInvGroup) == 4) || int(wInvGroup) == 3)
                {
                    lp1 = 0;
                    J0x1E7:

                    // End:0x2F1 [Loop If]
                    if(lp1 < AmmoThrowableInfos.Length)
                    {
                        // End:0x2E7
                        if(AmmoThrowableInfos[lp1].WeaponCode == wID)
                        {
                            // End:0x232
                            if(wID == 6000)
                            {
                                iCountFragGrenade++;
                                bCountFragGrenade = true;                                
                            }
                            else
                            {
                                // End:0x253
                                ...
                                else
                                {
                                    ...
                                    {
                                        iCountStunGrenade++;
                                        bCountStunGrenade = true;
                                    }
                                }
                            }
                            Wpn.GetAmmoCount(Max, curr);
                            AmmoThrowableInfos[lp1].Max = int(Max);
                            AmmoThrowableInfos[lp1].curr = AmmoThrowableInfos[lp1].curr + int(curr);
                            AmmoThrowableInfos[lp1].InvID = int(wInvGroup);
                            // [Explicit Break]
                            goto J0x2F1;
                        }
                        lp1++;
    ...
    iCountSlot4 = iCountFragGrenade;
    iCountSlot3 = iCountSmokeGrenade + iCountStunGrenade;
    //return;    
}

function DrawAmmoForThrowables(Canvas C)
{
    local int lp1, Count;
    local float X1, Y1, X2, Y2, W, H,
	    FontSize;

    local AmmoThrowable currAmmo;
    local int iDrawLocationIndex;
    ...
    {
        // End:0xB8
        if((AmmoThrowableInfos[lp1].WeaponCode == 6000) && bCountFragGrenade)
        {
            AmmoThrowableInfos[lp1].bActive = true;
            AmmoThrowableInfos[lp1].InvID = 4;            
        }
        else
        {
            // End:0x106
            if((AmmoThrowableInfos[lp1].WeaponCode == 6001) && bCountSmokeGrenade)
            {
                AmmoThrowableInfos[lp1].bActive = true;
                AmmoThrowableInfos[lp1].InvID = 3;                
            }
            else
            {
                // End:0x151
                if((AmmoThrowableInfos[lp1].WeaponCode == 6002) && bCountStunGrenade)
                {
                    AmmoThrowableInfos[lp1].bActive = true;
                    AmmoThrowableInfos[lp1].InvID = 3;
                }
        ...
        // End:0x16B
        if(false == AmmoThrowableInfos[lp1].bActive)
        {
            // [Explicit Continue]
            goto J0x4CA;
        }
        // End:0x1CE
        if(3 == AmmoThrowableInfos[lp1].InvID)
        {
            // End:0x1C4
            if(bCountSmokeGrenade && bCountStunGrenade)
            {
                // End:0x1BA
                if(AmmoThrowableInfos[lp1].WeaponCode == 6001)
                {
                    iDrawLocationIndex = 0;                    
                }
                else
                {
                    iDrawLocationIndex = 1;
                }                
            }
            else
            {
        ...
        {
            // End:0x1EC
            if(4 == AmmoThrowableInfos[lp1].InvID)
            {
                iDrawLocationIndex = 0;
            }
        }
        currAmmo = AmmoThrowableInfos[lp1];
        // End:0x4CA
        if(true)
        {
            // End:0x25A
            if(currAmmo.curr == 0)
            {
                C.DrawColor = C.MakeColorNoEmpty(AmmoGrenadeUnavailableColor.R, AmmoGrenadeUnavailableColor.G, AmmoGrenadeUnavailableColor.B, AmmoGrenadeUnavailableColor.A);                
            }
            else
            {
                C.DrawColor = C.MakeColorNoEmpty(AmmoGrenadeAvailableColor.R, AmmoGrenadeAvailableColor.G, AmmoGrenadeAvailableColor.B, AmmoGrenadeAvailableColor.A);
            }
            X1 = (AmmoGrenadeIconBeginX - (float(iDrawLocationIndex) * AmmoGrenadeOffsetX)) * C.ClipX;
            Y1 = AmmoGrenadeIconBeginY * C.ClipY;
            W = AmmoGrenadeIconWidth * C.ClipX;
            H = AmmoGrenadeIconHeight * C.ClipY;
            C.SetPos(X1, Y1);
            C.DrawTile(currAmmo.Icon.WidgetTexture, W, H, float(currAmmo.Icon.TextureCoords.X1), float(currAmmo.Icon.TextureCoords.Y1), float(currAmmo.Icon.TextureCoords.X2 - currAmmo.Icon.TextureCoords.X1), float(currAmmo.Icon.TextureCoords.Y2 - currAmmo.Icon.TextureCoords.Y1));
            X1 = (AmmoGrenadeCountBeginX - (float(iDrawLocationIndex) * AmmoGrenadeOffsetX)) * C.ClipX;
            Y1 = AmmoGrenadeCountBeginY * C.ClipY;
            X2 = X1 + (AmmoGrenadeCountWidth * C.ClipX);
            Y2 = Y1 + (AmmoGrenadeCountHeight * C.ClipY);
            FontSize = AmmoGrenadeCountFontSize * C.ClipY;
            C.BtrDrawTextJustifiedWithVolumeLine(string(currAmmo.curr), 1, X1, Y1, X2, Y2, int(FontSize), color_Shadow);
            Count++;
        }
        J0x4CA:
...
function DrawAmmoFlameThrower2(Canvas C, int curr, int Max)
{
    ...
    C.DrawTile(Texture'Warfare_UI_HUD.Common.frame_1', 223.0000000 * _reX, 40.0000000 * _reY, 0.0000000, 0.0000000, 224.0000000, 41.0000000);
    // End:0x75
    if(curr == 0)
    {        
    }
    else
    {
        ...
        C.DrawTile(Texture'Warfare_UI_HUD.Common.frame_fuel', (200.0000000 * ratio) * _reX, 26.0000000 * _reY, 0.0000000, 0.0000000, 201.0000000 * ratio, 27.0000000);
    }
    //return;    
}
...
function DrawHudSpectating(Canvas C)
{
    ...
    X1 = fbSpectateUser.X1 * _reX;
    X2 = X1 + (float(600) * _reX);
    ...
    X1 = fWidth + (fbSpectateUser.X1 * _reX);
    X2 = 1400.0000000 * _reX;
    ...
    if(i < 3)
    {
        ...
        {
            Class'Engine.BTCustomDrawHK'.static.DrawImage(C, ImgPlayerClanMark[i], fbSpectateClanMark.X1 * ratioX, fbSpectateClanMark.Y1 * ratioY, fbSpectateClanMark.X2 * ratioX, fbSpectateClanMark.Y2 * ratioY);
        }
        i++;
        // [Loop Continue]
        goto J0x602;
    }
    Class'Engine.BTCustomDrawHK'.static.DrawImage(C, ImgPlayerLevel, fbSpectateLevel.X1 * ratioX, fbSpectateLevel.Y1 * ratioY, fbSpectateLevel.X2 * ratioX, fbSpectateLevel.Y2 * ratioY);
    C.DrawColor = WhiteColor;
...
function DrawDamageDealNotification(Canvas C)
{
    ...
    {
        // End:0x96
        if(int(byte(PawnOwner.LastDamageCollisionPart)) == int(1))
        {
            PawnOwner.PlaySoundHK(Sound'Warfare_Sound_Char.etc.char_hit_success', 0, 1.0000000);            
        }
        else
        {
            PawnOwner.PlaySoundHK(Sound'Warfare_Sound_Char.etc.char_hit_success', 0, 1.0000000);
...
function NotifyHealthInDanger()
{
    ...
    {
        ShowHealthInDanagerSoundID = PawnOwner.PlaySoundHK(Sound'Warfare_Sound_Char.etc.char_heartbeat_01', 0, float(PawnOwner.SoundVolume) / 255.0000000);
    }
...
{
    PawnOwner.PlaySoundHK(SoundGroup'Warfare_Sound_Char.etc.char_fall', 0, float(PawnOwner.SoundVolume) / 255.0000000);
...
function DrawHealthInDanger(Canvas C)
{
    ...
    {
        ShowHealthInDanagerSoundID = PawnOwner.PlaySoundHK(Sound'Warfare_Sound_Char.etc.char_heartbeat_01', 0, 1.0000000 - Progress);
        ShowHealthInDanagerSoundID = PawnOwner.PlaySoundHK(SoundGroup'Warfare_Sound_Char.breath.char_breath_emergency', 0, 1.0000000 - Progress);
    }
    // End:0x1F5
...
function OnClientReceiveHeliDeathMessage(PlayerController P, PlayerReplicationInfo attackerPRI, PlayerReplicationInfo victimPRI, optional Object OptionalObject)
{
    ...
    HudPart_KillMessage.AddKillMessageItem(HudPart_KillMessage.MakeKillMessageItem(attackerPRI, none, attackerPRI.PlayerName, KillMessageHelicopterName, Class<DamageType>(cls), false, true, none));
    //return;    
}

function OnClientReceiveDeathMessage(PlayerController P, PlayerReplicationInfo attackerPRI, PlayerReplicationInfo victimPRI, optional Object OptionalObject)
{
    local Class<DamageType> DamageType;

    DamageType = Class<DamageType>(OptionalObject);
    // End:0xBF
    if((((P != none) && attackerPRI != none) && victimPRI != none) && DamageType != none)
    {
        HudPart_KillMessage.AddKillMessage(attackerPRI, victimPRI, DamageType);
        // End:0xBF
...
function DrawSelfKillMessage(Canvas C)
{
    ...
    if((LastSelfKillMessage.Time != float(0)) && (Level.TimeSeconds - LastSelfKillMessage.Time) < float(3))
    {
        ...
        C.SetDrawColor(byte(255), byte(255), byte(255));
        C.DrawTileStretched(Texture'Warfare_UI_HUD.Common.img_HUD_back_2', 511.0000000 * _reX, 51.0000000 * _reY);
...
function Vector CalcScreenPos(Canvas C, Vector objectLoc, float W, float H, out byte clipped, optional bool ClipEclipse, optional float rX, optional float rY)
{
    ...
    cX = 534.0000000 / float(1024);
    cY = 412.0000000 / float(768);
    // End:0x49
    if(rX == float(0))
    {
...
function DrawObjectSprite2(Canvas C, Object Tag, SpriteWidget objectSprite, Vector objectLoc, optional string ObjectName)
{
    local float W, H;
    local Vector ScreenPos;
    local byte clipped;
...
function DrawOutArrow(Canvas C, float W, float H, Vector ScreenPos)
{
    ...
    C.SetPos(ScreenPos.X - (Size / float(2)), (ScreenPos.Y - (H / float(2))) - (Size / float(2)));
...
function DrawUAV(Canvas C)
{
    ...
    if(myTeamUAV)
    {
        ...
        C.DrawTile(Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.icon_wh_uav", Class'Engine.Material')), UAVIconWidth * _reX, UAVIconHeight * _reY, 0.0000000, 0.0000000, 64.0000000, 64.0000000);
    ...
    if(enemyTeamUAV)
    {
        ...
        C.DrawTile(Material(DynamicLoadObject("Warfare_UI_HUD_ETC.minimapicon.icon_r_uav", Class'Engine.Material')), UAVIconWidth * _reX, UAVIconHeight * _reY, 0.0000000, 0.0000000, 64.0000000, 64.0000000);
...
simulated function DrawMessage(Canvas C, int i, float PosX, float PosY, out float dx, out float dy)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                Class'Engine.BTCustomDrawHK'.static.DrawStringModulateAlpha(C, LocalMessages[i].StringMessage, 4, (20.0000000 / 768.0000000) * C.ClipY, 0.0000000, ScreenY, C.ClipX, ScreenY + LocalMessages[i].dy, C.DrawBackColor, 4, false);
            }
        }
    }
...
simulated function DrawMessageScore(Canvas C, int i, float PosX, float PosY, out float dx, out float dy)
{
    ...
    local Color DrawShadowColor;
    local float fFadeOutTime, iFontSize, fPosY, fTotalEffectRunTime, fEffectRunTime1, fEffectRunTime2,
	    fRealDrawTime, CurrentScale, Delta, Delta2, fPassingTime,
	    StartScale, fScaleStepMultiplier, fScaleStep;
    ...
    switch(LocalMessages[i].StringMessage)
    {
        // End:0x3E2
        case "Assist":
            DrawScoreEffect(C, WAssist, 274.0000000, 72.0000000, calW);
            // End:0x4DD
            break;
        // End:0x411
        case "Helikill":
            DrawScoreEffect(C, WHelikill, 274.0000000, 72.0000000, calW);
            // End:0x4DD
            break;
        // End:0x445
        case "Artillerykill":
            DrawScoreEffect(C, WArtillerykill, 274.0000000, 72.0000000, calW);
            // End:0x4DD
            break;
        // End:0x473
        case "Capture":
            DrawScoreEffect(C, WCapture, 274.0000000, 72.0000000, calW);
            // End:0x4DD
            break;
        // End:0x4A4
        case "BombSetted":
            DrawScoreEffect(C, WBombSetted, 274.0000000, 72.0000000, calW);
            // End:0x4DD
            break;
        // End:0x4D7
        case "BombDiffused":
            DrawScoreEffect(C, WBombDiffused, 274.0000000, 72.0000000, calW);
            // End:0x4DD
            break;
        // End:0xFFFF
        default:
    ...
    if(Level.GetIsTeenVersion() == false)
    {
        switch(LocalMessages[i].StringMessage)
        {
            // End:0x54F
            case "3kill":
                DrawScoreEffect(C, WKillBlood, 378.0000000, 291.0000000, calW);
                DrawScoreEffect(C, W3Kill, 274.0000000, 72.0000000, calW);
                // End:0x6FC
                break;
            // End:0x59A
            case "5kill":
                DrawScoreEffect(C, WKillBlood, 378.0000000, 291.0000000, calW);
                DrawScoreEffect(C, W5Kill, 274.0000000, 72.0000000, calW);
                // End:0x6FC
                break;
            // End:0x5E5
            case "7kill":
                DrawScoreEffect(C, WKillBlood, 378.0000000, 291.0000000, calW);
                DrawScoreEffect(C, W7Kill, 274.0000000, 72.0000000, calW);
                // End:0x6FC
                break;
            // End:0x631
            case "10kill":
                DrawScoreEffect(C, WKillBlood, 378.0000000, 291.0000000, calW);
                DrawScoreEffect(C, W10Kill, 274.0000000, 72.0000000, calW);
                // End:0x6FC
                break;
            // End:0x67D
            case "15kill":
                DrawScoreEffect(C, WKillBlood, 378.0000000, 291.0000000, calW);
                DrawScoreEffect(C, W15Kill, 274.0000000, 72.0000000, calW);
                // End:0x6FC
                break;
            // End:0x6CB
            case "headshot":
                DrawScoreEffect(C, WKillBlood, 378.0000000, 291.0000000, calW);
                DrawScoreEffect(C, WHeadshot, 274.0000000, 72.0000000, calW);
                // End:0x6FC
                break;
            // End:0x6F6
            case "Kill":
                DrawScoreEffect(C, WKill, 274.0000000, 72.0000000, calW);
                // End:0x6FC
                break;
            // End:0xFFFF
            default:
    ...
    else
    {
        switch(LocalMessages[i].StringMessage)
        {
            // End:0x75C
            case "3kill":
                DrawScoreEffect(C, WKillBlood_Teen, 378.0000000, 291.0000000, calW);
                DrawScoreEffect(C, W3Kill, 274.0000000, 72.0000000, calW);
                // End:0x909
                break;
            // End:0x7A7
    ...
    HudPart_DisplayEvent.DrawGainPoint(C, Class'Engine.wMessage_Score'.static.GetGainPoint(LocalMessages[i].Switch), int(dx), 267, int(C.DrawColor.A), MessageScoreEffect, CurrentScale);
...
function DrawScoreEffect(Canvas C, SpriteWidget W, float fWidth, float fHeight, CalCoordsW calW)
{
...
function DrawGameNotice(Canvas C)
{
    ...
    HudPart_DisplayEvent.DrawGameNotice(C, aGameNotice[0].sNotice);
    // End:0xD1
    ...
    // End:0xF8
    if(aGameNotice[0].fEndTime < Level.TimeSeconds)
    {
...
defaultproperties
{
    ...
    DetectedBomb=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_indig_grenade',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=128),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    outArrow=TexRotator'Warfare_HUD.HUD.outArrow_rot'
    OutArrowSize=128.0000000
    ...
    HpBarBackground=(WidgetTexture=Texture'Warfare_UI_HUD.Common.gau_hp_back',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=16,Y2=16),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    HpBar=(WidgetTexture=Texture'Warfare_UI_HUD.Common.gau_hp',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=167,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    DamageBar=(WidgetTexture=Texture'Warfare_UI_HUD.Common.gau_hp_mn',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=167,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    RecoveryBar=(WidgetTexture=Texture'Warfare_UI_HUD.Common.gau_hp_pl',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=167,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    StaminaBarBackground=(WidgetTexture=Texture'Warfare_UI_HUD.Common.gau_sp_back',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=238,Y2=9),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=15,OffsetY=1179,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    StaminaBar=(WidgetTexture=Texture'Warfare_UI_HUD.Common.gau_sp',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=238,Y2=9),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=15,OffsetY=1179,ScaleMode=4,Scale=1.0000000,Tints=(R=112,G=157,B=211,A=255),Tints[1]=(R=112,G=157,B=255,A=211))
    HPIcon=(WidgetTexture=Texture'Warfare_UI_HUD.Common.hp_icon',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=22,Y2=22),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=57,OffsetY=1148,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    HpGauBlink=(WidgetTexture=Texture'Warfare_UI_HUD.Common.gau_hpblink',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=167,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    fHPDelayTime=0.5000000
    fHPDisplayRatio=1.0000000
    PostureStand=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_status',RenderStyle=5,TextureCoords=(X1=84,Y1=0,X2=126,Y2=42),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=15,OffsetY=1135,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    PostureCrouch=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_status',RenderStyle=5,TextureCoords=(X1=42,Y1=0,X2=84,Y2=42),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=15,OffsetY=1135,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    PostureDown=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_status',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=42,Y2=42),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=15,OffsetY=1135,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    PostureRun=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_status1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=42,Y2=42),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=15,OffsetY=1135,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    AmmoSet50=(DigitTexture=Texture'Warfare_UI_HUD.Common.ammo_50_set',TextureCoords=(X1=0,Y1=0,X2=0,Y2=0),TextureCoords[1]=(X1=7,Y1=0,X2=12,Y2=25),TextureCoords[2]=(X1=0,Y1=0,X2=5,Y2=25),TextureCoords[3]=(X1=14,Y1=0,X2=19,Y2=25),X2=1594,Y2=1152,XL=5,YL=25,ExtraOffsetX=0)
    AmmoSetSniper=(DigitTexture=Texture'Warfare_UI_HUD.Common.ammo_sr_set',TextureCoords=(X1=0,Y1=0,X2=0,Y2=0),TextureCoords[1]=(X1=11,Y1=0,X2=20,Y2=31),TextureCoords[2]=(X1=0,Y1=0,X2=9,Y2=31),TextureCoords[3]=(X1=22,Y1=0,X2=31,Y2=31),X2=1585,Y2=1155,XL=9,YL=31,ExtraOffsetX=4)
    AmmoSetShotgun=(DigitTexture=Texture'Warfare_UI_HUD.Common.ammo_shotgun_set',TextureCoords=(X1=0,Y1=0,X2=0,Y2=0),TextureCoords[1]=(X1=14,Y1=0,X2=26,Y2=26),TextureCoords[2]=(X1=0,Y1=0,X2=12,Y2=26),TextureCoords[3]=(X1=28,Y1=0,X2=40,Y2=26),X2=1585,Y2=1153,XL=12,YL=26,ExtraOffsetX=2)
    AmmoSetRPG=(DigitTexture=Texture'Warfare_UI_HUD.Common.ammo_rpg7_set',TextureCoords=(X1=0,Y1=0,X2=0,Y2=0),TextureCoords[1]=(X1=169,Y1=0,X2=336,Y2=20),TextureCoords[2]=(X1=0,Y1=0,X2=167,Y2=20),TextureCoords[3]=(X1=338,Y1=0,X2=505,Y2=20),X2=1585,Y2=1149,XL=167,YL=20,ExtraOffsetX=4)
    AmmoSetATR=(DigitTexture=Texture'Warfare_UI_HUD.Common.ammo_atr_set',TextureCoords=(X1=0,Y1=0,X2=0,Y2=0),TextureCoords[1]=(X1=91,Y1=0,X2=180,Y2=18),TextureCoords[2]=(X1=0,Y1=0,X2=89,Y2=18),TextureCoords[3]=(X1=182,Y1=0,X2=271,Y2=18),X2=1584,Y2=1148,XL=89,YL=18,ExtraOffsetX=2)
    ...
    AmmoFlameThrowerCan=(WidgetTexture=Texture'Warfare_UI_HUD.Common.frame_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=224,Y2=41),TextureScale=0.3950000,DrawPivot=4,PosX=0.9906250,PosY=0.9630000,OffsetX=0,OffsetY=0,ScaleMode=0,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    AmmoFlameThrowerBar=(WidgetTexture=Texture'Warfare_UI_HUD.Common.frame_fuel',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=201,Y2=27),TextureScale=0.3950000,DrawPivot=4,PosX=0.9887500,PosY=0.9608300,OffsetX=0,OffsetY=0,ScaleMode=0,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    GaugeOverHeat=(WidgetTexture=Texture'Warfare_UI_HUD.Common.gau_mg',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=32,Y2=5),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=1400,OffsetY=1127,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    AmmoFragGrenadeIcon=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_Frag_A',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=0.6500000,DrawPivot=3,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    AmmoFragGrenadeControl=(WidgetTexture=Texture'Warfare_UI.HUD.ui_num_g',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=20,Y2=13),TextureScale=0.6500000,DrawPivot=3,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    AmmoStunGrenadeIcon=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_Stun_A',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=0.6500000,DrawPivot=3,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    AmmoStunGrenadeControl=(WidgetTexture=Texture'Warfare_UI.HUD.ui_num_3',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=18,Y2=13),TextureScale=0.6500000,DrawPivot=3,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    AmmoSmokeGrenadeIcon=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_Smoke_A',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=0.6500000,DrawPivot=3,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    AmmoGrenadeBG=(WidgetTexture=Texture'Warfare_HUD.HUD.hud_weapon_bg2',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=255,Y2=63),TextureScale=0.6500000,DrawPivot=3,PosX=0.9511719,PosY=0.8893960,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    AmmoGrenadeAvailableColor=(R=255,G=255,B=255,A=255)
    AmmoGrenadeUnavailableColor=(R=128,G=128,B=128,A=128)
    AmmoGrenadeIconBeginX=0.7981250
    AmmoGrenadeIconBeginY=0.9425000
    AmmoGrenadeIconWidth=0.0400000
    AmmoGrenadeIconHeight=0.0533000
    AmmoGrenadeControlBeginX=0.9638670
    AmmoGrenadeControlBeginY=0.9244790
    AmmoGrenadeControlWidth=0.0185550
    AmmoGrenadeControlHeight=0.0169270
    AmmoGrenadeCountBeginX=0.8262500
    AmmoGrenadeCountBeginY=0.9733300
    AmmoGrenadeCountWidth=0.0087500
    AmmoGrenadeCountHeight=0.0175000
    AmmoGrenadeCountFontSize=0.0130000
    AmmoGrenadeOffsetX=0.0400000
    TeamDeathSprite=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.DisplayIcon.our_sol_death',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.6500000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    KillMessageHelicopterName="????"
    SelfKillMessage_Killed=" ?? ?????"
    SelfKillMessage_KilledBy=" ??? ?????"
    SelfKillColor=(R=254,G=1,B=3,A=255)
    SelfKilledByColor=(R=255,G=255,B=255,A=255)
    Crosshair_Left=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.Crosshairs.bagic_left',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=15,Y2=3),TextureScale=0.6500000,DrawPivot=3,PosX=0.5040000,PosY=0.5000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    Crosshair_Right=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.Crosshairs.bagic_right',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=15,Y2=3),TextureScale=0.6500000,DrawPivot=7,PosX=0.4960000,PosY=0.5000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    Crosshair_Up=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.Crosshairs.bagic_up',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=3,Y2=15),TextureScale=0.6500000,DrawPivot=5,PosX=0.5000000,PosY=0.5050000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    Crosshair_Down=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.Crosshairs.bagic_down',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=3,Y2=15),TextureScale=0.6500000,DrawPivot=1,PosX=0.5000000,PosY=0.4950000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    Crosshair_MG=(WidgetTexture=Texture'Warfare_UI_HUD_ETC.Crosshairs.ch_mg',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.6500000,DrawPivot=8,PosX=0.5000000,PosY=0.5000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    Crosshair_DamageDealt=(WidgetTexture=TexOscillator'Warfare_UI_HUD_ETC.Crosshairs.cross_hair_osc',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.6500000,DrawPivot=8,PosX=0.5000000,PosY=0.5000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    CrossHair_DamageDealtDrawTime=0.3500000
    C4Bomb=(WidgetTexture=FinalBlend'Warfare_UI.HUD_SearchAndDestroy.c4_bomb_fb',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=63),TextureScale=0.5300000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    SkillC4=(WidgetTexture=Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_time_c4_0',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.4325000,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SkillRPG=(WidgetTexture=Texture'Warfare_UI_Item.SupplySkillicon.icon_wea_AT4',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.4325000,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SkillM2B=(WidgetTexture=Texture'Warfare_UI_Item.SupplySkillicon.icon_wea_M2B',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.4325000,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SkillRPG7=(WidgetTexture=Texture'Warfare_UI_Item.SupplySkillicon.icon_wea_RPG7_0',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.4325000,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SkillRPG7On=(WidgetTexture=Texture'Warfare_UI_Item.SupplySkillicon.icon_wea_RPG7_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.4325000,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SkillHelicopter=(WidgetTexture=Texture'Warfare_UI_Item.SupplySkillicon.icon_sup_heli_0',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.4800000,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SkillAirstrike=(WidgetTexture=Texture'Warfare_UI_Item.SupplySkillicon.icon_sup_bomb_0',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.5275000,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SkillC4On=(WidgetTexture=Texture'Warfare_UI_Item.SupplySkillicon.icon_skil_time_c4',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.4325000,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    SkillUAV=(WidgetTexture=Texture'Warfare_UI_Item.SupplySkillicon.icon_sup_uav_0',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.5231250,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SkillUAVOn=(WidgetTexture=Texture'Warfare_UI_Item.SupplySkillicon.icon_sup_uav_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.5231250,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SkillBlink=(WidgetTexture=Texture'Warfare_UI_Item.SupplySkillicon.icon_tech_blink',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.4325000,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SkillSlot5=(WidgetTexture=none,RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.4325000,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SkillSlot6=(WidgetTexture=none,RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=64,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.5231250,PosY=0.9425000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    fBlinkDelayTime=0.2500000
    VisibleDistance=20.0000000
    PlaceMark=(WidgetTexture=TexOscillator'Warfare_UI_HUD.Common.img_spwp_posi_osc',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=54,Y2=32),TextureScale=0.3700000,DrawPivot=5,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=10,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    lsPlaceM2B="?????"
    lsPlaceMG3="???"
    lsPlaceRPG7="???"
    lsPlaceATR="???"
    ...
    SuppliesPositions_Class[0]=Class'WGame.wHealthPack'
    SuppliesPositions_Class[1]=Class'WGame.wHeliPack'
    SuppliesPositions_Class[2]=Class'WGame.wArtilleryPack'
    SuppliesPositions_Class[3]=Class'WGame.wUAVPack'
    SuppliesPositions_OffsetZ[0]=25
    SuppliesPositions_OffsetZ[1]=65
    SuppliesPositions_OffsetZ[2]=65
    SuppliesPositions_OffsetZ[3]=65
    ...
    MessageChangingHost="?????: "
    MessageChangingHostPre="??? ??"
    MessageChangingHostPost="?? ??? ?????"
    ShowTime_NameTag_EnemyWhoKillMe=4.0000000
    WKill=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=548,Y1=216,X2=822,Y2=288),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAssist=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=274,Y2=72),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHelikill=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=0,Y1=72,X2=274,Y2=144),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WArtillerykill=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=274,Y1=72,X2=548,Y2=144),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WCapture=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=274,Y1=0,X2=548,Y2=72),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WBombSetted=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=0,Y1=288,X2=274,Y2=360),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WBombDiffused=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=548,Y1=0,X2=822,Y2=72),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    W3Kill=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=0,Y1=144,X2=274,Y2=216),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    W5Kill=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=274,Y1=144,X2=548,Y2=216),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    W7Kill=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=548,Y1=144,X2=822,Y2=216),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    W10Kill=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=0,Y1=216,X2=274,Y2=288),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    W15Kill=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=274,Y1=216,X2=548,Y2=288),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHeadshot=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_text',RenderStyle=5,TextureCoords=(X1=548,Y1=72,X2=822,Y2=144),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=663,OffsetY=319,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillBlood=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_blood01',RenderStyle=5,TextureCoords=(X1=67,Y1=111,X2=453,Y2=421),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=606,OffsetY=186,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKillBlood_Teen=(WidgetTexture=Texture'Warfare_UI_HUD.Common.img_HUD_kill_blood01_T',RenderStyle=5,TextureCoords=(X1=67,Y1=111,X2=453,Y2=421),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=606,OffsetY=186,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
