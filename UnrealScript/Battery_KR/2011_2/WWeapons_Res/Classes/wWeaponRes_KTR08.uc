...
defaultproperties
{
    ...
    szIcon_HUD="Warfare_UI_Item.HUDIcon.Item_HUD_WP_AR_KTR08"
    szIcon_Kill="Warfare_UI_Item.Item_killIcon"
    ibIcon_Kill=(X=256,Y=546,W=128,H=32)
    szType_DisplayAmmo="ammo50"
    sound_Fire=Sound'Warfare_Sound_Weapon.KTR08.weapon_KTR08_fire'
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.KTR08.weapon_KTR08_fire'
    sound_Fire_Silencer=Sound'Warfare_Sound_Weapon.KTR08.weapon_KTR08_fire_silencer'
    sound_Fire_Silencer_Stereo=Sound'Warfare_Sound_Weapon.KTR08.weapon_KTR08_fire_silencer'
