...
{
    return Owner.rfAckLogin2(Result, ErrMsg, UserID, CharName, CurServerTime);
    //return;    
}
...
{
    return Owner.rfAckNotifyExpiredSkillIDs(UserID, ExpiredSkillUniqueIDs, ExpiredSkillIDs, Result, ErrMsg);
    //return;    
}
...
{
    return Owner.rfAckBuyShopItem(Result, ErrMsg, BoughtItemID, BoughtPartID, BoughtUntilTIme, BoughtStackCnt, PointRemain, CashRemain, BoughtItemIdx);
    //return;    
}
...
{
    return Owner.rfAckInviteGameRoom(Result);
    //return;    
}
...
{
    return Owner.rfReqAnswerInviteGameRoom(Answer, GuestCharName);
    //return;    
}
...
{
    return Owner.rfAckWebzenCash(Result, ErrMsg, Cash);
    //return;    
}
...
{
    return Owner.rfAckPCBangUserList(FriendName, Clanname, CM_Pattern, CM_BG, CM_BL, fServername, fServerShortName, fServerIP, fServerPort, CurPos, ChannelNum, ChannelNickName, GameRoomNum, Level, ClanGrade, ClanWin, ClanLose, IsLookForClan, IsCombat, ClanLevel, LevelMarkID, TitleMarkID, Reserved1, Reserved2, Reserved3);
    //return;    
}
...
{
    return Owner.rfAckRandomBox_Use(Result, ErrMsg, RandomBoxItemIdx, RandomBxoItemCount, ItemIDChoose, PartIDChoose, bHave, ItemIdx, UntilTime, StackCount);
    //return;    
}
...
{
    return Owner.rfAckPaidItem_NotifyChangeClanMark(Pattern, BG, BL);
    //return;    
}
