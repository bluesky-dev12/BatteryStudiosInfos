...
function SetupTutorialRoomInfo(string MapName)
{
    ...
    TutorialRoomInfo.MaxRSAUserAndBotNum = 8;
...
function OnPageRoomLobbyInited()
{
    ...
    if(bTutorial)
    {
        ...
        else
        {
            ...
            if(MM.kExp == 0)
            {
                MainMenu.EnterBotMode = true;
            }
            rfAckLeaveRoom(TutorialRoomInfo.RoomNumber, MM.kUID, MM.kUserName, 0, "");
            RealOne.sfReqChangeUserState(0, 0);
            RealOne.sfReqNotifyEndTutorial();
            bTutorial = false;
        }
    }
    //return;    
...
function bool sfReqLogin2(string CharName, int TimeStamp, int LoginHash1, int LoginHash2, int LoginHash3, int LoginHash4, int LoginHash5, string Guid)
{
    return RealOne.sfReqLogin2(CharName, TimeStamp, LoginHash1, LoginHash2, LoginHash3, LoginHash4, LoginHash5, Guid);
    //return;    
}
...
function bool sfReqEnterRoom(int GameNum, string Password)
{
    // End:0x5D
    if(bTutorial)
    {
    ...
    {
        return RealOne.sfReqEnterRoom(GameNum, Password);
    }
    //return;    
}
...
function bool sfReqBuyShopItem(int ItemID, byte BuyOption1, byte BuyOption2)
{
    return RealOne.sfReqBuyShopItem(ItemID, BuyOption1, BuyOption2);
    //return;    
}
...
function bool sfReqRecvClanInvite(string InviterCharname, string Clanname, string InviteMsg)
{
    return RealOne.sfReqRecvClanInvite(InviterCharname, Clanname, InviteMsg);
    //return;    
}
...
function bool sfReqRecvJoinClan(string CharName, string Message)
{
    return RealOne.sfReqRecvJoinClan(CharName, Message);
    //return;    
}
...
function bool sfReqLogGetScore(KillDeathLog KillDeathLogParam, array<int> AssistUIDs)
{
    // End:0x0C
    if(bTutorial)
    {        
    ...
    {
        return RealOne.sfReqLogGetScore(KillDeathLogParam, AssistUIDs);
    }
    //return;    
}
...
function bool sfReqAnswerInviteGameRoom(byte Answer, string GuestCharName)
{
    return RealOne.sfReqAnswerInviteGameRoom(Answer, GuestCharName);
    //return;    
}

function bool sfReqSendInviteGameRoomMoveResult(int RoomNumber, string RoomUniqueID, string InviteCharName, byte MoveResult)
{
    return RealOne.sfReqSendInviteGameRoomMoveResult(RoomNumber, RoomUniqueID, InviteCharName, MoveResult);
    //return;    
}

function bool sfReqRecvInviteGameRoomMoveResult(string GuestCharName, byte MoveResult)
{
    return RealOne.sfReqRecvInviteGameRoomMoveResult(GuestCharName, MoveResult);
    //return;    
}
...
function bool sfReqBuyItemByWebzenCash(int PackageProductSeq, int ProductDisplaySeq, int PriceSeq, array<int> ItemIDs)
{
    return RealOne.sfReqBuyItemByWebzenCash(PackageProductSeq, ProductDisplaySeq, PriceSeq, ItemIDs);
    //return;    
}
...
function bool sfAckRecvClanInvite(string InviterCharname, string InviterMsg, string Clanname, byte Permit)
{
    return RealOne.sfAckRecvClanInvite(InviterCharname, InviterMsg, Clanname, Permit);
    //return;    
}

function bool sfAckRecvJoinClan(string CharName, string ReqMsg, byte Permit)
{
    return RealOne.sfAckRecvJoinClan(CharName, ReqMsg, Permit);
    //return;    
}
...
{
    local int iItemID, iLength, iTemp;
    local BT_WeaponInfo lWeaponInfo;
    local wWeaponBaseParams wInfo;
    local bool bSame;
...
{
    Log((((((("[BTTcpHandler::rfAckLogin2] Result=" $ string(Result)) $ " ErrMsg=") $ ErrMsg) $ " UserID=") $ string(UserID)) $ " Charname=") $ CharName);
    i = MainMenu.Pages.Length;
    J0x82:

    // End:0xD9 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckLogin2(Result, ErrMsg, UserID, CharName, CurServerTime))
    {
        // [Loop Continue]
        goto J0x82;
    }
...
{
    Log(((((((((("[BTTcpHandler::rfAckBuyShopItem]" $ " Result=") $ string(Result)) $ " ErrMsg=") $ ErrMsg) $ " BoughtItemID=") $ string(BoughtItemID)) $ " PointRemain=") $ string(PointRemain)) $ " CashRemain=") $ string(CashRemain));
    i = MainMenu.Pages.Length;
    J0xAF:

    // End:0x11A [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckBuyShopItem(Result, ErrMsg, BoughtItemID, BoughtPartID, BoughtUntilTIme, BoughtStackCnt, PointRemain, CashRemain, BoughtItemIdx))
    {
        // [Loop Continue]
        goto J0xAF;
    }
...
function bool rfAckFriendList(array<string> FriendName, array<string> Clanname, array<int> CM_Pattern, array<int> CM_BG, array<int> CM_BL, array<string> fServername, array<string> fServerShortName, array<string> fServerIP, array<int> fServerPort, array<byte> CurPos, array<int> ChannelNum, array<string> ChannelNickName, array<int> GameRoomNum, array<int> Level, array<int> ClanGrade, array<int> ClanWin, array<int> ClanLose, array<byte> IsLookForClan, array<int> ClanLevel, array<int> LevelMarkID, array<int> TitleMarkID, array<int> Reserved1, array<int> Reserved2, array<int> Reserved3)
{
    ...
    // End:0xEE [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckFriendList(FriendName, Clanname, CM_Pattern, CM_BG, CM_BL, fServername, fServerShortName, fServerIP, fServerPort, CurPos, ChannelNum, ChannelNickName, GameRoomNum, Level, ClanGrade, ClanWin, ClanLose, IsLookForClan, ClanLevel, LevelMarkID, TitleMarkID, Reserved1, Reserved2, Reserved3))
    {
        // [Loop Continue]
        goto J0x38;
    }
...
function bool rfAckGetAttachedItemFromMemo(int Result, string ErrMsg, BtrDouble ItemIdx)
{
    ...
    // End:0x92 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckGetAttachedItemFromMemo(Result, ErrMsg, ItemIdx))
    {
        // [Loop Continue]
        goto J0x45;
    }
...
function bool rfAckNotifyExpiredSkillIDs(int UserID, array<int> ExpiredSkillUniqueIDs, array<int> ExpiredSkillIDs, int Result, string ErrMsg)
{
    ...
    // End:0x9A [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckNotifyExpiredSkillIDs(UserID, ExpiredSkillUniqueIDs, ExpiredSkillIDs, Result, ErrMsg))
    {
        // [Loop Continue]
        goto J0x43;
    }
...
function bool rfAckClanUserList(int Result, string ErrMsg, array<int> Level, array<string> CharName, array<byte> ClanGrade, array<string> ServerName, array<string> ServerShortName, array<string> serverIP, array<int> serverPort, array<byte> CurPos, array<int> ChannelNum, array<string> ChannelNickName, array<int> GameRoomNum, array<byte> IsCombat, array<int> ClanWinCnt, array<int> ClanLoseCnt, array<string> ClanSelfIntro, array<int> LevelMarkID, array<int> TitleMarkID, array<int> Reserved1, array<int> Reserved2, array<int> Reserved3)
{
    ...
    // End:0xE6 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckClanUserList(Result, ErrMsg, Level, CharName, ClanGrade, ServerName, ServerShortName, serverIP, serverPort, CurPos, ChannelNum, ChannelNickName, GameRoomNum, IsCombat, ClanWinCnt, ClanLoseCnt, ClanSelfIntro, LevelMarkID, TitleMarkID, Reserved1, Reserved2, Reserved3))
    {
        // [Loop Continue]
        goto J0x3A;
    }
...
function bool rfReqRecvClanInvite(string InviterCharname, string Clanname, string InviteMsg)
{
    ...
    // End:0xA1 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfReqRecvClanInvite(InviterCharname, Clanname, InviteMsg))
    {
        // [Loop Continue]
        goto J0x54;
    }
...
function bool rfReqRecvJoinClan(string CharName, string Message)
{
    ...
    // End:0x93 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfReqRecvJoinClan(CharName, Message))
    {
        // [Loop Continue]
        goto J0x4B;
    }
...
function bool rfAckInviteGameRoom(int Result)
{
    ...
    // End:0x90 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckInviteGameRoom(Result))
    {
        // [Loop Continue]
        goto J0x4D;
    }
...
{
    Log(((("[BTTcpHandler::rfReqAnswerInviteGameRoom]" $ "Answer=") $ string(Answer)) $ " GuestCharName=") $ GuestCharName);
    i = MainMenu.Pages.Length;
    J0x70:

    // End:0xB8 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfReqAnswerInviteGameRoom(Answer, GuestCharName))
    {
        // [Loop Continue]
        goto J0x70;
    }
...
function bool rfAckWebzenCash(int Result, string ErrMsg, BtrDouble Cash)
{
    ...
    // End:0x85 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckWebzenCash(Result, ErrMsg, Cash))
    {
        // [Loop Continue]
        goto J0x38;
    }
...
function bool rfAckPCBangUserList(array<string> FriendName, array<string> Clanname, array<int> CM_Pattern, array<int> CM_BG, array<int> CM_BL, array<string> fServername, array<string> fServerShortName, array<string> fServerIP, array<int> fServerPort, array<byte> CurPos, array<int> ChannelNum, array<string> ChannelNickName, array<int> GameRoomNum, array<int> Level, array<int> ClanGrade, array<int> ClanWin, array<int> ClanLose, array<byte> IsLookForClan, array<byte> IsCombat, array<int> ClanLevel, array<int> LevelMarkID, array<int> TitleMarkID, array<int> Reserved1, array<int> Reserved2, array<int> Reserved3)
{
    ...
    // End:0xF7 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckPCBangUserList(FriendName, Clanname, CM_Pattern, CM_BG, CM_BL, fServername, fServerShortName, fServerIP, fServerPort, CurPos, ChannelNum, ChannelNickName, GameRoomNum, Level, ClanGrade, ClanWin, ClanLose, IsLookForClan, IsCombat, ClanLevel, LevelMarkID, TitleMarkID, Reserved1, Reserved2, Reserved3))
    {
        // [Loop Continue]
        goto J0x3C;
    }
...
function bool rfAckRandomBox_Use(int Result, string ErrMsg, BtrDouble RandomBoxItemIdx, int RandomBxoItemCount, array<int> ItemIDChoose, array<int> PartIDChoose, array<byte> bHave, array<BtrDouble> ItemIdx, array<BtrDouble> UntilTime, array<int> StackCount)
{
    ...
    // End:0xAB [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckRandomBox_Use(Result, ErrMsg, RandomBoxItemIdx, RandomBxoItemCount, ItemIDChoose, PartIDChoose, bHave, ItemIdx, UntilTime, StackCount))
    {
        // [Loop Continue]
        goto J0x3B;
    }
...
function bool rfAckPaidItem_NotifyChangeClanMark(int Pattern, int BG, int BL)
{
    ...
    // End:0x98 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckPaidItem_NotifyChangeClanMark(Pattern, BG, BL))
    {
        // [Loop Continue]
        goto J0x4B;
    }
