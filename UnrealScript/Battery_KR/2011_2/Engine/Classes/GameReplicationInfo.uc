...
simulated function PostNetBeginPlay()
{
    ...
    {
        // End:0x2F
        foreach DynamicActors(Class'Engine_Decompressed.VoiceChatReplicationInfo', VoiceReplicationInfo)
        {
            // End:0x2F
            break;            
        }        
...
simulated function PlayTimerSound()
{
    ...
    if(!bStopCountDown)
    {
        ...
        {
            Level.GetLocalPlayerController().ClientPlaySound(Sound(DynamicLoadObject("Warfare_Sound_ATS.com.ats_com_bomb_countdown", Class'Engine_Decompressed.Sound')));            
        }
        else
        {
            // End:0xD2
            ...
            {
                Level.GetLocalPlayerController().ClientPlaySound(Sound(DynamicLoadObject("Warfare_Sound_ATS.com.ats_com_time_countdown", Class'Engine_Decompressed.Sound')));
            }
        }
    }
    //return;    
...
defaultproperties
{
    ...
    GRIPropsDisplayText[0]="????"
    GRIPropsDisplayText[1]="?? ??? ??"
    GRIPropsDisplayText[2]="?? ??? E-Mail"
