...
static function string GetString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2, optional Object OptionalObject)
{
    switch(Switch)
    {
        ...
        // End:0x431
        case default.Code_3Kill:
            return ((RelatedPRI_1.PlayerName $ default.strMultiKills1) $ " 3") $ default.strMultiKills2;
        // End:0x45C
        case default.Code_5Kill:
            return ((RelatedPRI_1.PlayerName $ default.strMultiKills1) $ " 5") $ default.strMultiKills2;
        // End:0x487
        case default.Code_7Kill:
            return ((RelatedPRI_1.PlayerName $ default.strMultiKills1) $ " 7") $ default.strMultiKills2;
        // End:0x4B3
        case default.Code_10Kill:
            return ((RelatedPRI_1.PlayerName $ default.strMultiKills1) $ " 10") $ default.strMultiKills2;
        // End:0x4DF
        case default.Code_15Kill:
            return ((RelatedPRI_1.PlayerName $ default.strMultiKills1) $ " 15") $ default.strMultiKills2;
        // End:0x4ED
...
static simulated function ClientReceive(PlayerController P, optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2, optional Object OptionalObject)
{
    ...
    {
        P.ViewTarget.PlayOwnedSound(P.StatusAnnouncer.GetSound(Class'Engine_Decompressed.wGameManager'.default.VoicePackageName $ default.SoundAllyKillEnemy), 0, 1.0000000);
        return;
    }
    // End:0x11C
    if(((default.Code_AllyDie == Switch) && P != none) && P.PlayerReplicationInfo == RelatedPRI_2)
    {
        P.ViewTarget.PlayOwnedSound(P.StatusAnnouncer.GetSound(Class'Engine_Decompressed.wGameManager'.default.VoicePackageName $ default.SoundAllyDie), 0, 1.0000000);
        return;
    }
    ...
    switch(Switch)
    {
        ...
        case default.Code_Win:
            ...
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundWin, Class'Engine_Decompressed.Sound')));
            // End:0x846
            break;
        // End:0x271
        case default.Code_Lose:
            P.QueueAnnouncement(default.AnnounceLose, 1);
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundLose, Class'Engine_Decompressed.Sound')));
            // End:0x846
            break;
        // End:0x2A8
        ...
        // End:0x2D7
        case default.Code_SDAllyBombPlanted:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundOurTeamPlantedBomb, Class'Engine_Decompressed.Sound')));
            // End:0x846
            break;
        // End:0x306
        case default.Code_SDEnemyBombPlanted:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundEnemyPlantedBomb, Class'Engine_Decompressed.Sound')));
            // End:0x846
            break;
        // End:0x34B
        case default.Code_SDAllyGotTheBomb:
            P.QueueAnnouncement(default.AnnounceSDAllyGotTheBomb, 1);
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundSDAllyGotTheBomb, Class'Engine_Decompressed.Sound')));
            // End:0x846
            break;
        // End:0x390
        case default.Code_SDIGotTheBomb:
            P.QueueAnnouncement(default.AnnounceSDIGotTheBomb, 1);
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundSDIGotTheBomb, Class'Engine_Decompressed.Sound')));
            // End:0x846
            break;
        // End:0x3B1
        case default.Code_SDAllyLostTheBomb:
        ...
        case default.Code_SBTAllyGotTheBomb:
            ...
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundSBTAllyGotTheBomb, Class'Engine_Decompressed.Sound')));
            // End:0x846
            break;
        // End:0x47D
        case default.Code_SBTEnemyGotTheBomb:
            P.QueueAnnouncement(default.AnnounceSBTEnemyGotTheBomb, 1);
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundSBTEnemyGotTheBomb, Class'Engine_Decompressed.Sound')));
            // End:0x846
            break;
        // End:0x4C2
        case default.Code_SBTIGotTheBomb:
            P.QueueAnnouncement(default.AnnounceSBTIGotTheBomb, 1);
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundSBTIGotTheBomb, Class'Engine_Decompressed.Sound')));
            // End:0x846
            break;
        // End:0x507
        case default.Code_SBTAllyBombDefused:
            P.QueueAnnouncement(default.AnnounceSBTAllyBombDefused, 1);
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundSBTAllyBombDefused, Class'Engine_Decompressed.Sound')));
            // End:0x846
            break;
        // End:0x54C
        case default.Code_SBTEnemyBombDefused:
            P.QueueAnnouncement(default.AnnounceSBTEnemyBombDefused, 1);
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundSBTEnemyBombDefused, Class'Engine_Decompressed.Sound')));
            // End:0x846
            break;
        // End:0x56D
        case default.Code_SBTAllyLostTheBomb:
    ...
    switch(Switch)
    {
        ...
        // End:0x88C
        case default.Code_DOMAllyCapturedC:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundDOMAllyCaptured, Class'Engine_Decompressed.Sound')));
            // End:0x8CE
            break;
        // End:0x894
        case default.Code_DOMEnemyCapturedA:
        ...
        // End:0x8CB
        case default.Code_DOMEnemyCapturedC:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.SoundDOMEnemyCaptured, Class'Engine_Decompressed.Sound')));
            // End:0x8CE
            break;
        // End:0xFFFF
        default:
    ...
    switch(Switch)
    {
        ...
        case default.Code_AllyDie:
            ...
            if(lp1 < P.Level.PawnList.Length)
            {
                ...
                {
                    tempP.PlayOwnedSound(P.StatusAnnouncer.GetSound(Class'Engine_Decompressed.wGameManager'.default.VoicePackageName $ default.SoundAllyDie), 0, 1.0000000);
                    // [Explicit Break]
                    goto J0x9B6;
                }
                lp1++;
        ...
        case default.Code_AllyKillEnemy:
            ...
            if(lp1 < P.Level.PawnList.Length)
            {
                ...
                {
                    tempP.PlayOwnedSound(P.StatusAnnouncer.GetSound(Class'Engine_Decompressed.wGameManager'.default.VoicePackageName $ default.SoundAllyKillEnemy), 0, 1.0000000);
                    // [Explicit Break]
                    goto J0xA9A;
                }
                lp1++;
        ...
        // End:0xBF9
        case default.Code_RMC[0]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMC[0], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xC2C
        case default.Code_RMC[1]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMC[1], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xC61
        case default.Code_RMC[2]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMC[2], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xC96
        case default.Code_RMC[3]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMC[3], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xCCB
        case default.Code_RMC[4]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMC[4], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xD00
        case default.Code_RMC[5]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMC[5], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xD35
        case default.Code_RMC[6]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMC[6], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xD6A
        case default.Code_RMC[7]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMC[7], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xD9F
        case default.Code_RMC[8]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMC[8], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xDD2
        case default.Code_RMS[0]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMS[0], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xE05
        case default.Code_RMS[1]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMS[1], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xE3A
        case default.Code_RMS[2]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMS[2], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xE6F
        case default.Code_RMS[3]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMS[3], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xEA4
        case default.Code_RMS[4]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMS[4], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xED9
        case default.Code_RMS[5]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMS[5], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xF0E
        case default.Code_RMS[6]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMS[6], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xF41
        case default.Code_RMR[0]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMR[0], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xF74
        case default.Code_RMR[1]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMR[1], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xFA9
        case default.Code_RMR[2]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMR[2], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xFDE
        case default.Code_RMR[3]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMR[3], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0x1013
        case default.Code_RMR[4]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMR[4], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0x1048
        case default.Code_RMR[5]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMR[5], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0x107D
        case default.Code_RMR[6]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMR[6], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0x10B2
        case default.Code_RMR[7]:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AnnounceRMR[7], Class'Engine_Decompressed.Sound')));
            // End:0x10B8
            break;
        // End:0xFFFF
        default:
