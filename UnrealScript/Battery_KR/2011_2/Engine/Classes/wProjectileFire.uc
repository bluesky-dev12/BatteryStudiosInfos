...
function wProjectile SpawnProjectile(Vector Start, Rotator Dir)
{
    ...
    if(ProjectileClass != none)
    {
        ...
        {
            WeaponAttachment(Weapon.ThirdPersonActor).UpdateHit(none, vect(0.0000000, 0.0000000, 0.0000000), vect(0.0000000, 0.0000000, 0.0000000), none);
        }
    }
...
defaultproperties
{
    ...
    bLeadTarget=true
    bInstantHit=false
    ProjectileClass=Class'Engine_Decompressed.wProjectile'
