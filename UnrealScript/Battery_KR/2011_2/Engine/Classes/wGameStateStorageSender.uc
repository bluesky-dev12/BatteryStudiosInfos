...
{
    local string strUserID, strSection, strName, strType, strValue, strVehicleClassName,
	    strState, strPawn, strTemp, strIsPawnValue;
...
simulated function SetScoreState_OnlyClient()
{
    ...
    foreach DynamicActors(Class'Engine_Decompressed.PlayerReplicationInfo', PRI)
    {
        ...
        LowSet(string(UID), "Char", "Score", "Exp", string(PRI.Exp));
