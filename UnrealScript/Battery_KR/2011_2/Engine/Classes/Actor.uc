...
enum eWeaponType
{
    ...
    WType_Melee,                    // 12
    WType_Helicopter,               // 13
    WType_Telegraph_Heli,           // 14
    WType_Telegraph_UAV,            // 15
    WType_Knife                     // 16
};
...
event TakeDamage(int Damage, Pawn EventInstigator, Vector HitLocation, Vector Momentum, Class<DamageType> DamageType, optional int CollisionPart, optional int WeaponType)
{
    //return;    
}
...
simulated function HurtRadius(float DamageAmount, float DamageRadius, Class<DamageType> DamageType, float Momentum, Vector HitLocation)
{
    ...
    bHurtEntry = true;
    // End:0x1C6
    foreach VisibleCollidingActors(Class'Engine_Decompressed.Actor', Victims, DamageRadius, HitLocation)
    {
        // End:0x1C5
...
simulated event TriggerEvent(name EventName, Actor Other, Pawn EventInstigator)
{
    ...
    // End:0x40
    foreach DynamicActors(Class'Engine_Decompressed.Actor', A, EventName)
    {
...
function bool IsInVolume(Volume aVolume)
{
    ...
    // End:0x23
    foreach TouchingActors(Class'Engine_Decompressed.Volume', V)
    {
        // End:0x22
        if(V == aVolume)
        {            
...
event ctlog(coerce string Msg)
{
    ...
    {
        Level.GetLocalPlayerController().myHUD.AddTextMessage(Msg, Class'Engine_Decompressed.GameMessage', Level.GetLocalPlayerController().PlayerReplicationInfo);
    }
    //return;    
}
...
defaultproperties
{
    ...
    LODBias=1.0000000
    Texture=Texture'Engine_Decompressed.S_Actor'
    DrawScale=1.0000000
    ...
    MessageClass=Class'Engine_Decompressed.LocalMessage'
}