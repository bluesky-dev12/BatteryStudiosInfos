...
event bool rfReqLogin2(string CharName, int TimeStamp, int LoginHash1, int LoginHash2, int LoginHash3, int LoginHash4, int LoginHash5, string Guid)
{
    return false;
    //return;    
}

event bool rfAckLogin2(int Result, string ErrMsg, int UserID, string CharName, BtrDouble CurServerTime)
{
    return false;
    //return;    
}
...
event bool rfReqEnterRoom(int GameNum, string Password)
{
    return false;
    //return;    
}
...
event bool rfAckNotifyExpiredSkillIDs(int UserID, array<int> ExpiredSkillUniqueIDs, array<int> ExpiredSkillIDs, int Result, string ErrMsg)
{
    return false;
    //return;    
}
...
event bool rfReqBuyShopItem(int ItemID, byte BuyOption1, byte BuyOption2)
{
    return false;
    //return;    
}

event bool rfAckBuyShopItem(int Result, string ErrMsg, int BoughtItemID, int BoughtPartID, BtrDouble BoughtUntilTIme, int BoughtStackCnt, int PointRemain, int CashRemain, BtrDouble BoughtItemIdx)
{
    return false;
    //return;    
}
...
event bool rfReqRecvClanInvite(string InviterCharname, string Clanname, string InviteMsg)
{
    return false;
    //return;    
}

event bool rfAckRecvClanInvite(string InviterCharname, string InviterMsg, string Clanname, byte Permit)
{
    return false;
    //return;    
}
...
event bool rfReqRecvJoinClan(string CharName, string Message)
{
    return false;
    //return;    
}

event bool rfAckRecvJoinClan(string CharName, string ReqMsg, byte Permit)
{
    return false;
    //return;    
}
...
event bool rfAckGetAttachedItemFromMemo(int Result, string ErrMsg, BtrDouble ItemIdx)
{
    return false;
    //return;    
}
...
event bool rfReqLogGetScore(KillDeathLog KillDeathLogParam, array<int> AssistUIDs)
{
    return false;
    //return;    
}
...
event bool rfAckInviteGameRoom(int Result)
{
    return false;
    //return;    
}
...
event bool rfReqAnswerInviteGameRoom(byte Answer, string GuestCharName)
{
    return false;
    //return;    
}

event bool rfReqSendInviteGameRoomMoveResult(int RoomNumber, string RoomUniqueID, string InviteCharName, byte MoveResult)
{
    return false;
    //return;    
}

event bool rfReqRecvInviteGameRoomMoveResult(string GuestCharName, byte MoveResult)
{
    return false;
    //return;    
}
...
event bool rfAckWebzenCash(int Result, string ErrMsg, BtrDouble Cash)
{
    return false;
    //return;    
}
...
event bool rfReqBuyItemByWebzenCash(int PackageProductSeq, int ProductDisplaySeq, int PriceSeq, array<int> ItemIDs)
{
    return false;
    //return;    
}
...
event bool rfAckRandomBox_Use(int Result, string ErrMsg, BtrDouble RandomBoxItemIdx, int RandomBxoItemCount, array<int> ItemIDChoose, array<int> PartIDChoose, array<byte> bHave, array<BtrDouble> ItemIdx, array<BtrDouble> UntilTime, array<int> StackCount)
{
    return false;
    //return;    
}
...
event bool rfAckPaidItem_NotifyChangeClanMark(int Pattern, int BG, int BL)
{
    return false;
    //return;    
}
...
event bool rfReqNotifyEndTutorial()
{
    return false;
    //return;    
}
...
native function bool sfReqLogin2(string CharName, int TimeStamp, int LoginHash1, int LoginHash2, int LoginHash3, int LoginHash4, int LoginHash5, string Guid)
{
    //native.CharName;
    //native.TimeStamp;
    //native.LoginHash1;
...
native function bool sfAckLogin2(int Result, string ErrMsg, int UserID, string CharName, BtrDouble CurServerTime)
{
    //native.Result;
    //native.ErrMsg;
    //native.UserID;
...
native function bool sfAckFriendList(array<string> FriendName, array<string> Clanname, array<int> CM_Pattern, array<int> CM_BG, array<int> CM_BL, array<string> fServername, array<string> fServerShortName, array<string> fServerIP, array<int> fServerPort, array<byte> CurPos, array<int> ChannelNum, array<string> ChannelNickName, array<int> GameRoomNum, array<int> Level, array<int> ClanGrade, array<int> ClanWin, array<int> ClanLose, array<byte> IsLookForClan, array<int> ClanLevel, array<int> LevelMarkID, array<int> TitleMarkID, array<int> Reserved1, array<int> Reserved2, array<int> Reserved3)
{
    //native.FriendName;
    //native.Clanname;
    //native.CM_Pattern;
...
native function bool sfReqEnterRoom(int GameNum, string Password)
{
    //native.GameNum;
    //native.Password;        
}
...
native function bool sfAckNotifyExpiredSkillIDs(int UserID, array<int> ExpiredSkillUniqueIDs, array<int> ExpiredSkillIDs, int Result, string ErrMsg)
{
    //native.UserID;
...
native function bool sfReqBuyShopItem(int ItemID, byte BuyOption1, byte BuyOption2)
{
    //native.ItemID;
    //native.BuyOption1;
    //native.BuyOption2;        
...
native function bool sfAckBuyShopItem(int Result, string ErrMsg, int BoughtItemID, int BoughtPartID, BtrDouble BoughtUntilTIme, int BoughtStackCnt, int PointRemain, int CashRemain, BtrDouble BoughtItemIdx)
{
    //native.Result;
    //native.ErrMsg;
    //native.BoughtItemID;
...
native function bool sfReqRecvClanInvite(string InviterCharname, string Clanname, string InviteMsg)
{
...
native function bool sfAckRecvClanInvite(string InviterCharname, string InviterMsg, string Clanname, byte Permit)
{
    //native.InviterCharname;
    //native.InviterMsg;
    //native.Clanname;
...
native function bool sfReqRecvJoinClan(string CharName, string Message)
{
    //native.CharName;
    //native.Message;        
}
...
native function bool sfAckRecvJoinClan(string CharName, string ReqMsg, byte Permit)
{
    //native.CharName;
    //native.ReqMsg;
    //native.Permit;        
...
native function bool sfAckClanUserList(int Result, string ErrMsg, array<int> Level, array<string> CharName, array<byte> ClanGrade, array<string> ServerName, array<string> ServerShortName, array<string> serverIP, array<int> serverPort, array<byte> CurPos, array<int> ChannelNum, array<string> ChannelNickName, array<int> GameRoomNum, array<byte> IsCombat, array<int> ClanWinCnt, array<int> ClanLoseCnt, array<string> ClanSelfIntro, array<int> LevelMarkID, array<int> TitleMarkID, array<int> Reserved1, array<int> Reserved2, array<int> Reserved3)
{
    //native.Result;
    //native.ErrMsg;
    //native.Level;
...
native function bool sfAckGetAttachedItemFromMemo(int Result, string ErrMsg, BtrDouble ItemIdx)
{
    //native.Result;
    //native.ErrMsg;
    //native.ItemIdx;        
...
native function bool sfReqLogGetScore(KillDeathLog KillDeathLogParam, array<int> AssistUIDs)
{
...
native function bool sfAckInviteGameRoom(int Result)
{
    //native.Result;        
}
...
// Export UBTTcpLink_Channel::execsfReqAnswerInviteGameRoom(FFrame&, void* const)
native function bool sfReqAnswerInviteGameRoom(byte Answer, string GuestCharName)
{
    //native.Answer;
    //native.GuestCharName;        
}

// Export UBTTcpLink_Channel::execsfReqSendInviteGameRoomMoveResult(FFrame&, void* const)
native function bool sfReqSendInviteGameRoomMoveResult(int RoomNumber, string RoomUniqueID, string InviteCharName, byte MoveResult)
{
    //native.RoomNumber;
    //native.RoomUniqueID;
    //native.InviteCharName;
...
// Export UBTTcpLink_Channel::execsfReqRecvInviteGameRoomMoveResult(FFrame&, void* const)
native function bool sfReqRecvInviteGameRoomMoveResult(string GuestCharName, byte MoveResult)
{
    //native.GuestCharName;
    //native.MoveResult;        
}
...
native function bool sfAckWebzenCash(int Result, string ErrMsg, BtrDouble Cash)
{
    //native.Result;
    //native.ErrMsg;
    //native.Cash;        
...
native function bool sfReqBuyItemByWebzenCash(int PackageProductSeq, int ProductDisplaySeq, int PriceSeq, array<int> ItemIDs)
{
...
native function bool sfAckRandomBox_Use(int Result, string ErrMsg, BtrDouble RandomBoxItemIdx, int RandomBxoItemCount, array<int> ItemIDChoose, array<int> PartIDChoose, array<byte> bHave, array<BtrDouble> ItemIdx, array<BtrDouble> UntilTime, array<int> StackCount)
{
    //native.Result;
    //native.ErrMsg;
...
native function bool sfAckPaidItem_NotifyChangeClanMark(int Pattern, int BG, int BL)
{
    //native.Pattern;
    //native.BG;
    //native.BL;        
...
native function bool sfReqNotifyEndTutorial();
