class MG_MuzFlash_01_1RD extends wEmitter;
...
defaultproperties
{
    ...
    mRandTextures=true
    mNumTileRows=2
    mMeshNodes=StaticMesh'Warfare_Staticmeshes.Weapon_Effects.AR_Muzzleflash_02_1rd'
    DrawScale=1.2000000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes.PB_Muzzleflash_02_1rd'
    Style=6
}