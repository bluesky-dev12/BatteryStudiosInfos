...
defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter176'
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter178'
    ...
    Emitters[1]=SpriteEmitter178
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter254'
    begin object name="SpriteEmitter254" class=Engine.SpriteEmitter
        UseColorScale=true
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
    ...
    Emitters[2]=SpriteEmitter254
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter255'
    begin object name="SpriteEmitter255" class=Engine.SpriteEmitter
        UseColorScale=true
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
    ...
    Emitters[3]=SpriteEmitter255
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter257'
    ...
    Emitters[4]=SpriteEmitter257
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter258'
    ...
    Emitters[5]=SpriteEmitter258
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter259'
    begin object name="SpriteEmitter259" class=Engine.SpriteEmitter
        UseDirectionAs=1
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
    ...
    Emitters[6]=SpriteEmitter259
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter261'
    begin object name="SpriteEmitter261" class=Engine.SpriteEmitter
        ...
        SizeScale=/* Array type was not detected. */
        StartSizeRange=(X=(Min=7.0000000,Max=7.0000000),Y=(Min=350.0000000,Max=350.0000000),Z=(Min=70.0000000,Max=70.0000000))
    ...
    Emitters[7]=SpriteEmitter261
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter262'
    begin object name="SpriteEmitter262" class=Engine.SpriteEmitter
        UseColorScale=true
        FadeOut=true
        RespawnDeadParticles=false
        SpinParticles=true
    ...
    Emitters[8]=SpriteEmitter262
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter263'
    ...
    Emitters[9]=SpriteEmitter263
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter265'
    begin object name="SpriteEmitter265" class=Engine.SpriteEmitter
        UseColorScale=true
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
    ...
    Emitters[10]=SpriteEmitter265
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter266'
    ...
    Emitters[11]=SpriteEmitter266
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion.SpriteEmitter267'
