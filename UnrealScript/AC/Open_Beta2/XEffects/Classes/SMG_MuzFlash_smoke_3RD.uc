class SMG_MuzFlash_smoke_3RD extends EmitterThirdPerson;

defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.SMG_MuzFlash_smoke_3RD.SpriteEmitter3'
    begin object name="SpriteEmitter3" class=Engine.SpriteEmitter
        ...
        StartVelocityRange=(X=(Min=233.9999847,Max=233.9999847),Y=(Min=0.0000000,Max=0.0000000),Z=(Min=0.0000000,Max=0.0000000))
    end object
    Emitters[0]=SpriteEmitter3
    // Reference: SpriteEmitter'XEffects_Decompressed.SMG_MuzFlash_smoke_3RD.SpriteEmitter4'
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.SMG_MuzFlash_smoke_3RD.SpriteEmitter5'
