...
event PlayerInput(float DeltaTime)
{
    ...
    // End:0x186
    if(((Outer.Pawn != none) && Outer.Pawn.bIsAiming) && int(Outer.Pawn.Weapon.WeaponType) == int(2))
    {
...
function UpdateSensitivity(float f, optional bool bZooming)
{
    ...
    {
        MouseSensitivityAim = FMax(0.0000000, f);
...
function UpdateSensitivityForAim(bool bZoom)
{
    ...
    if(bZoom == true)
    {
        ...
        {
            MouseSensitivityAim = FMax(0.0000000, default.MouseSensitivityAim * 0.8500000);            
        }
        else
        {
...
defaultproperties
{
    ...
    MouseSensitivityActive=3.0000000
    MouseSensitivityAim=3.0000000
