...
simulated function Material Get1stCamouflageMt(int iItemID, byte byTeam)
{
    ...
    if(int(byTeam) == 0)
    {
        ...
        {
            mt = Material(GM.DynamicLoadObject(cResParam.strRes_1st, Class'Engine_Decompressed.Material'));
        }        
    }
    else
    {
        ...
        {
            mt = Material(GM.DynamicLoadObject(cResParam.strRes_1st_RSA, Class'Engine_Decompressed.Material'));
        }
    }
    return mt;
    //return;    
