class wWeaponRes_FragGrenade_Easter_B extends wWeaponRes_Base;

defaultproperties
{
    stProj=StaticMesh'WPS_GR.Frag Grenade.Frag_EasterB'
    ...
    effect_Explosion=Class'XEffects.XWFX_Grenade_explosion_easter_B'
    effect_Explosion_dirt=Class'XEffects.XWFX_Grenade_explosion_easter_B'
    effect_Explosion_grass=Class'XEffects.XWFX_Grenade_explosion_easter_B'
    effect_Explosion_metal=Class'XEffects.XWFX_Grenade_explosion_easter_B'
    effect_Explosion_snow=Class'XEffects.XWFX_Grenade_explosion_easter_B'
    effect_Explosion_water=Class'XEffects.XWFX_Grenade_explosion_easter_B'
    effect_Explosion_wood=Class'XEffects.XWFX_Grenade_explosion_easter_B'
    Proj_ExplosionDecal=Class'XEffects.Event_Cash_Gacha_Easter_GR_mark_02'
