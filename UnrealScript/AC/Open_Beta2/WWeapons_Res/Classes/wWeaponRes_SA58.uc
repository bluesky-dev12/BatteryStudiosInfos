...
defaultproperties
{
    ...
    szIcon_HUD="Warfare_UI_Item.HUDIcon.Item_HUD_WP_AR_SA58"
    szIcon_Kill="Warfare_UI_Item.Item_killIcon"
    ibIcon_Kill=(X=128,Y=818,W=128,H=32)
    szType_DisplayAmmo="ammo50"
    fsound_Fire="Warfare_Sound_Weapon/AR/SA58/fire"
    fsound_Fire_Stereo="Warfare_Sound_Weapon/AR/SA58/fire_s"
    fSound_Fire_Silencer="Warfare_Sound_Weapon/AR/SA58/fire_silencer"
    fsound_Fire_Silencer_Stereo="Warfare_Sound_Weapon/AR/SA58/fire_silencer_s"
    ...
    fsound_Reload="Warfare_Sound_Weapon/AR/SA58/reload"
    fsound_ReloadEmpty="Warfare_Sound_Weapon/AR/SA58/reload_empty"
    fsound_Select="Warfare_Sound_Weapon/AR/SA58/select"
    fsound_Pickup="Warfare_Sound_Char/GetItem/char_getitem_weapon"
    fsound_Select_New="Warfare_Sound_Weapon/AR/SA58/select_n"
}