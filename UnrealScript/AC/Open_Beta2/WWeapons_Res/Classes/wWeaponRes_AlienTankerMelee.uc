class wWeaponRes_AlienTankerMelee extends wWeaponRes_Base;

defaultproperties
{
    effect_Melee_Attack1=Class'XEffects.HitEffect_alien_Tanker_meleeattack'
    effect_Melee_Attack2=Class'XEffects.HitEffect_alien_Tanker_meleeattack'
