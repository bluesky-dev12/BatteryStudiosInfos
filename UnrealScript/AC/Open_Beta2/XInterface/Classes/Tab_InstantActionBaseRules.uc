...
defaultproperties
{
    ...
    begin object name="IARulesGameSpeedSlider" class=XInterface_Decompressed.GUISlider
        ...
        Hint="Change the speed of the game."
        WinTop=0.0975520
        WinLeft=0.3750000
        WinWidth=0.2500000
    ...
    begin object name="IARulesWeaponStay" class=XInterface_Decompressed.moCheckBox
        ...
        Hint="Weapons stay at spawn points after being picked up, allowing multiple players to use them."
        WinTop=0.3151040
        WinLeft=0.0500000
        WinWidth=0.4000000
        WinHeight=0.0400000
    ...
    begin object name="IARulesTranslocator" class=XInterface_Decompressed.moCheckBox
        ComponentJustification=0
        CaptionWidth=0.9000000
        Caption="Allow Translocators"
        OnCreateComponent=IARulesTranslocator.InternalOnCreateComponent
        Hint="Enables the use of translocators."
        WinTop=0.4281250
        WinLeft=0.0500000
        WinWidth=0.4000000
        WinHeight=0.0400000
    ...
    begin object name="IARulesFriendlyFireSlider" class=XInterface_Decompressed.GUISlider
        ...
        Hint="Change the damage done by friendly fire."
        WinTop=0.6000000
        WinLeft=0.0500000
        WinWidth=0.4000000
        WinHeight=0.0400000
    ...
    begin object name="IARulesGoalScore" class=XInterface_Decompressed.moNumericEdit
        ...
        Hint="Once a player reaches this score, the game ends."
        WinTop=0.3151040
        WinLeft=0.5539060
        WinWidth=0.4000000
        WinHeight=0.0400000
    ...
    begin object name="IARulesTimeLimit" class=XInterface_Decompressed.moNumericEdit
        ...
        Hint="When the time limit ends, the game ends."
        WinTop=0.4281250
        WinLeft=0.5539060
        WinWidth=0.4000000
        WinHeight=0.0400000
    ...
    begin object name="IARulesMaxLives" class=XInterface_Decompressed.moNumericEdit
        ...
        Hint="Set the number of respawns each player is allowed. Set to 0 to allow unlimited respawns."
        WinTop=0.5476560
        WinLeft=0.5539060
        WinWidth=0.4000000
        WinHeight=0.0400000
    ...
    begin object name="IARulesAllowWeaponThrow" class=XInterface_Decompressed.moCheckBox
        ...
        Hint="Players may drop weapons currently held."
        WinTop=0.3708330
        WinLeft=0.0500000
        WinWidth=0.4000000
        WinHeight=0.0400000
    ...
    begin object name="IARulesBrightSkins" class=XInterface_Decompressed.moCheckBox
        ...
        Hint="Player skins are brighter for increased visibility."
        WinTop=0.4795850
        WinLeft=0.0482420
        WinWidth=0.3906260
        WinHeight=0.0400000
