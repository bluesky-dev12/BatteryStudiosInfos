...
{
    // End:0x26
    if(1 == int(Pawn.PlayerReplicationInfo.abySupplyItemFlag[int(1)]))
    {
        return false;
    }
    // End:0x3F
...
auto state Pickup
{
    function Touch(Actor Other)
    {
        ...
        if(ValidTouch(Other))
        {
            ...
            if(CanPickUp(P))
            {
                P.PlayerReplicationInfo.abySupplyItemFlag[int(1)] = 1;
...
defaultproperties
{
    SoundPickUP="Warfare_Sound_ATS/cb/ats_cb_ready_uav"
