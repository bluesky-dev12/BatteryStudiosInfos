...
replication
{
    ...
    reliable if(bNetDirty && int(Role) == int(ROLE_Authority))
        bActiveEffect, bActiveNowRespawn, 
        bActiveRepairNuclear, iRepairValue;

    // Pos:0x018
    reliable if(int(Role) < int(ROLE_Authority))
        ServerReqNowRespawn, ServerReqRepairNuclear;
}
    ...
    if(fDeltaTime > 0.2000000)
    {
        ...
        switch(byKey)
        {
            ...
            case 7:
                ...
                Log((((string(self) $ " [ ReqUsingItem::ServerReqRepairNuclear 1] / bEnableRequir:") $ string(bEnableRequir)) $ "/( IntToBtrDouble(0)!=iUniqueID ):") $ string(__NFUN_913__(__NFUN_921__(0), iUniqueID)));
                bEnableRequir = bEnableRequir && self.GetItemCount(iItemID) > 0;
                Log((((((string(self) $ " [ ReqUsingItem::ServerReqRepairNuclear 2] / bEnableRequir:") $ string(bEnableRequir)) $ "/ GetItemCount( ):") $ string(self.GetItemCount(iItemID))) $ "/bReqActiveRepair:") $ string(bReqActiveRepair));
                // End:0x284
                ...
                Log((((((string(self) $ " [ ReqUsingItem::ServerReqRepairNuclear ] / iItemID:") $ string(iItemID)) $ " / iUniqueID: ") $ __NFUN_918__(iUniqueID)) $ " / bEnableRequir:") $ string(bEnableRequir));
                // End:0x337
                break;
            // End:0xFFFF
            default:
        ...
        if(fDeltaTime > 1.1000000)
        {
            switch(byKey)
            {
                ...
                case 8:
                    ...
                    Log((((string(self) $ " [ ReqUsingItem::ServerReqNowRespawn ] / IsDead:") $ string(PlayerReplicationInfo.IsDead)) $ " / fDeltaTime:") $ string(fDeltaTime));
                    bEnableRequir = bEnableRequir && self.GetItemCount(iItemID) > 0;
                    Log((((string(self) $ " [ ReqUsingItem::ServerReqNowRespawn ] / bActiveNowRespawn :") $ string(bActiveNowRespawn)) $ " / bEnableRequir:") $ string(bEnableRequir));
                    // End:0x4E7
                    ...
                    Log((((((string(self) $ " [ ReqUsingItem::ServerReqNowRespawn ] / iItemID:") $ string(iItemID)) $ " / iUniqueID: ") $ __NFUN_918__(iUniqueID)) $ " / bEnableRequir:") $ string(bEnableRequir));
                    // End:0x59A
                    break;
                // End:0xFFFF
                default:
...
function int GetItemCount(int iItemID)
{
    ...
    {
        // End:0xAF
        if(sts.ItemList[lp1].iSlotPosition == int(26))
        {
            // End:0xAF
...
function AddSkillByInventory()
{
    ...
    {
        kUser = MM.UserInfos[lp1];
        // End:0x73
        if(kUser.UserName == PlayerReplicationInfo.PlayerName)
        {
            // [Explicit Break]
            goto J0x7D;
        }
    ...
    {
        // End:0x1A3
        if(kUser.EquippedItems[lp1].SlotPosition == int(26))
        {
