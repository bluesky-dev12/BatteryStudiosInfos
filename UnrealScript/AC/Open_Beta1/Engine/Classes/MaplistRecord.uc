...
static function KeyValuePair CreateMapOption(out string MapOptionString)
{
    ...
    Class'Engine_Decompressed.GameInfo'.static.GetKeyValue(MapOptionString, Pair.key, Pair.Value);
    return Pair;
    //return;    
}
...
static function bool CreateMapItem(string FullMapURL, out MapItem Item)
{
    ...
    // End:0xC6 [Loop If]
    if(Class'Engine_Decompressed.GameInfo'.static.GrabOption(FullMapURL, str))
    {
