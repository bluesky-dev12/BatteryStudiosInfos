...
exec function ListDynamicActors()
{
    ...
    // End:0x33
    foreach Outer.DynamicActors(Class'Engine_Decompressed.Actor', A)
    {
        i++;
...
exec function LogScriptedSequences()
{
    ...
    // End:0x3B
    foreach Outer.AllActors(Class'Engine_Decompressed.AIScript', S)
    {
...
exec function KillPawns()
{
    ...
    Outer.KillAllPawns(Class'Engine_Decompressed.Pawn');
...
exec function Avatar(string ClassName)
{
    ...
    {
        // End:0xD5
        foreach Outer.DynamicActors(Class'Engine_Decompressed.Pawn', P)
        {
            // End:0xD4
...
exec function ClearAllDebugLines()
{
    ...
    // End:0x29
    foreach Outer.AllActors(Class'Engine_Decompressed.Actor', A)
    {
...
exec function ruler()
{
    ...
    // End:0x4B
    foreach Outer.AllActors(Class'Engine_Decompressed.NavigationPoint', N)
    {
        // End:0x4A
