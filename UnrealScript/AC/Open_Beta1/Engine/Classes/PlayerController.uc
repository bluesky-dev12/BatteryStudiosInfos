...
exec function input_weaponex(string S)
{
    ...
    Pawn.Weapon.BaseParams.fMeleeDam_Head = float(arrs[int(Pawn.Weapon.BaseParams.4)]);
    Pawn.Weapon.BaseParams.fMeleeDam_UpperTorso = float(arrs[int(Pawn.Weapon.BaseParams.5)]);
    Pawn.Weapon.BaseParams.fMeleeDam_LowerTorso = float(arrs[int(Pawn.Weapon.BaseParams.6)]);
    Pawn.Weapon.BaseParams.fMeleeDam_UpperArm = float(arrs[int(Pawn.Weapon.BaseParams.7)]);
    Pawn.Weapon.BaseParams.fMeleeDam_LowerArm = float(arrs[int(Pawn.Weapon.BaseParams.8)]);
    Pawn.Weapon.BaseParams.fMeleeDam_UpperLeg = float(arrs[int(Pawn.Weapon.BaseParams.9)]);
    Pawn.Weapon.BaseParams.fMeleeDam_LowerLeg = float(arrs[int(Pawn.Weapon.BaseParams.10)]);
    Pawn.Weapon.BaseParams.fFiringSway_HipX_Max = float(arrs[int(Pawn.Weapon.BaseParams.11)]);
    Pawn.Weapon.BaseParams.fFiringSway_HipX_Incr = float(arrs[int(Pawn.Weapon.BaseParams.12)]);
    Pawn.Weapon.BaseParams.fFiringSway_HipX_Speed = float(arrs[int(Pawn.Weapon.BaseParams.13)]);
    Pawn.Weapon.BaseParams.fFiringSway_HipY_Max = float(arrs[int(Pawn.Weapon.BaseParams.14)]);
    Pawn.Weapon.BaseParams.fFiringSway_HipY_Incr = float(arrs[int(Pawn.Weapon.BaseParams.15)]);
    Pawn.Weapon.BaseParams.fFiringSway_HipY_Speed = float(arrs[int(Pawn.Weapon.BaseParams.16)]);
    Pawn.Weapon.BaseParams.fFiringSway_AdsX_Max = float(arrs[int(Pawn.Weapon.BaseParams.17)]);
    Pawn.Weapon.BaseParams.fFiringSway_AdsX_Incr = float(arrs[int(Pawn.Weapon.BaseParams.18)]);
    Pawn.Weapon.BaseParams.fFiringSway_AdsX_Speed = float(arrs[int(Pawn.Weapon.BaseParams.19)]);
    Pawn.Weapon.BaseParams.fFiringSway_AdsY_Max = float(arrs[int(Pawn.Weapon.BaseParams.20)]);
    Pawn.Weapon.BaseParams.fFiringSway_AdsY_Incr = float(arrs[int(Pawn.Weapon.BaseParams.21)]);
    Pawn.Weapon.BaseParams.fFiringSway_AdsY_Speed = float(arrs[int(Pawn.Weapon.BaseParams.22)]);
    i = 0;
    J0x690:
...
exec function input_weapon(string S)
{
    ...
    SplitForInputWeapon(S, arrs);
    Pawn.Weapon.BaseParams.iSpread_2nd_StartNum = int(arrs[int(Pawn.Weapon.BaseParams.74)]);
    Pawn.Weapon.BaseParams.fSpread_2nd_Add = float(arrs[int(Pawn.Weapon.BaseParams.75)]);
    Pawn.Weapon.BaseParams.fSpread_2nd_Max = float(arrs[int(Pawn.Weapon.BaseParams.76)]);
    Pawn.Weapon.BaseParams.fRateOfFire = float(arrs[int(Pawn.Weapon.BaseParams.7)]);
    Pawn.Weapon.BaseParams.fSpread_Aim_move_add = float(arrs[int(Pawn.Weapon.BaseParams.77)]);
    Pawn.Weapon.BaseParams.fSpread_Stand_Min = float(arrs[int(Pawn.Weapon.BaseParams.81)]);
    Pawn.Weapon.BaseParams.fSpread_Stand_Max = float(arrs[int(Pawn.Weapon.BaseParams.82)]);
    Pawn.Weapon.BaseParams.fSpread_Move_Add = float(arrs[int(Pawn.Weapon.BaseParams.87)]);
    Pawn.Weapon.BaseParams.fSpread_Fire_Add = float(arrs[int(Pawn.Weapon.BaseParams.88)]);
    Pawn.Weapon.BaseParams.fSpread_Image_Increase = float(arrs[int(Pawn.Weapon.BaseParams.89)]);
    Pawn.Weapon.BaseParams.fSpread_Stand_Reduce = float(arrs[int(Pawn.Weapon.BaseParams.90)]);
    ...
    Pawn.Weapon.BaseParams.iDam_OOR = int(arrs[int(Pawn.Weapon.BaseParams.36)]);
    Pawn.Weapon.BaseParams.iDamage = int(arrs[int(Pawn.Weapon.BaseParams.37)]);
    Pawn.Weapon.BaseParams.fDamPerc_Head = float(arrs[int(Pawn.Weapon.BaseParams.41)]);
    Pawn.Weapon.BaseParams.fDamPerc_UpperTorso = float(arrs[int(Pawn.Weapon.BaseParams.42)]);
    Pawn.Weapon.BaseParams.fDamPerc_LowerTorso = float(arrs[int(Pawn.Weapon.BaseParams.43)]);
    Pawn.Weapon.BaseParams.fDamPerc_UpperArm = float(arrs[int(Pawn.Weapon.BaseParams.44)]);
    Pawn.Weapon.BaseParams.fDamPerc_LowerArm = float(arrs[int(Pawn.Weapon.BaseParams.45)]);
    Pawn.Weapon.BaseParams.fDamPerc_UpperLeg = float(arrs[int(Pawn.Weapon.BaseParams.46)]);
    Pawn.Weapon.BaseParams.fDamPerc_LowerLeg = float(arrs[int(Pawn.Weapon.BaseParams.47)]);
    Pawn.Weapon.BaseParams.fViewKickHip_XMin = float(arrs[int(Pawn.Weapon.BaseParams.93)]);
    Pawn.Weapon.BaseParams.fViewKickHip_XMax = float(arrs[int(Pawn.Weapon.BaseParams.94)]);
    Pawn.Weapon.BaseParams.fViewKickHip_YMin = float(arrs[int(Pawn.Weapon.BaseParams.95)]);
    Pawn.Weapon.BaseParams.fViewKickHip_YMax = float(arrs[int(Pawn.Weapon.BaseParams.96)]);
    Pawn.Weapon.BaseParams.fViewKickHip_Accel = float(arrs[int(Pawn.Weapon.BaseParams.97)]);
    Pawn.Weapon.BaseParams.fViewKickHip_Decel = float(arrs[int(Pawn.Weapon.BaseParams.98)]);
    Pawn.Weapon.BaseParams.fViewKickHip_StayTime = float(arrs[int(Pawn.Weapon.BaseParams.99)]);
    Pawn.Weapon.BaseParams.fViewKickHip_DecaySpeed = float(arrs[int(Pawn.Weapon.BaseParams.100)]);
    Pawn.Weapon.BaseParams.fViewKickHip_DecayTimeFast = float(arrs[int(Pawn.Weapon.BaseParams.101)]);
    Pawn.Weapon.BaseParams.fViewKickAds_XMin = float(arrs[int(Pawn.Weapon.BaseParams.102)]);
    Pawn.Weapon.BaseParams.fViewKickAds_XMax = float(arrs[int(Pawn.Weapon.BaseParams.103)]);
    Pawn.Weapon.BaseParams.fViewKickAds_YMin = float(arrs[int(Pawn.Weapon.BaseParams.104)]);
    Pawn.Weapon.BaseParams.fViewKickAds_YMax = float(arrs[int(Pawn.Weapon.BaseParams.105)]);
    Pawn.Weapon.BaseParams.fViewKickAds_Accel = float(arrs[int(Pawn.Weapon.BaseParams.106)]);
    Pawn.Weapon.BaseParams.fViewKickAds_Decel = float(arrs[int(Pawn.Weapon.BaseParams.107)]);
    Pawn.Weapon.BaseParams.fViewKickAds_StayTime = float(arrs[int(Pawn.Weapon.BaseParams.108)]);
    Pawn.Weapon.BaseParams.fViewKickAds_DecaySpeed = float(arrs[int(Pawn.Weapon.BaseParams.109)]);
    Pawn.Weapon.BaseParams.fViewKickAds_DecayTimeFast = float(arrs[int(Pawn.Weapon.BaseParams.110)]);
    Pawn.Weapon.BaseParams.fHitMoveSpeed = float(arrs[int(Pawn.Weapon.BaseParams.139)]);
    Pawn.Weapon.BaseParams.fHitMoveTime = float(arrs[int(Pawn.Weapon.BaseParams.140)]);
    Pawn.Weapon.BaseParams.fHitMoveDelay = float(arrs[int(Pawn.Weapon.BaseParams.141)]);
    Pawn.Weapon.BaseParams.fSprintSpeed = float(arrs[int(Pawn.Weapon.BaseParams.142)]);
    Pawn.Weapon.BaseParams.fRunSpeed = float(arrs[int(Pawn.Weapon.BaseParams.143)]);
    Pawn.Weapon.BaseParams.fAimRunSpeed = float(arrs[int(Pawn.Weapon.BaseParams.146)]);
    Pawn.Weapon.BaseParams.fFireDelay = float(arrs[int(Pawn.Weapon.BaseParams.10)]);
    Pawn.Weapon.BaseParams.fDamRange_Eff = float(arrs[int(Pawn.Weapon.BaseParams.39)]);
    Pawn.Weapon.BaseParams.fDamRange_Max = float(arrs[int(Pawn.Weapon.BaseParams.40)]);
    Pawn.Weapon.BaseParams.fDamWallShot = float(arrs[int(Pawn.Weapon.BaseParams.38)]);
    Pawn.Weapon.BaseParams.fHitGunKick = float(arrs[int(Pawn.Weapon.BaseParams.50)]);
    Pawn.Weapon.BaseParams.fExplRad_Inner = float(arrs[int(Pawn.Weapon.BaseParams.64)]);
    Pawn.Weapon.BaseParams.fExplRad_Outer = float(arrs[int(Pawn.Weapon.BaseParams.65)]);
    Pawn.Weapon.BaseParams.fExplRad_Effect = float(arrs[int(Pawn.Weapon.BaseParams.66)]);
    Pawn.Weapon.BaseParams.fExplForce_Effect = float(arrs[int(Pawn.Weapon.BaseParams.67)]);
    Pawn.Weapon.BaseParams.fExplDam_Inner = float(arrs[int(Pawn.Weapon.BaseParams.68)]);
    Pawn.Weapon.BaseParams.fExplDam_Outer = float(arrs[int(Pawn.Weapon.BaseParams.69)]);
    Pawn.Weapon.BaseParams.iSpread_Visual_Add = int(arrs[int(Pawn.Weapon.BaseParams.78)]);
    Pawn.Weapon.BaseParams.fSpread_Shotgun = float(arrs[int(Pawn.Weapon.BaseParams.79)]);
    Pawn.Weapon.BaseParams.fSpread_Jump = float(arrs[int(Pawn.Weapon.BaseParams.80)]);
    Pawn.Weapon.BaseParams.fSpread_Ducked_Min = float(arrs[int(Pawn.Weapon.BaseParams.83)]);
    Pawn.Weapon.BaseParams.fSpread_Ducked_Max = float(arrs[int(Pawn.Weapon.BaseParams.84)]);
    Pawn.Weapon.BaseParams.fSpread_Prone_Min = float(arrs[int(Pawn.Weapon.BaseParams.85)]);
    Pawn.Weapon.BaseParams.fSpread_Prone_Max = float(arrs[int(Pawn.Weapon.BaseParams.86)]);
    Pawn.Weapon.BaseParams.fSpread_Ducked_Reduce = float(arrs[int(Pawn.Weapon.BaseParams.91)]);
    Pawn.Weapon.BaseParams.fSpread_Prone_Reduce = float(arrs[int(Pawn.Weapon.BaseParams.92)]);
    Pawn.Weapon.BaseParams.fCrouchSpeed = float(arrs[int(Pawn.Weapon.BaseParams.144)]);
    Pawn.Weapon.BaseParams.fPronedSpeed = float(arrs[int(Pawn.Weapon.BaseParams.145)]);
    Pawn.Weapon.BaseParams.fAimCrouchSpeed = float(arrs[int(Pawn.Weapon.BaseParams.147)]);
    ...
    Pawn.Weapon.BaseParams.ReloadType = Pawn.Weapon.BaseParams.GetReloadType(arrs[int(Pawn.Weapon.BaseParams.57)]);
    Pawn.Weapon.BaseParams.bRechamber = bool(arrs[int(Pawn.Weapon.BaseParams.58)]);
    Pawn.Weapon.BaseParams.fRechamberRate = float(arrs[int(Pawn.Weapon.BaseParams.59)]);
    Pawn.Weapon.BaseParams.fReloadRate = float(arrs[int(Pawn.Weapon.BaseParams.60)]);
    Pawn.Weapon.BaseParams.fReloadEmptyRate = float(arrs[int(Pawn.Weapon.BaseParams.61)]);
    Pawn.Weapon.BaseParams.fReloadBeginRate = float(arrs[int(Pawn.Weapon.BaseParams.62)]);
    Pawn.Weapon.BaseParams.fReloadEndRate = float(arrs[int(Pawn.Weapon.BaseParams.63)]);
    Pawn.Weapon.BaseParams.iAmmo_Initial = int(arrs[int(Pawn.Weapon.BaseParams.70)]);
    Pawn.Weapon.BaseParams.iAmmo_Magazine = int(arrs[int(Pawn.Weapon.BaseParams.71)]);
    Pawn.Weapon.BaseParams.iAmmo_Reload = int(arrs[int(Pawn.Weapon.BaseParams.72)]);
    Pawn.Weapon.BaseParams.iAmmo_Max = int(arrs[int(Pawn.Weapon.BaseParams.73)]);
    Pawn.Weapon.BaseParams.fBreathRadius_Idle = float(arrs[int(Pawn.Weapon.BaseParams.111)]);
    Pawn.Weapon.BaseParams.fBreathSpeed_Idle = float(arrs[int(Pawn.Weapon.BaseParams.112)]);
    Pawn.Weapon.BaseParams.fBreathRadius_Aim = float(arrs[int(Pawn.Weapon.BaseParams.113)]);
    Pawn.Weapon.BaseParams.fBreathSpeed_Aim = float(arrs[int(Pawn.Weapon.BaseParams.114)]);
    Pawn.Weapon.BaseParams.fBreathRadius_DuckedAim = float(arrs[int(Pawn.Weapon.BaseParams.115)]);
    Pawn.Weapon.BaseParams.fBreathSpeed_DuckedAim = float(arrs[int(Pawn.Weapon.BaseParams.116)]);
    Pawn.Weapon.BaseParams.fBreathRadius_ProneAim = float(arrs[int(Pawn.Weapon.BaseParams.117)]);
    Pawn.Weapon.BaseParams.fBreathSpeed_ProneAim = float(arrs[int(Pawn.Weapon.BaseParams.118)]);
    Pawn.Weapon.BaseParams.fBobWeapon_Sprint_Move = float(arrs[int(Pawn.Weapon.BaseParams.119)]);
    Pawn.Weapon.BaseParams.fBobWeapon_sprint_y = float(arrs[int(Pawn.Weapon.BaseParams.120)]);
    Pawn.Weapon.BaseParams.fBobScreen_Sprint_Move = float(arrs[int(Pawn.Weapon.BaseParams.121)]);
    Pawn.Weapon.BaseParams.fBobScreen_sprint_y = float(arrs[int(Pawn.Weapon.BaseParams.122)]);
    Pawn.Weapon.BaseParams.fBobWeapon_Ads_Move = float(arrs[int(Pawn.Weapon.BaseParams.123)]);
    Pawn.Weapon.BaseParams.fBobWeapon_ads_move_y = float(arrs[int(Pawn.Weapon.BaseParams.124)]);
    Pawn.Weapon.BaseParams.fBobScreen_Ads_Move = float(arrs[int(Pawn.Weapon.BaseParams.125)]);
    Pawn.Weapon.BaseParams.fBobScreen_ads_move_y = float(arrs[int(Pawn.Weapon.BaseParams.126)]);
    Pawn.Weapon.BaseParams.fBobWeapon_Move = float(arrs[int(Pawn.Weapon.BaseParams.127)]);
    Pawn.Weapon.BaseParams.fBobWeapon_move_y = float(arrs[int(Pawn.Weapon.BaseParams.128)]);
    Pawn.Weapon.BaseParams.fBobScreen_Move = float(arrs[int(Pawn.Weapon.BaseParams.129)]);
    Pawn.Weapon.BaseParams.fBobScreen_move_y = float(arrs[int(Pawn.Weapon.BaseParams.130)]);
    Pawn.Weapon.BaseParams.fBobWeapon_Ducked_Move = float(arrs[int(Pawn.Weapon.BaseParams.131)]);
    Pawn.Weapon.BaseParams.fBobWeapon_ducked_move_y = float(arrs[int(Pawn.Weapon.BaseParams.132)]);
    Pawn.Weapon.BaseParams.fBobScreen_Ducked_Move = float(arrs[int(Pawn.Weapon.BaseParams.133)]);
    Pawn.Weapon.BaseParams.fBobScreen_ducked_move_y = float(arrs[int(Pawn.Weapon.BaseParams.134)]);
    Pawn.Weapon.BaseParams.fBobScreen_Prone_Move = float(arrs[int(Pawn.Weapon.BaseParams.135)]);
    Pawn.Weapon.BaseParams.fBobScreen_prone_move_y = float(arrs[int(Pawn.Weapon.BaseParams.136)]);
    Pawn.Weapon.BaseParams.fSprintStaminaRate = float(arrs[int(Pawn.Weapon.BaseParams.137)]);
    Pawn.Weapon.BaseParams.fStaminaRecovery = float(arrs[int(Pawn.Weapon.BaseParams.138)]);
    Pawn.Weapon.BaseParams.fHitMoveSpeed = float(arrs[int(Pawn.Weapon.BaseParams.139)]);
    Pawn.Weapon.BaseParams.fHitMoveTime = float(arrs[int(Pawn.Weapon.BaseParams.140)]);
    Pawn.Weapon.BaseParams.fHitMoveDelay = float(arrs[int(Pawn.Weapon.BaseParams.141)]);
    Pawn.Weapon.BaseParams.fAnimRate_PutDown = float(arrs[int(Pawn.Weapon.BaseParams.148)]);
    Pawn.Weapon.BaseParams.fAnimRate_PutDown_Quick = float(arrs[int(Pawn.Weapon.BaseParams.149)]);
    Pawn.Weapon.BaseParams.bApplyQuickDrop = bool(arrs[int(Pawn.Weapon.BaseParams.150)]);
    Pawn.Weapon.BaseParams.fAnimRate_BringUp = float(arrs[int(Pawn.Weapon.BaseParams.151)]);
    Pawn.Weapon.BaseParams.fAnimRate_SprintBringUp = float(arrs[int(Pawn.Weapon.BaseParams.152)]);
    Pawn.Weapon.BaseParams.fAnimRate_AdsOn = float(arrs[int(Pawn.Weapon.BaseParams.153)]);
    Pawn.Weapon.BaseParams.fAnimRate_AdsOff = float(arrs[int(Pawn.Weapon.BaseParams.154)]);
    Pawn.Weapon.BaseParams.fMaxPitch = float(arrs[int(Pawn.Weapon.BaseParams.167)]);
    Pawn.Weapon.BaseParams.CrosshairType = Pawn.Weapon.BaseParams.GetCrosshairType(arrs[int(Pawn.Weapon.BaseParams.168)]);
    Pawn.Weapon.BaseParams.CrosshairImage = arrs[int(Pawn.Weapon.BaseParams.169)];
    Pawn.Weapon.BaseParams.fMovePivot = float(arrs[int(Pawn.Weapon.BaseParams.170)]);
    ...
    Pawn.Weapon.BaseParams.fActiveTime = float(arrs[int(Pawn.Weapon.BaseParams.30)]);
    Pawn.Weapon.BaseParams.i2ndBulletCount = int(arrs[int(Pawn.Weapon.BaseParams.31)]);
    Pawn.Weapon.BaseParams.fMomentum = float(arrs[int(Pawn.Weapon.BaseParams.32)]);
    Pawn.Weapon.BaseParams.fMomentum_Pawn = float(arrs[int(Pawn.Weapon.BaseParams.33)]);
    Pawn.Weapon.BaseParams.fDamPerc_Heli = float(arrs[int(Pawn.Weapon.BaseParams.48)]);
    Pawn.Weapon.BaseParams.bHitEffFriendly = bool(arrs[int(Pawn.Weapon.BaseParams.49)]);
    Pawn.Weapon.BaseParams.fHitStunTime = float(arrs[int(Pawn.Weapon.BaseParams.51)]);
    Pawn.Weapon.BaseParams.fHitFlashTime = float(arrs[int(Pawn.Weapon.BaseParams.53)]);
    Pawn.Weapon.BaseParams.fHitEAXEffectTime = float(arrs[int(Pawn.Weapon.BaseParams.54)]);
    Pawn.Weapon.BaseParams.strHitEAXEffectClass = arrs[int(Pawn.Weapon.BaseParams.55)];
    Pawn.Weapon.BaseParams.fHitFireTime = float(arrs[int(Pawn.Weapon.BaseParams.56)]);
    Pawn.Weapon.BaseParams.fSway_HipX_Max = float(arrs[int(Pawn.Weapon.BaseParams.155)]);
    Pawn.Weapon.BaseParams.fSway_HipX_Incr = float(arrs[int(Pawn.Weapon.BaseParams.156)]);
    Pawn.Weapon.BaseParams.fSway_HipX_Speed = float(arrs[int(Pawn.Weapon.BaseParams.157)]);
    Pawn.Weapon.BaseParams.fSway_HipY_Max = float(arrs[int(Pawn.Weapon.BaseParams.158)]);
    Pawn.Weapon.BaseParams.fSway_HipY_Incr = float(arrs[int(Pawn.Weapon.BaseParams.159)]);
    Pawn.Weapon.BaseParams.fSway_HipY_Speed = float(arrs[int(Pawn.Weapon.BaseParams.160)]);
    Pawn.Weapon.BaseParams.fSway_AdsX_Max = float(arrs[int(Pawn.Weapon.BaseParams.161)]);
    Pawn.Weapon.BaseParams.fSway_AdsX_Incr = float(arrs[int(Pawn.Weapon.BaseParams.162)]);
    Pawn.Weapon.BaseParams.fSway_AdsX_Speed = float(arrs[int(Pawn.Weapon.BaseParams.163)]);
    Pawn.Weapon.BaseParams.fSway_AdsY_Max = float(arrs[int(Pawn.Weapon.BaseParams.164)]);
    Pawn.Weapon.BaseParams.fSway_AdsY_Incr = float(arrs[int(Pawn.Weapon.BaseParams.165)]);
    Pawn.Weapon.BaseParams.fSway_AdsY_Speed = float(arrs[int(Pawn.Weapon.BaseParams.166)]);
    Pawn.Weapon.BaseParams.fNPCSpreadRate = float(arrs[int(Pawn.Weapon.BaseParams.178)]);
    Pawn.Weapon.BaseParams.fNPCRateOfFire = float(arrs[int(Pawn.Weapon.BaseParams.179)]);
    Pawn.Weapon.BaseParams.iNPCFire = int(arrs[int(Pawn.Weapon.BaseParams.180)]);
    i = 0;
    J0x2F51:
