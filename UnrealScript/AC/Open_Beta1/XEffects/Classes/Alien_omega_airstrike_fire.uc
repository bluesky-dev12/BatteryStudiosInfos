class Alien_omega_airstrike_fire extends Emitter;

defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.Alien_omega_airstrike_fire.SpriteEmitter1'
    begin object name="SpriteEmitter1" class=Engine.SpriteEmitter
        ...
        Acceleration=(X=0.0000000,Y=0.0000000,Z=-1152.3199463)
        ...
        StartSizeRange=(X=(Min=5.0000000,Max=5.0000000),Y=(Min=50.0000000,Max=50.0000000),Z=(Min=5.0000000,Max=5.0000000))
        ...
        StartVelocityRange=(X=(Min=-146.1179962,Max=846.1179810),Y=(Min=-146.1179962,Max=846.1179810),Z=(Min=107.7860031,Max=1107.7860107))
        GetVelocityDirectionFrom=3
    end object
    Emitters[0]=SpriteEmitter1
    // Reference: SpriteEmitter'XEffects_Decompressed.Alien_omega_airstrike_fire.SpriteEmitter2'
    begin object name="SpriteEmitter2" class=Engine.SpriteEmitter
        ...
        FadeOutStartTime=0.2761990
        FadeInEndTime=0.0946970
        ...
        SizeScale=/* Array type was not detected. */
        StartSizeRange=(X=(Min=80.0000000,Max=80.0000000),Y=(Min=400.0000000,Max=400.0000000),Z=(Min=80.0000000,Max=80.0000000))
        ...
        StartVelocityRange=(X=(Min=-653.7730103,Max=653.7730103),Y=(Min=-653.7730103,Max=653.7730103),Z=(Min=254.3209991,Max=385.1099854))
    end object
    Emitters[1]=SpriteEmitter2
    // Reference: SpriteEmitter'XEffects_Decompressed.Alien_omega_airstrike_fire.SpriteEmitter3'
    begin object name="SpriteEmitter3" class=Engine.SpriteEmitter
        ...
        LifetimeRange=(Min=1.0000000,Max=1.0000000)
        StartVelocityRange=(X=(Min=-660.0000000,Max=660.0000000),Y=(Min=-660.0000000,Max=660.0000000),Z=(Min=0.0000000,Max=500.0000000))
    end object
    Emitters[2]=SpriteEmitter3
    // Reference: SpriteEmitter'XEffects_Decompressed.Alien_omega_airstrike_fire.SpriteEmitter8'
    begin object name="SpriteEmitter8" class=Engine.SpriteEmitter
        ...
        ColorScale=/* Array type was not detected. */
        ColorMultiplierRange=(X=(Min=0.2000000,Max=0.2000000),Y=(Min=0.2000000,Max=0.2000000),Z=(Min=0.2000000,Max=0.2000000))
        FadeOutStartTime=0.3958330
        FadeInEndTime=0.1041670
        MaxParticles=20
        ...
        SizeScale=/* Array type was not detected. */
        StartSizeRange=(X=(Min=70.0000000,Max=70.0000000),Y=(Min=650.0000000,Max=650.0000000),Z=(Min=70.0000000,Max=70.0000000))
        InitialParticlesPerSecond=2094.4509277
        Texture=Texture'FX_TEX.Alien_FX.Alien_effect_020'
        TextureUSubdivisions=4
        TextureVSubdivisions=4
        SecondsBeforeInactive=7.0000000
        LifetimeRange=(Min=5.0000000,Max=5.0000000)
        InitialDelayRange=(Min=0.2000000,Max=0.2000000)
        StartVelocityRange=(X=(Min=0.0000000,Max=0.0000000),Y=(Min=0.0000000,Max=0.0000000),Z=(Min=0.0000000,Max=3263.1999512))
    end object
    Emitters[3]=SpriteEmitter8
    // Reference: SpriteEmitter'XEffects_Decompressed.Alien_omega_airstrike_fire.SpriteEmitter5'
    begin object name="SpriteEmitter5" class=Engine.SpriteEmitter
        ...
        LifetimeRange=(Min=1.0000000,Max=1.0000000)
        InitialDelayRange=(Min=0.2000000,Max=0.2000000)
        StartVelocityRange=(X=(Min=-120.0000000,Max=120.0000000),Y=(Min=-120.0000000,Max=120.0000000),Z=(Min=10.0000000,Max=1200.0000000))
    end object
