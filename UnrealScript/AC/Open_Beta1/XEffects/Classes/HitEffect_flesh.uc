...
simulated function SpawnEffects()
{
    ...
    {
        Spawn(Class'XEffects_Decompressed.HitEffect_flesh_BulletHole', self,, Location, Rotator(float(-1) * Vector(Rotation)));
        bViewed = true;
    }
    // End:0xAD
    ...
    Spawn(Class'XEffects_Decompressed.HitEffect_flesh_hit');
    //return;    
}
