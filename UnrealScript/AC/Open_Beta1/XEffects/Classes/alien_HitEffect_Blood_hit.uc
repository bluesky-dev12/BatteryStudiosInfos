class alien_HitEffect_Blood_hit extends Emitter;

defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.alien_HitEffect_Blood_hit.SpriteEmitter12'
    ...
    Emitters[0]=SpriteEmitter12
    // Reference: SpriteEmitter'XEffects_Decompressed.alien_HitEffect_Blood_hit.SpriteEmitter13'
    begin object name="SpriteEmitter13" class=Engine.SpriteEmitter
        ...
        StartSizeRange=(X=(Min=1.0000000,Max=3.0000000),Y=(Min=1.0000000,Max=3.0000000),Z=(Min=1.0000000,Max=3.0000000))
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.alien_HitEffect_Blood_hit.SpriteEmitter17'
    begin object name="SpriteEmitter17" class=Engine.SpriteEmitter
        FadeOut=true
        RespawnDeadParticles=false
        SpinParticles=true
        UseRegularSizeScale=false
    ...
    Emitters[2]=SpriteEmitter17
    // Reference: SpriteEmitter'XEffects_Decompressed.alien_HitEffect_Blood_hit.SpriteEmitter0'
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.alien_HitEffect_Blood_hit.SpriteEmitter2'
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.alien_HitEffect_Blood_hit.SpriteEmitter3'
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.alien_HitEffect_Blood_hit.SpriteEmitter27'
    begin object name="SpriteEmitter27" class=Engine.SpriteEmitter
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
        SpinParticles=true
