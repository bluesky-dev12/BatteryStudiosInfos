class BG_FX_flares_green extends Emitter;

defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.BG_FX_flares_green.SpriteEmitter5'
    begin object name="SpriteEmitter5" class=Engine.SpriteEmitter
        ...
        Texture=Texture'FX_TEX.Flares.glow_green'
