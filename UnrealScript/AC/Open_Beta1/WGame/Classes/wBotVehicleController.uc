...
state PathMove
{
    ...
    function BeginState()
    {
        ...
        {
            wBotVehicle(Pawn).PlaySound(wBotVehicle(Pawn).MoveSound, 10, 1.0000000,,,, false, true);            
        }
        else
        {
            wBotVehicle(Pawn).PlaySound(wBotVehicle(Pawn).MoveDamagedSound, 10, 1.0000000,,,, false, true);
        }
        //return;        
    }
...
state WaitForHunting
{
    function BeginState()
    {
        ...
        if(float(Pawn.Health) > (float(Pawn.default.Health) * 0.3000000))
        {
            wBotVehicle(Pawn).PlaySound(wBotVehicle(Pawn).StaySound, 10, 1.0000000,,,, false, true);            
        }
        else
        {
            wBotVehicle(Pawn).PlaySound(wBotVehicle(Pawn).MoveDamagedSound, 10, 1.0000000,,,, false, true);
