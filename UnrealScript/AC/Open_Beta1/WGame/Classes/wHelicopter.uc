...
simulated function ClientPlayMoveSound()
{
    ...
    if(!bHidden)
    {
        ...
        {
            PlaySoundHK(MoveSound, 0, 1.0000000, false, 1500.0000000,, true, true);            
        }
        else
        {
            PlaySoundHK(MoveDamagedSound, 0, 1.0000000, false, 1500.0000000,, true, true);
        }
    }
    //return;    
}
...
simulated function ClientPlayStaySound()
{
    ...
    if(!bHidden)
    {
        ...
        if(float(Health) > (float(default.Health) * 0.3000000))
        {
            PlaySoundHK(StaySound, 0, 1.0000000, false, 1500.0000000,, true, true);            
        }
        else
        {
            PlaySoundHK(MoveDamagedSound, 0, 1.0000000, false, 1500.0000000,, true, true);
