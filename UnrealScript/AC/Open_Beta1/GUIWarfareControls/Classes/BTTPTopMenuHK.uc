...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    Shop.buttonImage[0] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.TopMenuShop_Btn_n;
    Shop.buttonImage[1] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.TopMenuShop_Btn_on;
    Shop.buttonImage[2] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.TopMenuShop_Btn_n;
    Shop.buttonImage[3] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.TopMenuShop_Btn_cli;
    Shop.buttonImage[4] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.TopMenuShop_Btn_block;
    ...
    Inventory.buttonImage[0] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.TopMenuInven_Btn_n;
    Inventory.buttonImage[1] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.TopMenuInven_Btn_on;
    Inventory.buttonImage[2] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.TopMenuInven_Btn_n;
    Inventory.buttonImage[3] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.TopMenuInven_Btn_cli;
    Inventory.buttonImage[4] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.TopMenuInven_Btn_block;
    ...
    Clan.buttonImage[0] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.ClanBtn_n;
    Clan.buttonImage[1] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.ClanBtn_on;
    Clan.buttonImage[2] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.ClanBtn_n;
    Clan.buttonImage[3] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.ClanBtn_cli;
