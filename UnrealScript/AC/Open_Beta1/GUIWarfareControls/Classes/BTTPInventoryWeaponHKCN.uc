            ...
            if(nIndex < TPItemList.ItemList.DataPool.Length)
            {
                ...
                if(ro != none)
                {
                    ...
                    if((BTROItemBoxHK(ro).ItemInfo.CostType == 4) || BTROItemBoxHK(ro).ItemInfo.CostType == 1)
                    {
                        ...
                        if(cii != none)
                        {
                            Class'GUIWarfareControls_Decompressed.BTWindowSelectCashTypeHK'.static.ShowWindowSelectCashType(Controller, BTROItemBoxHK(ro), cii.EnablePCoin, cii.EnableCCoin);
