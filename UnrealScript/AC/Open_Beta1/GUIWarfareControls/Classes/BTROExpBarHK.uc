...
function bool Render(Canvas C, optional float Delta)
{
    ...
    {
        Class'Engine.BTCustomDrawHK'.static.DrawImagePadding(C, Gauge, AWinPos.X1 + float(LineWidth), AWinPos.Y1 + float(LineWidth), AWinPos.X2 - float(LineWidth), AWinPos.Y2 - float(LineWidth), 0.0000000, 0.0000000, DataPerc, 0.0000000);
    }
