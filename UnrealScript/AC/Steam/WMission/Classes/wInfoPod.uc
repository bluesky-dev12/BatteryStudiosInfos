 ...
 * Path WMission\Classes\wInfoPod.uc
 * Package Imports:
 *	WMission
 *	Engine
 *	Core
...
simulated function DrawInfoPod_PlainText(Canvas C, Vector IPScreenPos, PlayerController PC)
{
    ...
    FinalString = class'wHUD_Mission'.default.IP_Bracket_Open @ POD_Message @ class'wHUD_Mission'.default.IP_Bracket_Close;
...
simulated function DrawInfoPod_TextBrackets(Canvas C, Vector IPScrO, PlayerController PC)
{
    ...
    C.Font = PC.myHUD.GetFontSizeIndex(C, FontSize - 8);
    Description = class'wHUD_Mission'.default.IP_Bracket_Open @ POD_Message @ class'wHUD_Mission'.default.IP_Bracket_Close;
    class'wHUD_Mission'.static.Draw_2DCollisionBox(C, self, IPScrO, Description, DrawScale, false);
}
