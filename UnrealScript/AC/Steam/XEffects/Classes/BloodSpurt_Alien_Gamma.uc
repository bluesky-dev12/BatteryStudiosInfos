 ...
 * Path XEffects\Classes\BloodSpurt_Alien_Gamma.uc
 * Package Imports:
 *	XEffects
 *	Engine
 *	Core
 ...
 *
 *******************************************************************************/
class BloodSpurt_Alien_Gamma extends wEmitter;
...
defaultproperties
{
    BloodDecalClass=class'BloodSplatter_Alien_Gamma'
    ...
    HitEffectClass=class'HitEffect_blood_Alien_Gamma'
    mRegen=true
    mStartParticles=0
    mMaxParticles=0
    mLifeRange[0]=1.0
