 ...
 * Path XEffects\Classes\BloodSpurt_Alien_Omega.uc
 * Package Imports:
 *	XEffects
 *	Engine
 *	Core
 ...
 *
 *******************************************************************************/
class BloodSpurt_Alien_Omega extends wEmitter;
...
defaultproperties
{
    BloodDecalClass=class'BloodSplatter_Alien_Omega'
    ...
    HitEffectClass=class'HitEffect_blood_Alien_Omega'
    mRegen=true
    mStartParticles=0
    mMaxParticles=0
    mLifeRange[0]=1.0
