 ...
 * Path XEffects\Classes\xAlienPawnGidGroup.uc
 * Package Imports:
 *	XEffects
 *	Core
 *
...
defaultproperties
{
    BloodHitClass_Alpha=class'BloodSpurt_Alien'
    BloodHitClass_Gamma=class'BloodSpurt_Alien_Gamma'
    BloodHitClass_Eta=class'BloodSpurt_Alien_Eta'
    BloodHitClass_Kappa=class'BloodSpurt_Alien_Kappa'
    BloodHitClass_Omega=class'BloodSpurt_Alien_Omega'
    BloodHitClass=none
