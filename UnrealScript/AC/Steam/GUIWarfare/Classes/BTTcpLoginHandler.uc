 ...
 * Path GUIWarfare\Classes\BTTcpLoginHandler.uc
 * Package Imports:
 *	GUIWarfare
 *	BatteryNet
 *	Core
...
{
    UnresolvedNativeFunction_97("[BTTcpLoginHandler::OnConnect] ErrCode=" $ string(ErrCode));
    ...
    if(MainMenu.page_curr != none)
    {
        ...
        {
            UnresolvedNativeFunction_97("CurrPage is a RoomLobby");
        ...
        else
        {
            ...
            {
                UnresolvedNativeFunction_97("CurrPage is a Lobby");
            ...
            else
            {
                ...
                {
                    UnresolvedNativeFunction_97("CurrPage is a ServerSelection");
    ...
    {
        UnresolvedNativeFunction_97("CurrPage is none");
...
{
    UnresolvedNativeFunction_97("[BTTcpLoginHandler::OnClose] ErrCode=" $ string(ErrCode));
...
{
    UnresolvedNativeFunction_97("[BTTcpLoginHandler::OnError] ErrCode=" $ string(ErrCode));
...
{
    Log("[BTTcpLoginHandler::rfAckLoginWithGlobal]");
    // End:0x4c
    if(MainMenu.page_curr.TcpLogin == none)
    {
        return false;
    }
    return MainMenu.page_curr.TcpLogin.rfAckLoginWithGlobal(Result);
}
...
function bool rfAckMaxUserExceed()
{
    ...
    class'BTWindowDefineInfoHK'.static.ShowInfo(MainMenu.Controller, 99);
