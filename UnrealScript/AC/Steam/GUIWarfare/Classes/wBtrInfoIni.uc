 ...
 * Path GUIWarfare\Classes\wBtrInfoIni.uc
 * Package Imports:
 *	GUIWarfare
 *	Engine
 *	Core
...
defaultproperties
{
    Udp_Default_ConnectionTimeOut=90.0
    Udp_Default_InitialConnectionTimeOut=90.0
    Udp_Loading_ConnectionTimeOut=600.0
    Udp_Loading_InitialConnectionTimeOut=600.0
