 ...
 * Path WGame\Classes\wUAVPack.uc
 * Package Imports:
 *	WGame
 *	Engine
 *	Core
...
{
    // End:0x21
    if(P.PlayerReplicationInfo.bySupply_UAV == 1)
    {
        return false;
    }
    // End:0x3a
    ...
    function Touch(Actor Other)
    {
        ...
        if(ValidTouch(Other))
        {
            ...
            if(CanAdUAVpack(P))
            {
                ...
                PlayerController(P.Controller).ReceiveMessage_QuestType2(class'wMessage_Quest', class'wMessage_Quest'.default.Code_Quest_AcquireTrophy,,,, 4);
                Destroy();
            }
        }
    }
