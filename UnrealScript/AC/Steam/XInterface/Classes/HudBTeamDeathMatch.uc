 ...
 * Path XInterface\Classes\HudBTeamDeathMatch.uc
 * Package Imports:
 *	XInterface
 *	Engine
 *	Core
...
simulated function Tick(float DeltaTime)
{
    ...
    {
        TeamLinked = true;
        pulseWidget(DeltaTime, 255.0, 0.0, RHud2[3], TeamIndex, 1, 2000.0);
    }
    // End:0x6e
    else
    {
...
defaultproperties
{
    ScoreTeam[0]=(RenderStyle=5,MinDigitCount=2,TextureScale=0.240,DrawPivot=3,PosX=0.50,PosY=0.010,OffsetX=-150,OffsetY=80,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bPadWithZeroes=0)
    ScoreTeam[1]=(RenderStyle=5,MinDigitCount=2,TextureScale=0.240,DrawPivot=7,PosX=0.50,PosY=0.010,OffsetX=120,OffsetY=80,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bPadWithZeroes=0)
    totalLinks=(RenderStyle=5,MinDigitCount=2,TextureScale=0.20,DrawPivot=3,PosX=1.0,PosY=0.8350,OffsetX=-30,OffsetY=90,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bPadWithZeroes=0)
    Score=(RenderStyle=5,MinDigitCount=2,TextureScale=0.180,DrawPivot=2,PosX=0.0,PosY=0.0,OffsetX=560,OffsetY=40,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255),bPadWithZeroes=0)
    TeamSymbols[0]=(WidgetTexture=none,RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=256,Y2=256),TextureScale=0.10,DrawPivot=2,PosX=0.50,PosY=0.010,OffsetX=-60,OffsetY=60,ScaleMode=0,Scale=0.0,Tints=(R=255,G=100,B=100,A=200),Tints[1]=(R=255,G=32,B=32,A=200))
    TeamSymbols[1]=(WidgetTexture=none,RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=256,Y2=256),TextureScale=0.10,DrawPivot=0,PosX=0.50,PosY=0.010,OffsetX=90,OffsetY=60,ScaleMode=0,Scale=0.0,Tints=(R=0,G=128,B=255,A=200),Tints[1]=(R=32,G=210,B=255,A=200))
