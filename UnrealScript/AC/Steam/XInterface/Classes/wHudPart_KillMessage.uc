 ...
 * Path XInterface\Classes\wHudPart_KillMessage.uc
 * Package Imports:
 *	XInterface
 *	Engine
 *	Core
...
var Material Icon_OptionalKillInfo;

function Precache()
{
    DynamicLoadObject(class'wWeaponRes_AK47'.default.szIcon_Kill, class'Material');
}
...
function KillMessageItem MakeKillMessageItem(PlayerReplicationInfo KillerPRI, PlayerReplicationInfo victimPRI, string KillerName, string VictimName, class<DamageType> DamageType, int Switch, bool NoKillerName, bool NoVictimName, Material overrideImage)
{
    ...
    if(overrideImage == none)
    {
        ...
        {
            resClass = class<wWeaponRes_Base>(DynamicLoadObject("WWeapons_Res.wWeaponRes_Special_Melee", class'Class'));
        }
        // End:0x318
        else
        {
            ...
            if(class<wDamageAirStrike>(DamageType) != none)
            {
                ...
                {
                    resClass = class<wWeaponRes_Base>(DynamicLoadObject("WWeapons_Res.wWeaponRes_PinpointBomb", class'Class'));
                }
                // End:0x200
                else
                {
                    resClass = class<wWeaponRes_Base>(DynamicLoadObject("WWeapons_Res.wWeaponRes_Special_AirStrike", class'Class'));
                }
            }
            // End:0x318
            else
            {
                ...
                {
                    resClass = class<wWeaponRes_Base>(DynamicLoadObject("WWeapons_Res.wWeaponRes_Special_Helicopter", class'Class'));
                }
                // End:0x318
                else
                {
                    ...
                    {
                        resClass = class<wWeaponRes_Base>(DynamicLoadObject("WWeapons_Res.wWeaponRes_Special_Fell", class'Class'));
                    }
                    // End:0x318
                    else
                    {
                        ...
                        {
                            resClass = class<wWeaponRes_Base>(DynamicLoadObject("WWeapons_Res.wWeaponRes_Special_StepOn", class'Class'));
                        }
                        // End:0x318
                        else
                        {
        ...
        if(resClass != none)
        {
            Item.Image = Material(DynamicLoadObject(resClass.default.szIcon_Kill, class'Material'));
...
{
    // End:0x16
    if(Item.DamageType == class'Suicided')
    {
        return;
    }
    // End:0x60
...
function UpdateCache(Canvas C)
{
    ...
    if(lp1 < KillMessages.Length)
    {
        ...
        if(needCaching)
        {
            ...
            {
                KillMessages[lp1].CacheKillerNameWidth = 0.0;
            }
            // End:0x187
            else
            {
            ...
            {
                KillMessages[lp1].CacheVictimNameWidth = 0.0;
            }
            // End:0x205
            else
            {
            ...
            {
                KillMessages[lp1].CacheImageWidth = 32.0;
                KillMessages[lp1].CacheImageHeight = 32.0;
            }
            // End:0x284
            else
            {
                KillMessages[lp1].CacheImageWidth = 99.0 * _rX;
                KillMessages[lp1].CacheImageHeight = 25.0 * _rY;
            }
            ...
            KillMessages[lp1].CacheASImageWidth = 30.76920 * _rX;
            KillMessages[lp1].CacheASImageHeight = 25.0 * _rY;
            KillMessages[lp1].CacheHSImageWidth = 30.76920 * _rX;
            KillMessages[lp1].CacheHSImageHeight = 25.0 * _rY;
            KillMessages[lp1].CacheKSImageWidth = 99.0 * _rX;
            KillMessages[lp1].CacheKSImageHeight = 25.0 * _rY;
            // End:0x599
    ...
    if(lp1 < KillMessages.Length)
    {
        ...
        if(KillMessages[lp1].Image != none)
        {
            ...
            if(KillMessages[lp1].IsAimShot)
            {
                ...
                C.DrawColor = C.MakeColor(byte(255), byte(255), byte(255), byte(255));
                C.DrawTile(Icon_OptionalKillInfo, KillMessages[lp1].CacheASImageWidth, KillMessages[lp1].CacheASImageHeight, float(Icon_HeadShot.X), float(Icon_HeadShot.Y), float(Icon_HeadShot.W), float(Icon_HeadShot.H));
            }
            // End:0xb4e
            if(KillMessages[lp1].IsHeadShot)
            {
                C.SetPos(KillMessages[lp1].CacheHSImageWidth, CurrentY);
                C.DrawColor = C.MakeColor(byte(255), byte(255), byte(255), byte(255));
                C.DrawTile(Icon_OptionalKillInfo, KillMessages[lp1].CacheHSImageWidth, KillMessages[lp1].CacheHSImageHeight, float(Icon_HeadShot.X), float(Icon_HeadShot.Y), float(Icon_HeadShot.W), float(Icon_HeadShot.H));
            }
            // End:0xc6e
            if(KillMessages[lp1].NumKillSuccession > 1)
            {
                ...
                C.DrawColor = C.MakeColor(byte(255), byte(255), byte(255), byte(255));
                C.DrawTile(Icon_OptionalKillInfo, KillMessages[lp1].CacheKSImageWidth, KillMessages[lp1].CacheKSImageHeight, float(Icon_KillSuccession[KillMessages[lp1].NumKillSuccession - 2].X), float(Icon_KillSuccession[KillMessages[lp1].NumKillSuccession - 2].Y), float(Icon_KillSuccession[KillMessages[lp1].NumKillSuccession - 2].W), float(Icon_KillSuccession[KillMessages[lp1].NumKillSuccession - 2].H));
            }
        }
        // End:0xd95
        if(!KillMessages[lp1].NoVictimName)
...
defaultproperties
{
    SpriteWeaponAirStrike=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_WP_ETC_TargetIndicator',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=32,Y2=35),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponAR=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_WP_AR_AK47',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=58,Y2=19),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponFlameThrower=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_WP_HW_M2B',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=63,Y2=31),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponGR=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_WP_GR_Frag_A',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=21,Y2=25),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponHeadshot=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_Head_Shot',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=27,Y2=28),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponMG=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_WP_HW_M249',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=34,Y2=26),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponPistol=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_WP_PS_Glock17',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=27,Y2=20),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponRPG=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_WP_HW_RPG7',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=57,Y2=15),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponSMG=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_WP_SMG_MP5',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=51,Y2=21),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponSR=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_WP_SR_CheyTacLRRS',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=57,Y2=16),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponMelee=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_Melee_Attack',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponHelicopter=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_Helicopter',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponUnknown=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_Carblast',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=34,Y2=26),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponHelicopterKill=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_Helicopter_down',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponFell=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_Fall',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpriteWeaponStepOn=(WidgetTexture=Texture'Warfare_UI_Item.KillIcon.Item_Kill_Step_On',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=31,Y2=31),TextureScale=0.650,DrawPivot=8,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    MessageDuration=15.0
    MaxMessages=5
    FontSize=9
    KillMessageLineSpacing=3.0
    MarginXFromRight=0.020
    MarginYFromTop=0.020
    ShadowX=1
    ShadowY=1
    ...
    Icon_OptionalKillInfo=Texture'Warfare_UI_Item.KillIcon.Item_killIcon'
}