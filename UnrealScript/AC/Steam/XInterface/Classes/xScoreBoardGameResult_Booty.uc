 ...
 * Path XInterface\Classes\xScoreBoardGameResult_Booty.uc
 * Package Imports:
 *	XInterface
 *	Engine
 *	Core
...
defaultproperties
{
    SpBG=(WidgetTexture=Texture'Warfare_UI.HUD_Result.result_1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=823,Y2=696),TextureScale=0.650,DrawPivot=0,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    LogoImageX=0.040
    LogoImageY=0.0030
    LogoImageWidth=0.250
    LogoImageHeight=0.0820
    TrophyBGImage=Texture'Warfare_UI.HUD_Trophy.hud_etc_trophy_pic'
    TrophyBGBeginX=0.3860
    TrophyBGBeginY=0.2760
    TrophyBGWidth=0.250
    TrophyBGHeight=0.3330
    SpBootyGetTextImage=(WidgetTexture=Texture'Warfare_UI.HUD_Trophy.hud_etc_trophy_typo',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=128,Y2=32),TextureScale=0.63630,DrawPivot=0,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpBootyGetTextBeginX=0.4440
    SpBootyGetTextBeginY=0.3830
    SpWeaponBGImage=(WidgetTexture=Texture'Warfare_UI.Common_1.sto_item_w',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=256,Y2=128),TextureScale=0.63630,DrawPivot=0,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpWeaponBGTileImage=(WidgetTexture=Texture'Warfare_UI.Common_1.sto_item_w_bg',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=8,Y2=8),TextureScale=0.63630,DrawPivot=0,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpWeaponBGBeginX=0.3960
    SpWeaponBGBeginY=0.4570
    SpWeaponBGWidth=0.2080
    SpWeaponBGHeight=0.0950
    SpNickBGImage=(WidgetTexture=Texture'Warfare_UI.HUD_Trophy.hud_etc_trophy_typo_ba',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=256,Y2=64),TextureScale=0.63630,DrawPivot=0,PosX=0.0,PosY=0.0,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    SpNickBGBeginX=0.3960
    SpNickBGBeginY=0.560
    BGBeginX=0.0986330
    BGBeginY=0.0299480
    BGWidth=0.815430
    BGHeight=0.743490
    ControlBeginY=0.9023440
    ControlWidth=1.0
    ControlHeight=0.0833330
    TeamBeginX=0.1113280
    ...
    TeamMemberNicknameBeginX=0.1855470
    TeamMemberNicknameWidth=0.1201170
    TeamMemberClanBeginX=0.3378910
    TeamMemberClanWidth=0.0947270
    TeamMemberScoreBeginX=0.4384770
    TeamMemberScoreWidth=0.0400390
    TeamMemberKillBeginX=0.4843750
    TeamMemberKillWidth=0.0253910
    TeamMemberAssistBeginX=0.5156250
    TeamMemberAssistWidth=0.0419920
    TeamMemberDeathBeginX=0.5644530
    TeamMemberDeathWidth=0.0400390
    TeamMemberExpBeginX=0.6093750
    TeamMemberExpWidth=0.0859380
    TeamMemberPointBeginX=0.7001950
    TeamMemberPointWidth=0.0859380
    TeamMemberBeginY=0.1263020
    TeamMemberHeight=0.0286460
    TeamMemberHeightOffset=0.0338540
    ...
    BootyWeaponBeginX=0.3750
    BootyWeaponBeginY=0.4630
    BootyWeaponWidth=0.250
    BootyWeaponHeight=0.0830
    BootyGetUserNameBeginX=0.3960
    BootyGetUserNameBeginY=0.560
    BootyGetUserNameWidth=0.2080
    BootyGetUserNameHeight=0.0370
    BootyItemNameBeginX=0.4010
    BootyItemNameBeginY=0.470
    BootyDisplayFonsSize=0.013030
    strBootyGet="No one has taken the loot."
    BootyWeaponId=-1
    DefaultFontColor=(R=255,G=255,B=255,A=255)
    BootyPartsBeginX=0.5546880
    BootyPartsBeginY=0.4609380
    BootyPartsGapY=0.0351560
}