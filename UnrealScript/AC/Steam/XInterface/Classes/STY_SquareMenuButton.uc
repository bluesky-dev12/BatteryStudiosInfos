 ...
 * Path XInterface\Classes\STY_SquareMenuButton.uc
 * Package Imports:
 *	XInterface
 *	Core
 *
 * 
 *******************************************************************************/
class STY_SquareMenuButton extends STY_SquareButton
    instanced;

defaultproperties
{
    KeyName="SquareMenuButton"
    AlternateKeyName[1]="MedHeader"
