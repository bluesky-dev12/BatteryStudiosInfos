 ...
 * Path Engine\Classes\wCharacterManager.uc
 * Package Imports:
 *	Engine
 *	Core
 *
...
function LoadCacheMoveParam()
{
    ...
    MyPlayer.SprintSpeed = 570.0;
    MyPlayer.RunSpeed = 370.0;
    MyPlayer.CrouchSpeed = 252.0;
    MyPlayer.PronedSpeed = 100.0;
    MyPlayer.AimRunSpeed = 180.0;
    MyPlayer.AimCrouchSpeed = 120.0;
    MyPlayer.F_DiagmoveRatio = 0.90;
    MyPlayer.SideMoveRatio = 0.90;
    MyPlayer.B_DiagmoveRatio = 0.90;
    MyPlayer.BackMoveRatio = 0.90;
    MyPlayer.AccelRate = 1200.0;
    MyPlayer.JumpMaxAcc = 560.0;
    MyPlayer.JumpMinAcc = 300.0;
    MyPlayer.JumpReduceRate = 0.0;
    MyPlayer.JumpRecoverRate = 200.0;
    MyPlayer.Land_Dropspeed_Rate = 1.0;
    MyPlayer.ProneCam_MaxPicth = 10000.0;
    MyPlayer.ProneCam_MaxYaw = 10000.0;
    MyPlayer.ProneCam_RotSpeed = 10.0;
    MyPlayer.Stm_MaxTime = 8.0;
    MyPlayer.Stm_Delay_Stand = 0.0;
    MyPlayer.Stm_Delay_Crouch = 0.0;
    MyPlayer.Stm_Delay_Hit = 0.0;
...
event InitMyPlayer()
{
    ...
    if(MyPlayer == none)
    {
        MyPlayer = new class'wMyPlayerStatus';
    }
}
...
event AddBasePlayers()
{
    ...
    BasePlayers[i].Inven = new class'wInventory';
    BasePlayers[i].Skills = new class'wSkills';
}
