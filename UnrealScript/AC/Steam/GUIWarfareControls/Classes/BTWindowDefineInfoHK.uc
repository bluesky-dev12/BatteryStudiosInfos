 ...
 * Path GUIWarfareControls\Classes\BTWindowDefineInfoHK.uc
 * Package Imports:
 *	GUIWarfareControls
 *	GUI2K4
 *	XInterface
...
function SetContentText_Instance(int Code, optional string arg0, optional string arg1, optional string arg2, optional string arg3)
{
    ...
    str_Msg = class'BTCustomDrawHK'.static.FormatString(strClientDefine[Code], arg0, arg1, arg2);
...
static function bool ShowInfo(GUIController con, int Code, optional string arg0, optional string arg1, optional string arg2)
{
    ...
    strMsg = class'BTCustomDrawHK'.static.FormatString(BTWindowDefineInfoHK(con.TopPage()).strClientDefine[Code], arg0, arg1, arg2);
    Split(strMsg, "|", arrStr);
