 ...
 * Path GUIWarfareControls\Classes\BTWindowUserPersonalInfo.uc
 * Package Imports:
 *	GUIWarfareControls
 *	GUI2K4
 *	XInterface
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    BackgroundPanel = NewLabelComponent(class'BTCustomDrawHK'.static.MakeFloatBox(fbBackgroundPanel.X1, fbBackgroundPanel.Y1 + float(24), fbBackgroundPanel.X2, fbBackgroundPanel.Y2), class'BTUIResourcePoolHK'.default.panel_1);
    fb = class'BTCustomDrawHK'.static.MakeFloatBox(fbBackgroundPanel.X1, fbBackgroundPanel.Y1 + float(24), fbBackgroundPanel.X2, fbBackgroundPanel.Y2);
    fbScrollBar = class'BTCustomDrawHK'.static.MakeFloatBox(fbBackgroundPanel.X2 - float(1) - float(20), fbBackgroundPanel.Y1 + float(1) + float(24), fbBackgroundPanel.X2 - float(1), fbBackgroundPanel.Y2 - float(1));
    ...
    if(i < 2)
    {
        fb = class'BTCustomDrawHK'.static.MakeFloatBox(fbBackgroundPanel.X1 + float(100 * i) + float(i), fbBackgroundPanel.Y1 - float(2), fbBackgroundPanel.X1 + float(100 * i + 1) + float(i), fbBackgroundPanel.Y1 + float(24));
...
defaultproperties
{
    ...
    strButtonTab[1]="Detail Info."
    TabControl=mTabControl
    fbBackgroundPanel=(X1=188.0,Y1=41.0,X2=836.0,Y2=691.0)
