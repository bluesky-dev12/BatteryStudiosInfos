 ...
 * Path GUIWarfareControls\Classes\BTACLMessengerChannelHKCN.uc
 * Package Imports:
 *	GUIWarfareControls
 *	XInterface
 *	Core
 ...
 *
 *******************************************************************************/
class BTACLMessengerChannelHKCN extends BTACLMessengerChannelHK
    editinlinenew
    instanced;
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    super(BTACLMessengerCommon).InitComponent(MyController, myOwner);
