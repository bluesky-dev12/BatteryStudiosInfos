 ...
 * Path GUIWarfareControls\Classes\BTTPCWMessengerHK.uc
 * Package Imports:
 *	GUIWarfareControls
 *	XInterface
 *	Core
...
function AddFriendUser(string UserName, int ClanMark, int ClanBG, int ClanBL, string ClanName, int Level, string ServerName, string ServerIP, int serverPort, int CurPos, int ChannelNum, string ChannelNickName, int RoomNum, int ClanGrade, int IsCombat, int ClanWinCnt, int ClanLoseCnt, byte IsLookForClan, int ClanLevel, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3)
{
    ...
    switch(CurPos)
    {
        ...
        default:
            ...
            row.DataPerColumn[0].tempValue = ClanGrade;
            row.DataPerColumn[6].strValue = class'BTCustomDrawHK'.static.FormatString(strWinLose, string(ClanWinCnt), string(ClanLoseCnt));
            row.DataPerColumn[1].tempValue = ClanWinCnt;
            row.DataPerColumn[2].tempValue = ClanLoseCnt;
...
function AddClanUser(string UserName, int Level, string ServerName, string ServerIP, int serverPort, int CurPos, int ChannelNum, string ChannelNickName, int RoomNum, int ClanGrade, int IsCombat, int ClanWinCnt, int ClanLoseCnt, string ClanSelfIntro, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3)
{
    ...
    switch(CurPos)
    {
        ...
        default:
            ...
            row.DataPerColumn[5].strValue = class'BTCustomDrawHK'.static.FormatString(strWinLose, string(ClanWinCnt), string(ClanLoseCnt));
...
function AddPCBangUser(string UserName, int ClanMark, int ClanBG, int ClanBL, string ClanName, int Level, string ServerName, string ServerIP, int serverPort, int CurPos, int ChannelNum, string ChannelNickName, int RoomNum, int ClanGrade, int ClanWin, int ClanLose, byte IsLookForClan, int IsCombat, int ClanLevel, int LevelMarkID, int TitleMarkID, int Reserved1, int Reserved2, int Reserved3)
{
    ...
    switch(CurPos)
    {
        ...
        default:
            ...
            row.DataPerColumn[6].Image = GameMgr.GetClanMark32(ClanBL);
            row.DataPerColumn[0].tempValue = ClanGrade;
            row.DataPerColumn[6].strValue = class'BTCustomDrawHK'.static.FormatString(strWinLose, string(ClanWin), string(ClanLose));
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    if(i < 4)
    {
        ...
        if(i == 2)
        {
            serverACL = new class'BTACLCWMessengerChannelHK';
        ...
        else
        {
            ...
            if(i == 1)
            {
                serverACL = new class'BTACLCWMessengerFriendHK';
            }
            // End:0x4fd
            else
            {
                ...
                if(i == 0)
                {
                    serverACL = new class'BTACLCWMessengerClanHK';
                }
                // End:0x4fd
                else
                {
                    ...
                    if(i == 3)
                    {
                        serverACL = new class'BTACLCWMessengerPCBangHK';
                    }
                }
            }
        }
    ...
    CMMsg[2] = new class'BTCMMessengerChannelHK';
    CMMsg[1] = new class'BTCMMessengerFriendHK';
    CMMsg[0] = new class'BTCMMessengerClanHK';
...
defaultproperties
{
    begin object name=mBackgroundImage class=BTStretchedImageHK
        ...
        WinHeight=1.0
    object end
    // Reference: BTStretchedImageHK'BTTPCWMessengerHK.mBackgroundImage'
    BackgroundImage=mBackgroundImage
    begin object n[0]ame=mListBoundImage class=BTStretchedImageHK
        Image=Texture'Warfare_GP_UI_UI.Common.panel_1'
    object end
    // Reference: BTStretchedImageHK'BTTPCWMessengerHK.mListBoundImage'
    ListBoundImage=mListBoundImage
    begin object name=mListBoundImage3 class=BTStretchedImageHK
        Image=Texture'Warfare_GP_UI_UI.Common.panel_2'
    object end
    // Reference: BTStretchedImageHK'BTTPCWMessengerHK.mListBoundImage3'
    ...
    object end
    // Reference: TabControlMocker'BTTPCWMessengerHK.mTabControl'
