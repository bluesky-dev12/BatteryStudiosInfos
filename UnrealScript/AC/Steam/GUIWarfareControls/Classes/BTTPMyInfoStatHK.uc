 ...
 * Path GUIWarfareControls\Classes\BTTPMyInfoStatHK.uc
 * Package Imports:
 *	GUIWarfareControls
 *	XInterface
 *	Core
...
function InitializeContent()
{
    ...
    if(i < Content.Length)
    {
        Content[i] = NewComponent(new class'BTOwnerDrawTextArrayHK', class'BTCustomDrawHK'.static.MakeEmptyBox(), 0.780);
        ++ i;
        // This is an implied JumpToken; Continue!
        goto J0x07;
    }
...
defaultproperties
{
    strLabel[0]="Highest Kill Streak"
    strLabel[1]="Highest Score"
    strLabel[2]="Highest Kills"
    strLabel[3]="Highest Assists"
    strLabel[4]="3-Kill Streak"
    strLabel[5]="5-Kill Streak"
    strLabel[6]="7-Kill Streak"
    strLabel[7]="10-Kill Streak"
    strLabel[8]="15-Kill Streak"
    strLabel[9]="Rifle Kills"
    strLabel[10]="SMG Kills"
    strLabel[11]="Sniper Kills"
    strLabel[12]="Sub Weapon Kills"
    strLabel[13]="Melee Attack Kills"
    strLabel[14]="Grenade Kills"
    strLabel[15]="Flash Bang Kills"
    strLabel[16]="Stomp Kills"
    strLabel[17]="AT-4 Kills"
    strLabel[18]="Machine Gun Kills"
    strLabel[19]="Flamethrower Kills"
    strLabel[20]="RPG-7 Kills"
    strLabel[21]="C4 Kills"
    strLabel[22]="Incendiary Kills"
    strLabel[23]="Burst-grenade Kills"
    strLabel[24]="Chopper Kills"
    strLabel[25]="Artillery Kills"
    strLabel[26]="Chopper Destroy"
    strLabel[27]="Dominate"
    strLabel[28]="Bombs Planted"
    strLabel[29]="Bombs Defused"
    ItemWidth=468
    LabelWidth=114
