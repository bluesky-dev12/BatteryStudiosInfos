 ...
 * Path GUIWarfareControls\Classes\BTWindowItemBuyTerm.uc
 * Package Imports:
 *	GUIWarfareControls
 *	GUI2K4
 *	XInterface
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    imgItemSelectBack = new class'BTOwnerDrawImageHK';
    imgItemSelectBack.bUseAWinPos = true;
    imgItemSelectBack.AWinPos = fbBackgroundImage;
    imgItemSelectBack.BackgroundImage = class'BTUIResourcePoolHK'.default.img_timeitempopup_info;
    ...
    if(i < 4)
    {
        lbBriefingInfo[i] = new class'BTOwnerDrawImageHK';
        ...
        lbBriefingInfo[i].SetFontColorAll(class'BTCustomDrawHK'.static.MakeColorRGB(byte(255), 192, 0));
...
{
    OptionDay=1
    fbItemBoxView=(X1=436.0,Y1=289.0,X2=589.0,Y2=343.0)
    fbBriefingInfo[0]=(X1=323.0,Y1=198.0,X2=701.0,Y2=211.0)
    fbBriefingInfo[1]=(X1=323.0,Y1=213.0,X2=701.0,Y2=226.0)
    fbBriefingInfo[2]=(X1=323.0,Y1=228.0,X2=701.0,Y2=241.0)
    fbBriefingInfo[3]=(X1=323.0,Y1=243.0,X2=701.0,Y2=256.0)
    ...
    fbItemName=(X1=403.0,Y1=279.0,X2=621.0,Y2=294.0)
    fbBackgroundImage=(X1=297.0,Y1=159.0,X2=727.0,Y2=472.0)
    fbTopLine=(X1=403.0,Y1=165.0,X2=621.0,Y2=180.0)
    fbBottomLine=(X1=317.0,Y1=441.0,X2=707.0,Y2=484.0)
    fbButtonOK=(X1=378.0,Y1=419.0,X2=502.0,Y2=456.0)
    fbButtonCancel=(X1=522.0,Y1=419.0,X2=646.0,Y2=456.0)
    strOK="Buy Item"
