 ...
 * Path GUIWarfareControls\Classes\BTWindowCreateClanMarkHK.uc
 * Package Imports:
 *	GUIWarfareControls
 *	GUI2K4
 *	XInterface
...
class BTWindowCreateClanMarkHK extends BTWindowHK
    dependson(BTTPClanMarkListHK)
    dependson(BTClanMarkImageListHK)
    dependson(BTClanMarkHK)
    dependson(BTROCreateClanMarkHK)
    dependson(BTLabelClanMarkHK)
    editinlinenew
    instanced;
...
var() /*0x00000000-0x80000000*/ databinding editinlinenotify FloatBox fbPrevClanMarkBig;
var() /*0x00000000-0x80000000*/ databinding editinlinenotify FloatBox fbNewClanMarkBig;
...
var() /*0x00000000-0x80000000*/ databinding editinlinenotify FloatBox fbButtonIsExist;
var localized string strButtonIsExist;
var export editinline BTOwnerDrawCaptionButtonHK ButtonIsExist;
var() /*0x00000000-0x80000000*/ databinding editinlinenotify FloatBox fbFT_Button[6];
var() /*0x00000000-0x80000000*/ databinding editinlinenotify FloatBox fbFT_ClanMarkList;
...
var() /*0x00000000-0x80000000*/ databinding editinlinenotify FloatBox fbST_Button[6];
var() /*0x00000000-0x80000000*/ databinding editinlinenotify FloatBox fbST_ClanMarkList;
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    Label[1].BackgroundImage = class'BTUIResourcePoolHK'.default.empty;
    Label[2].BackgroundImage = class'BTUIResourcePoolHK'.default.empty;
    Label[3].BackgroundImage = class'BTUIResourcePoolHK'.default.img_make_clan;
    Label[4].BackgroundImage = class'BTUIResourcePoolHK'.default.panel_1;
    Label[5].BackgroundImage = class'BTUIResourcePoolHK'.default.butt_right_n;
    Label[6].BackgroundImage = class'BTUIResourcePoolHK'.default.panel_1;
    Label[7].BackgroundImage = class'BTUIResourcePoolHK'.default.panel_1;
    Label[8].BackgroundImage = class'BTUIResourcePoolHK'.default.img_panel_2;
    Label[9].BackgroundImage = class'BTUIResourcePoolHK'.default.empty;
    Label[10].BackgroundImage = class'BTUIResourcePoolHK'.default.empty;
    Label[11].BackgroundImage = class'BTUIResourcePoolHK'.default.empty;
    Label[1].SetFontSizeAll(11);
    Label[2].SetFontSizeAll(11);
    Label[9].SetFontSizeAll(9);
    Label[9].SetFontColorAll(class'BTUIColorPoolHK'.static.ChatSystem());
    Label[10].SetFontSizeAll(9);
    Label[10].SetFontColorAll(class'BTUIColorPoolHK'.static.ChatSystem());
    Label[11].SetFontSizeAll(9);
    Label[11].SetFontColorAll(class'BTUIColorPoolHK'.static.ChatSystem());
    PrevClanMark[0] = BTLabelClanMarkHK(NewComponent(new class'BTLabelClanMarkHK', fbPrevClanMarkBig));
    NewClanMark[0] = BTClanMarkHK(NewComponent(new class'BTClanMarkHK', fbLabel[4]));
    PrevClanMark[1] = BTLabelClanMarkHK(NewComponent(new class'BTLabelClanMarkHK', fbLabel[6]));
    NewClanMark[1] = BTClanMarkHK(NewComponent(new class'BTClanMarkHK', fbLabel[7]));
    ...
    FT_Group = ButtonGroups(NewComponent(new class'ButtonGroups', class'BTCustomDrawHK'.static.MakeEmptyBox()));
    FT_Group.bTabControlMode = true;
    ST_Group = ButtonGroups(NewComponent(new class'ButtonGroups', class'BTCustomDrawHK'.static.MakeEmptyBox()));
    ...
    FT_ClanMarkList = BTTPClanMarkListHK(NewComponent(new class'BTTPClanMarkListHK', fbFT_ClanMarkList));
    ST_ClanMarkList = BTTPClanMarkListHK(NewComponent(new class'BTTPClanMarkListHK', fbST_ClanMarkList));
...
defaultproperties
{
    fbLabel[0]=(X1=673.0,Y1=210.0,X2=905.0,Y2=613.0)
    fbLabel[1]=(X1=707.0,Y1=222.0,X2=766.0,Y2=240.0)
    fbLabel[2]=(X1=812.0,Y1=222.0,X2=871.0,Y2=240.0)
    fbLabel[3]=(X1=694.0,Y1=247.0,X2=778.0,Y2=331.0)
    fbLabel[4]=(X1=799.0,Y1=247.0,X2=883.0,Y2=331.0)
    fbLabel[5]=(X1=782.0,Y1=272.0,X2=797.0,Y2=308.0)
    fbLabel[6]=(X1=694.0,Y1=340.0,X2=725.0,Y2=371.0)
    fbLabel[7]=(X1=799.0,Y1=340.0,X2=830.0,Y2=371.0)
    fbLabel[8]=(X1=683.0,Y1=383.0,X2=895.0,Y2=562.0)
    fbLabel[9]=(X1=706.0,Y1=506.0,X2=872.0,Y2=520.0)
    fbLabel[10]=(X1=706.0,Y1=522.0,X2=872.0,Y2=536.0)
    fbLabel[11]=(X1=706.0,Y1=538.0,X2=872.0,Y2=552.0)
    fbPrevClanMarkBig=(X1=704.0,Y1=257.0,X2=768.0,Y2=321.0)
    fbNewClanMarkBig=(X1=809.0,Y1=257.0,X2=873.0,Y2=321.0)
    strLabel[1]="Previous"
    strLabel[2]="New"
    ...
    fbButtonIsExist=(X1=692.0,Y1=393.0,X2=886.0,Y2=425.0)
    strButtonIsExist="Duplicate Check"
    fbFT_Button[0]=(X1=118.0,Y1=185.0,X2=208.0,Y2=210.0)
    fbFT_Button[1]=(X1=209.0,Y1=185.0,X2=299.0,Y2=210.0)
    fbFT_Button[2]=(X1=300.0,Y1=185.0,X2=390.0,Y2=210.0)
    fbFT_Button[3]=(X1=391.0,Y1=185.0,X2=481.0,Y2=210.0)
    fbFT_Button[4]=(X1=482.0,Y1=185.0,X2=572.0,Y2=210.0)
    fbFT_Button[5]=(X1=573.0,Y1=185.0,X2=663.0,Y2=210.0)
    fbFT_ClanMarkList=(X1=118.0,Y1=210.0,X2=667.0,Y2=392.0)
    strFT_Button[0]="All"
    ...
    strFT_Button[4]="NEW"
    strFT_Button[5]="Cool"
    fbST_Button[0]=(X1=118.0,Y1=402.0,X2=208.0,Y2=427.0)
    fbST_Button[1]=(X1=209.0,Y1=402.0,X2=299.0,Y2=427.0)
    fbST_Button[2]=(X1=300.0,Y1=402.0,X2=390.0,Y2=427.0)
    fbST_Button[3]=(X1=391.0,Y1=402.0,X2=481.0,Y2=427.0)
    fbST_Button[4]=(X1=482.0,Y1=402.0,X2=572.0,Y2=427.0)
    fbST_Button[5]=(X1=573.0,Y1=402.0,X2=663.0,Y2=427.0)
    fbST_ClanMarkList=(X1=118.0,Y1=427.0,X2=667.0,Y2=609.0)
    strST_Button[0]="All"
    ...
    strST_Button[4]="NEW"
    strST_Button[5]="Cool"
    fbBackgroundImage=(X1=88.0,Y1=125.0,X2=934.0,Y2=639.0)
    fbTopLine=(X1=108.0,Y1=144.0,X2=915.0,Y2=170.0)
    fbButtonOK=(X1=692.0,Y1=433.0,X2=886.0,Y2=497.0)
    fbButtonCancel=(X1=683.0,Y1=571.0,X2=895.0,Y2=603.0)
