 ...
 * Path GUIWarfareControls\Classes\BTWindowDefineARHK.uc
 * Package Imports:
 *	GUIWarfareControls
 *	GUI2K4
 *	XInterface
...
class BTWindowDefineARHK extends BTWindowAutoResizeHK
    dependson(BTWindowAutoResizeHK)
    editinlinenew
    instanced;
...
function bool SetContentText_Instance(int Code, optional string arg0, optional string arg1, optional string arg2, optional string arg3)
{
    ...
    str_Msg = class'BTCustomDrawHK'.static.FormatString(strClientDefine[Code], arg0, arg1, arg2, arg3);
...
static function bool SetContentText(GUIController con, int Code, optional string arg0, optional string arg1, optional string arg2, optional string arg3)
{
    ...
    if(BTWindow != none)
    {
        strMsg = class'BTCustomDrawHK'.static.FormatString(BTWindowDefineARHK(con.TopPage()).strClientDefine[Code], arg0, arg1, arg2, arg3);
        Split(strMsg, "|", arrStr);
...
defaultproperties
{
    ...
    strClientTitle[70]="Standard PC Caf?"
    strClientTitle[71]="Gold PC Caf?"
    strClientTitle[72]="Premium PC Caf? "
    ...
    strClientDefine[70]="You are currently playing at your main PC Caf? %0. <10> <10>  Main PC Caf? benefits<9>       - Bonus 10%  EXP from battle<9>       - Bonus 10% Points from battle||Ok"
    strClientDefine[71]="You are currently playing at your main PC Caf? %0. <10> <10>  Main PC Caf? benefits<9>       - Bonus 10%  EXP from battle<9>       - Bonus 10% Points from battle||Ok"
    strClientDefine[72]="You are currently playing at your main PC Caf? %0. <10> <10>  Main PC Caf? benefits<9>       - Bonus 10%  EXP from battle<9>       - Bonus 10% Points from battle||Ok"
}