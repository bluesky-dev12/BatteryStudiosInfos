 ...
 * Path GUIWarfareControls\Classes\BTWindowDefineSelectHK.uc
 * Package Imports:
 *	GUIWarfareControls
 *	GUI2K4
 *	XInterface
...
static function bool ShowInfo(GUIController con, int Code, optional string arg0, optional string arg1, optional string arg2)
{
    ...
    strMsg = class'BTCustomDrawHK'.static.FormatString(BTWindowDefineSelectHK(con.TopPage()).strClientDefine[Code], arg0, arg1, arg2);
    Split(strMsg, "|", arrStr);
