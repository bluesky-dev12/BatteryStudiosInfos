 ...
 * Path GUIWarfareControls\Classes\BTWindowInviteFriend.uc
 * Package Imports:
 *	GUIWarfareControls
 *	GUI2K4
 *	XInterface
...
defaultproperties
{
    ...
    object end
    // Reference: BTOwnerDrawCaptionButtonHK'BTWindowInviteFriend.mButtonOK'
    ButtonOK=mButtonOK
    begin object name=mButtonCancel class=BTOwnerDrawCaptionButtonHK
        ...
        OnKeyEvent=InternalOnKeyEvent
    object end
    // Reference: BTOwnerDrawCaptionButtonHK'BTWindowInviteFriend.mButtonCancel'
    ...
    begin object name=mLabelDivider class=BTOwnerDrawImageHK
        ...
        OnRendered=Internal_OnRendered
    object end
    // Reference: BTOwnerDrawImageHK'BTWindowInviteFriend.mLabelDivider'
    ...
    begin object name=mLabelInviteMsg class=BTOwnerDrawImageHK
        ...
        OnRendered=Internal_OnRendered
    object end
    // Reference: BTOwnerDrawImageHK'BTWindowInviteFriend.mLabelInviteMsg'
    ...
    begin object name=mLabelSendMsg class=BTOwnerDrawImageHK
        ...
        OnRendered=Internal_OnRendered
    object end
    // Reference: BTOwnerDrawImageHK'BTWindowInviteFriend.mLabelSendMsg'
    ...
    begin object name=mLabelEditMsg class=BTOwnerDrawImageHK
        ...
        OnRendered=Internal_OnRendered
    object end
    // Reference: BTOwnerDrawImageHK'BTWindowInviteFriend.mLabelEditMsg'
    ...
    begin object name=mMultiLineEditMsg class=BTMultiLineEditBoxHK
        ...
        OnKeyEvent=InternalOnKeyEvent
    object end
    // Reference: BTMultiLineEditBoxHK'BTWindowInviteFriend.mMultiLineEditMsg'
