 ...
 * Path GUIWarfareControls\Classes\BTLabelTestHK.uc
 * Package Imports:
 *	GUIWarfareControls
 *	XInterface
 *	Core
        ...
        if(bStartShow)
        {
            switch(ShowPhase)
            {
                ...
                case 0:
                    ...
                    class'BTCustomDrawHK'.static.DrawImage(C, BackgroundImage, AWinPos.X1 - fWidthHalf, AWinPos.Y1 - fHeightHalf, AWinPos.X2 + fWidthHalf, AWinPos.Y2 + fHeightHalf);
