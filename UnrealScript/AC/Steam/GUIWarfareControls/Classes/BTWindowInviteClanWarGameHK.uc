 ...
 * Path GUIWarfareControls\Classes\BTWindowInviteClanWarGameHK.uc
 * Package Imports:
 *	GUIWarfareControls
 *	GUI2K4
 *	XInterface
 ...
 *
 *******************************************************************************/
class BTWindowInviteClanWarGameHK extends BTWindowHK
    editinlinenew
    instanced;
...
function bool Internal_OnPreDraw(Canvas C)
{
    ...
    {
        TcpChannel.sfAckClanMatch_RecvInviteCrew(2, InviterName);
        FadeOut(false, true);
        ElipsedTime = -99999.0;
    }
