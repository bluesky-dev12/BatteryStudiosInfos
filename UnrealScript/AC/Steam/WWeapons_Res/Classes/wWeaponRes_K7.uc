 ...
 * Path WWeapons_Res\Classes\wWeaponRes_K7.uc
 * Package Imports:
 *	WWeapons_Res
 *	Engine
 *	Core
 ...
 * 
 *******************************************************************************/
class wWeaponRes_K7 extends wWeaponRes_Base;
...
defaultproperties
{
    ...
    szIcon_HUD="Warfare_UI_Item.HUDIcon.Item_HUD_WP_SMG_K7"
    szIcon_Kill="Warfare_UI_Item.Item_killIcon"
    ibIcon_Kill=(X=128,Y=308,W=128,H=32)
    szType_DisplayAmmo="ammo50"
    sound_Fire=Sound'Warfare_Sound_Weapon.K7.weapon_K7_fire'
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.K7.weapon_K7_fire_s'
    sound_Fire_Silencer=Sound'Warfare_Sound_Weapon.K7.weapon_K7_fire'
    sound_Fire_Silencer_Stereo=Sound'Warfare_Sound_Weapon.K7.weapon_K7_fire_s'
    ...
    sound_Reload=Sound'Warfare_Sound_Weapon.K7.weapon_K7_reload'
    sound_ReloadEmpty=Sound'Warfare_Sound_Weapon.K7.weapon_K7_reload_empty'
    sound_Select=Sound'Warfare_Sound_Weapon.K7.weapon_K7_select'
    sound_Pickup=SoundGroup'Warfare_Sound_Char.GetItem.char_getitem_weapon'
    sound_Select_New=Sound'Warfare_Sound_Weapon.K7.weapon_K7_select_n'
}