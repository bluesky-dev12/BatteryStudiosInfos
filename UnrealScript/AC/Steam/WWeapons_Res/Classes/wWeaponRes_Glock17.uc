 ...
 * Path WWeapons_Res\Classes\wWeaponRes_Glock17.uc
 * Package Imports:
 *	WWeapons_Res
 *	Engine
 *	Core
 ...
 * 
 *******************************************************************************/
class wWeaponRes_Glock17 extends wWeaponRes_Base;
...
defaultproperties
{
    ...
    szIcon_HUD="Warfare_UI_Item.HUDIcon.Item_HUD_WP_PS_Glock17"
    szIcon_Kill="Warfare_UI_Item.Item_killIcon"
    ibIcon_Kill=(X=256,Y=36,W=128,H=32)
    szType_DisplayAmmo="ammo50"
    sound_Fire=Sound'Warfare_Sound_Weapon.glock17.weapon_glock17_fire'
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.glock17.weapon_glock17_fire_s'
    sound_Fire_Silencer=Sound'Warfare_Sound_Weapon.glock17.weapon_glock17_fire_silencer'
    sound_Fire_Silencer_Stereo=Sound'Warfare_Sound_Weapon.glock17.weapon_glock17_fire_silencer_s'
    ...
    sound_Reload=Sound'Warfare_Sound_Weapon.glock17.weapon_glock17_reload'
    sound_ReloadEmpty=Sound'Warfare_Sound_Weapon.glock17.weapon_glock17_reload_empty'
    sound_Select=Sound'Warfare_Sound_Weapon.glock17.weapon_glock17_select'
