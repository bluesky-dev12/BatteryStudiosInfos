 ...
 * Path WWeapons_Res\Classes\wWeaponRes_DesertEagle.uc
 * Package Imports:
 *	WWeapons_Res
 *	Engine
 *	Core
...
defaultproperties
{
    ...
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.DesertEagle.weapon_DesertEagle_fire_s'
    sound_Fire_Silencer=Sound'Warfare_Sound_Weapon.DesertEagle.weapon_DesertEagle_fire_silencer'
    sound_Fire_Silencer_Stereo=Sound'Warfare_Sound_Weapon.DesertEagle.weapon_DesertEagle_fire_silencer_s'
