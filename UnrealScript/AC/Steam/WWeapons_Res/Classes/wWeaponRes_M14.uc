 ...
 * Path WWeapons_Res\Classes\wWeaponRes_M14.uc
 * Package Imports:
 *	WWeapons_Res
 *	Engine
 *	Core
...
defaultproperties
{
    ...
    sound_Fire=Sound'Warfare_Sound_Weapon.M14.weapon_m14_fire'
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.M14.weapon_m14_fire_s'
    sound_Fire_Silencer=Sound'Warfare_Sound_Weapon.M14.weapon_m14_fire_silencer'
    sound_Fire_Silencer_Stereo=Sound'Warfare_Sound_Weapon.M14.weapon_m14_fire_silencer_s'
    ...
    sound_Reload=Sound'Warfare_Sound_Weapon.M14.weapon_m14_reload'
    sound_ReloadEmpty=Sound'Warfare_Sound_Weapon.M14.weapon_m14_reload_empty'
    sound_Select=Sound'Warfare_Sound_Weapon.M14.weapon_M14_select'
    sound_Pickup=SoundGroup'Warfare_Sound_Char.GetItem.char_getitem_weapon'
    sound_Select_New=Sound'Warfare_Sound_Weapon.M14.weapon_M14_select_n'
}