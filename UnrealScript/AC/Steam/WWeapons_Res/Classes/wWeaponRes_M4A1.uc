 ...
 * Path WWeapons_Res\Classes\wWeaponRes_M4A1.uc
 * Package Imports:
 *	WWeapons_Res
 *	Engine
 *	Core
 ...
 * 
 *******************************************************************************/
class wWeaponRes_M4A1 extends wWeaponRes_Base;
...
defaultproperties
{
    ...
    szIcon_HUD="Warfare_UI_Item.HUDIcon.Item_HUD_WP_AR_M4A1"
    szIcon_Kill="Warfare_UI_Item.Item_killIcon"
    ibIcon_Kill=(X=256,Y=206,W=128,H=32)
