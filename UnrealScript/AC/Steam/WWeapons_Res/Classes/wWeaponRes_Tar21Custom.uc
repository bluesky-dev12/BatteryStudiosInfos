 ...
 * Path WWeapons_Res\Classes\wWeaponRes_Tar21Custom.uc
 * Package Imports:
 *	WWeapons_Res
 *	Engine
 *	Core
 ...
 * 
 *******************************************************************************/
class wWeaponRes_Tar21Custom extends wWeaponRes_Base;
...
defaultproperties
{
    ...
    szIcon_HUD="Warfare_UI_Item.HUDIcon.Item_HUD_WP_AR_TAR21Custom"
    ...
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.TAR-21.weapon_TAR-21_fire_s'
    sound_Fire_Silencer=Sound'Warfare_Sound_Weapon.TAR-21.weapon_TAR-21_fire_silencer'
    sound_Fire_Silencer_Stereo=Sound'Warfare_Sound_Weapon.TAR-21.weapon_TAR-21_fire_silencer_s'
