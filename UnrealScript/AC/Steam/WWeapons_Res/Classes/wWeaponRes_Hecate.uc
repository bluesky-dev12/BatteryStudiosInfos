 ...
 * Path WWeapons_Res\Classes\wWeaponRes_Hecate.uc
 * Package Imports:
 *	WWeapons_Res
 *	Engine
 *	Core
 ...
 * 
 *******************************************************************************/
class wWeaponRes_Hecate extends wWeaponRes_Base;
...
defaultproperties
{
    ...
    szIcon_HUD="Warfare_UI_Item.HUDIcon.Item_HUD_WP_SR_Hecate"
    szIcon_Kill="Warfare_UI_Item.Item_killIcon"
    ibIcon_Kill=(X=256,Y=138,W=128,H=32)
    szType_DisplayAmmo="ammoSniper"
    sound_Fire=Sound'Warfare_Sound_Weapon.Hecate.weapon_hecate_fire'
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.Hecate.weapon_hecate_fire_s'
    ...
    sound_Reload=Sound'Warfare_Sound_Weapon.Hecate.weapon_hecate_reload'
    sound_ReloadEmpty=Sound'Warfare_Sound_Weapon.Hecate.weapon_hecate_reload_empty'
    sound_Select=Sound'Warfare_Sound_Weapon.Hecate.weapon_hecate_select'
    sound_Pickup=SoundGroup'Warfare_Sound_Char.GetItem.char_getitem_weapon'
    sound_Select_New=Sound'Warfare_Sound_Weapon.Hecate.weapon_hecate_select_n'
}