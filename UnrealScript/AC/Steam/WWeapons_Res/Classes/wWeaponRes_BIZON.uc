 ...
 * Path WWeapons_Res\Classes\wWeaponRes_BIZON.uc
 * Package Imports:
 *	WWeapons_Res
 *	Engine
 *	Core
 ...
 * 
 *******************************************************************************/
class wWeaponRes_BIZON extends wWeaponRes_Base;
...
defaultproperties
{
    ...
    ibIcon_Kill=(X=0,Y=852,W=128,H=32)
    szType_DisplayAmmo="ammo50"
    sound_Fire=Sound'Warfare_Sound_Weapon.Bizon.weapon_Bizon_fire'
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.Bizon.weapon_Bizon_fire_s'
    sound_Fire_Silencer=Sound'Warfare_Sound_Weapon.Bizon.weapon_Bizon_fire_silencer'
    sound_Fire_Silencer_Stereo=Sound'Warfare_Sound_Weapon.Bizon.weapon_Bizon_fire_silencer_s'
    ...
    sound_Reload=Sound'Warfare_Sound_Weapon.Bizon.weapon_Bizon_reload'
    sound_ReloadEmpty=Sound'Warfare_Sound_Weapon.Bizon.weapon_Bizon_reload_empty'
    sound_Select=Sound'Warfare_Sound_Weapon.Bizon.weapon_Bizon_select'
    sound_Pickup=SoundGroup'Warfare_Sound_Char.GetItem.char_getitem_weapon'
    sound_Select_New=Sound'Warfare_Sound_Weapon.Bizon.weapon_Bizon_select_n'
}