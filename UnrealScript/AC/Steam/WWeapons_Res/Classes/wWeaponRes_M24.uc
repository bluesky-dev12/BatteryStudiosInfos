 ...
 * Path WWeapons_Res\Classes\wWeaponRes_M24.uc
 * Package Imports:
 *	WWeapons_Res
 *	Engine
 *	Core
...
defaultproperties
{
    ...
    sound_Fire=Sound'Warfare_Sound_Weapon.M24.weapon_m24_fire'
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.M24.weapon_m24_fire_s'
    ...
    sound_Reload=Sound'Warfare_Sound_Weapon.M24.weapon_m24_reload_loop'
    sound_ReloadBegin=Sound'Warfare_Sound_Weapon.M24.weapon_m24_reload_start'
    sound_ReloadEnd=Sound'Warfare_Sound_Weapon.M24.weapon_m24_reload_end'
    sound_Select=Sound'Warfare_Sound_Weapon.M24.weapon_M24_select'
    sound_Pickup=SoundGroup'Warfare_Sound_Char.GetItem.char_getitem_weapon'
    sound_Select_New=Sound'Warfare_Sound_Weapon.M24.weapon_M24_select_n'
}