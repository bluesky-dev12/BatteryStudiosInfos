 ...
 * Path WWeapons_Res\Classes\wWeaponRes_M1014.uc
 * Package Imports:
 *	WWeapons_Res
 *	Engine
 *	Core
 ...
 * 
 *******************************************************************************/
class wWeaponRes_M1014 extends wWeaponRes_Base;

defaultproperties
{
    szClass_Shell="Xeffects.ShellSpewer_Gage_Blue"
    szClass_Shell_3rd="Xeffects.ShellSpewer_Gage_Blue_3rd"
    fTracerPop=0.50
    ...
    ibIcon_Kill=(X=384,Y=784,W=128,H=32)
    szType_DisplayAmmo="ammo50"
    sound_Fire=Sound'Warfare_Sound_Weapon.ak47.weapon_ak47_fire'
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.ak47.weapon_ak47_fire_s'
