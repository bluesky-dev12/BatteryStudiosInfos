 ...
 * Path WWeapons_Res\Classes\wWeaponRes_ASVal.uc
 * Package Imports:
 *	WWeapons_Res
 *	Engine
 *	Core
 ...
 * 
 *******************************************************************************/
class wWeaponRes_ASVal extends wWeaponRes_Base;
...
defaultproperties
{
    ...
    ibIcon_Kill=(X=384,Y=750,W=128,H=32)
    szType_DisplayAmmo="ammo50"
    sound_Fire=Sound'Warfare_Sound_Weapon.ASVAL.weapon_ASVAL_fire'
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.ASVAL.weapon_ASVAL_fire_s'
    sound_Fire_Silencer=Sound'Warfare_Sound_Weapon.ASVAL.weapon_ASVAL_fire_silencer'
    sound_Fire_Silencer_Stereo=Sound'Warfare_Sound_Weapon.ASVAL.weapon_ASVAL_fire_silencer_s'
    ...
    sound_Reload=Sound'Warfare_Sound_Weapon.ASVAL.weapon_ASVAL_reload'
    sound_ReloadEmpty=Sound'Warfare_Sound_Weapon.ASVAL.weapon_ASVAL_reload_empty'
    sound_Select=Sound'Warfare_Sound_Weapon.ASVAL.weapon_ASVAL_select'
    sound_Pickup=SoundGroup'Warfare_Sound_Char.GetItem.char_getitem_weapon'
    sound_Select_New=Sound'Warfare_Sound_Weapon.ASVAL.weapon_ASVAL_select_n'
}