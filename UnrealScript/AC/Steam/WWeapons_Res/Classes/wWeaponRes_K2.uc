 ...
 * Path WWeapons_Res\Classes\wWeaponRes_K2.uc
 * Package Imports:
 *	WWeapons_Res
 *	Engine
 *	Core
 ...
 * 
 *******************************************************************************/
class wWeaponRes_K2 extends wWeaponRes_Base;
...
defaultproperties
{
    ...
    szIcon_HUD="Warfare_UI_Item.HUDIcon.Item_HUD_WP_AR_K2"
    szIcon_Kill="Warfare_UI_Item.Item_killIcon"
    ibIcon_Kill=(X=384,Y=172,W=128,H=32)
    szType_DisplayAmmo="ammo50"
    sound_Fire=Sound'Warfare_Sound_Weapon.k2.weapon_K2_fire'
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.k2.weapon_K2_fire_s'
    ...
    sound_Reload=Sound'Warfare_Sound_Weapon.k2.weapon_K2_reload'
    sound_ReloadEmpty=Sound'Warfare_Sound_Weapon.k2.weapon_K2_reload_empty'
    sound_Select=Sound'Warfare_Sound_Weapon.k2.weapon_K2_select'
    sound_Pickup=SoundGroup'Warfare_Sound_Char.GetItem.char_getitem_weapon'
    sound_Select_New=Sound'Warfare_Sound_Weapon.k2.weapon_K2_select_n'
}