...
defaultproperties
{
    ...
    WaitRoom_Defence_Reward2=(X=0.0000000,Y=0.0000000,width=667.0000000,Height=503.0000000,Image=Texture'Warfare_GP_UI_UI.HUD_ETC.img_scoreboard_defence_giftitemlist_back',DrawType=28,DrawColor=(R=255,G=255,B=255,A=255),DrawShadowColor=(R=0,G=0,B=0,A=255))
}