...
simulated function DrawHudPassC(Canvas C)
{
    ...
    if(PlayerOwner.Pawn != none)
    {
        ...
        {
            // End:0xEE
            if(PlayerOwner.Pawn.Weapon.GetFireMode(0).IsA('wWeaponFireInstallPack'))
            {
                // End:0xEE
                if(wWeaponFireInstallPack(PlayerOwner.Pawn.Weapon.GetFireMode(0)).IsInstalling())
                {
