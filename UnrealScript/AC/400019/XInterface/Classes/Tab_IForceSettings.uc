...
defaultproperties
{
    ...
    begin object name="InputAutoAim" class=XInterface_Decompressed.moCheckBox
        ...
        Hint="Enable automatic aiming in single player games."
        WinTop=0.0573960
        WinLeft=0.0609380
        WinWidth=0.3000000
        WinHeight=0.0400000
    ...
    begin object name="InputAutoSlope" class=XInterface_Decompressed.moCheckBox
        ...
        Hint="Automatically adjust the camera angle on slopes."
        WinTop=0.1759890
        WinLeft=0.0609370
        WinWidth=0.3000000
        WinHeight=0.0400000
    ...
    begin object name="InputInvertMouse" class=XInterface_Decompressed.moCheckBox
        ...
        Hint="Invert the Y-axis of the mouse."
        WinTop=0.3219270
        WinLeft=0.0609380
        WinWidth=0.3000000
        WinHeight=0.0400000
    ...
    begin object name="InputMouseSmoothing" class=XInterface_Decompressed.moCheckBox
        ComponentJustification=0
        CaptionWidth=0.9000000
        Caption="Mouse Smoothness"
        ComponentClassName="xinterface.GUICheckBoxButton"
        OnCreateComponent=InputMouseSmoothing.InternalOnCreateComponent
        Hint="Adjust smoothness of mouse movement."
        WinTop=0.4160410
        WinLeft=0.0609380
        WinWidth=0.3000000
        WinHeight=0.0400000
    ...
    begin object name="InputUseJoystick" class=XInterface_Decompressed.moCheckBox
        ...
        Hint="Enable the use of a gamepad."
        WinTop=0.6513020
        WinLeft=0.0609380
        WinWidth=0.3000000
        WinHeight=0.0400000
    ...
    begin object name="InputMenuSensitivity" class=XInterface_Decompressed.moFloatEdit
        ...
        Hint="Adjust the mouse sensitivity in menus."
        WinTop=0.1886980
        WinLeft=0.4722660
        WinWidth=0.4218750
    end object
    ...
    begin object name="InputIFWeaponEffects" class=XInterface_Decompressed.moCheckBox
        ...
        Hint="Display visual effects during weapon fire."
        WinTop=0.8520000
        WinLeft=0.1000000
        WinWidth=0.3000000
        WinHeight=0.0400000
    ...
    begin object name="InputIFPickupEffects" class=XInterface_Decompressed.moCheckBox
        ComponentJustification=0
        CaptionWidth=0.9000000
        Caption="Pick-up Effects"
        ComponentClassName="xinterface.GUICheckBoxButton"
        OnCreateComponent=InputIFPickupEffects.InternalOnCreateComponent
        Hint="Show a special effect on items that can be picked up."
        WinTop=0.9330000
        WinLeft=0.1000000
        WinWidth=0.3000000
        WinHeight=0.0400000
    ...
    begin object name="InputIFGUIEffects" class=XInterface_Decompressed.moCheckBox
        ...
        Hint="Display effects on the GUI."
        WinTop=0.9330000
        WinLeft=0.5638670
        WinWidth=0.3000000
        WinHeight=0.0400000
    ...
    begin object name="InputIForceLabel" class=XInterface_Decompressed.GUILabel
        Caption="Touch-sensor Force Feedback"
        TextAlign=1
        TextColor=(R=255,G=255,B=255,A=255)
        WinTop=0.7770000
        WinLeft=0.0234370
    ...
    begin object name="InputMouseAccel" class=XInterface_Decompressed.moFloatEdit
        ...
        ComponentJustification=0
        CaptionWidth=0.7250000
        Caption="Mouse Acceleration Value"
        OnCreateComponent=InputMouseAccel.InternalOnCreateComponent
        Hint="Set the value for mouse pointer acceleration."
        WinTop=0.4050000
        WinLeft=0.4722660
        WinWidth=0.4218750
    end object
    ...
    begin object name="InputDodgeTime" class=XInterface_Decompressed.moFloatEdit
        ...
        ComponentJustification=0
        CaptionWidth=0.7250000
        Caption="Evade Double-click Time"
        OnCreateComponent=InputDodgeTime.InternalOnCreateComponent
        Hint="Set the double-click speed required to use evade."
        WinTop=0.5820830
        WinLeft=0.4722660
        WinWidth=0.4218750
    end object
    ...
    begin object name="InputMouseLag" class=XInterface_Decompressed.moCheckBox
        ComponentJustification=0
        CaptionWidth=0.9000000
        Caption="Decrease Mouse Lag"
        ComponentClassName="xinterface.GUICheckBoxButton"
        OnCreateComponent=InputMouseLag.InternalOnCreateComponent
        Hint="Enable hardware mouse for reduced mouse lag."
        WinTop=0.5097910
        WinLeft=0.0609380
        WinWidth=0.3000000
        WinHeight=0.0400000
