...
event bool CreateBackGroundImage(wMatchMaker MatchMaker)
{
    ...
    else
    {
        ...
        Mat_img_hud_text2 = Material(DynamicLoadObject("Warfare_GP_UI_HUD.Text.img_hud_text2", Class'Engine.Material'));
        Mat_img_help_all = Material(DynamicLoadObject("Warfare_GP_UI_Map.LoadingImage.img_loading_help_all", Class'Engine.Material'));
        ...
        Mat_img_SupplyIcon[int(1)] = Material(DynamicLoadObject("Warfare_GP_UI_Map.LoadingImage.img_loading_supplyicon_UAV", Class'Engine.Material'));
        Mat_img_SupplyIcon[int(2)] = Material(DynamicLoadObject("Warfare_GP_UI_Map.LoadingImage.img_loading_supplyicon_helicopter", Class'Engine.Material'));
        Mat_img_SupplyIcon[int(3)] = Material(DynamicLoadObject("Warfare_GP_UI_Map.LoadingImage.img_loading_supplyicon_bombing", Class'Engine.Material'));
        Mat_img_SupplyIcon[int(4)] = Material(DynamicLoadObject("Warfare_GP_UI_Map.LoadingImage.img_loading_supplyicon_sent", Class'Engine.Material'));
        Mat_img_RespawnLevelStar[0] = Material(DynamicLoadObject("Warfare_GP_UI_Map.LoadingImage.img_loading_respawnlevel_star01", Class'Engine.Material'));
        Mat_img_RespawnLevelStar[1] = Material(DynamicLoadObject("Warfare_GP_UI_Map.LoadingImage.img_loading_respawnlevel_star02", Class'Engine.Material'));
        Mat_img_RespawnLevelStar[2] = Material(DynamicLoadObject("Warfare_GP_UI_Map.LoadingImage.img_loading_respawnlevel_star03", Class'Engine.Material'));
        Mat_img_RespawnLevelStar[3] = Material(DynamicLoadObject("Warfare_GP_UI_Map.LoadingImage.img_loading_respawnlevel_star04", Class'Engine.Material'));
        Mat_img_RespawnLevelStar[4] = Material(DynamicLoadObject("Warfare_GP_UI_Map.LoadingImage.img_loading_respawnlevel_star05", Class'Engine.Material'));
        // End:0xCF5
