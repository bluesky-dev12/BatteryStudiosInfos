...
function DamageLog(Pawn Victim, float fDam, float fDist)
{
    ...
    Level.GetLocalPlayerController().myHUD.AddTextMessage((((((((((((((szType $ " ") $ string(fDam)) $ " / ") $ szName) $ " / ") $ BaseParams.strName) $ " / ") $ string(0)) $ " / ") $ string(fDist)) $ " / ") $ "0%") $ " / ") $ string(Level.TimeSeconds), Class'Engine.GameMessage', Instigator.Controller.PlayerReplicationInfo);
    //return;    
}
...
simulated function wLoadOut(int iID)
{
    ...
    {
        wLoadOut_SetStaticMesh(ResParams.default.stProj);
    }
    fGravMass = BaseParams.fBulletGravity;
    ExplosionClass = ResParams.default.effect_Explosion;
    // End:0x16E
    if(ResParams.default.fsound_Bullet_Move != "")
    {
        FmodPlaySound(ResParams.default.fsound_Bullet_Move, 3);
    }
    //return;    
}
...
simulated function BlowUp(Vector HitLocation)
{
    ...
    {
        HurtRadiusTutorial(Damage, DamageRadius, MyDamageType, 0.0000000, HitLocation);
    }
    // End:0x77
...
simulated function RumbleRadius(Vector HitLocation)
{
    ...
    // End:0x8C
    foreach CollidingActors(Class'Engine.Pawn', kVictim, BaseParams.fExplRad_Effect, HitLocation)
    {
        // End:0x8B
