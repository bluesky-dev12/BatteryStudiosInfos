...
function InitializeFor(Effect_ShadowController ShadowController)
{
    ...
    if(ShadowController.Owner != none)
    {
        ...
        switch(ShadowController.ShadowCrispness)
        {
            // End:0x65
            case 1:
                ShadowTexture = ShadowBitmapMaterial(Level.ObjectPool.AllocateObject(Class'Engine.Effect_ShadowBitmapMaterialMedium'));
                // End:0xF3
                break;
            // End:0x95
            case 2:
            ...
            // End:0xC5
            case 3:
                ShadowTexture = ShadowBitmapMaterial(Level.ObjectPool.AllocateObject(Class'Engine.Effect_ShadowBitmapMaterialMax'));
                // End:0xF3
                break;
            // End:0xFFFF
            default:
