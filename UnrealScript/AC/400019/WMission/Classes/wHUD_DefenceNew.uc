...
simulated function LocalizedMessageOptional(Class<LocalMessage> Message, optional int iCode_Message, optional int iItemID, optional int iReserve2)
{
    ...
    if(iItemID > 0)
    {
        ...
        strMessage = strItemName $ strMessage;
    }
...
defaultproperties
{
    strBotLevel="Difficulty :"
    strBotRound="Round"
    strReactor="Nuclear Reactor HP"
    strPoint="Points"
    strScore="Points"
    strBuy="Buy Items"
    lsIndication[0]="Barricade"
    lsIndication[1]="Nuclear Reactor"
    lsBotDifficulty[0]="Easy"
    lsBotDifficulty[1]="Normal"
    lsBotDifficulty[2]="Hard"
    lsBotDifficulty[3]="Very Hard"
    lsNoteiceCanBuyItem="Press 'F' to open the item purchase window."
    WGaugeBG=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_HUD_pve_reactorHP_bg',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=867,Y2=99),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=356,OffsetY=5,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGauge=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_HUD_pve_reactorHP_hpbar',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=412,Y2=26),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=590,OffsetY=37,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WGaugeWaring=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_HUD_pve_atomicHP_effect',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=434,Y2=48),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=579,OffsetY=26,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WIndication[0]=(WidgetTexture=Texture'Warfare_GP_UI_HUD_ETC.DisplayIcon.hurdleHP_defense',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=128,Y2=128),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WIndication[1]=(WidgetTexture=Texture'Warfare_GP_UI_HUD_ETC.DisplayIcon.atomicHP_defense',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=128,Y2=128),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WItemBG=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_HUD_pve_item_respawn_bg',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=93,Y2=64),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=531,OffsetY=445,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WItemBG2=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_HUD_pve_item_bg',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=98,Y2=71),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WMyPointBG=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_HUD_pve_itembuyHUD_bg',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=916,Y2=49),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=275,OffsetY=1151,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WBuyButton[0]=(WidgetTexture=Texture'Warfare_GP_UI_UI.HUD_ETC.butt_hud_quickslot_openslot',RenderStyle=5,TextureCoords=(X1=0,Y1=98,X2=282,Y2=169),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=815,OffsetY=1124,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WBuyButton[1]=(WidgetTexture=Texture'Warfare_GP_UI_UI.HUD_ETC.butt_hud_quickslot_openslot',RenderStyle=5,TextureCoords=(X1=0,Y1=169,X2=282,Y2=240),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=815,OffsetY=1124,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WBuyButton[2]=(WidgetTexture=Texture'Warfare_GP_UI_UI.HUD_ETC.butt_hud_quickslot_openslot',RenderStyle=5,TextureCoords=(X1=0,Y1=169,X2=282,Y2=240),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=815,OffsetY=1124,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKeyButtonBigF[0]=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_keyboard_2',RenderStyle=5,TextureCoords=(X1=260,Y1=182,X2=312,Y2=234),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WKeyButtonBigF[1]=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_keyboard_2',RenderStyle=5,TextureCoords=(X1=208,Y1=182,X2=260,Y2=234),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WItemPopBG=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_HUD_back_3',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=1024,Y2=4),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=0,OffsetY=739,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
