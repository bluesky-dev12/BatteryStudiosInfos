...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    if(i < 5)
    {
        ...
        ButtonTop[i].buttonImage[2] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.butt_list_cli;
    ...
    fb = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(AWinPos.X1, AWinPos.Y1, AWinPos.X2, AWinPos.Y2);
...
defaultproperties
{
    fbButtonTop[0]=(X1=13.0000000,Y1=189.0000000,X2=47.0000000,Y2=202.0000000)
    fbButtonTop[1]=(X1=47.0000000,Y1=189.0000000,X2=88.0000000,Y2=202.0000000)
    fbButtonTop[2]=(X1=81.0000000,Y1=189.0000000,X2=205.0000000,Y2=202.0000000)
    fbButtonTop[3]=(X1=205.0000000,Y1=189.0000000,X2=329.0000000,Y2=202.0000000)
    fbButtonTop[4]=(X1=329.0000000,Y1=189.0000000,X2=373.0000000,Y2=202.0000000)
    strButtonTop[0]="Clan"
    strButtonTop[1]="Lv."
