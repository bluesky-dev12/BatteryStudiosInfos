...
function bool Render(Canvas C, optional float Delta)
{
    ...
    {
        Class'Engine.BTCustomDrawHK'.static.DrawImagePadding(C, Gauge, AWinPos.X1 + float(7), AWinPos.Y1 + float(5), AWinPos.X2 - float(7), AWinPos.Y2 - float(9), 0.0000000, 0.0000000, DataPerc, 0.0000000);
    }
...
function bool RenderUsingCache(Canvas C, optional float Delta, optional int Level)
{
    ...
    Class'Engine.BTCustomDrawHK'.static.DrawImagePaddingCacheRatio(C, Gauge, AWinPos.X1 + float(LineWidth), AWinPos.Y1 + float(LineWidth), AWinPos.X2 - float(LineWidth), AWinPos.Y2 - float(LineWidth), 0.0000000, 0.0000000, DataPerc, 0.0000000, Level);
    // End:0x178
    if(bRenderText)
    {
