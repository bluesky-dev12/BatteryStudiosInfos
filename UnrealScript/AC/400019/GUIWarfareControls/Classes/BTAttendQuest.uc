...
{
    strAttend[0]="Receive"
    strAttend[1]="Roll Call"
    strAttend[2]="times"
    strAttend[3]="Receive the additional reward below by completing the Roll Call rewarded from the Roll Call mission."
    strAttend[4]="(Roll Calls reset every first day of the month at 00:00)"
    strAttend[5]="times achieved!"
