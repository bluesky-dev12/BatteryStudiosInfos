        ...
        else
        {
            ...
            else
            {
                ...
                if(MemoType == 5)
                {
                    ...
                    if(Panel == 1)
                    {
                        Data.DataPerColumn[7].strValue = Class'GUIWarfareControls_Decompressed.BTWindowDefineInfoHK'.static.GetFormatString(83, MM.kUserName, arrStr[1]);                        
                    }
                    else
                    {
                        Data.DataPerColumn[7].strValue = Class'GUIWarfareControls_Decompressed.BTWindowDefineInfoHK'.static.GetFormatString(83, Sender, arrStr[1]);
                    }
...
function InitTopButtons()
{
    ...
    img = Class'Engine.BTCustomDrawHK'.static.MakeImage(4, 16, 15, Texture'Warfare_GP_UI_UI.Common.img_list_divid');
    i = 0;
    J0x27:
    ...
    img = Class'Engine.BTCustomDrawHK'.static.MakeImage(8, 26, 15, Texture'Warfare_GP_UI_UI.Common.butt_list_n');
    ...
    onImg = Class'Engine.BTCustomDrawHK'.static.MakeImage(8, 8, 15, Texture'Warfare_GP_UI_UI.Common.butt_list_on');
    cliImg = Class'Engine.BTCustomDrawHK'.static.MakeImage(8, 8, 15, Texture'Warfare_GP_UI_UI.Common.butt_list_cli');
    i = 0;
    J0x2F8:
