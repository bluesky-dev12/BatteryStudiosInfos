...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    InternalPadding[4].Y2 = 3.0000000;
    InternalPadding[5].Y2 = 3.0000000;
...
function InitializeContent()
{
    ...
    PC = PlayerOwner();
    Content[0] = NewComponent(new Class'GUIWarfareControls_Decompressed.BTTPOptionTextureQuality', Class'Engine.BTCustomDrawHK'.static.MakeEmptyBox(), 0.7600000);
    i = 0;
    J0x3B:
    ...
    Content[1] = NewComponent(new Class'GUIWarfareControls_Decompressed.BTTPOptionBGQuality', Class'Engine.BTCustomDrawHK'.static.MakeEmptyBox(), 0.7600000);
    i = 0;
    J0xAD:
    ...
    Content[2] = NewComponent(new Class'GUIWarfareControls_Decompressed.BTTPOptionLOD', Class'Engine.BTCustomDrawHK'.static.MakeEmptyBox(), 0.7600000);
    i = 0;
    J0x120:
    ...
    Content[3] = NewComponent(new Class'GUIWarfareControls_Decompressed.BTTPOptionOnOffButton', Class'Engine.BTCustomDrawHK'.static.MakeEmptyBox(), 0.7700000);
    i = 0;
    J0x194:
    ...
    Content[14] = NewComponent(new Class'GUIWarfareControls_Decompressed.BTSliderHK', Class'Engine.BTCustomDrawHK'.static.MakeEmptyBox(), 0.7600000);
    BTSliderHK(Content[14]).MinValue = 1.0000000;
    BTSliderHK(Content[14]).MaxValue = 2.0000000;
...
defaultproperties
{
    ...
    strToolTip[4]="Reduces jagged polygon edges. Higher settings increase the effect. <P> <P>? This greatly affects frame rate. Users with lower-end graphics cards may want to disable this."
