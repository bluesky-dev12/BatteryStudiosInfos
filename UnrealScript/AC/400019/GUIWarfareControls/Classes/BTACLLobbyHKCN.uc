...
function LC3_Draw(Canvas C, float L, float t, float R, float B, ACLData Data, int Column, int row)
{
    ...
    // End:0x253
    if((ACLRowList[row].DataPerColumn[4].tempValue == 12) && ACLRowList[row].DataPerColumn[7].IntValue == 1)
    {
        C.DrawColor.R = 102;
        C.DrawColor.G = 102;
        C.DrawColor.B = 102;
