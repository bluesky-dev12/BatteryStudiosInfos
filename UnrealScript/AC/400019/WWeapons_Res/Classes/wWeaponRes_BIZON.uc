...
defaultproperties
{
    ...
    szIcon_HUD="Warfare_UI_Item.HUDIcon.Item_HUD_WP_SMG_BIZON"
    szIcon_Kill="Warfare_UI_Item.Item_killIcon"
    ibIcon_Kill=(X=0,Y=852,W=128,H=32)
    szType_DisplayAmmo="ammo50"
    fsound_Fire="Warfare_Sound_Weapon/SMG/Bizon/fire"
    fsound_Fire_Stereo="Warfare_Sound_Weapon/SMG/Bizon/fire_s"
    fSound_Fire_Silencer="Warfare_Sound_Weapon/SMG/Bizon/fire_silencer"
    fsound_Fire_Silencer_Stereo="Warfare_Sound_Weapon/SMG/Bizon/fire_silencer_s"
    ...
    fsound_Reload="Warfare_Sound_Weapon/SMG/Bizon/reload"
    fsound_ReloadEmpty="Warfare_Sound_Weapon/SMG/Bizon/reload_empty"
    fsound_Select="Warfare_Sound_Weapon/SMG/Bizon/select"
    fsound_Pickup="Warfare_Sound_Char/GetItem/char_getitem_weapon"
    fsound_Select_New="Warfare_Sound_Weapon/SMG/Bizon/select_n"
}