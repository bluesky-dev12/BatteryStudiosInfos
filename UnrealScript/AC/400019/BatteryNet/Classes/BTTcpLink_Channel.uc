...
struct native export ClanInfo
{
    ...
    var int ClanLevel;
    var int ConnectingCount;
    var int ConnectingRank;
};
...
// Export UBTTcpLink_Channel::execsfReqNotifyShopPackageItemData(FFrame&, void* const)
native function bool sfReqNotifyShopPackageItemData(int PackageProductNo, array<int> ProductCode, array<int> ProductQuantity, array<int> ProductHour, string Description)
{
    //native.PackageProductNo;
    //native.ProductCode;
    //native.ProductQuantity;
    //native.ProductHour;
    //native.Description;        
...
// Export UBTTcpLink_Channel::execsfReqCharDetailInfoWithClan(FFrame&, void* const)
native function bool sfReqCharDetailInfoWithClan(string CharName)
{
    //native.CharName;        
}

// Export UBTTcpLink_Channel::execsfAckCharDetailInfoWithClan(FFrame&, void* const)
native function bool sfAckCharDetailInfoWithClan(int ErrorCode, string CharName, int Exp, int Level, int LevelMarkID, int PreMonthlyRanking, int MonthlyRanking, int Win, int Lose, int Kill, int Death, int Assist, int KillCountByAimShooting, int HeadShot2, int TotPlayTime, int DisCon, int MainWeaponItemID, int MainWeaponPartID, int SubWeaponItemID, int SubWeaponPartID, int AFSpecialCostumeItemID, int RSASpecialCostumeItemID, int DispHeadItem, int DispFaceItem, int DispBackpack, int DispPouch, int DispCamouflage, string ClanName, int ClanLevel, int CM_Pattern, int CM_BG, int CM_BL, int ClanExp, byte ClanGrade, int ClanActivity, int MonthlyConnectingCount, int UserClanWin, int UserClanLose, int UserClanDraw, int ClanWin, int ClanLose, int ClanDraw, int PreClanTotalRankCur, int ClanTotalRankCur, int PreClanMonthlyRankCur, int ClanMonthlyRankCur, int PreClanMonthlyConnectingRank, int ClanMonthlyConnectingRank, string ClanIntro)
{
    //native.ErrorCode;
    //native.CharName;
    //native.Exp;
    //native.Level;
    //native.LevelMarkID;
    //native.PreMonthlyRanking;
    //native.MonthlyRanking;
    //native.Win;
    //native.Lose;
    //native.Kill;
    //native.Death;
    //native.Assist;
    //native.KillCountByAimShooting;
    //native.HeadShot2;
    //native.TotPlayTime;
    //native.DisCon;
    //native.MainWeaponItemID;
    ...
    //native.ClanLose;
    //native.ClanDraw;
    //native.PreClanTotalRankCur;
    //native.ClanTotalRankCur;
    //native.PreClanMonthlyRankCur;
    //native.ClanMonthlyRankCur;
    //native.PreClanMonthlyConnectingRank;
    //native.ClanMonthlyConnectingRank;
    //native.ClanIntro;        
}

// Export UBTTcpLink_Channel::execsfReqGP20CashModifyWeapon(FFrame&, void* const)
native function bool sfReqGP20CashModifyWeapon(BtrDouble UniqueID, int AddPartID, int PaintID, array<int> ProductNo)
{
    //native.UniqueID;
    //native.AddPartID;
    //native.PaintID;
...
// Export UBTTcpLink_Channel::execsfAckGP20CashModifyWeapon(FFrame&, void* const)
native function bool sfAckGP20CashModifyWeapon(int Result, string ErrMsg, BtrDouble UniqueID, int AddPartID, int PaintID, int Point)
{
    //native.Result;
    //native.ErrMsg;
    //native.UniqueID;
