...
event bool rfReqUpdateUserCount_ChannelServer(int ServerID, int ChannelCount, array<int> ChannelNum, array<int> ChannelMaxUserCount, array<int> ChannelCurUserCount, array<int> ChannelPlayingUserCount, array<int> ChannelRoomCount, array<byte> ChannelGrade)
{
    return false;
    //return;    
}
...
event bool rfReqUpdatePostAlram(int QQID, string Subject, string Text, int ItemID)
{
    return false;
    //return;    
}

event bool rfReqNotifyKickOffUser(int QQID)
{
    return false;
    //return;    
}

event bool rfReqUpdateCurrentRunningInfo(int GroupID, string GroupName, string ServerName, int ServerID, array<string> key, array<int> Value)
{
    return false;
    //return;    
}
...
native function bool sfReqUpdateUserCount_ChannelServer(int ServerID, int ChannelCount, array<int> ChannelNum, array<int> ChannelMaxUserCount, array<int> ChannelCurUserCount, array<int> ChannelPlayingUserCount, array<int> ChannelRoomCount, array<byte> ChannelGrade)
{
    //native.ServerID;
    //native.ChannelCount;
    //native.ChannelNum;
...
// Export UBTTcpLink_Process2Agent::execsfReqUpdatePostAlram(FFrame&, void* const)
native function bool sfReqUpdatePostAlram(int QQID, string Subject, string Text, int ItemID)
{
    //native.QQID;
    //native.Subject;
    //native.Text;
...
// Export UBTTcpLink_Process2Agent::execsfReqNotifyKickOffUser(FFrame&, void* const)
native function bool sfReqNotifyKickOffUser(int QQID)
{
    //native.QQID;        
}

// Export UBTTcpLink_Process2Agent::execsfReqUpdateCurrentRunningInfo(FFrame&, void* const)
native function bool sfReqUpdateCurrentRunningInfo(int GroupID, string GroupName, string ServerName, int ServerID, array<string> key, array<int> Value)
{
    //native.GroupID;
    //native.GroupName;
    //native.ServerName;
