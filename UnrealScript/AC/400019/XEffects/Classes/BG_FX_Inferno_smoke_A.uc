class BG_FX_Inferno_smoke_A extends Emitter;

defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.BG_FX_Inferno_smoke_A.SpriteEmitter0'
    begin object name="SpriteEmitter0" class=Engine.SpriteEmitter
        ...
        StartVelocityRange=(X=(Min=-52.0000000,Max=52.0000000),Y=(Min=58.0000000,Max=120.0000000),Z=(Min=58.0000000,Max=120.0000000))
    end object
    Emitters[0]=SpriteEmitter0
    // Reference: SpriteEmitter'XEffects_Decompressed.BG_FX_Inferno_smoke_A.SpriteEmitter1'
    begin object name="SpriteEmitter1" class=Engine.SpriteEmitter
        ...
        TextureVSubdivisions=2
        LifetimeRange=(Min=2.5641019,Max=2.5641019)
        StartVelocityRange=(X=(Min=-52.0000000,Max=52.0000000),Y=(Min=-120.0000000,Max=-70.0000000),Z=(Min=58.0000000,Max=120.0000000))
    end object
    Emitters[1]=SpriteEmitter1
    // Reference: SpriteEmitter'XEffects_Decompressed.BG_FX_Inferno_smoke_A.SpriteEmitter4'
    begin object name="SpriteEmitter4" class=Engine.SpriteEmitter
        ...
        StartLocationRange=(X=(Min=-30.0000000,Max=30.0000000),Y=(Min=-60.0000000,Max=-60.0000000),Z=(Min=0.0000000,Max=0.0000000))
        SizeScale=/* Array type was not detected. */
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.BG_FX_Inferno_smoke_A.SpriteEmitter5'
    begin object name="SpriteEmitter5" class=Engine.SpriteEmitter
        ...
        SecondsBeforeInactive=7.0000000
        LifetimeRange=(Min=1.0000000,Max=2.0000000)
        StartVelocityRange=(X=(Min=-52.0000000,Max=52.0000000),Y=(Min=156.0000000,Max=560.0000000),Z=(Min=208.0000000,Max=381.6799927))
        GetVelocityDirectionFrom=3
    end object
