class BG_FX_sky_burn02 extends Emitter;

defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.BG_FX_sky_burn02.SpriteEmitter41'
    begin object name="SpriteEmitter41" class=Engine.SpriteEmitter
        UseDirectionAs=4
        UseColorScale=true
        FadeOut=true
        FadeIn=true
