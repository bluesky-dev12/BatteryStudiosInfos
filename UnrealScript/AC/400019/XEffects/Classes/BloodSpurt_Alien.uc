class BloodSpurt_Alien extends wEmitter;
...
defaultproperties
{
    BloodDecalClass=Class'XEffects_Decompressed.BloodSplatter_Alien'
    ...
    HitEffectClass=Class'XEffects_Decompressed.HitEffect_blood_Alien'
    mRegen=false
    mStartParticles=0
    mMaxParticles=0
