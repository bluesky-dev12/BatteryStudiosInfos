...
struct native sQuickSlot
{
    ...
    var int iItemID[5];
    var BtrDouble iUniqueItemUID[5];
    var int iPartsID[4];
    var int iSkillID[4];
...
var(Base) editconst int DispPouch;
var(Base) editconst int DispCamouflage;
var byte Activated;
...
function SetQSlotList(array<int> QSlotID, array<string> QSlotName, array<byte> QSlotDispOrder, array<BtrDouble> MWItemID, array<BtrDouble> PistolItemID, array<BtrDouble> KnifeItemID, array<BtrDouble> TWItemID1, array<BtrDouble> TWItemID2, array<int> Skill1, array<int> Skill2, array<int> Skill3, array<int> Skill4)
{
    local int i, iIndex;
    ...
    if(i < QSlotID.Length)
    {
        ...
        SetQSlotData(byte(iIndex), MWItemID[i], PistolItemID[i], KnifeItemID[i], TWItemID1[i], TWItemID2[i], Skill1[i], Skill2[i], Skill3[i], Skill4[i]);
        i++;
        // [Loop Continue]
        goto J0x3D;
    }
...
function SetQSlotData(byte QSlotDispOrder, BtrDouble MWItemID, BtrDouble PistolItemID, BtrDouble KnifeItemID, BtrDouble TWItemID1, BtrDouble TWItemID2, int Skill1, int Skill2, int Skill3, int Skill4)
{
    QuickSlotList[int(QSlotDispOrder)].iUniqueItemUID[0] = MWItemID;
    QuickSlotList[int(QSlotDispOrder)].iUniqueItemUID[1] = PistolItemID;
    QuickSlotList[int(QSlotDispOrder)].iUniqueItemUID[2] = TWItemID1;
    QuickSlotList[int(QSlotDispOrder)].iUniqueItemUID[3] = TWItemID2;
    QuickSlotList[int(QSlotDispOrder)].iUniqueItemUID[4] = KnifeItemID;
    QuickSlotList[int(QSlotDispOrder)].iUniqueSkillID[0] = Skill1;
    QuickSlotList[int(QSlotDispOrder)].iUniqueSkillID[1] = Skill2;
    QuickSlotList[int(QSlotDispOrder)].iUniqueSkillID[2] = Skill3;
    QuickSlotList[int(QSlotDispOrder)].iUniqueSkillID[3] = Skill4;
    //return;    
}

function ApplyQuickSlotData()
{
    local int i, j, k;
...
defaultproperties
{
    ...
    QuickSlotList[0]=(strName="",iUniqueSlotID=0,iItemID=0,iItemID[1]=0,iItemID[2]=0,iItemID[3]=0,iItemID[4]=0,iUniqueItemUID=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[1]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[2]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[3]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[4]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iPartsID=0,iPartsID[1]=0,iPartsID[2]=0,iPartsID[3]=0,iSkillID=0,iSkillID[1]=0,iSkillID[2]=0,iSkillID[3]=0,iUniqueSkillID=0,iUniqueSkillID[1]=0,iUniqueSkillID[2]=0,iUniqueSkillID[3]=0)
    QuickSlotList[1]=(strName="",iUniqueSlotID=0,iItemID=0,iItemID[1]=0,iItemID[2]=0,iItemID[3]=0,iItemID[4]=0,iUniqueItemUID=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[1]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[2]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[3]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[4]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iPartsID=0,iPartsID[1]=0,iPartsID[2]=0,iPartsID[3]=0,iSkillID=0,iSkillID[1]=0,iSkillID[2]=0,iSkillID[3]=0,iUniqueSkillID=0,iUniqueSkillID[1]=0,iUniqueSkillID[2]=0,iUniqueSkillID[3]=0)
    QuickSlotList[2]=(strName="",iUniqueSlotID=0,iItemID=0,iItemID[1]=0,iItemID[2]=0,iItemID[3]=0,iItemID[4]=0,iUniqueItemUID=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[1]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[2]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[3]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[4]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iPartsID=0,iPartsID[1]=0,iPartsID[2]=0,iPartsID[3]=0,iSkillID=0,iSkillID[1]=0,iSkillID[2]=0,iSkillID[3]=0,iUniqueSkillID=0,iUniqueSkillID[1]=0,iUniqueSkillID[2]=0,iUniqueSkillID[3]=0)
    QuickSlotList[3]=(strName="",iUniqueSlotID=0,iItemID=0,iItemID[1]=0,iItemID[2]=0,iItemID[3]=0,iItemID[4]=0,iUniqueItemUID=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[1]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[2]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[3]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[4]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iPartsID=0,iPartsID[1]=0,iPartsID[2]=0,iPartsID[3]=0,iSkillID=0,iSkillID[1]=0,iSkillID[2]=0,iSkillID[3]=0,iUniqueSkillID=0,iUniqueSkillID[1]=0,iUniqueSkillID[2]=0,iUniqueSkillID[3]=0)
    QuickSlotList[4]=(strName="",iUniqueSlotID=0,iItemID=0,iItemID[1]=0,iItemID[2]=0,iItemID[3]=0,iItemID[4]=0,iUniqueItemUID=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[1]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[2]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[3]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iUniqueItemUID[4]=(dummy_1_DO_NOT_USE=0,dummy_2_DO_NOT_USE=0),iPartsID=0,iPartsID[1]=0,iPartsID[2]=0,iPartsID[3]=0,iSkillID=0,iSkillID[1]=0,iSkillID[2]=0,iSkillID[3]=0,iUniqueSkillID=0,iUniqueSkillID[1]=0,iUniqueSkillID[2]=0,iUniqueSkillID[3]=0)
    ...
    BodyFL_Rot=-8500.0000000
    BodyFR_Rot=8500.0000000
    BodyBL_Rot=8500.0000000
    BodyBR_Rot=-8000.0000000
    TweenRate_Proned_Run=0.3000000
    TweenRate_Crouched_Run=0.2000000
    TweenRate_Sprint=0.1000000
    TweenRate_Run=0.2000000
    TweenRate_Aim_Run=0.2000000
    TweenRate_Idle=0.3000000
    TweenRate_Proned_Idle=0.4000000
    TweenRate_Crouched_Idle=0.3000000
    TweenRate_SideStep=0.1000000
    iCurWeaponId=-1
}