...
struct native EquippedQSlotInfo
{
    var int ItemID[5];
    var int PartsID[5];
    var BtrDouble ItemUniqueID[5];
    var int ItemUsedSeconds[5];
    var int ItemUsedCount[5];
    var byte ItemOnUse[5];
    var int SkillID[4];
...
function UpdateQuest(int MissionType, int MissionOption1, int MissionOption2, int AddCount)
{
    ...
    if(i < MissionList.Length)
    {
        ...
        if(MissionList[i].MissionType == MissionType)
        {
            ...
            // End:0x124
            if(((MissionList[i].QuestType != 8) && InGamePlaying) && kGame_GameMode == Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_BotTutorial())
            {
                // [Explicit Continue]
                goto J0x3D7;
            }
...
event Material GetLoadingImage()
{
    ...
    if(BotTutorial)
    {
        return Material(DynamicLoadObject(resourceName, Class'Engine_Decompressed.Material'));
    }
...
event Material GetMiniMapInfoImage()
{
    ...
    {
        // End:0x19
        case Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_TeamDeath():
        // End:0x2B
        case Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_DeathMatch():
        // End:0x3D
        case Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_BotTeamDeath():
        // End:0x4F
        case Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_BotDeathMatch():
        // End:0x85
        case Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_BotTeamDeathBeginner():
        ...
        case Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_SD():
            ...
            break;
        // End:0xB3
        case Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_Domination():
        // End:0xF3
        case Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_BotDomination():
            switch(kGame_WeaponLimit)
            {
                // End:0xD3
                case int(1):
        ...
        // End:0x117
        case Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_BotTutorial():
        // End:0x12B
        case Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_Defence():
            return none;
        // End:0xFFFF
        default:
            break;
    }
    return Material(DynamicLoadObject(MapSettings.GetMapInfo(szMapName).ResourceMiniMapInfoImage[ImageIndex], Class'Engine_Decompressed.Material'));
    //return;    
}
...
function bool CheckEquipLevel(wItemBoxHK ItemInfo)
{
    // End:0x1A
    if(kLevel >= ItemInfo.EquipLevel)
    {
        return true;
    }
    return false;
...
{
    return kGame_GameMode == Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_Defence();
    //return;    
}
...
function bool IsEnableUsingItem()
{
    ...
    bEnable = kGame_GameMode == Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_Defence();
    return bEnable;
    //return;    
}
