...
var string strSuffixMuzFlashClass;
var int iSavedWID;
...
var name Anim_SentryGunPack_Plant;
var name Anim_SentryGunPack_PlantStop;
var name Anim_Throw;
...
simulated function wLoadOut(int iID, int iAddPartsID, int iPaintID, Pawn Pawn)
{
    ...
    if(iSavedWID != iID)
    {
        ...
        else
        {
            ...
            Hands = Spawn(Class'Engine_Decompressed.wSkinShell', self);
            Hands.SetDrawType(2);
...
simulated function SetResParams(Class<wWeaponRes_Base> wRes)
{
    ...
    if(ResParams.default.szClass_Muzz_1st != "")
    {
        ...
        if(bModMuzFlash)
        {
            strClassName = ResParams.default.szClass_Muzz_1st $ strSuffixMuzFlashClass;            
        }
        else
        {
            strClassName = ResParams.default.szClass_Muzz_1st;
        }
        FlashEmitterClass = Class<wEmitter>(DynamicLoadObject(strClassName, Class'Core.Class'));
        // End:0x14D
        if(FlashEmitterClass == none)
        {
            FlashFirstPersonEmitterClass = Class<EmitterFirstPerson>(DynamicLoadObject(strClassName, Class'Core.Class'));
        }
    }
    // End:0x197
...
simulated function LoadWarhead(StaticMesh stProj)
{
    ...
    wWarhead = Spawn(Class'Engine_Decompressed.wSkinShell', self);
...
simulated function SetAnimAction(byte byType, optional bool Opt1)
{
    ...
    switch(byType)
    {
        ...
        case 4:
            ...
            if(Opt1)
            {
                PlayAnim(Anim_SentryGunPack_Plant, 1.0000000, 0.0000000);                
            }
            else
            {
                PlayAnim(Anim_SentryGunPack_PlantStop, 1.0000000, 0.0000000);
            }
            // End:0x1E4
            if(bInstantFOV)
            {
...
defaultproperties
{
    ...
    Anim_SentryGunPack_Plant="plant"
    Anim_SentryGunPack_PlantStop="PlantStop"
    Anim_Throw="Throw"
