...
replication
{
    ...
    reliable if(bNetDirty && int(Role) == int(ROLE_Authority))
        ...
        NPCID, NumLives, 
        NumMedals, PlayerName, 
        PlayerVolume, PlayerZone, 
        Point, PointIns, 
        ...
        abySupplyItemFlag, aiBodyItemID, 
        ...
        bWaitingPlayer, fExp, 
        fSpawnedTime, iAccessoryItemID, 
        iBackPackItemID, iCamouflageItemID, 
        iCurrentWeaponID, iHeadItemID, 
        iHelmetItemID, iPouchItemID, 
        iWaitingForStartCountDown, nQuickSlotIdx;
