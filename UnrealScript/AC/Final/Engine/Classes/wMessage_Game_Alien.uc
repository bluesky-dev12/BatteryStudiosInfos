...
defaultproperties
{
    ...
    strAMAppearHostAlien="Aliens have appeared."
    strAMTransformdHostAlien="You have evolved to an Alien Host."
    strAMTransformdMasterAlien="You have evolved to an Alien Master."
    strAMHeadShotAlien="You have been slain by a headshot and cannot revive."
    strAMSelectedHero="%0 has become a Hero."
    strAMAcquiredAttackBuff="Human attack power increased to level %0"
    strAMReadyTimeCount="%0 seconds until Alien invasion"
    strAMInfectedHero="%0 has been infected."
    strAMDropRandomItemBox="Supply crate has been dropped."
    strAMTouchItemBoxToEveryOne="%0 has obtained a supply crate."
    strAMTouchItemBoxInWeapon="Obtained weapon."
    strAMTouchItemBoxInSkill="Obtained skill."
    strAMTouchItemBoxInFillAmmo="Obtained ammunition."
    strAMDefenceToAlien="Infection has been prevented."
    strAMInfectToFail="Infection failed. The enemy has used the Infection Defense item. "
    strAMYouwereSuperHero="You have changed into the MVP."
    strAMAppearSuperHero="MVP has appeared."
    strAMReadyTimeCountSuperAlien="%0 seconds before aliens are enraged."
    strAMAppearSuperAlien="Aliens are enraged."
