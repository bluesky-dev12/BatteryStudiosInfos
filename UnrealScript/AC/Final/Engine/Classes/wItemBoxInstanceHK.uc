...
function bool NotLeftTime()
{
    // End:0x48
    if((((LeftTime.Day < 0) || LeftTime.Hour < 0) || LeftTime.Minute < 0) || LeftTime.Second < 0)
    {
        return true;
    }
    // End:0xC6
    if(((((((LeftTime.Year <= 0) && LeftTime.Month <= 0) && LeftTime.DayOfWeek <= 0) && LeftTime.Day <= 0) && LeftTime.Hour <= 0) && LeftTime.Minute <= 0) && LeftTime.Second <= 0)
    {
        return true;
    }
    return false;
