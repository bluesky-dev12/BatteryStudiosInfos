...
defaultproperties
{
    ...
    strEnableInstallSentryGun="Sentry Gun can be used. Left click to deploy."
    strDisableInstallSentryGun="Sentry Gun cannot be deployed on this location."
    strAllySentryGun="Ally has deployed a Sentry Gun!"
    strAllyDestroySentryGun="Ally Sentry Gun has been destroyed!"
    strMySentryGun="Sentry Gun deployed"
    ...
    strEnemySentryGun="Enemy has deployed a Sentry Gun!"
    strEnemyDestroySentryGun="Enemy Sentry Gun has been destroyed."
