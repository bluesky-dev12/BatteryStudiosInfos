...
function PawnDied(Pawn P)
{
    ...
    RemoveLocalizedMessage(Class'Engine_Decompressed.wMessage_Game_ImpSystem', Class'Engine_Decompressed.wMessage_Game_ImpSystem'.default.Code_EnableInstallSentryGun);
    RemoveLocalizedMessage(Class'Engine_Decompressed.wMessage_Game_ImpSystem', Class'Engine_Decompressed.wMessage_Game_ImpSystem'.default.Code_DisableInstallSentryGun);
    super.PawnDied(P);
    //return;    
}
...
simulated function ReceiveLocalizedMessage2(Class<LocalMessage> Message, optional int Switch, optional bool bOption_Push, optional int Reserved1, optional int Reserved2, optional string Reserved3)
{
    ...
    // End:0x1E0
    if(Message == Class'Engine_Decompressed.wMessage_Game_Alien')
    {
        switch(Switch)
        {
            // End:0x27
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMAppearHostAlien:
            // End:0x38
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMTransformdHostAlien:
            // End:0x49
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMTransformdMasterAlien:
            // End:0x5A
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMHeadShotAlien:
            // End:0x6B
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMDropRandomItemBox:
            // End:0x7C
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMTouchItemBoxInWeapon:
            // End:0x8D
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMTouchItemBoxInSkill:
            // End:0x9E
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMTouchItemBoxInFillAmmo:
            // End:0xAF
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMDefenceToAlien:
            // End:0xC0
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMInfectToFail:
            // End:0xD1
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMYouwereSuperHero:
            // End:0xE2
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMAppearSuperHero:
            // End:0x110
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMAppearSuperAlien:
                strMessage = Class'Engine_Decompressed.wMessage_Game_Alien'.static.GetString(Switch);
                // End:0x1DD
                break;
            // End:0x121
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMAcquiredAttackBuff:
            // End:0x132
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMReadyTimeCount:
            // End:0x176
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMReadyTimeCountSuperAlien:
                strMessage = Class'Engine_Decompressed.wMessage_Game_Alien'.static.GetString(Switch);
                ReplaceText(strMessage, "%0", string(Reserved1));
                // End:0x1DD
                break;
            // End:0x187
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMSelectedHero:
            // End:0x198
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMInfectdHero:
            // End:0x1DA
            case Class'Engine_Decompressed.wMessage_Game_Alien'.default.Code_AMTouchItemBoxToEveryOne:
                strMessage = Class'Engine_Decompressed.wMessage_Game_Alien'.static.GetString(Switch);
    ...
    {
        // End:0x23D
        if(Message == Class'Engine_Decompressed.wMessage_Game_ImpSystem')
        {
            switch(Switch)
            {
                // End:0x23A
                case Class'Engine_Decompressed.wMessage_Game_ImpSystem'.default.Code_DFSupplyAmmo:
                    strMessage = Class'Engine_Decompressed.wMessage_Game_ImpSystem'.static.GetString(Switch);
                    ReplaceText(strMessage, "%0", string(Reserved1));
                    // End:0x23D
                    break;
                // End:0xFFFF
                ...
                switch(iKey)
                {
                    ...
                    case 8:
                        ...
                        if(C != none)
                        {
                            ...
                            {
                                PlayerController(C).ReceiveLocalizedMessage(Class'Engine_Decompressed.wMessage_Game', iCodeID, PlayerReplicationInfo);
                            }
                            C = C.nextController;
                            // [Loop Continue]
                            goto J0x3B8;
    ...
    switch(VoiceLanguage)
    {
        ...
        case "chinese":
            ...
            if(iTeamIndex == 0)
            {
                Class'Engine_Decompressed.wGameManager'.default.TeamIndex = 0;
                // End:0x195
                if(Class'Engine_Decompressed.wGameManager'.default.VoicePackageName != Class'Engine_Decompressed.wMessage_Game'.default.PackageCH_AF)
                {
                    bPackageChanged = true;
                }
                Class'Engine_Decompressed.wGameManager'.default.VoicePackageName = Class'Engine_Decompressed.wMessage_Game'.default.PackageCH_AF;
                VoiceType = Class'Engine_Decompressed.wMessage_Game'.default.PackageCH_AF;                
            }
            else
            {
                // End:0x23E
                if(iTeamIndex == 1)
                {
                    Class'Engine_Decompressed.wGameManager'.default.TeamIndex = 1;
                    // End:0x20D
                    if(Class'Engine_Decompressed.wGameManager'.default.VoicePackageName != Class'Engine_Decompressed.wMessage_Game'.default.PackageCH_RSA)
                    {
                        bPackageChanged = true;
                    }
                    Class'Engine_Decompressed.wGameManager'.default.VoicePackageName = Class'Engine_Decompressed.wMessage_Game'.default.PackageCH_RSA;
                    VoiceType = Class'Engine_Decompressed.wMessage_Game'.default.PackageCH_RSA;
                }
            }
...
function ChangeVoiceObjectLanguage(out string voiceObjectName)
{
    ...
    voiceObjectName = (Class'Engine_Decompressed.wGameManager'.default.VoicePackageName $ "/") $ rearDivide;
    //return;    
}
...
state PlayerWalking
{
    ...
    function BeginState()
    {
        ...
        if(Pawn != none)
        {
            ...
            // End:0x27E
            if((((self == Level.GetLocalPlayerController()) && Pawn.PlayerReplicationInfo.IsInvulnerable) && Level.GetMatchMaker().kGame_GameMode != Class'Engine_Decompressed.wGameSettings'.static.GetModeIndex_SD()) && !GameReplicationInfo.WaitingForStart)
            {
                // End:0x269
