...
var float m_afDropItem[5];
var float m_BlackBoxItemID;
var float m_BlackBoxInfo;
...
function CopyTo(wMapInfo Dest)
{
    ...
    if(i < int(5))
    {
        Dest.m_afDropItem[i] = m_afDropItem[i];
        ++i;
        // [Loop Continue]
        goto J0x6B;
    }
    Dest.m_BlackBoxItemID = m_BlackBoxItemID;
    Dest.m_BlackBoxInfo = m_BlackBoxInfo;
    ...
    Dest.ModeAlien_Max = ModeAlien_Max;
