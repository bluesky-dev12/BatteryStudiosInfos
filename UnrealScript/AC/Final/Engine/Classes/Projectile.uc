...
singular simulated function HitWall(Vector HitNormal, Actor Wall, Material HitMaterial)
{
    ...
    SpawnExplosionDecal(PC, HitNormal);
    HurtWall = none;
    //return;    
}

simulated function SpawnExplosionDecal(PlayerController PC, Vector HitNormal)
{
    // End:0x11B
...
defaultproperties
{
    ...
    LifeSpan=14.0000000
    Texture=Texture'Engine_Decompressed.S_Camera'
    bUnlit=true
    bGameRelevant=true
    bCanBeDamaged=true
