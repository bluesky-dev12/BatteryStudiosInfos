...
function bool IsEnableEquipGrenade(int ItemID, int ItemID1)
{
    ...
    WBP = GetBaseParam(ItemID);
    // End:0x3D
    if(int(WBP.eType) != int(5))
    {
        return true;
    }
    wbp1 = GetBaseParam(ItemID1);
    // End:0x69
...
defaultproperties
{
    ...
    arr_szResClass[79]="WWeapons_Res.wWeaponRes_AK47Custom"
    ...
    arr_szResClass[122]="WWeapons_Res.wWeaponRes_M4Custom_Drum"
    arr_szResClass[123]="WWeapons_Res.wWeaponRes_P90_Custom"
    arr_szResClass[124]="WWeapons_Res.wWeaponRes_Flamethrower_02"
    arr_szResClass[125]="WWeapons_Res.wWeaponRes_DesertEagle_Dual"
    arr_szResClass[126]="WWeapons_Res.wWeaponRes_Dragunov_Summer"
    arr_szResClass[127]="WWeapons_Res.wWeaponRes_DesertEagle_Summer"
    arr_szResClass[128]="WWeapons_Res.wWeaponRes_Kbar"
    arr_szResClass[129]="WWeapons_Res.wWeaponRes_ColdSteel"
    arr_szResClass[130]="WWeapons_Res.wWeaponRes_FragGrenade_Water"
