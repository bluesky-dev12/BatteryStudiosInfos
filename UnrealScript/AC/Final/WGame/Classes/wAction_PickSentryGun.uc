class wAction_PickSentryGun extends wAction;

var Pickup Pack;

function wAction_PickSentryGun Init(Pickup inPack)
{
    Pack = inPack;
...
function Sim_PostEffect(wStateData ws)
{
    ws.FreeLegs = true;
    ws.FlagIamOn = none;
    ws.MeetNewEnemyProbabilty += (Class'WGame_Decompressed.wAction_Explore'.static.CalcMeetNewEnemyProbability(ws) * float(2));
