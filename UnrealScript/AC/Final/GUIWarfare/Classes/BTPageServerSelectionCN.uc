...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    if(AdvertiseURL[0] == "")
    {
        ChannelADSmall = NewButtonComponent(Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(663.0000000, 472.0000000, 1012.0000000, 738.0000000));
        ChannelADSmall.buttonImage[0] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.ad_serverchannel;
        ChannelADSmall.buttonImage[1] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.ad_serverchannel;
        ChannelADSmall.buttonImage[2] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.ad_serverchannel;
        ChannelADSmall.buttonImage[3] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.ad_serverchannel;
        ChannelADSmall.buttonImage[4] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.ad_serverchannel;
        ChannelADSmall.buttonImage[5] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.ad_serverchannel;
    ...
    if(AdvertiseURL[1] == "")
    {
        ChannelADLarge = NewButtonComponent(Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(6.0000000, 114.0000000, 318.0000000, 730.0000000));
        ChannelADLarge.buttonImage[0] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.Ad_ServerChannel2;
        ChannelADLarge.buttonImage[1] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.Ad_ServerChannel2;
        ChannelADLarge.buttonImage[2] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.Ad_ServerChannel2;
        ChannelADLarge.buttonImage[3] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.Ad_ServerChannel2;
        ChannelADLarge.buttonImage[4] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.Ad_ServerChannel2;
        ChannelADLarge.buttonImage[5] = Class'GUIWarfareControls.BTUIResourcePoolHK'.default.Ad_ServerChannel2;
    ...
    TPTopMenu.Option.SetVisibility(false);
    //return;    
}
...
function bool rfAckLimitedListInChannel(int Result, array<int> LimitedMapID, array<int> LimitedModeID)
{
    ...
    Log("[BTPageServerSelection::rfAckLimitedListInChannel] Result -" $ string(Result));
    // End:0x6E
    if(Result != 0)
    {
        Class'GUIWarfareControls.BTWindowErrorDefineHK'.static.ShowError(Controller, Result);
    ...
    {
        Log((("(" $ string(i)) $ ") MapID = ") $ string(LimitedMapID[i]));
        MM.ChannelRestrictionMaps[i] = LimitedMapID[i];
        i++;
        // [Loop Continue]
        goto J0xE1;
    }
    Log("==== LimitedModeID From Server ====");
    ...
    {
        Log((("(" $ string(i)) $ ") ModeID = ") $ string(LimitedModeID[i]));
...
function bool rfAckPaidItem_RelayBroadcast(string CharName, string Msg)
{
    ...
    Log((("[BTPageServerSelectionCN::rfAckPaidItem_RelayBroadcast] [" $ CharName) $ "] ") $ Msg);
    // End:0x7C
    if(CharName != "")
    {
...
function bool rfAckQSlotList(int Result, string ErrMsg, array<int> QSlotID, array<string> QSlotName, array<byte> QSlotDispOrder, array<BtrDouble> MWItemID, array<BtrDouble> PistolItemID, array<BtrDouble> TWItemID1, array<BtrDouble> TWItemID2, array<int> Skill1, array<int> Skill2, array<int> Skill3, array<int> Skill4, array<BtrDouble> KnifeItemID)
{
    ...
    if(Result == 0)
    {
        ...
        if(i < QSlotID.Length)
        {
            ...
            instanceInfo = GameMgr.FindInstanceItem(KnifeItemID[i]);
            // End:0x5F3
            if(instanceInfo != none)
            {
                GameMgr.SetQuickSlotBox_Item(DispOrder, 4, instanceInfo.ItemID, KnifeItemID[i]);
                PlayerOwner().dblog(((("4 WeaponID = (" $ string(instanceInfo.ItemID)) $ ") Dur = (") $ string(instanceInfo.Durability)) $ ")");
            }
...
function bool AD_Small_OnClick(GUIComponent Sender)
{
    ...
    downTex = DownloadTexture(Class'GUIWarfareControls.BTUIResourcePoolHK'.default.ad_serverchannel.Image);
    // End:0x83
...
function bool AD_Large_OnClick(GUIComponent Sender)
{
    ...
    downTex = DownloadTexture(Class'GUIWarfareControls.BTUIResourcePoolHK'.default.Ad_ServerChannel2.Image);
    // End:0x83
    if((downTex != none) && downTex.bIsExistLink == true)
    {
        PlayerOwner().Level.ConsoleCommand("ShellExecute OP=open FILE=" $ downTex.strLinkFileName);
