...
function bool ConnectDomain(string domain, int nPort)
{
    return RealOne.ConnectDomain(domain, nPort);
    //return;    
}
...
function bool rfAckMyEquipedQSlotList(array<byte> QSlotDispOrder, array<BtrDouble> MWUniqueID, array<int> MWItemID, array<int> MWPartID, array<int> MWPaintID, array<BtrDouble> PistolUniqueID, array<int> PistolItemID, array<int> PistolPartID, array<int> PistolPaintID, array<BtrDouble> TW1UniqueID, array<int> TWItemID1, array<BtrDouble> TW2UniqueID, array<int> TWItemID2, array<int> Skill1ID, array<int> Skill2ID, array<int> Skill3ID, array<int> Skill4ID, int Result, array<BtrDouble> KnifeUniqueID, array<int> KnifeItemID)
{
    ...
    if(lp1 < QSlotDispOrder.Length)
    {
        ...
        MM.UserInfos[0].EquippedQSlots[idx].ItemID[4] = KnifeItemID[lp1];
...
function bool sfReqEquipItem(int ItemID, BtrDouble UniqueID, int SlotPos_Key, byte SlotPos_Value)
{
    return RealOne.sfReqEquipItem(ItemID, UniqueID, SlotPos_Key, SlotPos_Value);
    //return;    
}
...
function bool sfReqUpdateQSlot(int QSlotID, string QSlotName, BtrDouble MWItemID, BtrDouble PistolItemID, BtrDouble TWItemID1, BtrDouble TWItemID2, int Skill1, int Skill2, int Skill3, int Skill4, BtrDouble KnifeItemID)
{
    return RealOne.sfReqUpdateQSlot(QSlotID, QSlotName, MWItemID, PistolItemID, TWItemID1, TWItemID2, Skill1, Skill2, Skill3, Skill4, KnifeItemID);
    //return;    
}
...
function bool rfAckQSlotList(int Result, string ErrMsg, array<int> QSlotID, array<string> QSlotName, array<byte> QSlotDispOrder, array<BtrDouble> MWItemID, array<BtrDouble> PistolItemID, array<BtrDouble> TWItemID1, array<BtrDouble> TWItemID2, array<int> Skill1, array<int> Skill2, array<int> Skill3, array<int> Skill4, array<BtrDouble> KnifeItemID)
{
    ...
    // End:0xBB [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckQSlotList(Result, ErrMsg, QSlotID, QSlotName, QSlotDispOrder, MWItemID, PistolItemID, TWItemID1, TWItemID2, Skill1, Skill2, Skill3, Skill4, KnifeItemID))
    {
        // [Loop Continue]
        goto J0x37;
    }
...
{
    Log("[BTTcpHandler::rfAckQSlotList_2]");
    i = MainMenu.Pages.Length;
    J0x39:

    // End:0x9A [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckQSlotList_2(Result, ErrMsg, QSlotDispOrder, QSlotIDX, ItemTID, ItemUID, SlotPos))
    {
        // [Loop Continue]
        goto J0x39;
    }
...
function bool rfAckEntryQSlotIDList(int UserNum, array<byte> QSlotDispOrder, array<int> MWItemID, array<int> MWPartID, array<int> MWPaintID, array<int> PistolItemID, array<int> PistolPartID, array<int> PistolPaintID, array<int> TWItemID1, array<int> TWItemID2, array<int> Skill1ID, array<int> Skill2ID, array<int> Skill3ID, array<int> Skill4ID, array<int> KWItemID)
{
    ...
    // End:0xC7 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckEntryQSlotIDList(UserNum, QSlotDispOrder, MWItemID, MWPartID, MWPaintID, PistolItemID, PistolPartID, PistolPaintID, TWItemID1, TWItemID2, Skill1ID, Skill2ID, Skill3ID, Skill4ID, KWItemID))
    {
        // [Loop Continue]
        goto J0x3E;
    }
...
function bool rfAckEntryQSlotUniqueIDList(int UserNum, array<byte> QSlotDispOrder, array<BtrDouble> MWUniqueID, array<BtrDouble> PistolUniqueID, array<BtrDouble> TW1UniqueID, array<BtrDouble> TW2UniqueID, array<BtrDouble> KnifeUniqueID)
{
    ...
    // End:0xA5 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckEntryQSlotUniqueIDList(UserNum, QSlotDispOrder, MWUniqueID, PistolUniqueID, TW1UniqueID, TW2UniqueID, KnifeUniqueID))
    {
        // [Loop Continue]
        goto J0x44;
    }
...
function bool rfAckNotifyExpiredItemIDs(array<byte> DisplayOrder, array<byte> SlotPos, array<int> ItemTID, array<BtrDouble> ItemUID)
{
    ...
    // End:0x94 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckNotifyExpiredItemIDs(DisplayOrder, SlotPos, ItemTID, ItemUID))
    {
        // [Loop Continue]
        goto J0x42;
    }
...
function bool rfAckNotifyExpiredSkillIDs(array<byte> DisplayOrder, array<byte> SlotPos, array<int> ItemTID, array<BtrDouble> ItemUID)
{
    ...
    // End:0x95 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckNotifyExpiredSkillIDs(DisplayOrder, SlotPos, ItemTID, ItemUID))
    {
        // [Loop Continue]
        goto J0x43;
    }
...
{
    GameMgr.ReceiveRandomBox_Use = true;
...
{
    Log("[BTTcpHandler::rfAckExclusivePcItemList] Length : " $ string(ItemTID.Length));
    i = MainMenu.Pages.Length;
    J0x55:

    // End:0x9D [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckPcBangItemList(ItemTID, PartID))
    {
        // [Loop Continue]
        goto J0x55;
    }
...
{
    Log("[BTTcpHandler::rfAckUpdateQSlot_2] Result : " $ string(Result));
    i = MainMenu.Pages.Length;
    J0x4E:

    // End:0xAF [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckUpdateQSlot_2(Result, ErrMsg, DisplayOrder, ItemTID, ItemUID, SlotPos_Key, SlotPos_Value))
    {
        // [Loop Continue]
        goto J0x4E;
    }
...
function bool rfAckExpandSlotConfirm(int Result, string ErrMsg, int QSlotID, BtrDouble MWItemID, BtrDouble PistolItemID, BtrDouble TWItemID1, BtrDouble TWItemID2, int Skill1, int Skill2, int Skill3, int Skill4, BtrDouble KnifeItemID)
{
    ...
    // End:0x8F [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfAckExpandSlotConfirm(Result, ErrMsg, QSlotID, MWItemID, PistolItemID, TWItemID1, TWItemID2, Skill1, Skill2, Skill3, Skill4, KnifeItemID))
    {
        // [Loop Continue]
        goto J0x15;
    }
...
function bool rfNotifyPcBangInfo(byte PcBang_Grade)
{
    i = MainMenu.Pages.Length;
    J0x15:

    // End:0x58 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfNotifyPcBangInfo(PcBang_Grade))
    {
        // [Loop Continue]
        goto J0x15;
    }
...
function bool rfReqAddSpecialRank(string NickName)
{
    ...
    // End:0x58 [Loop If]
    if((i > 0) && !MainMenu.Pages[--i].TcpChannel.rfReqAddSpecialRank(NickName))
    {
        // [Loop Continue]
        goto J0x15;
    }
