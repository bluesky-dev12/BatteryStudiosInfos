...
function SetDefaultWeapon(int SlotIndex)
{
    switch(SlotIndex)
    {
        // End:0x82
        case 0:
            GameMgr.ChangeInstance_DefaultWeapon(int(0));
            // End:0x61
            if(page_Main.EquipQuickSlot(0, 0, GameMgr.GetMainWeaponID(), GameMgr.GetMainWeaponUniqueID(), false))
            {
        ...
        // End:0xFD
        case 1:
            GameMgr.ChangeInstance_DefaultWeapon(int(1));
            // End:0xDC
            if(page_Main.EquipQuickSlot(0, 1, GameMgr.GetSubWeaponID(), GameMgr.GetSubWeaponUniqueID(), false))
            {
                page_Main.UpdateReqQuickSlot();
            }
...
defaultproperties
{
    ...
    OnRendered=BTNetGUIPageHK.Internal_OnRendered
}