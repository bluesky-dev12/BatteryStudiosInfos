...
var() bool bUseMyInactiveFadeColor;
...
//var delegate<GetFocus> __GetFocus__Delegate;
//var delegate<LostFocus> __LostFocus__Delegate;
...
delegate LostFocus(GUIPage NewMenu)
{
    //return;    
}
