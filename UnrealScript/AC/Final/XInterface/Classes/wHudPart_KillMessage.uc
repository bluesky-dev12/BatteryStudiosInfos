...
struct native KillMessageItem
{
    ...
    var bool KillerIsBot;
    var bool VictimIsBot;
    var int iBotType;
    var Material ImageKiller;
    var Material ImageVictim;
    var IntBoxWH ImageKillerCoord;
    var IntBoxWH ImageVictimCoord;
    var bool Cached;
...
var() SpriteWidget SpriteWeaponAlienHands;
var int CacheClipX;
var int CacheClipY;
...
function Color GetNameColor(PlayerReplicationInfo PRI)
{
    ...
    // End:0xB8
    if((MM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_DeathMatch()) || MM.kGame_GameMode == Class'Engine.wGameSettings'.static.GetModeIndex_BotDeathMatch())
    {
        // End:0xA3
    ...
    else
    {
        ...
        {
            // End:0x127
            if(HudOwner.PlayerOwner.PlayerReplicationInfo.GetTeamIndex() == 0)
            {
        ...
        {
            return HudOwner.GetBaseTeamColor(HudOwner.PlayerOwner.PlayerReplicationInfo.GetTeamIndex(), PRI.GetTeamIndex());
        }
    }
    //return;    
}
