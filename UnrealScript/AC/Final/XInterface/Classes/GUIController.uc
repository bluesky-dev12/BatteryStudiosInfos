...
var string MouseOverSound;
var string ClickSound;
var string EditSound;
var string UpSound;
var string DownSound;
var string DragSound;
var string FadeSound;
var string ItemEquipSuccessSound;
var string ItemEquipFailSound;
var string ItemTakeoffSound;
var string ItemAddPartsSound;
var string ItemRepairSound;
var string ItemClickSound;
var string ItemBuySound;
var string ItemSellSound;
var string TrophyWindowSound;
var string TrophyReceiverUserSound;
...
protected event PopMenu(int Index, GUIPage CurMenu, optional bool bCancelled)
{
    ...
    if(MenuStack.Length > 0)
    {
        CurMenu.LostFocus(MenuStack[MenuStack.Length - 1]);
        MenuStack[MenuStack.Length - 1].GetFocus();        
    }
    else
    {
        CurMenu.LostFocus(none);
    }
    //return;    
}
...
defaultproperties
{
    ...
    FastCursorStep=1
    CursorStep=1
    ItemEquipSuccessSound="Warfare_Sound_UI/Item/success"
    ItemEquipFailSound="Warfare_Sound_UI/Item/fail"
    ItemTakeoffSound="Warfare_Sound_UI/Item/takeoff"
    ItemAddPartsSound="Warfare_Sound_UI/Item/parts"
    ItemRepairSound="Warfare_Sound_UI/Item/repair"
    ItemClickSound="Warfare_Sound_UI/Item/click"
    ItemBuySound="Warfare_Sound_UI/Shop/buy"
    ItemSellSound="Warfare_Sound_UI/Shop/sell"
    TrophyWindowSound="Warfare_Sound_UI/Result/item_open"
    TrophyReceiverUserSound="Warfare_Sound_UI/Result/user_open"
