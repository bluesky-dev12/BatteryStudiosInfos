...
function CallItemBuy(optional int iKey, optional int iReservation1, optional int iReservation2)
{
    ...
    if((iKey > 0) && iKey < 7)
    {
        strMessage = strItemName[iKey - 1] $ Class'Engine.wMessage_Game_Defence'.default.lsItemBuyOK;
