...
function FloatBox GetTooltipPosFinal(int tooltipWidth, int tooltipHeight, float CursorUSize, float CursorVSize, optional int nOffsetX, optional int nOffsetY)
{
