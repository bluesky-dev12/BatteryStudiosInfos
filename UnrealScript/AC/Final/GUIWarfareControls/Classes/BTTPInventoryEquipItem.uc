...
function UnequipItem(int ButtonID)
{
    ...
    if(ib.itemBox.instanceInfo != none)
    {
        ...
        TcpChannel.sfReqEquipItem(ib.itemBox.instanceInfo.ItemID, ib.itemBox.instanceInfo.UniqueID, ib.itemBox.instanceInfo.SlotPosition, 0);
    }
    //return;    
}
...
defaultproperties
{
    ...
    strEquipItemSlot[0]="Helmet"
    strEquipItemSlot[1]="Face"
    strEquipItemSlot[2]="Backpack"
    strEquipItemSlot[3]="AF"
    strEquipItemSlot[4]="RSA"
    strEquipItemSlot[5]="Fake Rank"
    strEquipItemSlot[6]="Pouch"
    strEquipItemSlot[7]="Camoflauge"
    strAF="AF"
    strRSA="RSA"
