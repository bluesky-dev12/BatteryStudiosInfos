...
function ButtonItemBox_OnChangeItemInfo1(int Index)
{
    ...
    ButtonItemBox[0].SetData(GameMgr.CandidateLists[Index], none, false);
...
function ButtonItemBox_OnChangeItemInfoEnd1()
{
    ...
    ButtonItemBox[0].SetData(SaveItemInfo[0], SaveInstanceInfo[0], false);
...
function ButtonItemBox_OnChangeItemInfo2(int Index)
{
    ...
    GameMgr = Controller.ViewportOwner.Actor.Level.GameMgr;
    ButtonItemBox[1].SetData(GameMgr.CandidateLists[Index], none, false);
...
function ButtonItemBox_OnChangeItemInfoEnd2()
{
    ...
    ButtonItemBox[1].SetData(SaveItemInfo[1], SaveInstanceInfo[1], false);
...
function SetData(string MyNickName, string TrophyReceiver1, string TrophyReceiver2, wItemBoxHK ItemInfo1, wItemBoxInstanceHK InstanceInfo1, wItemBoxHK ItemInfo2, wItemBoxInstanceHK InstanceInfo2, optional BTROModelWeapon ro1, optional BTROModelWeapon ro2)
{
    ...
    ButtonItemBox[0].SetData(GameMgr.CandidateLists[0], none, false);
    ...
    ButtonItemBox[1].SetData(GameMgr.CandidateLists[0], none, false);
...
{
    PlayerOwner().FmodClientPlaySound("Warfare_Sound_UI/Result/item_open",,, 6);
    //return;    
}
