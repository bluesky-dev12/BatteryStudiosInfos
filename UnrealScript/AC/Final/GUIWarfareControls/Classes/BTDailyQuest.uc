...
defaultproperties
{
    strDaily[0]="Receive the additional reward below by completing the puzzle rewarded from the daily mission."
    strDaily[1]="Puzzle Reward (Capsule)"
    strDaily[2]="Receive reward"
