...
function OnRendered(Canvas C)
{
    ...
    Class'Engine.BTCustomDrawHK'.static.DrawStringRatio(C, myName, 4, float(fntSize + 4), 811.0000000, 533.0000000, 966.0000000, 550.0000000);
    Class'Engine.BTCustomDrawHK'.static.DrawStringPaddingOffsetRatio(C, strExp, 3, float(fntSize), 774.0000000, 585.0000000, 841.0000000, 598.0000000, 0, 0, 0, 0);
    Class'Engine.BTCustomDrawHK'.static.DrawStringPaddingOffsetRatio(C, strPoint, 3, float(fntSize), 774.0000000, 622.0000000, 841.0000000, 635.0000000, 0, 0, 0, 0);
    Class'Engine.BTCustomDrawHK'.static.DrawStringPaddingOffsetRatio(C, strRanking[0], 3, float(fntSize), 774.0000000, 645.0000000, 841.0000000, 658.0000000, 0, 0, 0, 0);
    Class'Engine.BTCustomDrawHK'.static.DrawStringPaddingOffsetRatio(C, strRecord, 3, float(fntSize), 774.0000000, 668.0000000, 841.0000000, 681.0000000, 0, 0, 0, 0);
    Class'Engine.BTCustomDrawHK'.static.DrawStringPaddingOffsetRatio(C, strClan, 3, float(fntSize), 774.0000000, 691.0000000, 841.0000000, 704.0000000, 0, 0, 0, 0);
    i = 0;
    ...
    if(ClanName != "")
    {
        ...
        roClanMark.Render(C);
        Class'Engine.BTCustomDrawHK'.static.DrawStringPaddingOffsetRatio(C, ClanName, 3, float(fntSize), 881.0000000, 691.0000000, 1005.0000000, 704.0000000, 0, 0, 0, 0);
    }
    i = 1;
    C.DrawColor = DescColor;
    Class'Engine.BTCustomDrawHK'.static.DrawTextArrayRatio(C, taRanking, 3, 0, 843.0000000, 645.0000000, 1005.0000000, 658.0000000);
    i = 2;
    C.DrawColor = DescColor;
    expbar.AWinPos = Class'Engine.BTCustomDrawHK'.static.MakeFloatBox(839.0000000, 578.0000000, 993.0000000, 606.0000000);
    expbar.Render(C);
    Class'Engine.BTCustomDrawHK'.static.DrawTextArrayRatio(C, taExpbar, 4, 0, 850.0000000, 584.0000000, 980.0000000, 597.0000000);
    i = 3;
    C.DrawColor = DescColor;
    Class'Engine.BTCustomDrawHK'.static.DrawImagePaddingOffsetRatio(C, Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.newimg_point_LC, 843.0000000, 621.0000000, 858.0000000, 636.0000000, 0, 0, 0, 0);
    Class'Engine.BTCustomDrawHK'.static.DrawTextPaddingOffsetRatio(C, tPoint, 863.0000000, 622.0000000, 1005.0000000, 635.0000000, 0, 0, 0, 0);
    i = 4;
    C.DrawColor = DescColor;
    Class'Engine.BTCustomDrawHK'.static.DrawStringPaddingOffsetRatio(C, strWinLose, 3, float(fntSize), 843.0000000, 668.0000000, 1005.0000000, 681.0000000, 0, 0, 0, 0);
    //return;    
}
