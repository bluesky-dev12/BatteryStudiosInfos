...
function ItemBuyWindowProcess(int ItemID)
{
    ...
    if(cii != none)
    {
        Class'GUIWarfareControls_Decompressed.BTWindowSelectCashTypeHK'.static.ShowWindowSelectCashType(Controller, TempRO, 0);
...
defaultproperties
{
    ...
    strOpening="Opening Supply Box…"
    strCongratulation="Congratulations! You have received these items."
    strReOpen="Would you like to open more?"
    strUseCapsule="Open again"
    strInventory="Go to Inventory"
    strBestItemGet[0]="Congratulations!!"
    strBestItemGet[1]="You have received a Best item."
