...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    super(BTTabPanelHK).InitComponent(MyController, myOwner);
    fb.X1 = AWinPos.X1;
    ...
    ButtonChatState.buttonImage[0] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Lobby_ChatBtnUp_small_n;
    ButtonChatState.buttonImage[1] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Lobby_ChatBtnUp_small_on;
    ButtonChatState.buttonImage[2] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Lobby_ChatBtnUp_small_n;
    ButtonChatState.buttonImage[3] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Lobby_ChatBtnUp_small_cli;
    ButtonChatState.buttonImage[4] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Lobby_ChatBtnUp_small_block;
    ButtonChatState.buttonImage[5] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Lobby_ChatBtnUp_small_on;
...
function bool Internal_OnPreDraw(Canvas C)
{
    ...
    if(bShowAni)
    {
        ...
        if(bShowChatState)
        {
            ...
            {
                ButtonChatState.buttonImage[0] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Lobby_ChatBtnDn_small_n;
                ButtonChatState.buttonImage[1] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Lobby_ChatBtnDn_small_on;
                ButtonChatState.buttonImage[2] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Lobby_ChatBtnDn_small_n;
                ButtonChatState.buttonImage[3] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Lobby_ChatBtnDn_small_cli;
                ButtonChatState.buttonImage[4] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Lobby_ChatBtnDn_small_block;
                ButtonChatState.buttonImage[5] = Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Lobby_ChatBtnDn_small_on;
                i = 0;
                J0x220:
