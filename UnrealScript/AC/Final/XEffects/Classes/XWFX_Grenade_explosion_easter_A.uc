class XWFX_Grenade_explosion_easter_A extends Emitter;
...
defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_easter_A.SpriteEmitter252'
    ...
    Emitters[0]=SpriteEmitter252
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_easter_A.SpriteEmitter253'
    begin object name="SpriteEmitter253" class=Engine.SpriteEmitter
        ...
        Texture=Texture'FX_TEX.Event_Cash_Gacha.explo_star'
    ...
    Emitters[1]=SpriteEmitter253
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_easter_A.SpriteEmitter264'
    ...
    Emitters[2]=SpriteEmitter264
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_easter_A.SpriteEmitter265'
    ...
    Emitters[3]=SpriteEmitter265
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_easter_A.SpriteEmitter266'
    ...
    Emitters[4]=SpriteEmitter266
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_easter_A.SpriteEmitter267'
    begin object name="SpriteEmitter267" class=Engine.SpriteEmitter
        ...
        Texture=Texture'FX_TEX.Event_Cash_Gacha.easter_01_noalpha'
        LifetimeRange=(Min=0.5000000,Max=0.5000000)
        InitialDelayRange=(Min=0.1000000,Max=0.1000000)
    end object
    Emitters[5]=SpriteEmitter267
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_easter_A.SpriteEmitter268'
    ...
    Emitters[6]=SpriteEmitter268
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Grenade_explosion_easter_A.SpriteEmitter269'
