class GibSentryBack extends Gib
    notplaceable;
...
simulated function SetTeam(string strSTMeshName)
{
    ...
    NewMesh = StaticMesh(DynamicLoadObject("Char_SentryGun_Gore_Static.SentryG01.SentryG01_GoreBackProp_St", Class'Engine.StaticMesh'));
