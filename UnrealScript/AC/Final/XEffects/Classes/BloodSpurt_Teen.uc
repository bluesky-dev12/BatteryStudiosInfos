class BloodSpurt_Teen extends wEmitter;
...
defaultproperties
{
    BloodDecalClass=Class'XEffects_Decompressed.BloodSplatter_Teen'
    ...
    HitEffectClass=Class'XEffects_Decompressed.HitEffect_Teen_Blood'
    mRegen=false
    mStartParticles=0
    mMaxParticles=0
    ...
    RemoteRole=2
    LifeSpan=5.5000000
    Skins[0]=Texture'FX_TEX.Hit_Effects.Blood_splatter'
    Style=5
}