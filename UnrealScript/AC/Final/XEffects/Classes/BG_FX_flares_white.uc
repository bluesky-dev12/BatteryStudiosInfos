class BG_FX_flares_white extends Emitter;

defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.BG_FX_flares_white.SpriteEmitter7'
    begin object name="SpriteEmitter7" class=Engine.SpriteEmitter
        ...
        Texture=Texture'FX_TEX.Flares.glow_white'
        LifetimeRange=(Min=1.1904759,Max=1.1904759)
    end object
