class GibSentryLFProp extends Gib
    notplaceable;
...
simulated function SetTeam(string strSTMeshName)
{
    ...
    NewMesh = StaticMesh(DynamicLoadObject("Char_SentryGun_Gore_Static.SentryG01.SentryG01_GoreLFProp_St", Class'Engine.StaticMesh'));
