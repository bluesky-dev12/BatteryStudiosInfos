class SR_MuzFlash_04_1RD_Orange extends wEmitter;
...
defaultproperties
{
    ...
    mNumTileColumns=4
    mNumTileRows=4
    mMeshNodes=StaticMesh'FX_StaticMesh.MuzzleFlash.Muzzleflash_04_1rd'
    DrawScale=1.5000000
    Skins[0]=FinalBlend'FX_TEX.Muzzle_Flashes_color.FB_Muzzleflash_04_1rd_Orange'
    Style=6
}