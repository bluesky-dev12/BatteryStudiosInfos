class GibSentryGunPoint extends Gib
    notplaceable;
...
simulated function SetTeam(string strSTMeshName)
{
    ...
    NewMesh = StaticMesh(DynamicLoadObject("Char_SentryGun_Gore_Static.SentryG01.SentryG01_GoreGunPoint_St", Class'Engine.StaticMesh'));
