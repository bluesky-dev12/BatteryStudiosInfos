...
function bool ProcessQuickEnter(int MapIndex, int GameMode, int WRestrict, int botLevel)
{
    ...
    if(i < ACLLobby.ACLRowList.Length)
    {
        ...
        {
            // End:0x153
            if((ACLLobby.ACLRowList[i].DataPerColumn[3].tempValue == MapInfos[MapIndex].MapID) && ACLLobby.ACLRowList[i].DataPerColumn[5].IntValue == WRestrict)
            {
                RoomList[RoomList.Length] = i;
            }
            // [Explicit Continue]
        ...
        {
            // End:0x263
            if((ACLLobby.ACLRowList[i].DataPerColumn[4].tempValue == GameMode) && ACLLobby.ACLRowList[i].DataPerColumn[3].tempValue == MapInfos[MapIndex].MapID)
            {
                RoomList[RoomList.Length] = i;
            }
            // [Explicit Continue]
        ...
        // End:0x318
        if(((ACLLobby.ACLRowList[i].DataPerColumn[3].tempValue == MapInfos[MapIndex].MapID) && ACLLobby.ACLRowList[i].DataPerColumn[5].IntValue == WRestrict) && ACLLobby.ACLRowList[i].DataPerColumn[4].tempValue == GameMode)
        {
            RoomList[RoomList.Length] = i;
        }
        J0x318:
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    TPMessenger.ACLMsg[int(TPMessenger.0)].__OnHitBottom__Delegate = TPMessenger_ACLMsg0_OnHitBottom;
...
function bool rfAckFriendPosition(int Result, string TargetCharName, string fServername, string fServerShortName, string fServerIP, int fServerPort, byte CurPos, byte CurState, int ChannelNum, string ChannelNickName, int GameRoomNum)
{
    local int i;
...
defaultproperties
{
    ...
    ListBottomButtonPosition[2]=(X1=445.0000000,Y1=460.0000000,X2=566.0000000,Y2=492.0000000)
    ListBottomButtonPosition[3]=(X1=570.0000000,Y1=460.0000000,X2=631.0000000,Y2=492.0000000)
