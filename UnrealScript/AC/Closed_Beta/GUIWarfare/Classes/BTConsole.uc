        ...
        if(ViewportOwner.Actor.bCanChangeQS)
        {
            ...
            if(ViewportOwner.Actor.bToggleQuickSlotWindow)
            {
                ...
                else
                {
                    ...
                    {
                        // End:0xFC
                        if(((int(Action) == int(1)) && IsHaveMainWeapon(1)) && BlockChangeWeapon(1))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            // End:0x143
                            if(((int(Action) == int(1)) && IsHaveMainWeapon(2)) && BlockChangeWeapon(2))
                            {
                        ...
                        else
                        {
                            ...
                            {
                                // End:0x18A
                                if(((int(Action) == int(1)) && IsHaveMainWeapon(3)) && BlockChangeWeapon(3))
                                {
...
function SendMessage(MessageItem msgItem)
{
    ...
    else
    {
        ...
        // End:0x1E3
        if(int(MM.GetGameModeNum(MM.szGameClass)) == int(MM.2))
        {
            TeamName = "";            
        }
        else
