...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    ButtonLR = NewButtonComponent(Class'Engine.BTCustomDrawHK'.static.MakeFloatBox((AFTeamBG.AWinPos.X1 + float(252)) + float(10), (AFTeamBG.AWinPos.Y1 + float(483)) + float(10), (AFTeamBG.AWinPos.X1 + float(303)) + float(10), (AFTeamBG.AWinPos.Y1 + float(514)) + float(10)), 0.8000000);
    ...
    ButtonRR = NewButtonComponent(Class'Engine.BTCustomDrawHK'.static.MakeFloatBox((AFTeamBG.AWinPos.X1 + float(5)) + float(10), (AFTeamBG.AWinPos.Y1 + float(483)) + float(10), (AFTeamBG.AWinPos.X1 + float(56)) + float(10), (AFTeamBG.AWinPos.Y1 + float(514)) + float(10)), 0.8000000);
...
defaultproperties
{
    ...
    strAF="AF"
    strRSA="RSA"
    strLabelLine[0]="Helmet"
    strLabelLine[1]="Face"
    strLabelLine[2]="Accessory"
    strLabelLine[3]="Nickname"
