...
{
    local int i, btnSizeX, btnSizeY, btnSpacingX, btnSpacingY;
    ...
    if(i < 3)
    {
        ...
        CalcCashLabel[i].CaptionDrawType = 4;
...
{
    local int i, iOrigSightPartID, iOrigSilencerPartID, iOrigBarrelPartID, iOrigGunstockPartID, iDestSightPartID,
	    iDestSilencerPartID, iDestBarrelPartID, iDestGunstockPartID;
