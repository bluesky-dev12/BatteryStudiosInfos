...
function OnRendered(Canvas C)
{
    ...
    Class'Engine.BTCustomDrawHK'.static.DrawStringPaddingOffset(C, Caption, 3, float(FontSize[SelectMenuState]), Bounds[0] + float(PaddingSize), Bounds[1], Bounds[2], Bounds[3], CaptionPadding[0], CaptionPadding[1], CaptionPadding[2], CaptionPadding[3], FontShadowColor[SelectMenuState]);
    //return;    
}
