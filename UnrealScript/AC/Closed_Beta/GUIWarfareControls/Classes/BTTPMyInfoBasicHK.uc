...
function InitializeContent()
{
    ...
    BTOwnerDrawTextArrayHK(Content[10]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeNormal();
    ...
    BTOwnerDrawTextArrayHK(Content[11]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeNormal();
    ...
    BTOwnerDrawTextArrayHK(Content[21]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeNormal();
    ...
    BTOwnerDrawTextArrayHK(Content[22]).tarray[1].DrawColor = Class'GUIWarfareControls_Decompressed.BTUIColorPoolHK'.static.GradeNormal();
    //return;    
}
...
defaultproperties
{
    ...
    strLabel[10]="Women's Rank"
    strLabel[11]="Women's Rank (M)"
    strLabel[12]="Headshot Rank"
    strLabel[13]="Headshot Rank (M)"
    strLabel[14]="Clan Contribution"
    strLabel[15]="Clan Battle Record"
    strLabel[16]="Clan Battle Info"
    strLabel[17]="Clan Headshots"
    strLabel[18]="Clan Withdrawals"
    strLabel[19]="Clan Rank"
    strLabel[20]="Clan Rank (M)"
    strLabel[21]="Force Quit"
    strLabel[22]="Total Play Time"
