...
{
    local int i, ScreenRatioIndex, TestRatioIndex, currentW, currentHT;
...
defaultproperties
{
    ...
    strTooltip[4]="Quickly optimize your graphics settings.<P>Recommended specifications for each option are as follows.<P> <P>[Ultra] P4 3.2 GHz, 2 GB RAM, GeForce 9800 GT or equivalent. <P> [High] P4 3.0 GHz, 2 GB RAM, GeForce 8600 GT or equivalent.<P>[Medium] P4 3.0 GHz, 2 GB RAM, GeForce 7600 GT or equivalent. <P>[Low] P4 2.8 GHz, 1 GB RAM, GeForce 6600 GT or equivalent. <P>[Lowest] P4 2.4 GHz, 1 GB RAM, GeForce FX 5700 or equivalent. "
