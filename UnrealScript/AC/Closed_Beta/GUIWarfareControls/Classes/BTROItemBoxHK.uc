...
{
    local int i, temp, iSightPartID, iSilencerPartID, iBarrelPartID, iGunstockPartID,
	    PartIndex;
...
function bool Render(Canvas C, optional float Delta)
{
    ...
    local float XL, YL, fbWidth, fbHeight;
    local FloatBox fb;
    ...
    else
    {
        ...
        else
        {
            ItemImage.DrawType = 1;
            // End:0x8FD
            if((((int(InvenState) == int(6)) || int(InvenState) == int(3)) || int(InvenState) == int(5)) || int(InvenState) == int(16))
            {
    ...
    else
    {
        ...
        if(ItemInfo != none)
        {
            ...
            {
                // End:0x162E
                if(((bShowRestrictionPrice && ItemInfo.PurchaseType == 1) && instanceInfo != none) && MyData.MyCash < instanceInfo.CashItemInfo.WZCashPrice[0])
                {
                    bRedCash = true;
                    ReasonCount++;                    
                }
    ...
    switch(RibbonState)
    {
        ...
        // End:0x1C80
        case 1:
            Class'Engine.BTCustomDrawHK'.static.DrawImage(C, Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Store_Item_Prop_Mark_Own, AWinPos.X2 - float(60), AWinPos.Y1, AWinPos.X2 - float(8), AWinPos.Y1 + float(31));
            // End:0x1DAF
            break;
        // End:0x1CE4
        case 2:
            Class'Engine.BTCustomDrawHK'.static.DrawImage(C, Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Store_Item_Prop_Mark_New, AWinPos.X2 - float(60), AWinPos.Y1, AWinPos.X2 - float(8), AWinPos.Y1 + float(31));
            // End:0x1DAF
            break;
        // End:0x1D48
        case 3:
            Class'Engine.BTCustomDrawHK'.static.DrawImage(C, Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Store_Item_Prop_Mark_Best, AWinPos.X2 - float(60), AWinPos.Y1, AWinPos.X2 - float(8), AWinPos.Y1 + float(31));
            // End:0x1DAF
            break;
        // End:0x1DAC
        case 4:
            Class'Engine.BTCustomDrawHK'.static.DrawImage(C, Class'GUIWarfareControls_Decompressed.BTUIResourcePoolHK'.default.Store_Item_Prop_Mark_Cool, AWinPos.X2 - float(60), AWinPos.Y1, AWinPos.X2 - float(8), AWinPos.Y1 + float(31));
            // End:0x1DAF
            break;
        // End:0xFFFF
        default:
