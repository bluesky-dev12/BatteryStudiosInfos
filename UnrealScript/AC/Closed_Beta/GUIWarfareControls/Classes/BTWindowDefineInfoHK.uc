...
static function string GetClientString(int Code)
{
    ...
    BTWindow = new Class'GUIWarfareControls_Decompressed.BTWindowDefineInfoHK';
    return BTWindow.strClientDefine[Code];
    //return;    
}
...
defaultproperties
{
    ...
    strClientDefine[186]="The clan name was changed from [%0] to [%1]. You must log off the game and log in again for the clan name change to take effect. You must log in again for clan functions to work correctly."
