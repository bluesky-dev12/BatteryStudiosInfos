...
function ShowAll(int Max, optional int Min)
{
    ...
    if(i < DataPool.Length)
    {
        ro = DataPool[i];
        // End:0x7D
        if((Min > 4) && (ro.ItemInfo.ItemType == 32) || ro.ItemInfo.ItemType == 33)
        {
            // [Explicit Continue]
            goto J0x138;
        }
        // End:0x138
        if((((ro.ItemInfo.ItemType <= Max) && ro.ItemInfo.ItemType >= Min) || ro.ItemInfo.ItemType == 32) || ro.ItemInfo.ItemType == 33)
        {
            // End:0x138
...
function ShowEtc()
{
    ...
    if(i < DataPool.Length)
    {
        ro = DataPool[i];
        // End:0xE3
        if((ro.ItemInfo.ItemType == 20) || ((ro.ItemInfo.ItemType > 24) && ro.ItemInfo.ItemType < 30) || ro.ItemInfo.ItemType == 34)
        {
            // End:0xE3
            if((bShowOnlyInventory == false) || ro.instanceInfo.SlotPosition == 13)
            {
