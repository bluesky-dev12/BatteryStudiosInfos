...
defaultproperties
{
    ...
    strClientDefine[42]="You have completed the tutorial. <10>Next, you will battle against the AI (computer) in a rookie mission. <10>By playing the rookie mission, you will receive <10>Grenades [Unrepairable] and a 50% Point increase as a quest reward.||OK"
    strClientDefine[43]="Let's begin with a tutorial to instruct you on the basics of battle.||OK"
    strClientDefine[44]="Next, you will battle against the AI (computer) in a rookie mission. <10>By playing the rookie mission, you will receive Grenades [Unrepairable] and a 50% Point increase as a reward. <10>?You can resume the tutorial by selecting it as the game mode in the Create Game menu.||OK"
