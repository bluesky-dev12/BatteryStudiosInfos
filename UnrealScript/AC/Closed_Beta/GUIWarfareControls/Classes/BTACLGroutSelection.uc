...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    MultiColumnList.NoVisibleCols = 2;
    MultiColumnList.MyScrollBar.Step = 2;
    ...
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("server_Group", 25.0000000, 7);
    ...
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("server_name", 200.0000000, 7);
    headerInfo.__CustomDraw__Delegate = LC1_Draw;
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("ping", 150.0000000, 7);
