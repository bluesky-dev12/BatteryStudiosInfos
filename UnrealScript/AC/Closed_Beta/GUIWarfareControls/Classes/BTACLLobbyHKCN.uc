...
function AddRoom(int SP, int no, int PASS, string room_name, string map_name, int map_num, int game_mode, int restrict, int CurUser, int MaxUser, int game_state, int Ping, string masterIP, int game_minute, int teambalance, string room_owner, int BotDifficult, int BotUserTeam, optional int cw_no)
{
    ...
    {
        row.DataPerColumn[5].strValue = strWeaponRestrict[restrict];
    }
...
function ChangeRoomInfo(int i, string room_name, string map_name, int map_num, int game_mode, byte IsTeamBalance, int CurUser, int MaxUser, int game_state, byte IsPW, byte BotDifficult, byte WeaponLimit, byte BotModeUserTeamNum)
{
    ...
    {
        ACLRowList[i].DataPerColumn[5].strValue = strWeaponRestrict[int(WeaponLimit)];
    }
...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("no", 34.0000000, 7);
    ...
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("map_name", 91.0000000, 7);
    headerInfo.__CustomDraw__Delegate = DrawMapName;
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("game_mode", 60.0000000, 7);
    headerInfo.__CustomDraw__Delegate = DrawGameMode;
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("restrict", 70.0000000, 7);
    headerInfo.__CustomDraw__Delegate = DrawSubMode;
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("curuser/maxuser", 40.0000000, 7);
    headerInfo.__CustomDraw__Delegate = LC7_Draw;
    self.AddColumn(headerInfo);
    headerInfo = Class'GUIWarfareControls_Decompressed.BTAutoColumnListHeaderHK'.static.MakeHeader("game_state", 44.0000000, 7);
