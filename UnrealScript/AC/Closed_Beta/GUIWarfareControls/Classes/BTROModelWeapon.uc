...
function SetWeaponParts(int iPartsID, optional int iPaintingID)
{
    ...
    if(iSightPartID > 1)
    {
        ...
        if((wcpp.iItemID > 0) && wcpp.iPartID == iSightPartID)
        {
            ...
            if(ItemResParam.iItemResourceID != -1)
            {
                ...
                {
                    wWeaponParts[0].Skins[0] = Material(DynamicLoadObject(ItemResParam.strRes_3rd_AF_Backpack, Class'Engine.Material'));
                }
    ...
    if(iSubSightPartItemID > 0)
    {
        ...
        if(ItemResParam.iItemResourceID != -1)
        {
            ...
            if(Len(ItemResParam.strRes_3rd_AF_Backpack) > 1)
            {
                wWeaponParts[2].Skins[0] = Material(DynamicLoadObject(ItemResParam.strRes_3rd_AF_Backpack, Class'Engine.Material'));
            }
    ...
    if(iSilencerPartID > (1 << 17))
    {
        ...
        if((wcpp.iItemID > 0) && wcpp.iPartID == iSilencerPartID)
        {
            ...
            if(ItemResParam.iItemResourceID != -1)
            {
                ...
                if(Len(ItemResParam.strRes_3rd_AF_Backpack) > 1)
                {
                    wWeaponParts[1].Skins[0] = Material(DynamicLoadObject(ItemResParam.strRes_3rd_AF_Backpack, Class'Engine.Material'));
                }
                // End:0x591
                if(Len(ItemResParam.strRes_3rd_AF_Backpack) > 1)
                {
