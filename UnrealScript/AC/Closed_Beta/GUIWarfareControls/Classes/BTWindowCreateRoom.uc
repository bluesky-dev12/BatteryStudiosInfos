...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    TeamBlanceRadioBtn = BTRadioOnOffButtonHK(NewComponent(new Class'GUIWarfareControls_Decompressed.BTRadioOnOffButtonHK', fbRadio, 0.3000000));
...
defaultproperties
{
    ...
    DefaultRoomNames[6]="The was has begun!"
