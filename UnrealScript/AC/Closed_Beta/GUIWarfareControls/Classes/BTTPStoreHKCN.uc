...
function InitComponent(GUIController MyController, GUIComponent myOwner)
{
    ...
    if(i < 1)
    {
        ...
        if(i == 0)
        {
            TPWeapon = new Class'GUIWarfareControls_Decompressed.BTTPStoreWeaponHKCN';
            serverTP = TPWeapon;
        }
...
defaultproperties
{
    // Reference: TabControlMocker'GUIWarfareControls_Decompressed.BTTPStoreHKCN.mTabControl'
