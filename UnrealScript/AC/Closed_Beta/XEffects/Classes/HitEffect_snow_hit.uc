...
defaultproperties
{
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_snow_hit.SpriteEmitter172'
    begin object name="SpriteEmitter172" class=Engine.SpriteEmitter
        ...
        Acceleration=(X=226.7906342,Y=79.2610855,Z=89.8301392)
        ColorScale=/* Array type was not detected. */
        Opacity=0.1500000
        FadeOutStartTime=0.3310610
        CoordinateSystem=1
        MaxParticles=2
        StartLocationOffset=(X=10.0000000,Y=0.0000000,Z=0.0000000)
        StartLocationShape=2
        SpinsPerSecondRange=(X=(Min=-0.3960000,Max=0.3960000),Y=(Min=0.1069200,Max=0.2138400),Z=(Min=0.1069200,Max=0.2138400))
        ...
        InitialParticlesPerSecond=10121.7597656
        DrawStyle=6
        Texture=Texture'FX_TEX.Smoke.smoke_fire'
        SubdivisionEnd=1
        LifetimeRange=(Min=1.4393940,Max=1.4393940)
        InitialDelayRange=(Min=0.1600000,Max=0.1600000)
        StartVelocityRange=(X=(Min=-56.9711990,Max=56.9711990),Y=(Min=-111.1968079,Max=111.1968079),Z=(Min=-37.0656013,Max=37.0656013))
        StartVelocityRadialRange=(Min=3.0000000,Max=3.0000000)
        GetVelocityDirectionFrom=3
    end object
    Emitters[0]=SpriteEmitter172
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_snow_hit.SpriteEmitter173'
    begin object name="SpriteEmitter173" class=Engine.SpriteEmitter
        FadeOut=true
        RespawnDeadParticles=false
        SpinParticles=true
        DampRotation=true
    ...
    Emitters[1]=SpriteEmitter173
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_snow_hit.SpriteEmitter174'
    begin object name="SpriteEmitter174" class=Engine.SpriteEmitter
        FadeOut=true
        FadeIn=true
        RespawnDeadParticles=false
        UseSizeScale=true
    ...
    Emitters[2]=SpriteEmitter174
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_snow_hit.SpriteEmitter179'
    ...
    Emitters[3]=SpriteEmitter179
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_snow_hit.SpriteEmitter180'
    ...
    Emitters[4]=SpriteEmitter180
    // Reference: SpriteEmitter'XEffects_Decompressed.HitEffect_snow_hit.SpriteEmitter181'
