...
defaultproperties
{
    ...
    begin object name="SpriteEmitter2" class=Engine.SpriteEmitter
        ...
        StartVelocityRange=(X=(Min=-3193.6960449,Max=3193.6960449),Y=(Min=-3193.6960449,Max=3193.6960449),Z=(Min=-1748.1140137,Max=721.6500244))
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Alien_explosion.SpriteEmitter4'
    begin object name="SpriteEmitter4" class=Engine.SpriteEmitter
        ...
        Acceleration=(X=0.0000000,Y=0.0000000,Z=-51.3242264)
        ColorScale=/* Array type was not detected. */
        ...
        MaxParticles=5
        StartLocationRange=(X=(Min=-168.0000000,Max=168.0000000),Y=(Min=-176.3999939,Max=176.3999939),Z=(Min=0.0000000,Max=0.0000000))
        ...
        StartSizeRange=(X=(Min=120.0000000,Max=120.0000000),Y=(Min=1170.0000000,Max=1170.0000000),Z=(Min=120.0000000,Max=120.0000000))
        ...
        InitialDelayRange=(Min=0.2000000,Max=0.2000000)
        StartVelocityRange=(X=(Min=-313.0209961,Max=313.0209961),Y=(Min=-313.0209961,Max=313.0209961),Z=(Min=231.5720062,Max=550.9819946))
    end object
    ...
    // Reference: SpriteEmitter'XEffects_Decompressed.XWFX_Alien_explosion.SpriteEmitter7'
    begin object name="SpriteEmitter7" class=Engine.SpriteEmitter
        ...
        UniformSize=true
        AutomaticInitialSpawning=false
        Acceleration=(X=11.6812811,Y=11.7201595,Z=178.8955383)
        ColorScale=/* Array type was not detected. */
        ...
        StartSpinRange=(X=(Min=-1.0000000,Max=1.0000000),Y=(Min=0.0000000,Max=0.0000000),Z=(Min=0.0000000,Max=0.0000000))
        SizeScale=/* Array type was not detected. */
        StartSizeRange=(X=(Min=201.6000061,Max=201.6000061),Y=(Min=201.6000061,Max=201.6000061),Z=(Min=201.6000061,Max=201.6000061))
        ...
        StartVelocityRange=(X=(Min=-172.2240143,Max=465.6960144),Y=(Min=-465.4656067,Max=465.4656067),Z=(Min=224.6399994,Max=786.2400513))
        MaxAbsVelocity=(X=0.0000000,Y=20.0000000,Z=0.0000000)
    end object
    ...
    Emitters[9]=SpriteEmitter10
    Emitters[10]=SpriteEmitter'XEffects_Decompressed.HitEffect_Teen_blood_hit.SpriteEmitter11'
    AutoDestroy=true
    LightType=10
    LightEffect=21
    LightHue=28
