class wWeaponRes_Vector extends wWeaponRes_Base;
...
defaultproperties
{
    ...
    sound_Fire=Sound'Warfare_Sound_Weapon.Vector.weapon_Vector_fire'
    sound_Fire_Stereo=Sound'Warfare_Sound_Weapon.Vector.weapon_Vector_fire_s'
    sound_Fire_Silencer=Sound'Warfare_Sound_Weapon.Vector.weapon_Vector_fire_silencer'
    sound_Fire_Silencer_Stereo=Sound'Warfare_Sound_Weapon.Vector.weapon_Vector_fire_silencer_s'
    ...
    sound_Reload=Sound'Warfare_Sound_Weapon.Vector.weapon_Vector_reload'
    sound_ReloadEmpty=Sound'Warfare_Sound_Weapon.Vector.weapon_Vector_reload_empty'
    sound_Select=Sound'Warfare_Sound_Weapon.Vector.weapon_Vector_select'
    sound_Pickup=SoundGroup'Warfare_Sound_Char.GetItem.char_getitem_weapon'
    sound_Select_New=Sound'Warfare_Sound_Weapon.Vector.weapon_Vector_select_n'
}