...
function Vector CalcAirStrikeLocation(float fMaxDist)
{
    ...
    kMM = Level.GetMatchMaker();
    // End:0xE2
    if((((kMM.kGame_GameMode == int(kMM.0)) || kMM.kGame_GameMode == int(kMM.3)) || kMM.kGame_GameMode == 5) || kMM.kGame_GameMode == int(kMM.4))
    {
...
exec function HIJ2()
{
    ...
    // End:0x37
    foreach DynamicActors(Class'WGame_Decompressed.wAIBotBase', B)
    {
        // End:0x36
