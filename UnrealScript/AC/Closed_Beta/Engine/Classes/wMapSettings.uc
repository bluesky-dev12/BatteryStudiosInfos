...
{
    // End:0xCA
    if((((((((LocStr == "dm-bootcamp") || LocStr == "dm-cqbhouse") || LocStr == "dm-arcticwind") || LocStr ~= "TUT-BasicTraining") || LocStr == "dm-mirage") || LocStr == "dm-sandstorm") || LocStr == "dm-newyork") || LocStr == "dm-mist")
    {
        return true;
    }
    return false;
...
{
    // End:0xFB
    if((((((((((LocStr == "dm-bootcamp") || LocStr == "dm-cqbhouse") || LocStr == "dm-arcticwind") || LocStr == "dm-downtown") || LocStr == "dm-quarterblow") || LocStr == "dm-mirage") || LocStr == "dm-sandstorm") || LocStr == "dm-newyork") || LocStr == "dm-arcbase") || LocStr == "dm-bigbang")
    {
        return true;
    }
    return false;
...
function int IsGameModeEnable(int MapID, int GameModeIdx)
{
    ...
    if(GameModeIdx == 13)
    {
        return int(gm.MapInfos[idx].ModeInfection);
    }
    return 1;
    //return;    
}
