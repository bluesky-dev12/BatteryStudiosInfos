...
static function PrecacheMaterials(LevelInfo Level)
{
    ...
    {
        Level.AddPrecacheMaterial(Material(DynamicLoadObject(default.szIcon_HUD, Class'Engine.Material')));
    }
    // End:0x60
    if(default.szIcon_Kill != "")
    {
        Level.AddPrecacheMaterial(Material(DynamicLoadObject(default.szIcon_Kill, Class'Engine.Material')));
    }
    //return;    
}
...
static function PrecacheSound()
{
    ...
    {
        DynamicLoadObject("" $ string(default.sound_Fire_Stereo), Class'Engine.Sound');
    }
    // End:0x42
    if(default.sound_Fire_Silencer_Stereo != none)
    {
        DynamicLoadObject("" $ string(default.sound_Fire_Silencer_Stereo), Class'Engine.Sound');
    }
    // End:0x63
    if(default.sound_Fire != none)
    {
        DynamicLoadObject("" $ string(default.sound_Fire), Class'Engine.Sound');
    }
    // End:0x84
    if(default.sound_Fire_Silencer != none)
    {
        DynamicLoadObject("" $ string(default.sound_Fire_Silencer), Class'Engine.Sound');
    }
    // End:0xA5
    if(default.sound_Fire_Shell != none)
    {
        DynamicLoadObject("" $ string(default.sound_Fire_Shell), Class'Engine.Sound');
    }
    // End:0xC6
    if(default.sound_Fire_Empty != none)
    {
        DynamicLoadObject("" $ string(default.sound_Fire_Empty), Class'Engine.Sound');
    }
    // End:0xE7
    if(default.sound_Melee_Ok != none)
    {
        DynamicLoadObject("" $ string(default.sound_Melee_Ok), Class'Engine.Sound');
    }
    // End:0x108
    if(default.sound_Melee_Miss != none)
    {
        DynamicLoadObject("" $ string(default.sound_Melee_Miss), Class'Engine.Sound');
    }
    // End:0x129
    if(default.sound_Reload != none)
    {
        DynamicLoadObject("" $ string(default.sound_Reload), Class'Engine.Sound');
    }
    // End:0x14A
    if(default.sound_ReloadEmpty != none)
    {
        DynamicLoadObject("" $ string(default.sound_ReloadEmpty), Class'Engine.Sound');
    }
    // End:0x16B
    if(default.sound_Select != none)
    {
        DynamicLoadObject("" $ string(default.sound_Select), Class'Engine.Sound');
    }
    // End:0x18C
    if(default.sound_Select_New != none)
    {
        DynamicLoadObject("" $ string(default.sound_Select_New), Class'Engine.Sound');
    }
    // End:0x1AD
    if(default.sound_Pickup != none)
    {
        DynamicLoadObject("" $ string(default.sound_Pickup), Class'Engine.Sound');
    }
    //return;    
}
...
defaultproperties
{
    ...
    rad_Fire_Silencer=150.0000000
    rad_Fire_Far=400.0000000
    rad_Fire_Stop=400.0000000
    rad_Reload=400.0000000
    rad_Explosion=400.0000000
    rad_Bullet_Move=400.0000000
}