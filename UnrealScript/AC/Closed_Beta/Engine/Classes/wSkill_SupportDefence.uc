...
simulated function UpdateProcess()
{
    ...
    if(Kills >= nSupplyValue)
    {
        ...
        if(nSupplyIndex == 0)
        {
            ...
            PC.ClientPlaySound(Sound(DynamicLoadObject(AirStrikeSoundPickUP, Class'Engine.Sound')),,, 0);
            PC.QueueAnnouncement(Class'Engine.wGameManager'.default.VoicePackageName $ AirStrikeSoundStandby, 1);
            PC.ReceiveMessage_QuestType2(Class'Engine.wMessage_Quest', Class'Engine.wMessage_Quest'.default.Code_Quest_AcquireTrophy,,,, 3);
            // End:0x24C
