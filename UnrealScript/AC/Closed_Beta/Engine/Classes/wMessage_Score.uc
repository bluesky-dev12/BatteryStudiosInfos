...
static simulated function PlaySoundMessageScore(PlayerController P, string SoundKind)
{
    switch(SoundKind)
    {
        ...
        case "FragGrenadeKill":
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AMsgGrenadeKillSound, Class'Engine.Sound')));
            // End:0x1B2
            break;
        // End:0x77
        case "MeleeKill":
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AMsgMeleeKillSound, Class'Engine.Sound')));
            // End:0x1B2
            break;
        // End:0xAD
        case "StepOnKill":
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AMsgStepOnKillSound, Class'Engine.Sound')));
            // End:0x1B2
            break;
        // End:0xE7
        case "SpecialETCKill":
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AMsgSpecialETCKillSound, Class'Engine.Sound')));
            // End:0x1B2
            break;
        // End:0x11B
        case "Helikill":
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AMsgHeliKillSound, Class'Engine.Sound')));
            // End:0x1B2
            break;
        // End:0x154
        case "Artillerykill":
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AMsgArtilleryKillSound, Class'Engine.Sound')));
            // End:0x1B2
            break;
        // End:0x188
        case "headshot":
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AMessageHeadshotSound, Class'Engine.Sound')));
            // End:0x1B2
            break;
        // End:0xFFFF
        default:
            P.ClientPlaySound(Sound(DynamicLoadObject(default.AMessageScoreSound, Class'Engine.Sound')));
            // End:0x1B2
            break;
            break;
    }
