...
replication
{
    ...
    reliable if(int(Role) < int(ROLE_Authority))
        ...
        ServerAcknowledgePossession, ServerCallAirStrike, 
        ServerCallHelicopter, ServerChangeTeam, 
        ServerChangeTeam3, ServerMutate, 
        ServerPause, ServerRequestWeapon, 
        ServerRestartGame, ServerSelectQSlot, 
        ServerSetClientDemo, ServerSetShakeRotation, 
        ServerSetViewValue, ServerSetwBreathRotation, 
        ServerSetwShakeRotation, ServerSetwShockRotation, 
        ServerSpectate, ServerSpectateSpeed, 
        ServerSpeech, ServerThrowWeapon, 
        ServerUseSupplyItem, ServerValidationResponse, 
        ServerVerifyViewTarget, ServerViewNextPlayer, 
        ServerWarp, SetPause, 
        Suicide, Typing;
...
simulated function ClientPlayVoiceSound(string strSoundName, optional bool bVolumeControl, optional float inAtten, optional Actor.ESoundSlot Slot)
{
    ...
    ASound = Sound(DynamicLoadObject(VoiceType $ strSoundName, Class'Engine.Sound'));
    // End:0x7A
    if(ViewTarget != none)
    {
        ViewTarget.DemoPlaySound(ASound, Slot, Atten,,,, false);
...
{
    // End:0x43
    if(kWeapon.BaseParams.szClass_Resource == "WWeapons_Res.wWeaponRes_FragGrenade")
    {
        return true;
    }
    return false;
    ...
    if(wShakeDeltaTime >= wShakeFixedTime)
    {
        ...
        switch(wShakeState)
        {
            ...
            case 1:
                ...
                // End:0x3FA
                if((Pawn != none) && (!Pawn.bIsAiming && Pawn.Weapon.wt_BoundingMax > 0) || Pawn.bIsAiming && Pawn.Weapon.wtAim_BoundingMax > 0)
                {
            ...
            case 2:
                ...
                if(wShakeStayingTime <= 0.0000000)
                {
                    ...
                    // End:0x5CB
                    if(((Pawn != none) && Pawn.Weapon != none) && Pawn.Weapon.wt_index > 0)
                    {
                        wShakeDecayDist_Per_wt_index = wShakeDist / float(Pawn.Weapon.wt_index);
                        Pawn.Weapon.wt_index = int(wShakeDist / wShakeDecayDist_Per_wt_index);
                    }
                }
                // End:0x8F1
                break;
    ...
    switch(VoiceLanguage)
    {
        ...
        case "native":
            ...
            if(iTeamIndex == 0)
            {
                ...
                // End:0x88
                if(Class'Engine.wGameManager'.default.VoicePackageName != Class'Engine.wMessage_Game'.default.PackageKor_AF)
                {
                    bPackageChanged = true;
                }
                Class'Engine.wGameManager'.default.VoicePackageName = Class'Engine.wMessage_Game'.default.PackageKor_AF;
                VoiceType = Class'Engine.wMessage_Game'.default.PackageKor_AF;                
            }
            else
            {
                // End:0x131
                if(iTeamIndex == 1)
                {
                    ...
                    // End:0x100
                    if(Class'Engine.wGameManager'.default.VoicePackageName != Class'Engine.wMessage_Game'.default.PackageKor_RSA)
                    {
                        bPackageChanged = true;
                    }
                    Class'Engine.wGameManager'.default.VoicePackageName = Class'Engine.wMessage_Game'.default.PackageKor_RSA;
                    VoiceType = Class'Engine.wMessage_Game'.default.PackageKor_RSA;
                }
            }
...
function VoiceObjectNameSetting()
{
    ...
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSuddenDeath);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceTakingLead);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceFallingBehind);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceEndingWinning);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceEndingLosing);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceWin);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceLose);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSDAllyGotTheBomb);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSDAllyLostTheBomb);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSDIGotTheBomb);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSDAllyBombDefused);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSDEnemyBombDefused);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSBTAllyGotTheBomb);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSBTEnemyGotTheBomb);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSBTIGotTheBomb);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSBTAllyLostTheBomb);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSBTAllyBombDefused);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSBTEnemyBombDefused);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMAllyCapturedAll);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMEnemyCapturedAll);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMAllyCapturingA);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMAllyCapturingB);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMAllyCapturingC);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMEnemyCapturingA);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMEnemyCapturingB);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMEnemyCapturingC);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMAllyCapturedA);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMAllyCapturedB);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMAllyCapturedC);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMEnemyCapturedA);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMEnemyCapturedB);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceDOMEnemyCapturedC);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceFFATakingLead);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceFFAFallingBehind);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceFFAEndingWinning);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceFFAEndingLosing);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceFFAWin);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceFFALose);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSelfArtillery);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSelfHelicopter);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceSelfUAV);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceAllyHelicopter);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceAllyArtillery);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceAllyUAV);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceEnemyHelicopter);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceEnemyArtillery);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceEnemyUAV);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMC[0]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMC[1]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMC[2]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMC[3]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMC[4]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMC[5]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMC[6]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMC[7]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMC[8]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMS[0]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMS[1]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMS[2]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMS[3]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMS[4]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMS[5]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMS[6]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMR[0]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMR[1]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMR[2]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMR[3]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMR[4]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMR[5]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMR[6]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.AnnounceRMR[7]);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.SoundEnemyMG);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.SoundEnemyTank);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.SoundEnemyGreanade);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.SoundEnemyRPG);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.SoundAllyReload);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.SoundAllyDie);
    ChangeVoiceObjectLanguage(Class'Engine.wMessage_Game'.default.SoundAllyKillEnemy);
    //return;    
}
...
function ChangeVoiceObjectLanguage(out string voiceObjectName)
{
    ...
    VoicePackageName = Class'Engine.wGameManager'.default.VoicePackageName $ voiceObjectName;
...
exec function input_weapon(string S)
{
    ...
    Pawn.Weapon.BaseParams.fSpread_Aim_move_add = float(arrs[int(Pawn.Weapon.BaseParams.76)]);
    Pawn.Weapon.BaseParams.fSpread_Stand_Min = float(arrs[int(Pawn.Weapon.BaseParams.79)]);
    Pawn.Weapon.BaseParams.fSpread_Stand_Max = float(arrs[int(Pawn.Weapon.BaseParams.80)]);
    Pawn.Weapon.BaseParams.fSpread_Move_Add = float(arrs[int(Pawn.Weapon.BaseParams.85)]);
    Pawn.Weapon.BaseParams.fSpread_Fire_Add = float(arrs[int(Pawn.Weapon.BaseParams.86)]);
    Pawn.Weapon.BaseParams.fSpread_Image_Increase = float(arrs[int(Pawn.Weapon.BaseParams.87)]);
    Pawn.Weapon.BaseParams.fSpread_Stand_Reduce = float(arrs[int(Pawn.Weapon.BaseParams.88)]);
    ...
    Pawn.Weapon.BaseParams.fViewKickHip_XMin = float(arrs[int(Pawn.Weapon.BaseParams.91)]);
    Pawn.Weapon.BaseParams.fViewKickHip_XMax = float(arrs[int(Pawn.Weapon.BaseParams.92)]);
    Pawn.Weapon.BaseParams.fViewKickHip_YMin = float(arrs[int(Pawn.Weapon.BaseParams.93)]);
    Pawn.Weapon.BaseParams.fViewKickHip_YMax = float(arrs[int(Pawn.Weapon.BaseParams.94)]);
    Pawn.Weapon.BaseParams.fViewKickHip_Accel = float(arrs[int(Pawn.Weapon.BaseParams.95)]);
    Pawn.Weapon.BaseParams.fViewKickHip_Decel = float(arrs[int(Pawn.Weapon.BaseParams.96)]);
    Pawn.Weapon.BaseParams.fViewKickHip_StayTime = float(arrs[int(Pawn.Weapon.BaseParams.97)]);
    Pawn.Weapon.BaseParams.fViewKickHip_DecaySpeed = float(arrs[int(Pawn.Weapon.BaseParams.98)]);
    Pawn.Weapon.BaseParams.fViewKickHip_DecayTimeFast = float(arrs[int(Pawn.Weapon.BaseParams.99)]);
    Pawn.Weapon.BaseParams.fViewKickAds_XMin = float(arrs[int(Pawn.Weapon.BaseParams.100)]);
    Pawn.Weapon.BaseParams.fViewKickAds_XMax = float(arrs[int(Pawn.Weapon.BaseParams.101)]);
    Pawn.Weapon.BaseParams.fViewKickAds_YMin = float(arrs[int(Pawn.Weapon.BaseParams.102)]);
    Pawn.Weapon.BaseParams.fViewKickAds_YMax = float(arrs[int(Pawn.Weapon.BaseParams.103)]);
    Pawn.Weapon.BaseParams.fViewKickAds_Accel = float(arrs[int(Pawn.Weapon.BaseParams.104)]);
    Pawn.Weapon.BaseParams.fViewKickAds_Decel = float(arrs[int(Pawn.Weapon.BaseParams.105)]);
    Pawn.Weapon.BaseParams.fViewKickAds_StayTime = float(arrs[int(Pawn.Weapon.BaseParams.106)]);
    Pawn.Weapon.BaseParams.fViewKickAds_DecaySpeed = float(arrs[int(Pawn.Weapon.BaseParams.107)]);
    Pawn.Weapon.BaseParams.fViewKickAds_DecayTimeFast = float(arrs[int(Pawn.Weapon.BaseParams.108)]);
    Pawn.Weapon.BaseParams.fHitMoveSpeed = float(arrs[int(Pawn.Weapon.BaseParams.136)]);
    Pawn.Weapon.BaseParams.fHitMoveTime = float(arrs[int(Pawn.Weapon.BaseParams.137)]);
    Pawn.Weapon.BaseParams.fHitMoveDelay = float(arrs[int(Pawn.Weapon.BaseParams.138)]);
    Pawn.Weapon.BaseParams.fSprintSpeed = float(arrs[int(Pawn.Weapon.BaseParams.139)]);
    Pawn.Weapon.BaseParams.fRunSpeed = float(arrs[int(Pawn.Weapon.BaseParams.140)]);
    Pawn.Weapon.BaseParams.fAimRunSpeed = float(arrs[int(Pawn.Weapon.BaseParams.143)]);
    ...
    Pawn.Weapon.BaseParams.fHitGunKick = float(arrs[int(Pawn.Weapon.BaseParams.51)]);
    Pawn.Weapon.BaseParams.fMeleeDelay = float(arrs[int(Pawn.Weapon.BaseParams.11)]);
    ...
    Pawn.Weapon.BaseParams.iSpread_Visual_Add = int(arrs[int(Pawn.Weapon.BaseParams.77)]);
    Pawn.Weapon.BaseParams.fSpread_Jump = float(arrs[int(Pawn.Weapon.BaseParams.78)]);
    Pawn.Weapon.BaseParams.fSpread_Ducked_Min = float(arrs[int(Pawn.Weapon.BaseParams.81)]);
    Pawn.Weapon.BaseParams.fSpread_Ducked_Max = float(arrs[int(Pawn.Weapon.BaseParams.82)]);
    Pawn.Weapon.BaseParams.fSpread_Prone_Min = float(arrs[int(Pawn.Weapon.BaseParams.83)]);
    Pawn.Weapon.BaseParams.fSpread_Prone_Max = float(arrs[int(Pawn.Weapon.BaseParams.84)]);
    Pawn.Weapon.BaseParams.fSpread_Ducked_Reduce = float(arrs[int(Pawn.Weapon.BaseParams.89)]);
    Pawn.Weapon.BaseParams.fSpread_Prone_Reduce = float(arrs[int(Pawn.Weapon.BaseParams.90)]);
    Pawn.Weapon.BaseParams.fCrouchSpeed = float(arrs[int(Pawn.Weapon.BaseParams.141)]);
    Pawn.Weapon.BaseParams.fPronedSpeed = float(arrs[int(Pawn.Weapon.BaseParams.142)]);
    Pawn.Weapon.BaseParams.fAimCrouchSpeed = float(arrs[int(Pawn.Weapon.BaseParams.144)]);
    Pawn.Weapon.BaseParams.fZoomFOV = float(arrs[int(Pawn.Weapon.BaseParams.13)]);
    Pawn.Weapon.BaseParams.BulletType = Pawn.Weapon.BaseParams.GetBulletType(arrs[int(Pawn.Weapon.BaseParams.18)]);
    Pawn.Weapon.BaseParams.ProjMoveType = Pawn.Weapon.BaseParams.GetProjMoveType(arrs[int(Pawn.Weapon.BaseParams.19)]);
    Pawn.Weapon.BaseParams.iBulletCount = int(arrs[int(Pawn.Weapon.BaseParams.20)]);
    Pawn.Weapon.BaseParams.fProjSpeed = float(arrs[int(Pawn.Weapon.BaseParams.21)]);
    Pawn.Weapon.BaseParams.fFuseTime = float(arrs[int(Pawn.Weapon.BaseParams.30)]);
    Pawn.Weapon.BaseParams.iDamMelee = int(arrs[int(Pawn.Weapon.BaseParams.58)]);
    ...
    Pawn.Weapon.BaseParams.fBreathRadius_Idle = float(arrs[int(Pawn.Weapon.BaseParams.109)]);
    Pawn.Weapon.BaseParams.fBreathSpeed_Idle = float(arrs[int(Pawn.Weapon.BaseParams.110)]);
    Pawn.Weapon.BaseParams.fBreathRadius_Aim = float(arrs[int(Pawn.Weapon.BaseParams.111)]);
    Pawn.Weapon.BaseParams.fBreathSpeed_Aim = float(arrs[int(Pawn.Weapon.BaseParams.112)]);
    Pawn.Weapon.BaseParams.fBreathRadius_DuckedAim = float(arrs[int(Pawn.Weapon.BaseParams.113)]);
    Pawn.Weapon.BaseParams.fBreathSpeed_DuckedAim = float(arrs[int(Pawn.Weapon.BaseParams.114)]);
    Pawn.Weapon.BaseParams.fBreathRadius_ProneAim = float(arrs[int(Pawn.Weapon.BaseParams.115)]);
    Pawn.Weapon.BaseParams.fBreathSpeed_ProneAim = float(arrs[int(Pawn.Weapon.BaseParams.116)]);
    Pawn.Weapon.BaseParams.fBobWeapon_Sprint_Move = float(arrs[int(Pawn.Weapon.BaseParams.117)]);
    Pawn.Weapon.BaseParams.fBobWeapon_sprint_y = float(arrs[int(Pawn.Weapon.BaseParams.118)]);
    Pawn.Weapon.BaseParams.fBobScreen_Sprint_Move = float(arrs[int(Pawn.Weapon.BaseParams.119)]);
    Pawn.Weapon.BaseParams.fBobScreen_sprint_y = float(arrs[int(Pawn.Weapon.BaseParams.120)]);
    Pawn.Weapon.BaseParams.fBobWeapon_Ads_Move = float(arrs[int(Pawn.Weapon.BaseParams.121)]);
    Pawn.Weapon.BaseParams.fBobWeapon_ads_move_y = float(arrs[int(Pawn.Weapon.BaseParams.122)]);
    Pawn.Weapon.BaseParams.fBobScreen_Ads_Move = float(arrs[int(Pawn.Weapon.BaseParams.123)]);
    Pawn.Weapon.BaseParams.fBobScreen_ads_move_y = float(arrs[int(Pawn.Weapon.BaseParams.124)]);
    Pawn.Weapon.BaseParams.fBobWeapon_Move = float(arrs[int(Pawn.Weapon.BaseParams.125)]);
    Pawn.Weapon.BaseParams.fBobWeapon_move_y = float(arrs[int(Pawn.Weapon.BaseParams.126)]);
    Pawn.Weapon.BaseParams.fBobScreen_Move = float(arrs[int(Pawn.Weapon.BaseParams.127)]);
    Pawn.Weapon.BaseParams.fBobScreen_move_y = float(arrs[int(Pawn.Weapon.BaseParams.128)]);
    Pawn.Weapon.BaseParams.fBobWeapon_Ducked_Move = float(arrs[int(Pawn.Weapon.BaseParams.129)]);
    Pawn.Weapon.BaseParams.fBobWeapon_ducked_move_y = float(arrs[int(Pawn.Weapon.BaseParams.130)]);
    Pawn.Weapon.BaseParams.fBobScreen_Ducked_Move = float(arrs[int(Pawn.Weapon.BaseParams.131)]);
    Pawn.Weapon.BaseParams.fBobScreen_ducked_move_y = float(arrs[int(Pawn.Weapon.BaseParams.132)]);
    Pawn.Weapon.BaseParams.fBobScreen_Prone_Move = float(arrs[int(Pawn.Weapon.BaseParams.133)]);
    Pawn.Weapon.BaseParams.fBobScreen_prone_move_y = float(arrs[int(Pawn.Weapon.BaseParams.134)]);
    Pawn.Weapon.BaseParams.fSprintStaminaRate = float(arrs[int(Pawn.Weapon.BaseParams.135)]);
    Pawn.Weapon.BaseParams.fHitMoveSpeed = float(arrs[int(Pawn.Weapon.BaseParams.136)]);
    Pawn.Weapon.BaseParams.fHitMoveTime = float(arrs[int(Pawn.Weapon.BaseParams.137)]);
    Pawn.Weapon.BaseParams.fHitMoveDelay = float(arrs[int(Pawn.Weapon.BaseParams.138)]);
    Pawn.Weapon.BaseParams.fAnimRate_PutDown = float(arrs[int(Pawn.Weapon.BaseParams.145)]);
    Pawn.Weapon.BaseParams.fAnimRate_PutDown_Quick = float(arrs[int(Pawn.Weapon.BaseParams.146)]);
    Pawn.Weapon.BaseParams.bApplyQuickDrop = bool(arrs[int(Pawn.Weapon.BaseParams.147)]);
    Pawn.Weapon.BaseParams.fAnimRate_BringUp = float(arrs[int(Pawn.Weapon.BaseParams.148)]);
    Pawn.Weapon.BaseParams.fAnimRate_SprintBringUp = float(arrs[int(Pawn.Weapon.BaseParams.149)]);
    Pawn.Weapon.BaseParams.fAnimRate_AdsOn = float(arrs[int(Pawn.Weapon.BaseParams.150)]);
    Pawn.Weapon.BaseParams.fAnimRate_AdsOff = float(arrs[int(Pawn.Weapon.BaseParams.151)]);
    Pawn.Weapon.BaseParams.fMaxPitch = float(arrs[int(Pawn.Weapon.BaseParams.164)]);
    Pawn.Weapon.BaseParams.CrosshairType = Pawn.Weapon.BaseParams.GetCrosshairType(arrs[int(Pawn.Weapon.BaseParams.165)]);
    Pawn.Weapon.BaseParams.CrosshairImage = arrs[int(Pawn.Weapon.BaseParams.166)];
    Pawn.Weapon.BaseParams.fMovePivot = float(arrs[int(Pawn.Weapon.BaseParams.167)]);
    Pawn.Weapon.BaseParams.bOverHeat = bool(arrs[int(Pawn.Weapon.BaseParams.15)]);
    Pawn.Weapon.BaseParams.fOverHeat_Up = float(arrs[int(Pawn.Weapon.BaseParams.16)]);
    Pawn.Weapon.BaseParams.fOverHeat_Down = float(arrs[int(Pawn.Weapon.BaseParams.17)]);
    Pawn.Weapon.BaseParams.bExplodeCollide = bool(arrs[int(Pawn.Weapon.BaseParams.22)]);
    Pawn.Weapon.BaseParams.bBulletLandExplode = bool(arrs[int(Pawn.Weapon.BaseParams.23)]);
    Pawn.Weapon.BaseParams.bProjTakeDamage = bool(arrs[int(Pawn.Weapon.BaseParams.24)]);
    Pawn.Weapon.BaseParams.fProjDecelEachBound = float(arrs[int(Pawn.Weapon.BaseParams.25)]);
    Pawn.Weapon.BaseParams.fProjSpin = float(arrs[int(Pawn.Weapon.BaseParams.26)]);
    Pawn.Weapon.BaseParams.fProjThrowPitch = float(arrs[int(Pawn.Weapon.BaseParams.27)]);
    Pawn.Weapon.BaseParams.fBulletGravity = float(arrs[int(Pawn.Weapon.BaseParams.28)]);
    // End:0x26D8
    if(Pawn.Weapon.BaseParams.fBulletGravity == 0.0000000)
    {
        Pawn.Weapon.BaseParams.fBulletGravity = 1.0000000;
    }
    Pawn.Weapon.BaseParams.iBombWeaponID = int(float(arrs[int(Pawn.Weapon.BaseParams.29)]));
    ...
    Pawn.Weapon.BaseParams.bHitEffFriendly = bool(arrs[int(Pawn.Weapon.BaseParams.50)]);
    Pawn.Weapon.BaseParams.fHitStunTime = float(arrs[int(Pawn.Weapon.BaseParams.52)]);
    Pawn.Weapon.BaseParams.fHitFlashTime = float(arrs[int(Pawn.Weapon.BaseParams.54)]);
    Pawn.Weapon.BaseParams.fHitEAXEffectTime = float(arrs[int(Pawn.Weapon.BaseParams.55)]);
    Pawn.Weapon.BaseParams.strHitEAXEffectClass = arrs[int(Pawn.Weapon.BaseParams.56)];
    Pawn.Weapon.BaseParams.fHitFireTime = float(arrs[int(Pawn.Weapon.BaseParams.57)]);
    Pawn.Weapon.BaseParams.fSway_HipX_Max = float(arrs[int(Pawn.Weapon.BaseParams.152)]);
    Pawn.Weapon.BaseParams.fSway_HipX_Incr = float(arrs[int(Pawn.Weapon.BaseParams.153)]);
    Pawn.Weapon.BaseParams.fSway_HipX_Speed = float(arrs[int(Pawn.Weapon.BaseParams.154)]);
    Pawn.Weapon.BaseParams.fSway_HipY_Max = float(arrs[int(Pawn.Weapon.BaseParams.155)]);
    Pawn.Weapon.BaseParams.fSway_HipY_Incr = float(arrs[int(Pawn.Weapon.BaseParams.156)]);
    Pawn.Weapon.BaseParams.fSway_HipY_Speed = float(arrs[int(Pawn.Weapon.BaseParams.157)]);
    Pawn.Weapon.BaseParams.fSway_AdsX_Max = float(arrs[int(Pawn.Weapon.BaseParams.158)]);
    Pawn.Weapon.BaseParams.fSway_AdsX_Incr = float(arrs[int(Pawn.Weapon.BaseParams.159)]);
    Pawn.Weapon.BaseParams.fSway_AdsX_Speed = float(arrs[int(Pawn.Weapon.BaseParams.160)]);
    Pawn.Weapon.BaseParams.fSway_AdsY_Max = float(arrs[int(Pawn.Weapon.BaseParams.161)]);
    Pawn.Weapon.BaseParams.fSway_AdsY_Incr = float(arrs[int(Pawn.Weapon.BaseParams.162)]);
    Pawn.Weapon.BaseParams.fSway_AdsY_Speed = float(arrs[int(Pawn.Weapon.BaseParams.163)]);
    Pawn.Weapon.BaseParams.fNPCSpreadRate = float(arrs[int(Pawn.Weapon.BaseParams.175)]);
    Pawn.Weapon.BaseParams.fNPCRateOfFire = float(arrs[int(Pawn.Weapon.BaseParams.176)]);
    Pawn.Weapon.BaseParams.iNPCFire = int(arrs[int(Pawn.Weapon.BaseParams.177)]);
    i = 0;
    J0x2E79:
...
function DisplayDebugChan1(Canvas Canvas)
{
    ...
    Canvas.DrawText("======== Hit Offset Time ========");
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(20));
    Canvas.DrawText("bHit = " $ string(bHit));
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(40));
    Canvas.DrawText((("hit_gun_delta_Time = " $ string(hit_gun_delta_Time)) $ " hit_gun_move_time =") $ string(hit_gun_move_time));
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(60));
    Canvas.DrawText("hit_gun_move_delay = " $ string(hit_gun_move_delay));
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(80));
    Canvas.DrawText("hit_gun_move_speed = " $ string(hit_gun_move_speed));
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(100));
    Canvas.DrawText("Vel = " $ string(VSize(Pawn.Velocity - (Pawn.Velocity.Z * vect(0.0000000, 0.0000000, 1.0000000)))));
    Canvas.SetPos(10.0000000, (Canvas.ClipY / float(3)) + float(120));
    Canvas.DrawText((("Acc = " $ string(Pawn.Acceleration)) $ " aForward = ") $ string(aForward));
...
state SpectatingGM extends BaseSpectating
{
    ...
    simulated function ChangeCamView(optional byte Mode)
    {
        ...
        Log("LEEKSLOG : Set Cam Num " $ string(Mode));
        switch(Mode)
        {
            // End:0x5A
            case 0:
