...
function PI_EnterChannel(int ServerGroupID, string ServerGroupName, int ServerID, string ServerName, int ChannelID, string ChannelName, optional bool bClanWarChannel, optional bool IsPracticeChannel, optional bool IsDedicatedServer)
{
    ...
    Log("[wMatchMaker::PI_EnterChannel()] kIsInPracticeChannel=" $ string(kIsInPracticeChannel));
...
event Material GetMiniMapInfoImage()
{
    ...
    switch(kGame_GameMode)
    {
        ...
        // End:0x13D
        case Class'Engine.wGameSettings'.static.GetModeIndex_Infection():
            return none;
        // End:0xFFFF
        default:
            break;
