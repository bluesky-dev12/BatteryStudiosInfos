...
function ServerReload()
{
    ...
    Level.Game.TeamReceiveLocalizedMessageEx(byte(iTeamNum), Class'Engine.wMessage_Game', iCodeID, Pawn(Owner).PlayerReplicationInfo,,, vLocation, fMessageRange, true);
    //return;    
}
