...
simulated function PlayTimerSound()
{
    ...
    if(!bStopCountDown)
    {
        ...
        {
            Level.GetLocalPlayerController().ClientPlaySound(Sound(DynamicLoadObject("Warfare_Sound_ATS.com.ats_com_bomb_countdown", Class'Engine.Sound')));            
        }
        else
        {
            // End:0xD2
            ...
            {
                Level.GetLocalPlayerController().ClientPlaySound(Sound(DynamicLoadObject("Warfare_Sound_ATS.com.ats_com_time_countdown", Class'Engine.Sound')));
            }
        }
    }
    //return;    
