...
enum EItemType
{
    ...
    ITYPE_Knife,                    // 28
    ITYPE_LVMark,                   // 29
    ITYPE_Part_Barrel,              // 30
    ITYPE_Part_Gunstock,            // 31
    ITYPE_SG,                       // 32
    ITYPE_MG,                       // 33
    ITYPE_GOLD,                     // 34
    ITYPE_None                      // 35
...
function int IsUsablePartItem(int iItemID, int iPartsArrayIndex)
{
    ...
    // End:0x103
    if((int(wcpp.eType) == int(23)) || int(wcpp.eType) == int(16))
    {
        // End:0x100
    ...
    // End:0x2FD
    if((wcpp.bUsablePS == false) && int(ibp.eType) == int(3))
    {
        return 0;
    }
    // End:0x32F
    if((wcpp.bUsableSG == false) && int(ibp.eType) == int(32))
    {
        return 0;
    }
    // End:0x39D
    if((wcip.bCustomSight == false) && (int(wcpp.eType) == int(16)) || int(wcpp.eType) == int(23))
    {
        // End:0x39D
    ...
    // End:0x3F0
    if((wcip.bCustomBarrel == false) && int(wcpp.eType) == int(30))
    {
        // End:0x3F0
    ...
    // End:0x443
    if((wcip.bCustomSilencer == false) && int(wcpp.eType) == int(17))
    {
        // End:0x443
    ...
    // End:0x496
    if((wcip.bCustomGunstock == false) && int(wcpp.eType) == int(31))
    {
        // End:0x496
...
function int IsEnableRemovePart(wItemBaseParam Inip, wGameManager.EItemType InType)
{
    ...
    // End:0x85
    if((int(InType) == int(16)) || int(InType) == int(23))
    {
        // End:0x57
...
function LoadUILists()
{
    ...
    if(lp1 < ItemParams.Length)
    {
        ...
        if((cItemParam.iItemID != -1) && cItemResParam.iItemResourceID != -1)
        {
            ...
            // End:0x381
            if(((((int(cItemParam.eType) == int(16)) || int(cItemParam.eType) == int(17)) || int(cItemParam.eType) == int(23)) || int(cItemParam.eType) == int(30)) || int(cItemParam.eType) == int(31))
            {
            ...
            if((wcip.iItemID > 0) && ItemID == wcip.iItemID)
            {
                ...
                {
                    // End:0x705
                    if((IsEnableRemovePart(cItemParam, 16)) > 0)
                    {
                    ...
                    // End:0x7F9
                    if((IsEnableRemovePart(cItemParam, 30)) > 0)
                    {
                    ...
                    // End:0x8EE
                    if((IsEnableRemovePart(cItemParam, 17)) > 0)
                    {
                    ...
                    // End:0x9E3
                    if((IsEnableRemovePart(cItemParam, 31)) > 0)
                    {
...
function int GetItemType(wItemBoxHK ItemInfo, wItemBoxInstanceHK instanceInfo)
{
    ...
    if((ItemInfo.CostType == 1) || ItemInfo.CostType == 4)
    {
        ...
        {
            // End:0x149
            if(instanceInfo.CashItemInfo.bWZCanBuy == true)
            {
                iItemType += FlagRenew;
            }            
        }
