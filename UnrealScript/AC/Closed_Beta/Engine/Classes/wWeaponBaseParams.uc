...
enum EWEAPON_BASE_PARAMS_TYPE
{
    ...
    WBP_HIT_EFFECT_FRIENDLY,        // 50
    WBP_HIT_GUN_KICK,               // 51
    WBP_HIT_STUN_TIME,              // 52
    WBP_HIT_FREEZE_TIME,            // 53
    WBP_HIT_VIEW_FLASH_TIME,        // 54
    WBP_HIT_EAXSOUND_TIME,          // 55
    WBP_HIT_EAXSOUND_CLASS,         // 56
    WBP_HIT_FIRE_TIME,              // 57
    WBP_MELEE_DAMAGE,               // 58
    WBP_RELOAD_TYPE,                // 59
    WBP_RECHAMBER,                  // 60
    ...
    WBP_RELOAD_AMMO,                // 74
    WBP_MAX_AMMO,                   // 75
    WBP_SPREAD_AIM_MOVE_ADD,        // 76
    WBP_SPREAD_VISUAL_ADD,          // 77
    WBP_SPREAD_JUMP,                // 78
    WBP_SPREAD_STAND_MIN,           // 79
    WBP_SPREAD_STAND_MAX,           // 80
    WBP_SPREAD_DUCKED_MIN,          // 81
    WBP_SPREAD_DUCKED_MAX,          // 82
    WBP_SPREAD_PRONE_MIN,           // 83
    WBP_SPREAD_PRONE_MAX,           // 84
    WBP_SPREAD_MOVE_ADD,            // 85
    WBP_SPREAD_FIRE_ADD,            // 86
    WBP_SPREAD_OUT_SPEED,           // 87
    WBP_SPREAD_STAND_IN_RT,         // 88
    WBP_SPREAD_DUCKED_IN_RT,        // 89
    WBP_SPREAD_PRONE_IN_RT,         // 90
    WBP_VIEW_KICK_HIP_X_MIN,        // 91
    WBP_VIEW_KICK_HIP_X_MAX,        // 92
    WBP_VIEW_KICK_HIP_Y_MIN,        // 93
    WBP_VIEW_KICK_HIP_Y_MAX,        // 94
    WBP_VIEW_KICK_HIP_ACCEL,        // 95
    WBP_VIEW_KICK_HIP_DECEL,        // 96
    WBP_VIEW_KICK_HIP_STAY_TIME,    // 97
    WBP_VIEW_KICK_HIP_DECAY_SPEED,  // 98
    WBP_VIEW_KICK_HIP_DECAY_TIME_FAST,// 99
    WBP_VIEW_KICK_ADS_X_MIN,        // 100
    WBP_VIEW_KICK_ADS_X_MAX,        // 101
    WBP_VIEW_KICK_ADS_Y_MIN,        // 102
    WBP_VIEW_KICK_ADS_Y_MAX,        // 103
    WBP_VIEW_KICK_ADS_ACCEL,        // 104
    WBP_VIEW_KICK_ADS_DECEL,        // 105
    WBP_VIEW_KICK_ADS_STAY_TIME,    // 106
    WBP_VIEW_KICK_ADS_DECAY_SPEED,  // 107
    WBP_VIEW_KICK_ADS_DECAY_TIME_FAST,// 108
    WBP_BREATH_STAND_GUN,           // 109
    WBP_BREATH_STAND_GUN_SPEED,     // 110
    WBP_BREATH_ADS_GUNNAIM,         // 111
    WBP_BREATH_ADS_GUNNAIM_SPEED,   // 112
    WBP_BREATH_ADS_DUCKED_GUNNAIM,  // 113
    WBP_BREATH_ADS_DUCKED_GUNNAIM_SPEED,// 114
    WBP_BREATH_ADS_PRONE_GUNNAIM,   // 115
    WBP_BREATH_ADS_PRONE_GUNNAIM_SPEED,// 116
    WBP_BOB_SPRINT_GUN,             // 117
    WBP_BOB_SPRINT_GUN_Y,           // 118
    WBP_BOB_SPRINT_VIEW,            // 119
    WBP_BOB_SPRINT_VIEW_Y,          // 120
    WBP_BOB_ADS_MOVE_GUNNAIM,       // 121
    WBP_BOB_ADS_MOVE_GUNNAIM_Y,     // 122
    WBP_BOB_ADS_MOVE_VIEW,          // 123
    WBP_BOB_ADS_MOVE_VIEW_Y,        // 124
    WBP_BOB_HIP_MOVE_GUN,           // 125
    WBP_BOB_HIP_MOVE_GUN_Y,         // 126
    WBP_BOB_HIP_MOVE_VIEW,          // 127
    WBP_BOB_HIP_MOVE_VIEW_Y,        // 128
    WBP_BOB_HIP_DUCKED_MOVE_GUN,    // 129
    WBP_BOB_HIP_DUCKED_MOVE_GUN_Y,  // 130
    WBP_BOB_HIP_DUCKED_MOVE_VIEW,   // 131
    WBP_BOB_HIP_DUCKED_MOVE_VIEW_Y, // 132
    WBP_BOB_HIP_PRONE_MOVE_VIEW,    // 133
    WBP_BOB_HIP_PRONE_MOVE_VIEW_Y,  // 134
    WBP_WP_SPRINT_STA_RATE,         // 135
    WBP_WP_GUN_MOVE_SPEED,          // 136
    WBP_WP_GUN_MOVE_TIME,           // 137
    WBP_WP_GUN_MOVE_DELAY,          // 138
    WBP_WP_SPRINT_MOVE,             // 139
    WBP_WP_STAND_MOVE,              // 140
    WBP_WP_CROUCH_MOVE,             // 141
    WBP_WP_PRONE_MOVE,              // 142
    WBP_WP_AIM_MOVE,                // 143
    WBP_WP_CROUCH_AIM_MOVE,         // 144
    WBP_ANI_RATE_DROP,              // 145
    WBP_ANI_RATE_DROP_QUICK,        // 146
    WBP_DROP_QUICK,                 // 147
    WBP_ANI_RATE_RAISE,             // 148
    WBP_ANI_RATE_SPRINT_RAISE,      // 149
    WBP_ANI_RATE_ADS_ON,            // 150
    WBP_ANI_RATE_ADS_OFF,           // 151
    WBP_SWAY_GUN_HIP_X_MAX_ANGLE,   // 152
    WBP_SWAY_GUN_HIP_X_MOVE_ANGLE,  // 153
    WBP_SWAY_GUN_HIP_X_MOVE,        // 154
    WBP_SWAY_GUN_HIP_Y_MAX_ANGLE,   // 155
    WBP_SWAY_GUN_HIP_Y_MOVE_ANGLE,  // 156
    WBP_SWAY_GUN_HIP_Y_MOVE,        // 157
    WBP_SWAY_GUN_ADS_X_MAX_ANGLE,   // 158
    WBP_SWAY_GUN_ADS_X_MOVE_ANGLE,  // 159
    WBP_SWAY_GUN_ADS_X_MOVE,        // 160
    WBP_SWAY_GUN_ADS_Y_MAX_ANGLE,   // 161
    WBP_SWAY_GUN_ADS_Y_MOVE_ANGLE,  // 162
    WBP_SWAY_GUN_ADS_Y_MOVE,        // 163
    WBP_VIEW_ANGLE_PITCH_MAX,       // 164
    WBP_CROSSHAIR_TYPE,             // 165
    WBP_CROSSHAIR_IMAGE,            // 166
    WBP_GUN_POS_HIP_MOVE_FRONT_Y,   // 167
    WBP_GUN_POS_HIP_MOVE_FRONT_X,   // 168
    WBP_UI_DAMAGE,                  // 169
    WBP_UI_SPREAD,                  // 170
    WBP_UI_VIEW_KICK,               // 171
    WBP_UI_RATE_OF_FIRE,            // 172
    WBP_UI_MOVE,                    // 173
    WBP_UI_RANGE,                   // 174
    WBP_NPC_SPREAD_RATE,            // 175
    WBP_NPC_RATE_OF_FIRE,           // 176
    WBP_NPC_FIRE                    // 177
};
