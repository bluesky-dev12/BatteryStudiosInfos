...
static function GameModeInfo GetGameModeByIndex(int Index)
{
    ...
    switch(Index)
    {
        ...
        // End:0x94A
        case 13:
            Mode.ClassName = "wMission.wInvaderGameInfo";
            Mode.UserFriendlyName = default.Invader_UserFriendlyName;
            Mode.ModeDescription = default.Invader_ModeDescription;
            Mode.TimeLimits = default.Invader_TimeLimits;
            Mode.Scores = default.Invader_Scores;
            Mode.ScoreDefault = default.Invader_ScoreDefault;
            Mode.Scores_DefaultTimeLimits = default.Invader_Scores_DefaultTimeLimits;
            Mode.UserCount = default.Invader_UserCount;
            Mode.UserCount_Default = default.Invader_UserCount_Default;
            // End:0x95D
            break;
        // End:0xFFFF
        default:
...
static function int GetModeIndex_Infection()
{
    return 13;
    //return;    
}
...
defaultproperties
{
    ...
    Bot_Domination_ScoreDefault="100"
    ...
    Bot_Deathmatch_ScoreDefault="100"
    ...
    Defence_UserCount[0]=1
    Defence_UserCount[1]=2
    Defence_UserCount[2]=3
    Defence_UserCount[3]=4
    Defence_UserCount_Default=4
    Invader_TimeLimits[0]="3"
    Invader_Scores[0]="7"
    Invader_Scores[1]="9"
    Invader_Scores[2]="11"
    Invader_Scores[3]="13"
    Invader_Scores_DefaultTimeLimits[0]="3"
    Invader_ScoreDefault="7"
    Invader_UserCount[0]=4
    Invader_UserCount[1]=6
    Invader_UserCount[2]=8
    Invader_UserCount[3]=10
    Invader_UserCount[4]=12
    Invader_UserCount[5]=14
    Invader_UserCount[6]=16
    ...
    WeaponRestriction_RPGOnly="RPG Only"
