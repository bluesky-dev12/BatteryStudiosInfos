...
function DrawAirStrikePosition(Canvas C)
{
    ...
    {
        // End:0xEE
        if(int(PlayerOwner.PlayerReplicationInfo.bySupply_AirStrike) != 2)
        {
            DrawObjectSprite3(C, WAirStrikeMark, vLocation);
        }
    }
...
function Material GetSkillIconByWeaponID(int nWeaponID)
{
    switch(nWeaponID)
    {
        // End:0x53
        case 7001:
            return Material(DynamicLoadObject("Warfare_UI_Item.SupplySkillicon.icon_skil_time_c4", Class'Engine.Material'));
        // End:0x9B
        case 5011:
            return Material(DynamicLoadObject("Warfare_UI_Item.SupplySkillicon.icon_wea_RPG7", Class'Engine.Material'));
        // End:0xE5
        case 6005:
            return Material(DynamicLoadObject("Warfare_UI_Item.SupplySkillicon.icon_skil_incen", Class'Engine.Material'));
        // End:0xED
        case 5013:
        // End:0x13A
        case 5015:
            return Material(DynamicLoadObject("Warfare_UI_Item.SupplySkillicon.icon_skil_hellfire", Class'Engine.Material'));
        // End:0x186
        case 7003:
            return Material(DynamicLoadObject("Warfare_UI_Item.SupplySkillicon.icon_skil_Cluster", Class'Engine.Material'));
        // End:0xFFFF
        default:
...
function OnClientReceiveFlyingDefenceBotDeathMessage(PlayerController P, PlayerReplicationInfo attackerPRI, PlayerReplicationInfo victimPRI, optional Object OptionalObject)
{
    ...
    cls = DynamicLoadObject("WWeapons_Res.wWeaponRes_Special_FlyingDefenceBotKill", Class'Core.Class');
...
simulated function DrawMessageScore(Canvas C, int i, float PosX, float PosY, out float dx, out float dy)
{
    ...
    switch(LocalMessages[i].StringMessage)
    {
        ...
        case "FragGrenadeKill":
            DrawScoreEffect(C, WFragGrenadeKill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW, MedalMarkPosX, MedalMarkPosY);
            bNeedReturn = true;
            // End:0x73F
            break;
        // End:0x4C2
        case "MeleeKill":
            DrawScoreEffect(C, WMeleeKill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW, MedalMarkPosX, MedalMarkPosY);
            bNeedReturn = true;
            // End:0x73F
            break;
        // End:0x509
        case "StepOnKill":
            DrawScoreEffect(C, WStepOnKill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW, MedalMarkPosX, MedalMarkPosY);
            bNeedReturn = true;
            // End:0x73F
            break;
        // End:0x554
        case "SpecialETCKill":
            DrawScoreEffect(C, WSpecialETCKill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW, MedalMarkPosX, MedalMarkPosY);
            bNeedReturn = true;
            // End:0x73F
            break;
        // End:0x599
        case "Helikill":
            DrawScoreEffect(C, WHelikill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW, MedalMarkPosX, MedalMarkPosY);
            bNeedReturn = true;
            // End:0x73F
            break;
        // End:0x5E3
        case "Artillerykill":
            DrawScoreEffect(C, WArtillerykill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW, MedalMarkPosX, MedalMarkPosY);
            bNeedReturn = true;
            // End:0x73F
            break;
        // End:0x628
        case "headshot":
            DrawScoreEffect(C, WHeadshot, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW, MedalMarkPosX, MedalMarkPosY);
            bNeedReturn = true;
            // End:0x73F
            break;
        // End:0x671
        case "headshot_Aim":
            DrawScoreEffect(C, WHeadshotAim, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW, MedalMarkPosX, MedalMarkPosY);
            bNeedReturn = true;
            // End:0x73F
            break;
        // End:0x6AF
        case "NormalKill":
            DrawScoreEffect(C, WKill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW, MedalMarkPosX, MedalMarkPosY);
            return;
        // End:0x6F1
        case "NormalKill_Aim":
            DrawScoreEffect(C, WKillAim, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW, MedalMarkPosX, MedalMarkPosY);
            return;
        // End:0x739
        case "WallShotKill":
            DrawScoreEffect(C, WWallShotKill, float(KillMarkMedalWidth), float(KillMarkMedalHeight), calW, MedalMarkPosX, MedalMarkPosY);
            bNeedReturn = true;
            return;
        // End:0xFFFF
        default:
...
defaultproperties
{
    ...
    HpBar=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.gau_hp',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=167,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    DamageBar=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.gau_hp_mn',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=167,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    RecoveryBar=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.gau_hp_pl',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=167,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    ...
    HPIcon=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.hp_icon',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=29,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=55,OffsetY=1150,ScaleMode=4,Scale=1.0000000,Tints=(R=189,G=0,B=0,A=255),Tints[1]=(R=189,G=0,B=0,A=255))
    HpGauBlink=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.gau_hpblink',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=167,Y2=20),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=86,OffsetY=1149,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    PostureDown=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_status',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=42,Y2=42),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=13,OffsetY=1126,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    PostureRun=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_status1',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=42,Y2=42),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=13,OffsetY=1126,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
