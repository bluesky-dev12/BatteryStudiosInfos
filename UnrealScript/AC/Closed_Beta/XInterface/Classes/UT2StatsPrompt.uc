...
defaultproperties
{
    ...
    begin object name="PromptHeader" class=XInterface_Decompressed.GUILabel
        Caption="This server records UT2004 Stats."
        TextAlign=1
    ...
    begin object name="PromptDesc" class=XInterface_Decompressed.GUILabel
        Caption="Enter this server by going to Check Stats and setting your stats name and password.||You can enter this server with stats turned off.||Do you want to create a stats user name and password?"
        TextAlign=1
