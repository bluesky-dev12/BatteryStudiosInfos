...
defaultproperties
{
    ...
    begin object name="BotAggrSlider" class=XInterface_Decompressed.moSlider
        ...
        Hint="Set the bot's aggressiveness."
        WinTop=0.2082290
        WinLeft=0.3453130
        WinWidth=0.5984380
        TabOrder=0
    ...
    begin object name="BotAccuracySlider" class=XInterface_Decompressed.moSlider
        ...
        Hint="Set the accuracy of the bot."
        WinTop=0.2811450
        WinLeft=0.3453130
        WinWidth=0.5984380
        OnChange=UT2BotConfigPage.SliderChange
    ...
    begin object name="BotCStyleSlider" class=XInterface_Decompressed.moSlider
        ...
        Hint="Adjust the bot's combat style."
        WinTop=0.3540620
        WinLeft=0.3453130
        WinWidth=0.5984380
        OnChange=UT2BotConfigPage.SliderChange
    ...
    begin object name="BotStrafeSlider" class=XInterface_Decompressed.moSlider
        ...
        Hint="Adjust the bot's fire power."
        WinTop=0.4269790
        WinLeft=0.3453130
        WinWidth=0.5984380
        OnChange=UT2BotConfigPage.SliderChange
    ...
    begin object name="BotTacticsSlider" class=XInterface_Decompressed.moSlider
        ...
        Hint="Adjust the bot's recognition of teamplay tactics."
        WinTop=0.4998950
        WinLeft=0.3453130
        WinWidth=0.5984380
        OnChange=UT2BotConfigPage.SliderChange
    ...
    begin object name="BotReactionSlider" class=XInterface_Decompressed.moSlider
        ...
        Hint="Adjust the bot's response time."
        WinTop=0.5936450
        WinLeft=0.3453130
        WinWidth=0.5984380
        OnChange=UT2BotConfigPage.SliderChange
    ...
    begin object name="BotJumpy" class=XInterface_Decompressed.moCheckBox
        ...
        Hint="Set how often the bot jumps during the game."
        WinTop=0.6665620
        WinLeft=0.3453130
        WinWidth=0.5984380
        WinHeight=0.0400000
    ...
    begin object name="BotWeapon" class=XInterface_Decompressed.moComboBox
        ...
        Caption="Weapon Preference"
        OnCreateComponent=BotWeapon.InternalOnCreateComponent
        Hint="Select the bot's preferred weapon."
        WinTop=0.7290620
        WinLeft=0.3453130
        WinWidth=0.5984380
        WinHeight=0.0443750
