...
function CallSkill(optional int iKey, optional bool bRequire, optional bool iSucess)
{
    ...
    if(5 == iKey)
    {
        ...
        if(1 == HudCDeathmatch(HudOwner).ActiveUsingSkill.iState)
        {
            ...
            switch(iSkillID)
            {
                ...
                case 40018:
                    ...
                    {
                        iCodeID = Class'Engine.wMessage_Game_ImpSystem'.default.Code_NotHasPinpointBomb;
                        HudOwner.PlayerOwner.ReceiveLocalizedMessage(Class'Engine.wMessage_Game_ImpSystem', iCodeID);
                    }
                    // End:0x231
                    break;
        ...
        }/* !MISMATCHING REMOVE, tried If got Type:Else Position:0x260! */
        else
        {
            // End:0x503
            if(6 == iKey)
...
function DisplayEvent_Respawn(Canvas C)
{
    ...
    {
        C.BtrDrawTextJustifiedWithVolumeLine(safeZoneRandomRespawn, 1, 0.0000000, RandomRespawnTextPos * _reY, 1600.0000000 * _reX, (RandomRespawnTextPos + float(12)) * _reY, int(float(24) * _reY), color_Shadow);        
    }
    else
    {
...
function DrawDFRankingInfo(Canvas C, PlayerReplicationInfo PRI, float iPosX, float iPosY)
{
    ...
    if(i < 3)
    {
        ...
        {
            C.SetPos(fX1, fY1);
            C.DrawTile(markClan[i], 32.0000000 * _reX, 32.0000000 * _reX, 0.0000000, 0.0000000, float(markClan[i].MaterialUSize()), float(markClan[i].MaterialVSize()));
        }
        i++;
        // [Loop Continue]
        goto J0x2B0;
    ...
    if(Mark != none)
    {
        ...
        C.SetPos(fX1, fY1);
        C.DrawTile(Mark, 32.0000000 * _reX, 32.0000000 * _reX, PRI.ClassMarkBox.X1, PRI.ClassMarkBox.Y1, PRI.ClassMarkBox.X2, PRI.ClassMarkBox.Y2);
    }
    C.DrawColor = TextColor;
...
defaultproperties
{
    ...
    WReadyIncen=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=0,Y1=82,X2=512,Y2=164),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WReadyHellFire=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=0,Y1=164,X2=512,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WReadySpiltGrenade=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=0,Y1=246,X2=512,Y2=328),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WReadyPinpointFire=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=0,Y1=328,X2=512,Y2=410),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WNotReadyIncen=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=82,X2=1024,Y2=164),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WNotReadyHellFire=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=164,X2=1024,Y2=246),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WNotReadySpiltGrenade=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=246,X2=1024,Y2=328),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WNotReadyPinpointFire=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=328,X2=1024,Y2=410),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirkeIcon=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_pac_bom',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.6500000,DrawPivot=0,PosX=0.3475000,PosY=0.6016667,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHelicopterIcon=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_pac_hel',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.6500000,DrawPivot=0,PosX=0.3475000,PosY=0.6016667,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WUAVIcon=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_pac_uav',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=127,Y2=127),TextureScale=0.6500000,DrawPivot=0,PosX=0.3475000,PosY=0.6016667,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WAirStirkeNotReady=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=82,X2=512,Y2=164),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WHelicopterNotReady=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=0,X2=1024,Y2=82),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WUAVNotReady=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=246,X2=512,Y2=328),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WRPG7NotReady=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text1',RenderStyle=5,TextureCoords=(X1=512,Y1=0,X2=1024,Y2=82),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    WHelicopterRequireFaild=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=248,X2=1024,Y2=328),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WUAVRequireFaild=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=512,Y1=328,X2=1024,Y2=410),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    WAirStirkeFocus=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Text.img_HUD_text',RenderStyle=5,TextureCoords=(X1=0,Y1=328,X2=512,Y2=410),TextureScale=1.0000000,DrawPivot=0,PosX=0.3400000,PosY=0.6208333,OffsetX=0,OffsetY=0,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
    ...
    DFRankingBG=(WidgetTexture=Texture'Warfare_GP_UI_HUD.Common.img_HUD_pve_ranking_bg',RenderStyle=5,TextureCoords=(X1=0,Y1=0,X2=361,Y2=112),TextureScale=1.0000000,DrawPivot=0,PosX=0.0000000,PosY=0.0000000,OffsetX=1239,OffsetY=976,ScaleMode=4,Scale=1.0000000,Tints=(R=255,G=255,B=255,A=255),Tints[1]=(R=255,G=255,B=255,A=255))
