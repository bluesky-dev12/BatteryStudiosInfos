...
defaultproperties
{
    ...
    begin object name="DetailWorldDetail" class=XInterface_Decompressed.moComboBox
        ...
        IniDefault="High"
        Hint="Change the level of detail used for world textures."
        WinTop=0.1000000
        WinLeft=0.0500000
        WinWidth=0.4000000
        WinHeight=0.0500000
    ...
    begin object name="DetailCharacterDetail" class=XInterface_Decompressed.moComboBox
        ...
        IniDefault="High"
        Hint="Change the level of detail used for characters."
        WinTop=0.1000000
        WinLeft=0.5500000
        WinWidth=0.4000000
        WinHeight=0.0500000
    ...
    begin object name="DetailActorDetail" class=XInterface_Decompressed.moComboBox
        ...
        IniOption="@Internal"
        IniDefault="High"
        Hint="Change the overall detail level used for the game world."
        WinTop=0.2000000
        WinLeft=0.0500000
        WinWidth=0.4000000
        WinHeight=0.0500000
    ...
    begin object name="DetailPhysics" class=XInterface_Decompressed.moComboBox
        ComponentJustification=0
        Caption="Physics Effects"
        OnCreateComponent=DetailPhysics.InternalOnCreateComponent
        IniOption="@Internal"
        IniDefault="High"
        Hint="Change the physics level of the engine."
        WinTop=0.2000000
        WinLeft=0.5500000
        WinWidth=0.4000000
        WinHeight=0.0500000
    ...
    begin object name="DetailCharacterShadows" class=XInterface_Decompressed.moCheckBox
        ...
        IniOption="@Internal"
        IniDefault="True"
        Hint="Enable shadows for characters."
        WinTop=0.3600000
        WinLeft=0.1000000
        WinWidth=0.3000000
        WinHeight=0.0500000
    ...
    begin object name="DetailDynamicLighting" class=XInterface_Decompressed.moCheckBox
        ...
        IniDefault="True"
        Hint="Enable dynamic lighting effects."
        WinTop=0.4600000
        WinLeft=0.1000000
        WinWidth=0.3000000
        WinHeight=0.0500000
    ...
    begin object name="DetailCoronas" class=XInterface_Decompressed.moCheckBox
        ...
        IniDefault="True"
        Hint="Enable coronas around light sources."
        WinTop=0.4600000
        WinLeft=0.6000000
        WinWidth=0.3000000
        WinHeight=0.0500000
    ...
    begin object name="DetailDecalStay" class=XInterface_Decompressed.moComboBox
        ComponentJustification=0
        Caption="Bullet Mark Duration"
        OnCreateComponent=DetailDecalStay.InternalOnCreateComponent
        IniOption="@Internal"
        IniDefault="Normal"
        Hint="Change the length of time bullet marks remain."
        WinTop=0.5500000
        WinLeft=0.5987500
        WinWidth=0.3500000
        WinHeight=0.0600000
    ...
    begin object name="DetailDecoLayers" class=XInterface_Decompressed.moCheckBox
        ...
        IniDefault="True"
        Hint="Show ground clutter, like plants and grass."
        WinTop=0.6562510
        WinLeft=0.5987500
        WinWidth=0.3000000
        WinHeight=0.0400000
    ...
    begin object name="DetailBlob" class=XInterface_Decompressed.moCheckBox
        ComponentJustification=0
        CaptionWidth=0.9000000
        Caption="Simple Shadows"
        OnCreateComponent=DetailBlob.InternalOnCreateComponent
        IniOption="@Internal"
        IniDefault="False"
        Hint="Enable simple shadows. Recommended for computers with older hardware."
        WinTop=0.7500000
        WinLeft=0.5987500
        WinWidth=0.3000000
        WinHeight=0.0400000
