...
event bool rfAckFriendPosition(int Result, string TargetCharName, string fServername, string fServerShortName, string fServerIP, int fServerPort, byte CurPos, byte CurState, int ChannelNum, string ChannelNickName, int GameRoomNum)
{
    return false;
    //return;    
}
...
native function bool sfAckFriendPosition(int Result, string TargetCharName, string fServername, string fServerShortName, string fServerIP, int fServerPort, byte CurPos, byte CurState, int ChannelNum, string ChannelNickName, int GameRoomNum)
{
    //native.Result;
    //native.TargetCharName;
    //native.fServername;
...
native function bool sfAckPopUpMessage(byte MessageType)
{
    //native.MessageType;        
}
