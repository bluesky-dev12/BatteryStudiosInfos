...
event bool rfAckCharInfo(int Result, string CharName, int Level, int Exp)
{
    return false;
    //return;    
}
...
event bool rfReqLoginWithGlobal(string G_AccountID, string G_GUID, string G_AuthKey)
{
    return false;
    //return;    
}
...
native function bool sfAckCharInfo(int Result, string CharName, int Level, int Exp)
{
    //native.Result;
    //native.CharName;
    //native.Level;
...
native function bool sfReqLoginWithGlobal(string G_AccountID, string G_GUID, string G_AuthKey)
{
    //native.G_AccountID;
    //native.G_GUID;
    //native.G_AuthKey;        
